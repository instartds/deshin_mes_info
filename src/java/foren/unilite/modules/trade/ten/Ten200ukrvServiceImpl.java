...
@Service("ten200ukrvService")
public class Ten200ukrvServiceImpl extends TlabAbstractServiceImpl  {
    ...
    public List<Map<String, Object>> selectDetail(Map param) throws Exception {
        return super.commonDao.list("ten200ukrvServiceImpl.selectDetail", param);
    }
    ...
    public List<Map<String, Object>> selectBLList(Map param) throws Exception {
        return super.commonDao.list("ten200ukrvServiceImpl.selectBLList", param);
    }
    ...
    public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
        ...
        for(Map paramData: paramList) {         
            ...
            for(Map param:  dataList) {
                ...
                param.put("data", super.commonDao.insert("ten200ukrvServiceImpl.insertLogDetail", param));
            }
        }   
        ...
        super.commonDao.queryForObject("ten200ukrvServiceImpl.USP_TRADE_Ten200ukr", spParam);
