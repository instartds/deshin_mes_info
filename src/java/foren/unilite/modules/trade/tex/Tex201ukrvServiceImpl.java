...
@Service("tex201ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Tex201ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMasterList(Map param) throws Exception {
		return super.commonDao.list("tex201ukrvService.selectMasterList", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("tex201ukrvService.selectDetailList", param);
	}
	...
	public Integer updateMaster(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList ) {
			 super.commonDao.update("tex201ukrvService.updateMaster", param);
		}
		return 0;
	}
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {
		try {
			for(Map param : paramList ) {
				super.commonDao.update("tex201ukrvService.insertDetail", param);
			}
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("tex201ukrvService.updateDetail", param);
		}
		return 0;
	}
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList ) {
			try {
				super.commonDao.delete("tex201ukrvService.deleteDetail", param);
			}catch(Exception e) {
