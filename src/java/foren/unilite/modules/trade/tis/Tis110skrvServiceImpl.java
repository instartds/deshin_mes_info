...
@Service("tis110skrvService")
public class Tis110skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("tis110skrvServiceImpl.selectList", param);
	}
}
