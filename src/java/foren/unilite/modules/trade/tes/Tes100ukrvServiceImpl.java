...
@Service("tes100ukrvService")
public class Tes100ukrvServiceImpl extends TlabAbstractServiceImpl {
    ...
    public Map<String, Object> getOwnCustInfo(Map param) throws Exception {
        return (Map<String, Object>) super.commonDao.select("tes100ukrvServiceImpl.getOwnCustInfo", param);
    }
    ...
    public List<Map<String, Object>> fnExchgRateO(Map param) throws Exception {
        return super.commonDao.list("tes100ukrvServiceImpl.fnExchgRateO", param);
    }
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("tes100ukrvServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("tes100ukrvServiceImpl.selectDetailList", param);
	}
     ...
     */
    @ExtDirectMethod(group = "trade", value = ExtDirectMethodType.STORE_READ)
    public List<Map<String, Object>> selectOfferRefList(Map param) throws Exception {
        return super.commonDao.list("tes100ukrvServiceImpl.selectOfferRefList", param);
    }
    ...
    public List<Map<String, Object>> selectIssueList(Map param) throws Exception {
        return super.commonDao.list("tes100ukrvServiceImpl.selectIssueList", param);
    }
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("tes100ukrvServiceImpl.insertLogMaster", dataMaster);
		...
		super.commonDao.queryForObject("tes100ukrvServiceImpl.USP_TRADE_Tes100ukr", spParam);
		...
		if(ObjUtils.isNotEmpty(errorDesc)){
			...
			dataMaster.put("ERROR", this.getMessage(messsage[0], user));
			paramList.add(0, dataMaster);	
	...
	public ExtDirectFormPostResult syncForm(Tes100ukrvModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {	
...
//		dataMaster.setS_COMP_CODE(user.getCompCode());
//		super.commonDao.update("tes100ukrvServiceImpl.updateMasterForm", dataMaster);
//		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
		return extResult;
	}
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("tes100ukrvServiceImpl.insertLogDetail", param);
		}		
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("tes100ukrvServiceImpl.deleteMaster", param);
	}
	...
	public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
		...
		return super.commonDao.list("tes100ukrvServiceImpl.getFileList", param);
	}
	@ExtDirectMethod(group = "trade", value = ExtDirectMethodType.STORE_MODIFY)
	public void insertTED120(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("ADD_FIDS")).split(",");
			 ...
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.insert("tes100ukrvServiceImpl.insertTED120", param);
			 }
	}
	@ExtDirectMethod(group = "trade", value = ExtDirectMethodType.STORE_MODIFY)
	public void deleteTED120(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("DEL_FIDS")).split(",");
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.update("tes100ukrvServiceImpl.deleteTED120", param);
			 }
	}
	@ExtDirectMethod(group = "trade", value = ExtDirectMethodType.STORE_READ)
	public Object selectDocCnt(Map param) throws Exception {
		return super.commonDao.select("tes100ukrvServiceImpl.selectDocCnt", param);
	}
	
	@ExtDirectMethod(group = "trade", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return (List) super.commonDao.list("tes100ukrvServiceImpl.selectList", param);
	}
	
	@ExtDirectMethod(group = "trade", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return (List) super.commonDao.list("tes100ukrvServiceImpl.selectList2", param);
	}
}