...
@Controller
public class TesContoroller extends UniliteCommonController {
	...
	final static String		JSP_PATH	= "/trade/tes/";	
	
	@Resource(name="tes100ukrvService")
    private Tes100ukrvServiceImpl tes100ukrvService;
	
	@RequestMapping(value = "/trade/tes100ukrv.do")
	public String tes100ukrv(String popupID, ExtHtttprequestParam _req, LoginVO loginVO,ListOp listOp, ModelMap model) throws Exception {
	    ...
	    Map<String, Object> gsOwnCustInfo = tes100ukrvService.getOwnCustInfo(param); //자사 코드(수출자) 가져오기
        model.addAttribute("gsOwnCustInfo",ObjUtils.toJsonStr(gsOwnCustInfo));
        
		return JSP_PATH + "tes100ukrv";
