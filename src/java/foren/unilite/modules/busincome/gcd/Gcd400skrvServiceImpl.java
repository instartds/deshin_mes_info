...
@Service("gcd400skrvService")
public class Gcd400skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gcd400skrvService.selectList", param);
	}	
}
