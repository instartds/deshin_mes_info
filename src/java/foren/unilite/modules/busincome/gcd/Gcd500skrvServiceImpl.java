...
@Service("gcd500skrvService")
public class Gcd500skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gcd500skrvService.selectList", param);
	}	
}
