...
@Service("gcd300skrvService")
public class Gcd300skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gcd300skrvService.selectList", param);
	}	
}
