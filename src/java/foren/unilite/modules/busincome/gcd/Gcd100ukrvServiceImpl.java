...
@Service("gcd100ukrvService")
public class Gcd100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gcd100ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map>  insert(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			...
			super.commonDao.update("gcd100ukrvServiceImpl.insert", param);		
		}
		return  paramList;
	}
	...
	public void  deleteExcel(Map param, LoginVO user) throws Exception {		
		super.commonDao.update("gcd100ukrvServiceImpl.deleteExcel", param);		
	}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("gcd100ukrvServiceImpl.selectExcelUploadSheet1", param);
    }
    
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor={Exception.class})	
	public void excelValidate(String jobID, Map param) {
		super.commonDao.update("gcd100ukrvServiceImpl.excelValidate", param);
	}
