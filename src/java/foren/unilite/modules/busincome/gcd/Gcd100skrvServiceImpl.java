...
@Service("gcd100skrvService")
public class Gcd100skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gcd100skrvService.selectList", param);
	}
	
	@ExtDirectMethod(group = "busincome", value = ExtDirectMethodType.STORE_READ)
	public List<Map<Object, String>>  selectList2(Map param) throws Exception {	
		return  super.commonDao.list("gcd100skrvService.selectList2", param);
	}	
}
