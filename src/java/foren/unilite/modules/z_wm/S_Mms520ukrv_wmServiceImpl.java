...
@Service("s_mms520ukrv_wmService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_Mms520ukrv_wmServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object getWhCellCode(Map param) throws Exception {
		return super.commonDao.select("s_mms520ukrv_wmServiceImpl.getWhCellCode", param);
	}
	...
	public Object selectExpirationdate(Map param) throws Exception {
		return super.commonDao.select("s_mms520ukrv_wmServiceImpl.selectExpirationdate", param);
	}
	...
	public Object fnOrderPrice(Map param) throws Exception {
		return super.commonDao.select("s_mms520ukrv_wmServiceImpl.fnOrderPrice", param);
	}
	...
	public Object taxType(Map param) throws Exception {
		return super.commonDao.select("s_mms520ukrv_wmServiceImpl.taxType", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("s_mms520ukrv_wmServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectinoutNoMasterList(Map param) throws Exception {
		return super.commonDao.list("s_mms520ukrv_wmServiceImpl.selectinoutNoMasterList", param);
	}
...
//						throw new UniDirectValidateException("입고유형이 금액보정이 아닐때 구매단가가 0 이거나 0보다 작을 수 없습니다.");
						...
						param.put("data", super.commonDao.insert("s_mms520ukrv_wmServiceImpl.insertLogDetail", param));
					}
				}else{
					if("N".equals(oprFlag) || "D".equals(oprFlag)){
						param.put("data", super.commonDao.insert("s_mms520ukrv_wmServiceImpl.insertLogDetail", param));
					}else{
						param.put("data", super.commonDao.insert("s_mms520ukrv_wmServiceImpl.updateLogDetail", param));
					}
				}
			}
		}
		...
		super.commonDao.queryForObject("s_mms520ukrv_wmServiceImpl.spReceiving", spParam);
...
//			dataMaster.put("INOUT_NUM", "");
	...
	public List<Map<String, Object>> printMasterData(Map param) throws Exception {
		return super.commonDao.list("s_mms520ukrv_wmServiceImpl.printMasterData", param);
	}
	...
	public List<Map<String, Object>> printDetailData(Map param) throws Exception {
		return super.commonDao.list("s_mms520ukrv_wmServiceImpl.printDetailData", param);
	}
}