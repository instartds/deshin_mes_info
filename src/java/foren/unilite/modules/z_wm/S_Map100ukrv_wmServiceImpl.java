...
@Service("s_map100ukrv_wmService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_Map100ukrv_wmServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectRefCode2(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectRefCode2", param);
	}
	...
	public List<Map<String, Object>> selectMms510ukrv(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectMms510ukrv", param);
	}
	...
	public Object selectForm(Map param) throws Exception {
		return super.commonDao.select("s_map100ukrv_wmServiceImpl.selectForm", param);
	}//form

	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectList", param);
	}//grid
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectOrderNumMasterList", param);
	}
	...
	public List<Map<String, Object>> selectreceiveHistoryList(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectreceiveHistoryList", param);
	}
	...
	public List<Map<String, Object>> selectreturningHistoryList(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectreturningHistoryList", param);
	}
	...
	public List<Map<String, Object>> selectorderHistoryList(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectorderHistoryList", param);
	}
	/**
	 * 신고사업장
	 * @param param
	...
	public Object  billDivCode(Map param) throws Exception {
		return  super.commonDao.select("s_map100ukrv_wmServiceImpl.billDivCode", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("s_map100ukrv_wmServiceImpl.insertLogForm", dataMaster);
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("s_map100ukrv_wmServiceImpl.insertLogMaster", param));
			//	param.put("data", super.commonDao.update("s_map100ukrv_wmServiceImpl.insertLogForm", param));
			}
		}
...
//		super.commonDao.queryForObject("spBuy", spParam);
		super.commonDao.queryForObject("s_map100ukrv_wmServiceImpl.spBuy", spParam);
...
//		Map<String, Object> dataMaster = (Map<String, Object>) paramMaster.get("data");
	...
	public List<Map<String, Object>> selectMainReportList(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectMainReportList", param);
	}//grid
	...
	public List<Map<String, Object>> selectPrimaryDataList2(Map param) throws Exception {
		return super.commonDao.list("s_map100ukrv_wmServiceImpl.selectPrimaryDataList2", param);
	}
}