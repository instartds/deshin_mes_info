...
@Service("s_emp110skr_hsService")
public class S_emp110skr_hsServiceImpl extends TlabAbstractServiceImpl {
	...
	*/
	...
	public Map<String, Object> selectList( Map param) throws Exception {
        ...
        rList = (List)super.commonDao.list("s_emp110skr_hsserviceimpl.selectList", param);
	...
	public List<Map> selectExchg(Map param) throws Exception {
		return super.commonDao.list("s_emp110skr_hsserviceimpl.selectExchg", param);
	}
}
