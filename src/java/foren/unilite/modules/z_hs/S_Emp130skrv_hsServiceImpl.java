...
@Service("s_emp130skrv_hsService")
public class S_Emp130skrv_hsServiceImpl extends TlabAbstractServiceImpl {
	...
	public Map<String, Object> selectList(Map param) throws Exception {
		...
		rList = (List<Map<String, Object>>) super.commonDao.list("s_emp130skrv_hsServiceImpl.selectList", param);
	...
	public List<Map> selectExchg(Map param) throws Exception {
		return super.commonDao.list("s_emp130skrv_hsServiceImpl.selectExchg", param);
	}
}
