...
@Service("gri600ukrvService")
public class Gri600ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gri600ukrvServiceImpl.selectList", param);
	}
