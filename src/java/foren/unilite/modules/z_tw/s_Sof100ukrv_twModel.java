...
public class s_Sof100ukrv_twModel extends BaseVO {
	...
	//20191129 추가
	private String LC_SER_NO;
	//20200923 추가
	private String BOOKING_NUM;
	private String PACK_TYPE;
	private String PALLET_USE;
	private Integer	PALLET_QTY;
	private String LABEL_USE;
	...
	public String getLC_SER_NO() {
		return LC_SER_NO;
	}

	public void setLC_SER_NO(String lC_SER_NO) {
		LC_SER_NO = lC_SER_NO;
	}
   ...
   public String getDEST_FINAL() {
	...
	public String getPALLET_USE() {
		return PALLET_USE;
	}
	public void setPALLET_USE(String pALLET_USE) {
		PALLET_USE = pALLET_USE;
	}
	
	public Integer getPALLET_QTY() {
		return PALLET_QTY;
	}

	public void setPALLET_QTY(Integer pALLET_QTY) {
	...
	public String getLABEL_USE() {
		return LABEL_USE;
	}
	public void setLABEL_USE(String lABEL_USE) {
		LABEL_USE = lABEL_USE;
	}
