...
@Service("s_sof100ukrv_twService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_Sof100ukrv_twServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectGsDvry(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_twServiceImpl.selectGsDvry", param);
	}
    ...
    public List<Map<String, Object>> fnExchgRateO(Map param) throws Exception {
        return super.commonDao.list("s_sof100ukrv_twServiceImpl.fnExchgRateO", param);
    }
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_twServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_twServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_twServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_twServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_twServiceImpl.selectEstiList", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_twServiceImpl.selectRefList", param);
	}
	...
	public List<Map<String, Object>> getCustCredit(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_twServiceImpl.getCustCredit", param);
	}
...
//		}
		...
		super.commonDao.insert("s_sof100ukrv_twServiceImpl.insertLogMaster", dataMaster);
		...
		super.commonDao.queryForObject("s_sof100ukrv_twServiceImpl.spSalesOrder", spParam);
	...
	public ExtDirectFormPostResult syncForm(s_Sof100ukrv_twModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {

		String keyValue = getLogKey();
		//2.수주마스터 로그테이블에 KEY_VALUE, OPR_FLAG 업데이트
		dataMaster.setCOMP_CODE(user.getCompCode());
		dataMaster.setKEY_VALUE(keyValue);
		logger.debug("[[dataMaster]]" + dataMaster);
...
//		super.commonDao.update("s_sof100ukrv_twServiceImpl.updateMasterForm", dataMaster);
//		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
		return extResult;
	}
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)		{
			...
			if(oprFlag.equals("N")){
				param.put("INIT_DVRY_DATE", param.get("DVRY_DATE"));
			}else{
				param.put("INIT_DVRY_DATE", param.get("INIT_DVRY_DATE"));
			}
			super.commonDao.insert("s_sof100ukrv_twServiceImpl.insertLogDetail", param);
		}
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("s_sof100ukrv_twServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(s_Sof100ukrv_twModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);

		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("s_sof100ukrv_twServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("s_sof100ukrv_twServiceImpl.updateMaster", paramMap);
		}

		super.commonDao.update("s_sof100ukrv_twServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(s_Sof100ukrv_twModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag")))){
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("s_sof100ukrv_twServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("s_sof100ukrv_twServiceImpl.insertDetail", param);
		}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("s_sof100ukrv_twServiceImpl.updateDetail", param);
		}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("s_sof100ukrv_twServiceImpl.checkSSA110", param);
		        if(ObjUtils.isEmpty(checkListSSA110))	{
		        	...
		        	for(Map<String, Object> checkSSA110 : checkListSSA110)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_sof100ukrv_twServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("s_sof100ukrv_twServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_sof100ukrv_twServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("s_sof100ukrv_twServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("s_sof100ukrv_twServiceImpl.checkDeleteAllDetail", params.get(0));
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_sof100ukrv_twServiceImpl.checkEstimate", param);

		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{
						super.commonDao.update("s_sof100ukrv_twServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("s_sof100ukrv_twServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_sof100ukrv_twServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("s_sof100ukrv_twServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_twServiceImpl.checkProgressDetail", param);
		}
    ...
    public List<Map> selectExcelUploadSheet1(Map param) throws Exception {
        ...
        List<Map> excelUploadMapList2 = new ArrayList<Map>();
    	List<Map> excelUploadMapList = super.commonDao.list("s_sof100ukrv_twServiceImpl.selectExcelUploadSheet1", param);

    	for(Map excelUploadMap : excelUploadMapList)	{
    		paramMap.put("COMP_CODE", param.get("S_COMP_CODE"));
    		paramMap.put("CUSTOM_CODE", param.get("CUSTOM_CODE"));
    		paramMap.put("AGENT_TYPE", 	param.get("AGENT_TYPE"));
    		paramMap.put("ITEM_CODE",   excelUploadMap.get("ITEM_CODE"));
    		paramMap.put("MONEY_UNIT", param.get("MONEY_UNIT"));
    		paramMap.put("ORDER_UNIT", excelUploadMap.get("ORDER_UNIT"));
    		paramMap.put("STOCK_UNIT", excelUploadMap.get("STOCK_UNIT"));
    		paramMap.put("TRANS_RATE", excelUploadMap.get("TRNS_RATE"));
    		paramMap.put("BASIS_DATE", param.get("ORDER_DATE"));
    		logger.debug("[paramMap]"  + paramMap);
    		Map<String, Object> priceMap = (Map<String, Object>) super.commonDao.queryForObject("salesCommonServiceImpl.fnGetPriceInfo", paramMap);
    		if(ObjUtils.isNotEmpty(priceMap)) {
    			excelUploadMap.put("PRICE", priceMap.get("SALE_PRICE"));
    		}

    		excelUploadMapList2.add((Map) excelUploadMap);
    	}

    	logger.debug("[[excelUploadMapList2]]" + excelUploadMapList2);
        return excelUploadMapList2;
    }

	public void excelValidate(String jobID, Map param) {
	    logger.debug("validate: {}", jobID);
		super.commonDao.update("s_sof100ukrv_twServiceImpl.excelValidate", param);
	}

	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.FORM_LOAD)
	public Object checkOfferNo(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_twServiceImpl.checkOfferNo", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.FORM_LOAD)
	public Object checkUpnCode(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_twServiceImpl.checkUpnCode", param);
	}
	...
	public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
		...
		return super.commonDao.list("s_sof100ukrv_twServiceImpl.getFileList", param);
	}
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public int insertSOF102(Map param, LoginVO login) throws Exception {
		...
		String[] fids =  ObjUtils.getSafeString(param.get("ADD_FIDS")).split(",");
		 ...
		 for(String fid : fids)	{
			 param.put("FID", fid);
			 insRtn += super.commonDao.insert("s_sof100ukrv_twServiceImpl.insertSOF102", param);
		 }
		 
		 return insRtn;
	}
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public void deleteSOF102(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("DEL_FIDS")).split(",");
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.update("s_sof100ukrv_twServiceImpl.deleteSOF102", param);
			 }
	}
	 ...
	 * @throws Exception
	 */
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "sales")			//SRM 데이터 수신
	public List<Map<String, Object>>  receiveSRM (Map param) throws Exception {
		return  super.commonDao.list("s_sof100ukrv_twServiceImpl.receiveSRM", param);
	}
	...
	public String soToPoRequest (Map param, LoginVO user) throws Exception {
		String rtnV = "N";
		Map<String, Object> spParam = new HashMap<String, Object>();
		...
		spParam.put("ORDER_NUM"	, param.get("ORDER_NUM"));
		spParam.put("USER_ID"	, user.getUserID());
		spParam.put("TYPE"		, param.get("TYPE"));

		super.commonDao.queryForObject("s_sof100ukrv_twServiceImpl.soToPoRequest", spParam);
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));
		if(!ObjUtils.isEmpty(errorDesc)){
	...
	public Object selectDocCnt(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_twServiceImpl.selectDocCnt", param);
	}
     ...
     */
    @ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
    public List<Map<String, Object>> getSupplyType(Map param) throws Exception {
        return super.commonDao.list("s_sof100ukrv_twServiceImpl.getSupplyType", param);
    }
	...
	public Object insertPurchaseRequest(Map spParam, LoginVO user) throws Exception {
		//1.구매요청정보 존재여부 체크
		Map existPurchaseOrder = (Map) super.commonDao.select("s_sof100ukrv_twServiceImpl.checkPurchaseOrder", spParam);
		if(ObjUtils.isNotEmpty(existPurchaseOrder)) {
			throw new UniDirectValidateException("이미 구매요청 된 데이터입니다." + "\n" + "수주번호:" + existPurchaseOrder.get("ORDER_NUM") + "\n" + "수주순번:" + existPurchaseOrder.get("SER_NO"));
		}
		//2.로그테이블에서 사용할 Key 생성
		String keyValue = getLogKey();
		spParam.put("KEY_VALUE"	, keyValue);
		spParam.put("LangCode"	, user.getLanguage());
		//3.로그테이블에 insert
		super.commonDao.update("s_sof100ukrv_twServiceImpl.insertLogPurchaseOrder", spParam);
		//4.SP 호출
		super.commonDao.update("s_sof100ukrv_twServiceImpl.callMakePurchaseOrder", spParam);
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));
		if(!ObjUtils.isEmpty(errorDesc)){
