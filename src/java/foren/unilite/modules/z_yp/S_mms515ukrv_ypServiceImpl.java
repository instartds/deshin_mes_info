...
@Service("s_mms515ukrv_ypService")
@SuppressWarnings({"rawtypes", "unchecked"})
public class S_mms515ukrv_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public String getCertType (Map param) throws Exception {
		return  (String) super.commonDao.select("s_mms515ukrv_ypServiceImpl.getCertType", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectinoutNoMasterList(Map param) throws Exception {
		return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectinoutNoMasterList", param);
	}
	...
	public List<Map<String, Object>> selectnoReceiveList(Map param) throws Exception {
		return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectnoReceiveList", param);
	}
    ...
    public List<Map<String, Object>> selectReceiveList(Map param) throws Exception {
        return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectReceiveList", param);
    }
	...
	public List<Map<String, Object>> selectreturnPossibleList(Map param) throws Exception {
		return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectreturnPossibleList", param);
	}
	...
	public List<Map<String, Object>> selectScmRefList(Map param) throws Exception {
		return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectScmRefList", param);
	}
	...
	public List<Map<String, Object>> selectinspectResultList(Map param) throws Exception {
		return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectinspectResultList", param);
	}
	...
	public Object  fnOrderPrice(Map param) throws Exception {
		return  super.commonDao.select("s_mms515ukrv_ypServiceImpl.fnOrderPrice", param);
	}

	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public Object selectGetOrderPrice(Map param) throws Exception {
		return super.commonDao.select("s_mms515ukrv_ypServiceImpl.selectGetOrderPrice", param);
	}
	/**
	 * userID에 따른 납품창고
	 */
	...
	public Object userWhcode(Map param) throws Exception {
		return  super.commonDao.select("s_mms515ukrv_ypServiceImpl.userWhcode", param);
	}
	...
	public Object fnGetCalcTaxAmt(Map param) throws Exception {
		return  super.commonDao.select("s_mms515ukrv_ypServiceImpl.fnGetCalcTaxAmt", param);
	}
	...
	public Object  taxType(Map param) throws Exception {
		return  super.commonDao.select("s_mms515ukrv_ypServiceImpl.taxType", param);
	}
...
//		List<List<Map>> resultList = new ArrayList<List<Map>>();
			...
			for(Map param:  dataList) {
				...
				if(oprFlag.equals("N")  && param.get("ACCOUNT_YNC").equals("Y") && !param.get("INOUT_TYPE_DETAIL").equals("91") && param.get("PRICE_YN").equals("Y")){
					if(ObjUtils.parseInt(param.get("ORDER_UNIT_FOR_P"))<= 0){
						...
						param.put("data", super.commonDao.insert("s_mms515ukrv_ypServiceImpl.insertLogDetail", param));
					}
				}else{
					if("N".equals(oprFlag) || "D".equals(oprFlag)){
						param.put("data", super.commonDao.insert("s_mms515ukrv_ypServiceImpl.insertLogDetail", param));
					}else{
						param.put("data", super.commonDao.insert("s_mms515ukrv_ypServiceImpl.updateLogDetail", param));
					}
				}
			}
		}
	    ...
	    super.commonDao.queryForObject("s_mms515ukrv_ypServiceImpl.spReceiving", spParam);
...
//			dataMaster.put("INOUT_NUM", "");
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("s_mms515ukrv_ypServiceImpl.insertDetail", param);
		}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("s_mms515ukrv_ypServiceImpl.updateDetail", param);
		}
		return params;
	}
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("s_mms515ukrv_ypServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("s_mms515ukrv_ypServiceImpl.checkDeleteAllDetail", params.get(0));
	}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("s_mms515ukrv_ypServiceImpl.checkSSA110", param);
		        if(ObjUtils.isEmpty(checkListSSA110))	{
		        	...
		        	for(Map<String, Object> checkSSA110 : checkListSSA110)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_mms515ukrv_ypServiceImpl.updateBTR100", paramSRQ100);
		        		}
		        	}
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("s_mms515ukrv_ypServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_mms515ukrv_ypServiceImpl.updateSRQ100", paramSRQ100);
		        		}
		        	}
		        }
	        }
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_mms515ukrv_ypServiceImpl.checkEstimate", param);

		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkEstimateConfirm", params.get(0));
			...
			if(!ObjUtils.isEmpty(cfrmData))	{
				...
				for(Map<String, Object> estiParam : params)	{
					super.commonDao.update("s_mms515ukrv_ypServiceImpl.updateEstimateConfirm", estiParam);
				}
			}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
		Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkEstiDetail", param);
		if(!ObjUtils.isEmpty(cfrmData))	{
			if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
				throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
			}
			...
			super.commonDao.update("s_mms515ukrv_ypServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_mms515ukrv_ypServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("s_mms515ukrv_ypServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("s_mms515ukrv_ypServiceImpl.checkProgressDetail", param);
		}
   ...
   public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
       return super.commonDao.list("s_mms515ukrv_ypServiceImpl.selectExcelUploadSheet1", param);
   }

	public void excelValidate(String jobID, Map param) {
	    logger.debug("validate: {}", jobID);
	    logger.debug("param >> " + param);
		super.commonDao.update("s_mms515ukrv_ypServiceImpl.excelValidate", param);
	}
}
