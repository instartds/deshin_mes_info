...
@Service("s_str103ukrv_ypService")
@SuppressWarnings({"unchecked", "rawtypes"})
public class S_str103ukrv_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_ypServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_ypServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectRequestiList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_ypServiceImpl.selectRequestiList", param);
	}
	...
	public List<Map<String, Object>> selectSalesOrderList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_ypServiceImpl.selectSalesOrderList", param);
	}
	/**
	 * 
	 * 창고조회
	...
	public Object  deptWhcode(Map param) throws Exception {	
		...
		return  super.commonDao.select("s_str103ukrv_ypServiceImpl.deptWhcode", param);
	}
	/**
	 * 출고정보 저장
...
//				param.put("PICK_STATUS", "");			
				param.put("data", super.commonDao.insert("s_str103ukrv_ypServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("s_str103ukrv_ypServiceImpl.spReceiving", spParam);
