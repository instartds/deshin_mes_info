...
@Service("s_mpo105ukrv_ypService")
public class S_mpo105ukrv_ypServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectCustData(Map param) throws Exception {
            return super.commonDao.list("s_mpo105ukrv_ypService.selectCustData", param);
        }
        ...
        public List<Map<String, Object>> selectItemData(Map param) throws Exception {
            return super.commonDao.list("s_mpo105ukrv_ypService.selectItemData", param);
        }
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_mpo105ukrv_ypService.selectList", param);
        }
        ...
        public List<Map<String, Object>> selectList2(Map param) throws Exception {
            return super.commonDao.list("s_mpo105ukrv_ypService.selectList2", param);
        }
        ...
        public Integer insertDetail(List<Map> paramList, LoginVO user) throws Exception {
            for(Map param : paramList ) {
                super.commonDao.update("s_mpo105ukrv_ypService.insertDetail", param);
            }      
            return 0;
        } 
        ...
        public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
            ...
            for(Map param :paramList ) {   
                super.commonDao.update("s_mpo105ukrv_ypService.updateDetail", param);
            }
            return 0;
        } 
        ...
        public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                super.commonDao.update("s_mpo105ukrv_ypService.deleteDetail", param);
            }
            return 0;
        } 
        ...
        public Object  createOrderInfo(Map spParam, LoginVO user) throws Exception {
            Map errorMap = new HashMap();
            if(spParam.get("ORDER_PLAN_TYPE").equals("1")){     //통합
                errorMap = (Map) super.commonDao.select("s_mpo105ukrv_ypService.USP_MATRL_CreateOrderPlan_YP_V10", spParam);
            }else{  //개별
                errorMap = (Map) super.commonDao.select("s_mpo105ukrv_ypService.USP_MATRL_CreateOrderPlan_YP_V20", spParam);
            }
