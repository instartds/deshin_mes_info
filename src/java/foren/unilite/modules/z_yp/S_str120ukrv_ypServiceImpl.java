...
@Service("s_str120ukrv_ypService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_str120ukrv_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectInNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_str120ukrv_ypServiceImpl.selectInNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectProdtList(Map param) throws Exception {
		return super.commonDao.list("s_str120ukrv_ypServiceImpl.selectProdtList", param);
	}
	...
	public List<Map<String, Object>> inspecResult(Map param) throws Exception {
		return super.commonDao.list("s_str120ukrv_ypServiceImpl.inspecResultList", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_str120ukrv_ypServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> getWkShopDivCode(Map param) throws Exception {
		return super.commonDao.list("s_str120ukrv_ypServiceImpl.getWkShopDivCode", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				param.put("data", super.commonDao.insert("s_str120ukrv_ypServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("s_str120ukrv_ypServiceImpl.spReceiving", spParam);
	...
	public List<Map<String, Object>> getItemInfo (Map param) throws Exception {
		return super.commonDao.list("s_str120ukrv_ypServiceImpl.getItemInfo", param);
	}
}
