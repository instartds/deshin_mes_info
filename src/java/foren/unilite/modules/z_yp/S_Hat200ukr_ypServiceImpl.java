...
@Service("s_hat200ukr_ypService")
public class S_Hat200ukr_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO loginVO) throws Exception {
		...
		List vrecord2 = (List)super.commonDao.list("s_hat200ukr_ypServiceImpl.vrecord2" ,param);
		...
		List list = (List) super.commonDao.list("s_hat200ukr_ypServiceImpl.selectList", param);
				
		return (List) super.commonDao.list("s_hat200ukr_ypServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectList2(Map param, LoginVO loginVO) throws Exception {
		return (List) super.commonDao.list("s_hat200ukr_ypServiceImpl.selectList2", param);
	}
	...
	public List<Map> updateHat200(List<Map> param, LoginVO loginVO, Map paramMaster) throws Exception {
        ...
        Map fnCheckCloseDate = (Map) super.commonDao.select("s_hat200ukr_ypServiceImpl.fnCheckCloseMonth", tempParam);
		...
		List<Map> fnHat200Set = (List)super.commonDao.list("s_hat200ukr_ypServiceImpl.fnHat200Set" ,fnHat200SetMap);
		...
		for(int x=0; x< param.size();x++){			
			...
			super.commonDao.list("s_hat200ukr_ypServiceImpl.update", map2);
	...
	public List<Map> deleteHat200(List<Map> deleteList,LoginVO loginVO, Map paramMaster) throws Exception {		
		...
		for(Map param :deleteList )	{
			if(param.get("FLAG").equals("U")){
				...
				super.commonDao.list("s_hat200ukr_ypServiceImpl.delete", param);
//				System.out.println(paramList.toString());
	...
	public List<Map> wirteCheck(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("s_hat200ukr_ypServiceImpl.wirteCheck", param);
	}	
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("s_hat200ukr_ypServiceImpl.selectExcelUploadSheet1", param);
    }
    ...
    public List<Map<String, Object>> selectExcelUploadApply(Map param) throws Exception {
        return super.commonDao.list("s_hat200ukr_ypServiceImpl.selectExcelUploadApply", param);
    }
    
    public void excelValidate(String jobID, Map param) {                            // 엑셀 Validate
        logger.debug("validate: {}", jobID);
        super.commonDao.update("s_hat200ukr_ypServiceImpl.excelValidate", param);
    }
}
