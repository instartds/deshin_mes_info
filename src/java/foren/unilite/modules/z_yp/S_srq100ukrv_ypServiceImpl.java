...
@Service("s_srq100ukrv_ypService")
@SuppressWarnings({"rawtypes", "unchecked"})
public class S_srq100ukrv_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_ypServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_ypServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectReferList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_ypServiceImpl.selectReferList", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_ypServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_ypServiceImpl.selectRefList", param);
	}
...
//					Map checkReqSeq = (Map) super.commonDao.select("s_srq100ukrv_ypServiceImpl.chkReqSeq",param);
//					if (ObjUtils.isNotEmpty(checkReqSeq)){
//						Map getMaxReqSeq = (Map) super.commonDao.select("s_srq100ukrv_ypServiceImpl.getMaxReqSeq",param);
//						issReqSeq = Integer.parseInt(getMaxReqSeq.get("MAX_REQ_SEQ").toString());
//						param.put("ISSUE_REQ_SEQ", getMaxReqSeq);
//					}
//				}
				param.put("data", super.commonDao.insert("s_srq100ukrv_ypServiceImpl.insertLogDetail", param));
			}
		}
		...
		super.commonDao.queryForObject("s_srq100ukrv_ypServiceImpl.spSalesShipment", spParam);
	...
	@ExtDirectMethod(group = "z_yp", value = ExtDirectMethodType.STORE_MODIFY)
