...
@Service("s_sof101ukrv_ypService")
@SuppressWarnings({"rawtypes", "unchecked"})
public class S_sof101ukrv_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> fnExchgRateO(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.fnExchgRateO", param);
	}
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("s_sof101ukrv_ypServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		int i= 1;
		List<Map<String, Object>> calDateList = super.commonDao.list("s_sof101ukrv_ypServiceImpl.getCalDate", param);
		
		for(Map calDate: calDateList) {
			param.put("CAL_DATE"+i, calDate.get("CAL_DATE"));
			i++;
		}

		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.selectEstiList", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.selectRefList", param);
	}
	...
	public List<Map<String, Object>> getCustCredit(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.getCustCredit", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("s_sof101ukrv_ypServiceImpl.insertLogMaster", dataMaster);
...
//		List<List<Map>> resultList = new ArrayList<List<Map>>();
		...
		super.commonDao.queryForObject("s_sof101ukrv_ypServiceImpl.spSalesOrder_YP", spParam);
...
//		super.commonDao.update("s_sof101ukrv_ypServiceImpl.updateMasterForm", dataMaster);
//		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
		return extResult;
	}
...
//			List<Map<String, Object>> calDateList = super.commonDao.list("s_sof101ukrv_ypServiceImpl.getCalDate", param);
			...
			for(i = 1; i < 8; i++) {
				if(!param.get("OPR_FLAG").equals("D")) {
					param.put("OPR_FLAG", param.get("NEW_YN" + i));
				}
				param.put("SER_NO"			, param.get("SER_NO" + i));
				param.put("ORDER_Q"			, param.get("ORDER_Q" + i));
				param.put("DVRY_DATE"		, param.get("DVRY_DATE" + i));
				param.put("PROD_END_DATE"	, param.get("PROD_END_DATE" + i));
				param.put("EXP_ISSUE_DATE"	, param.get("EXP_ISSUE_DATE" + i));
				param.put("GOODS_DIVISION"	, param.get("GOODS_DIVISION" + i));	//202109 jhj:컬럼추가	농공산구분
				param.put("WONSANGI"		, param.get("WONSANGI" + i));		//202109 jhj:컬럼추가	원산지
				param.put("FARM_NAME"		, param.get("FARM_NAME" + i));		//202109 jhj:컬럼추가	농가코드
				param.put("CUSTOM_CODE"		, param.get("CUSTOM_CODE" + i));	//202109 jhj:컬럼추가	인증번호
				param.put("PREV_ORDER_Q"	, param.get("PREV_ORDER_Q" + i));
				param.put("ORDER_O"			, param.get("ORDER_O" + i));
				param.put("ORDER_TAX_O"		, param.get("ORDER_TAX_O" + i));
				param.put("ORDER_O_TAX_O"	, param.get("ORDER_O_TAX_O" + i));
				param.put("PROD_SALE_Q"		, param.get("PROD_SALE_Q" + i));
				param.put("ORDER_UNIT_Q"	, param.get("ORDER_UNIT_Q" + i));
				param.put("PROD_Q"			, param.get("PROD_Q" + i));
				param.put("STOCK_Q"			, param.get("STOCK_Q" + i));
				param.put("OUTSTOCK_Q"		, param.get("OUTSTOCK_Q" + i));
				param.put("ISSUE_REQ_Q"		, param.get("ISSUE_REQ_Q" + i));
				param.put("SALE_Q"			, param.get("SALE_Q" + i));
				param.put("REMARK"			, param.get("REMARK" + i));
				
				logger.debug(param.toString());
				
				if (( param.get("OPR_FLAG").equals("U") && (ObjUtils.parseDouble(param.get("SER_NO"))!= 0))
				 || ( param.get("OPR_FLAG").equals("N") && (ObjUtils.parseDouble(param.get("SER_NO"))!= 0 && ObjUtils.parseDouble(param.get("ORDER_Q"))!= 0))
				 || ( param.get("OPR_FLAG").equals("D") && (ObjUtils.parseDouble(param.get("SER_NO"))!= 0))) {
					super.commonDao.insert("s_sof101ukrv_ypServiceImpl.insertLogDetail", param);
				}
			}
		}		
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("s_sof101ukrv_ypServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(S_sof100ukrv_ypModel param, LoginVO user,  BindingResult result) throws Exception {
		...
		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("s_sof101ukrv_ypServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("s_sof101ukrv_ypServiceImpl.updateMaster", paramMap);
		}
		
		super.commonDao.update("s_sof101ukrv_ypServiceImpl.updatePrice", paramMap);
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag")))){
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("s_sof101ukrv_ypServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("s_sof101ukrv_ypServiceImpl.insertDetail", param);
		}		
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("s_sof101ukrv_ypServiceImpl.updateDetail", param);
		}		
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
			...
			if(sCase > 0)	{
				if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
					Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkSaleQ", param);
			...
			if(outStockQ > 0)	{
				List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("s_sof101ukrv_ypServiceImpl.checkSSA110", param);
				if(ObjUtils.isEmpty(checkListSSA110))	{
					...
					for(Map<String, Object> checkSSA110 : checkListSSA110)	{
						...
						if(sFlg != 0)	{
							...
							super.commonDao.update("s_sof101ukrv_ypServiceImpl.updateBTR100", paramSRQ100);
			...
			if(issueReqQ > 0)	{
				List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("s_sof101ukrv_ypServiceImpl.checkSRQ100", param);
				...
				if(ObjUtils.isEmpty(checkListSRQ100))	{
					...
					for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
						...
						if(sFlg != 0)	{
							...
							super.commonDao.update("s_sof101ukrv_ypServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("s_sof101ukrv_ypServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("s_sof101ukrv_ypServiceImpl.checkDeleteAllDetail", params.get(0)); 
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_sof101ukrv_ypServiceImpl.checkEstimate", param);
		
		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{					
						super.commonDao.update("s_sof101ukrv_ypServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("s_sof101ukrv_ypServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_sof101ukrv_ypServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{	
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("s_sof101ukrv_ypServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("s_sof101ukrv_ypServiceImpl.checkProgressDetail", param);
		}
	...
	public Object  insertPurchaseRequest(Map spParam, LoginVO user) throws Exception {
		spParam.put("LangCode", user.getLanguage());
		super.commonDao.update("s_sof101ukrv_ypServiceImpl.callMakePurchaseOrder", spParam);		
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));				
	...
	/**
	 * 엑셀업로드 (임시테이블에 업로드 된 데이터를 업로드팝업 데이터에 조회)
	 * @param param
	 * @return
	 * @throws Exception
	 */
	...
	public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.selectExcelUploadSheet1", param);
	}
	
	public void excelValidate(String jobID, Map param) {
		logger.debug("validate: {}", jobID);
		super.commonDao.update("s_sof101ukrv_ypServiceImpl.excelValidate", param);
	}
	
	/**
	 * 엑셀업로드 (엑셀파일에 입력된 아이템명으로 ITEM_CODE 찾아 해당 정보 가져오는 로직)
	 * @param param
	 * @return
	 * @throws Exception
	 */
	...
	public Object getItemCode(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.getItemCode", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public Object getItemInfo(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.getItemInfo", param);
	}
	...
	public Object getCustomItemCode(Map param) throws Exception {
		return super.commonDao.select("s_sof101ukrv_ypServiceImpl.getCustomItemCode", param);
	}
	

	/**
	 * 수주일자 입력 시, 주차 가져오는 로직
	 * 
	 * @param param
	 * @return
	 * @throws Exception
	...
	public Object getCalNo(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.getCalNo", param);
	}
	...
	public Object getCalDate(Map param) throws Exception {
		return super.commonDao.list("s_sof101ukrv_ypServiceImpl.getCalDate", param);
	}
}
