...
public class S_sof100ukrv_ypModel extends BaseVO {
    /**
     * 
     */
    ...
    public String getGOODS_DIVISION() {
    	return GOODS_DIVISION;
    }
    
    public void setGOODS_DIVISION(String gOODS_DIVISION) {
