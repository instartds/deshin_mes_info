...
@Service("w_sof100ukrv_ypService")
@SuppressWarnings({"rawtypes", "unchecked"})
public class W_sof100ukrv_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> fnExchgRateO(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.fnExchgRateO", param);
	}
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("w_sof100ukrv_ypServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.selectEstiList", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.selectRefList", param);
	}
	...
	public List<Map<String, Object>> getCustCredit(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.getCustCredit", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("w_sof100ukrv_ypServiceImpl.insertLogMaster", dataMaster);
		...
		super.commonDao.queryForObject("w_sof100ukrv_ypServiceImpl.spSalesOrder_YP", spParam);
	...
	public ExtDirectFormPostResult syncForm(W_sof100ukrv_ypModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {	
...
//		super.commonDao.update("w_sof100ukrv_ypServiceImpl.updateMasterForm", dataMaster);
//		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
		return extResult;
	}
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("w_sof100ukrv_ypServiceImpl.insertLogDetail", param);
		}		
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("w_sof100ukrv_ypServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(W_sof100ukrv_ypModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);
		
		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("w_sof100ukrv_ypServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("w_sof100ukrv_ypServiceImpl.updateMaster", paramMap);
		}
		
		super.commonDao.update("w_sof100ukrv_ypServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(W_sof100ukrv_ypModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag")))){
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("w_sof100ukrv_ypServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("w_sof100ukrv_ypServiceImpl.insertDetail", param);
		}		
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("w_sof100ukrv_ypServiceImpl.updateDetail", param);
		}		
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
			...
			if(sCase > 0)	{
				if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
					Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkSaleQ", param);
			...
			if(outStockQ > 0)	{
				List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("w_sof100ukrv_ypServiceImpl.checkSSA110", param);
				if(ObjUtils.isEmpty(checkListSSA110))	{
					...
					for(Map<String, Object> checkSSA110 : checkListSSA110)	{
						...
						if(sFlg != 0)	{
							...
							super.commonDao.update("w_sof100ukrv_ypServiceImpl.updateBTR100", paramSRQ100);
			...
			if(issueReqQ > 0)	{
				List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("w_sof100ukrv_ypServiceImpl.checkSRQ100", param);
				...
				if(ObjUtils.isEmpty(checkListSRQ100))	{
					...
					for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
						...
						if(sFlg != 0)	{
							...
							super.commonDao.update("w_sof100ukrv_ypServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("w_sof100ukrv_ypServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("w_sof100ukrv_ypServiceImpl.checkDeleteAllDetail", params.get(0)); 
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("w_sof100ukrv_ypServiceImpl.checkEstimate", param);
		
		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{					
						super.commonDao.update("w_sof100ukrv_ypServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("w_sof100ukrv_ypServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("w_sof100ukrv_ypServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{	
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("w_sof100ukrv_ypServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("w_sof100ukrv_ypServiceImpl.checkProgressDetail", param);
		}
	...
	public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
		return super.commonDao.list("w_sof100ukrv_ypServiceImpl.selectExcelUploadSheet1", param);
	}
	
	public void excelValidate(String jobID, Map param) {
		logger.debug("validate: {}", jobID);
		super.commonDao.update("w_sof100ukrv_ypServiceImpl.excelValidate", param);
	}
	...
	public Object  insertPurchaseRequest(Map spParam, LoginVO user) throws Exception {
		spParam.put("LangCode", user.getLanguage());
		super.commonDao.update("w_sof100ukrv_ypServiceImpl.callMakePurchaseOrder", spParam);		
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));				
	...
	public Object getCustomItemCode(Map param) throws Exception {
		return super.commonDao.select("w_sof100ukrv_ypServiceImpl.getCustomItemCode", param);
	}
	...
	public Object getItemCode(Map param) throws Exception {
		return super.commonDao.select("w_sof100ukrv_ypServiceImpl.getItemCode", param);
	}
     ...
     */
    @ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
    public Map<String, Object> getCustomCode(Map param) throws Exception {
        return (Map<String, Object>) super.commonDao.select("w_sof100ukrv_ypServiceImpl.getCustomCode", param);
    }
