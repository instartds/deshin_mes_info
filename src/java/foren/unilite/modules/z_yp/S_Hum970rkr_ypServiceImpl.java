...
@Service("s_hum970rkr_ypService")
public class S_Hum970rkr_ypServiceImpl extends TlabAbstractServiceImpl {
	...
	public String fnHum970ini(Map param) throws Exception {
		...
		List<Map>qureyValue = (List<Map>) super.commonDao.list("s_hum970rkr_ypServiceImpl.fnHum970ini", param);
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{	
				if(super.commonDao.select("s_hum970rkr_ypServiceImpl.selectProfNum", param) == null){
					super.commonDao.update("s_hum970rkr_ypServiceImpl.insertDetail", param);
				}
			}
		}catch(Exception e){
