...
@Service("str414skrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Str414skrvServiceImpl  extends TlabAbstractServiceImpl {
	@InjectLogger
	...
	public List<Map<String, Object>> selectList1(Map param) throws Exception {
		return super.commonDao.list("str414skrvServiceImpl.selectList1", param);
	}

	public List<Map<String, Object>> clipselect(Map param) throws Exception {
		return super.commonDao.list("str414skrvServiceImpl.clipselect", param);
	}

	public List<Map<String, Object>> clipselectsub(Map param) throws Exception {
		return super.commonDao.list("str414skrvServiceImpl.clipselectsub", param);
	}
	...
	public List<Map<String, Object>> clipselect_sh_main(Map param) throws Exception {
		return super.commonDao.list("str414skrvServiceImpl.clipselect_sh_main", param);
	}
	public List<Map<String, Object>> clipselect_sh_sub(Map param) throws Exception {
		return super.commonDao.list("str414skrvServiceImpl.clipselect_sh_sub", param);
	}
	...
	public void insertFax(Map paramMap) throws Exception {
		super.commonDao.insert("str414skrvServiceImpl.insertFaxMeta", paramMap);
		super.commonDao.insert("str414skrvServiceImpl.insertFaxMsg", paramMap);
	}
	...
	public String getReportFileInfo(Map param) throws Exception {
		return (String) super.commonDao.select("str414skrvServiceImpl.getReportFileInfo", param);
	}
}