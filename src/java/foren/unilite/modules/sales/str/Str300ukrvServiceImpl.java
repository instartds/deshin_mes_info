...
@Service("str300ukrvService")
public class Str300ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public List<Map> selectDetailList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("str300ukrvService.selectDetailList", param);
	}
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		try {			
			for(Map param : paramList )	{					
				 super.commonDao.update("str300ukrvService.insertDetail", param);
			}	
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {		
		 for(Map param :paramList )	{
			 super.commonDao.update("str300ukrvService.updateDetail", param);
		 }
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {		
		try {
			for(Map param :paramList )	{
				super.commonDao.delete("str300ukrvService.deleteDetail", param);						
			 }
		 }catch(Exception e){
	...
	public List<Map<String, Object>> selectExcelUploadSheet(Map param) throws Exception {
		...
		return super.commonDao.list("str300ukrvService.selectExcelUploadSheet", param);
	}
	...
	public void excelValidate(String jobID, Map param) throws Exception {
		...
		List<Map> getData = (List<Map>) super.commonDao.list("str300ukrvService.getData", param);
