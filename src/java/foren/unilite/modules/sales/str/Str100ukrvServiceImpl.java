...
@Service("str100ukrvService")
public class Str100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("str100ukrvServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("str100ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectRequestiList(Map param) throws Exception {
		return super.commonDao.list("str100ukrvServiceImpl.selectRequestiList", param);
	}
	...
	public List<Map<String, Object>> selectSalesOrderList(Map param) throws Exception {
		return super.commonDao.list("str100ukrvServiceImpl.selectSalesOrderList", param);
	}
	/**
	 * 
	 * 창고조회
	...
	public Object  deptWhcode(Map param) throws Exception {	
		...
		return  super.commonDao.select("str100ukrvServiceImpl.deptWhcode", param);
	}
	/**
	 * 출고정보 저장
...
//				param.put("PICK_STATUS", "");			
				param.put("data", super.commonDao.insert("str100ukrvServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("str100ukrvServiceImpl.spReceiving", spParam);
