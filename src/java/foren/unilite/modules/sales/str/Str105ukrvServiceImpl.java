...
@Service("str105ukrvService")
@SuppressWarnings({"unchecked", "rawtypes"})
public class Str105ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList (Map param) throws Exception {
		return super.commonDao.list("str105ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectList2 (Map param) throws Exception {
		return super.commonDao.list("str105ukrvServiceImpl.selectList2", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("str105ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectRequestiList(Map param) throws Exception {
		return super.commonDao.list("str105ukrvServiceImpl.selectRequestiList", param);
	}
	...
	public List<Map<String, Object>> selectSalesOrderList(Map param) throws Exception {
		return super.commonDao.list("str105ukrvServiceImpl.selectSalesOrderList", param);
	}
	...
	public Object  deptWhcode(Map param) throws Exception {	
		...
		return  super.commonDao.select("str105ukrvServiceImpl.deptWhcode", param);
	}
...
//				param.put("PICK_STATUS", "");			
				param.put("data", super.commonDao.insert("str105ukrvServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("str105ukrvServiceImpl.spReceiving", spParam);
...
//		    throw new  UniDirectValidateException(this.getMessage(messsage[0], user));
	...
	public List<Map<String, Object>> getFifo (Map param) throws Exception {
		...
		return super.commonDao.list("str105ukrvServiceImpl.getFifo", param);
	}
...
//		}
	...
	public List<Map<String, Object>>  clipselectsub(Map param) throws Exception {
		return  super.commonDao.list("str105ukrvServiceImpl.clipselectsub", param); 
	}
}
