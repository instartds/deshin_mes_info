...
@Service("str413skrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Str413skrvServiceImpl  extends TlabAbstractServiceImpl {
    @InjectLogger
	...
	public List<Map<String, Object>>  selectList1(Map param) throws Exception {
		return  super.commonDao.list("str413skrvServiceImpl.selectList1", param);
	}

	public List<Map<String, Object>>  clipselect(Map param) throws Exception {
		return  super.commonDao.list("str413skrvServiceImpl.clipselect", param);
	}

	public List<Map<String, Object>>  clipselectsub(Map param) throws Exception {
		return  super.commonDao.list("str413skrvServiceImpl.clipselectsub", param);
	}
	...
	public List<Map<String, Object>> clipselect_sh_main(Map param) throws Exception {
		return  super.commonDao.list("str413skrvServiceImpl.clipselect_sh_main", param);
	}
	public List<Map<String, Object>> clipselect_sh_sub(Map param) throws Exception {
		return  super.commonDao.list("str413skrvServiceImpl.clipselect_sh_sub", param);
	}
	...
	public void insertFax(Map paramMap) throws Exception {
		super.commonDao.insert("str413skrvServiceImpl.insertFaxMeta", paramMap);
		super.commonDao.insert("str413skrvServiceImpl.insertFaxMsg", paramMap);
	}
