...
@Service("str104ukrvService")
@SuppressWarnings({"unchecked", "rawtypes"})
public class Str104ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("str104ukrvServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("str104ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectRequestiList(Map param) throws Exception {
		return super.commonDao.list("str104ukrvServiceImpl.selectRequestiList", param);
	}
	...
	public List<Map<String, Object>> selectSalesOrderList(Map param) throws Exception {
		return super.commonDao.list("str104ukrvServiceImpl.selectSalesOrderList", param);
	}
	/**
	 *
	 * 창고조회
	...
	public Object  deptWhcode(Map param) throws Exception {
		...
		return  super.commonDao.select("str104ukrvServiceImpl.deptWhcode", param);
	}
	/**
	 * 출고정보 저장
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("str104ukrvServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("str104ukrvServiceImpl.spReceiving", spParam);
