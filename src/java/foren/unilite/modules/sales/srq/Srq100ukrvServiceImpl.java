...
@Service("srq100ukrvService")
public class Srq100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("srq100ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectReferList(Map param) throws Exception {
		return super.commonDao.list("srq100ukrvServiceImpl.selectReferList", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("srq100ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("srq100ukrvServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("srq100ukrvServiceImpl.selectRefList", param);
	}
...
//					Map checkReqSeq = (Map) super.commonDao.select("srq100ukrvServiceImpl.chkReqSeq",param);
//					if (ObjUtils.isNotEmpty(checkReqSeq)){
//						Map getMaxReqSeq = (Map) super.commonDao.select("srq100ukrvServiceImpl.getMaxReqSeq",param);
//						issReqSeq = Integer.parseInt(getMaxReqSeq.get("MAX_REQ_SEQ").toString());
//						param.put("ISSUE_REQ_SEQ", getMaxReqSeq);
//					}
//				}
				param.put("data", super.commonDao.insert("srq100ukrvServiceImpl.insertLogDetail", param));
			}
		}
		...
		super.commonDao.queryForObject("srq100ukrvServiceImpl.spSalesShipment", spParam);
