...
@Service("srq200ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Srq200ukrvServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());	

	/**
	 * 거래처출하품목등록 (srq200ukrv) 조회
	 * @param param
	 * @return
	 * @throws Exception
	 */
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("srq200ukrvServiceImpl.selectList", param);
	}

	/**
	 * 거래처출하품목등록 (srq200ukrv) 저장
	...
	public Integer insertDetail(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		try {
			for(Map param : paramList) {
				super.commonDao.insert("srq200ukrvServiceImpl.insertDetail", param);
			}
		} catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			super.commonDao.update("srq200ukrvServiceImpl.updateDetail", param);
		}
		return 0;
	}
	...
	public Integer deleteDetail(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		 for(Map param :paramList) {
			try {
				super.commonDao.update("srq200ukrvServiceImpl.deleteDetail", param);
			} catch(Exception e) {
