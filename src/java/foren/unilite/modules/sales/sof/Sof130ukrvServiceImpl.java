...
@Service("sof130ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Sof130ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map> selectList(Map param) throws Exception{
		return super.commonDao.list("sof130ukrvServiceImpl.selectList", param);
	}
...
//	}
	...
	public void updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )  {
			...
			super.commonDao.update("sof130ukrvServiceImpl.updateDetail", param);
