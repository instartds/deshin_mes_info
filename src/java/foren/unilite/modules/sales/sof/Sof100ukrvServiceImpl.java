...
@Service("sof100ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Sof100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectGsDvry(Map param) throws Exception {
		return super.commonDao.select("sof100ukrvServiceImpl.selectGsDvry", param);
	}
    ...
    public List<Map<String, Object>> fnExchgRateO(Map param) throws Exception {
        return super.commonDao.list("sof100ukrvServiceImpl.fnExchgRateO", param);
    }
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("sof100ukrvServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("sof100ukrvServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("sof100ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("sof100ukrvServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("sof100ukrvServiceImpl.selectEstiList", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("sof100ukrvServiceImpl.selectRefList", param);
	}

	/**
	 * 출하예정 참조 조회 - 20191231 추가
	 * @param param
	 * @return
	 * @throws Exception
	 */
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectRefReqList(Map param, LoginVO loginVO) throws Exception {
		...
		return super.commonDao.list("sof100ukrvServiceImpl.selectRefReqList", param);
	}
	...
	public List<Map<String, Object>> getCustCredit(Map param) throws Exception {
		return super.commonDao.list("sof100ukrvServiceImpl.getCustCredit", param);
	}
...
//		}
		...
		super.commonDao.insert("sof100ukrvServiceImpl.insertLogMaster", dataMaster);
		...
		super.commonDao.queryForObject("sof100ukrvServiceImpl.spSalesOrder", spParam);
	...
	public ExtDirectFormPostResult syncForm(Sof100ukrvModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {
...
//		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("sof100ukrvServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(Sof100ukrvModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);

		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("sof100ukrvServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("sof100ukrvServiceImpl.updateMaster", paramMap);
		}

		super.commonDao.update("sof100ukrvServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(Sof100ukrvModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag")))){
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("sof100ukrvServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("sof100ukrvServiceImpl.insertDetail", param);
		}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("sof100ukrvServiceImpl.updateDetail", param);
		}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("sof100ukrvServiceImpl.checkSSA110", param);
		        if(ObjUtils.isEmpty(checkListSSA110))	{
		        	...
		        	for(Map<String, Object> checkSSA110 : checkListSSA110)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("sof100ukrvServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("sof100ukrvServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("sof100ukrvServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("sof100ukrvServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("sof100ukrvServiceImpl.checkDeleteAllDetail", params.get(0));
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("sof100ukrvServiceImpl.checkEstimate", param);

		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{
						super.commonDao.update("sof100ukrvServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("sof100ukrvServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("sof100ukrvServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("sof100ukrvServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("sof100ukrvServiceImpl.checkProgressDetail", param);
		}
    ...
    public List<Map> selectExcelUploadSheet1(Map param) throws Exception {
    	...
    	List<Map> excelUploadMapList = super.commonDao.list("sof100ukrvServiceImpl.selectExcelUploadSheet1", param);
	...
	public void excelValidate(String jobID, Map param) {
		...
		super.commonDao.update("sof100ukrvServiceImpl.excelValidate", param);
	}

	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.FORM_LOAD)
	public Object checkOfferNo(Map param) throws Exception {
		return super.commonDao.select("sof100ukrvServiceImpl.checkOfferNo", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.FORM_LOAD)
	public Object checkUpnCode(Map param) throws Exception {
		return super.commonDao.select("sof100ukrvServiceImpl.checkUpnCode", param);
	}
	...
	public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
		...
		return super.commonDao.list("sof100ukrvServiceImpl.getFileList", param);
	}
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public int insertSOF102(Map param, LoginVO login) throws Exception {
		...
		String[] fids =  ObjUtils.getSafeString(param.get("ADD_FIDS")).split(",");
		 ...
		 for(String fid : fids)	{
			 param.put("FID", fid);
			 insRtn += super.commonDao.insert("sof100ukrvServiceImpl.insertSOF102", param);
		 }
	...
	public void deleteSOF102(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("DEL_FIDS")).split(",");
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.update("sof100ukrvServiceImpl.deleteSOF102", param);
			 }
	}
	...
	public List<Map<String, Object>>  receiveSRM (Map param) throws Exception {
		return  super.commonDao.list("sof100ukrvServiceImpl.receiveSRM", param);
	}
	...
	public String soToPoRequest (Map param, LoginVO user) throws Exception {
		...
		super.commonDao.queryForObject("sof100ukrvServiceImpl.soToPoRequest", spParam);
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));
		if(!ObjUtils.isEmpty(errorDesc)){
	...
	public Object selectDocCnt(Map param) throws Exception {
		return super.commonDao.select("sof100ukrvServiceImpl.selectDocCnt", param);
	}
    ...
    public List<Map<String, Object>> getSupplyType(Map param) throws Exception {
        return super.commonDao.list("sof100ukrvServiceImpl.getSupplyType", param);
    }
	...
	public Object insertPurchaseRequest(Map spParam, LoginVO user) throws Exception {
		//1.구매요청정보 존재여부 체크
		Map existPurchaseOrder = (Map) super.commonDao.select("sof100ukrvServiceImpl.checkPurchaseOrder", spParam);
		...
		spParam.put("LangCode"	, user.getLanguage());
		//3.로그테이블에 insert
		super.commonDao.update("sof100ukrvServiceImpl.insertLogPurchaseOrder", spParam);
		//4.SP 호출
		super.commonDao.update("sof100ukrvServiceImpl.callMakePurchaseOrder", spParam);
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));
		if(!ObjUtils.isEmpty(errorDesc)){
