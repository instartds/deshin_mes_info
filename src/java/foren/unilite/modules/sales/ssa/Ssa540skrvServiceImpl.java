...
@Service("ssa540skrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Ssa540skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList1(Map param) throws Exception {
		return (List) super.commonDao.list("ssa540skrvServiceImpl.selectList1", param);
	}
	...
	public List<Map<String, Object>>  printList(Map param) throws Exception {
		...
		return  super.commonDao.list("ssa540skrvServiceImpl.printList", param);
	}
}