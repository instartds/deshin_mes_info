...
@Service("ssa700ukrvService")
public class Ssa700ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectSendBillMaster(Map param) throws Exception {
		...
		return super.commonDao.list("ssa700ukrvServiceImpl.selectSendBillMaster", param);
	}
	...
	public List<Map<String, Object>> selectWebCashMaster(Map param) throws Exception {
		return super.commonDao.list("ssa700ukrvServiceImpl.selectWebCashMaster", param);
	}

	/**
	 * 전자세금계산서 저장(Send Bill)
	 * @param paramList
	 * @param paramMaster
	 * @param user
	 * @return
	...
	public List<Map> saveAllSendBill(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		
		List<Map> dataList = new ArrayList<Map>();
		if(paramList != null)	{
			for(Map param: paramList) {
				dataList = (List<Map>)param.get("data");
				if(param.get("method").equals("saveSendBill")) {
					param.put("data", saveSendBill(dataList, user) );	
				} 
			}
		}	
	...
	public List<Map>  saveSendBill(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			String keyValue = getLogKey();	
			param.put("KEY_VALUE", keyValue);			
			super.commonDao.update("ssa700ukrvServiceImpl.saveSendBill", param);	
			super.commonDao.update("ssa700ukrvServiceImpl.execSendBill", param);
		...
		if(paramList != null)	{
			for(Map param: paramList) {
				...
				if(param.get("method").equals("saveWebCash")) {
					param.put("data", saveWebCash(dataList, user) );	
				} 
			}
		}	
		paramList.add(0, paramMaster);
	...
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public List<Map>  saveWebCash(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			String keyValue = getLogKey();	
			param.put("KEY_VALUE", keyValue);			
			super.commonDao.update("ssa700ukrvServiceImpl.saveWebCash", param);	
			super.commonDao.update("ssa700ukrvServiceImpl.execWebCash", param);
			String errorDesc = ObjUtils.getSafeString(param.get("ErrorDesc"));
			if(ObjUtils.isNotEmpty(errorDesc)){				
				String messsage = errorDesc.replaceAll("\\;", "");
				throw new  UniDirectValidateException(this.getMessage(messsage, user));
	...
	public Object getErrMsg(Map param) throws Exception {
		return super.commonDao.select("ssa700ukrvServiceImpl.getErrMsg", param);
	}
	...
	public List<Map<String, Object>> getSalesPrsn(Map param) throws Exception {
		return super.commonDao.list("ssa700ukrvServiceImpl.getSalesPrsn", param);
	}
	...
	public List<Map<String, Object>> selectBillReferList(Map param) throws Exception {
		return super.commonDao.list("ssa700ukrvServiceImpl.selectBillReferList", param);
	}
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("ssa700ukrvServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("ssa700ukrvServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("ssa700ukrvServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("ssa700ukrvServiceImpl.selectRefList", param);
	}
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("ssa700ukrvServiceImpl.insertLogDetail", param);
		}		
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("ssa700ukrvServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(Ssa700ukrvModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);
		
		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("ssa700ukrvServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("ssa700ukrvServiceImpl.updateMaster", paramMap);
		}
		
		super.commonDao.update("ssa700ukrvServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(Ssa700ukrvModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("ssa700ukrvServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("ssa700ukrvServiceImpl.insertDetail", param);
		}		
	...
	public List<Map> insertDetails(List<Map> params, Map<String,  Object> paramMap, LoginVO user) throws Exception {
		for(Map param: params)		{
			param.put("ORDER_NUM", paramMap.get("ORDER_NUM")); //master 의 세금계산서번호
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("ssa700ukrvServiceImpl.updateDetail", param);
		}		
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if("N".equals(orderStatus) && "Y".equals(param.get("ORDER_STATUS")))	{
	        	if((orderQ + returnQ - outStockQ) == 0 )	{
	        		throw new  UniDirectValidateException(this.getMessage("54440", user));	// 54440:해당 세금계산서건에 대해 강제마감할 자료가 없습니다.(완납) 
	        	}
	        }
	        
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("ssa700ukrvServiceImpl.checkSSA110", param);
		        if(ObjUtils.isEmpty(checkListSSA110))	{
		        	...
		        	for(Map<String, Object> checkSSA110 : checkListSSA110)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("ssa700ukrvServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("ssa700ukrvServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("ssa700ukrvServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("ssa700ukrvServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("ssa700ukrvServiceImpl.checkDeleteAllDetail", params.get(0)); 
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("ssa700ukrvServiceImpl.checkEstimate", param);
		
		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{					
						super.commonDao.update("ssa700ukrvServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	/**
	 * 견적확정정보 조회 & 견적정보 Update - 세금계산서정보 Detail 저장시 사용
	 * @param param
	 * @return
	 * @throws Exception
	 */
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("ssa700ukrvServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("ssa700ukrvServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{	
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("ssa700ukrvServiceImpl.updateSCM", scmParam);
						}
	...
	/**
	 * 세금계산서등록(SCM연계) 사용여부 값 조회
	 * @param param
	 * @return
	 * @throws Exception
	 */
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkStatus", param);
		String r = "";
		if(!ObjUtils.isEmpty(obj))	{
			r = ObjUtils.getSafeString(obj.get("STATUS"));
			if(!"1".equals(r) && !"5".equals(r) )	{
				throw new  UniDirectValidateException(this.getMessage("55442", user));	/* 55442:세금계산서승인이 진행된 건은 수정/삭제할 수 없습니다.*/
			}
		}
	}
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("ssa700ukrvServiceImpl.checkProgressDetail", param);
		}
		...
		if(ObjUtils.isEmpty(obj))	{
			...
			if(ObjUtils.parseInt(obj.get("ISSUE_REQ_Q")) > 0)	{
				throw new  UniDirectValidateException(this.getMessage("54460", user));	/* 54460:출하지시가 진행중인 세금계산서내역을 수정/삭제할 수 없습니다.*/
			}
			
			if(ObjUtils.parseInt(obj.get("SALE_Q")) > 0)	{
				throw new  UniDirectValidateException(this.getMessage("54412", user));	/* 54460:출고가 진행중인 세금계산서내역은 삭제가 불가능합니다.(세금계산서내역 삭제시)*/
			}
			
			if(ObjUtils.parseInt(obj.get("RETURN_Q")) > 0)	{
				throw new  UniDirectValidateException(this.getMessage("54446", user));	/* 54446:반품이 진행된 세금계산서내역은 삭제할 수 없습니다.*/
			}
		}
	}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("ssa700ukrvServiceImpl.selectExcelUploadSheet1", param);
    }
	...
	public List<Map<String, Object>>  getGsBillYN(Map param) throws Exception {	
		return  super.commonDao.list("ssa700ukrvServiceImpl.getGsBillYN", param); 
	}
