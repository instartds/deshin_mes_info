...
@Service("ssa453skrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Ssa453skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList1(Map param) throws Exception {
		return (List) super.commonDao.list("ssa453skrvServiceImpl.selectList1", param);
	}
	...
	public List<Map<String, Object>>  printList(Map param) throws Exception {
		...
		return  super.commonDao.list("ssa453skrvServiceImpl.printList", param);
	}
}