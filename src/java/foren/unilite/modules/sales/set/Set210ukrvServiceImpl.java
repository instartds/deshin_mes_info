...
@Service("set210ukrvService")
public class Set210ukrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectMaster(Map param) throws Exception {
		if("child".equals(param.get("OP_FLAG"))){
			return  super.commonDao.list("set210ukrvServiceImpl.selectComponseGen1", param);
		}
		return  super.commonDao.list("set210ukrvServiceImpl.selectMaster", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "set")
	public List<Map<String, Object>>  selectMaster2(Map param) throws Exception {
		if("child".equals(param.get("OP_FLAG"))){
			return  super.commonDao.list("set210ukrvServiceImpl.selectComponseGen2", param);
		}
		return  super.commonDao.list("set210ukrvServiceImpl.selectMaster2", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "set")
	public List<Map<String, Object>>  selectWorkNoMaster(Map param) throws Exception {
		return  super.commonDao.list("set210ukrvServiceImpl.selectWorkNoMaster", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "set")
	public Object  selectStockQty(Map param) throws Exception {
		return  super.commonDao.select("set210ukrvServiceImpl.selectStockQty", param);
	}
	...
	public Object selectAverageP(Map param) throws Exception {
		...
		return  super.commonDao.select("set210ukrvServiceImpl.selectAverageP", param);
	}
			  ...
			  for(Map param: dataList) {
				  if(addAssembleFlag){
					  ...
					  if(!ObjUtils.isEmpty(paramMasterData.get("WORK_NUM"))){
						  ...
						  super.commonDao.insert("set210ukrvServiceImpl.updateLogDetail", newMap);
					  }else{
						  newMap.put("KEY_VALUE", keyValue);
						  newMap.put("OPR_FLAG", "N");
						  super.commonDao.insert("set210ukrvServiceImpl.insertLogDetail", newMap);
					  }
				  ...
				  if("N".equals(oprFlag) || "D".equals(oprFlag)){
					  param.put("data", super.commonDao.insert("set210ukrvServiceImpl.insertLogDetail", param));
				  }else{
					  param.put("data", super.commonDao.insert("set210ukrvServiceImpl.updateLogDetail", param));
				  }
			  }
		  }
