...
@Service("sco170skrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Sco170skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  getColumn(Map param) throws Exception {
		return super.commonDao.list("sco170skrvServiceImpl.getColumn", param);
	}
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return super.commonDao.list("sco170skrvServiceImpl.selectList", param);
	}
}
