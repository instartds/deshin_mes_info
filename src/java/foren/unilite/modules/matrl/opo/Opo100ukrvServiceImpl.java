...
@Service("opo100ukrvService")
public class Opo100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("opo100ukrvServiceImpl.selectMpoList", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("opo100ukrvServiceImpl.selectDetailList", param);		/* 검색 */
	}
	...
	public List<Map<String, Object>> selectOrderNumList(Map param) throws Exception {
		return super.commonDao.list("opo100ukrvServiceImpl.selectOrderNumList", param);
	}
    ...
    public List<Map<String, Object>> selectMre100tList(Map param) throws Exception {
        return super.commonDao.list("opo100ukrvServiceImpl.selectMre100tList", param);
    }
    ...
    public List<Map<String, Object>> selectGwData(Map param) throws Exception {
        return super.commonDao.list("opo100ukrvServiceImpl.selectGwData", param);
    }
    ...
    public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
        return super.commonDao.list("opo100ukrvServiceImpl.makeDraftNum", param);
    }
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.queryForObject("opo100ukrvServiceImpl.spPurchaseOutOrder", spParam);
