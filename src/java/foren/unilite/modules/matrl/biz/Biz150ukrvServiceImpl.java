...
@Service("Biz150ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Biz150ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public Object  YyyymmSet(Map param) throws Exception {
		return  super.commonDao.select("Biz150ukrvService.Yyyymm", param);	// 자동 날짜 지정
	}
	...
	public List<Map>  selectMaster(Map param) throws Exception {
		...
		return  super.commonDao.list("Biz150ukrvService.selectList", param);	// 실행하기 전 조회
	}
	...
	public Object excuteStockAdjust(Map param, LoginVO user) throws Exception {			// SP 로 실행
		//Object r = super.commonDao.queryForObject("Biz150ukrvService.execStockAdjust", param);
		super.commonDao.queryForObject("Biz150ukrvService.execStockAdjust", param);
...
//사용 안 함
	...
	public Object insertMaster(Map param, LoginVO user) throws Exception {			// SQL 로 실행
		Object r = super.commonDao.queryForObject("Biz150ukrvService.insertDetail", param);
	...
	public Object deleteMaster(Map param, LoginVO user) throws Exception {
		Object r = super.commonDao.queryForObject("Biz150ukrvService.deleteDetail", param);
		Map<String, Object>	rMap = (Map<String, Object>) r;
		if(!"".equals(rMap.get("ERROR_CODE")))	{
			String[] sErr = rMap.get("ERROR_CODE").toString().split(";");
			throw new UniDirectValidateException(this.getMessage(sErr[0], user));
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user, String cellFlagYN) throws Exception {
		try {
			...
			List<Map> chkList = (List<Map>) super.commonDao.list("Biz150ukrvService.checkCompCode", compCodeMap);
			for(Map param : paramList )	{
				for(Map checkCompCode : chkList) {
					 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
					 param.put("CELL_FLAG_YN", cellFlagYN);
					 super.commonDao.insert("Biz150ukrvService.insertDetail", param);
				}
			}
		}catch(Exception e){
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		Map compCodeMap = new HashMap();
		compCodeMap.put("S_COMP_CODE", user.getCompCode());
		List<Map> chkList = (List) super.commonDao.list("Biz150ukrvService.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 super.commonDao.update("Biz150ukrvService.deleteDetail", param);
			 }
		 }
		 return 0;
	}
