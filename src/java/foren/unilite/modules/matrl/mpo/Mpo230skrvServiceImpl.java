...
@Service("mpo230skrvService")
public class Mpo230skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		...
		return  super.commonDao.list("mpo230skrvServiceImpl.selectList", param);
	}
...
//				super.commonDao.update("bpr101ukrvService.bpr200tUpdateDetail", param);
	...
	public List<Map> insertSend(List<Map> paramList) throws Exception {		
		for(Map param : paramList)	{
			super.commonDao.queryForObject("mpo230skrvServiceImpl.insert", param);
		}
		return  paramList;
	}
}
