...
@Service("mpo502ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Mpo502ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectOrderPrsn(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectOrderPrsn", param);
	}
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("mpo502ukrvServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectList2", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectOrderNumMasterList", param);
	}
	 ...
	 */
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectOrderNumDetail(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList2(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectOrderNumMasterList2", param);
	}
	...
	public List<Map<String, Object>> selectMrp400tList(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectMrp400tList", param);
	}
	...
	public Object  callInspecyn(Map param) throws Exception {
		...
		return  super.commonDao.select("mpo502ukrvServiceImpl.callInspecyn", param);
	}
	/**
	 *
	 *  구매담당 선택시 승인자 가져옴
	...
	public Object  userName(Map param) throws Exception {
		...
		return  super.commonDao.select("mpo502ukrvServiceImpl.userName", param);
	}
	...
	public Object  userWhcode(Map param) throws Exception {
		...
		return  super.commonDao.select("mpo502ukrvServiceImpl.userWhcode", param);
	}
	...
	public Object  fnOrderPrice(Map param) throws Exception {
		...
		return  super.commonDao.select("mpo502ukrvServiceImpl.fnOrderPrice", param);
	}
	/**
	 *
	 * 품질검사여부 관련 (부서별)
	...
	public Object  callDeptInspecFlag(Map param) throws Exception {
		...
		return  super.commonDao.select("mpo502ukrvServiceImpl.callDeptInspecFlag", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("mpo502ukrvServiceImpl.insertLogMaster", dataMaster);
		...
		if ("4".equals(dataMaster.get("ORDER_TYPE"))){  // 외주
			super.commonDao.queryForObject("mpo502ukrvServiceImpl.spPurchaseOutOrder", spParam);
		} else {
			super.commonDao.queryForObject("mpo502ukrvServiceImpl.spPurchaseOrder", spParam);
		}
...
//		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)	{
			...
			if(!oprFlag.equals("D")){
				super.commonDao.update("mpo502ukrvServiceImpl.insertBpr400t", param);
			}
			super.commonDao.insert("mpo502ukrvServiceImpl.insertLogDetail", param);
		}
		return params;
	}
	/**
	...
	public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectExcelUploadSheet1", param);
	}

	public void excelValidate(String jobID, Map param) {							// 엑셀 Validate
		logger.debug("validate: {}", jobID);
		super.commonDao.update("mpo502ukrvServiceImpl.excelValidate", param);
	}

	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> mainReport(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.mainReport", param);
	}

	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> subReport(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.subReport", param);
	}
	...
	public List<Map<String, Object>> selectOrderList(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectOrderList", param);
	}
	...
	public List<Map<String, Object>> selectOrderHistoryList(Map param) throws Exception {
		return super.commonDao.list("mpo502ukrvServiceImpl.selectOrderHistoryList", param);
	}
}
