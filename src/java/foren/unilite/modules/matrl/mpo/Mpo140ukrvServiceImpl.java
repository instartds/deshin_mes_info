...
@Service("mpo140ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Mpo140ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map> selectList(Map param) throws Exception{
		return super.commonDao.list("mpo140ukrvServiceImpl.selectList", param);
	}
...
//			super.commonDao.insert("mpo140ukrvServiceImpl.insertDetail", param);
//		}
//		return;
//	}
	...
	public void updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )  {
			...
			super.commonDao.update("mpo140ukrvServiceImpl.updateDetail", param);
...
//		 for(Map param :paramList ) {
//			 super.commonDao.delete("mpo140ukrvServiceImpl.deleteDetail", param);
//		 }
//		 return;
//	}
