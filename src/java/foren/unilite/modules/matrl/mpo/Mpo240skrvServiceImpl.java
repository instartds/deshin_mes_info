...
@Service("mpo240skrvService")
public class Mpo240skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		...
		return  super.commonDao.list("mpo240skrvServiceImpl.selectList", param);
	}
...
//				super.commonDao.update("bpr101ukrvService.bpr200tUpdateDetail", param);
	...
	public List<Map> insertSend(List<Map> paramList) throws Exception {		
		for(Map param : paramList)	{
			super.commonDao.queryForObject("mpo240skrvServiceImpl.insert", param);
		}
		return  paramList;
	}
}
