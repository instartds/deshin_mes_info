...
@Service("mpo501ukrvService")
public class Mpo501ukrvServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectOrderPrsn(Map param) throws Exception {
        return super.commonDao.list("mpo501ukrvServiceImpl.selectOrderPrsn", param);
    }
    ...
    public Object selectMaster(Map param) throws Exception {
        return super.commonDao.select("mpo501ukrvServiceImpl.selectMaster", param);
    }
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("mpo501ukrvServiceImpl.selectList", param);
	}
    ...
    public List<Map<String, Object>> selectList2(Map param) throws Exception {
        return super.commonDao.list("mpo501ukrvServiceImpl.selectList2", param);
    }
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("mpo501ukrvServiceImpl.selectOrderNumMasterList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList2(Map param) throws Exception {
		return super.commonDao.list("mpo501ukrvServiceImpl.selectOrderNumMasterList2", param);
	}
    ...
    public List<Map<String, Object>> selectMre100tList(Map param) throws Exception {
        return super.commonDao.list("mpo501ukrvServiceImpl.selectMre100tList", param);
    }
	...
	public Object  callInspecyn(Map param) throws Exception {	
		...
		return  super.commonDao.select("mpo501ukrvServiceImpl.callInspecyn", param);
	}
	/**
	 * 
	 *  구매담당 선택시 승인자 가져옴
	...
	public Object  userName(Map param) throws Exception {	
		...
		return  super.commonDao.select("mpo501ukrvServiceImpl.userName", param);
	}
	...
	public Object  userWhcode(Map param) throws Exception {	
		...
		return  super.commonDao.select("mpo501ukrvServiceImpl.userWhcode", param);
	}
/*	*//**
	 * 
	 *  userID에 따른 납품창고 
	...
	public Object  ref1(Map param) throws Exception {	
		...
		return  super.commonDao.select("mpo501ukrvServiceImpl.ref1", param);
	}*/
	/**
	 * 단가 조회
	 * @param param
	...
	public Object  fnOrderPrice(Map param) throws Exception {	
		...
		return  super.commonDao.select("mpo501ukrvServiceImpl.fnOrderPrice", param);
	}
	/**
	 * 
	 * 품질검사여부 관련 (부서별)
	...
	public Object  callDeptInspecFlag(Map param) throws Exception {	
		...
		return  super.commonDao.select("mpo501ukrvServiceImpl.callDeptInspecFlag", param);
	}
	 /**
	   *
	   * 금형외주가공의뢰참조
	  ...
	  public List<Map<String, Object>> selectRequestRegList(Map param) throws Exception {
	      return super.commonDao.list("mpo501ukrvServiceImpl.selectRequestRegList", param);
	  }
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("mpo501ukrvServiceImpl.insertLogMaster", param));
			}
		}
...
*/
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.queryForObject("mpo501ukrvServiceImpl.spPurchaseOrder", spParam);
...
/**
 ...
 public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
     return super.commonDao.list("mpo501ukrvServiceImpl.selectExcelUploadSheet1", param);
 }
 
	public void excelValidate(String jobID, Map param) {
	    logger.debug("validate: {}", jobID);
		super.commonDao.update("mpo501ukrvServiceImpl.excelValidate", param);
	}
}
