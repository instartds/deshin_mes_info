...
@Service("mpo210skrvService")
public class Mpo210skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		if("1".equals(param.get("TYPE"))){
			return  super.commonDao.list("mpo210skrvServiceImpl.selectList1", param);
		}
		return  super.commonDao.list("mpo210skrvServiceImpl.selectList", param);
	}
...
//				super.commonDao.update("bpr101ukrvService.bpr200tUpdateDetail", param);
	...
	public List<Map> insertSend(List<Map> paramList) throws Exception {		
		for(Map param : paramList)	{
			super.commonDao.queryForObject("mpo210skrvServiceImpl.insert", param);
		}
		return  paramList;
	}
}
