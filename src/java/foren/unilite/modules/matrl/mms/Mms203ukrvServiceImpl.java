...
@Service("mms203ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Mms203ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectExpirationdate(Map param) throws Exception {
		return super.commonDao.select("mms203ukrvServiceImpl.selectExpirationdate", param);
	}
	/**
	 * 검사등록 -> 검사내역조회
	 */
	...
	public List<Map<String, Object>> selectList1(Map param) throws Exception {
		return super.commonDao.list("mms203ukrvServiceImpl.selectList1", param);
	}
	...
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return super.commonDao.list("mms203ukrvServiceImpl.selectList2", param);
	}
	...
	public List<Map<String, Object>> selectreceiptList(Map param) throws Exception {
		return super.commonDao.list("mms203ukrvServiceImpl.selectreceiptList", param);
	}
	...
	public List<Map<String, Object>> selectreceiptNumMasterList(Map param) throws Exception {
		return super.commonDao.list("mms203ukrvServiceImpl.selectreceiptNumMasterList", param);
	}
	...
	public List<Map<String, Object>> selectTestListNew(Map param) throws Exception {
		return super.commonDao.list("mms203ukrvServiceImpl.selectTestListNew", param);
	}		
...
//		List<List<Map>> resultList = new ArrayList<List<Map>>();
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				param.put("data", super.commonDao.insert("mms203ukrvServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("mms203ukrvServiceImpl.spMms203ukrv", spParam);
		...
		if(!ObjUtils.isEmpty(errorDesc)){
		    ...
		    throw new  UniDirectValidateException(this.getMessage(messsage[0], user));
				...
				//자동입고 사용 여부 가져오기
				autoInputChk = (int) super.commonDao.select("mms203ukrvServiceImpl.autoInputCheck", autoInputParam);
				//자동입고 사용시
				if(autoInputChk > 0){
					...
					for(Map paramData: paramList) {
						...
						if(oprFlag2.equals("N") || oprFlag2.equals("U")){
								...
								for(Map masterParam:  dataList2) {
										...
										//1-1발주유형이 외주가 아닌 건에대하여 기존에 수불내역이 있으면 삭제
												autoInputBeforeDeleteList = super.commonDao.list("mms203ukrvServiceImpl.selectAutoInputBeforeDeletetList", autoInputParam);
											...
											//2-1발주유형이 외주인 건 수불내역의 삭제할 건 조회
												autoInputBeforeDeleteOutList = super.commonDao.list("mms203ukrvServiceImpl.selectAutoInputBeforeDeletetOutList", autoInputParam);
											...
											//3.자동입고(외주가 아닌 것)
												autoInputList = 	super.commonDao.list("mms203ukrvServiceImpl.selectAutoInputList", autoInputParam);
							...
							//									throw new  UniDirectValidateException("입고유형이 금액보정이 아닐때  구매단가가 0 이거나 0보다 작을 수 없습니다.");
											...
											if(! ObjUtils.getSafeString(dataMaster.get("GOOD_WH_CODE")).equals(ObjUtils.getSafeString(dataMaster.get("BAD_WH_CODE")))){
												autoInputBadList = super.commonDao.list("mms203ukrvServiceImpl.selectAutoInputBadList", autoInputParam);
											...
											//4.자동입고 (외주)
											autoInputOutList = 	super.commonDao.list("mms203ukrvServiceImpl.selectAutoInputOutList", autoInputParam);
						...
						//									throw new  UniDirectValidateException("입고유형이 금액보정이 아닐때  구매단가가 0 이거나 0보다 작을 수 없습니다");
											...
											if(! ObjUtils.getSafeString(dataMaster.get("GOOD_WH_CODE")).equals(ObjUtils.getSafeString(dataMaster.get("BAD_WH_CODE")))){
												autoInputBadOutList = super.commonDao.list("mms203ukrvServiceImpl.selectAutoInputOutBadList", autoInputParam);
	...
	List<Map> dataList = new ArrayList<Map>();
       for(Map paramData: paramList) {
			...
			String oprFlag = "N";
			if(paramData.get("method").equals("deleteBad"))  oprFlag="D";			
			...
			if(paramData.get("method").equals("deleteBad")) {//디테일 내역 삭제시
				for(Map param:  dataList) {
					...
					super.commonDao.delete("mms203ukrvServiceImpl.deleteQms2102", param);
				}
			}else{
				for(Map param:  dataList) {
					...
					if(oprFlag != "D") {
						if("N".equals(param.get("SAVE_FLAG"))) {
							...
							param.put("DIV_CODE", dataMaster.get("DIV_CODE"));
							param.put("S_USER_ID", user.getUserID());
							super.commonDao.insert("mms203ukrvServiceImpl.insertQms210", param);
						} else {
							oprFlag = "U";
							//수정건에 대한 처리
							param.put("S_USER_ID", user.getUserID());
							super.commonDao.update("mms203ukrvServiceImpl.updateQms210", param);
...
//					}
				...
				//super.commonDao.update("Mms203ukrvServiceImpl.updateQms200", dataMaster);
				//샘플검사에 해당
				...
				if(StringUtils.isNotBlank(sInspecNum)){
					...
					//super.commonDao.update("Mms203ukrvServiceImpl.updateQms200AndQms100", dataMaster);
				}
			}
		}
        paramList.add(0, paramMaster);
	...
	public List<Map<String, Object>>  inspecQtyCheck(Map param) throws Exception {
		return  super.commonDao.list("mms203ukrvServiceImpl.inspecQtyCheck", param);
	}
	/**
	 * 표준검사항목 저장
	 * @throws Exception
	...
	public List<Map> copyAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.delete("mms203ukrvServiceImpl.testcodeDelete", dataMaster);
	...
	public List<Map> testcodeCopy(List<Map> params, LoginVO user) throws Exception {
		...
		for(Map param: params)		{
			super.commonDao.insert("mms203ukrvServiceImpl.testcodeCopy", param);
		}
		return params;
	}	
