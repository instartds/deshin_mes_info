...
@Service("mms512ukrvService")
public class Mms512ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectExpirationdate(Map param) throws Exception {
		return super.commonDao.select("mms512ukrvServiceImpl.selectExpirationdate", param);
	}
	/**
	 * 입고등록(SP+통합)-> 입고내역 조회
	 */
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("mms512ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectinoutNoMasterList(Map param) throws Exception {
		return super.commonDao.list("mms512ukrvServiceImpl.selectinoutNoMasterList", param);
	}
	...
	public List<Map<String, Object>> selectnoReceiveList(Map param) throws Exception {
		return super.commonDao.list("mms512ukrvServiceImpl.selectnoReceiveList", param);
	}
	...
	public List<Map<String, Object>> selectreturnPossibleList(Map param) throws Exception {
		return super.commonDao.list("mms512ukrvServiceImpl.selectreturnPossibleList", param);
	}
	...
	public List<Map<String, Object>> selectScmRefList(Map param) throws Exception {
		return super.commonDao.list("mms512ukrvServiceImpl.selectScmRefList", param);
	}
	...
	public List<Map<String, Object>> selectinspectResultList(Map param) throws Exception {
		...
		if(ObjUtils.getSafeString(param.get("WINDOW_FLAG")).equals("inspectResult")){	// 검사결과
			resultList = super.commonDao.list("mms512ukrvServiceImpl.selectinspectResultList1", param);
		}else{ // 무검사
			resultList = super.commonDao.list("mms512ukrvServiceImpl.selectinspectResultList2", param);
		}
		return resultList;
	}
	...
	public Object  fnOrderPrice(Map param) throws Exception {
		return  super.commonDao.select("mms512ukrvServiceImpl.fnOrderPrice", param);
	}
	...
	public Object userWhcode(Map param) throws Exception {
		return  super.commonDao.select("mms512ukrvServiceImpl.userWhcode", param);
	}
	...
	public Object fnGetCalcTaxAmt(Map param) throws Exception {
		return  super.commonDao.select("mms512ukrvServiceImpl.fnGetCalcTaxAmt", param);
	}
	...
	public Object  taxType(Map param) throws Exception {
		return  super.commonDao.select("mms512ukrvServiceImpl.taxType", param);
	}
...
//						throw new  UniDirectValidateException("입고유형이 금액보정이 아닐때  구매단가가 0 이거나 0보다 작을 수 없습니다.");
						...
						param.put("data", super.commonDao.insert("mms512ukrvServiceImpl.insertLogDetail", param));
					}
				}else{
					if("N".equals(oprFlag) || "D".equals(oprFlag)){
						param.put("data", super.commonDao.insert("mms512ukrvServiceImpl.insertLogDetail", param));
					}else{
						param.put("data", super.commonDao.insert("mms512ukrvServiceImpl.updateLogDetail", param));
					}
				}
			}
		}
	    ...
	    super.commonDao.queryForObject("mms512ukrvServiceImpl.spReceiving", spParam);
...
//			dataMaster.put("INOUT_NUM", "");
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("mms512ukrvServiceImpl.insertDetail", param);
		}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("mms512ukrvServiceImpl.updateDetail", param);
		}
		return params;
	}
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("mms512ukrvServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("mms512ukrvServiceImpl.checkDeleteAllDetail", params.get(0));
	}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("mms512ukrvServiceImpl.checkSSA110", param);
		        if(ObjUtils.isEmpty(checkListSSA110))	{
		        	...
		        	for(Map<String, Object> checkSSA110 : checkListSSA110)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("mms512ukrvServiceImpl.updateBTR100", paramSRQ100);
		        		}
		        	}
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("mms512ukrvServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("mms512ukrvServiceImpl.updateSRQ100", paramSRQ100);
		        		}
		        	}
		        }
	        }
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("mms512ukrvServiceImpl.checkEstimate", param);

		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkEstimateConfirm", params.get(0));
			...
			if(!ObjUtils.isEmpty(cfrmData))	{
				...
				for(Map<String, Object> estiParam : params)	{
					super.commonDao.update("mms512ukrvServiceImpl.updateEstimateConfirm", estiParam);
				}
			}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
		Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkEstiDetail", param);
		if(!ObjUtils.isEmpty(cfrmData))	{
			if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
				throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
			}
			...
			super.commonDao.update("mms512ukrvServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("mms512ukrvServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("mms512ukrvServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("mms512ukrvServiceImpl.checkProgressDetail", param);
		}
	...
	public List<Map<String, Object>>  mainReport_label(Map param) throws Exception {
		return  super.commonDao.list("mms512ukrvServiceImpl.mainReport_label", param);
	}
	...
	public List<Map<String, Object>>  mainReport_label_afterProg(Map param) throws Exception {
		return  super.commonDao.list("mms512ukrvServiceImpl.mainReport_label_afterProg", param);
	}
}
