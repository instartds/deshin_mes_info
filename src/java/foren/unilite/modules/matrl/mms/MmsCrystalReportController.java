...
@Controller
public class MmsCrystalReportController extends UniliteCommonController {
	 @InjectLogger
	 ...
	 protected TlabAbstractDAO dao;
		...
		@RequestMapping(value = "/matrl/mms200crkrv.do", method = RequestMethod.GET)
		public ModelAndView mms200crkrvPrint(ExtHtttprequestParam _req, LoginVO user,
			...
			String sql = "";
			try {
				sql = dao.mappedSqlString("mms200rkrvServiceImpl.printList", param);
			...
			clientDoc.setPrintFileName("mms200crkrv");
			clientDoc.setReportType(reportType);
			return ViewHelper.getCrystalReportView(clientDoc);
		}

		@RequestMapping(value = "/matrl/mms210crkrv.do", method = RequestMethod.GET)
		public ModelAndView mms210crkrvPrint(ExtHtttprequestParam _req, LoginVO user,
			@RequestParam(value = "reportType", required = false, defaultValue = "pdf") String reportType,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
			CrystalReportDoc cDoc = new CrystalReportDoc();
			CrystalReportFactory clientDoc = null;
			...
			String sql = "";
			try {
				sql = dao.mappedSqlString("mms210skrvServiceImpl.printList", param);
				List subReports = new ArrayList();
				/**
	            * 결재란관련     san_top_sub.rpt
	            */
			...
			clientDoc.setPrintFileName("mms210crkrv");
			clientDoc.setReportType(reportType);
			return ViewHelper.getCrystalReportView(clientDoc);
		}
}
