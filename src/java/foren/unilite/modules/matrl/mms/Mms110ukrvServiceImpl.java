...
@Service("mms110ukrvService")
public class Mms110ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectExpirationdate(Map param) throws Exception {
		return super.commonDao.select("mms110ukrvServiceImpl.selectExpirationdate", param);
	}
	/**
	 * 수주정보 Master 조회
	 *
	...
	public Object a(Map param) throws Exception {
		return super.commonDao.select("mms110ukrvServiceImpl.a", param);
	}
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectreceiptNumMasterList(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.selectreceiptNumMasterList", param);
	}
	...
	public List<Map<String, Object>> selectorderList(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.selectorderList", param);
	}
	/**
	 *
	 * 접수등록->거래처참조
	...
	public List<Map<String, Object>> selectCustList(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.selectCustList", param);
	}
	/**
	 *
	 * 접수등록->거래처참조디테일
	...
	public List<Map<String, Object>> selectCustDetailList(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.selectCustDetailList", param);
	}
	...
	public List<Map<String, Object>> printList(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.printList", param);
	}
	...
	public List<Map<String, Object>> selectcommerceList(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.selectcommerceList", param);
	}
	...
	public List<Map<String, Object>>  inspecQtyCheck(Map param) throws Exception {
		...
		return  super.commonDao.list("mms110ukrvServiceImpl.inspecQtyCheck", param);
	}
	...
	public List<Map<String, Object>> selectvmiList(Map param) throws Exception {
		return super.commonDao.list("mms110ukrvServiceImpl.selectvmiList", param);
	}
	...
	public Object  userWhcode(Map param) throws Exception {
		...
		return  super.commonDao.select("mms110ukrvServiceImpl.userWhcode", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		//				param.put("PICK_STATUS", "");
						param.put("data", super.commonDao.insert("mms110ukrvServiceImpl.insertLogMaster", param));
					}
				}else{
					param.put("KEY_VALUE", keyValue);
					param.put("OPR_FLAG", oprFlag);
	...
	//				param.put("PICK_STATUS", "");
		...
		super.commonDao.queryForObject("mms110ukrvServiceImpl.spImportReceipt", spParam);
		...
		if(!ObjUtils.isEmpty(errorDesc)){
		   ...
		   // throw new  UniDirectValidateException(this.getMessage(messsage[0], user));
			...
			//자동입고 사용 여부 가져오기
			autoInputChk = (int) super.commonDao.select("mms110ukrvServiceImpl.autoInputCheck", autoInputParam);
			//자동입고 사용시
			if(autoInputChk > 0){
				...
				for(Map paramData: paramList) {
					...
					if(paramData.get("method").equals("deleteDetail"))	oprFlag2="D";
							...
							if(oprFlag2.equals("N") || oprFlag2.equals("U")){
								...
								for(Map detailParam:  dataList2) {
										...
										//1-1발주유형이 외주가 아닌 건에대하여 기존에 수불내역이 있으면 삭제
											autoInputBeforeDeleteList = super.commonDao.list("mms110ukrvServiceImpl.selectAutoInputBeforeDeletetList", autoInputParam);
											...
											autoInputBeforeDeleteOutList = super.commonDao.list("mms110ukrvServiceImpl.selectAutoInputBeforeDeletetOutList", autoInputParam);
											...
											//3.자동입고 (외주가 아닌 것)
											autoInputList = 	super.commonDao.list("mms110ukrvServiceImpl.selectAutoInputList", autoInputParam);
						...
						//									throw new  UniDirectValidateException("입고유형이 금액보정이 아닐때  구매단가가 0 이거나 0보다 작을 수 없습니다.");
											...
											//4.자동입고 (외주)
											autoInputOutList = 	super.commonDao.list("mms110ukrvServiceImpl.selectAutoInputOutList", autoInputParam);
	...
	public List<Map<String, Object>>  inOutQtyCheck(Map param) throws Exception {
		return  super.commonDao.list("mms110ukrvServiceImpl.inOutQtyCheck", param);
	}
	...
	public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
		...
		return super.commonDao.list("mms110ukrvServiceImpl.getFileList", param);
	}
	...
	public void insertQMS101(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("ADD_FIDS")).split(",");
			 ...
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.insert("mms110ukrvServiceImpl.insertQMS101", param);
			 }
	}
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public void deleteQMS101(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("DEL_FIDS")).split(",");
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.update("mms110ukrvServiceImpl.deleteQMS101", param);
			 }
	}
	...
	public List<Map<String, Object>>  mainReport(Map param) throws Exception {
		return  super.commonDao.list("mms110ukrvServiceImpl.mainReport", param);
	}
	...
	public List<Map<String, Object>>  subReport(Map param) throws Exception {
		return  super.commonDao.list("mms110ukrvServiceImpl.subReport", param);
	}
	...
	public List<Map<String, Object>>  selectLabelPrintList(Map param) throws Exception {
		return  super.commonDao.list("mms110ukrvServiceImpl.selectLabelPrintList", param);
	}
	...
	public List<Map<String, Object>>  partitionPrintList(Map param) throws Exception {
		return  super.commonDao.list("mms110ukrvServiceImpl.partitionPrintList", param);
	}
	...
	/**
	 * 20210615 추가: 최우선적으로 공통코드 B706 검색해서 없으면 기존로직 수행하도록 변경
	 * @param param
	 * @return
	 * @throws Exception
	 */
	...
	public String getReportFileInfo(Map param) throws Exception {
		return (String) super.commonDao.select("mms110ukrvServiceImpl.getReportFileInfo", param);
	}
}