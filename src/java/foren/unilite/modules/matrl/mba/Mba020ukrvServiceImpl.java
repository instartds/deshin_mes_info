...
@Service("mba020ukrvService")
public class Mba020ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectForm(Map param) throws Exception {
		return super.commonDao.select("mba020ukrvServiceImpl.selectForm", param);
	}
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.FORM_LOAD)
	public Object selectForm2(Map param) throws Exception {
		return super.commonDao.select("mba020ukrvServiceImpl.selectForm2", param);
	}
	...
	public ExtDirectFormPostResult syncForm(Mba020ukrvModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {	
		...
		super.commonDao.update("mba020ukrvServiceImpl.updateForm", dataMaster);
	...
	@ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "matrl")
	public ExtDirectFormPostResult syncForm2(Mba020ukrvModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {	
	
		dataMaster.setS_COMP_CODE(user.getCompCode());
		dataMaster.setS_USER_ID(user.getUserID());
		super.commonDao.update("mba020ukrvServiceImpl.updateForm2", dataMaster);
		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
