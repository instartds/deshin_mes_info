...
@Service("mtr200ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Mtr200ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectInoutType(Map param) throws Exception {
		return super.commonDao.select("mtr200ukrvServiceImpl.selectInoutType", param);
	}
	/**
	 * 출고등록->출고내역조회
	 *
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("mtr200ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectreleaseNoMasterList(Map param) throws Exception {
		return super.commonDao.list("mtr200ukrvServiceImpl.selectreleaseNoMasterList", param);
	}
    ...
    public List<Map<String, Object>> selectrefList(Map param) throws Exception {
        return super.commonDao.list("mtr200ukrvServiceImpl.selectrefList", param);
    }
	...
	public List<Map<String, Object>> selectrefList2(Map param) throws Exception {
		return super.commonDao.list("mtr200ukrvServiceImpl.selectrefList2", param);
	}
	 ...
	 */
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectrefList3(Map param) throws Exception {
		return super.commonDao.list("mtr200ukrvServiceImpl.selectrefList3", param);
	}
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("mtr200ukrvServiceImpl.insertLogMaster", param));
			}
		}
        ...
        super.commonDao.queryForObject("mtr200ukrvServiceImpl.spReseving", spParam);
