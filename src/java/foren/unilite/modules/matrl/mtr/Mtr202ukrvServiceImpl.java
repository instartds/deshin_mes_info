...
@Service("mtr202ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Mtr202ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.selectList", param);
	}
	
	/**
	 * 출고등록->출고내역조회 (barcodeGrid)
	 * 
	 * @param param
	 * @return
	 * @throws Exception
	...
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.selectList2", param);
	}
	...
	public List<Map<String, Object>> getItemInfo (Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.getItemInfo", param);
	}
	
	/**
	 * 출고요청 참조 바코드 입력 시, 데이터 조회
	 * 
	 * @param param
	 * @return
	 * @throws Exception
	...
	public List<Map<String, Object>> getBarcodeInfo(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.getBarcodeInfo", param);
	}
	
	/**
	 * 반품가능 참조 바코드 입력 시, 데이터 조회
	 * 
	 * @param param
	 * @return
	 * @throws Exception
	...
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> getBarcodeInfo2(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.getBarcodeInfo2", param);
	}
	...
	public List<Map<String, Object>> selectreleaseNoMasterList(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.selectreleaseNoMasterList", param);
	}
	...
	public List<Map<String, Object>> selectrefList(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.selectrefList", param);
	}
	...
	public List<Map<String, Object>> selectrefList2(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.selectrefList2", param);
	}
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("mtr202ukrvServiceImpl.insertLogMaster", param));
			}
		}
		...
		spParam.put("INOUT_CODE_TYPE"	, dataMaster.get("INOUT_CODE_TYPE"));
		spParam.put("LangCode"			, user.getLanguage());
		spParam.put("GUBUN"				, "1");

		super.commonDao.queryForObject("mtr202ukrvServiceImpl.spReseving", spParam);
...
//			throw new  UniDirectValidateException(this.getMessage(messsage[0], user));
	...
	public List<Map<String, Object>> printList(Map param) throws Exception {
		return super.commonDao.list("mtr202ukrvServiceImpl.printList", param);
	}
