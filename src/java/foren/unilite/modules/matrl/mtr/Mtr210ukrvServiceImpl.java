...
@Service("mtr210ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Mtr210ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectInoutType(Map param) throws Exception {
		return super.commonDao.select("mtr210ukrvServiceImpl.selectInoutType", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("mtr210ukrvServiceImpl.selectList", param);
	}
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("mtr210ukrvServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("mtr210ukrvServiceImpl.spReseving", spParam);
