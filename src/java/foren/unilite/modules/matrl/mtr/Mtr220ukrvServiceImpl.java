...
@Service("mtr220ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Mtr220ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectInoutType(Map param) throws Exception {
		return super.commonDao.select("mtr220ukrvServiceImpl.selectInoutType", param);
	}
	/**
	 * 출고등록->출고내역조회
	 *
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("mtr220ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectreleaseNoMasterList(Map param) throws Exception {
		return super.commonDao.list("mtr220ukrvServiceImpl.selectreleaseNoMasterList", param);
	}
    ...
    public List<Map<String, Object>> selectrefList(Map param) throws Exception {
        return super.commonDao.list("mtr220ukrvServiceImpl.selectrefList", param);
    }
	...
	public List<Map<String, Object>> selectrefList2(Map param) throws Exception {
		return super.commonDao.list("mtr220ukrvServiceImpl.selectrefList2", param);
	}
	...
	public List<Map<String, Object>> selectrefList3(Map param) throws Exception {
		return super.commonDao.list("mtr220ukrvServiceImpl.selectrefList3", param);
	}
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("mtr220ukrvServiceImpl.insertLogMaster", param));
			}
		}
        ...
        super.commonDao.queryForObject("mtr220ukrvServiceImpl.spReseving", spParam);
