...
@Service("map110ukrvService")
public class Map110ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectForm(Map param) throws Exception {
		return super.commonDao.select("map110ukrvServiceImpl.selectForm", param);
	}//form
	
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("map110ukrvServiceImpl.selectList", param);
	}//grid
	/**
	 * 
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("map110ukrvServiceImpl.selectOrderNumMasterList", param);
	}
	...
	public List<Map<String, Object>> selectreceiveHistoryList(Map param) throws Exception {
		return super.commonDao.list("map110ukrvServiceImpl.selectreceiveHistoryList", param);
	}
	...
	public List<Map<String, Object>> selectreturningHistoryList(Map param) throws Exception {
		return super.commonDao.list("map110ukrvServiceImpl.selectreturningHistoryList", param);
	}
	/**
	 * 
	 * 지급결의등록->발주내역참조(선지급)
	...
	public List<Map<String, Object>> selectorderHistoryList(Map param) throws Exception {
		return super.commonDao.list("map110ukrvServiceImpl.selectorderHistoryList", param);
	}
	/**
	 * 
	 * 신고사업장
	...
	public Object  billDivCode(Map param) throws Exception {	
		return  super.commonDao.select("map110ukrvServiceImpl.billDivCode", param);
	}
	/**
	 * 지급결의등록-> 저장
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("map110ukrvServiceImpl.insertLogForm", dataMaster);
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("map110ukrvServiceImpl.insertLogMaster", param));
			//	param.put("data", super.commonDao.update("map110ukrvServiceImpl.insertLogForm", param));
			}
		}
