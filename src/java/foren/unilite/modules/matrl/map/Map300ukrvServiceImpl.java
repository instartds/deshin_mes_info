...
@Service("map300ukrvService")
public class Map300ukrvServiceImpl  extends TlabAbstractServiceImpl {
    @InjectLogger
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("map300ukrvServiceImpl.selectList", param);
	}
...
//			if(paramData.get("method").equals("deleteDetail"))	oprFlag="D";
			...
			for(Map<String, Object> param:  dataList) {
				...
				param.put("data", super.commonDao.insert("map300ukrvServiceImpl.insertLogMaster", param));
			}
		}
