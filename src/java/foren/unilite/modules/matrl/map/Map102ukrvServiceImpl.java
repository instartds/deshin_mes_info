...
@Service("map102ukrvService")
public class Map102ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> purchaseRequest(Map param) throws Exception {
		return super.commonDao.list("map102ukrvServiceImpl.purchaseRequest", param);
	}
	/**
	 * 
	...
	public Object  userWhcode(Map param) throws Exception {	
		...
		return  super.commonDao.select("map102ukrvServiceImpl.userWhcode", param);
	}
	...
	public Object  fnAuthPubli(Map param) throws Exception {	
		...
		return  super.commonDao.select("map102ukrvServiceImpl.fnAuthPubli", param);
	}
	...
	public Object  fnCustom(Map param) throws Exception {	
		...
		return  super.commonDao.select("map102ukrvServiceImpl.fnCustom", param);
	}
	...
	public List<Map<String, Object>> salesHistory(Map param) throws Exception {
		return super.commonDao.list("map102ukrvServiceImpl.salesHistory", param);
	}
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {		
		try {
			...
			List<Map> chkList = (List<Map>) super.commonDao.list("map102ukrvServiceImpl.checkCompCode", compCodeMap);
			...
			for(Map param : paramList )	{			 
				 for(Map checkCompCode : chkList) {
					 ...
					 super.commonDao.update("map102ukrvServiceImpl.insertDetail", param);
					 }
			}	
		}catch(Exception e){
		 ...
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {
				 ...
				 param.put("ORDER_PRSN", dataMaster.get("ORDER_PRSN"));
					 ...
					 super.commonDao.insert("map102ukrvServiceImpl.updateDetail", param);
			 }
		 }
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user,  Map paramMaster) throws Exception {
		...
		compCodeMap.put("S_COMP_CODE", user.getCompCode());
		List<Map> chkList = (List) super.commonDao.list("map102ukrvServiceImpl.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 param.put("DIV_CODE", dataMaster.get("DIV_CODE"));
				 ...
				 param.put("ORDER_PRSN", dataMaster.get("ORDER_PRSN"));
					 try {
						 super.commonDao.delete("map102ukrvServiceImpl.deleteDetail", param);
