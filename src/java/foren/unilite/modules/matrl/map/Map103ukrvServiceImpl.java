...
@Service("map103ukrvService")
public class Map103ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectForm(Map param) throws Exception {
		return super.commonDao.select("map103ukrvServiceImpl.selectForm", param);
	}//form
	
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("map103ukrvServiceImpl.selectList", param);
	}//grid
	/**
	 * 
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("map103ukrvServiceImpl.selectOrderNumMasterList", param);
	}
	...
	public List<Map<String, Object>> selectreceiveHistoryList(Map param) throws Exception {
		return super.commonDao.list("map103ukrvServiceImpl.selectreceiveHistoryList", param);
	}
	...
	public List<Map<String, Object>> selectreturningHistoryList(Map param) throws Exception {
		return super.commonDao.list("map103ukrvServiceImpl.selectreturningHistoryList", param);
	}
	/**
	 * 
	 * 지급결의등록->발주내역참조(선지급)
	...
	public List<Map<String, Object>> selectorderHistoryList(Map param) throws Exception {
		return super.commonDao.list("map103ukrvServiceImpl.selectorderHistoryList", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("map103ukrvServiceImpl.insertLogForm", dataMaster);
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("map103ukrvServiceImpl.insertLogMaster", param));
			//	param.put("data", super.commonDao.update("map103ukrvServiceImpl.insertLogForm", param));
			}
		}
