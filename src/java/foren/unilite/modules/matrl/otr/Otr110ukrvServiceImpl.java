...
@Service("otr110ukrvService")
public class Otr110ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("otr110ukrvServiceImpl.selectMasterList", param);		/* 조회 */
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("otr110ukrvServiceImpl.selectDetailList", param);		/* 검색 */
	}
	...
	public List<Map<String, Object>> selectDetail2(Map param) throws Exception {
		return super.commonDao.list("otr110ukrvServiceImpl.selectDetailList2", param);		/* 예약참조 */
	}
	...
	public List<Map<String, Object>> selectDetail3(Map param) throws Exception {
		return super.commonDao.list("otr110ukrvServiceImpl.selectDetailList3", param);		/* 반춤가능 예약참조 */
	}
	/**
	 * 수주정보 저장
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		//1.로그테이블에서 사용할 KeyValue 생성
		  ...
		  for(Map paramData: paramList) {
			  ...
			  for(Map param: dataList) {
				  ...
				  param.put("data", super.commonDao.insert("otr110ukrvServiceImpl.insertLogMaster", param));
			  }
		  }
		...
		//4.접수등록 Stored Procedure 실행
			...
			super.commonDao.queryForObject("spOtr110ukrv", spParam);
	...
	public Object selectProductNumInWh(Map param) throws Exception {
		return super.commonDao.select("otr110ukrvServiceImpl.selectProductNumInWh", param);		/* 검색 */
	}
}
