...
@Service("otr120ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Otr120ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("otr120ukrvServiceImpl.selectMasterList", param);		// 조회
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("otr120ukrvServiceImpl.selectDetailList", param);		// 검색
	}
	...
	public List<Map<String, Object>> selectDetail2(Map param) throws Exception {
		return super.commonDao.list("otr120ukrvServiceImpl.selectDetailList2", param);		// 미입고참조
	}
	...
	public List<Map<String, Object>> selectDetail3(Map param) throws Exception {
		return super.commonDao.list("otr120ukrvServiceImpl.selectDetailList3", param);		// 반품가능발주참조
	}
	...
	public List<Map<String, Object>> selectDetail4(Map param) throws Exception {
		return super.commonDao.list("otr120ukrvServiceImpl.selectDetailList4", param);		// 검사결과참조
	}
	*/
	...
	public List<Map<String, Object>> selectDetail4(Map param) throws Exception {
		...
		if(ObjUtils.getSafeString(param.get("WINDOW_FLAG")).equals("inspectResult")){	// 검사결과
			resultList = super.commonDao.list("otr120ukrvServiceImpl.selectDetailList4", param);
		}else{ // 무검사
			resultList = super.commonDao.list("otr120ukrvServiceImpl.selectNoDetailList4", param);
		}
		return resultList;
	...
	public Object selectGetOrderPrice(Map param) throws Exception {
		return super.commonDao.select("otr120ukrvServiceImpl.selectGetOrderPrice", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public Object selectStockQ(Map param) throws Exception {
		return super.commonDao.select("otr120ukrvServiceImpl.selectStockQ", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("otr120ukrvServiceImpl.selectRefList", param);
	}
		...
		for(Map paramData: paramList) {			
			...
			for(Map param:  dataList) {
				...
				if(oprFlag.equals("N")  && param.get("ACCOUNT_YNC").equals("Y") && !param.get("INOUT_TYPE_DETAIL").equals("91") && param.get("PRICE_YN").equals("Y")){
					//20191211 parseInt -> parseDouble로 변경
					if(ObjUtils.parseDouble(param.get("ORDER_UNIT_FOR_P"))<= 0 && !param.get("INOUT_TYPE_DETAIL").equals("20")){
//						throw new  UniDirectValidateException("입고유형이 금액보정이 아닐때  구매단가가 0 이거나 0보다 작을 수 없습니다");
						...
						param.put("data", super.commonDao.insert("otr120ukrvServiceImpl.insertLogDetail", param));
					}
				}else{
					if("N".equals(oprFlag) || "D".equals(oprFlag)){
						param.put("data", super.commonDao.insert("otr120ukrvServiceImpl.insertLogDetail", param));
					}else{
						param.put("data", super.commonDao.insert("otr120ukrvServiceImpl.updateLogDetail", param));
					}
				}
			}
		}
	    ...
	    super.commonDao.queryForObject("otr120ukrvServiceImpl.spOtr120ukrv", spParam);
...
//		for(Map param : paramList )	{
		...
		public void deleteMaster(Map param, LoginVO user) throws Exception {
			...
			super.commonDao.delete("otr120ukrvServiceImpl.deleteMaster", param);
		}
		...
		private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
			if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
				...
				checkProgress(param, "Master", user);
				//수불정보 update
				super.commonDao.queryForObject("otr120ukrvServiceImpl.checkOrderType", param);
			}
		}
		...
		public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
			for(Map param: params)		{
				Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkSerNo", param);
				if(!ObjUtils.isEmpty(checkSerNo))	{
					Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.autoSerNo", param);
					param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
				}
				beforeSaveDetail(param, user, "insert");
				super.commonDao.insert("otr120ukrvServiceImpl.insertDetail", param);
			}		
	...
	public Map<String, Object> saveMaster(Map<String, Object> paramMap, LoginVO user) throws Exception {
		...
		if (ObjUtils.isEmpty(paramMap.get("INOUT_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("otr120ukrvServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("otr120ukrvServiceImpl.updateMaster", paramMap);
		}
		
		super.commonDao.update("otr120ukrvServiceImpl.updatePrice", paramMap);
		
		
		return paramMap;
	}
	
	private Map<String, Object> makeMapParam(otr120ukrvModel param, LoginVO user)	{
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("otr120ukrvServiceImpl.updateDetail", param);
		}		
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA120 = (List<Map<String, Object>>)super.commonDao.list("otr120ukrvServiceImpl.checkSSA120", param);
		        if(ObjUtils.isEmpty(checkListSSA120))	{
		        	...
		        	for(Map<String, Object> checkSSA120 : checkListSSA120)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("otr120ukrvServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("otr120ukrvServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("otr120ukrvServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("otr120ukrvServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("otr120ukrvServiceImpl.checkDeleteAllDetail", params.get(0)); 
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("otr120ukrvServiceImpl.checkEstimate", param);
		
		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{					
						super.commonDao.update("otr120ukrvServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("otr120ukrvServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("otr120ukrvServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{	
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("otr120ukrvServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("otr120ukrvServiceImpl.checkProgressDetail", param);
		}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("otr120ukrvServiceImpl.selectExcelUploadSheet1", param);
    }
}
