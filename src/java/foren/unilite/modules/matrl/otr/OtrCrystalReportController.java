...
@Controller
public class OtrCrystalReportController extends UniliteCommonController{
	@InjectLogger
	 ...
	 @RequestMapping(value = "/matrl/otr330crkrv.do", method = RequestMethod.GET)
		public ModelAndView opo330crkrvPrint(ExtHtttprequestParam _req, LoginVO user,
			...
			String sql = "";
			try {
				sql = dao.mappedSqlString("otr330rkrvServiceImpl.printList", param);
			...
			clientDoc.setPrintFileName("otr330crkrv");
