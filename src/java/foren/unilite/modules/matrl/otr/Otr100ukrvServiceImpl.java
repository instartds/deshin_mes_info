...
@Service("otr100ukrvService")
public class Otr100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("otr100ukrvServiceImpl.selectMasterlList", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("otr100ukrvServiceImpl.selectDetailList", param);
	}
    ...
    public List<Map<String, Object>> selectReplaceItemList(Map param) throws Exception {
        return super.commonDao.list("otr100ukrvServiceImpl.selectReplaceItemList", param);
    }
	...
	public void deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		 for(Map param :paramList )	{
			 try {
				 ...
				 super.commonDao.delete("otr100ukrvServiceImpl.deleteDetail", param);
	...
	public List<Map> insertDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param: paramList)		{
			...
			super.commonDao.insert("otr100ukrvServiceImpl.insertDetail", param);
		}		
	...
	public List<Map> updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param: paramList)		{
			...
			super.commonDao.insert("otr100ukrvServiceImpl.updateDetail", param);
		}		
	...
	private void  checkProgress(Map param, String oprType, LoginVO user)  throws Exception {
		...
		obj = (Map<String, Object>)super.commonDao.select("otr100ukrvServiceImpl.checkProgress", param);
...
///////////==========================================================
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("otr100ukrvServiceImpl.itemInfo", param);
	...
	public ExtDirectFormPostResult syncMaster(otr100ukrvModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);
		
		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("otr100ukrvServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("otr100ukrvServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("otr100ukrvServiceImpl.updateMaster", paramMap);
		}
		
		super.commonDao.update("otr100ukrvServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(otr100ukrvModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			...
			//수불정보 update
			super.commonDao.queryForObject("otr100ukrvServiceImpl.checkOrderType", param);
		}
	}
	

	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("otr100ukrvServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("otr100ukrvServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA100 = (List<Map<String, Object>>)super.commonDao.list("otr100ukrvServiceImpl.checkSSA100", param);
		        if(ObjUtils.isEmpty(checkListSSA100))	{
		        	...
		        	for(Map<String, Object> checkSSA100 : checkListSSA100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("otr100ukrvServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("otr100ukrvServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("otr100ukrvServiceImpl.updateSRQ100", paramSRQ100);
