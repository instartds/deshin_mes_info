...
@Service("otr112ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Otr112ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("otr112ukrvServiceImpl.selectMasterList", param);		/* 조회 */
	}
	...
	public List<Map<String, Object>> selectMaster2(Map param) throws Exception {
		return super.commonDao.list("otr112ukrvServiceImpl.selectMasterList2", param);		/* 조회 */
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("otr112ukrvServiceImpl.selectDetailList", param);		/* 검색 */
	}
	...
	public List<Map<String, Object>> selectDetail2(Map param) throws Exception {
		return super.commonDao.list("otr112ukrvServiceImpl.selectDetailList2", param);		/* 예약참조 */
	}
	...
	public List<Map<String, Object>> selectDetail3(Map param) throws Exception {
		return super.commonDao.list("otr112ukrvServiceImpl.selectDetailList3", param);		/* 반춤가능 예약참조 */	
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		//1.로그테이블에서 사용할 KeyValue 생성
		  ...
		  for(Map paramData: paramList) {
			  ...
			  for(Map param: dataList) {
				  ...
				  param.put("data", super.commonDao.insert("otr112ukrvServiceImpl.insertLogMaster", param));
			  }
		  }
		...
		//4.접수등록 Stored Procedure 실행
			...
			super.commonDao.queryForObject("spotr112ukrv", spParam);
	...
	public List<Map> updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param: paramList)		{
			super.commonDao.update("otr100ukrvServiceImpl.updateDetail", param);
		}		
		return paramList;
	}
	...
	public Object selectProductNumInWh(Map param) throws Exception {
		return super.commonDao.select("otr112ukrvServiceImpl.selectProductNumInWh", param);		/* 검색 */
	}
	...
	public List<Map<String, Object>> getBarcodeInfo(Map param) throws Exception {
		return super.commonDao.list("otr112ukrvServiceImpl.getBarcodeInfo", param);
	}
