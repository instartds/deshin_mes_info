...
@Service("gme100ukrvService")
public class Gme100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gme100ukrvServiceImpl.selectList", param);
	}
	...
	public Integer  update(List<Map> paramList) throws Exception {
		for(Map param : paramList) 	{
			int r = super.commonDao.update("gme100ukrvServiceImpl.update", param);
		}
		return 0;
	}
