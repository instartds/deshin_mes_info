...
@Service("gre200skrvService")
public class Gre200skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gre200skrvServiceImpl.selectList", param);
	}
