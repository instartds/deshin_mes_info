...
@Service("gre600skrvService")
public class Gre600skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gre600skrvServiceImpl.selectList", param);
	}
