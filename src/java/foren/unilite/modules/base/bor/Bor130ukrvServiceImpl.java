...
@Service("bor130ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Bor130ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public UniTreeNode selectList(Map param) throws Exception {		
		...
		*/
		List<GenericTreeDataMap> menuList = super.commonDao.list("bor130ukrvServiceImpl.selectTreeList", param);
	...
	public List<Map>  insertMulti(List<Map> paramList, LoginVO user) throws Exception {
		...
		for(Map param :paramList ) {
			Map chkMap = (Map)super.commonDao.select("bor130ukrvServiceImpl.checkPK", param);
			if( ObjUtils.parseInt(chkMap.get("CNT")) > 0) 	{
				logger.debug("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  CNT:{}",ObjUtils.parseInt(chkMap.get("CNT")));
				throw new  UniDirectValidateException(this.getMessage("2627", user));
			}
			super.commonDao.insert("bor130ukrvServiceImpl.insert", param);
			if(replication){
				super.commonDao.insert("bor130ukrvRepServiceImpl.insert", param);
			}
		}
		return paramList;
	}
	...
	public List<Map>  updateMulti(List<Map> paramList, LoginVO user) throws Exception {
		...
		for(Map param :paramList ) {	
			super.commonDao.update("bor130ukrvServiceImpl.update", param);
			if(replication){
				super.commonDao.update("bor130ukrvRepServiceImpl.update", param);
			}
		}
		return paramList;
	}
	...
	public List<Map>  deleteMulti(List<Map> paramList, LoginVO user) throws Exception {
		...
		for(Map param :paramList ) {	
			super.commonDao.update("bor130ukrvServiceImpl.delete", param);
			if(replication){
				super.commonDao.update("bor130ukrvRepServiceImpl.delete", param);
			}
		}
		return paramList;
	}
