...
@Service("gve120ukrvService")
public class Gve120ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gve120ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map>  insert(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			...
			Map r = (Map) super.commonDao.queryForObject("gve120ukrvServiceImpl.insert", param);		
		}
		return  paramList;
	}
	...
	public List<Map>  update(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			param.put("S_USER_ID", user.getUserID());
			super.commonDao.update("gve120ukrvServiceImpl.update", param);		
		}
		return  paramList;
	}
	...
	public List<Map>  delete(List<Map> paramList) throws Exception {		
		for(Map param :paramList )	{
			super.commonDao.update("gve120ukrvServiceImpl.delete", param);		
		}
		return  paramList;
	}
