...
@Service("bpl130ukrvService")
public class Bpl130ukrvServiceImpl extends TlabAbstractServiceImpl{	
	...
	public List<Map<String, Object>> selectMasterList(Map param) throws Exception {
		...
		return super.commonDao.list("bpl130ukrvServiceImpl.selectMasterList", param);
	}
	
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("bpl130ukrvServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderList(Map param) throws Exception {
		return super.commonDao.list("bpl130ukrvServiceImpl.selectOrderList", param);
	}
	...
	public int insertMaster(String keyValue, List<Map> dataList, LoginVO user) throws Exception {
		//bpl130ukrvServiceImpl.USP_CALC_BOMPL
		Map<String, Object> spParam = new HashMap<String, Object>();
		spParam.put("KeyValue", keyValue);
		
		super.commonDao.queryForObject("bpl130ukrvServiceImpl.USP_CALC_BOMPL", spParam);
		...
		for(Map dataMap : dataList) {
			super.commonDao.update("bpl130ukrvServiceImpl.updateBpl120T", dataMap);
			super.commonDao.update("bpl130ukrvServiceImpl.updateBpl130T", dataMap);
		}
		return 0;
	}
	...
	public int deleteMaster(String keyValue, List<Map> dataList, LoginVO user) throws Exception {
		for(Map param : dataList) {
			int res = super.commonDao.update("bpl130ukrvServiceImpl.deleteMaster", param);
			if(res > 0) {
				super.commonDao.update("bpl130ukrvServiceImpl.deleteDetail", param);
			}
		}
		return 0;
	}
	...
	private void insertLogMaster(String keyValue, String oprFlag, List<Map> dataList, LoginVO user) {
		for(Map param:  dataList) {
			...
			super.commonDao.insert("bpl130ukrvServiceImpl.insertLogMaster", param);
		}
	}
