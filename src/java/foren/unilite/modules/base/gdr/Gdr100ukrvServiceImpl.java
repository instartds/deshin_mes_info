...
@Service("gdr100ukrvService")
public class Gdr100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gdr100ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map>  update(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			...
			super.commonDao.update("gdr100ukrvServiceImpl.update", param);		
		}
		return  paramList;
	}
