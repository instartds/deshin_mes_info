...
@Service("bpr220ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Bpr220ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map> selectList(Map param) throws Exception{
		return super.commonDao.list("bpr220ukrvServiceImpl.selectList", param);
	}
...
//		Map<String, Object> dataMaster = (Map<String, Object>) paramMaster.get("data");
	...
	public void insertDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param : paramList) {
			super.commonDao.insert("bpr220ukrvServiceImpl.insertDetail", param);
		}
		return;
	}
	...
	public void updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList) {
			super.commonDao.update("bpr220ukrvServiceImpl.updateDetail", param);
		}
		return;
	}
	...
	public void deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("bpr220ukrvServiceImpl.deleteDetail", param);
		}
		return;
	}
}