...
@Service("bpr305rkrvService")
public class Bpr305rkrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		...
		return  super.commonDao.list("bpr305rkrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectClipPrintList(Map param) throws Exception {
		...
		return super.commonDao.list("bpr305rkrvServiceImpl.selectClipPrintList", param);
	}
}
