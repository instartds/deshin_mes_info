...
@Service("bpr815rkrvService")
public class Bpr815rkrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> printList(Map param) throws Exception{
		return super.commonDao.list("bpr815rkrvServiceImpl.printList", param);
	}
}
