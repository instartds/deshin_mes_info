...
@Service("bpr105ukrvService")
public class Bpr105ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public List<Map> selectDetailList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bpr105ukrvService.selectDetailList", param);
	}
	...
	public List<Map> selectSubDetailList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bpr105ukrvService.selectSubDetailList", param);
	}
...
//			List<Map> chkList = (List<Map>) super.commonDao.list("bpr105ukrvService.checkCompCode", compCodeMap);
//			for(Map param : paramList )	{			 
//				 for(Map checkCompCode : chkList) {
//					 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
////					 super.commonDao.update("bpr105ukrvService.bpr100tInsertDetail", param);
//					 
//					 if(ObjUtils.parseInt(param.get("SALE_BASIS_P")) == 0 || "".equals(param.get("SALE_BASIS_P"))){
//						 //skip
//					 }else{
//						 super.commonDao.update("bpr105ukrvService.bpr400tInsertDetail", param);	//판매단가 저장
//					 }					 
////					 String divCodeList[] = ((String) param.get("DIV_CODE")).split(",");
////					 for(int i = 0; i<divCodeList.length; i++){
////						 param.put("DIV_CODE", divCodeList[i]);
//						 super.commonDao.update("bpr105ukrvService.bpr200tInsertDetail", param);
////					 }					 
//				 }					 
//			}	
//		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		...
		List<Map> chkList = (List<Map>) super.commonDao.list("bpr105ukrvService.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {				 
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 Map chkItemMap = (Map) super.commonDao.select("bpr105ukrvService.checkExistBpr200tInfo", param);
				 if(ObjUtils.parseInt(chkItemMap.get("CNT")) > 0)	{
					 super.commonDao.update("bpr105ukrvService.bpr200tUpdateDetail", param);//detail 저장
				 }else {
					 super.commonDao.update("bpr105ukrvService.bpr200tInsertDetail", param);//detail 저장
				 }
//				 String divCodeList[] = ((String) param.get("DIV_CODE")).split(",");
//				 for(int i = 0; i<divCodeList.length; i++){
//					 param.put("DIV_CODE", divCodeList[i]);
...
//				 }
//				 Map chkItemPriceMap = (Map) super.commonDao.select("bpr105ukrvService.checkItemPrice", param);
//				 if(ObjUtils.parseInt(chkItemPriceMap.get("CNT")) > 0)	{	//등록된 item판매단가가있을시 update else insert 
//					 super.commonDao.update("bpr105ukrvService.bpr400tUpdateDetail", param);
//				 }else {
//					 super.commonDao.update("bpr105ukrvService.bpr400tInsertDetail", param);
//			 	 }				
//				 super.commonDao.update("bpr105ukrvService.bpr100tUpdateDetail", param);
			 }
		 }
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		Map compCodeMap = new HashMap();
		compCodeMap.put("S_COMP_CODE", user.getCompCode());
		List<Map> chkList = (List) super.commonDao.list("bpr105ukrvService.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 List chkChildList = (List) super.commonDao.list("bpr105ukrvService.checkChildCode", param);
				 if(chkChildList.size() > 0)	{
					 ...
					 try {
						 Map chkItemMap = (Map) super.commonDao.select("bpr105ukrvService.checkExistBpr200tInfo", param);
						 if(ObjUtils.parseInt(chkItemMap.get("CNT")) > 0)	{
							 super.commonDao.delete("bpr105ukrvService.bpr200tDeleteDetail", param);
						 }
//						 super.commonDao.delete("bpr105ukrvService.bpr100tDeleteDetail", param);						
					 }catch(Exception e)	{
		...
		try {
			...
			for(Map param : paramList )	{			 
				 for(Map checkCompCode : chkList) {
					 ...
					 super.commonDao.update("bpr105ukrvService.insertSubDetail", param);
					 }
				}	
		}catch(Exception e){
			throw new  UniDirectValidateException(this.getMessage("2627", user));
		 ...
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
					 ...
					 super.commonDao.insert("bpr105ukrvService.updateSubDetail", param);
			 }
		 }
		 return 0;
	} 
		 ...
		 for(Map param :paramList )	{
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
					 ...
					 try {
						 super.commonDao.delete("bpr105ukrvService.deleteSubDetail", param);
	...
	public List<Map> checkExistBpr400tInfo(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bpr105ukrvService.checkExistBpr400tInfo", param);
	}
	...
	public List<Map> checkItemCode(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bpr105ukrvService.checkItemCode", param);
	}
