...
@Service( "bsb020ukrvService" )
public class Bsb020ukrvServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO user ) throws Exception {
        ...
        return super.commonDao.list("bsb020ukrvService.selectList", param);
    }
    ...
    public List<Map> insert( List<Map> paramList, LoginVO user ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.insert("bsb020ukrvService.insert", param);
        }
    ...
    public List<Map> delete( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.update("bsb020ukrvService.delete", param);
        }
        tlabBadgeService.reload();
        return paramList;
    }
    ...
    public List<Map> update( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.update("bsb020ukrvService.update", param);
        }
        tlabBadgeService.reload();
        return paramList;
    }
