...
@Service( "bsa400ukrvService" )
public class Bsa400ukrvServiceImpl extends TlabAbstractServiceImpl {
    ...
    public UniTreeNode selectList( Map param, LoginVO user ) throws Exception {
        List<GenericTreeDataMap> treeList = super.commonDao.list("bsa400ukrvService.selectList", param);
    ...
    public List<Map> insertPrograms( List<Map> paramList, LoginVO user ) throws Exception {
        for (Map param : paramList) {
            Map chkMap = (Map)super.commonDao.select("bsa400ukrvService.checkPK", param);
            if (ObjUtils.parseInt(chkMap.get("CNT")) > 0) {
                throw new UniDirectValidateException(this.getMessage("2627", user));
            }
            
            super.commonDao.insert("bsa400ukrvService.insertPrograms", param);
    ...
    public List<Map> deletePrograms( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.update("bsa400ukrvService.deletePrograms", param);
        }
    ...
    public List<Map> updatePrograms( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.update("bsa400ukrvService.updatePrograms", param);
        }
        tlabMenuService.reload();
        return paramList;
    }
    ...
    public Object reloadAll() throws Exception {
    ...
    @ExtDirectMethod( group = "Base", value = ExtDirectMethodType.FORM_LOAD )
    public Object reloadMenu() throws Exception {
        Map<String, Object> rtn = new HashMap<String, Object>();
        tlabMenuService.reload(true);
        return rtn;
    }
    ...
    @ExtDirectMethod( group = "Base", value = ExtDirectMethodType.FORM_LOAD )
    public Object reloadCode() throws Exception {
        Map<String, Object> rtn = new HashMap<String, Object>();
        tlabCodeService.reload(true);
        return rtn;
    }
    ...
    public List<Map<String, Object>> selectCodes(LoginVO user) throws Exception {
    	CodeInfo  codeInfo = tlabCodeService.getCodeInfo(user.getCompCode());
        return codeInfo.getAllCodes();
