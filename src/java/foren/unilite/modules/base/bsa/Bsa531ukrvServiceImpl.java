...
@Service("bsa531ukrvService")
public class Bsa531ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public List<Map> selecMastertList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bsa531ukrvService.selectMasterList", param);
	}
	/**
	 * 권한그룹 디테일 조회
	 * @param param
	...
	public List<Map> selectDetailList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bsa531ukrvService.selectDetailList", param);
	}
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		try {			
			for(Map param : paramList )	{
				super.commonDao.update("bsa531ukrvService.insertDetail", param);				 				 
			}	
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {		
		 for(Map param :paramList )	{
			 super.commonDao.update("bsa531ukrvService.updateDetail", param);			 
		 }
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {		
		 for(Map param :paramList )	{			 
			 try {
				 super.commonDao.delete("bsa531ukrvService.deleteDetail", param);				 						
			 }catch(Exception e)	{
