...
@Service( "bsa360ukrvService" )
@SuppressWarnings( { "rawtypes", "unchecked" } )
public class Bsa360ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object oldPwdCheck( Map param ) throws Exception {
		...
		return super.commonDao.select("bsa360ukrvServiceImpl.oldPwdCheck", param);
	}
	...
	public List<Map<String, Object>> pwRuleCheck( Map param ) throws Exception {
		return super.commonDao.list("bsa360ukrvServiceImpl.pwRuleCheck", param);
	}
	...
	public Object pwCheckQ( Map param ) throws Exception {
		return super.commonDao.select("bsa360ukrvServiceImpl.pwCheckQ", param);
	}
	...
	public Object pwDuplicateCheck( Map param ) throws Exception {
		...
		return super.commonDao.select("bsa360ukrvServiceImpl.pwDuplicateCheck", param);
	}
	...
	public Object pwSameCheck( Map param ) throws Exception {
		return super.commonDao.select("bsa360ukrvServiceImpl.pwSameCheck", param);
	}
	...
	public Object encryptionYN( Map param ) throws Exception {
		return super.commonDao.select("bsa360ukrvServiceImpl.encryptionYN", param);
	}
	...
	public Object encryptionSavePw( Map param ) throws Exception {
		...
		return super.commonDao.update("bsa360ukrvServiceImpl.encryptionSavePw", param);
	}
	...
	public Object notEncryptionSavePw( Map param ) throws Exception {
		return super.commonDao.update("bsa360ukrvServiceImpl.notEncryptionSavePw", param);
	}
