...
@Service("bcm620ukrvService")
public class Bcm620ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("bcm620ukrvService.selectMasterList", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		...
		return  super.commonDao.list("bcm620ukrvService.selectDetailList", param);
	}
	 ...
	 /**
		...
		public Integer deleteMaster(List<Map> paramList,  LoginVO user) throws Exception {
			 for(Map param :paramList )	{
				 try {
					 super.commonDao.delete("bcm620ukrvService.deleteMaster", param);
				 }catch(Exception e)	{
		...
		public Integer  insertMaster(List<Map> paramList, LoginVO user) throws Exception {		
			try {
				for(Map param : paramList )	{
					super.commonDao.update("bcm620ukrvService.insertMaster", param);
				}
			}catch(Exception e){
		...
		public Integer updateMaster(List<Map> paramList, LoginVO user) throws Exception {		
			 for(Map param :paramList )	{
				 super.commonDao.update("bcm620ukrvService.updateMaster", param);
			 }		 
			 return 0;
		}
		...
		public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
			 for(Map param :paramList )	{
				 try {
					 super.commonDao.delete("bcm620ukrvService.deleteDetail", param);
				 }catch(Exception e)	{
		    			throw new  UniDirectValidateException(this.getMessage("55523",user));//삭제할 수 없습니다.
				 }
			 }
		...
		public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
			try {
				for(Map param : paramList )	{
					super.commonDao.update("bcm620ukrvService.insertDetail", param);
				}
			}catch(Exception e){
				throw new  UniDirectValidateException(this.getMessage("2627", user));//중복되는 자료가 입력 되었습니다.
			}		
		...
		public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {		
			 for(Map param :paramList )	{
				 super.commonDao.update("bcm620ukrvService.updateDetail", param);
			 }		 
			 return 0;
		} 
