...
@Service("bcm104skrvService")
public class Bcm104skrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public List<Map<String, Object>>  selectDetailList(Map param) throws Exception {
		return  super.commonDao.list("bcm104skrvServiceImpl.getDataList", param);
	}
	...
	public List<Map> selectPurchaseList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bcm104skrvServiceImpl.selectPurchaseList", param);
	}
	...
	public Object chkPK(Map param)	{
		return super.commonDao.select("bcm104skrvServiceImpl.insertQuery06", param);
	}
...
//		}		
	...
	public List<Map>  insertDetail(List<Map> paramList, LoginVO user, String keyValue, String oprFlag) throws Exception {		
		...
		try {
			...
			List<Map<String, Object>> rsInfoList = (List<Map<String, Object>>)super.commonDao.list("bcm104skrvServiceImpl.insertQuery01", uMap);
			...
			for(Map param :paramList )	{				
				...
				if(ObjUtils.isEmpty(param.get("CUSTOM_CODE"))){
					List<Map> customCode = (List<Map>) super.commonDao.list("bcm104skrvServiceImpl.getAutoCustomCode", compCodeMap);
			    ...
			    for(Map rsInfo : rsInfoList) { 		    	
			    	...
			    	r = super.commonDao.update("bcm104skrvServiceImpl.insertMulti", param);
			    	super.commonDao.update("bcm104skrvServiceImpl.insertMultiLog", param);
			        if( "Y".equals(sDemo)) {
			        	if(!license){		        		
			        		Map<String, Object> customCnt = (Map<String, Object>)super.commonDao.select("bcm104skrvServiceImpl.insertQuery01", param);
		...
		//try {
			...
			for(Map param :paramList )	{
			    ...
			    for(Map rsInfo : rsInfoList) { 		    	
			    	...
			    	/*List<Map<String, Object>> rsCust = (List<Map.<String, Object>>)super.commonDao.list("bcm104skrvServiceImpl.updateQuery04", param);
			    	if(rsCust.size() == 0)	{ 
			    		r = super.commonDao.update("bcm104skrvServiceImpl.insertMulti", param);
			    	}else {*/
			    		r = super.commonDao.update("bcm104skrvServiceImpl.updateMulti", param);
			    		super.commonDao.update("bcm104skrvServiceImpl.updateMultiLog", param);
			    	//}
...
//		}
			...
			for(Map param :paramList )	{
		            ...
		            for(Map rsInfo : rsInfoList) { 	
		            	try {
			            	...
			            	Map<String, Object> rsSheet = (Map<String, Object>)super.commonDao.select("bcm104skrvServiceImpl.deleteQuery02", param);
			               ...
			               if(Integer.parseInt(rsSheet.get("CNT").toString()) > 0 )		{
			            	   ...
			            	   r = super.commonDao.delete("bcm104skrvServiceImpl.deleteMulti", param);
			            	   super.commonDao.delete("bcm104skrvServiceImpl.deleteMultiLog", param);
			            	   super.commonDao.delete("bcm104skrvServiceImpl.deleteBCM120", param);
			               }
			               param.put("COMP_CODE", sOrgCompCode);
			            }catch(Exception e)	{
	...
	public List<Map<String, Object>>  getBCM120List(Map param) throws Exception {
		return  super.commonDao.list("bcm104skrvServiceImpl.getBCM120List", param);
	}
	...
	public List<Map>  insertBCM120(List<Map> paramList) throws Exception {
		...
		//공통코드(B107:타법인 복사여부)에 따라 법인정보 조회
		for(Map param :paramList )	{
		    	r = super.commonDao.update("bcm104skrvServiceImpl.insertBCM120", param);
		}
		return  paramList;
	}
	...
	public List<Map>  updateBCM120(List<Map> paramList,  LoginVO loginVO) throws Exception {
		int r = 0;
		for(Map param :paramList )	{
		    	r = super.commonDao.update("bcm104skrvServiceImpl.updateBCM120", param);
		}
		return  paramList;
	}
	...
	public List<Map>  deleteBCM120(List<Map> paramList) throws Exception {
		int r = 0;
		for(Map param :paramList )	{
				  r = super.commonDao.delete("bcm104skrvServiceImpl.deleteBCM120", param);
		}
		return  paramList;
	}
	...
	public List<Map>  insertSimple(List<Map> paramList) throws Exception {
		...
		for(Map param :paramList )	{
	    	Map result = (Map)super.commonDao.queryForObject("bcm104skrvServiceImpl.insertSimple", param);
	...
	public List<Map> getUnPayAmt(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("bcm104skrvServiceImpl.getUnPayAmt", param);
	}
