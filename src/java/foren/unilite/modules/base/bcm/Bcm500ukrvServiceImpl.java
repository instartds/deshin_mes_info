...
@Service("bcm500ukrvService")
public class Bcm500ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("bcm500ukrvService.selectMasterList", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		...
		return  super.commonDao.list("bcm500ukrvService.selectDetailList", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		 ...
		 if(paramList != null)	{
				...
				if(deleteList != null){
					this.deleteMaster(deleteList, user);
				}
	 ...
	 /**
		...
		public Integer deleteMaster(List<Map> paramList,  LoginVO user) throws Exception {
			 for(Map param :paramList )	{
				 try {
					 super.commonDao.delete("bcm500ukrvService.deleteMaster", param);
				 }catch(Exception e)	{
		...
		public Integer  insertMaster(List<Map> paramList, LoginVO user) throws Exception {		
			try {
				for(Map param : paramList )	{
					super.commonDao.update("bcm500ukrvService.insertMaster", param);
				}
			}catch(Exception e){
		...
		public Integer updateMaster(List<Map> paramList, LoginVO user) throws Exception {		
			 for(Map param :paramList )	{
				 super.commonDao.update("bcm500ukrvService.updateMaster", param);
			 }		 
			 return 0;
		}
		...
		public List<Map> saveAll2(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
			 //logger.debug("=========paramMaster=========" + paramMaster.toString());
			 Map formData = (Map) paramMaster.get("data");			
			 if(paramList != null)	{
					List<Map> insertList = null;
					List<Map> updateList = null;
					List<Map> deleteList = null;
					...
					//if(deleteList != null) this.deleteDetail(deleteList, user, formData);
		 ...
		 */
		@ExtDirectMethod(group = "base", needsModificatinAuth = true)
		//public Integer deleteDetail(List<Map> paramList,  LoginVO user, Map formParam) throws Exception {
		public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
			 for(Map param :paramList )	{
				 try {
					 	String acDate = (String) param.get("AC_DATE"); 
					 	acDate = acDate.replaceAll("[.]", ""); 
					 	param.put("AC_DATE", acDate);
					 	
					 	/*
					 	String exchgDivi = (String) formParam.get("EXCHG_DIVI");
						String baseYear  = (String) formParam.get("BASE_YEAR");
						String baseMonth  = null;
						logger.debug("=========exchgDivi=====" + exchgDivi + "=========baseYear=====" + baseYear);
						param.put("BASE_YEAR", baseYear);
						if("2".equals(exchgDivi)){
							baseMonth  = (String) formParam.get("BASE_MONTH");
							param.put("BASE_MONTH", baseMonth);
						}	
						*/ 					 
						
					 	super.commonDao.delete("bcm500ukrvService.deleteDetail", param);
				 }catch(Exception e)	{
		    			throw new  UniDirectValidateException(this.getMessage("55523",user));//삭제할 수 없습니다.
				 }
			 }
		...
		public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
			try {
				for(Map param : paramList )	{
					super.commonDao.update("bcm500ukrvService.insertDetail", param);
				}
			}catch(Exception e){
				throw new  UniDirectValidateException(this.getMessage("2627", user));//중복되는 자료가 입력 되었습니다.
			}		
		...
		public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {		
			 for(Map param :paramList )	{
				 super.commonDao.update("bcm500ukrvService.updateDetail", param);
			 }		 
			 return 0;
		} 
