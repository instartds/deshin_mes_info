...
@Service("esa101ukrvService")
public class Esa101ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectForm(Map param) throws Exception {
		return super.commonDao.select("esa101ukrvServiceImpl.selectMaster", param);
	}
	/**
	 * masterForm 저장
	 * @param dataMaster
	...
	public ExtDirectFormPostResult syncForm(Esa101ukrvModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {	
		dataMaster.setS_COMP_CODE(user.getCompCode());
		dataMaster.setS_USER_ID(user.getUserID());
		Map map=(Map) super.commonDao.select("esa101ukrvServiceImpl.existMaster", dataMaster);
		if(map==null){
			super.commonDao.insert("esa101ukrvServiceImpl.insertMaster", dataMaster);
		}
		else{
			super.commonDao.update("esa101ukrvServiceImpl.updateMaster", dataMaster);
		}
	...
	public List<Map> selectList(Map param) throws Exception{
		return super.commonDao.list("esa101ukrvServiceImpl.selectList", param);
	}
/**
 * master,detail 저장
 * @param paramList
 ...
 */
    ...
    public void insertDetail(List<Map> paramList, LoginVO user) throws Exception {      
        for(Map param : paramList ) {
            super.commonDao.insert("esa101ukrvServiceImpl.insertDetail", param);
        }   
        return;
    }   
    ...
    public void updateDetail(List<Map> paramList, LoginVO user) throws Exception {
        for(Map param :paramList )  {
            super.commonDao.update("esa101ukrvServiceImpl.updateDetail", param);
        }
         return;
    } 
    ...
    public void deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
         for(Map param :paramList ) {
             super.commonDao.delete("esa101ukrvServiceImpl.deleteDetail", param);
         }
         return;
    }
	...
	public List<Map<String, Object>>  mainReport(Map param) throws Exception {
		return  super.commonDao.list("esa101ukrvServiceImpl.mainReport", param);
	}
		
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "equip")
	public List<Map<String, Object>>  subReport(Map param) throws Exception {
		return  super.commonDao.list("esa101ukrvServiceImpl.subReport", param);
	}
}
