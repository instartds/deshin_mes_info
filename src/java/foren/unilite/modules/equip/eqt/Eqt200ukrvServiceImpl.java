...
@Service("eqt200ukrvService")
public class Eqt200ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Map<String, Object> selectOrderNumMaster(Map param) throws Exception {
		...
		return (Map<String, Object>) super.commonDao.select("eqt200ukrvServiceImpl.selectOrderNumMaster", param);
	}
	@ExtDirectMethod(group = "equit", value = ExtDirectMethodType.FORM_LOAD)
	public Map<String, Object> prevOrderNumMaster(Map param) throws Exception {
		...
		return (Map<String, Object>) super.commonDao.select("eqt200ukrvServiceImpl.prevOrderNumMaster", param);
	}
	@ExtDirectMethod(group = "equit", value = ExtDirectMethodType.FORM_LOAD)
	public Map<String, Object> nextOrderNumMaster(Map param) throws Exception {
		param.put("EQU_CODE", param.get("EQU_CODE") == "" || param.get("EQU_CODE") == null ? "ZZZZZZZZZZZZZZ" : param.get("EQU_CODE"));
		return (Map<String, Object>) super.commonDao.select("eqt200ukrvServiceImpl.nextOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectMasterList3(Map param,HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        List<Map<String, Object>> photo=super.commonDao.list("eqt200ukrvServiceImpl.selectMasterList3", param);
	...
	public List<Map<String, Object>> selectMasterList4(Map param,HttpServletRequest request,HttpServletResponse response) throws Exception {
		//HttpSession seesion = request.getSession();
        List<Map<String, Object>> photo=super.commonDao.list("eqt200ukrvServiceImpl.selectMasterList4", param);
        return photo;
	}
	...
	public List<Map<String, Object>> selectMasterList(Map param) throws Exception {
		return super.commonDao.list("eqt200ukrvServiceImpl.selectMasterList", param);
	}
	...
	public List<Map<String, Object>> selectMasterList2(Map param) throws Exception {
		return super.commonDao.list("eqt200ukrvServiceImpl.selectMasterList2", param);
	}
...
//				}
				if(dataMaster.get("TYPE")!=null) {
					...
					{
						//L_EQT200T
						param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.insertLogDetail", param));
					}else if (dataMaster.get("TYPE").equals("B")) {
						//L_EQR200T
						param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.insertLogDetail2", param));
					}else if (dataMaster.get("TYPE").equals("C")) {
						if(oprFlag.equals("N")){
						//EQR210T
						param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.insertImage", param));
						}else if(oprFlag.equals("U")){
							//EQR210T
							param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.deleteImage", param));
		...
		super.commonDao.queryForObject("eqt200ukrvServiceImpl.spequitEqt200save", spParam);
					...
					param.put("EQU_CODE",dataMaster.get("EQU_CODE"));
					 if (dataMaster.get("TYPE").equals("C")) {
						...
						param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.insertImage", param));
							...
							//模具图片修改
							param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.updateImage", param));
						}else if(oprFlag.equals("D")){
					...
					param.put("EQU_CODE",dataMaster.get("EQU_CODE"));
					 ...
					 if (dataMaster.get("TYPE").equals("C")) {
						...
						if(oprFlag.equals("N")){
							...
							param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.insertMaster4", param));
						}else if(oprFlag.equals("U")){
							//설비일상점검내역(EQU300T_UPDATE)
							param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.updateMaster4", param));
						}else if(oprFlag.equals("D")){
							//설비일상점검내역(EQU300T_DELETE)
							  logger.debug("###################22222222222222222"+oprFlag.equals("N"));
							param.put("data", super.commonDao.insert("eqt200ukrvServiceImpl.deleteMaster4", param));
						}
					}
				}
			}
...
//----- 2023.01.30 Dongsoo Park - (설비일상점검내역 Tab추가작업) End------- //
	...
	public List<Map<String, Object>> imagesList(Map param) throws Exception {
		return super.commonDao.list("eqt200ukrvServiceImpl.imagesList", param);
	}
	...
	public List<ComboItemModel> progWorkCombo(Map param) throws Exception {
		return (List<ComboItemModel>) super.commonDao.list("eqt200ukrvServiceImpl.progWorkCombo", param);
