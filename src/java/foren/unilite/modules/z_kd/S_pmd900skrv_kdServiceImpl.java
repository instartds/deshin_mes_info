...
@Service("s_pmd900skrv_kdService")
public class S_pmd900skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_pmd900skrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> selectList2(Map param) throws Exception {
            return super.commonDao.list("s_pmd900skrv_kdService.selectList2", param);
        }
}
