...
@Service("s_pmd200skrv_kdService")
public class S_pmd200skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_pmd200skrv_kdService.selectList", param);
        }
}
