...
@Service( "s_hum540skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hum540skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hum540skr_kdServiceImpl.selectList", param);
    }
}
