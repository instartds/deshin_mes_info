...
@Service("s_sbx900skrv_kdService")
public class S_sbx900skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_sbx900skrv_kdService.selectList", param);
        }
}
