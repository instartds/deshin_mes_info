...
@Service("s_hat930ukr_kdService")
@SuppressWarnings({"rawtypes", "unchecked"})
public class S_hat930ukr_kdServiceImpl extends TlabAbstractServiceImpl	{
	...
	public List<Map> selectList(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.queryForObject("s_hat930ukr_kdService.spReceiving", spParam);
		...
		List<Map> resultList = super.commonDao.list("s_hat930ukr_kdService.select", param);
	...
	public Integer	insertDetail(List<Map> paramList, LoginVO user) throws Exception {
		try {
			...
			for(Map param : paramList )	{
				 super.commonDao.update("s_hat930ukr_kdService.insertDetail", param);
			}
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		...
		compCodeMap.put("S_COMP_CODE", user.getCompCode());
		 for(Map param :paramList )	{
			 super.commonDao.update("s_hat930ukr_kdService.updateDetail", param);
		 }
		 return 0;
	}
	...
	public Integer deleteDetail(List<Map> paramList,	LoginVO user) throws Exception {
		...
		compCodeMap.put("S_COMP_CODE", user.getCompCode());
		 for(Map param :paramList )	{
			 super.commonDao.update("s_hat930ukr_kdService.deleteDetail", param);
		 }
		 return 0;
	}

	@ExtDirectMethod(group = "hum", needsModificatinAuth = true)
	 public Object selectMealPersonId(Map param) throws Exception {
        return super.commonDao.select("s_hat930ukr_kdService.selectMealPersonId", param);
     }
