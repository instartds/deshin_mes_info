...
@Service( "s_hpa720skr_kdService" )
public class S_hpa720skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO user ) throws Exception {
        ...
        return super.commonDao.list("s_hpa720skr_kdService.selectList", param);
    }
}
