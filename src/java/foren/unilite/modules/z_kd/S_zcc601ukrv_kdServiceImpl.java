...
@Service("s_zcc601ukrv_kdService")
public class S_zcc601ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_zcc601ukrv_kdService.selectList", param);
        }

        @ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)      // 조회
        public List<Map<String, Object>> selectList1(Map param) throws Exception {
            return super.commonDao.list("s_zcc601ukrv_kdService.selectList1", param);
        }

        @ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)      // 조회
        public List<Map<String, Object>> selectList2(Map param) throws Exception {
            return super.commonDao.list("s_zcc601ukrv_kdService.selectList2", param);
        }
        ...
        public Integer insertDetail1(List<Map> paramList, LoginVO user) throws Exception {
            for(Map param : paramList ) {
                super.commonDao.update("s_zcc601ukrv_kdService.insertDetail1", param);
            }
            return 0;
        }
        ...
        public Integer updateDetail1(List<Map> paramList, LoginVO user) throws Exception {
            ...
            try {
                for(Map param :paramList ) {
                    exists610t = (String) super.commonDao.select("s_zcc601ukrv_kdService.exists610t", param);
                    
                    if(exists610t.equals("Y")){
                        msgAlertYN = "Y";
                        msgAlert = "수금내역이 존재하여 수정할 수 없습니다."+ "\n관리코드 : " + param.get("ENTRY_NUM");
                        throw new  UniDirectValidateException(msgAlert);
                    }
    
                    super.commonDao.update("s_zcc601ukrv_kdService.updateDetail1", param);
                }
            }
            catch(Exception e){
                if(msgAlertYN == "Y"){
        ...
        public Integer deleteDetail1(List<Map> paramList,  LoginVO user) throws Exception {
            ...
            try {
                for(Map param :paramList ) {
                    ...
                    super.commonDao.update("s_zcc601ukrv_kdService.deleteDetail1", param);
                }
            }
            catch(Exception e){
                if(msgAlertYN == "Y"){
        ...
        public Integer insertDetail2(List<Map> paramList, LoginVO user) throws Exception {
            for(Map param : paramList ) {
                super.commonDao.update("s_zcc601ukrv_kdService.insertDetail2", param);
                super.commonDao.update("s_zcc601ukrv_kdService.updateCloseYN", param);
            }      
            return 0;
        } 
        ...
        public Integer updateDetail2(List<Map> paramList, LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                super.commonDao.update("s_zcc601ukrv_kdService.updateDetail2", param);
                super.commonDao.update("s_zcc601ukrv_kdService.updateCloseYN", param);
            }
            return 0;
        }
        ...
        public Integer deleteDetail2(List<Map> paramList,  LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                super.commonDao.update("s_zcc601ukrv_kdService.deleteDetail2", param);
                super.commonDao.update("s_zcc601ukrv_kdService.updateCloseYN", param);
            }
            return 0;
        }        
