...
@Service("s_otr100ukrv_kdService")
public class S_otr100ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("s_otr100ukrv_kdServiceImpl.selectMasterlList", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("s_otr100ukrv_kdServiceImpl.selectDetailList", param);
	}
    ...
    public List<Map<String, Object>> selectReplaceItemList(Map param) throws Exception {
        return super.commonDao.list("s_otr100ukrv_kdServiceImpl.selectReplaceItemList", param);
    }
	...
	public void deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		 for(Map param :paramList )	{
			 try {
				 ...
				 super.commonDao.delete("s_otr100ukrv_kdServiceImpl.deleteDetail", param);
	...
	public List<Map> insertDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param: paramList)		{
			...
			super.commonDao.insert("s_otr100ukrv_kdServiceImpl.insertDetail", param);
		}		
	...
	public List<Map> updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param: paramList)		{
			...
			super.commonDao.insert("s_otr100ukrv_kdServiceImpl.updateDetail", param);
		}		
	...
	private void  checkProgress(Map param, String oprType, LoginVO user)  throws Exception {
		...
		obj = (Map<String, Object>)super.commonDao.select("s_otr100ukrv_kdServiceImpl.checkProgress", param);
...
///////////==========================================================
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("s_otr100ukrv_kdServiceImpl.itemInfo", param);
	...
	public ExtDirectFormPostResult syncMaster(S_otr100ukrv_kdModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);
		
		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("s_otr100ukrv_kdServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("s_otr100ukrv_kdServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("s_otr100ukrv_kdServiceImpl.updateMaster", paramMap);
		}
		
		super.commonDao.update("s_otr100ukrv_kdServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(S_otr100ukrv_kdModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			...
			//수불정보 update
			super.commonDao.queryForObject("s_otr100ukrv_kdServiceImpl.checkOrderType", param);
		}
	}
	

	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("s_otr100ukrv_kdServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("s_otr100ukrv_kdServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA100 = (List<Map<String, Object>>)super.commonDao.list("s_otr100ukrv_kdServiceImpl.checkSSA100", param);
		        if(ObjUtils.isEmpty(checkListSSA100))	{
		        	...
		        	for(Map<String, Object> checkSSA100 : checkListSSA100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_otr100ukrv_kdServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("s_otr100ukrv_kdServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_otr100ukrv_kdServiceImpl.updateSRQ100", paramSRQ100);
    ...
    public List<Map> printList(Map param, LoginVO user) throws Exception {
        return super.commonDao.list("s_otr100ukrv_kdServiceImpl.printList", param);
    }
}
