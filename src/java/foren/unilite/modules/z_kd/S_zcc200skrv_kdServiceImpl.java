...
@Service("s_zcc200skrv_kdService")
public class S_zcc200skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_zcc200skrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> selectDetail1(Map param) throws Exception {
            return super.commonDao.list("s_zcc200skrv_kdService.selectDetail1", param);
        }

        @ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)      // 디테일 조회
        public List<Map<String, Object>> selectDetail2(Map param) throws Exception {
            return super.commonDao.list("s_zcc200skrv_kdService.selectDetail2", param);
        }
       ...
       public List<Map<String, Object>> selectGwData(Map param) throws Exception {
           return super.commonDao.list("s_zcc200skrv_kdService.selectGwData", param);
       }
       ...
       public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
           return super.commonDao.list("s_zcc200skrv_kdService.makeDraftNum", param);
       }
}
