...
@Service("s_ryt600ukrv_kdService")
public class S_ryt600ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_ryt600ukrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> selectMasterData(Map param) throws Exception {
            return super.commonDao.list("s_ryt600ukrv_kdService.selectMasterData", param);
        }
        ...
        public Integer insertDetail(List<Map> paramList, LoginVO user) throws Exception {
            for(Map param : paramList ) {
                super.commonDao.update("s_ryt600ukrv_kdService.insertDetail", param);
            }      
            return 0;
        } 
        ...
        public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
            ...
            for(Map param :paramList ) {   
                super.commonDao.update("s_ryt600ukrv_kdService.updateDetail", param);
            }
            return 0;
        } 
        ...
        public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                super.commonDao.update("s_ryt600ukrv_kdService.deleteDetail", param);
            }
            return 0;
        } 
}
