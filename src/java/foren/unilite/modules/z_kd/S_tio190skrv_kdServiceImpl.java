...
@Service("s_tio190skrv_kdService")
public class S_tio190skrv_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList(Map param) throws Exception {
        return super.commonDao.list("s_tio190skrv_kdService.selectList", param);
    }
    ...
    public List<Map<String, Object>> selectGwData(Map param) throws Exception {
        return super.commonDao.list("s_tio190skrv_kdService.selectGwData", param);
    }
    ...
    public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
        return super.commonDao.list("s_tio190skrv_kdService.makeDraftNum", param);
    }    
}