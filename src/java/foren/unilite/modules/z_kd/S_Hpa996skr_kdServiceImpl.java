...
@Service( "s_hpa996skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hpa996skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hpa996skr_kdServiceImpl.selectList", param);
    }
}
