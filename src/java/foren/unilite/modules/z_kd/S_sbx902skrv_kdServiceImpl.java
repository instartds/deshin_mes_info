...
@Service("s_sbx902skrv_kdService")
public class S_sbx902skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_sbx902skrv_kdService.selectList", param);
        }
}
