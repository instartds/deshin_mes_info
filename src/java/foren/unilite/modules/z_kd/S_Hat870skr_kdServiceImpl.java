...
@Service( "s_hat870skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hat870skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hat870skr_kdServiceImpl.selectList", param);
    }
}
