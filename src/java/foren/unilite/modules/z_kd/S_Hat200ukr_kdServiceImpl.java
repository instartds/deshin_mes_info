...
@Service("s_hat200ukr_kdService")
public class S_Hat200ukr_kdServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO loginVO) throws Exception {
		...
		List dutyCode = (List)super.commonDao.list("s_hat200ukr_kdServiceImpl.selectDutycode" ,loginVO.getCompCode());
		param.put("DUTY_CODE", dutyCode);
		List vrecord2 = (List)super.commonDao.list("s_hat200ukr_kdServiceImpl.vrecord2" ,param);
		...
		Map fnCheckCloseDate = (Map) super.commonDao.select("s_hat200ukr_kdServiceImpl.fnCheckCloseMonth", param);
		...
		return (List) super.commonDao.list("s_hat200ukr_kdServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectList2(Map param, LoginVO loginVO) throws Exception {
		return (List) super.commonDao.list("s_hat200ukr_kdServiceImpl.selectList2", param);
	}
	...
	public List<Map> updateHat200(List<Map> param, LoginVO loginVO, Map paramMaster) throws Exception {
        ...
        Map fnCheckCloseDate = (Map) super.commonDao.select("s_hat200ukr_kdServiceImpl.fnCheckCloseMonth", tempParam);
        ...
        List<Map> dutyCode = (List)super.commonDao.list("s_hat200ukr_kdServiceImpl.selectDutycode" ,loginVO.getCompCode());
		...
		List<Map> fnHat200Set = (List)super.commonDao.list("s_hat200ukr_kdServiceImpl.fnHat200Set" ,fnHat200SetMap);
		...
		for(int x=0; x< param.size();x++){			
			...
			super.commonDao.list("s_hat200ukr_kdServiceImpl.update", map2);
	...
	public List<Map> deleteHat200(List<Map> deleteList,LoginVO loginVO, Map paramMaster) throws Exception {		
		...
		for(Map param :deleteList )	{
			//if(param.get("FLAG").equals("U")){
				...
				super.commonDao.list("s_hat200ukr_kdServiceImpl.delete", param);
//				System.out.println(paramList.toString());
	...
	public List<Map> wirteCheck(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("s_hat200ukr_kdServiceImpl.wirteCheck", param);
	}	
	/**
	 * 근태코드 조회
	 * @param param
	...
	public List selectDutycode(String comp_code) throws Exception {
		return (List)super.commonDao.list("s_hat200ukr_kdServiceImpl.selectDutycode" ,comp_code);
	}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("s_hat200ukr_kdServiceImpl.selectExcelUploadSheet1", param);
    }
    ...
    public List<Map<String, Object>> selectExcelUploadApply(Map param) throws Exception {
        return super.commonDao.list("s_hat200ukr_kdServiceImpl.selectExcelUploadApply", param);
    }
    
    public void excelValidate(String jobID, Map param) {                            // 엑셀 Validate
        logger.debug("validate: {}", jobID);
        super.commonDao.update("s_hat200ukr_kdServiceImpl.excelValidate", param);
    }
	...
	public Map fnCheckCloseMonth(LoginVO loginVO) throws Exception {		
        ...
        return (Map) super.commonDao.select("s_hat200ukr_kdServiceImpl.fnCheckCloseMonth", tempParam);
