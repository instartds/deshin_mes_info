...
@Service("s_ryt530skrv_kdService")
public class S_ryt530skrv_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> getMonthDiff(Map param) throws Exception {
        return super.commonDao.list("s_ryt530skrv_kdService.getMonthDiff", param);
    }
    
    @ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)      // 조회(temp)
    public List<Map<String, Object>> selectList(Map param) throws Exception {
        return super.commonDao.list("s_ryt530skrv_kdService.selectList", param);
    }
   ...
   public List<Map<String, Object>> selectGwData(Map param) throws Exception {
       return super.commonDao.list("s_ryt530skrv_kdService.selectGwData", param);
   }
   ...
   public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
       return super.commonDao.list("s_ryt530skrv_kdService.makeDraftNum", param);
   }
   
   @ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)
   public List<Map<String, Object>> editMonth(Map param) throws Exception {
       return super.commonDao.list("s_ryt530skrv_kdService.editMonth", param);
   }
