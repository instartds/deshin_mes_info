...
@Service( "s_hum510skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hum510skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hum510skr_kdServiceImpl.selectList", param);
    }
}
