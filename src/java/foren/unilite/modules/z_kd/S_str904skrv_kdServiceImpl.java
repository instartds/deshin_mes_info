...
@Service("s_str904skrv_kdService")
public class S_str904skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_str904skrv_kdService.selectList", param);
        }
