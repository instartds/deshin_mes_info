...
@Service("s_zbb300ukrv_kdService")
public class S_zbb300ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_zbb300ukrv_kdService.selectList", param);
        }
        ...
        public List<Map> insertList(List<Map> paramList, LoginVO user, String addFid, String delFid) throws Exception {     
            ...
            for(Map param :paramList ) {
                docNum = (Map)super.commonDao.select("s_zbb300ukrv_kdService.insertList", param);
...
//                  fileMnagerService.confirmFile(user, ObjUtils.getSafeString(param.get("ADD_FID")));
        ...
        public Integer updateList(List<Map> paramList, LoginVO user, String addFid, String delFid) throws Exception {
            ...
            for(Map param :paramList ) {  
                ...
                this.insertBDC101(param);
                super.commonDao.update("s_zbb300ukrv_kdService.updateList", param);
            }
            return 0;
        } 
        ...
        public Integer deleteList(List<Map> paramList,  LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                List<Map> delFileList = (List<Map>) super.commonDao.list("s_zbb300ukrv_kdService.getDelFileId", param);
                ...
                super.commonDao.update("s_zbb300ukrv_kdService.deleteList", param);
            }
            return 0;
        } 
        ...
        public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
            ...
            return super.commonDao.list("s_zbb300ukrv_kdService.getFileList", param);
        }
        ...
        private void insertBDC101(Map param) throws Exception {
             ...
             for(String fid : fids) {
                 param.put("FID", fid);
                 super.commonDao.insert("s_zbb300ukrv_kdService.insertBDC101", param);
             }
        }
        ...
        private void deleteBDC101(Map param) throws Exception {
            String[] fids =  ObjUtils.getSafeString(param.get("DEL_FIDS")).split(",");
             for(String fid : fids) {
                 param.put("FID", fid);
                 super.commonDao.update("s_zbb300ukrv_kdService.deleteBDC101", param);
             }
        }
}
