...
@Service("s_pmp201ukrv_kdService")
public class S_pmp201ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectAgreePrsn(Map param) throws Exception {
		return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.selectAgreePrsn", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.selectMaster", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.selectOrderNumMaster", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.selectEstiList", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> orderApply(Map param) throws Exception {
		return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.orderApply", param);		// 참조 팝업 적용버튼 클릭시
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> orderApply2(Map param) throws Exception {
		return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.orderApply2", param);		// 참조 팝업 적용버튼 클릭시2
	}
    ...
    public List<Map<String, Object>> selectGwData(Map param) throws Exception {
        return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.selectGwData", param);
    }
    ...
    public List<Map<String, Object>> selectDraftNo(Map param) throws Exception {
        return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.selectDraftNo", param);
    }
    ...
    public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
        return super.commonDao.list("s_pmp201ukrv_kdServiceImpl.makeDraftNum", param);
    }
    ...
    public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
     ...
     for(Map paramData: paramList) {
         ...
         for(Map param:  dataList) {
           ...
           param.put("data", super.commonDao.insert("s_pmp201ukrv_kdServiceImpl.insertLogMaster", param));
         }
     }
   //4.매출저장 Stored Procedure 실행
           ...
           super.commonDao.queryForObject("s_pmp201ukrv_kdServiceImpl.spReceiving", spParam);
