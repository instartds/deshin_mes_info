...
@Service("s_sbx900ukrv_kdService")
public class S_sbx900ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_sbx900ukrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> selectList2(Map param) throws Exception {
            return super.commonDao.list("s_sbx900ukrv_kdService.selectList2", param);
        }
        ...
        public List<Map<String, Object>> selectList3(Map param) throws Exception {
            return super.commonDao.list("s_sbx900ukrv_kdService.selectList3", param);
        }
        ...
        public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
            ...
            for(Map paramData: paramList) {
                ...
                for(Map param:  dataList) {
                    ...
                    super.commonDao.update("s_sbx900ukrv_kdService.spReceiving", param);
                }
            }
      ...
      public  List<ComboItemModel> selectZ0031(Map param) throws Exception {
          return super.commonDao.list("s_sbx900ukrv_kdService.selectZ0031", param);
      }
      ...
      public  List<ComboItemModel> selectZ0032(Map param) throws Exception {
          return super.commonDao.list("s_sbx900ukrv_kdService.selectZ0032", param);
      }
      ...
      public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
  		  return super.commonDao.list("s_sbx900ukrv_kdService.selectExcelUploadSheet1", param);
  	  }
      public void excelValidate(String jobID, Map param) throws Exception {
  		logger.debug("validate: {}", jobID);
  		//UPLOAD 전 데이터 존재여부 체크
  		List<Map> getData = (List<Map>) super.commonDao.list("s_sbx900ukrv_kdService.getData", param);
