...
@Service("s_zbb200ukrv_kdService")
public class S_zbb200ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_zbb200ukrv_kdService.selectList", param);
        }
        ...
        public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
            ...
            if(paramList != null)  {
                   ...
                   if(updateList != null) this.updateDetail(updateList, user, addFid, delFid);
                   if(insertList != null) this.insertDetail(insertList, user, addFid, delFid);
               }
        ...
        public List<Map> insertDetail(List<Map> paramList, LoginVO user, String addFid, String delFid) throws Exception {
            for(Map param :paramList ) {
                docNum = (Map)super.commonDao.select("s_zbb200ukrv_kdService.insertDetail", param);
...
//            return 0;
        ...
        public Integer updateDetail(List<Map> paramList, LoginVO user, String addFid, String delFid) throws Exception {
            ...
            for(Map param :paramList ) {
                ...
                super.commonDao.update("s_zbb200ukrv_kdService.updateDetail", param);
            }
            return 0;
        } 
        ...
        public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {
                List<Map> delFileList = (List<Map>) super.commonDao.list("s_zbb200ukrv_kdService.getDelFileId", param);
                ...
                super.commonDao.update("s_zbb200ukrv_kdService.deleteDetail", param);
            }
            return 0;
        }
        ...
        public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
            ...
            return super.commonDao.list("s_zbb200ukrv_kdService.getFileList", param);
        }
        ...
        private void insertBDC101(Map param) throws Exception {
             ...
             for(String fid : fids) {
                 param.put("FID", fid);
                 super.commonDao.insert("s_zbb200ukrv_kdService.insertBDC101", param);
             }
        }
        ...
        private void deleteBDC101(Map param) throws Exception {
            String[] fids =  ObjUtils.getSafeString(param.get("DEL_FIDS")).split(",");
             for(String fid : fids) {
                 param.put("FID", fid);
                 super.commonDao.update("s_zbb200ukrv_kdService.deleteBDC101", param);
             }
        }        
}
