...
@Service("s_zdd300skrv_kdService")
public class S_zdd300skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_zdd300skrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
            ...
            return super.commonDao.list("s_zdd300skrv_kdService.getFileList", param);
        }
}
