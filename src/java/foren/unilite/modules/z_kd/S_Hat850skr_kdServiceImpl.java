...
@Service( "s_hat850skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hat850skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hat850skr_kdServiceImpl.selectList", param);
    }
}
