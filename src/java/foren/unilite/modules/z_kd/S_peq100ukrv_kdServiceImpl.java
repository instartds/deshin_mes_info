...
@Service("s_peq100ukrv_kdService")
public class S_peq100ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_peq100ukrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> selectList2(Map param) throws Exception {
            return super.commonDao.list("s_peq100ukrv_kdService.selectList2", param);
        }
        ...
        public Integer insertDetail(List<Map> paramList, LoginVO user) throws Exception {
            ...
            for(Map param :paramList ) {   
                super.commonDao.update("s_peq100ukrv_kdService.insertDetail", param);
        ...
        public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                super.commonDao.update("s_peq100ukrv_kdService.updateDetail", param);
        ...
        public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                super.commonDao.update("s_peq100ukrv_kdService.deleteDetail", param);
