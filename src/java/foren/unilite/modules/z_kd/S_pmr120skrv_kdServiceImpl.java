...
@Service("s_pmr120skrv_kdService")
public class S_pmr120skrv_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList(Map param) throws Exception {
        return super.commonDao.list("s_pmr120skrv_kdService.selectList", param);
    }
}