...
@Service("s_zbb600skrv_kdService")
public class S_zbb600skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_zbb600skrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
            ...
            return super.commonDao.list("s_zbb600skrv_kdService.getFileList", param);
        }
}
