...
@Service("s_ryt200skrv_kdService")
public class S_ryt200skrv_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList(Map param) throws Exception {
        return super.commonDao.list("s_ryt200skrv_kdService.selectList", param);
    }
    ...
    public List<Map> printList(Map param, LoginVO user) throws Exception {
        return super.commonDao.list("s_ryt200skrv_kdService.printList", param);
    }    
}