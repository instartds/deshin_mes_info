...
@Service("s_str903skrv_kdService")
public class S_str903skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_str903skrv_kdService.selectList", param);
        }
        ...
        public List<Map<String, Object>> selectGwData(Map param) throws Exception {
            return super.commonDao.list("s_str903skrv_kdService.selectGwData", param);
        }
}
