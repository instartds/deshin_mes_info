...
@Service("s_bco100skrv_kdService")
public class S_bco100skrv_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList(Map param) throws Exception {
        return super.commonDao.list("s_bco100skrv_kdService.selectList", param);
    }	
    ...
    public List<Map<String, Object>> selectDraftNo(Map param) throws Exception {
        return super.commonDao.list("s_bco100skrv_kdService.selectDraftNo", param);
    }
}
