...
@Service("s_str901skrv_kdService")
public class S_str901skrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_str901skrv_kdService.selectList", param);
        }
