...
@Service( "s_axt110skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Axt110skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_axt110skr_kdService.selectList", param);
    }
}
