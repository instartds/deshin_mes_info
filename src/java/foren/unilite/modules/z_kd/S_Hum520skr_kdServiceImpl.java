...
@Service( "s_hum520skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hum520skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hum520skr_kdServiceImpl.selectList", param);
    }
}
