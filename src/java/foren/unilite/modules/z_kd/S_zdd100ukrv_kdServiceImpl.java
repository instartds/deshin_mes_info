...
@Service("s_zdd100ukrv_kdService")
public class S_zdd100ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
    	 ...
    	 * @throws Exception
    	 */
    	public List<ComboItemModel> getEquipType(Map param) throws Exception {
    		return (List<ComboItemModel>) super.commonDao.list("s_zdd100ukrv_kdService.getEquipType", param);
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_zdd100ukrv_kdService.selectList", param);
        }
        ...
        public Integer updateList(List<Map> paramList, LoginVO user) throws Exception {
            ...
            for(Map param :paramList ) {  
                super.commonDao.update("s_zdd100ukrv_kdService.updateList", param);
            }
            return 0;
        } 
}
