...
@Service( "s_hat900skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hat900skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hat900skr_kdServiceImpl.selectList", param);
    }
}
