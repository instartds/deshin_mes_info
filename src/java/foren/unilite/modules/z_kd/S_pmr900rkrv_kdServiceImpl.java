...
@Service("s_pmr900rkrv_kdService")
public class S_pmr900rkrv_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList(Map param) throws Exception {
        return super.commonDao.list("s_pmr900rkrv_kdService.selectList", param);
    }
}