...
@Service("s_ryt400ukrv_kdService")
public class S_ryt400ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
        ...
        public List<Map<String, Object>> selectList(Map param) throws Exception {
            return super.commonDao.list("s_ryt400ukrv_kdService.selectList", param);
        }
        
        @ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)      // 검색팝업창 조회
        public List<Map<String, Object>> selectList2(Map param) throws Exception {
            return super.commonDao.list("s_ryt400ukrv_kdService.selectList2", param);
        }
        ...
        public List<Map<String, Object>> beforeSaveDelete(Map param) throws Exception {
            return super.commonDao.list("s_ryt400ukrv_kdService.beforeSaveDelete", param);
        }
        ...
        public List<Map<String, Object>> selectList3(Map param) throws Exception {
            return super.commonDao.list("s_ryt400ukrv_kdService.selectList3", param);
        }
        ...
        public List<Map<String, Object>> selectMasterData(Map param) throws Exception {
            return super.commonDao.list("s_ryt400ukrv_kdService.selectMasterData", param);
        }
        ...
        public Integer insertDetail(List<Map> paramList, LoginVO user) throws Exception {
            for(Map param : paramList ) {
                super.commonDao.update("s_ryt400ukrv_kdService.insertDetail", param);
            }      
            return 0;
        } 
        ...
        public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
            ...
            for(Map param :paramList ) {   
                super.commonDao.update("s_ryt400ukrv_kdService.updateDetail", param);
            }
            return 0;
        }
        ...
        public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
            Map compCodeMap = new HashMap();
            for(Map param :paramList ) {   
                super.commonDao.update("s_ryt400ukrv_kdService.deleteDetail", param);
            }
            return 0;
        } 
}
