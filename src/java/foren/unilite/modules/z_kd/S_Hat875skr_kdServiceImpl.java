...
@Service( "s_hat875skr_kdService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class S_Hat875skr_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("s_hat875skr_kdServiceImpl.selectList", param);
    }
}
