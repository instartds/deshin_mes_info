...
@Service("s_str103ukrv_kdService")
@SuppressWarnings({"unchecked", "rawtypes"})
public class S_str103ukrv_kdServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_kdServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_kdServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectRequestiList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_kdServiceImpl.selectRequestiList", param);
	}
	...
	public List<Map<String, Object>> selectSalesOrderList(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_kdServiceImpl.selectSalesOrderList", param);
	}
	/**
	 * 
	 * 창고조회
	...
	public Object  deptWhcode(Map param) throws Exception {	
		...
		return  super.commonDao.select("s_str103ukrv_kdServiceImpl.deptWhcode", param);
	}
	/**
	 * 출고정보 저장
...
//				param.put("PICK_STATUS", "");			
				param.put("data", super.commonDao.insert("s_str103ukrv_kdServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("s_str103ukrv_kdServiceImpl.spReceiving", spParam);
...
//		}
	 ...
	 */
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectStockMove(Map param) throws Exception {
		return super.commonDao.list("s_str103ukrv_kdServiceImpl.selectStockMove", param);
	}
