...
@Service("s_ryt510skrv_kdService")
public class S_ryt510skrv_kdServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList(Map param) throws Exception {
        return super.commonDao.list("s_ryt510skrv_kdService.selectList", param);
    }
    
    @ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)      // 조회(temp)
    public List<Map<String, Object>> selectList2(Map param) throws Exception {
        return super.commonDao.list("s_ryt510skrv_kdService.selectList2", param);
    }
   ...
   public List<Map<String, Object>> selectGwData(Map param) throws Exception {
       return super.commonDao.list("s_ryt510skrv_kdService.selectGwData", param);
   }
   ...
   public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
       return super.commonDao.list("s_ryt510skrv_kdService.makeDraftNum", param);
   }
