...
@Service("s_pms401ukrv_jwService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_Pms401ukrv_jwServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("s_pms401ukrv_jwServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("s_pms401ukrv_jwServiceImpl.selectDetail", param);
	}
	...
	public List<Map<String, Object>> selectCheckItem(Map param) throws Exception {
		return super.commonDao.list("s_pms401ukrv_jwServiceImpl.selectCheckItem", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_pms401ukrv_jwServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("s_pms401ukrv_jwServiceImpl.selectEstiList", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				param.put("data", super.commonDao.insert("s_pms401ukrv_jwServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("s_pms401ukrv_jwServiceImpl.spReceiving", spParam);
	...
	public List<Map> saveAll2(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				param.put("KEY_VALUE", keyValue);
				param.put("OPR_FLAG", oprFlag);
				param.put("data", super.commonDao.insert("s_pms401ukrv_jwServiceImpl.insertLogMaster2", param));
			}
		}
