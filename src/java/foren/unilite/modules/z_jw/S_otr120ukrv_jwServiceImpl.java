...
@Service("s_otr120ukrv_jwService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_otr120ukrv_jwServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectMasterList", param);		// 조회
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectDetailList", param);		// 검색
	}
	...
	public List<Map<String, Object>> selectDetail2(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectDetailList2", param);		// 미입고참조
	}
	...
	public List<Map<String, Object>> selectDetail3(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectDetailList3", param);		// 반품가능발주참조
	}
	...
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetail4(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectDetailList4", param);		// 검사결과참조
	}
	*/
	...
	public List<Map<String, Object>> selectDetail4(Map param) throws Exception {
		...
		if(ObjUtils.getSafeString(param.get("WINDOW_FLAG")).equals("inspectResult")){	// 검사결과
			resultList = super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectDetailList4", param);
		}else{ // 무검사
			resultList = super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectNoDetailList4", param);
		}
		return resultList;
	...
	public Object selectGetOrderPrice(Map param) throws Exception {
		return super.commonDao.select("s_otr120ukrv_jwServiceImpl.selectGetOrderPrice", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public Object selectStockQ(Map param) throws Exception {
		return super.commonDao.select("s_otr120ukrv_jwServiceImpl.selectStockQ", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectRefList", param);
	}
	...
	public List<Map<String, Object>> selectClipList(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectClipList", param);
	}
...
//						throw new  UniDirectValidateException("입고유형이 금액보정이 아닐때  구매단가가 0 이거나 0보다 작을 수 없습니다");
						...
						for(int j = 0; j < roofcount; j++) {
							//LOT_NO 자동채번
							String newLotNo = (String) super.commonDao.select("s_otr120ukrv_jwServiceImpl.fnGetLotNo", param);
							...
							param.put("data", super.commonDao.insert("s_otr120ukrv_jwServiceImpl.insertLogDetail", param));
							inoutSeq++;
						}
					}
					...
					} else if("D".equals(oprFlag)) {
						param.put("data", super.commonDao.insert("s_otr120ukrv_jwServiceImpl.insertLogDetail", param));
						
					} else {
						param.put("data", super.commonDao.insert("s_otr120ukrv_jwServiceImpl.updateLogDetail", param));
					}
				}
			}
		}
	    ...
	    super.commonDao.queryForObject("s_otr120ukrv_jwServiceImpl.sps_otr120ukrv_jw", spParam);
...
//		for(Map param : paramList )	{
		if(!ObjUtils.isEmpty(ErrorDesc)){
			...
			if(messsage.length == 1){
				...
				throw new  UniDirectValidateException(this.getMessage(messsage[0], user) + messsage[1]);
			}
		...
		public void deleteMaster(Map param, LoginVO user) throws Exception {
			...
			super.commonDao.delete("s_otr120ukrv_jwServiceImpl.deleteMaster", param);
		}
		...
		private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
			if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
				...
				checkProgress(param, "Master", user);
				//수불정보 update
				super.commonDao.queryForObject("s_otr120ukrv_jwServiceImpl.checkOrderType", param);
			}
		}
		...
		public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
			for(Map param: params)		{
				Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkSerNo", param);
				if(!ObjUtils.isEmpty(checkSerNo))	{
					Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.autoSerNo", param);
					param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
				}
				beforeSaveDetail(param, user, "insert");
				super.commonDao.insert("s_otr120ukrv_jwServiceImpl.insertDetail", param);
			}		
	...
	public Map<String, Object> saveMaster(Map<String, Object> paramMap, LoginVO user) throws Exception {
		...
		if (ObjUtils.isEmpty(paramMap.get("INOUT_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.autoNum", paramMap);
			String OrderNum = ObjUtils.getSafeString(autoNum.get("INOUT_NUM"));				
			paramMap.put("INOUT_NUM", OrderNum);
			beforeSaveMaster(paramMap, user);
			super.commonDao.insert("s_otr120ukrv_jwServiceImpl.insertMaster", paramMap);
			
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("s_otr120ukrv_jwServiceImpl.updateMaster", paramMap);
		}
		
		super.commonDao.update("s_otr120ukrv_jwServiceImpl.updatePrice", paramMap);
		
		
		return paramMap;
	}
	
	private Map<String, Object> makeMapParam(S_otr120ukrv_jwModel param, LoginVO user)	{
	...
	public List<Map> insertDetails(List<Map> params, Map<String,  Object> paramMap, LoginVO user) throws Exception {
		for(Map param: params)		{
			param.put("INOUT_NUM", paramMap.get("INOUT_NUM")); //master 의 수주번호
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("s_otr120ukrv_jwServiceImpl.updateDetail", param);
		}		
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA120 = (List<Map<String, Object>>)super.commonDao.list("s_otr120ukrv_jwServiceImpl.checkSSA120", param);
		        if(ObjUtils.isEmpty(checkListSSA120))	{
		        	...
		        	for(Map<String, Object> checkSSA120 : checkListSSA120)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_otr120ukrv_jwServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("s_otr120ukrv_jwServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_otr120ukrv_jwServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("s_otr120ukrv_jwServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("s_otr120ukrv_jwServiceImpl.checkDeleteAllDetail", params.get(0)); 
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_otr120ukrv_jwServiceImpl.checkEstimate", param);
		
		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{					
						super.commonDao.update("s_otr120ukrv_jwServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("s_otr120ukrv_jwServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_otr120ukrv_jwServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{	
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("s_otr120ukrv_jwServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("s_otr120ukrv_jwServiceImpl.checkProgressDetail", param);
		}
		
		if(ObjUtils.isEmpty(obj))	{
			throw new  UniDirectValidateException(this.getMessage("54400", user));	/* 54400:이미 삭제된 자료입니다.(영업공통)*/
		} else {
			if(ObjUtils.parseDouble(obj.get("ISSUE_REQ_Q")) > 0)	{
				throw new  UniDirectValidateException(this.getMessage("54460", user));	/* 54460:출하지시가 진행중인 수주내역을 수정/삭제할 수 없습니다.*/
			}
			
			if(ObjUtils.parseDouble(obj.get("SALE_Q")) > 0)	{
				throw new  UniDirectValidateException(this.getMessage("54412", user));	/* 54460:출고가 진행중인 수주내역은 삭제가 불가능합니다.(수주내역 삭제시)*/
			}
			
			if(ObjUtils.parseDouble(obj.get("RETURN_Q")) > 0)	{
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectExcelUploadSheet1", param);
    }
	...
	/**
	 * 외주입고 등록(JW) (s_otr120ukrv_jw)-> 입고내역  DETAIL 조회 
	 */
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return super.commonDao.list("s_otr120ukrv_jwServiceImpl.selectList2", param);
	}

	/**
	 * 외주입고 등록(JW) (s_otr120ukrv_jw)-> detail 저장
	 * @param paramList	리스트의 create, update, destroy 오퍼레이션별 정보
	 * @param paramMaster 폼(마스터 정보)의 기본 정보
	 * @param CreateType 
	 * @return 전달받은 파라미터 data 를 갱신하여 돌려준다.
...
//						throw new  UniDirectValidateException("입고유형이 금액보정이 아닐때  구매단가가 0 이거나 0보다 작을 수 없습니다");
		...
		//4.외주입고 등록(JW) Stored Procedure 실행
		Map<String, Object> spParam = new HashMap<String, Object>();
		Map<String, Object> dataMaster = (Map<String, Object>) paramMaster.get("data");
		spParam.put("KeyValue", keyValue);
		spParam.put("LangCode", user.getLanguage());
