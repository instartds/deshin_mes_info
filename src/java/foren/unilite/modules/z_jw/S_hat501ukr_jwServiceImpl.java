...
@Service( "s_hat501ukr_jwService" )
public class S_hat501ukr_jwServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> select( Map param, LoginVO loginVO ) throws Exception {
            ...
            return (List)super.commonDao.list("s_hat501ukr_jwServiceImpl.selectList", param);
//        } else {
...
//        }
    ...
    public String getDutyRule( String comp_code ) throws Exception {
        DutyRule = (String)super.commonDao.selectByPk("s_hat501ukr_jwServiceImpl.getDutyRule", comp_code);
        return DutyRule;
    }
    ...
    public List getAllDutycode( Map param ) throws Exception {
        return (List)super.commonDao.list("s_hat501ukr_jwServiceImpl.getAllDutycode", param);
    }
    ...
    public List getDutycode( Map param ) throws Exception {
        return (List)super.commonDao.list("s_hat501ukr_jwServiceImpl.getDutycode", param);
    }
    ...
    public List<ComboItemModel> getComboList( Map param ) throws Exception {
        return (List<ComboItemModel>)super.commonDao.list("s_hat501ukr_jwServiceImpl.getComboList", param);
    ...
    public List<Map> insertList( List<Map> paramList, LoginVO user ) throws Exception {
        try {
            for (Map param : paramList) {
                super.commonDao.insert("s_hat501ukr_jwServiceImpl.insertList", param);
            }
        } catch (Exception e) {
    ...
    public List<Map> updateList( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.update("s_hat501ukr_jwServiceImpl.updateList", param);
        }
        return paramList;
    }
    ...
    public List<Map> deleteList( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.delete("s_hat501ukr_jwServiceImpl.deleteList", param);
        }
        return paramList;
    }
    ...
    @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "hat")
   	...
   	public Map<String, Object> procSP( Map param, LoginVO user ) throws Exception {
		...
		super.commonDao.queryForObject("s_hat501ukr_jwServiceImpl.procSP", spParam);
    ...
    public String selectExcelUploadSheet1(Map<String, Object> param, LoginVO loginVO) throws Exception {
        ...
        String dutyDate = (String) super.commonDao.select("s_hat501ukr_jwServiceImpl.selectExcelUploadSheet1", param);
        String keyValue = (String) super.commonDao.select("s_hat501ukr_jwServiceImpl.selectExcelUploadSheet2", param);
		        ...
		        Map ErrorMap = (Map) super.commonDao.select("s_hat501ukr_jwServiceImpl.insertSP",param);
	...
	public void excelValidate(String jobID, Map param) throws Exception {
		...
		List<Map> getData = (List<Map>) super.commonDao.list("s_hat501ukr_jwServiceImpl.getData", param);
	...
	public List selectDutycode(String comp_code) throws Exception {
		return (List)super.commonDao.list("s_hat501ukr_jwServiceImpl.selectDutycode" ,comp_code);
	}
