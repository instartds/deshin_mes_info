...
@Service("s_mpo200ukrv_jwService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_mpo200ukrv_jwServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> gridUp(Map param) throws Exception {
		return super.commonDao.list("s_mpo200ukrv_jwServiceImpl.gridUp", param);
	}
	...
	public List<Map<String, Object>> gridDown(Map param) throws Exception {
		...
		return super.commonDao.list("s_mpo200ukrv_jwServiceImpl.gridDown", param);
	}
	...
	public List<Map<String, Object>> selectAdjustList(Map param) throws Exception {   
		List<Map> chkList = (List) super.commonDao.list("s_mpo200ukrv_jwServiceImpl.selectAdjustList1", param);
		String BaseDates = "";
		String FromItems = "";
		...
		return super.commonDao.list("s_mpo200ukrv_jwServiceImpl.selectAdjustList2", param);
	}
	...
	public List<Map> orderConfirm(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				if("Y".equals(param.get("SAVE_FLAG"))) {
					saveFlag = "Y";
					if(i == 0){
						param.put("data", super.commonDao.update("s_mpo200ukrv_jwServiceImpl.insertLogMaster", param));
					}
					param.put("data", super.commonDao.update("s_mpo200ukrv_jwServiceImpl.insertLogDetail", param));
				}
				i++;
			}
		}
		...
		if("Y".equals(saveFlag)) {
			...
			super.commonDao.queryForObject("s_mpo200ukrv_jwServiceImpl.USP_MATRL_Mpo200ukr", spParam);
...
//		}
	...
	public Integer updateDetail(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map param :paramList ) {
			if(i == 0){
				super.commonDao.update("s_mpo200ukrv_jwServiceImpl.insertLogMaster", param);
			}
			super.commonDao.update("s_mpo200ukrv_jwServiceImpl.insertLogMaster", param);
			i++;
		}
	...
	public void updateAdjust(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		for(Map param :paramList ) {
			 super.commonDao.update("s_mpo200ukrv_jwServiceImpl.updateAdjust", param);
		}
		return;
	}
	...
	public void deleteAdjust(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("s_mpo200ukrv_jwServiceImpl.deleteAdjust", param);
		}
		return;
	}
}