...
@Service("s_sof100ukrv_jwService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_Sof100ukrv_jwServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectGsDvry(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_jwServiceImpl.selectGsDvry", param);
	}
    ...
    public List<Map<String, Object>> fnExchgRateO(Map param) throws Exception {
        return super.commonDao.list("s_sof100ukrv_jwServiceImpl.fnExchgRateO", param);
    }
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_jwServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_jwServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_jwServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_jwServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_jwServiceImpl.selectEstiList", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_jwServiceImpl.selectRefList", param);
	}
	...
	public List<Map<String, Object>> getCustCredit(Map param) throws Exception {
		return super.commonDao.list("s_sof100ukrv_jwServiceImpl.getCustCredit", param);
	}
...
//		}
		...
		super.commonDao.insert("s_sof100ukrv_jwServiceImpl.insertLogMaster", dataMaster);
		...
		super.commonDao.queryForObject("s_sof100ukrv_jwServiceImpl.spSalesOrder", spParam);
	...
	public ExtDirectFormPostResult syncForm(S_Sof100ukrv_jwModel dataMaster,  LoginVO user,  BindingResult result) throws Exception {
...
//		super.commonDao.update("s_sof100ukrv_jwServiceImpl.updateMasterForm", dataMaster);
//		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
		return extResult;
	}
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("s_sof100ukrv_jwServiceImpl.insertLogDetail", param);
		}
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("s_sof100ukrv_jwServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(S_Sof100ukrv_jwModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);

		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("s_sof100ukrv_jwServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("s_sof100ukrv_jwServiceImpl.updateMaster", paramMap);
		}

		super.commonDao.update("s_sof100ukrv_jwServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(S_Sof100ukrv_jwModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag")))){
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("s_sof100ukrv_jwServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("s_sof100ukrv_jwServiceImpl.insertDetail", param);
		}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("s_sof100ukrv_jwServiceImpl.updateDetail", param);
		}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("s_sof100ukrv_jwServiceImpl.checkSSA110", param);
		        if(ObjUtils.isEmpty(checkListSSA110))	{
		        	...
		        	for(Map<String, Object> checkSSA110 : checkListSSA110)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_sof100ukrv_jwServiceImpl.updateBTR100", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("s_sof100ukrv_jwServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_sof100ukrv_jwServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("s_sof100ukrv_jwServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("s_sof100ukrv_jwServiceImpl.checkDeleteAllDetail", params.get(0));
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_sof100ukrv_jwServiceImpl.checkEstimate", param);

		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{
						super.commonDao.update("s_sof100ukrv_jwServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("s_sof100ukrv_jwServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_sof100ukrv_jwServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("s_sof100ukrv_jwServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkProgressDetail", param);
		}
    ...
    public List<Map> selectExcelUploadSheet1(Map param) throws Exception {
    	...
    	List<Map> excelUploadMapList = super.commonDao.list("s_sof100ukrv_jwServiceImpl.selectExcelUploadSheet1", param);
	...
	public void excelValidate(String jobID, Map param) {
		...
		super.commonDao.update("s_sof100ukrv_jwServiceImpl.excelValidate", param);
	}
	...
	public Object  insertPurchaseRequest(Map spParam, LoginVO user) throws Exception {
		spParam.put("LangCode", user.getLanguage());
		super.commonDao.update("s_sof100ukrv_jwServiceImpl.callMakePurchaseOrder", spParam);
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));
	...
	public Object checkOfferNo(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_jwServiceImpl.checkOfferNo", param);
	}
	...
	public List<Map<String, Object>> getFileList(Map param,  LoginVO login) throws Exception {
		...
		return super.commonDao.list("s_sof100ukrv_jwServiceImpl.getFileList", param);
	}
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public void insertSOF102(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("ADD_FIDS")).split(",");
			 ...
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.insert("s_sof100ukrv_jwServiceImpl.insertSOF102", param);
			 }
	}
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public void deleteSOF102(Map param, LoginVO login) throws Exception {
			...
			String[] fids =  ObjUtils.getSafeString(param.get("DEL_FIDS")).split(",");
			 for(String fid : fids)	{
				 param.put("FID", fid);
				 super.commonDao.update("s_sof100ukrv_jwServiceImpl.deleteSOF102", param);
			 }
	}
	...
	public List<Map<String, Object>>  receiveSRM (Map param) throws Exception {
		return  super.commonDao.list("s_sof100ukrv_jwServiceImpl.receiveSRM", param);
	}
	...
	public String soToPoRequest (Map param, LoginVO user) throws Exception {
		...
		super.commonDao.queryForObject("s_sof100ukrv_jwServiceImpl.soToPoRequest", spParam);
		String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));
		if(!ObjUtils.isEmpty(errorDesc)){
	...
	public Object selectDocCnt(Map param) throws Exception {
		return super.commonDao.select("s_sof100ukrv_jwServiceImpl.selectDocCnt", param);
	}
}
