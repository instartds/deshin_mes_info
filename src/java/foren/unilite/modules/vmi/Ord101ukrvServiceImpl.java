...
@Service("ord101ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Ord101ukrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param,LoginVO user) throws Exception {
		...
		return  super.commonDao.list("ord101ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		Map getNum		= (Map) commonDao.select("ord101ukrvServiceImpl.getSoNum", dataMaster);
		...
		if(soSeq == 0) {
			super.commonDao.insert("ord101ukrvServiceImpl.insertMaster", dataMaster);
		} else {
			//20190830 추가: 최종 등록한 주문일자로 MASTER Data의 주문일 update
			dataMaster.put("SO_NUM", soNum);
			super.commonDao.update("ord101ukrvServiceImpl.updateMaster", dataMaster);
		}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user, String soNum, int soSeq, String customCode) throws Exception {
		for(Map param: params) {
			...
			if("Y".equals(param.get("SAVE_FLAG"))) {
				super.commonDao.update("ord101ukrvServiceImpl.insertDetail", param);
			}
		}
		return params;
	}
