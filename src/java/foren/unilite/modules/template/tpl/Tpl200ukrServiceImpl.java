...
@Service( "tpl200ukrService" )
public class Tpl200ukrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> select( Map param, LoginVO loginVO ) throws Exception {
        ...
        if ("N".equals((String)param.get("CSV_LOAD_YN"))) {
            return (List)super.commonDao.list("tpl200ukrServiceImpl.select", param);
        } else {
            ...
            try {
                ...
                while (( csvline = in.readLine() ) != null) {
                    ...
                    if(csvline.trim().length() > 0) {
                        ...
                        super.commonDao.update("tpl200ukrServiceImpl.insertCSV", iMap);
