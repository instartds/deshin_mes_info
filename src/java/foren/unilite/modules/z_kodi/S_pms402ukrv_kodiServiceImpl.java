...
@Service("s_pms402ukrv_kodiService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_pms402ukrv_kodiServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());


	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("s_pms402ukrv_kodiServiceImpl.selectMaster", param);
	}

	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("s_pms402ukrv_kodiServiceImpl.selectDetail", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_pms402ukrv_kodiServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("s_pms402ukrv_kodiServiceImpl.selectEstiList", param);
	}
	...
	public List<Map<String, Object>> selectTestListNew(Map param) throws Exception {
		return super.commonDao.list("s_pms402ukrv_kodiServiceImpl.selectTestListNew", param);
	}	
	...
	public String getTestResult(Map param) throws Exception {
		return (String) super.commonDao.select("s_pms402ukrv_kodiServiceImpl.getTestResult", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				param.put("data", super.commonDao.insert("s_pms402ukrv_kodiServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("s_pms402ukrv_kodiServiceImpl.spReceiving", spParam);
	...
	public List<Map> saveAll2(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				param.put("KEY_VALUE", keyValue);
				param.put("OPR_FLAG", oprFlag);
				param.put("data", super.commonDao.insert("s_pms402ukrv_kodiServiceImpl.insertLogMaster2", param));
			}
		}
	...
	public List<Map> copyAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.delete("s_pms402ukrv_kodiServiceImpl.testcodeDelete", dataMaster);
	...
	public List<Map> testcodeCopy(List<Map> params, LoginVO user) throws Exception {
		...
		for(Map param: params)		{
			super.commonDao.insert("s_pms402ukrv_kodiServiceImpl.testcodeCopy", param);
		}
		return params;
	}	
	...
	public List<Map<String, Object>>  inspecQtyCheck(Map param) throws Exception {
		return  super.commonDao.list("s_pms402ukrv_kodiServiceImpl.inspecQtyCheck", param);
	}
	...
	public List<ComboItemModel> getTestCode(Map param) throws Exception{
		return (List<ComboItemModel>) super.commonDao.list("s_pms402ukrv_kodiServiceImpl.getTestCode", param);
	}
