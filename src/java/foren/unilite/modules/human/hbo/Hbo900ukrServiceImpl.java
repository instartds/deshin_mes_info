...
@Service( "hbo900ukrServiceImpl" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hbo900ukrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param ) throws Exception {
        return (List)super.commonDao.list("hbo900ukrServiceImpl.selectList", param);
    }
    ...
    public List<Map> insertList( List<Map> paramList, LoginVO user ) throws Exception {
        try {
            for (Map param : paramList) {
                super.commonDao.insert("hbo900ukrServiceImpl.insertList", param);
            }
        } catch (Exception e) {
    ...
    public List<Map> updateList( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.update("hbo900ukrServiceImpl.updateList", param);
        }
        return paramList;
    }
    ...
    public List<Map> deleteList( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.delete("hbo900ukrServiceImpl.deleteList", param);
        }
        return paramList;
    }
