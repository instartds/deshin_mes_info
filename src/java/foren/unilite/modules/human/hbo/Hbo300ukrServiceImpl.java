...
@Service("hbo300ukrService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Hbo300ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO loginVO) throws Exception {
		...
		return (List) super.commonDao.list("hbo300ukrServiceImpl.selectList", param);
//		return null;
	}
	...
	public Map procHbo300(Map param, LoginVO loginVO) throws Exception {
		...
		System.out.println(param.toString());		
		Map result = (Map)super.commonDao.queryForObject("hbo300ukrServiceImpl.proc", param);		
	...
	public List<Map> insert(List<Map> paramList,LoginVO loginVO) throws Exception {
		for(Map param :paramList )	{
			...
			super.commonDao.update("hbo300ukrServiceImpl.insert", param);
		}
	...
	public List<Map> update(List<Map> paramList,LoginVO loginVO) throws Exception {
		for(Map param :paramList )	{
			param.put("PAY_YYYYMM", param.get("PAY_YYYYMM").toString().replace(".", ""));
			super.commonDao.update("hbo300ukrServiceImpl.update", param);
		}		
		return paramList;
	}
	...
	public List<Map> delete(List<Map> paramList,LoginVO loginVO) throws Exception {
		for(Map param :paramList )	{			
			param.put("S_COMP_CODE",loginVO.getCompCode());
			param.put("PAY_YYYYMM", param.get("PAY_YYYYMM").toString().replace(".", ""));
			super.commonDao.update("hbo300ukrServiceImpl.delete", param);
		}
		return paramList;		
	}
	...
	public int checkData(Map param, LoginVO user) throws Exception {
		List<Map> checkDataCnt = (List<Map>) super.commonDao.queryForObject("hbo300ukrServiceImpl.checkData", param);
		if (!ObjUtils.isEmpty(checkDataCnt)) {
			throw new  UniDirectValidateException(this.getMessage("54281", user));
		} else {
			return (int) super.commonDao.select("hbo300ukrServiceImpl.checkData2", param);
		}
	}
	...
	public List<Map<String, Object>> selectExcelUploadSheet(Map param) throws Exception {
		...
		return super.commonDao.list("hbo300ukrServiceImpl.selectExcelUploadSheet", param);
	}
	...
	public void excelValidate(String jobID, Map param) throws Exception {
		...
		List<Map> getData = (List<Map>) super.commonDao.list("hbo300ukrServiceImpl.getData", param);
