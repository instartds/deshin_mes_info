...
@Service("had619ukrService")
public class Had619ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectEmpList(Map param, LoginVO user) throws Exception {
		return (List<Map<String, Object>>) super.commonDao.list("had619ukrServiceImpl.selectEmpList", param);
	}
	...
	public Map<String, Object> fnSetClose( Map param, LoginVO user ) throws Exception {
		super.commonDao.update("had619ukrServiceImpl.fnSetClose", param);
		return param;
    }
	...
	public List<Map<String, Object>> selectFormHad600(Map param, LoginVO user) throws Exception {
		...
		rv = (List<Map<String, Object>>) super.commonDao.list("had619ukrServiceImpl.selectFormHad600", param);
	...
	public List<Map<String, Object>> selectFormHad400(Map param) throws Exception {
		...
		List<Map<String, Object>> rv = (List)super.commonDao.list("had619ukrServiceImpl.selectFormHad400", param);
	...
	public Map<String, Object> selectPrev(Map param) throws Exception {
		Map<String, Object> rv = (Map)super.commonDao.select("had619ukrServiceImpl.selectPrevious", param);
		return rv;
	}
	
	@ExtDirectMethod(group = "human")
	public Map<String, Object> selectNext(Map param) throws Exception {
		Map<String, Object> rv = (Map)super.commonDao.select("had619ukrServiceImpl.selectNext", param);
		return rv;
	}
	...
	public Object selectAuth(Map param) throws Exception {
		return super.commonDao.select("had619ukrServiceImpl.selectAuth", param);
	}
	...
	public List<Map<String, Object>> selectList02(Map param) throws Exception {
		return (List) super.commonDao.list("had619ukrServiceImpl.selectList02", param);
	}
	...
	public List<Map<String, Object>> selectList03(Map param) throws Exception {
		return (List) super.commonDao.list("had619ukrServiceImpl.selectList03", param);
	}
	...
	public List<Map<String, Object>> selectList04(Map param) throws Exception {
		return (List) super.commonDao.list("had619ukrServiceImpl.selectList04", param);
	}
	...
	public List<Map> insertList04(List<Map> paramList, LoginVO loginVO) throws Exception {
		...
		for(Map param : paramList ) {
			...
			super.commonDao.insert("had619ukrServiceImpl.insertList04", param);
		}
		return paramList;
	}
	...
	public List<Map> updateList04(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("had619ukrServiceImpl.updateList04", param);
		}
		return paramList;
	}
	...
	public List<Map<String, Object>> selectList05(Map param) throws Exception {
		return (List) super.commonDao.list("had619ukrServiceImpl.selectList05", param);
	}
	...
	public List<Map<String, Object>> selectList06(Map param) throws Exception {
		return (List) super.commonDao.list("had619ukrServiceImpl.selectList06", param);
	}
	...
	public Map<String, Object> fnSuppTotI(Map param) throws Exception {
		return (Map) super.commonDao.select("had619ukrServiceImpl.fnSuppTotI", param);
	}
	...
	public List<Map<String, Object>> selectSummaryData(Map param, LoginVO user) throws Exception {
		...
		List<Map<String, Object>> rv = null;
		Map chkTaxRate  = (Map) super.commonDao.select("had619ukrServiceImpl.checkTaxRate", param);
		if(ObjUtils.isEmpty(chkTaxRate))	{
			String msg = "54205;";
			throw new  UniDirectValidateException(this.getMessage(ObjUtils.getSafeString(msg), user));
		}
		Map checkTaxDedRate  = (Map) super.commonDao.select("had619ukrServiceImpl.checkTaxDedRate", param);
		if(ObjUtils.isEmpty(chkTaxRate))	{
			String msg = "54250;";
			throw new  UniDirectValidateException(this.getMessage(ObjUtils.getSafeString(msg), user));
		}
		...
		rv = (List<Map<String, Object>>) super.commonDao.list("had619ukrServiceImpl.selectSummaryData", param);
		for(Map<String, Object> map : rv)	{
	...
	public void batchSummaryData(Map param) throws Exception {
		super.commonDao.update("had619ukrServiceImpl.batchSummaryData", param);
	...
	public List<Map> selectCalculateTax(Map param, LoginVO user) throws Exception {
		...
		return	(List<Map>)super.commonDao.list("had619ukrServiceImpl.selectCalculateTax", param);
	...
	public void batchCalculateTax(Map param) throws Exception {
		super.commonDao.update("had619ukrServiceImpl.batchCalculateTax", param);
	...
	List<Map> insert400(List<Map> paramList)	{
		for(Map param : paramList)	{			
			...
			super.commonDao.update("had619ukrServiceImpl.save400", param);
	...
	List<Map> update600_2(List<Map> paramList)	{
		for(Map param : paramList)	{
			...
			super.commonDao.update("had619ukrServiceImpl.save600_2", param);
	...
	List<Map> insert600(List<Map> paramList)	{
		for(Map param : paramList)	{
			...
			super.commonDao.update("had619ukrServiceImpl.save600", param);
			param.put("FORE_SINGLE_YN"		, this.getCheckboxValueTF(param.get("FORE_SINGLE_YN"),"FORE_SINGLE_YN") );
			param.put("FOREIGN_DISPATCH_YN"	, this.getCheckboxValueTF(param.get("FOREIGN_DISPATCH_YN"),"FOREIGN_DISPATCH_YN") );
			param.put("HOUSEHOLDER_YN"		, this.getCheckboxValueTF(param.get("HOUSEHOLDER_YN"),"HOUSEHOLDER_YN") );
			param.put("HALFWAY_TYPE"		, this.getCheckboxValueTF(param.get("HALFWAY_TYPE"),"HALFWAY_TYPE") );
	...
	public Map<String, Object> deleteAll(Map<String, Object> param) throws Exception {
		super.commonDao.update("had619ukrServiceImpl.delete", param);
		return param;
	}
	
	@ExtDirectMethod(group = "human", value = ExtDirectMethodType.FORM_LOAD)
	public Object selectNap(Map param) throws Exception {
		return super.commonDao.select("had619ukrServiceImpl.selectNap", param);		
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "human")
	public ExtDirectFormPostResult napSyncMaster(Had619ukrNapModel param,  LoginVO user, BindingResult result) throws Exception {
		param.setS_COMP_CODE(user.getCompCode());
		param.setS_USER_ID(user.getUserID());
	
		super.commonDao.update("had619ukrServiceImpl.updateNap", param);
	...
	public Map<String, Object> napDeleteAll(Map<String, Object> param) throws Exception {
		super.commonDao.update("had619ukrServiceImpl.deleteNap", param);
		return param;
	}
	...
	public List<Map<String, Object>> selectFamliy(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> rv = null;		
		rv = (List) super.commonDao.list("had619ukrServiceImpl.selectFamliy", param);
		return rv;
	}
	...
	public Map<String, Object> selectMedicalDed(Map<String, Object> param) throws Exception {
		return (Map<String, Object>)super.commonDao.select("had619ukrServiceImpl.selectMedicalDed", param);
	}
	/**
	 * 의료비 추가 update
	 * @param param
	...
	public Map<String, Object> updateMedI(Map<String, Object> param) throws Exception {
		super.commonDao.update("had619ukrServiceImpl.updateMedI", param);
		return param;
	}
	...
	public Object selectPDFSummary(Map param, LoginVO user) throws Exception {	
		return super.commonDao.select("had619ukrServiceImpl.selectPDFSummary", param);
	}	
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "human")
	public List<Map<String, Object>> selectPdfList(Map param) throws Exception {	
		return super.commonDao.list("had619ukrServiceImpl.selectPdfList", param);
	}
	
	@ExtDirectMethod(group = "human")
	public Map spYearTaxPdf(Map sParam, LoginVO user) throws Exception {

		super.commonDao.queryForObject("had619ukrServiceImpl.sp2019YearTaxPDF", sParam);
	...
	public List<Map<String, Object>>  updatePdf(List<Map<String, Object>> paramList) throws Exception {
		...
		for(Map param :paramList ) {
			...
			super.commonDao.update("had619ukrServiceImpl.updatePdf", param);
    ...
    public Object pdfRead( Map param, LoginVO login) throws IOException, Exception {
        ...
        if (path != null ) {
			...
			List<Map<String, Object>> checkFamily = super.commonDao.list("had619ukrServiceImpl.checkFamily", param);
        ...
        if (file != null && !file.isEmpty()) {
            ...
            if (file.getSize() > 0) {
                ...
                // 기타 검증결과는 Exception을 발생 시킴
                	...
                	String message = MessageUtils.getMessage("omegaplus.msg.had618pdf01", Locale.KOREA);//"[Step1] 위변조 검증 실패( message : " + ex.getMessage() + ")";
                	result.addError(new ObjectError("errors",message));
					return new ExtDirectFormPostResult( result, true);
                }
	            ...
	            if ( v_ret == 1 ) {
					...
					try{
						List<Map<String, Object>> checkFamily = super.commonDao.list("had618ukrServiceImpl.checkFamily", param);
						if(checkFamily != null && checkFamily.size() > 0)	{
							String dName = "";
							for(Map<String, Object> family : checkFamily)	{
								if(dName.length()!=0)  dName += ",";
							...
							String message = MessageUtils.getMessage("omegaplus.msg.had618pdf02", Locale.KOREA)+"("+dName+")";//"등록된 부양가족과 PDF상의 부양가족이 맞지 않습니다.\n 부양가족을 먼저 확인하여 주십시오.("+dName+")";
							logger.error(message);
							result.addError(new ObjectError("errors",message));
						...
						logger.error(MessageUtils.getMessage("omegaplus.msg.had618pdf02", Locale.KOREA));
						logger.error(e.toString());
					}
					
	            }else if(v_ret == 0) { 
	            	
	            	String message = MessageUtils.getMessage("omegaplus.msg.had618pdf03", Locale.KOREA);//"<!-- 연말정산간소화 표준 전자문서가 아닙니다. -->";
	            	logger.error(message);
					result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
	            }else if(v_ret == -1) { 
	            	
	            	String message = MessageUtils.getMessage("omegaplus.msg.had618pdf04", Locale.KOREA);//"<!-- 비밀번호가 맞지 않습니다. -->";
	            	logger.error(message);
	            	result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
	            }else if(v_ret == -2) { 
	            	String message = MessageUtils.getMessage("omegaplus.msg.had618pdf05", Locale.KOREA);//"<!-- PDF문서가 아니거나 손상된 문서입니다. -->";
	            	logger.error(message);
					result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
	            }else{ 
	            	String message = MessageUtils.getMessage("omegaplus.msg.had618pdf06", Locale.KOREA);//"<!-- 데이터 추출에 실패하였습니다. -->";
	            	logger.error(message);
					result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
	            }
	...
	private void saveDataList(String formCd, Map<String, Object> form, Map params) throws Exception	{
			...
			super.commonDao.delete("had619ukrServiceImpl.deletePDF", dataMap);
			...
			for(Map<String, Object> man : men)	{
				...
				if(dataList != null)	{
					for(Map<String, Object> data : dataList)	{
						...
						super.commonDao.insert("had619ukrServiceImpl.applyPDF", dataMap);
					}
				}
	...
	private Map getFormCode() throws Exception	{
		...
		formCodeMap.put("A102Y"		,"보장성보험,장애인전용보장성보험");
		formCodeMap.put("B101Y"		,"의료비");
		
		formCodeMap.put("C101Y"		,"교육비");
		formCodeMap.put("C102Y"		,"교육비");
		formCodeMap.put("C202Y"		,"교육비-직업훈련비");
		formCodeMap.put("C301Y"		,"교육비-교복구입비");
		formCodeMap.put("C401Y"		,"교육비-학자금대출");

		formCodeMap.put("G107Y"		,"신용카드");
		formCodeMap.put("G107M"		,"신용카드");
		formCodeMap.put("G207Y"		,"현금영수증");
		formCodeMap.put("G207M"		,"현금영수증");
		formCodeMap.put("G307Y"		,"직불카드 등");
		formCodeMap.put("G307M"		,"직불카드 등");
		formCodeMap.put("G407Y"		,"제로페이(직불카드)");
		formCodeMap.put("G407M"		,"제로페이(직불카드)");
		
		formCodeMap.put("D101Y"		,"개인연금저축/연금계좌-개인연금저축");
		formCodeMap.put("E102Y"		,"개인연금저축/연금계좌-연금저축");
		formCodeMap.put("F102Y"		,"개인연금저축/연금계좌-퇴직연금");
		
		formCodeMap.put("J101Y"		,"주택자금-주택임차차입금원리금상환액");
		formCodeMap.put("J203Y"		,"주택자금-장기주택저당차입금이자상환액");
		formCodeMap.put("J401Y"		,"주택자금-목돈안드는전세이자상환액");
		formCodeMap.put("J301Y"		,"주택마련저축");

		formCodeMap.put("N101Y"		,"장기집합투자증권저축");
		formCodeMap.put("Q101Y"		,"벤처기업투자신탁(2019)");
		formCodeMap.put("Q201Y"		,"벤처기업투자신탁(2018)");
