...
@Service("had620ukrService")
public class Had620ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectEmpList(Map param, LoginVO user) throws Exception {
		return (List<Map<String, Object>>) super.commonDao.list("had620ukrServiceImpl.selectEmpList", param);
	}
	...
	public Map<String, Object> fnSetClose( Map param, LoginVO user ) throws Exception {
		super.commonDao.update("had620ukrServiceImpl.fnSetClose", param);
		return param;
    }
	...
	public Map<String, Object> checkInstallmentPay(Map param) throws Exception {
		Map<String, Object> rv = (Map)super.commonDao.select("had620ukrServiceImpl.checkInstallmentPay", param);
		return rv;
	}
	...
	public List<Map<String, Object>> selectFormHad600(Map param, LoginVO user) throws Exception {
		...
		rv = (List<Map<String, Object>>) super.commonDao.list("had620ukrServiceImpl.selectFormHad600", param);
		
		for(Map<String, Object> map : rv)	{
			map.put("FORE_SINGLE_YN"		, this.getCheckboxValueTF(map.get("FORE_SINGLE_YN"),"FORE_SINGLE_YN") );
			map.put("FOREIGN_DISPATCH_YN"	, this.getCheckboxValueTF(map.get("FOREIGN_DISPATCH_YN"),"FOREIGN_DISPATCH_YN") );
			map.put("HOUSEHOLDER_YN"		, this.getCheckboxValueTF(map.get("HOUSEHOLDER_YN"),"HOUSEHOLDER_YN") );
			map.put("HALFWAY_TYPE"		, this.getCheckboxValueTF(map.get("HALFWAY_TYPE"),"HALFWAY_TYPE") );
			map.put("COMP_PREMINUM"		, this.getCheckboxValueTF(map.get("COMP_PREMINUM"),"COMP_PREMINUM") );
		}
		return rv;
	}
	...
	public List<Map<String, Object>> selectFormHad400(Map param) throws Exception {
		...
		List<Map<String, Object>> rv = (List)super.commonDao.list("had620ukrServiceImpl.selectFormHad400", param);
	...
	public Map<String, Object> selectPrev(Map param) throws Exception {
		Map<String, Object> rv = (Map)super.commonDao.select("had620ukrServiceImpl.selectPrevious", param);
		return rv;
	}
	
	@ExtDirectMethod(group = "human")
	public Map<String, Object> selectNext(Map param) throws Exception {
		Map<String, Object> rv = (Map)super.commonDao.select("had620ukrServiceImpl.selectNext", param);
		return rv;
	}
	...
	public Object selectAuth(Map param) throws Exception {
		return super.commonDao.select("had620ukrServiceImpl.selectAuth", param);
	}
	...
	public List<Map<String, Object>> selectList02(Map param) throws Exception {
		return (List) super.commonDao.list("had620ukrServiceImpl.selectList02", param);
	}
	...
	public List<Map<String, Object>> selectList03(Map param) throws Exception {
		return (List) super.commonDao.list("had620ukrServiceImpl.selectList03", param);
	}
	...
	public List<Map<String, Object>> selectList04(Map param) throws Exception {
		return (List) super.commonDao.list("had620ukrServiceImpl.selectList04", param);
	}
	...
	public List<Map> insertList04(List<Map> paramList, LoginVO loginVO) throws Exception {
		...
		for(Map param : paramList ) {
			...
			super.commonDao.insert("had620ukrServiceImpl.insertList04", param);
		}
		return paramList;
	}
	...
	public List<Map> updateList04(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("had620ukrServiceImpl.updateList04", param);
		}
		return paramList;
	}
	...
	public List<Map<String, Object>> selectList05(Map param) throws Exception {
		return (List) super.commonDao.list("had620ukrServiceImpl.selectList05", param);
	}
	...
	public List<Map<String, Object>> selectList06(Map param) throws Exception {
		return (List) super.commonDao.list("had620ukrServiceImpl.selectList06", param);
	}
	...
	public Map<String, Object> fnSuppTotI(Map param) throws Exception {
		return (Map) super.commonDao.select("had620ukrServiceImpl.fnSuppTotI", param);
	}
	 ...
	 */
	@ExtDirectMethod(group = "human")
	public List<Map<String, Object>> selectSummaryData(Map param, LoginVO user) throws Exception {
		boolean chk = humanCommonService.fnCloseYn("Y", ObjUtils.getSafeString(param.get("YEAR_YYYY")),  user);
		List<Map<String, Object>> rv = null;
		Map chkTaxRate  = (Map) super.commonDao.select("had620ukrServiceImpl.checkTaxRate", param);
		if(ObjUtils.isEmpty(chkTaxRate))	{
			String msg = "54205;";
			throw new  UniDirectValidateException(this.getMessage(ObjUtils.getSafeString(msg), user));
		}
		Map checkTaxDedRate  = (Map) super.commonDao.select("had620ukrServiceImpl.checkTaxDedRate", param);
		if(ObjUtils.isEmpty(chkTaxRate))	{
			String msg = "54250;";
			throw new  UniDirectValidateException(this.getMessage(ObjUtils.getSafeString(msg), user));
		}
		...
		logger.debug("############################################     param.get(\"FORE_SINGLE_YN\")" + param.get("FORE_SINGLE_YN"));		
		rv = (List<Map<String, Object>>) super.commonDao.list("had620ukrServiceImpl.selectSummaryData", param);
		for(Map<String, Object> map : rv)	{
	...
	public void batchSummaryData(Map param) throws Exception {
		super.commonDao.update("had620ukrServiceImpl.batchSummaryData", param);
	...
	public List<Map> selectCalculateTax(Map param, LoginVO user) throws Exception {
		...
		return	(List<Map>)super.commonDao.list("had620ukrServiceImpl.selectCalculateTax", param);
	...
	public void batchCalculateTax(Map param) throws Exception {
		super.commonDao.update("had620ukrServiceImpl.batchCalculateTax", param);
	...
	List<Map> insert400(List<Map> paramList)	{
		for(Map param : paramList)	{			
			...
			param.put("HALFWAY_TYPE"		, this.getCheckboxValueYN(param.get("HALFWAY_TYPE"),"HALFWAY_TYPE") );
			//param.put("HALFWAY_TYPE"		, param.get("HALFWAY_TYPE"));
			param.put("COMP_PREMINUM"		, this.getCheckboxValueYN(param.get("COMP_PREMINUM"),"COMP_PREMINUM") );
			
			super.commonDao.update("had620ukrServiceImpl.save400", param);
	...
	List<Map> update600_2(List<Map> paramList)	{
		for(Map param : paramList)	{
			...
			super.commonDao.update("had620ukrServiceImpl.save600_2", param);
	...
	List<Map> insert600(List<Map> paramList)	{
		for(Map param : paramList)	{
			...
			super.commonDao.update("had620ukrServiceImpl.save600", param);
			param.put("FORE_SINGLE_YN"		, this.getCheckboxValueTF(param.get("FORE_SINGLE_YN"),"FORE_SINGLE_YN") );
			param.put("FOREIGN_DISPATCH_YN"	, this.getCheckboxValueTF(param.get("FOREIGN_DISPATCH_YN"),"FOREIGN_DISPATCH_YN") );
			param.put("HOUSEHOLDER_YN"		, this.getCheckboxValueTF(param.get("HOUSEHOLDER_YN"),"HOUSEHOLDER_YN") );
			param.put("HALFWAY_TYPE"		, this.getCheckboxValueTF(param.get("HALFWAY_TYPE"),"HALFWAY_TYPE") );
	...
	public Map<String, Object> deleteAll(Map<String, Object> param) throws Exception {
		super.commonDao.update("had620ukrServiceImpl.delete", param);
		return param;
	}
	
	@ExtDirectMethod(group = "human", value = ExtDirectMethodType.FORM_LOAD)
	public Object selectNap(Map param) throws Exception {
		return super.commonDao.select("had620ukrServiceImpl.selectNap", param);		
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "human")
	public ExtDirectFormPostResult napSyncMaster(Had620ukrNapModel param,  LoginVO user, BindingResult result) throws Exception {
		param.setS_COMP_CODE(user.getCompCode());
		param.setS_USER_ID(user.getUserID());
	
		super.commonDao.update("had620ukrServiceImpl.updateNap", param);
	...
	public Map<String, Object> napDeleteAll(Map<String, Object> param) throws Exception {
		super.commonDao.update("had620ukrServiceImpl.deleteNap", param);
		return param;
	}
	...
	public List<Map<String, Object>> selectFamliy(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> rv = null;		
		rv = (List) super.commonDao.list("had620ukrServiceImpl.selectFamliy", param);
		return rv;
	}
	
	/**
	 * 의료비정보 - 의료비제출 대상 제한 금액 비율
	 * 
	 */
	@ExtDirectMethod(group = "human")
	public Map<String, Object> selectMedicalDed(Map<String, Object> param) throws Exception {
		return (Map<String, Object>)super.commonDao.select("had620ukrServiceImpl.selectMedicalDed", param);
	}
	...
	public Map<String, Object> updateMedI(Map<String, Object> param) throws Exception {
		super.commonDao.update("had620ukrServiceImpl.updateMedI", param);
		return param;
	}
	...
	public Object selectPDFSummary(Map param, LoginVO user) throws Exception {	
		return super.commonDao.select("had620ukrServiceImpl.selectPDFSummary", param);
	}	
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "human")
	public List<Map<String, Object>> selectPdfList(Map param) throws Exception {	
		return super.commonDao.list("had620ukrServiceImpl.selectPdfList", param);
	}
	
	@ExtDirectMethod(group = "human")
	public Map spYearTaxPdf(Map sParam, LoginVO user) throws Exception {
		super.commonDao.queryForObject("had620ukrServiceImpl.sp2020YearTaxPDF", sParam);
	...
	public List<Map<String, Object>>  updatePdf(List<Map<String, Object>> paramList) throws Exception {
		...
		for(Map param :paramList ) {
			...
			super.commonDao.update("had620ukrServiceImpl.updatePdf", param);
	...
	public ExtDirectFormPostResult pdfUploadFile( @RequestParam( "pdfFile" ) MultipartFile file, HadPdfModel param, LoginVO login, BindingResult result ) throws IOException, Exception {
		...
		if (file != null && !file.isEmpty()) {
			...
			// 기타 검증결과는 Exception을 발생 시킴
				...
				String message = MessageUtils.getMessage("system.message.human.messageHadPdf01", Locale.KOREA);//"[Step1] 위변조 검증 실패( message : " + ex.getMessage() + ")";
			...
			if (file.getSize() > 0) {
				...
				if ( v_ret == 1 ) {
					...
					String message = new String(MessageUtils.getMessage("system.message.human.messageHadPdf03", Locale.KOREA).getBytes(), "UTF-8");//"<!-- 연말정산간소화 표준 전자문서가 아닙니다. -->";
					logger.error(message);
					result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
				}
				else if(v_ret == -1) {
					String message = MessageUtils.getMessage("system.message.human.messageHadPdf04", Locale.KOREA);//"<!-- 비밀번호가 맞지 않습니다. -->";
					logger.error(message);
					result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
				}
				else if(v_ret == -2) { 
					String message = MessageUtils.getMessage("system.message.human.messageHadPdf05", Locale.KOREA);//"<!-- PDF문서가 아니거나 손상된 문서입니다. -->";
					logger.error(message);
					result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
				}
				else{ 
					String message = MessageUtils.getMessage("system.message.human.messageHadPdff06", Locale.KOREA);//"<!-- 데이터 추출에 실패하였습니다. -->";
					logger.error(message);
					result.addError(new ObjectError("errors",message ));
					return new ExtDirectFormPostResult( result, true);
				}
	...
	public Object pdfRead( Map param, LoginVO login) throws IOException, Exception {
		...
		if (path != null ) {
			...
			List<Map<String, Object>> checkFamily = super.commonDao.list("had620ukrServiceImpl.checkFamily", param);
			if(checkFamily != null && checkFamily.size() > 0) {
				...
				String message = MessageUtils.getMessage("system.message.human.messageHadPdf02", Locale.KOREA)+"("+dName+")";//"등록된 부양가족과 PDF상의 부양가족이 맞지 않습니다.\n 부양가족을 먼저 확인하여 주십시오.("+dName+")";
				logger.error(message);
	...
	private void saveDataList(String formCd, Map<String, Object> form, Map params) throws Exception	{
		AES256EncryptoUtils encUtil = new AES256EncryptoUtils();
...
//		if("G207M".equals(formCd))	{
//			formCd = "G207Y";
//		}

		if("G107Y".equals(formCd) || "G107M".equals(formCd) || "G108M".equals(formCd)) {
			formCd = "G108Y";
		}
		if("G207Y".equals(formCd) || "G207M".equals(formCd) || "G208M".equals(formCd)) {
			formCd = "G208Y";
		}
		if("G307Y".equals(formCd) || "G307M".equals(formCd) || "G308M".equals(formCd)) {
			formCd = "G308Y";
		}
		if("G407Y".equals(formCd) || "G407M".equals(formCd) || "G408M".equals(formCd)) {
			formCd = "G408Y";
		}
		...
		super.commonDao.delete("had620ukrServiceImpl.deletePDF", dataMap);
		...
		for(Map<String, Object> man : men)	{
			...
			if("G".equals(GStringUtils.left(formCd,1))) {
				//data Tag List
				List<Map<String, Object>> sumList = (List<Map<String, Object>>) man.get("sum_data");
				if(sumList != null) {
					Map<String, Object> sumData = sumList.get(0);
					...
					String dat_cd = "";
					String usePlaceCd = "";
					if(formCd.equals("G108Y") || formCd.equals("G108M")) {
						dat_cd = "G0012";
						usePlaceCd = "1";
					}
					else if(formCd.equals("G208Y") || formCd.equals("G208M")) {
						dat_cd = "G0013";
						usePlaceCd = "1";
					}
					else if(formCd.equals("G308Y") || formCd.equals("G308M")) {
						dat_cd = "G0014";
						usePlaceCd = "1";
					}
					else if(formCd.equals("G408Y") || formCd.equals("G408M")) {
						dat_cd = "G0014";
						usePlaceCd = "1";
					}
					//	일반
					dataMap.put("DATA_CD"				, dat_cd);
					dataMap.put("USE_PLACE_CD"			, usePlaceCd);
					dataMap.put("USE_AMT"				, this.getTextValue(sumData, "gnrl_sum"));
					dataMap.put("USE_AMT1"				, this.getTextValue(sumData, "gnrl_mar_sum"));
					dataMap.put("USE_AMT2"				, this.getTextValue(sumData, "gnrl_aprl_sum"));
					dataMap.put("USE_AMT3"				, this.getTextValue(sumData, "gnrl_jan_sum"));
					
					super.commonDao.insert("had620ukrServiceImpl.applyPDF", dataMap);
					
					//	전통시장
					dataMap.put("DATA_CD"				, dat_cd);
					dataMap.put("USE_PLACE_CD"			, "2");
					dataMap.put("USE_AMT"				, this.getTextValue(sumData, "tdmr_sum"));
					dataMap.put("USE_AMT1"				, this.getTextValue(sumData, "tdmr_mar_sum"));
					dataMap.put("USE_AMT2"				, this.getTextValue(sumData, "tdmr_aprl_sum"));
					dataMap.put("USE_AMT3"				, this.getTextValue(sumData, "tdmr_jan_sum"));
					
					super.commonDao.insert("had620ukrServiceImpl.applyPDF", dataMap);
					
					//	대중교통
					dataMap.put("DATA_CD"				, dat_cd);
					dataMap.put("USE_PLACE_CD"			, "3");
					dataMap.put("USE_AMT"				, this.getTextValue(sumData, "trp_sum"));
					dataMap.put("USE_AMT1"				, this.getTextValue(sumData, "trp_mar_sum"));
					dataMap.put("USE_AMT2"				, this.getTextValue(sumData, "trp_aprl_sum"));
					dataMap.put("USE_AMT3"				, this.getTextValue(sumData, "trp_jan_sum"));
					
					super.commonDao.insert("had620ukrServiceImpl.applyPDF", dataMap);
					
					//	도서공연등
					dataMap.put("DATA_CD"				, dat_cd);
					dataMap.put("USE_PLACE_CD"			, "4");
					dataMap.put("USE_AMT"				, this.getTextValue(sumData, "isld_sum"));
					dataMap.put("USE_AMT1"				, this.getTextValue(sumData, "isld_mar_sum"));
					dataMap.put("USE_AMT2"				, this.getTextValue(sumData, "isld_aprl_sum"));
					dataMap.put("USE_AMT3"				, this.getTextValue(sumData, "isld_jan_sum"));
					...
					if(dataList != null) {
						...
						for(Map<String, Object> data : dataList) {
							...
							dataMap.put("USE_PLACE_CD"			, ObjUtils.nvl(data.get("use_place_cd"),""));

							int useAmt1 = 0;
							int useAmt2 = 0;
							int useAmt3 = 0;
							List<Map<String, Object>> amtList = (List<Map<String, Object>>) data.get("amt");
							if(amtList != null) {
								useAmt1 = 0;
								useAmt2 = 0;
								useAmt3 = 0;
								
								for(Map<String, Object> amt : amtList) {
									int mm = Integer.parseInt((String)amt.get("mm"));
									if(mm == 3) {
										useAmt1 += Integer.parseInt((String)amt.get("value"));
									}
									else if(mm >= 4 && mm <= 7) {
										useAmt2 += Integer.parseInt((String)amt.get("value"));
									}
									else {
										useAmt3 += Integer.parseInt((String)amt.get("value"));
									}
								}
							}
							
							dataMap.put("USE_AMT"				, useAmt1 + useAmt2 + useAmt3);
							dataMap.put("USE_AMT1"				, useAmt1);
							dataMap.put("USE_AMT2"				, useAmt2);
							dataMap.put("USE_AMT3"				, useAmt3);
				...
				if(dataList != null) {
					for(Map<String, Object> data : dataList) {
						...
						if("J203Y".equals(formCd)) {
							List<Map<String, Object>> tSum = (List<Map<String, Object>>) data.get("sum");
							...
							dataMap.put("J203Y_DDCT"			, ObjUtils.parseInt(tSum.get(0).get("ddct"),0));
						} else {
							dataMap.put("J203Y_START_DT"		, "");
							dataMap.put("J203Y_REPAY_YEARS"		, 0);
							dataMap.put("J203Y_FIXED_RATE_DEBT"	, 0);
						...
						if("K101M".equals(formCd)) {
							...
							dataMap.put("RULE_YN"		, this.getTextValue(data, "rule_yn"));
						} else {
							dataMap.put("START_DT"		, "00000000");
							dataMap.put("END_DT"		, "00000000");
							dataMap.put("RULE_YN"		, "");
						...
						//월세
						if("J501Y".equals(formCd)) {
							dataMap.put("START_DT"		, this.getTextValue(data, "start_dt"));
							dataMap.put("END_DT"		, this.getTextValue(data, "end_dt"));
							dataMap.put("LSOR_NO"		, encUtil.encryto(data.get("lsor_no").toString()));
							dataMap.put("LSOR_NM"		, data.get("lsor_nm"));
							dataMap.put("ADR"			, this.getTextValue(data, "adr"));
							dataMap.put("AREA"			, ObjUtils.parseInt(this.getTextValue(data, "area"),0));
							dataMap.put("TYPECD"		, this.getTextValue(data, "typeCd"));
						} else {
							dataMap.put("START_DT"		, "00000000");
							dataMap.put("END_DT"		, "00000000");
							dataMap.put("LSOR_NO"		, encUtil.encryto(""));
							dataMap.put("LSOR_NM"		, "");
							dataMap.put("ADR"			, "");
							dataMap.put("AREA"			, "0");
							dataMap.put("TYPECD"		, "");
...
//						//신용카드, 현금영수증, 직불카드	- 2020년 귀속 연말정산에서 신용카드등 로직은 별도로 처리.
//						if("G".equals(GStringUtils.left(formCd,1))) {
...
//						}
						...
						dataMap.put("USE_AMT1"				, 0);
						dataMap.put("USE_AMT2"				, 0);
						dataMap.put("USE_AMT3"				, 0);
						...
						if( "E102Y".equals(formCd) || "F102Y".equals(formCd) ) {
							...
							//List<Map<String, Object>> tSum = (List<Map<String, Object>>) data.get("sum");
							//dataMap.put("USE_AMT"		, ObjUtils.parseInt(tSum.get(0).get("ddct"),0));
							
							dataMap.put("USE_AMT"		, ObjUtils.parseInt(this.getTextValue(data, "sum"),0));
						} else {
	...
	private Map getFormCode() throws Exception	{
		...
		formCodeMap.put("B201Y"		,"실손의료보험금");
		
		formCodeMap.put("C102Y"		,"유초중고, 대학, 기타");
		formCodeMap.put("C202Y"		,"직업훈련비");
		formCodeMap.put("C301Y"		,"교복구입비");
		formCodeMap.put("C401Y"		,"학자금대출");
		
		formCodeMap.put("D101Y"		,"연금저축-개인연금저축");
		formCodeMap.put("E102Y"		,"연금계좌-연금저축");
		formCodeMap.put("F102Y"		,"연금계좌-퇴직연금");
		
		formCodeMap.put("G108Y"		,"신용카드");
		formCodeMap.put("G108M"		,"신용카드");
		formCodeMap.put("G208Y"		,"현금영수증");
		formCodeMap.put("G208M"		,"현금영수증");
		formCodeMap.put("G308Y"		,"직불카드");
		formCodeMap.put("G308M"		,"직불카드");
		formCodeMap.put("G408Y"		,"제로페이");
		formCodeMap.put("G408M"		,"제로페이");
		
		formCodeMap.put("J101Y"		,"주택임차차입금 원리금상환액");
		formCodeMap.put("J203Y"		,"장기주택저당차입금 이자상환액");
		formCodeMap.put("J301Y"		,"주택마련저축");
		formCodeMap.put("J501Y"		,"월세액");
		...
		formCodeMap.put("Q101Y"		,"벤처기업투자신탁(당해년도)");
		formCodeMap.put("Q201Y"		,"벤처기업투자신탁(이전년도)");
		
		//==================================================
		//	PDF 자료로 제공읜 되나 ERP 급여자료 이용하기 위해 미 반영.
		//==================================================
		//formCodeMap.put("O101M"		,"건강보험료");
		//formCodeMap.put("P102M"		,"국민연금보험료");

		//==================================================
		//	과거 사용되던 코드이나 현재는 삭제된 서식 코드
		//==================================================
		//formCodeMap.put("C101Y"		,"교육비");
		//formCodeMap.put("J401Y"		,"주택자금-목돈안드는전세이자상환액");
	...
	private boolean getCheckboxValueTF(Object obj, String fieldName)	{
