...
@Service("had452ukrService")
public class Had452ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	
	@ExtDirectMethod(group = "human", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return (List<Map<String, Object>>)super.commonDao.list("had452ukrServiceImpl.selectList", param);		
	}
	...
	public List<Map<String, Object>> delete(List<Map<String, Object>> paramList) throws Exception {
		for(Map param : paramList) {
			super.commonDao.update("had452ukrServiceImpl.delete", param);
		}
		return paramList;
	}
	...
	public List<Map<String, Object>> insert(List<Map<String, Object>> paramList) throws Exception {
		for(Map param : paramList) {
			Map rMap = (Map)super.commonDao.select("had452ukrServiceImpl.getSeq", param);	
			param.put("SEQ_NO", rMap.get("SEQ_NO"));
			
			super.commonDao.update("had452ukrServiceImpl.insert", param);
	...
	public List<Map<String, Object>> update(List<Map<String, Object>> paramList) throws Exception {
		for(Map param : paramList) {
			super.commonDao.update("had452ukrServiceImpl.update", param);
		}
		return paramList;		
	}
}
