...
@Service("had910rkrService")
public class Had910rkrServiceImpl  extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());	

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "coop")			// 조회
	public List<Map<String, Object>>  selectToPrintYN(Map param) throws Exception {
		return  super.commonDao.list("had910rkrServiceImpl.selectToPrintYN", param);	
	}	
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "coop")			// 조회
	public List<Map<String, Object>>  selectToPrintR(Map param) throws Exception {
		return  super.commonDao.list("had910rkrServiceImpl.selectToPrintR", param);	
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "coop")			// 조회
	public List<Map<String, Object>>  selectToPrintOther(Map param) throws Exception {
		return  super.commonDao.list("had910rkrServiceImpl.selectToPrintOther", param);	
	}	
