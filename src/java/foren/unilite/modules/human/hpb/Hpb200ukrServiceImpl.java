...
@Service( "hpb200ukrService" )
public class Hpb200ukrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> getGubun( Map param, LoginVO user ) throws Exception {
        return super.commonDao.list("hpb200ukrServiceImpl.getGubun", param);
    }
    ...
    public List<Map> fnGetBusinessCode( Map param, LoginVO user ) throws Exception {
        return super.commonDao.list("hpb200ukrServiceImpl.fnGetBusinessCode", param);
    }
    ...
    public List<Map> selectList( Map param, LoginVO user ) throws Exception {
        return super.commonDao.list("hpb200ukrServiceImpl.selectList", param);
    }
    ...
    public List userDept( LoginVO loginVO ) throws Exception {
        ...
        return (List)super.commonDao.list("hpb200ukrServiceImpl.userDept", param);
    }
    /*	
    	*//**
           * 소득자코드 중복 조회
           ...
           * @throws Exception
           *//*
             * @ExtDirectMethod(value = ExtDirectMethodType.FORM_LOAD, group = "hpb") public Map chkFamilyRepreNum(Map param) throws Exception { return (Map) super.commonDao.select("hpb200ukrServiceImpl.chkFamilyRepreNum", param); }
             */
    ...
    public Object getAutoCustomCode( Map param ) throws Exception {
        return super.commonDao.select("hpb200ukrServiceImpl.getAutoCustomCode", param);
    }
    ...
    public void insertDetail( List<Map> paramList, LoginVO user, Map paramMaster ) throws Exception {
            ...
            for (Map param : paramList) {
                ...
                List<Map> checkName = (List<Map>)super.commonDao.list("hpb200ukrServiceImpl.checkName", param);//hpb100t에 동일한 주민등록번호 체크
                ...
                if (!ObjUtils.isEmpty(checkValueName)) {
                    ...
                    if (!ObjUtils.isEmpty(dataMaster.get("AUTO_CODE"))) {
                        if (dataMaster.get("AUTO_CODE").equals("Y")) {
                            ...
                            List<Map> customCode = (List<Map>)super.commonDao.list("hpb200ukrServiceImpl.getAutoCustomCode", compCodeMap);
                            if (!customCode.isEmpty()) {
                                param.put("PERSON_NUMB", customCode.get(0).get("CUSTOM_CODE"));
                            }
                            String checkValue1 = "";
                            List<Map> checkTopNum = (List<Map>)super.commonDao.list("hpb200ukrServiceImpl.checkTopNum", param);//bcm100t에 주민등록번호 비교
                            if (!checkTopNum.isEmpty()) {
                                ...
                                super.commonDao.insert("hpb200ukrServiceImpl.insertList", param);
                                super.commonDao.update("hpb200ukrServiceImpl.updateListAutoCustom", param);
                                
                            } else {
                                super.commonDao.insert("hpb200ukrServiceImpl.insertList", param);
                                super.commonDao.update("hpb200ukrServiceImpl.insertListAutoCustom", param);
                            }
                            
                            if (!ObjUtils.isEmpty(param.get("BANK_ACCOUNT"))) {
                                String checkValue2 = "";
                                List<Map> checkBankBookNum = (List<Map>)super.commonDao.list("hpb200ukrServiceImpl.checkBankBookNum", param);//bcm130t에 계좌번호 비교
                                ...
                                if (checkBankBookNum.isEmpty()) {
                                	...
                                	super.commonDao.insert("hpb200ukrServiceImpl.insertListAutoBankAccount", param);
        ...
        for (Map param : paramList) {
            ...
            if (!ObjUtils.isEmpty(dataMaster.get("AUTO_CODE"))) {
                if (dataMaster.get("AUTO_CODE").equals("Y")) {
                    ...
                    super.commonDao.update("hpb200ukrServiceImpl.updateList", param);
                    super.commonDao.update("hpb200ukrServiceImpl.updateListAutoCustom", param);
    ...
    public void deleteDetail( List<Map> paramList, LoginVO user, Map paramMaster ) throws Exception {
        ...
        for (Map param : paramList) {
            String checkValue4 = "";
            List<Map> beforeDeleteCheck1 = (List<Map>)super.commonDao.list("hpb200ukrServiceImpl.beforeDeleteCheck1", param);
            ...
            if (!beforeDeleteCheck1.isEmpty()) {
                ...
                if (!ObjUtils.isEmpty(dataMaster.get("AUTO_CODE"))) {
                    if (dataMaster.get("AUTO_CODE").equals("Y")) {
                        Map<String, Object> beforeDeleteCheck2 = (Map<String, Object>)super.commonDao.select("hpb200ukrServiceImpl.beforeDeleteCheck2", param);
                        
                        if (Integer.parseInt(beforeDeleteCheck2.get("CNT").toString()) > 0) {
                            throw new UniDirectValidateException(this.getMessage("547", user));
                        } else {
                            List<Map> beforeDeleteCheck3 = (List<Map>)super.commonDao.list("hpb200ukrServiceImpl.beforeDeleteCheck3", param);
                            if (!beforeDeleteCheck3.isEmpty()) {
                                super.commonDao.delete("hpb200ukrServiceImpl.deleteList", param);
                            } else {
                                super.commonDao.delete("hpb200ukrServiceImpl.deleteListAutoCustom", param);
                                super.commonDao.delete("hpb200ukrServiceImpl.deleteListAutoBankAccount", param);
                            }
                        }
                    } else {
                        super.commonDao.delete("hpb200ukrServiceImpl.deleteList", param);
     ...
     */
    /*
     * @ExtDirectMethod(value = ExtDirectMethodType.FORM_POST, group = "hpb") public ExtDirectFormPostResult submitList(Hpb200ukrModel hpb200ukrModel, LoginVO loginVO, BindingResult result) throws Exception { hpb200ukrModel.setS_COMP_CODE(loginVO.getCompCode()); hpb200ukrModel.setS_USER_ID(loginVO.getUserID()); Map<String, String> map = new HashMap<String, String>(); map.put("S_COMP_CODE", loginVO.getCompCode()); map.put("DED_TYPE", hpb200ukrModel.getDED_TYPE()); map.put("PERSON_NUMB", hpb200ukrModel.getPERSON_NUMB()); int cnt = (int)chkFamilyRepreNum(map).get("CNT"); // update if (cnt > 0) { logger.debug("update!"); // 사업자 번호의 '-'를 제거함. hpb200ukrModel.setCOMP_NUM(hpb200ukrModel.getCOMP_NUM().replaceAll("-", "")); super.commonDao.update("hpb200ukrServiceImpl.updateList", hpb200ukrModel); // insert } else { logger.debug("insert!"); super.commonDao.insert("hpb200ukrServiceImpl.insertList", hpb200ukrModel); } ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result); return
     * extResult; }
     *//**
     ...
     *//**
       ...
       * @throws Exception
       *//*
         * @ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "hpb") public List<Map> deleteList(List<Map> paramList) throws Exception { for(Map param :paramList ) { super.commonDao.delete("hpb200ukrServiceImpl.deleteList", param); } return paramList; }
