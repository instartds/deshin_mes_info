...
@Service("hat503ukrService")
public class Hat503ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public String checkData(Map param) throws Exception {
		return (String) super.commonDao.select("hat503ukrServiceImpl.checkData", param);
	}	
	/**
	 * 
	 * @param param
	 ...
	 */
	@ExtDirectMethod(group = "human", value = ExtDirectMethodType.STORE_READ)
	public String gsActivFlag(Map param) throws Exception {
		return (String) super.commonDao.select("hat503ukrServiceImpl.gsActivFlag", param);
	}
    ...
    public List<Map<String, Object>> select( Map param, LoginVO loginVO ) throws Exception {
        ...
        if ("N".equals((String)param.get("CSV_LOAD_YN"))) {
            return (List)super.commonDao.list("hat503ukrServiceImpl.select", param);
        } else {
            ...
            try {
                ...
                while (( txtline = in2.readLine() ) != null) {
                    ...
                    if(txtline.trim().length() > 0) {
                        ...
                        super.commonDao.update("hat503ukrServiceImpl.insertTXT", iMap);
                        
                        row++;
                    }
                    
                }
                super.commonDao.update("hat503ukrServiceImpl.insertHAT", iMap);
...
//                
                ...
                resultList = super.commonDao.list("hat503ukrServiceImpl.insertSP", spParam);
...
//                dataMaster.put("DUTY_DATE", ObjUtils.getSafeString(spParam.get("RETURN_DATE")));
	...
	public String getDutyRule(String comp_code) throws Exception{
		DutyRule = (String) super.commonDao.selectByPk("hat503ukrServiceImpl.getDutyRule", comp_code);
		return DutyRule;
	}
	...
	public List getAllDutycode(Map param) throws Exception {
		return (List)super.commonDao.list("hat503ukrServiceImpl.getAllDutycode" ,param);
	}
	...
	public List getDutycode(Map param) throws Exception {
		return (List)super.commonDao.list("hat503ukrServiceImpl.getDutycode" ,param);
	}
...
//		return (List)super.commonDao.list("hat503ukrServiceImpl.getComboList" ,param);
//	}
	/**
	 * 근태구분 콤보박스 리스트 조회
	 * @param param
	...
	public List<ComboItemModel> getComboList(Map param) throws Exception {
		return (List<ComboItemModel>) super.commonDao.list("hat503ukrServiceImpl.getComboList", param);
...
/*		logger.debug("=====================================1==================================");
		logger.debug("=====================================2==================================");
		logger.debug((String) param.get("DEPT_CODE"));*/
		
		return (List) super.commonDao.list("hat503ukrServiceImpl.selectList", param);
	}
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user) throws Exception {
		try{
			for(Map param :paramList ) {
				...
				super.commonDao.insert("hat503ukrServiceImpl.insertList", param);
			}
		}catch(Exception e){
...
//						super.commonDao.update("hat503ukrServiceImpl.insertList_DutyRule_Y", param);
//					}else{
//						super.commonDao.update("hat503ukrServiceImpl.updateList_DutyRule_Y", param);
//					}
//					
//				} else {
//					// 1.기존의 데이터를 모두 삭제
//					super.commonDao.delete("hat503ukrServiceImpl.deleteList_DutyRule_N", param);
//					// 2. 새로운 데이터를 다시 인서트 함
...
//						super.commonDao.insert("hat503ukrServiceImpl.insertList_DutyRule_N01", map);
//					}
//					// 3. 등록 안 된 근태 0값으로 인서트함
//					super.commonDao.insert("hat503ukrServiceImpl.insertList_DutyRule_N02", param);
//					// 4. 근태코드가 입력 된 경우 DUTY_NUM을 1로 수정함
//					
//					if (param.get("NUMN").equals("1") && param.get("NUMC") != "") {
//						super.commonDao.update("hat503ukrServiceImpl.updateList_DutyRule_N", param);
//					}
//				}
//			}
//		}
...
//		for(Map param :paramList ) {
//			super.commonDao.delete("hat503ukrServiceImpl.deleteList", param);
//		}
//		return paramList;
//	}
	/**
	...
	public List<Map> updateList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("hat503ukrServiceImpl.updateList", param);
		}
		return paramList;
	}
...
//	@ExtDirectMethod(value = ExtDirectMethodType.STORE_SYNCALL, group = "hum")
		public List<Map> commitAll(Map param, LoginVO loginVO) throws Exception {
			...
			super.commonDao.update("hat503ukrServiceImpl.commitAll_A", param);
			...
			if (str == null || str.equals("")) {
				...
				super.commonDao.update("hat503ukrServiceImpl.commitAll_B", param);
			}
	...
	public List<Map> cancelAll(Map param, LoginVO loginVO) throws Exception {
		...
		super.commonDao.update("hat503ukrServiceImpl.cancelAll_A", param);
		...
		if (str == null || str.equals("")) {
			...
			super.commonDao.update("hat503ukrServiceImpl.cancelAll_B", param);
		}
    ...
    @ExtDirectMethod(value = ExtDirectMethodType.STORE_SYNCALL, group = "hum")
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor={Exception.class})   
    public List<Map> saveAllCommitButton(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {

    	if(paramList != null)   {
            List<Map> insertList = null;
            for(Map dataListMap: paramList) {
                if(dataListMap.get("method").equals("insertCommitButtonList")) {
                    insertList = (List<Map>)dataListMap.get("data");
                }
            }
            if(insertList != null) this.insertCommitButtonList(insertList,paramMaster, user);          
        }
        paramList.add(0, paramMaster);
    ...
    @ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "hum")
    public void insertCommitButtonList(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {   
        ...
        /*if(dataMaster.get("DUTY_CHK_YN").equals("Y") ){
    ...
    @ExtDirectMethod(value = ExtDirectMethodType.STORE_SYNCALL, group = "hum")
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor={Exception.class})   
    public List<Map> saveAllCancelButton(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {

    	if(paramList != null)   {
            List<Map> insertList = null;
            for(Map dataListMap: paramList) {
                if(dataListMap.get("method").equals("insertCancelButtonList")) {
                    insertList = (List<Map>)dataListMap.get("data");
                }
            }
            if(insertList != null) this.insertCancelButtonList(insertList,paramMaster, user);          
        }
        paramList.add(0, paramMaster);
    ...
    @ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "hum")
    public void insertCancelButtonList(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {   
    ...
    @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "hum")
   	...
   	public Map<String, Object> procSP( Map param, LoginVO user ) throws Exception {
		...
		spParam.put("DUTY_CODE", param.get("DUTY_CODE"));

		super.commonDao.queryForObject("hat503ukrServiceImpl.procSP", spParam);
