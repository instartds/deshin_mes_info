...
@Service("hat502ukrService")
public class Hat502ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return (List) super.commonDao.list("hat502ukrServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> getDutyList(Map param) throws Exception {
		return (List)super.commonDao.list("hat502ukrServiceImpl.getDutyList" ,param);
	}
	...
	public Object getWorkTeam(Map param) throws Exception {
		return super.commonDao.select("hat502ukrServiceImpl.getWorkTeam", param);
	}
	/*public String getWorkTeam(Map param) throws Exception {
		String rv = "fail";
		try {
			rv = super.commonDao.queryForObject("hat502ukrServiceImpl.getWorkTeam" ,param).toString();
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user) throws Exception {
		try{
			for(Map param :paramList ) {
				super.commonDao.insert("hat502ukrServiceImpl.insertList", param);
			}
		}catch(Exception e){
	...
	public List<Map> updateList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("hat502ukrServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("hat502ukrServiceImpl.deleteList", param);
		}
		return paramList;
	}
