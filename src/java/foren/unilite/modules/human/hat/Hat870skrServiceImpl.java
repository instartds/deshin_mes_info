...
@Service( "hat870skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hat870skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hat870skrServiceImpl.selectList", param);
    }
}
