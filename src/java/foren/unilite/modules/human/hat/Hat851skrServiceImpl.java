...
@Service( "hat851skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hat851skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hat851skrServiceImpl.selectList", param);
    }
}
