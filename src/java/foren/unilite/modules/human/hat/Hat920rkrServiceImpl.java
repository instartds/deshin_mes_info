...
@Service( "hat920rkrServiceImpl" )
public class Hat920rkrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hat920rkrService.selectList", param);
    }
}
