...
@Service( "hat930skrServiceImpl" )
public class Hat930skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param , LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hat930skrService.selectList", param);
    }
}
