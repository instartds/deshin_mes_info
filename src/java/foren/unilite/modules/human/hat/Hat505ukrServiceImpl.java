...
@Service( "hat505ukrService" )
public class Hat505ukrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> select( Map param, LoginVO loginVO ) throws Exception {
        ...
        if ("N".equals((String)param.get("CSV_LOAD_YN"))) {
            return (List)super.commonDao.list("hat505ukrServiceImpl.select", param);
        } else {
            ...
            try {
                ...
                while (( txtline = in2.readLine() ) != null) {
                    ...
                    if (txtline.trim().length() > 0) {
                        ...
                        super.commonDao.update("hat505ukrServiceImpl.insertTXT", iMap);
                        
                        row++;
                    }
                    
                }
                super.commonDao.update("hat505ukrServiceImpl.insertHAT", iMap);
                ...
                resultList = super.commonDao.list("hat505ukrServiceImpl.insertSP", spParam);
    ...
    public String getDutyRule( String comp_code ) throws Exception {
        DutyRule = (String)super.commonDao.selectByPk("hat505ukrServiceImpl.getDutyRule", comp_code);
        return DutyRule;
    }
    ...
    public List getAllDutycode( Map param ) throws Exception {
        return (List)super.commonDao.list("hat505ukrServiceImpl.getAllDutycode", param);
    }
    ...
    public List getDutycode( Map param ) throws Exception {
        return (List)super.commonDao.list("hat505ukrServiceImpl.getDutycode", param);
    }
    ...
    //		return (List)super.commonDao.list("hat505ukrServiceImpl.getComboList" ,param);
    //	}
    /**
     * 근태구분 콤보박스 리스트 조회
     * 
    ...
    public List<ComboItemModel> getComboList( Map param ) throws Exception {
        return (List<ComboItemModel>)super.commonDao.list("hat505ukrServiceImpl.getComboList", param);
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        //		logger.debug(param+"");
        return (List)super.commonDao.list("hat505ukrServiceImpl.selectList", param);
    }
    ...
    public List<Map> insertList( List<Map> paramList, LoginVO user ) throws Exception {
        try {
            for (Map param : paramList) {
                super.commonDao.insert("hat505ukrServiceImpl.insertList", param);
            }
        } catch (Exception e) {
    ...
    //						super.commonDao.update("hat505ukrServiceImpl.insertList_DutyRule_Y", param);
    //					}else{
    //						super.commonDao.update("hat505ukrServiceImpl.updateList_DutyRule_Y", param);
    //					}
    //					
    //				} else {
    //					// 1.기존의 데이터를 모두 삭제
    //					super.commonDao.delete("hat505ukrServiceImpl.deleteList_DutyRule_N", param);
    //					// 2. 새로운 데이터를 다시 인서트 함
    ...
    //						super.commonDao.insert("hat505ukrServiceImpl.insertList_DutyRule_N01", map);
    //					}
    //					// 3. 등록 안 된 근태 0값으로 인서트함
    //					super.commonDao.insert("hat505ukrServiceImpl.insertList_DutyRule_N02", param);
    //					// 4. 근태코드가 입력 된 경우 DUTY_NUM을 1로 수정함
    //					
    //					if (param.get("NUMN").equals("1") && param.get("NUMC") != "") {
    //						super.commonDao.update("hat505ukrServiceImpl.updateList_DutyRule_N", param);
    //					}
    //				}
    //			}
    //		}
    ...
    //		for(Map param :paramList ) {
    //			super.commonDao.delete("hat505ukrServiceImpl.deleteList", param);
    //		}
    //		return paramList;
    //	}
    /**
    ...
    public List<Map> updateList( List<Map> paramList ) throws Exception {
        for (Map param : paramList) {
            super.commonDao.update("hat505ukrServiceImpl.updateList", param);
        }
        return paramList;
    }
    ...
    @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "hat")
   	...
   	public Map<String, Object> procSP( Map param, LoginVO user ) throws Exception {
		...
		super.commonDao.queryForObject("hat505ukrServiceImpl.procSP", spParam);
