...
@Service( "hpcExcelService" )
public class HpcExcelServiceImpl extends TlabAbstractServiceImpl {
    private final Logger         logger = LoggerFactory.getLogger(this.getClass());

    public Workbook makeExcel( Map param ) throws Exception {
        FileInputStream file = new FileInputStream(new File(ConfigUtil.getUploadBasePath("ExcelFrame") + File.separatorChar + "hpc950p-201602.xlsx"));
       ...
       // Style 02 : 중간명칭 중앙정렬과 노란색
        ...
        List<Map> list1 = super.commonDao.list("hpc950ukrServiceImpl.printExcel1", param);
        ...
        if(list1.size() > 0) {
		    ...
		    //작성일자
		    WORK_DATE = ObjUtils.getSafeString(param.get("WORK_DATE"));
		    //법인등록번호
		    ...
		    //지급일
		    SUPP_YYYYMM = ObjUtils.getSafeString(param.get("SUPP_YYYYMM"));
		    ...
		    row = sheet1.getRow(3);
		    cell = row.getCell(N);
		    cell.setCellValue(ObjUtils.getSafeString(param.get("SUPP_YYYYMM")).substring(0,4) + "년 " + ObjUtils.getSafeString(param.get("SUPP_YYYYMM")).substring(4,6) + "월");
		    ...
		    cell = row.getCell(G);
		    cell.setCellValue(ObjUtils.getSafeString(param.get("WORK_DATE")).substring(0,4) + "년 " + ObjUtils.getSafeString(param.get("WORK_DATE")).substring(4,6) + "월 " + ObjUtils.getSafeString(param.get("WORK_DATE")).substring(6,8)+ "일");
		    ...
		    List<Map> list2 = super.commonDao.list("hpc950ukrServiceImpl.printExcel2", param);
	        ...
	        //----------------------------------------//
				...
				//근로소득납부서
				sheet4 = makeExcelSheet4(sheet4, SAFFER_TAX_NM, SAFFER_BANK_NUM, WORK_DATE);
				//주민세납부서
				sheet5 = makeExcelSheet5(sheet5, SAFFER_TAX_NM, SAFFER_BANK_NUM, WORK_DATE);
				//주민세납부서
				sheet6 = makeExcelSheet6(sheet6, COMP_OWN_NO, LOCAL_TAX_GOV);
				//법인원천세납부서
				sheet7 = makeExcelSheet7(sheet7, SAFFER_TAX_NM, SAFFER_BANK_NUM, WORK_DATE);
				//기타소득납부서
				sheet8 = makeExcelSheet8(sheet8, SAFFER_TAX_NM, SAFFER_BANK_NUM, WORK_DATE);
				//배당소득납부서
				sheet9 = makeExcelSheet9(sheet9, SAFFER_TAX_NM, SAFFER_BANK_NUM, WORK_DATE);
				//사업소득납부서
				sheet10 = makeExcelSheet10(sheet10, SAFFER_TAX_NM, SAFFER_BANK_NUM, WORK_DATE);
				//사업소세(재산할)신고서
				sheet11 = makeExcelSheet11(sheet11, DIV_NAME, WORK_DATE, COMP_OWN_NO, REPRE_NO, LOCAL_TAX_GOV);
				//사업소세(종업원할)신고서
				sheet12 = makeExcelSheet12(sheet12, DIV_NAME, WORK_DATE, COMP_OWN_NO, REPRE_NO, SUPP_YYYYMM, LOCAL_TAX_GOV);
				//지방소득세(종업원)납부서
				sheet13 = makeExcelSheet13(sheet13, DIV_NAME, WORK_DATE, COMP_OWN_NO, SUPP_YYYYMM, LOCAL_TAX_GOV);
    ...
    public Sheet makeExcelSheet4( Sheet sheet4, String SAFFER_TAX_NM, String SAFFER_BANK_NUM, String WORK_DATE ) throws Exception {
		...
		row = sheet4.getRow(16);
		cell = row.getCell(W);
		cell.setCellValue(WORK_DATE.substring(0,4));
		
		row = sheet4.getRow(16);
		cell = row.getCell(Z);
		cell.setCellValue(WORK_DATE.substring(4,6));
		
		row = sheet4.getRow(16);
		cell = row.getCell(AC);
		cell.setCellValue(WORK_DATE.substring(6,8));
    ...
    public Sheet makeExcelSheet5( Sheet sheet5, String SAFFER_TAX_NM, String SAFFER_BANK_NUM, String WORK_DATE ) throws Exception {
    ...
    public Sheet makeExcelSheet7( Sheet sheet7, String SAFFER_TAX_NM, String SAFFER_BANK_NUM, String WORK_DATE ) throws Exception {
    ...
    public Sheet makeExcelSheet8( Sheet sheet8, String SAFFER_TAX_NM, String SAFFER_BANK_NUM, String WORK_DATE ) throws Exception {
    ...
    public Sheet makeExcelSheet9( Sheet sheet9, String SAFFER_TAX_NM, String SAFFER_BANK_NUM, String WORK_DATE ) throws Exception {
    ...
    public Sheet makeExcelSheet10( Sheet sheet10, String SAFFER_TAX_NM, String SAFFER_BANK_NUM, String WORK_DATE ) throws Exception {
    ...
    public Sheet makeExcelSheet11( Sheet sheet11, String DIV_NAME, String WORK_DATE, String COMP_OWN_NO, String REPRE_NO, String LOCAL_TAX_GOV ) throws Exception {
    ...
    public Sheet makeExcelSheet12( Sheet sheet12, String DIV_NAME, String WORK_DATE, String COMP_OWN_NO, String REPRE_NO, String SUPP_YYYYMM, String LOCAL_TAX_GOV ) throws Exception {
		...
		row = sheet12.getRow(12);
		cell = row.getCell(K);
		//cell.setCellValue(SUPP_YYYYMM.substring(0, 4) + "년 " + SUPP_YYYYMM.substring(4, 6) + "월" + SUPP_YYYYMM.substring(6, 8) + "일");
		cell.setCellValue(SUPP_YYYYMM.substring(0, 4) + "년 " + SUPP_YYYYMM.substring(4, 6) + "월" );
    ...
    public Sheet makeExcelSheet13( Sheet sheet13, String DIV_NAME, String WORK_DATE, String COMP_OWN_NO, String SUPP_YYYYMM, String LOCAL_TAX_GOV ) throws Exception {
