...
@Service("hpa350ukrService")
public class Hpa350ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List selectColumns(LoginVO loginVO) throws Exception {
		return (List) super.commonDao.list(
				"hpa350ukrServiceImpl.selectColumns", loginVO.getCompCode());
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return (List) super.commonDao.list("hpa350ukrServiceImpl.selectList",
				param);
	}
	...
	public Integer deleteList(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		 for(Map param :paramList )	{	
			...
			param.put("CALC_HIR_YN"	, paramMaster.get("CALC_HIR_YN"));
     		...
     		param.put("CALC_MED_YN" , paramMaster.get("CALC_MED_YN"));
     		
     		param.put("DELETE_YN", "Y");
	     		
     		Map ErrMap = (Map) super.commonDao.queryForObject("hpa350ukrServiceImpl.payroll", param);
	...
	public List<Map> updateList(List<Map> paramList, Map master, LoginVO user) throws Exception {
		...
		List<Map> chkList = (List<Map>) super.commonDao.list("hpa350ukrServiceImpl.checkCompCode", compCodeMap);
		for (Map<String, Object> param : paramList) {
				...
				updateData.put("PERSON_NUMB", param.get("PERSON_NUMB"));
	     		...
	     		for(Map.Entry<String, Object> entry : param.entrySet()) {
	     			if(entry.getKey().indexOf("WAGES_PAY") > -1)	{
	     				...
	     				super.commonDao.update("hpa350ukrServiceImpl.updateList1", updateData);
	     			}
	     			if(entry.getKey().indexOf("WAGES_DED") > -1)	{
	     				...
	     				super.commonDao.update("hpa350ukrServiceImpl.updateList2", updateData);
	     			}
	        	}
	     		...
	     		paramMaster.put("CALC_MED_YN", master.get("CALC_MED_YN"));
	    		...
	    		Map ErrMap = (Map) super.commonDao.select("hpa350ukrServiceImpl.payroll", paramMaster);
