...
@Service( "hpa710skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hpa710skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hpa710skrServiceImpl.selectList", param);
    }
}
