...
@Service( "hum521skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum521skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum521skrServiceImpl.selectList", param);
    }
}
