...
@Service( "hum523skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum523skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum523skrServiceImpl.selectList", param);
    }
}
