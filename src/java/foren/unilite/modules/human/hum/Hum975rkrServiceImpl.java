...
@Service("hum975rkrService")
public class Hum975rkrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Map fnHum975ini(Map param) throws Exception {
		...
		List<Map> qureyValue = (List<Map>) super.commonDao.list("hum975rkrServiceImpl.fnHum975ini", param);	 // 증명번호 check
		String certi ="0";
		if(qureyValue != null && qureyValue.size() > 0){
			certi = (String) qureyValue.get(0).get("CERTI_NUM");
		}
		List<Map>masterName  = (List<Map>) super.commonDao.list("hum975rkrServiceImpl.fnHum975ini1", param); // 대표자명 가져오기
//		String codeName = (String) masterName.get(0).get("CODE_NAME");
		
		List<Map>postName 	 = (List<Map>) super.commonDao.list("hum975rkrServiceImpl.fnHum975ini2", param); // 인사카드 / 증명서 등 직위 표시 방법
		
//		String refCode = (String) postName.get(0).get("REF_CODE2");
		
		List<Map>loginPerson = (List<Map>) super.commonDao.list("hum975rkrServiceImpl.fnHum975ini3", param); // (공공) 인사카드 / 증명서 로그인 사용자 사번
//		String personNumb = (String) loginPerson.get(0).get("PERSON_NUMB");
	...
	public List<Map> selectList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("hum975rkrServiceImpl.gridSelect", param);
	}
	...
	public void  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{			 
				 super.commonDao.update("hum975rkrServiceImpl.insertDetail", param);
			}
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		 ...
		 for(Map param :paramList )	{	
			 super.commonDao.update("hum975rkrServiceImpl.updateDetail", param);
		 }
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		 ...
		 for(Map param :paramList )	{	
			 super.commonDao.update("hum975rkrServiceImpl.deleteDetail", param);
		 }
		 return 0;
	}	
	...
	public Integer insertProfNum(List<Map> paramList, LoginVO user) throws Exception {
		 ...
		 for(Map param :paramList )	{	
			 if(super.commonDao.select("hum975rkrServiceImpl.selectProfNum", param) == null){
				 super.commonDao.update("hum975rkrServiceImpl.insertProfNum", param);
			 }
		 }
		 return 0;
	} 
	...
	public Object fnDeleteAllData(Map param) throws Exception {
		return super.commonDao.update("hum975rkrServiceImpl.fnDeleteAllData", param);
	}
