...
@Service( "hum580skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum580skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum580skrServiceImpl.selectList", param);
    }
}
