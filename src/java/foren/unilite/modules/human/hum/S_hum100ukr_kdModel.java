...
public class S_hum100ukr_kdModel extends BaseVO {
    ...
    private	int   	MED_AVG_I			;
    private	int   	MED_INSUR_I			;
    private	String	MED_INSUR_NO		;
    private	int   	HIRE_AVG_I			;
    private	int   	HIRE_INSUR_I		;
    private	int   	ANU_BASE_I			;
    private	int   	ANU_INSUR_I			;
    private	String	SPOUSE				;
    private	String	WOMAN				;
    private  String  ONE_PARENT         ;
    private	int   	SUPP_AGED_NUM		;
    private	String	DEFORM_YN			;
    private	int   	DEFORM_NUM			;
    private	int   	CHILD_20_NUM		;
    private	int   	AGED_NUM			;
    private	int   	AGED_NUM70			;
    private	int   	BRING_CHILD_NUM		;
    private	int   	ANNUAL_SALARY_I		;
    private	int   	WAGES_STD_I			;
    private	int   	PAY_PRESERVE_I		;
    private	int   	BONUS_STD_I			;
    private	int   	COM_DAY_WAGES		;
    private	int   	COM_YEAR_WAGES		;
    ...
    private int		ORI_MED_INSUR_I		;
    private int		OLD_MED_INSUR_I		;
    private String  CIVIL_DEF_YN		;
    private String  CIVIL_DEF_NUM		;
    
    private String  ANNOUNCE_CODE		;
	...
	public int getMED_AVG_I() {
		return MED_AVG_I;
	}
	public void setMED_AVG_I(int mED_AVG_I) {
		MED_AVG_I = mED_AVG_I;
	}
	public int getMED_INSUR_I() {
		return MED_INSUR_I;
	}
	public void setMED_INSUR_I(int mED_INSUR_I) {
	...
	public int getHIRE_AVG_I() {
		return HIRE_AVG_I;
	}
	public void setHIRE_AVG_I(int hIRE_AVG_I) {
		HIRE_AVG_I = hIRE_AVG_I;
	}
	public int getHIRE_INSUR_I() {
		return HIRE_INSUR_I;
	}
	public void setHIRE_INSUR_I(int hIRE_INSUR_I) {
		HIRE_INSUR_I = hIRE_INSUR_I;
	}
	public int getANU_BASE_I() {
		return ANU_BASE_I;
	}
	public void setANU_BASE_I(int aNU_BASE_I) {
		ANU_BASE_I = aNU_BASE_I;
	}
	public int getANU_INSUR_I() {
		return ANU_INSUR_I;
	}
	public void setANU_INSUR_I(int aNU_INSUR_I) {
	...
	public int getSUPP_AGED_NUM() {
		return SUPP_AGED_NUM;
	}
	public void setSUPP_AGED_NUM(int sUPP_AGED_NUM) {
	...
	public int getDEFORM_NUM() {
		return DEFORM_NUM;
	}
	public void setDEFORM_NUM(int dEFORM_NUM) {
		DEFORM_NUM = dEFORM_NUM;
	}
	public int getCHILD_20_NUM() {
		return CHILD_20_NUM;
	}
	public void setCHILD_20_NUM(int cHILD_20_NUM) {
		CHILD_20_NUM = cHILD_20_NUM;
	}
	public int getAGED_NUM() {
		return AGED_NUM;
	}
	public void setAGED_NUM(int aGED_NUM) {
		AGED_NUM = aGED_NUM;
	}
	public int getAGED_NUM70() {
		return AGED_NUM70;
	}
	public void setAGED_NUM70(int aGED_NUM70) {
		AGED_NUM70 = aGED_NUM70;
	}
	public int getBRING_CHILD_NUM() {
		return BRING_CHILD_NUM;
	}
	public void setBRING_CHILD_NUM(int bRING_CHILD_NUM) {
		BRING_CHILD_NUM = bRING_CHILD_NUM;
	}
	public int getANNUAL_SALARY_I() {
		return ANNUAL_SALARY_I;
	}
	public void setANNUAL_SALARY_I(int aNNUAL_SALARY_I) {
		ANNUAL_SALARY_I = aNNUAL_SALARY_I;
	}
	public int getWAGES_STD_I() {
		return WAGES_STD_I;
	}
	public void setWAGES_STD_I(int wAGES_STD_I) {
		WAGES_STD_I = wAGES_STD_I;
	}
	public int getPAY_PRESERVE_I() {
		return PAY_PRESERVE_I;
	}
	public void setPAY_PRESERVE_I(int pAY_PRESERVE_I) {
		PAY_PRESERVE_I = pAY_PRESERVE_I;
	}
	public int getBONUS_STD_I() {
		return BONUS_STD_I;
	}
	public void setBONUS_STD_I(int bONUS_STD_I) {
	...
	public int getCOM_YEAR_WAGES() {
		return COM_YEAR_WAGES;
	}
	public void setCOM_YEAR_WAGES(int cOM_YEAR_WAGES) {
	...
	public int getORI_MED_INSUR_I() {
		return ORI_MED_INSUR_I;
	}
	public void setORI_MED_INSUR_I(int oRI_MED_INSUR_I) {
		ORI_MED_INSUR_I = oRI_MED_INSUR_I;
	}
	public int getOLD_MED_INSUR_I() {
		return OLD_MED_INSUR_I;
	}
	public void setOLD_MED_INSUR_I(int oLD_MED_INSUR_I) {
	...
	public String getANNOUNCE_CODE() {
		return ANNOUNCE_CODE;
	}
	public void setANNOUNCE_CODE(String aNNOUNCE_CODE) {
