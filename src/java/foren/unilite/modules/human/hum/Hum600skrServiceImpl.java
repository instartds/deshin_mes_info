...
@Service( "hum600skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum600skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum600skrServiceImpl.selectList", param);
    }
}
