...
@Service( "hum522skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum522skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum522skrServiceImpl.selectList", param);
    }
}
