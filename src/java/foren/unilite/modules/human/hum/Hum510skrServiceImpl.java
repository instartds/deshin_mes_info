...
@Service( "hum510skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum510skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum510skrServiceImpl.selectList", param);
    }
}
