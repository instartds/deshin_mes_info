...
@Service( "hum610skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum610skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum610skrServiceImpl.selectList", param);
    }
}
