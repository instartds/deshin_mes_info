...
@Service( "hum560skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum560skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum560skrServiceImpl.selectList", param);
    }
}
