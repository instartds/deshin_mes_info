...
@Service( "hum530skrService" )
@SuppressWarnings( { "unchecked", "rawtypes" } )
public class Hum530skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param, LoginVO loginVO ) throws Exception {
        ...
        return super.commonDao.list("hum530skrServiceImpl.selectList", param);
    }
}
