...
@Service("hum930rkrService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Hum930rkrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectClList(Map param) throws Exception {
		return super.commonDao.list("hum930rkrServiceImpl.selectClList", param);
	}
}