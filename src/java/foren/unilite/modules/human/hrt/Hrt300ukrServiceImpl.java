...
@Service("hrt300ukrService")
public class Hrt300ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	
	
//	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "hpa")
//	public Map procHrt300(Map param, LoginVO loginVO) throws Exception {
...
//		}
//		Map result = (Map)super.commonDao.queryForObject("hrt300ukrServiceImpl.proc", param);		
//		
...
//	}
	...
	public Object  spStart(Map spParam, LoginVO user) throws Exception {
		...
		Map errorMap = (Map) super.commonDao.select("hrt300ukrServiceImpl.USP_HUMAN_HRT300UKR", spParam);
		if(!ObjUtils.isEmpty(errorMap.get("errorDesc"))){
			String errorDesc = (String) errorMap.get("errorDesc");
			String[] messsage = errorDesc.split(";");
		    throw new  UniDirectValidateException(this.getMessage(messsage[0], user));
		    //throw new  UniDirectValidateException(this.getMessage(messsage[0], user) + "\n" + this.getMessage(messsage[1], user));
		}else{
			return true;
		}	
	}
