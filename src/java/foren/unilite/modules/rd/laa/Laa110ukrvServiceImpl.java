...
@Service("laa110ukrvService")
@SuppressWarnings({"unchecked", "rawtypes"})
public class Laa110ukrvServiceImpl  extends TlabAbstractServiceImpl{
	...
	public List<Map<String, Object>> itemCodeList(Map param) throws Exception {
		return super.commonDao.list("laa110ukrvServiceImpl.itemCodeList", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("laa110ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map> insertMulti( List<Map> paramList, LoginVO user ) throws Exception {
		for (Map param : paramList) {
			super.commonDao.insert("laa110ukrvServiceImpl.insertMulti", param);
		}		
		return paramList;
	}
	...
	public List<Map> updateMulti( List<Map> paramList, LoginVO user ) throws Exception {
		for (Map param : paramList) {
			super.commonDao.update("laa110ukrvServiceImpl.updateMulti", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteMulti( List<Map> paramList, LoginVO user ) throws Exception {
		for (Map param : paramList) {
			super.commonDao.delete("laa110ukrvServiceImpl.deleteMulti", param);
		}
		return paramList;
	}
}
