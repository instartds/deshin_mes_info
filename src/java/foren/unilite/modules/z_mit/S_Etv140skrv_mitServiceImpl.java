...
@Service("s_etv140skrv_mitService")
public class S_Etv140skrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public Map<String, Object> selectList( Map param) throws Exception {
		...
		rList = (List)super.commonDao.list("s_etv140skrv_mitServiceImpl.selectList", param);
	...
	public List<Map> selectContents(Map param) throws Exception {
		return super.commonDao.list("s_etv140skrv_mitServiceImpl.selectContents", param);
	}	
	...
	public String selectNextPgmId(Map param) throws Exception {
        String nextPgmId = (String)super.commonDao.select("s_etv140skrv_mitServiceImpl.selectNextPgmId", param);
	...
	public Integer selectNextPgmInterval(Map param) throws Exception {
        Integer interval = (Integer)super.commonDao.select("s_etv140skrv_mitServiceImpl.selectNextPgmInterval", param);
