...
@Service("s_agc730ukr_mitService") 
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_agc730ukr_mitServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		...
		return   super.commonDao.list("s_agc730ukr_mitServiceImpl.selectList", param);
	}
	...
	public Map selectCheckNewList(Map param) throws Exception {
		return  (Map) super.commonDao.select("s_agc730ukr_mitServiceImpl.selectCheckNewDataList", param);
	}
	...
	public List<Map<String, Object>> selectNewList(Map param) throws Exception {
		...
		if(checkCnt != null && ObjUtils.parseInt(checkCnt.get("CNT")) > 0  )	{
			...
			return   super.commonDao.list("s_agc730ukr_mitServiceImpl.selectNewDataList", param);
		}
	}
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			super.commonDao.update("s_agc730ukr_mitServiceImpl.insertList", param);
		}
		return paramList;
	}
	...
	public List<Map> updateList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			super.commonDao.update("s_agc730ukr_mitServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList,  LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("s_agc730ukr_mitServiceImpl.deleteList", param);
		}
		return paramList;
	}
	...
	public Map deleteAll(Map param,  LoginVO user) throws Exception {
		super.commonDao.delete("s_agc730ukr_mitServiceImpl.deleteAll", param);
		return param;
	}
}
