...
@Service("s_sas315skrv_mitService")
public class S_sas315skrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO loginVO) throws Exception {	
    	...
    	List<Map<String, Object>> r  = externalDAO.list("s_sas315skrv_mitServiceImpl.selectlist", param, errorMessage);
