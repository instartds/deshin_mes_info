...
@Service("s_bpr600ukrv_mitService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_bpr600ukrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_bpr600ukrv_mitServiceImpl.selectDetailList", param);
	}
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList) {
			super.commonDao.update("s_bpr600ukrv_mitServiceImpl.updateDetail", param);
		}
		return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("s_bpr600ukrv_mitServiceImpl.deleteDetail", param);
		}
		return 0;
	}
	...
	public void excelValidate(String jobID, Map param) throws Exception {
		//20191114 품목정보 없으면 INSERT하도록 로직 변경 - 주석처리
//		logger.debug("validate: {}", jobID);
//		//UPLOAD 전 데이터 존재여부 체크
//		List<Map> getData = (List<Map>) super.commonDao.list("s_bpr600ukrv_mitServiceImpl.getData", param);
//
//		if(!getData.isEmpty()){
//			//excel 파일의 데이터 체크
...
//				String itemExistYn = (String) super.commonDao.select("s_bpr600ukrv_mitServiceImpl.checkItem", param);
//				if (itemExistYn.equals("Y")) {
//					param.put("MSG", "품목코드 [" + data.get("ITEM_CODE") +"]를 먼저 등록한 후 업로드 해 주세요.");
//					super.commonDao.update("s_bpr600ukrv_mitServiceImpl.insertErrorMsg", param);
//				}
//			}
//		}
	}
	...
	public List<Map<String, Object>> selectExcelUploadSheet(Map param) throws Exception {
		return super.commonDao.list("s_bpr600ukrv_mitServiceImpl.getData", param);
	}
}