...
@Service("s_out200ukrv_mitService") 
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_out200ukrv_mitServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return   super.commonDao.list("s_out200ukrv_mitServiceImpl.selectList", param);
	}
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			super.commonDao.update("s_out200ukrv_mitServiceImpl.insertList", param);
		}
		return paramList;
	}
	...
	public List<Map> updateList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			super.commonDao.update("s_out200ukrv_mitServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList,  LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("s_out200ukrv_mitServiceImpl.deleteList", param);
		}
		return paramList;
	}
    ...
    public List<Map> selectExcelUploadSheet1(Map param) throws Exception {
    	...
    	List<Map> excelUploadMapList = super.commonDao.list("s_out200ukrv_mitServiceImpl.selectExcelUploadSheet1", param);
	...
	public void excelValidate(String jobID, Map param) {
		super.commonDao.update("s_out200ukrv_mitServiceImpl.excelValidate", param);
	}
}
