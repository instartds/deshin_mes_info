...
@Service("s_sas310skrv_mitService")
public class S_sas310skrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO loginVO) throws Exception {		
		return  (List<Map<String, Object>>)super.commonDao.list("s_sas310skrv_mitServiceImpl.selectlist", param);
	}
