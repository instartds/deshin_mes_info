...
@Service("s_agc850ukr_mitService") 
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_agc850ukr_mitServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		...
		rList = super.commonDao.list("s_agc850ukr_mitServiceImpl.selectList", param);
		if(rList == null || (rList != null && rList.size() == 0))	{
			...
			if(checkCnt != null && ObjUtils.parseInt(checkCnt.get("CNT")) > 0  )	{
				...
				rList = super.commonDao.list("s_agc850ukr_mitServiceImpl.selectNewDataList", param);
			}
		}
		return   rList;
	}
	...
	public Map selectCheckNewList(Map param) throws Exception {
		return  (Map) super.commonDao.select("s_agc850ukr_mitServiceImpl.selectCheckNewDataList", param);
	}
	
	/*
	 * @ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "z_mit")
	 * public List<Map<String, Object>> selectNewList(Map param) throws Exception {
	 * 
	 * return super.commonDao.list("s_agc850ukr_mitServiceImpl.selectNewDataList",
	 * param); }
	 */
	/**
	 *  저장
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			...
			param.put("DATE_MONTH", paramMaster.get("DATE_MONTH"));
			super.commonDao.update("s_agc850ukr_mitServiceImpl.insertList", param);
		}
		return paramList;
	}
	...
	public List<Map> updateList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			...
			param.put("DIV_CODE", paramMaster.get("DIV_CODE"));
			param.put("DATE_MONTH", paramMaster.get("DATE_MONTH"));
			super.commonDao.update("s_agc850ukr_mitServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList,  LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList ) {
			param.put("DIV_CODE", paramMaster.get("DIV_CODE"));
			param.put("DATE_MONTH", paramMaster.get("DATE_MONTH"));
			super.commonDao.delete("s_agc850ukr_mitServiceImpl.deleteList", param);
		}
		return paramList;
	}
	...
	public Map deleteAll(Map param,  LoginVO user) throws Exception {
		super.commonDao.delete("s_agc850ukr_mitServiceImpl.deleteAll", param);
		return param;
	}
}
