...
@Service("s_hat800ukr_mitService")
public class S_hat800ukr_mitServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	
	@ExtDirectMethod(group = "z_mit")
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		List<Map<String, Object>> rList = null;
		rList = super.commonDao.list("s_hat800ukr_mitServiceImpl.selectList", param);
		if(rList == null || (rList != null && rList.size() == 0))	{
			...
			if(checkCnt != null && ObjUtils.parseInt(checkCnt.get("CNT")) > 0  )	{
				...
				rList = super.commonDao.list("s_hat800ukr_mitServiceImpl.selectNewDataList", param);
			}
		}
		return   rList;
	}
	...
	public Map selectCheckNewList(Map param) throws Exception {
		return  (Map) super.commonDao.select("s_hat800ukr_mitServiceImpl.selectCheckNewDataList", param);
	}
	...
	public List<Map> updateList(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )	{
			super.commonDao.update("s_hat800ukr_mitServiceImpl.updateList", param);		
			param.put("FLAG", "");
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )	{	
			super.commonDao.update("s_hat800ukr_mitServiceImpl.deleteList", param);	
		}
		return paramList;
	}
	/**
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )	{			
			super.commonDao.update("s_hat800ukr_mitServiceImpl.insertList", param);	
		}
		return paramList;
	}
	...
	public Map deleteAll(Map param,  LoginVO user) throws Exception {
		super.commonDao.delete("s_hat800ukr_mitServiceImpl.deleteAll", param);
		return param;
	}

	@ExtDirectMethod(group = "z_mit")
	public Object getLongYearSave_mit(Map param,  LoginVO user) throws Exception {
		return	super.commonDao.select("s_hat800ukr_mitServiceImpl.getLongYearSave_mit", param);	
	}
