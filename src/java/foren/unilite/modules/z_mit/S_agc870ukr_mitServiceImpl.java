...
@Service("s_agc870ukr_mitService") 
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_agc870ukr_mitServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		...
		rList = super.commonDao.list("s_agc870ukr_mitServiceImpl.selectList", param);
		if(rList == null || (rList != null && rList.size() == 0))	{
			...
			if(checkCnt != null && ObjUtils.parseInt(checkCnt.get("CNT")) > 0  )	{
				...
				rList = super.commonDao.list("s_agc870ukr_mitServiceImpl.selectNewDataList", param);
			}
		}
		return   rList;
	}
	...
	public Map selectCheckNewList(Map param) throws Exception {
		return  (Map) super.commonDao.select("s_agc870ukr_mitServiceImpl.selectCheckNewDataList", param);
	}
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			param.put("FLAG", "");
			param.put("REMARK", "");
			super.commonDao.update("s_agc870ukr_mitServiceImpl.insertList", param);
		}
		return paramList;
	}
	...
	public List<Map> updateList(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList) {
			param.put("FLAG", "");
			param.put("REMARK", "");
			super.commonDao.update("s_agc870ukr_mitServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList,  LoginVO user, Map paramMaster) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("s_agc870ukr_mitServiceImpl.deleteList", param);
		}
		return paramList;
	}
	...
	public Map deleteAll(Map param,  LoginVO user) throws Exception {
		super.commonDao.delete("s_agc870ukr_mitServiceImpl.deleteAll", param);
		return param;
	}
}
