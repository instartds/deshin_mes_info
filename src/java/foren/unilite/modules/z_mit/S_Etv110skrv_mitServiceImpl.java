...
@Service("s_etv110skrv_mitService")
public class S_Etv110skrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public Map<String, Object> selectList( Map param) throws Exception {
        ...
        rList = (List)super.commonDao.list("s_etv110skrv_mitServiceImpl.selectList", param);
	...
	public List<Map> selectContents(Map param) throws Exception {
		return super.commonDao.list("s_etv110skrv_mitServiceImpl.selectContents", param);
	}	
	...
	public Map<String, Object> selectList1( Map param) throws Exception {
        ...
        rList = (List)super.commonDao.list("s_etv110skrv_mitServiceImpl.selectList1", param);
	...
	public String selectNextPgmId(Map param) throws Exception {
        String nextPgmId = (String)super.commonDao.select("s_etv110skrv_mitServiceImpl.selectNextPgmId", param);
	...
	public Integer selectNextPgmInterval(Map param) throws Exception {
        Integer interval = (Integer)super.commonDao.select("s_etv110skrv_mitServiceImpl.selectNextPgmInterval", param);
	...
	public List selectCaldate(String comp_code) throws Exception {
		return (List)super.commonDao.list("s_etv110skrv_mitServiceImpl.selectCaldate" ,comp_code);
	}	
