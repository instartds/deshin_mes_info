...
@Service("s_srq100ukrv_mitService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_srq100ukrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_mitServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_mitServiceImpl.selectList2", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				//체크된 데이터만 INSERT
				if("Y".equals(param.get("SELECTED_YN"))) {
					param.put("KEY_VALUE"	, keyValue);
					param.put("OPR_FLAG"	, oprFlag);
					param.put("PICK_BOX_QTY", 0);
					param.put("PICK_EA_QTY"	, 0);
					param.put("PICK_STATUS"	, "");
					param.put("data", super.commonDao.insert("s_srq100ukrv_mitServiceImpl.insertLogDetail", param));
				}
			}
		}
		...
		super.commonDao.queryForObject("s_srq100ukrv_mitServiceImpl.spSalesShipment", spParam);
	...
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_MODIFY)
	public List<Map> deleteDetail2(List<Map> params, LoginVO user) throws Exception {
		return null;
	}
}