...
@Service("s_pmp112ukrv_mitService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class S_pmp112ukrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map> tab1SelectList(Map param) throws Exception{
		return super.commonDao.list("s_pmp112ukrv_mitServiceImpl.tab1SelectList", param);
	}
	/**
	 * 등록 탭 조회
	 * @param param
	...
	public List<Map> tab2SelectList(Map param) throws Exception{
		return super.commonDao.list("s_pmp112ukrv_mitServiceImpl.tab2SelectList", param);
	}
	...
	public void tab1UpdateDetail(List<Map> paramList, LoginVO user) throws Exception {
		...
		for(Map param :paramList )  {
			if(param.get("CHECK").equals("Y")){
				...
				param.put("SEQ", nm);
				nm += 1;
				super.commonDao.insert("s_pmp112ukrv_mitServiceImpl.insertTab1", param);
			}
		}
		Map<String, Object> spParam = new HashMap<String, Object>();
		spParam.put("KeyValue", keyValue);
		super.commonDao.queryForObject("s_pmp112ukrv_mitServiceImpl.spCallTab1", spParam);
	...
	public void tab2UpdateDetail(List<Map> paramList, LoginVO user) throws Exception {
		//20200225추가
		for(Map param :paramList ) {
			super.commonDao.update("s_pmp112ukrv_mitServiceImpl.tab2UpdateDetail", param);
		}
		return;
	}
	...
	public void tab2DeleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList ) {
	        ...
	        progWorkList =  super.commonDao.list("s_pmp112ukrv_mitServiceImpl.progWorkCodeList", param);
	        for(Map progWorkParam : progWorkList){
		        param.put("PROG_WORK_CODE", progWorkParam.get("PROG_WORK_CODE"));
		        param.put("PROG_UNIT_Q", 1);
			  super.commonDao.insert("s_pmp112ukrv_mitServiceImpl.insertLogMaster", param);
	        }
	        Map<String, Object> spParam = new HashMap<String, Object>();
	        spParam.put("KeyValue", keyValue);
	        spParam.put("LangCode", user.getLanguage());
	        super.commonDao.delete("s_pmp112ukrv_mitServiceImpl.deleteS_sof120t_mit", spParam);
	        super.commonDao.queryForObject("s_pmp112ukrv_mitServiceImpl.USP_PRODT_Pmp100ukr", spParam);
	        String errorDesc = ObjUtils.getSafeString(spParam.get("ErrorDesc"));
	        if(!ObjUtils.isEmpty(errorDesc)){
