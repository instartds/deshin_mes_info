...
@Service("s_pmr120ukrv_mitService")
@SuppressWarnings({"rawtypes", "unchecked"})
public class S_pmr120ukrv_mitServiceImpl extends TlabAbstractServiceImpl  {
	...
	public List<Map> selectList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("s_pmr120ukrv_mitServiceImpl.selectList", param);
	}
	...
	public List<Map> updateList(List<Map> paramList, Map masterData, LoginVO user) throws Exception {	
		if(paramList != null)	{
			 for(Map param :paramList )	{
			 	 Map updateData = (Map)super.commonDao.queryForObject("s_pmr120ukrv_mitServiceImpl.updateList", param);
			 	 if(updateData != null)	{
    ...
    public List<Map> selectExcelUploadSheet1(Map param) throws Exception {
    	...
    	List<Map> excelUploadMapList = super.commonDao.list("s_pmr120ukrv_mitServiceImpl.selectExcelUploadSheet1", param);
	...
	public void excelValidate(String jobID, Map param) {
		super.commonDao.update("s_pmr120ukrv_mitServiceImpl.excelValidate", param);
	}

	@ExtDirectMethod(group = "z_mit")
	public Map deleteAll(Map param) {
		
		List<Map> paramList = super.commonDao.list("s_pmr120ukrv_mitServiceImpl.deleteList", param);
			
		if(paramList != null)	{
			 for(Map gparam :paramList )	{
				 super.commonDao.update("s_pmr120ukrv_mitServiceImpl.deleteAll", param);
			 }
		}
