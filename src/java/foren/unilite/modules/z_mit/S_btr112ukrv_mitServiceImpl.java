...
@Service("s_btr112ukrv_mitService")
public class S_btr112ukrv_mitServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object  userWhcode(Map param) throws Exception {
		return  super.commonDao.select("s_btr112ukrv_mitServiceImpl.userWhcode", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("s_btr112ukrv_mitServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectDetail2(Map param) throws Exception {
		return super.commonDao.list("s_btr112ukrv_mitServiceImpl.selectDetailList2", param);
	}
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("s_btr112ukrv_mitServiceImpl.selectMasterList", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)	/* 조회 */
	public List<Map<String, Object>> selectMasterExcel(Map param) throws Exception {
		return super.commonDao.list("s_btr112ukrv_mitServiceImpl.selectMasterExcelList", param);
	}
	
	@ExtDirectMethod(group = "stock")	/* ITEM_CODE 선택시 수량 SET */
	public Object QtySet(Map param) throws Exception {
		return super.commonDao.select("s_btr112ukrv_mitServiceImpl.QtySet", param);
	}

	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public Object  deptWhcode(Map param) throws Exception {
		return  super.commonDao.select("s_btr112ukrv_mitServiceImpl.deptWhcode", param);
	}

	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public Object  getItemInfo(Map param) throws Exception {
		return  super.commonDao.select("s_btr112ukrv_mitServiceImpl.getItemInfo", param);
	}
	/**
	 * 수주정보 저장
	 ...
	 public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
	  ...
	  for(Map paramData: paramList) {
		  ...
		  for(Map param:  dataList) {
			  ...
			  param.put("data", super.commonDao.insert("s_btr112ukrv_mitServiceImpl.insertLogMaster", param));
		  }
	  }
	//4.매출저장 Stored Procedure 실행
		...
		super.commonDao.queryForObject("s_btr112ukrv_mitServiceImpl.spReceiving", spParam);
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("s_btr112ukrv_mitServiceImpl.deleteMaster", param);
	}
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("s_btr112ukrv_mitServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("s_btr112ukrv_mitServiceImpl.insertDetail", param);
		}
...
//	public ExtDirectFormPostResult syncMaster(S_btr112ukrv_mitModel param, LoginVO user,  BindingResult result) throws Exception {
//		Map<String, Object> paramMap = this.makeMapParam(param, user);
//
//		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
//			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.autoNum", paramMap);
...
//			super.commonDao.insert("s_btr112ukrv_mitServiceImpl.insertMaster", paramMap);
//		}else {
//			beforeSaveMaster(paramMap, user);
//			super.commonDao.update("s_btr112ukrv_mitServiceImpl.updateMaster", paramMap);
//		}
//
//		super.commonDao.update("s_btr112ukrv_mitServiceImpl.updatePrice", paramMap);
//
...
//	}
//
//	private Map<String, Object> makeMapParam(S_btr112ukrv_mitModel param, LoginVO user)	{
...
//	}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("s_btr112ukrv_mitServiceImpl.updateDetail", param);
		}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA110 = (List<Map<String, Object>>)super.commonDao.list("s_btr112ukrv_mitServiceImpl.checkSSA110", param);
		        if(ObjUtils.isEmpty(checkListSSA110))	{
		        	...
		        	for(Map<String, Object> checkSSA110 : checkListSSA110)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			paramSRQ100.put("ORDER_NUM", checkSSA110.get("ORDER_NUM"));
		        			...
		        			super.commonDao.update("s_btr112ukrv_mitServiceImpl.updatebtr111", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("s_btr112ukrv_mitServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("s_btr112ukrv_mitServiceImpl.updateSRQ100", paramSRQ100);
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			...
			super.commonDao.delete("s_btr112ukrv_mitServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("s_btr112ukrv_mitServiceImpl.checkDeleteAllDetail", params.get(0));
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_btr112ukrv_mitServiceImpl.checkEstimate", param);

		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{
						super.commonDao.update("s_btr112ukrv_mitServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("s_btr112ukrv_mitServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("s_btr112ukrv_mitServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("s_btr112ukrv_mitServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("s_btr112ukrv_mitServiceImpl.checkProgressDetail", param);
		}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("s_btr112ukrv_mitServiceImpl.selectExcelUploadSheet1", param);
    }
	...
	public List<Map<String, Object>> getFifo (Map param) throws Exception {
		String keyValue = getLogKey();
		param.put("KEY_VALUE", keyValue);
		return super.commonDao.list("s_btr112ukrv_mitServiceImpl.getFifo", param);
	}
	...
	public List<Map<String, Object>> selectRefStock(Map param) throws Exception {
		return super.commonDao.list("s_btr112ukrv_mitServiceImpl.selectRefStock", param);
	}
