...
@Service("txt120skrvService")
public class Txt120skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("txt120skrvServiceImpl.selectList", param);

	}
	@ExtDirectMethod( group = "txt")
	public Object searchMenu(Map param, LoginVO user) throws Exception {

		List<Map<String,Object>> list = super.commonDao.list("txt120skrvServiceImpl.searchMenu", param);
	...
	public Object  subCode1(Map param) throws Exception {	
		...
		return  super.commonDao.select("txt120skrvServiceImpl.subCode1", param);
	}
