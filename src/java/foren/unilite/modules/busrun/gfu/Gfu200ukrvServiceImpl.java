...
@Service("gfu200ukrvService")
public class Gfu200ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gfu200ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map>  insert(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			...
			param.put("SUPPLY_TIME", ObjUtils.getSafeString(param.get("SUPPLY_TIME")).replaceAll("\\:", ""));
			super.commonDao.update("gfu200ukrvServiceImpl.insert", param);		
		}
		return  paramList;
	}
	...
	public void  deleteExcel(Map param, LoginVO user) throws Exception {		
		super.commonDao.update("gfu200ukrvServiceImpl.deleteExcel", param);		
	}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("gfu200ukrvServiceImpl.selectExcelUploadSheet1", param);
    }
    
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor={Exception.class})	
	public void excelValidate(String jobID, Map param) {
		super.commonDao.update("gfu200ukrvServiceImpl.excelValidate", param);
	}
