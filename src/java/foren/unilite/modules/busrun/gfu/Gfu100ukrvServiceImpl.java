...
@Service("gfu100ukrvService")
public class Gfu100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gfu100ukrvServiceImpl.selectList", param);
	}
	
	@ExtDirectMethod(group = "busrun", value = ExtDirectMethodType.STORE_MODIFY)
	public List<Map>  update(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			...
			super.commonDao.update("gfu100ukrvServiceImpl.update", param);	
	...
	@ExtDirectMethod(group = "busrun", value = ExtDirectMethodType.STORE_SYNCALL)
