...
@Service("grn300skrvService")
public class Grn300skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("grn300skrvServiceImpl.selectList", param);
	}
	
	@ExtDirectMethod(group = "busrun", value = ExtDirectMethodType.STORE_READ)
	public List<Map<Object, String>>  selectDetailList(Map param) throws Exception {	
		return  super.commonDao.list("grn300skrvServiceImpl.selectDetailList", param);
	}
