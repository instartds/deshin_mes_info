...
@Service("s_srq100ukrv_inService")
public class S_srq100ukrv_inServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_inServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectReferList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_inServiceImpl.selectReferList", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_inServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_inServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("s_srq100ukrv_inServiceImpl.selectRefList", param);
	}
...
//					Map checkReqSeq = (Map) super.commonDao.select("s_srq100ukrv_inServiceImpl.chkReqSeq",param);
//					if (ObjUtils.isNotEmpty(checkReqSeq)){
//						Map getMaxReqSeq = (Map) super.commonDao.select("s_srq100ukrv_inServiceImpl.getMaxReqSeq",param);
//						issReqSeq = Integer.parseInt(getMaxReqSeq.get("MAX_REQ_SEQ").toString());
//						param.put("ISSUE_REQ_SEQ", getMaxReqSeq);
//					}
//				}
				param.put("data", super.commonDao.insert("s_srq100ukrv_inServiceImpl.insertLogDetail", param));
			}
		}
		...
		super.commonDao.queryForObject("s_srq100ukrv_inServiceImpl.spSalesShipment", spParam);
