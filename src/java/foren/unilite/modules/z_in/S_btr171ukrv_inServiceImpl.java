...
@Service("s_btr171ukrv_inService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class S_btr171ukrv_inServiceImpl extends TlabAbstractServiceImpl {
//	private static final Map  = null;
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("s_btr171ukrv_inService.selectList", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_btr171ukrv_inService.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_btr171ukrv_inService.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectBiv100tMasterRefer(Map param) throws Exception {
		return super.commonDao.list("s_btr171ukrv_inService.selectBiv100tMasterRefer", param);
	}
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("s_btr171ukrv_inService.updateDetail", param);
		}
		return 0;
	}
	...
	public Integer insertDetail(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("s_btr171ukrv_inService.insertDetail", param);
		}
		return 0;
	}
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("s_btr171ukrv_inService.deleteDetail", param);
		}
		return 0;
	}
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				if(param.get("WORK_TYPE").equals("1")){	 //입고행만 저장..
					...
					selectMap	= (Map) super.commonDao.select("s_btr171ukrv_inService.updateDetail", param);
	...
	public void excelValidate(String jobID, Map param) {
		...
		super.commonDao.update("s_btr171ukrv_inService.excelValidate", param);
	}

	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectExcelist(Map param) {
	    return super.commonDao.list("s_btr171ukrv_inService.selectExcelist", param);
	}
