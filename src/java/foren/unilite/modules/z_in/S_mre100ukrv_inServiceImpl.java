...
@Service("s_mre100ukrv_inService")
public class S_mre100ukrv_inServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectGwData(Map param) throws Exception {
        return super.commonDao.list("S_mre100ukrv_inServiceImpl.selectGwData", param);
    }
    ...
    public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
        return super.commonDao.list("S_mre100ukrv_inServiceImpl.makeDraftNum", param);
    }
    ...
    public List<Map<String, Object>> fnExchgRateO(Map param) throws Exception {
        return super.commonDao.list("S_mre100ukrv_inServiceImpl.fnExchgRateO", param);
    }
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("S_mre100ukrv_inServiceImpl.selectList", param);
	}
    ...
    public List<Map<String, Object>> selectItemReqNumList(Map param) throws Exception {
        return super.commonDao.list("S_mre100ukrv_inServiceImpl.selectItemReqNumList", param);
    }
	...
	public Object  userName(Map param) throws Exception {
		...
		return  super.commonDao.select("S_mre100ukrv_inServiceImpl.userName", param);
	}
	...
	public Object  userWhcode(Map param) throws Exception {
		...
		return  super.commonDao.select("S_mre100ukrv_inServiceImpl.userWhcode", param);
	}
/*	*//**
	 *
	 *  userID에 따른 납품창고
	...
	public Object  ref1(Map param) throws Exception {
		...
		return  super.commonDao.select("S_mre100ukrv_inServiceImpl.ref1", param);
	}*/
	...
	public Object  callDeptInspecFlag(Map param) throws Exception {
		...
		return  super.commonDao.select("S_mre100ukrv_inServiceImpl.callDeptInspecFlag", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		if (ObjUtils.isEmpty(dataMaster.get("ITEM_REQ_NUM") )) {
			...
			super.commonDao.queryForObject("S_mre100ukrv_inServiceImpl.spAutoNum", spParam);
			...
			super.commonDao.insert("S_mre100ukrv_inServiceImpl.insertMaster", dataMaster);
...
//				    super.commonDao.insert("S_mre100ukrv_inServiceImpl.insertMaster", param);
	                super.commonDao.update("S_mre100ukrv_inServiceImpl.insertDetail", param);
				} else {
				    super.commonDao.update("S_mre100ukrv_inServiceImpl.insertDetail", param);
				}
			}
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		...
		for(Map param :paramList )	{
			 try {
				 ...
				 super.commonDao.delete("S_mre100ukrv_inServiceImpl.deleteDetail", param);
				 cnt = (int) super.commonDao.select("S_mre100ukrv_inServiceImpl.deleteChk", param);
				 if(cnt == 0){
					 super.commonDao.delete("S_mre100ukrv_inServiceImpl.deleteMaster", param);
				 }
		...
		logger.debug("[mapData]" + mapData);
		 for(Map param :paramList )	{
			if(i == 0 &&  param.get("SAVE_FLAG").equals("Y")){
				...
				super.commonDao.update("S_mre100ukrv_inServiceImpl.updateMaster", param);
			}
			 super.commonDao.update("S_mre100ukrv_inServiceImpl.updateDetail", param);
		 }
		 return 0;
	}
}
