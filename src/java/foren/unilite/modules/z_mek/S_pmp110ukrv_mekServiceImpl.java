...
@Service("s_pmp110ukrv_mekService")
public class S_pmp110ukrv_mekServiceImpl extends TlabAbstractServiceImpl  {
	 ...
	 * @throws Exception
	 */
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "z_mek")
	public List<Map> selectList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("s_pmp110ukrv_mekServiceImpl.selectList", param);
	}
	...
	public List<Map> selectWorkNum(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("s_pmp110ukrv_mekServiceImpl.selectWorkNum", param);
	}
	...
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "z_mek")
	public List<Map> updateList(List<Map> paramList, Map masterData, LoginVO user) throws Exception {	
		if(paramList != null)	{
			 for(Map param :paramList )	{
				super.commonDao.update("s_pmp110ukrv_mekServiceImpl.updateExcel", param);
			 }	
		 	 Map updateData = (Map)super.commonDao.queryForObject("s_pmp110ukrv_mekServiceImpl.updateList", masterData);
		 	 if(updateData != null)	{
    ...
    public List<Map> selectExcelUploadSheet1(Map param) throws Exception {
    	...
    	List<Map> excelUploadMapList = super.commonDao.list("s_pmp110ukrv_mekServiceImpl.selectExcelUploadSheet1", param);

        return excelUploadMapList;
    }

	@ExtDirectMethod(group = "z_mek")
	public void excelValidate(String jobID, Map param) {
		super.commonDao.update("s_pmp110ukrv_mekServiceImpl.excelValidate", param);
	}

	@ExtDirectMethod(group = "z_mek")
	public Map deleteAll(Map param) {
		super.commonDao.update("s_pmp110ukrv_mekServiceImpl.deleteAll", param);
		return param;
	}
