...
@Service("s_str106ukrv_mekService")
@SuppressWarnings({"unchecked", "rawtypes"})
public class S_str106ukrv_mekServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("s_str106ukrv_mekServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("s_str106ukrv_mekServiceImpl.selectOrderNumMaster", param);
	}
	/**
	 *
	 * 출하지시번호 팝업창 조회
	...
	public List<Map<String, Object>> selectOrderNumMasterList2(Map param) throws Exception {
		return super.commonDao.list("s_str106ukrv_mekServiceImpl.selectOrderNumMaster2", param);
	}
	/**
	 *
	 * 출하지시 참조 조회
	...
	public List<Map<String, Object>> selectRequestiList(Map param) throws Exception {
		return super.commonDao.list("s_str106ukrv_mekServiceImpl.selectRequestiList", param);
	}
	...
	public List<Map<String, Object>> selectSalesOrderList(Map param) throws Exception {
		return super.commonDao.list("s_str106ukrv_mekServiceImpl.selectSalesOrderList", param);
	}
	/**
	 *
	 * 창고조회
	...
	public Object  deptWhcode(Map param) throws Exception {
		...
		return  super.commonDao.select("s_str106ukrv_mekServiceImpl.deptWhcode", param);
	}
	/**
	 * 출고정보 저장
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("s_str106ukrv_mekServiceImpl.insertLogMaster", param));
			}
		}
		...
		super.commonDao.queryForObject("s_str106ukrv_mekServiceImpl.spReceiving", spParam);
...
//		}
	 ...
	 * @throws Exception
	 */
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "sales") // 엑셀 업로드 조회
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("s_str106ukrv_mekServiceImpl.selectExcelUploadSheet1", param);
    }
	
	public void excelValidate(String jobID, Map param) {
	    logger.debug("validate: {}", jobID);
		super.commonDao.update("s_str106ukrv_mekServiceImpl.excelValidate", param);
	}
	...
	public List<Map<String, Object>>  getDivcode(Map param) throws Exception {	
		return  super.commonDao.list("s_str106ukrv_mekServiceImpl.insertLogMaster", param);
	}
	 ...
	 */
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "sales")
	public String selectRequestExcelList(Map param, LoginVO user) throws Exception {
		String keyValue = getLogKey();
		param.put("keyValue", keyValue);
		super.commonDao.list("s_str106ukrv_mekServiceImpl.selectRequestExcelList", param);
...
//				dataMaster.put("SALE_PRSN_CHK", salePrsnChk);
		...
		return ObjUtils.getSafeString(spParam.get("InOutNum"));
	}
}
