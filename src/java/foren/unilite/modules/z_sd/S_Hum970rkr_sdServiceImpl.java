...
@Service("s_hum970rkr_sdService")
public class S_Hum970rkr_sdServiceImpl extends TlabAbstractServiceImpl {
	...
	public String fnHum970ini(Map param) throws Exception {
		...
		List<Map>qureyValue = (List<Map>) super.commonDao.list("s_hum970rkr_sdServiceImpl.fnHum970ini", param);
...
/*	@ExtDirectMethod(group = "hum")
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{	
				if(ObjUtils.isEmpty(super.commonDao.select("s_hum970rkr_sdServiceImpl.selectProfNum", param))){
					super.commonDao.update("s_hum970rkr_sdServiceImpl.insertDetail", param);
				}
			}
		}catch(Exception e){
	...
	public List<Map<String, Object>> selectPrintMaster(Map param) throws Exception {
		return super.commonDao.list("s_hum970rkr_sdServiceImpl.selectPrintMaster", param);
	}	

	@ExtDirectMethod(group = "hum", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectPrintDetail(Map param) throws Exception {
		return super.commonDao.list("s_hum970rkr_sdServiceImpl.selectPrintDetail", param);
	}	
