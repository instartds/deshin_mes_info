...
public class S_Hpa940ukr_ygModel extends BaseVO {
    /**
     * 
     */
	...
	public String toString() {
		return "S_Hpa940ukr_ygModel [gubun=" + gubun + ", S_COMP_CODE=" + S_COMP_CODE + ", PAY_YYYYMM=" + PAY_YYYYMM + ", SUPP_TYPE=" + SUPP_TYPE + ", DIV_CODE=" + DIV_CODE + ", DEPT_CODE=" + DEPT_CODE + ", DEPT_NAME=" + DEPT_NAME
