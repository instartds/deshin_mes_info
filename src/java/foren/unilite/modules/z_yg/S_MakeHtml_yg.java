...
public class S_MakeHtml_yg {
	...
	public S_MakeHtml_yg(S_Hpa940ukr_ygEmailModel vo, 
			S_Hpa940ukr_ygYearModel yearVo2,	
			List<S_Hpa940ukr_ygCode1Model>  workVo2,
			List<S_Hpa940ukr_ygCode2Model>  code2, 
			List<S_Hpa940ukr_ygCode3Model>  code3, 
			S_Hpa940ukr_ygModel extra_info){
		...
		S_Hpa940ukr_ygYearModel yearVo = new S_Hpa940ukr_ygYearModel();
		if(yearVo2 != null)
			yearVo = yearVo2;
		
		makeHeader(pay_yyyymm, supp_name);
	...
	private void makeHeader(String pay_yyyymm, String supp_name) {
		htm = "<HTML>                                                                                                                               ";
		...
		htm += " </STYLE> </HEAD><body bgcolor=#FFFFFF >                                                                                             ";
	...
	private void makeBasic(S_Hpa940ukr_ygEmailModel vo) {
	...
	private void makeYear(S_Hpa940ukr_ygYearModel yearVo) {
		...
		if(yearVo != null){
			...
			htm += "<td width=10% height=23 align=right > " + yearVo.getMONTH_PROV() + " &nbsp;</td>                                                                                  ";
	...
	private void makeWork2(List<S_Hpa940ukr_ygCode2Model>  code2, List<S_Hpa940ukr_ygCode3Model>  code3){
	...
	private void makeWork3(List<S_Hpa940ukr_ygCode1Model>  code1, List<S_Hpa940ukr_ygCode2Model>  code2, List<S_Hpa940ukr_ygCode3Model>  code3){
	...
	private void makeTail3(S_Hpa940ukr_ygEmailModel vo, String comments ){
...
private void makeTail2(S_Hpa940ukr_ygEmailModel vo, String comments ){
