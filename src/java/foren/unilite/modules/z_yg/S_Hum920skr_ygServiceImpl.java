...
@Service("s_hum920skr_ygService")
public class S_Hum920skr_ygServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDataList(Map param) throws Exception {
		...
		return (List) super.commonDao.list("s_hum920skr_ygService.selectDataList", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO user) throws Exception {
		...
		chkYN = (Map<String, Object>)super.commonDao.select("s_hum920skr_ygService.checkRejoiningYn", checkRejoining);
		...
		return (List) super.commonDao.list("s_hum920skr_ygService.selectList", param);
	}
	...
	public List<Map<String, Object>> checkLicenseTab(Map param) throws Exception {
		...
		return (List) super.commonDao.list("s_hum920skr_ygService.checkLicenseTab", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "hum")
	public List<Map<String, Object>> checkOnlyHuman(Map param) throws Exception {
		
		return (List) super.commonDao.list("s_hum920skr_ygService.checkOnlyHuman", param);
	}
