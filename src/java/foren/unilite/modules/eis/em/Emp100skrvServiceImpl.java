...
@Service( "emp100skrvService" )
public class Emp100skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Map<String, Object> selectList( Map param) throws Exception {
        ...
        rList = (List)super.commonDao.list("emp100skrvServiceImpl.selectList", param);
