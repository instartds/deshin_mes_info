...
@Service( "emp120skrvService" )
public class Emp120skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Map<String, Object> selectList( Map param) throws Exception {
        ...
        rList = (List)super.commonDao.list("emp120skrvServiceImpl.selectList", param);
