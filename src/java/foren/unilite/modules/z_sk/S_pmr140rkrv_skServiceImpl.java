...
@Service( "s_pmr140rkrv_skService" )
public class S_pmr140rkrv_skServiceImpl extends TlabAbstractServiceImpl {
    private final Logger         logger = LoggerFactory.getLogger(this.getClass());
	
    @Resource(name="tlabCodeService")
	private TlabCodeService tlabCodeService;
    
    @ExtDirectMethod( group = "z_sk")
    public Workbook makeExcel1( Map param , LoginVO user) throws Exception {
        ...
        styleNum_3.setDataFormat(format.getFormat("#,##0.000"));
        ...
        // 생산현황, 실적
        List<Map> list1 = super.commonDao.list("s_pmr140rkrv_skServiceImpl.selectList1", param);
        int i = 9, j = 0;;
        ...
        // 생산/출고
        List<Map> list2 = super.commonDao.list("s_pmr140rkrv_skServiceImpl.selectList2", param);
        i = 27;
        ...
        // 거래처별 출고량
        List<Map> list3 = super.commonDao.list("s_pmr140rkrv_skServiceImpl.selectList3", param);
        i = 41;
        //일일업무보고
        for(Map data : list3) {
        	if(i < 47) {
    ...
    public Workbook makeExcel2( Map param, LoginVO user ) throws Exception {
        ...
        // 생산량
        List<Map> list1 = super.commonDao.list("s_pmr140rkrv_skServiceImpl.selectList4", param);
        int i = 8, j = 0;;
        ...
        // 원재료
        List<Map> list2 = super.commonDao.list("s_pmr140rkrv_skServiceImpl.selectList5", param);
        i = 26;
        ...
        // 부재료
        List<Map> list3 = super.commonDao.list("s_pmr140rkrv_skServiceImpl.selectList6", param);
        i = 33;
        //일일업무보고
        for(Map data : list3) {
        	if(i < 42) {
