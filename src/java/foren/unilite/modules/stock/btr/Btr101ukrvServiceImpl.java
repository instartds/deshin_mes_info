...
@Service("btr101ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Btr101ukrvServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());


	/**
	 * 창고변경 시, 창고cell 가져오는 로직 추가: 20210129
	 * @param param
	 * @return
	 * @throws Exception
	 */
	...
	public Object getWhCellCode(Map param) throws Exception {
		return super.commonDao.select("btr101ukrvServiceImpl.getWhCellCode", param);
	}
	...
	public Object  userWhcode(Map param) throws Exception {	
		return  super.commonDao.select("btr101ukrvServiceImpl.userWhcode", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)	/* ��ȸ */
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.selectMasterList", param);
	}

	@ExtDirectMethod(group = "stock")	/* ITEM_CODE 선택시 수량 SET */
	public Object QtySet(Map param) throws Exception {
		return super.commonDao.select("btr101ukrvServiceImpl.QtySet", param);
	}
	...
	public List<Map<String, Object>> selectGwData(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.selectGwData", param);
	}
	...
	public List<Map<String, Object>> makeDraftNum(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.makeDraftNum", param);
	}
	...
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.selectDetailList", param);
	}
	...
	public List<Map<String, Object>> selectSalesOrderList(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.selectSalesOrderList", param);
	}
	...
	public List<Map> selectSetItemList(Map param, LoginVO user) throws Exception {
		return  super.commonDao.list("btr101ukrvServiceImpl.selectSetItemList", param);
	}
	...
	public List<Map<String, Object>> selectDetail2(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.selectDetailList2", param);
	}
	 ...
	 public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
	  ...
	  for(Map paramData: paramList) {   
		  ...
		  for(Map param:  dataList) {
			...
			/*param.put("CREATE_LOC", '4');// ������ ������
			param.put("SALE_C_YN", 'N');// ������ ������
			param.put("SALE_DIV_CODE", '*');	// ������ ������
			param.put("SALE_CUSTOM_CODE", '*');	// ������ ������
			param.put("BILL_TYPE", '*');// ������ ������
			param.put("SALE_TYPE", '*');// ������ ������
*/			param.put("data", super.commonDao.insert("btr101ukrvServiceImpl.insertLogMaster", param));
		  }
	  }
		...
		super.commonDao.queryForObject("btr101ukrvServiceImpl.spReceiving", spParam);
		...
		if(!ObjUtils.isEmpty(errorDesc)){
			dataMaster.put("REQSTOCK_NUM", "");
			String[] messsage = errorDesc.split(";");
			throw new  UniDirectValidateException(this.getMessage(messsage[0], user));
		} else {
			dataMaster.put("REQSTOCK_NUM", ObjUtils.getSafeString(spParam.get("ReqstockNum")));
		}
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("btr101ukrvServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(Btr101ukrvModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);

		if (ObjUtils.isEmpty(paramMap.get("REQSTOCK_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.autoNum", paramMap);
			String ReqstockNum = ObjUtils.getSafeString(autoNum.get("REQSTOCK_NUM"));			
			paramMap.put("REQSTOCK_NUM", ReqstockNum);
			beforeSaveMaster(paramMap, user);
			super.commonDao.insert("btr101ukrvServiceImpl.insertMaster", paramMap);
		} else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("btr101ukrvServiceImpl.updateMaster", paramMap);
		}
		super.commonDao.update("btr101ukrvServiceImpl.updatePrice", paramMap);

		ExtDirectFormPostResult extResult = new ExtDirectFormPostResult(result);
		extResult.addResultProperty("REQSTOCK_NUM", ObjUtils.getSafeString(paramMap.get("REQSTOCK_NUM")));
		return extResult;
	}
	...
	private Map<String, Object> makeMapParam(Btr101ukrvModel param, LoginVO user) {
	...
	*/
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag")))) {
			...
			checkProgress(param, "Master", user);
			//�������� update
			super.commonDao.queryForObject("btr101ukrvServiceImpl.checkOrderType", param);
		}
	}
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo)) {
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.autoSerNo", param);
				param.put("SER_NO", ObjUtils.getSafeString(autoSerNo.get("SER_NO")));
			}
			beforeSaveDetail(param, user, "insert");
			super.commonDao.insert("btr101ukrvServiceImpl.insertDetail", param);
		}
		return params;
	}
	...
	public List<Map> insertDetails(List<Map> params, Map<String,  Object> paramMap, LoginVO user) throws Exception {
		for(Map param: params)		{
			param.put("ORDER_NUM", paramMap.get("ORDER_NUM")); //master �� ���ֹ�ȣ
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("btr101ukrvServiceImpl.updateDetail", param);
		}
		return params;
	}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag")))) {
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.itemInfo", param);
			if(!ObjUtils.isEmpty(itemInfo)) {
				throw new  UniDirectValidateException(this.getMessage("54445", user));/* 54445:�������� �ʴ� ǰ���Դϴ�. ǰ�������� Ȯ���ϼ���(��������) */
			} else {
				if("N".equals(itemInfo.get("USE_YN"))) {
					throw new  UniDirectValidateException(this.getMessage("54444", user)); /* 54444:���Ұ� ǰ���Դϴ�.ǰ�������� ��������� Ȯ���ϼ���.(��������) */
				}
			}
		}
			//���� ���� ���� Ȯ��
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData)) {
			...
			if("N".equals(orderStatus) && "Y".equals(param.get("ORDER_STATUS"))) {
				if((orderQ + returnQ - outStockQ) == 0 ) {
					throw new  UniDirectValidateException(this.getMessage("54440", user));// 54440:�ش� ���ְǿ� ���� ���������� �ڷᰡ ����ϴ�.(�ϳ�) 
				}
			}

			if(sCase > 0) {
				if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 )))) {
					Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkSaleQ", param);
			...
			if(outStockQ > 0) {
				List<Map<String, Object>> checkListSSA120 = (List<Map<String, Object>>)super.commonDao.list("btr101ukrvServiceImpl.checkSSA120", param);
				if(ObjUtils.isEmpty(checkListSSA120)) {
					throw new  UniDirectValidateException(this.getMessage("54400", user));
				} else {
					for(Map<String, Object> checkSSA120 : checkListSSA120) {
						int sFlg = 0;
						Map mapfCompute = new HashMap();
						double saleP = ObjUtils.parseDouble(checkSSA120.get("SALE_P"));
						String ssa120_priceYn = ObjUtils.getSafeString(checkSSA120.get("PRICE_YN"));
						if("N".equals(accountYnc) && "Y".equals(param.get("ACCOUNT_YNC")) &&  saleP != ObjUtils.parseDouble(param.get("ORDER_P")) ||
						   ...
						   !ssa120_priceYn.equals(param.get("PRICE_YN")) && "1".equals(ssa120_priceYn)
						) {
							Map ssa120Param = new HashMap();
							ssa120Param.put("TAX_TYPE", checkSSA120.get("TAX_TYPE"));
							ssa120Param.put("M_TAX_TYPE", checkDetailData.get("M_TAX_TYPE"));
							ssa120Param.put("WON_CALC_BAS", checkDetailData.get("WON_CALC_BAS"));
							ssa120Param.put("VAT_RATE", checkDetailData.get("VAT_RATE"));
							ssa120Param.put("TRANS_RATE", checkSSA120.get("TRANS_RATE"));
							ssa120Param.put("SALE_Q", checkSSA120.get("SALE_Q"));
							...
							//mapfCompute = SalesUtil.fnReCompute(ssa120Param, dParam_Unit_P);
							sFlg = 1;
						} else if( !ssa120_priceYn.equals(param.get("PRICE_YN"))) {
							sFlg = 2;
						}
						if(sFlg != 0) {
							...
							paramSRQ100.put("INOUT_NUM", checkSSA120.get("INOUT_NUM"));
							paramSRQ100.put("INOUT_SEQ", checkSSA120.get("INOUT_SEQ"));
							...
							super.commonDao.update("btr101ukrvServiceImpl.updateBTr101", paramSRQ100);
						}
					}
				}
			}
			...
			if(issueReqQ > 0) {
				List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("btr101ukrvServiceImpl.checkSRQ100", param);
				...
				if(ObjUtils.isEmpty(checkListSRQ100)) {
					...
					for(Map<String, Object> checkSRQ100 : checkListSRQ100) {
						...
						if(ObjUtils.parseDouble(param.get("ORDER_P")) != ObjUtils.parseDouble(checkSRQ100.get("ORDER_P")) ) {
							Map ssa120Param = new HashMap();
							ssa120Param.put("TAX_TYPE", checkSRQ100.get("TAX_TYPE"));
							ssa120Param.put("M_TAX_TYPE", checkDetailData.get("M_TAX_TYPE"));
							ssa120Param.put("WON_CALC_BAS", checkDetailData.get("WON_CALC_BAS"));
							ssa120Param.put("VAT_RATE", checkDetailData.get("VAT_RATE"));
							ssa120Param.put("TRANS_RATE", checkSRQ100.get("TRANS_RATE"));
							ssa120Param.put("SALE_Q", checkSRQ100.get("ISSUE_REQ_QTY"));
						...
						if(sFlg != 0) {
							...
							super.commonDao.update("btr101ukrvServiceImpl.updateSRQ100", paramSRQ100);
						}
					}
				}
			}
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params) {
			...
			super.commonDao.delete("btr101ukrvServiceImpl.deleteDetail", param);
		}
		super.commonDao.delete("btr101ukrvServiceImpl.checkDeleteAllDetail", params.get(0)); 
	}
	...
	public List<Map<String, Object>> selectDraftNo(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.selectDraftNo", param);
	}
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("btr101ukrvServiceImpl.checkEstimate", param);
		
		if(!ObjUtils.isEmpty(params)) {
			Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkEstimateConfirm", params.get(0));

			if(!ObjUtils.isEmpty(cfrmData)) {
				if(!"2".equals(cfrmData.get("CONFIRM_FLAG"))) {
					throw new  UniDirectValidateException(this.getMessage("54458", user));/* 54458:�̹� ��ҵǾ�ų� Ȯ������ �ʾҽ��ϴ�. */
				}
				for(Map<String, Object> estiParam : params) {
					super.commonDao.update("btr101ukrvServiceImpl.updateEstimateConfirm", estiParam);
				}
			} else {
				throw new  UniDirectValidateException(this.getMessage("54400", user));/* 54400:�̹� ������ �ڷ��Դϴ�.(��������) */
			}
		}
	}
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
		Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkEstiDetail", param);
		if(!ObjUtils.isEmpty(cfrmData)) {
			if(!"2".equals(cfrmData.get("CONFIRM_FLAG"))) {
				throw new  UniDirectValidateException(this.getMessage("54458", user));/* 54458:�̹� ��ҵǾ�ų� Ȯ������ �ʾҽ��ϴ�. */
			}
			...
			super.commonDao.update("btr101ukrvServiceImpl.updateEstimateDetailConfirm", param);
		} else {
			throw new  UniDirectValidateException(this.getMessage("54400", user));/* 54400:�̹� ������ �ڷ��Դϴ�.(��������) */
		}
	}
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("btr101ukrvServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params)) {
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkSCMDetail", param);

			if(!ObjUtils.isEmpty(baseData)) {
				if(ObjUtils.isEmpty(baseData.get("DB_NAME"))) {
					throw new  UniDirectValidateException(this.getMessage("68022", user));/*  68022:B605(=SCM��������)�� ���3[DataBase��] �� �����Ǿ��ֽ��ϴ�.*/
				}
				
				if(ObjUtils.isEmpty(baseData.get("COMP_CODE"))) {
					throw new  UniDirectValidateException(this.getMessage("68023", user));/* 68023:B605(=SCM��������)�� ���4[�����ڵ�] �� �����Ǿ��ֽ��ϴ�. */
				}
				
				if(ObjUtils.isEmpty(baseData.get("DIV_CODE"))) {
					throw new  UniDirectValidateException(this.getMessage("68024", user));/* 68024:B605(=SCM��������)�� ���5[������ڵ�] �� �����Ǿ��ֽ��ϴ�.*/
				}

				for(Map<String, Object> scmParam : params) {
					scmParam.putAll(baseData);
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData)) {
						throw new  UniDirectValidateException(this.getMessage("54400", user));/* 54400:�̹� ������ �ڷ��Դϴ�.(��������) */
					} else {
						String controlStatus = ObjUtils.getSafeString(dData.get("CONTROL_STATUS"));
						if("2".equals(controlStatus)) {
							throw new  UniDirectValidateException(this.getMessage("54614", user));/* 54614:�԰�� ���ִ� �����Ҽ� ����ϴ�. [�����Ұ�] */
						} else if("3".equals(controlStatus)) {
							throw new  UniDirectValidateException(this.getMessage("54483", user));/* 54483:��꼭ó���� �ڷ��Դϴ�. Ȯ���Ͻñ� �ٶ�ϴ�. */
						} else if("8".equals(controlStatus)) {
							throw new  UniDirectValidateException(this.getMessage("68025", user));/* 68025:���������� �ڷ�� ���� �� ������ �Ұ��� �մϴ�. */
						} else if("9".equals(controlStatus)) {
							throw new  UniDirectValidateException(this.getMessage("54100", user));/* 54100:�̹� ������ �ڷ� �Դϴ�. */
						} else if("1".equals(controlStatus) || "7".equals(controlStatus)) {
							super.commonDao.update("btr101ukrvServiceImpl.updateSCM", scmParam);
						}
					}
				}
			} else {
				throw new  UniDirectValidateException(this.getMessage("68021", user));/* 68021:B605(=SCM��������)�����ڵ尡 ��ϵǾ� ���� �ʰų� ��� �������� �����Ǿ��ֽ��ϴ�. */
			}
		}
	}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkStatus", param);
		String r = "";
		if(!ObjUtils.isEmpty(obj)) {
			r = ObjUtils.getSafeString(obj.get("STATUS"));
			if(!"1".equals(r) && !"5".equals(r) ) {
				throw new  UniDirectValidateException(this.getMessage("55442", user));/* 55442:���ֽ����� ����� ���� ����/������ �� ����ϴ�.*/
			}
		}
	}
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type)) {
			obj = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkProgressMaster", param);
		} else {
			obj = (Map<String, Object>)super.commonDao.select("btr101ukrvServiceImpl.checkProgressDetail", param);
		}
		if(ObjUtils.isEmpty(obj)) {
			throw new  UniDirectValidateException(this.getMessage("54400", user));/* 54400:�̹� ������ �ڷ��Դϴ�.(��������)*/
		} else {
			if(ObjUtils.parseInt(obj.get("ISSUE_REQ_Q")) > 0) {
				throw new  UniDirectValidateException(this.getMessage("54460", user));/* 54460:�������ð� �������� ���ֳ����� ����/������ �� ����ϴ�.*/
			}
			if(ObjUtils.parseInt(obj.get("SALE_Q")) > 0) {
				throw new  UniDirectValidateException(this.getMessage("54412", user));/* 54460:��? �������� ���ֳ����� ������ �Ұ����մϴ�.(���ֳ��� ������)*/
			}
			if(ObjUtils.parseInt(obj.get("RETURN_Q")) > 0) {
				throw new  UniDirectValidateException(this.getMessage("54446", user));/* 54446:��ǰ�� ����� ���ֳ����� ������ �� ����ϴ�.*/
			}
		}
	}
	...
	public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
		return super.commonDao.list("btr101ukrvServiceImpl.selectExcelUploadSheet1", param);
	}

	public void excelValidate(String jobID, Map param) {
		logger.debug("validate: {}", jobID);
		super.commonDao.update("btr101ukrvServiceImpl.excelValidate", param);
	}
}