...
@Service("qms600ukrvService")
public class Qms600ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("qms600ukrvServiceImpl.selectMaster", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("qms600ukrvServiceImpl.selectDetail", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectCheckItem(Map param) throws Exception {
		return super.commonDao.list("qms600ukrvServiceImpl.selectCheckItem", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("qms600ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("qms600ukrvServiceImpl.selectEstiList", param);
	}
    ...
    public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
        ...
        for(Map paramData: paramList) {         
            ...
            for(Map param:  dataList) {
                ...
                param.put("data", super.commonDao.insert("qms600ukrvServiceImpl.insertLogMaster", param));
            }
        }
        ...
        super.commonDao.queryForObject("qms600ukrvServiceImpl.spReceiving", spParam);
        ...
        if(!ObjUtils.isEmpty(errorDesc)){
            ...
            throw new  UniDirectValidateException(this.getMessage(errorDesc, user) + this.getMessage(messsage[0], user));
    ...
    public List<Map> saveAll2(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
        ...
        for(Map paramData: paramList) {         
            ...
            for(Map param:  dataList) {
                param.put("KEY_VALUE", keyValue);
                param.put("OPR_FLAG", oprFlag);
                param.put("data", super.commonDao.insert("qms600ukrvServiceImpl.insertLogMaster2", param));
            }
        }
