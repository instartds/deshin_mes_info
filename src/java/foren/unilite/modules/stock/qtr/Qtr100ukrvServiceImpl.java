...
@Service("qtr100ukrvService")
public class Qtr100ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectInoutType(Map param) throws Exception {
		return super.commonDao.select("qtr100ukrvServiceImpl.selectInoutType", param);
	}
	/**
	 * 출고등록->출고내역조회
	 *
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("qtr100ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectreleaseNoMasterList(Map param) throws Exception {
		return super.commonDao.list("qtr100ukrvServiceImpl.selectreleaseNoMasterList", param);
	}
    ...
    public List<Map<String, Object>> selectrefList(Map param) throws Exception {
        return super.commonDao.list("qtr100ukrvServiceImpl.selectrefList", param);
    }
	...
	public List<Map<String, Object>> selectrefList2(Map param) throws Exception {
		return super.commonDao.list("qtr100ukrvServiceImpl.selectrefList2", param);
	}
...
//				param.put("PICK_STATUS", "");
				param.put("data", super.commonDao.insert("qtr100ukrvServiceImpl.insertLogMaster", param));
			}
		}
        ...
        super.commonDao.queryForObject("qtr100ukrvServiceImpl.spReseving", spParam);
	 ...
	 * @throws Exception
	 */
	@ExtDirectMethod(group = "mtrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> getFifo (Map param) throws Exception {
		return super.commonDao.list("qtr100ukrvServiceImpl.getFifo", param);
	}
	 ...
	 */
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectPurchaseReceiptList(Map param) throws Exception {
		return super.commonDao.list("qtr100ukrvServiceImpl.selectPurchaseReceiptList", param);
	}
	 ...
	 */
	@ExtDirectMethod(group = "matrl", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectProductionReceiptList(Map param) throws Exception {
		return super.commonDao.list("qtr100ukrvServiceImpl.selectProductionReceiptList", param);
	}
}
