...
@Service("qba100ukrvService")
public class Qba100ukrvServiceImpl  extends TlabAbstractServiceImpl{
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("qba100ukrvServiceImpl.selectList", param);
	}
    ...
    public List<Map> insertMulti( List<Map> paramList, LoginVO user ) throws Exception {
        ...
        for (Map param : paramList) {
        	Map<String, String> chkUniqueCode = (Map<String, String>)super.commonDao.select("qba100ukrvServiceImpl.chkUniqueCODE", param);
            ...
            super.commonDao.insert("qba100ukrvServiceImpl.insertMulti", param);
        }        
        return paramList;
    }
	...
	public List<Map> updateMulti( List<Map> paramList, LoginVO user ) throws Exception {
		...
		for (Map param : paramList) {        	           
			super.commonDao.update("qba100ukrvServiceImpl.updateMulti", param);
		}        
		return paramList;
	}
	...
	public List<Map> deleteMulti( List<Map> paramList, LoginVO user ) throws Exception {
		...
		for (Map param : paramList) {        	           
			super.commonDao.delete("qba100ukrvServiceImpl.deleteMulti", param);
		}        
		return paramList;
	}
