...
@Service("qba210ukrvService")
public class Qba210ukrvServiceImpl extends TlabAbstractServiceImpl {

	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	
	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ) 
	public List<Map<String, Object>> getCntQba210t(Map param) throws Exception {
		return super.commonDao.list("qba210ukrvServiceImpl.getCntQba210t", param);
	}
	
	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ) 
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("qba210ukrvServiceImpl.selectList", param);
	}
	
	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ) 
	public List<Map<String, Object>> selectTestList(Map param) throws Exception {
		return super.commonDao.list("qba210ukrvServiceImpl.selectTestList", param);
	}
	...
	public List<Map> insertAnUpdateDetail(List<Map> params, Map paramMaster, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.update("qba210ukrvServiceImpl.insertAnUpdateDetail", param);
		}		
		return params;
	}
	/**
	...
	public List<Map> insertDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			super.commonDao.insert("qba210ukrvServiceImpl.insertDetail", param);
		}		
		return params;
	}
	...
	public List<Map> updateDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map param: params)		{
			super.commonDao.insert("qba210ukrvServiceImpl.updateDetail", param);
		}		
		return params;
	}
	/**
	...
	public void deleteDetail(List<Map> params, LoginVO user) throws Exception {
		for(Map<String, Object> param : params)	{
			super.commonDao.delete("qba210ukrvServiceImpl.deleteDetail", param);
		}
	}
}
