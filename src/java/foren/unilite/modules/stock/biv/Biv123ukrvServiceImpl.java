...
@Service("biv123ukrvService")
public class Biv123ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> report(Map param) throws Exception {
		return super.commonDao.list("biv123ukrvServiceImpl.report", param);
	}
	...
	public Object  userWhcode(Map param) throws Exception {
		return  super.commonDao.select("biv123ukrvServiceImpl.userWhcode", param);
	}
	...
	public List<ComboItemModel> getSectorList(Map param) throws Exception {
		return (List<ComboItemModel>) super.commonDao.list("biv123ukrvServiceImpl.getSectorList", param);
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("biv123ukrvServiceImpl.selectMasterList", param);
	}
    ...
    public int insertExcelData(Map param) throws Exception {
        return super.commonDao.update("biv123ukrvServiceImpl.insertExcelBiv301t", param);
    }
	...
	public Object  dataCheckSave(Map<String, String> spParam, LoginVO user) throws Exception {
		...
		super.commonDao.queryForObject("biv123ukrvServiceImpl.spReceiving", spParam);
	 ...
	 @ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "base")		// INSERT
		public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {
			try {
				...
				List<Map> chkList = (List<Map>) super.commonDao.list("biv123ukrvServiceImpl.checkCompCode", compCodeMap);
				for(Map param : paramList )	{
					for(Map checkCompCode : chkList) {
						 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
						 super.commonDao.update("biv123ukrvServiceImpl.insertDetail", param);
					}
				}
			}catch(Exception e){
		...
		public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
			...
			List<Map> chkList = (List<Map>) super.commonDao.list("biv123ukrvServiceImpl.checkCompCode", compCodeMap);
			 for(Map param :paramList )	{
				 for(Map checkCompCode : chkList) {
					 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
					 super.commonDao.update("biv123ukrvServiceImpl.updateDetail", param);
				 }
			 }
			 return 0;
		}
		...
		public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
			Map compCodeMap = new HashMap();
			compCodeMap.put("S_COMP_CODE", user.getCompCode());
			List<Map> chkList = (List) super.commonDao.list("biv123ukrvServiceImpl.checkCompCode", compCodeMap);
			 for(Map param :paramList )	{
				 for(Map checkCompCode : chkList) {
					 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
					 super.commonDao.update("biv123ukrvServiceImpl.deleteDetail", param);
				 }
			 }
			 return 0;
	}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("biv123ukrvServiceImpl.selectExcelUploadSheet1", param);
    }

    public void excelValidate(String jobID, Map param) {							// 엑셀 Validate
	    logger.debug("validate: {}", jobID);
		super.commonDao.update("biv123ukrvServiceImpl.excelValidate", param);
	}
