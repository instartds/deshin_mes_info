...
@Service("biv121skrvService")
public class Biv121skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		...
		return  super.commonDao.list("biv121skrvServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>>  report(Map param) throws Exception {
		if(param.get("COUNT_DATE") != null ) param.put("COUNT_DATE", ObjUtils.getSafeString( param.get("COUNT_DATE")).replaceAll("\\.", ""));
		return  super.commonDao.list("biv121skrvServiceImpl.report", param);
	}
