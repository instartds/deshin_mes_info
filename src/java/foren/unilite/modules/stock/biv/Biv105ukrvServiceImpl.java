...
@Service("biv105ukrvService")
public class Biv105ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object  userWhcode(Map param) throws Exception {
		return  super.commonDao.select("biv105ukrvServiceImpl.userWhcode", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)
	public Object  YyyymmSet(Map param) throws Exception {
		return  super.commonDao.select("biv105ukrvServiceImpl.YyyymmSet", param);	// 창고콤보 선택시 자동 날짜 지정
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)		// 품목 선택했을시
	public Object  fnOrderPrice(Map param) throws Exception {
		return  super.commonDao.select("biv105ukrvServiceImpl.fnOrderPrice", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)		// 거래처 선택했을시(품목없을떄)
	public Object  fnOrderPriceCust1(Map param) throws Exception {
		return  super.commonDao.select("biv105ukrvServiceImpl.fnOrderPriceCust1", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)		// 거래처 선택했을시(품목있을떄)
	public Object  fnOrderPriceCust2(Map param) throws Exception {
		return  super.commonDao.select("biv105ukrvServiceImpl.fnOrderPriceCust2", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)		// 조회1
	public List<Map<String, Object>> selectMaster1(Map param) throws Exception {
		return super.commonDao.list("biv105ukrvServiceImpl.selectMasterList1", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)		// 조회2
	public List<Map<String, Object>> selectMaster2(Map param) throws Exception {
		return super.commonDao.list("biv105ukrvServiceImpl.selectMasterList2", param);
	}

	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)		// DEPT
	public List<Map<String, Object>> deptSet(Map param) throws Exception {
		return super.commonDao.list("biv105ukrvServiceImpl.Deptset", param);
	}
    ...
    public List<Map<String, Object>> selectExcelUploadSheet1(Map param) throws Exception {
        return super.commonDao.list("biv105ukrvServiceImpl.selectExcelUploadSheet1", param);
    }

    public void excelValidate(String jobID, Map param) {							// 엑셀 Validate
	    logger.debug("validate: {}", jobID);
		super.commonDao.update("biv105ukrvServiceImpl.excelValidate", param);
	}
	 ...
	 public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
    	  ...
    	  for(Map paramData: paramList) {
    		  ...
    		  for(Map param:  dataList) {
    		      ...
    		      double d = 0.000000;
    		      d = ObjUtils.parseDouble(param.get("STOCK_I"));
    		      String strStockI = df.format(d);
    		      param.put("STOCK_I", strStockI);

    		      DecimalFormat dp = new DecimalFormat("#.######");
    		      double p = 0.000000;
    		      p = ObjUtils.parseDouble(param.get("AVERAGE_P"));
    		      String strAverageP = dp.format(p);
    		      param.put("AVERAGE_P", strAverageP);

    		      Map errorMap = (Map) super.commonDao.select("biv105ukrvServiceImpl.USP_STOCK_BIV105UKRV", param);
	...
	public void deleteMaster(Map param, LoginVO user) throws Exception {
		...
		super.commonDao.delete("biv105ukrvServiceImpl.deleteMaster", param);
	}
	...
	public ExtDirectFormPostResult syncMaster(Biv105ukrvModel param, LoginVO user,  BindingResult result) throws Exception {
		Map<String, Object> paramMap = this.makeMapParam(param, user);

		/*if(!"".equals(ObjUtils.getSafeString(param.getBASIS_YYYYMM())))	{
			param.setBASIS_YYYYMM(param.getBASIS_YYYYMM().replace(".", ""));
		}*/
		if (ObjUtils.isEmpty(paramMap.get("ORDER_NUM") )) {
			Map<String, Object> autoNum = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.autoNum", paramMap);
			...
			super.commonDao.insert("biv105ukrvServiceImpl.insertMaster", paramMap);
		}else {
			beforeSaveMaster(paramMap, user);
			super.commonDao.update("biv105ukrvServiceImpl.updateMaster", paramMap);
		}

		super.commonDao.update("biv105ukrvServiceImpl.updatePrice", paramMap);
	...
	private Map<String, Object> makeMapParam(Biv105ukrvModel param, LoginVO user)	{
	...
	private void beforeSaveMaster(Map param, LoginVO user) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			...
			checkProgress(param, "Master", user);
			//수불정보 update
			super.commonDao.queryForObject("biv105ukrvServiceImpl.checkOrderType", param);
		}
	}
...
//			super.commonDao.insert("biv105ukrvServiceImpl.insertDetail", param);
//		}
	...
	public List<Map> insertDetails(List<Map> params, Map<String,  Object> paramMap, LoginVO user) throws Exception {
		for(Map param: params)		{
			...
			/*Map<String, Object> checkSerNo =  (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkSerNo", param);
			if(!ObjUtils.isEmpty(checkSerNo))	{
				Map<String, Object> autoSerNo =  (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.autoSerNo", param);
...
//			super.commonDao.insert("biv105ukrvServiceImpl.updateDetail", param);
//		}
	...
	private void beforeSaveDetail(Map param, LoginVO user, String saveMode) throws Exception	{
		if("Y".equals(ObjUtils.getSafeString(param.get("gsDraftFlag"))))	{
			Map<String, Object> itemInfo = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.itemInfo", param);
	...
	private void checkCompare(Map<String, Object> param, LoginVO user) throws Exception {
		Map<String, Object> checkDetailData = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkDetailData", param);
		int sCase=0;
		...
		if(!ObjUtils.isEmpty(checkDetailData))	{
	        ...
	        if(sCase > 0)	{
	        	if(!(sCase == 1 || sCase == 3 || ((sCase == 5 || sCase ==6) && (reqIssueQty > 0 ))))	{
	        		Map<String, Object> checkSaleQ = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkSaleQ", param);
	        ...
	        if(outStockQ > 0)	{
		        List<Map<String, Object>> checkListSSA120 = (List<Map<String, Object>>)super.commonDao.list("biv105ukrvServiceImpl.checkSSA120", param);
		        if(ObjUtils.isEmpty(checkListSSA120))	{
		        	...
		        	for(Map<String, Object> checkSSA120 : checkListSSA120)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("biv105ukrvServiceImpl.updatebiv105", paramSRQ100);
	        ...
	        if(issueReqQ > 0)	{
	        	List<Map<String, Object>> checkListSRQ100 = (List<Map<String, Object>>)super.commonDao.list("biv105ukrvServiceImpl.checkSRQ100", param);
		        ...
		        if(ObjUtils.isEmpty(checkListSRQ100))	{
		        	...
		        	for(Map<String, Object> checkSRQ100 : checkListSRQ100)	{
		        		...
		        		if(sFlg != 0)	{
		        			...
		        			super.commonDao.update("biv105ukrvServiceImpl.updateSRQ100", paramSRQ100);
	...
	private void checkEstimate(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("biv105ukrvServiceImpl.checkEstimate", param);

		 if(!ObjUtils.isEmpty(params))	{
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkEstimateConfirm", params.get(0));
				...
				if(!ObjUtils.isEmpty(cfrmData))	{
					...
					for(Map<String, Object> estiParam : params)	{
						super.commonDao.update("biv105ukrvServiceImpl.updateEstimateConfirm", estiParam);
					}
				}else {
	...
	private void checkEstimateDetail(Map param, LoginVO user, String saveMode) throws Exception {
				...
				Map<String, Object> cfrmData = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkEstiDetail", param);
				if(!ObjUtils.isEmpty(cfrmData))	{
					if(!"2".equals(cfrmData.get("CONFIRM_FLAG")))	{
						throw new  UniDirectValidateException(this.getMessage("54458", user));	/* 54458:이미 취소되었거나 확정되지 않았습니다. */
					}
					...
					super.commonDao.update("biv105ukrvServiceImpl.updateEstimateDetailConfirm", param);
	...
	private void checkScm(Map param, LoginVO user) throws Exception {
		List<Map<String, Object>> params = super.commonDao.list("biv105ukrvServiceImpl.checkSCM", param);
		if(!ObjUtils.isEmpty(params))	{
			Map<String, Object> baseData = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkSCMDetail", param);
			...
			if(!ObjUtils.isEmpty(baseData))	{
				...
				for(Map<String, Object> scmParam : params)	{
					...
					Map<String, Object> dData = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkSCMDelete", scmParam);
					if(ObjUtils.isEmpty(dData))	{
						...
						if("2".equals(controlStatus))	{
							...
							super.commonDao.update("biv105ukrvServiceImpl.updateSCM", scmParam);
						}
	...
	private String  getScm(Map param)  throws Exception {
		Map<String, Object> scm = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.getSCM", param);
		String r = "N";
	...
	private void  checkStatus(Map param, LoginVO user)  throws Exception {
		Map<String, Object> obj = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkStatus", param);
		String r = "";
	...
	private void  checkProgress(Map param, String type, LoginVO user)  throws Exception {
		...
		if("Master".equals(type))	{
			obj = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkProgressMaster", param);
		}else {
			obj = (Map<String, Object>)super.commonDao.select("biv105ukrvServiceImpl.checkProgressDetail", param);
		}
