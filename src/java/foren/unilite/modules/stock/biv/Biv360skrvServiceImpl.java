...
@Service("biv360skrvService")
public class Biv360skrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectList(Map param,LoginVO user) throws Exception {
		...
		return  super.commonDao.list("biv360skrvServiceImpl.selectList", param);
	}
