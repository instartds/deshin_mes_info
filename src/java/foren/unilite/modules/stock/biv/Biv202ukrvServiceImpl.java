...
@Service("biv202ukrvService")
public class Biv202ukrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public Object  userWhcode(Map param) throws Exception {	
		return  super.commonDao.select("biv202ukrvServiceImpl.userWhcode", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "stock")
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
	
		return  super.commonDao.list("biv202ukrvServiceImpl.selectList", param);
	}
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "stock")
	public List<Map<String, Object>>  selectList2(Map param) throws Exception {
	
		return  super.commonDao.list("biv202ukrvServiceImpl.selectList2", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {			
			...
			for(Map param:  dataList) {
				...
				param.put("data", super.commonDao.insert("biv202ukrvServiceImpl.insertLog", param));
...
//			param.put("OPR_FLAG", oprFlag);
			...
			super.commonDao.insert("biv202ukrvServiceImpl.insertLog", param);
		}		
