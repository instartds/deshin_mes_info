...
@Service("biv130ukrvService")
public class Biv130ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public Object  userWhcode(Map param) throws Exception {	
		return  super.commonDao.select("biv130ukrvService.userWhcode", param);
	}
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("biv130ukrvService.selectMasterList", param);
	}
	...
	public List<Map<String, Object>> selectMaster2(Map param) throws Exception {
		return super.commonDao.list("biv130ukrvService.selectMasterList2", param);
	}
	...
	public Object insertMaster(Map param, LoginVO user) throws Exception {
		...
		Object r = super.commonDao.queryForObject("biv130ukrvService.insertMasterList", param);
		...
		//super.commonDao.list("biv130ukrvService.selectMasterList2", param);
		return r;
	}
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user, String cellFlagYN) throws Exception {		
		try {
			...
			List<Map> chkList = (List<Map>) super.commonDao.list("biv130ukrvService.checkCompCode", compCodeMap);
			for(Map param : paramList )	{			 
				for(Map checkCompCode : chkList) {
					 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
					 param.put("CELL_FLAG_YN", cellFlagYN);
					 super.commonDao.insert("biv130ukrvService.insertDetail", param);
				}
			}	
		}catch(Exception e){
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		Map compCodeMap = new HashMap();
		compCodeMap.put("S_COMP_CODE", user.getCompCode());
		List<Map> chkList = (List) super.commonDao.list("biv130ukrvService.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 super.commonDao.update("biv130ukrvService.deleteDetail", param);
			 }
		 }
		 return 0;
	}
