...
@Service("biv113ukrvService")
public class Biv113ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public Object  YyyymmSet(Map param) throws Exception {	
		return  super.commonDao.select("biv113ukrvService.YyyymmSet", param);	// 자동 날짜 지정
	}
	
	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)
	public Object  WhCodeSet(Map param) throws Exception {	
		return  super.commonDao.select("biv113ukrvService.WhCodeSet", param);	// 실행할때 창고 검사
	}
	
	@ExtDirectMethod(group = "stock", value = ExtDirectMethodType.STORE_READ)
	public Object  WhCodeCount(Map param) throws Exception {	
		return  super.commonDao.select("biv113ukrvService.WhCodeCount", param);	// 실행할때 창고 recordCount검사
	}
	...
	public Object insertMaster(Map param, LoginVO user) throws Exception {
		...
		Object r = super.commonDao.queryForObject("biv113ukrvService.insertDetail", param);
