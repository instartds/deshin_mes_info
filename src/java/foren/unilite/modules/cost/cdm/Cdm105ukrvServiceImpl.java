...
@Service("cdm105ukrvService")
public class Cdm105ukrvServiceImpl extends TlabAbstractServiceImpl {
    //에러메세지 처리
    String errorDesc = "";
	...
	public Object procButton(Map param, LoginVO user) throws Exception {
		super.commonDao.queryForObject("cdm105ukrvServiceImpl.processCosting", param);
	...
	public Object selectRefConfig(Map param) throws Exception {
		return super.commonDao.select("cdm105ukrvServiceImpl.selectRefConfig", param);
	}

	@ExtDirectMethod(group = "cost", value = ExtDirectMethodType.FORM_LOAD)
	public Object selectMaxSeq(Map param) throws Exception {
		return super.commonDao.select("cdm105ukrvServiceImpl.selectMaxSeq", param);
	}
