...
@Service("cdm100ukrvService")
public class Cdm100ukrvServiceImpl extends TlabAbstractServiceImpl {
    //에러메세지 처리
    String errorDesc = "";
	...
	public Object procButton(Map param, LoginVO user) throws Exception {
		super.commonDao.queryForObject("cdm100ukrvServiceImpl.processCosting", param);
	...
	public Object selectRefConfig(Map param) throws Exception {
		return super.commonDao.select("cdm100ukrvServiceImpl.selectRefConfig", param);
	}

	@ExtDirectMethod(group = "cost", value = ExtDirectMethodType.FORM_LOAD)
	public Object selectMaxSeq(Map param) throws Exception {
		return super.commonDao.select("cdm100ukrvServiceImpl.selectMaxSeq", param);
	}
