...
@Service("cbm050ukrvService")
public class Cbm050ukrvServiceImpl extends TlabAbstractServiceImpl {
	
	@ExtDirectMethod(group = "cost", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList1(Map param) throws Exception {
		return super.commonDao.list("cbm050ukrvServiceImpl.selectList1", param);
	}
	@ExtDirectMethod(group = "cost", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectCopy1(Map param) throws Exception {
		return super.commonDao.list("cbm050ukrvServiceImpl.selectCopy1", param);
	}
	...
	public Integer insertDetail1(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{	
			super.commonDao.update("cbm050ukrvServiceImpl.insertDetail1", param);
		}
		return 0;
	}	
	...
	public Integer updateDetail1(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )	{	
			super.commonDao.update("cbm050ukrvServiceImpl.updateDetail1", param);
		}
		 return 0;
	} 
	...
	public Integer deleteCopyDetail1(Map param) throws Exception {
		super.commonDao.update("cbm050ukrvServiceImpl.deleteCopyDetail1", param);
		return 0;
	}
	
	@ExtDirectMethod(group = "cost", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return super.commonDao.list("cbm050ukrvServiceImpl.selectList2", param);
	}
	...
	public Integer insertDetail2(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{	
			super.commonDao.update("cbm050ukrvServiceImpl.insertDetail2", param);
		}
		return 0;
	}	
	...
	public Integer updateDetail2(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )	{	
			super.commonDao.update("cbm050ukrvServiceImpl.updateDetail2", param);
		}
		 return 0;
	} 
	...
	public Integer deleteDetail2(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList )	{	
			super.commonDao.update("cbm050ukrvServiceImpl.deleteDetail2", param);
		}
		return 0;
	}
