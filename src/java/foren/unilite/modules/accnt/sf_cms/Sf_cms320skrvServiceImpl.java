...
@Service("sf_cms320skrvService")
public class Sf_cms320skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetail(Map param, LoginVO loginVO) throws Exception {
		...
		return super.commonDao.list("sf_cms320skrvService.selectDetail", param);
	}
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("sf_cms320skrvService.selectMaster", param);
	}
