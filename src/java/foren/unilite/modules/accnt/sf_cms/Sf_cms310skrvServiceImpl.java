...
@Service("sf_cms310skrvService")
public class Sf_cms310skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetail(Map param, LoginVO loginVO) throws Exception {
		...
		return super.commonDao.list("sf_cms310skrvService.selectDetail", param);
	}
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("sf_cms310skrvService.selectMaster", param);
	}
