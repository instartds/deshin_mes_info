...
@Service("sf_cms110skrvService")
public class Sf_cms110skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetail(Map param, LoginVO loginVO) throws Exception {
		...
		return super.commonDao.list("sf_cms110skrvService.selectDetail", param);
	}
