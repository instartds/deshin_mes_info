...
@Service("sf_cms100skrvService")
public class Sf_cms100skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetail(Map param, LoginVO loginVO) throws Exception {
		...
		return super.commonDao.list("sf_cms100skrvService.selectDetail", param);
	}
