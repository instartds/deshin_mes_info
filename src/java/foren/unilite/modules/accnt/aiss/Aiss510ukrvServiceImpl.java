...
@Service("aiss510ukrvService")
public class Aiss510ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("aiss510ukrvServiceImpl.selectList", param);
	}	
	...
	public List<Map<String, Object>> selectList2(Map param) throws Exception {
		return super.commonDao.list("aiss510ukrvServiceImpl.selectList2", param);
	}
	...
	private void insertList(List<Map> paramList, Map paramMaster, LoginVO user) throws UniDirectValidateException {
		...
		for(Map param :paramList )	{
			Map seqMap = (Map) super.commonDao.select("aiss510ukrvServiceImpl.getSeq", param);
			 if(ObjUtils.isNotEmpty(seqMap))	{
				 param.put("SEQ", seqMap.get("SEQ"));
			 }
			 Map err = (Map) super.commonDao.select("aiss510ukrvServiceImpl.checkData", param);
			...
			super.commonDao.insert("aiss510ukrvServiceImpl.insertList", param);							
		}
		return;
	}
	...
	public List<Map> updateList(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map param :paramList )	{			
			...
			super.commonDao.update("aiss510ukrvServiceImpl.updateList", param);							
		}
		return paramList;
	}
	...
	public void deleteList(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map param :paramList )	{
			 Map err = (Map) super.commonDao.select("aiss510ukrvServiceImpl.checkDelete", param);
			 if(!ObjUtils.isEmpty(err.get("ERROR_DESC"))){
				String errorDesc = ObjUtils.getSafeString(err.get("ERROR_DESC"));
				String errorCode = ObjUtils.getSafeString(err.get("ERROR_CODE"));
				String[] messsage = errorDesc.split(",");
			 ...
			 super.commonDao.delete("aiss510ukrvServiceImpl.deleteList", param);
		}	
		return;
	}
