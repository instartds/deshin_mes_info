...
@Service("acm110ukrService")
public class Acm110ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object getSlipNum(Map param) throws Exception {
		return super.commonDao.select("acm110ukrServiceImpl.getSlipNum", param);
	}	
	...
	public List<Map> selectSearch(Map param) throws Exception {
		return super.commonDao.list("acm110ukrServiceImpl.selectSearch", param);
	}
	// masterGrid1 조회
	@ExtDirectMethod(group = "Accnt", value = ExtDirectMethodType.STORE_READ)
	public List<Map> selectList(Map param) throws Exception {
		return super.commonDao.list("acm110ukrServiceImpl.selectList", param);
	}

	@ExtDirectMethod(group = "Accnt", value = ExtDirectMethodType.STORE_READ)
	public List<Map> selectList4(Map param) throws Exception {
		Map<String, Object> rTemp = (Map<String, Object>) super.commonDao.select("acm110ukrServiceImpl.selectFnDate", param);
		...
		return super.commonDao.list("acm110ukrServiceImpl.selectList4", param);
	}
	// 참조데이터 조회 
	@ExtDirectMethod(group = "Accnt", value = ExtDirectMethodType.STORE_READ)
	public List<Map> selectInOutRef(Map param) throws Exception {
		return super.commonDao.list("acm110ukrServiceImpl.selectInOutRef", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		if(paramList != null)	{
			for(Map param: paramList) {
				...
				for(Map paramData: dataList) {
					...
					super.commonDao.update("acm110ukrServiceImpl.insertLog", paramData);	
					i++;
				}
			}
		}
		String slipNum = ObjUtils.getSafeString(paramMasterData.get("SLIP_NUM"));
		String acDate = ObjUtils.getSafeString(paramMasterData.get("SLIP_NUM"));
		...
		// 데이터 삭제 후 저장
		super.commonDao.queryForObject("acm110ukrServiceImpl.spAccntDeleteAcSlip", sParam);
		super.commonDao.queryForObject("acm110ukrServiceImpl.spAccntInsertAcSlip", sParam);
		...
		List<Map> chkData = super.commonDao.list("acm110ukrServiceImpl.getChkData", paramMasterData);
