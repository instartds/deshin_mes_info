...
@Service("acm200ukrService")
public class Acm200ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object getCashAccnt(Map param) throws Exception {
		return super.commonDao.select("acm200ukrServiceImpl.getCashAccnt", param);
	}
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return (List) super.commonDao.list("acm200ukrServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> selectSalesList(Map param, LoginVO loginVO) throws Exception {
		...
		return (List) super.commonDao.list("acm200ukrServiceImpl.selectSalesList", param);
	}
	...
	public List<Map<String, Object>> fnGetAutoMethod( Map param ) throws Exception {
		...
		List<Map<String, Object>> rList = super.commonDao.list("acm200ukrServiceImpl.fnGetAutoMethod", param);
		for (Map rData : rList) {
	...
	public Object fnAcmcarMapping(Map param, LoginVO user) throws Exception {	
		...
		super.commonDao.queryForObject("acm200ukrServiceImpl.spAcmCarMapping", sParam);
	...
	public Object selectOption(Map param) throws Exception {
		return super.commonDao.select("acm200ukrServiceImpl.selectOption", param);
	}
	...
	public Object getSlipNum(Map param) throws Exception {
		return super.commonDao.select("acm200ukrServiceImpl.getSlipNum", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		Map autoMap = (Map) super.commonDao.select("acm200ukrServiceImpl.getMaxAutoNum", sParam);
		...
		if(paramList != null)	{
			for(Map param: paramList) {
				...
				for(Map paramData: dataList) {
					...
					super.commonDao.update("acm200ukrServiceImpl.insertLog", paramData);
					i++;
				}
			}
		}
		...
		super.commonDao.queryForObject("acm200ukrServiceImpl.spAccntAcSlip", sParam);
			...
			if(paramList != null)	{
				...
				for(Map param: paramList) {
					...
					for(Map paramData: dataList2) {
						Map rMap= (Map) super.commonDao.select("acm200ukrServiceImpl.selectLog", paramData);
						...
						if(rMap.get("OPR_FLAG").equals("D")) {
							...
							dataMaster.put("AC_DATE","");
						}else{
							dataMaster.put("SLIP_YN","Y");
							dataMaster.put("AC_DATE",paramData.get("AC_DATE"));
						}
				...
				if(bDelete) {
					super.commonDao.update("acm200ukrServiceImpl.updateMasterDelete", dataMaster);
				}
				else {
					super.commonDao.update("acm200ukrServiceImpl.updateMaster", dataMaster);
				}
			}
		}
	...
	public List<Map> selectDuplicate(Map params, LoginVO user) throws Exception {
		...
		for(Map pMap : paramList) {
			if("1".equals(params.get("csSLIP_TYPE"))) {
				...
				Map dup = (Map)super.commonDao.select("acm200ukrServiceImpl.selectDuplicate", pMap);
