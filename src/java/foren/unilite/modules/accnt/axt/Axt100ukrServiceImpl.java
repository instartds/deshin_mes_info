...
@Service("axt100ukrService")
@SuppressWarnings({"unchecked", "rawtypes"})
public class Axt100ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return (List) super.commonDao.list("axt100ukrServiceImpl.selectList", param);
	}
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user) throws Exception {
		try{
			for(Map param :paramList ) {
				super.commonDao.insert("axt100ukrServiceImpl.insertList", param);
			}
		}catch(Exception e){
	...
	public List<Map> updateList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("axt100ukrServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("axt100ukrServiceImpl.deleteList", param);
		}
		return paramList;
	}
