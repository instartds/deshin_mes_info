...
@Service( "afs520skrService" )
public class Afs520skrServiceImpl extends TlabAbstractServiceImpl {
    ...
    public List<Map<String, Object>> selectList( Map param ) throws Exception {
        ...
        if (param.get("DEC_FLAG").equals("Y")) {
            List<Map> decList = (List<Map>)super.commonDao.list("afs520skrServiceImpl.selectList", param);
            ...
            return (List)super.commonDao.list("afs520skrServiceImpl.selectList", param);
        }
    }
