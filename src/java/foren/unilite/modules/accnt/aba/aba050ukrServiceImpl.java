...
@Service("aba050ukrService")
public class aba050ukrServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  select(Map param) throws Exception {
		return  super.commonDao.list("aba050ukrService.select", param);
	}
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{			 
					 ...
					 super.commonDao.update("aba050ukrService.insertDetail", param);
				}
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		...
		List<Map> chkList = (List<Map>) super.commonDao.list("aba050ukrService.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 super.commonDao.update("aba050ukrService.updateDetail", param);
			 }
		 }
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		Map compCodeMap = new HashMap();
		compCodeMap.put("S_COMP_CODE", user.getCompCode());
		List<Map> chkList = (List) super.commonDao.list("aba050ukrService.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 super.commonDao.update("aba050ukrService.deleteDetail", param);
			 }
		 }
		 return 0;
	}
	...
	public List<Map<String, Object>>  select2(Map param) throws Exception {
		...
		return  super.commonDao.list("aba050ukrService.select2", param);
	}
	...
	public Integer  insertDetail2(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{			 
					 param.put("COMP_CODE", user.getCompCode());
					 super.commonDao.update("aba050ukrService.insertDetail2", param);
				}
		}catch(Exception e){
			throw new  UniDirectValidateException(this.getMessage("2627", user));
		}
	...
	public Integer deleteDetail2(List<Map> paramList,  LoginVO user) throws Exception {
		...
		List<Map> chkList = (List) super.commonDao.list("aba050ukrService.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {
				 param.put("COMP_CODE", checkCompCode.get("COMP_CODE"));
				 super.commonDao.update("aba050ukrService.deleteDetail2", param);
			 }
		 }
		 return 0;
	}	
	...
	public List<Map<String, Object>>  select3(Map param) throws Exception {
		...
		return  super.commonDao.list("aba050ukrService.select3", param);
	}
	...
	public Integer  insertDetail4(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{			 
					 param.put("COMP_CODE", user.getCompCode());
					 super.commonDao.update("aba050ukrService.insertDetail4", param);
				}
		}catch(Exception e){
			throw new  UniDirectValidateException(this.getMessage("2627", user));
		}
	...
	public Integer  insertDetail5(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{			 
					 param.put("COMP_CODE", user.getCompCode());
					 super.commonDao.update("aba050ukrService.insertDetail5", param);
				}
		}catch(Exception e){
			throw new  UniDirectValidateException(this.getMessage("2627", user));
		}
