...
@Service("aba160ukrService")
public class Aba160ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("aba160ukrServiceImpl.selectList", param);
	}	
	/**
	 * 
	 * 연간자료생성전 체크관련
	...
	public Object  checkBeforeInsert(Map param) throws Exception {	
		...
		return  super.commonDao.select("aba160ukrServiceImpl.checkBeforeInsert", param);
	}
	/**
	 * 저장
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {		
		try {
			...
			super.commonDao.delete("aba160ukrServiceImpl.deleteDetail", dataMaster);
			
			for(Map param : paramList )	{	
				param.put("F_CLOSE_DATE", dataMaster.get("F_CLOSE_DATE"));
				super.commonDao.update("aba160ukrServiceImpl.insertDetail", param);
			}
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		Map<String, Object> dataMaster = (Map<String, Object>) paramMaster.get("data");
		 for(Map param :paramList )	{
			 param.put("F_CLOSE_DATE", dataMaster.get("F_CLOSE_DATE"));
			 super.commonDao.update("aba160ukrServiceImpl.updateDetail", param);
		 }		 
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user, Map paramMaster) throws Exception {
		 for(Map param :paramList )	{
			 try {
				 super.commonDao.delete("aba160ukrServiceImpl.deleteDetail", param);
			 }catch(Exception e)	{
