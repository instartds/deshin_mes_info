...
@Service("agd430ukrService")
public class Agd430ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("agd430ukrServiceImpl.selectList", param);
	}
    ...
    private List<Map> runProcedure(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
        ...
        for(Map param: paramList)      {
        	//AGD390T에 먼저 INSERT
        	super.commonDao.insert("agd430ukrServiceImpl.insertAgd390", param);
        	
        	//로그테이블에 키값 추가하여 INSERT
        	param.put("KEY_VALUE", keyValue);
        	param.put("PROC_DATE", procDate);
        	super.commonDao.insert("agd430ukrServiceImpl.insertLogTable", param);
        }  
    	...
    	if(oprFlag.equals("D")) {
    		...
    		super.commonDao.queryForObject("agd430ukrServiceImpl.cancelSlip", spParam);
    		...
    		spParam.put("INPUT_USER_ID"	, user.getUserID());
    		spParam.put("ERROR_DESC"	, "");
    		super.commonDao.queryForObject("agd430ukrServiceImpl.runAutoSlip", spParam);
    	}
