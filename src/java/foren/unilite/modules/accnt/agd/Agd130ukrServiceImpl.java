...
@Service("agd130ukrService")
public class Agd130ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object procButton(Map param, LoginVO user) throws Exception {
		super.commonDao.queryForObject("agd130ukrServiceImpl.agd130ukrDo", param);
	...
	public Object cancButton(Map param, LoginVO user) throws Exception {
		super.commonDao.queryForObject("agd130ukrServiceImpl.agd130ukrCancel", param);
