...
@Service("agd111ukrService")
public class Agd111ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "accnt")			// 조회
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("agd111ukrServiceImpl.selectList", param);
	}
    ...
    private void runProcedure( List<Map> paramList, Map paramMaster, LoginVO user ) throws Exception {
        ...
        for(Map param: paramList)      {
        	...
        	super.commonDao.insert("agd111ukrServiceImpl.insertLogTable", param);
        }       
        ...
        if (oprFlag.equals("D")) {
            ...
            spParam.put("BILL_TYPE"		, (String)dataMaster.get("BILL_TYPE"));
            ...
            super.commonDao.queryForObject("agd111ukrServiceImpl.cancelSlip", spParam);
            ...
            spParam.put("EBYN_MESSAGE"	, "");
            spParam.put("ERROR_DESC"	, "");
            super.commonDao.queryForObject("agd111ukrServiceImpl.runAutoSlip", spParam);
        }
