...
@Service("agd410ukrService")
public class Agd410ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("agd410ukrServiceImpl.selectList", param);
	}
    ...
    private List<Map> runProcedure(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
        ...
        //설정계정
        String acctCode	= (String) dataMaster.get("SET_ACCNT_CODE");
        //계정과목 1, 2
//        String bookCode1= (String) dataMaster.get("BOOK_CODE1");
//        String bookCode2= (String) dataMaster.get("BOOK_CODE2");
        //language type
        ...
        for(Map param: paramList)      {
        	if(!oprFlag.equals("D")) {
	        	//AGD410T에 먼저 INSERT
	        	super.commonDao.insert("agd410ukrServiceImpl.insertAgd410", param);
        	}
        	
        	//로그테이블에 키값 추가하여 INSERT
        	param.put("KEY_VALUE", keyValue);
        	param.put("PROC_DATE", procDate);
        	super.commonDao.insert("agd410ukrServiceImpl.insertLogTable", param);
        }  
...
//    		spParam.put("BOOK_CODE1"	, bookCode1);
//    		spParam.put("BOOK_CODE2"	, bookCode2);
    		spParam.put("LANG_TYPE"		, langType);
    		spParam.put("INPUT_USER_ID"	, user.getUserID());
    		spParam.put("ERROR_DESC"	, "");
    		super.commonDao.queryForObject("agd410ukrServiceImpl.cancelSlip", spParam);
...
//    		spParam.put("BOOK_CODE1"	, bookCode1);
//    		spParam.put("BOOK_CODE2"	, bookCode2);
    		spParam.put("S_ACCNT"		, acctCode);
    		spParam.put("LANG_TYPE"		, langType);
    		spParam.put("INPUT_USER_ID"	, user.getUserID());
    		spParam.put("ERROR_DESC"	, "");
    		super.commonDao.queryForObject("agd410ukrServiceImpl.runAutoSlip", spParam);
    	}
