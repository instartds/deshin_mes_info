...
@Service("agd121ukrService")
public class Agd121ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("agd121ukrServiceImpl.selectList", param);
	}
    ...
    private void runProcedure( List<Map> paramList, Map paramMaster, LoginVO user ) throws Exception {
        ...
        for(Map param: paramList)      {
        	...
        	super.commonDao.insert("agd121ukrServiceImpl.insertLogTable", param);
        }       
        ...
        if (oprFlag.equals("D")) {
            ...
            spParam.put("ACCOUNT_TYPE"		, (String)dataMaster.get("ACCOUNT_TYPE"));
            spParam.put("EXPECTED_DATE"		, (String)dataMaster.get("EXPECTED_DATE"));
            ...
            super.commonDao.queryForObject("agd121ukrServiceImpl.cancelSlip", spParam);
            ...
            spParam.put("EBYN_MESSAGE"		, "");
            spParam.put("ERROR_DESC"		, "");
            super.commonDao.queryForObject("agd121ukrServiceImpl.runAutoSlip", spParam);
        }
