...
@Service("agd390ukrService")
public class Agd390ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("agd390ukrServiceImpl.selectList", param);
	}
...
//        String bookCode2= (String) dataMaster.get("BOOK_CODE2");
        ...
        for(Map param: paramList)      {
        	if(!oprFlag.equals("D")) {
	        	//AGD390T에 먼저 INSERT
	        	super.commonDao.insert("agd390ukrServiceImpl.insertAgd390", param);
        	}
        	
        	//로그테이블에 키값 추가하여 INSERT
        	param.put("KEY_VALUE"	, keyValue);
        	param.put("PROC_DATE"	, procDate);
        	super.commonDao.insert("agd390ukrServiceImpl.insertLogTable", param);
        }  
    	...
    	if(oprFlag.equals("D")) {
    		...
    		super.commonDao.queryForObject("agd390ukrServiceImpl.cancelSlip", spParam);
    		...
    		spParam.put("INPUT_USER_ID"	, user.getUserID());
    		spParam.put("ERROR_DESC"	, "");
    		super.commonDao.queryForObject("agd390ukrServiceImpl.runAutoSlip", spParam);
    	}
