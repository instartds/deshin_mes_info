...
@Service("agc180skrService")
public class Agc180skrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> fnCheckExistABA131(Map param) throws Exception {
		return super.commonDao.list("agc180skrService.fnCheckExistABA131", param);
	}
	...
	public List<Map<String, Object>> selectList1(Map param , LoginVO user) throws Exception {			// 
		...
		List<Map> fnCheckExistABA131 = (List<Map>) super.commonDao.list("agc180skrService.fnCheckExistABA131", param);
	    if(ObjUtils.isEmpty(fnCheckExistABA131)){
			throw new  UniDirectValidateException(this.getMessage("55321", user));
		}else{
		    List<Map<String, Object>> returnData = (List<Map<String, Object>>) super.commonDao.list("agc180skrService.selectList1", param);
            String errorDesc ="";
	...
	public List<Map<String, Object>> selectList2(Map param , LoginVO user) throws Exception {			// 
		...
		if(ObjUtils.isEmpty(fnCheckExistABA131)){
		    ...
		    List<Map<String, Object>> returnData = (List<Map<String, Object>>) super.commonDao.list("agc180skrService.selectList2", param);
            String errorDesc ="";
            if(ObjUtils.isNotEmpty(returnData)){
                errorDesc = ObjUtils.getSafeString(returnData.get(0).get("ERROR_DESC"));
            }
