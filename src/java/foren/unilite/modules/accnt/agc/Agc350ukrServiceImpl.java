...
@Service("agc350ukrService")
public class Agc350ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object fnDispYN(Map param) throws Exception {
		return super.commonDao.select("agc350ukrServiceImpl.fnDispYN", param);
	}
	...
	public List<Map<String, Object>> selectRef1(Map param, LoginVO user) throws Exception {
		...
		return super.commonDao.list("agc350ukrServiceImpl.selectRef1", param);
	}
	...
	public Object costInformation(Map param) throws Exception {
		...
		reValue = reValue.replaceAll("\\]", "");
		param.put("DIV_CODE", reValue);
		return super.commonDao.select("agc350ukrServiceImpl.costInformation", param);
	}
	...
	public List<Map<String, Object>> selectList1(Map param, LoginVO user) throws Exception {
		...
		param.put("COST_PD", "2050"); // 용역원가의 '7000 당기용역원가'가 반영될 손익계산서의 '2050 용역매출원가2' 항목코드
	...
	//		param.put("dAmt7000","0");
			...
			super.commonDao.list("agc350ukrServiceImpl.fnCreateTable", param);
			...
			return super.commonDao.list("agc350ukrServiceImpl.fnMakeSQL", param);
		}else{
		
			//String sMatrl_YN = "";
	
			/*//회계기준설정으로부터 원가대체기준 설정내용 확인
			if(super.commonDao.list("agc350ukrServiceImpl.fnGetBaseInfo", param).size()==0){
				throw new  UniDirectValidateException(this.getMessage("54302", user));
			}else{
				List<Map> option1 = (List<Map>) super.commonDao.list("agc350ukrServiceImpl.fnGetBaseInfo", param);
	...
	//		param.get("FR_DATE")
			...
			if(sMatrl_YN.equals("1")){
				super.commonDao.list("agc350ukrServiceImpl.fnRefMatrlTbl", param);
			}*/
...
//		param.get("FR_DATE")
		...
		if(param.get("SEARCH").equals("SEARCH")){
			...
			return super.commonDao.list("agc350ukrServiceImpl.produceBudgetSearch", param);
		}else{
			return super.commonDao.list("agc350ukrServiceImpl.produceBudget", param);
		}
	}
	...
	public Integer  cancSlip(Map param, LoginVO user) throws Exception {
		...
		String errorCode ="";
		List<Map> errCheck = (List<Map>) super.commonDao.list("agc350ukrServiceImpl.fnagd058Canc", param);
	...
	public void  insertDetail1(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {		
		...
		if(super.commonDao.list("agc350ukrServiceImpl.beforeSaveCheck", dataMaster).size() > 0){
			...
			List<Map> checkOption = (List<Map>) super.commonDao.list("agc350ukrServiceImpl.beforeSaveCheck", dataMaster);
		...
		//원가대체 마스터 삭제
		super.commonDao.delete("agc350ukrServiceImpl.deleteMaster", dataMaster);
		
		//원가대체 디테일 삭제
		super.commonDao.delete("agc350ukrServiceImpl.deleteDetail", dataMaster);
		...
		super.commonDao.update("agc350ukrServiceImpl.insertDetail1", dataList);
	...
	public void  insertDetail2(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {		
		...
		super.commonDao.update("agc350ukrServiceImpl.insertDetail2", dataList);
	...
	public void updateDetail3(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {
		...
		for(Map param :paramList )	{	
			...
			super.commonDao.update("agc350ukrServiceImpl.updateDetail3", param);
		}
		 return;
	} 
	...
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_MODIFY, group = "accnt")
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor={Exception.class})
	public void agc350ukrDelA (Map paramMaster, LoginVO user) throws Exception {
