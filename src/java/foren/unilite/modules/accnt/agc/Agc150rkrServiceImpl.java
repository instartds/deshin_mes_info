...
@Service("agc150rkrService")
public class Agc150rkrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO user) throws Exception {
    	...
    	return super.commonDao.list("agc150rkrService.selectList", param);
	}	
