...
@Service("agc170skrService")
public class Agc170skrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList1(Map param, LoginVO user) throws Exception {			// 재무상태표
	    ...
	    if(ObjUtils.isEmpty(fnCheckExistABA131)){
		    ...
		    List<Map<String, Object>> returnData = (List<Map<String, Object>>) super.commonDao.list("agc170skrService.selectList1", param);
            String errorDesc ="";
	...
	public List<Map<String, Object>> selectList2(Map param, LoginVO user) throws Exception {
	    ...
	    if(ObjUtils.isEmpty(fnCheckExistABA131)){
		    ...
		    List<Map<String, Object>> returnData = (List<Map<String, Object>>) super.commonDao.list("agc170skrService.selectList2", param);
            String errorDesc ="";
            if(ObjUtils.isNotEmpty(returnData)){
                errorDesc = ObjUtils.getSafeString(returnData.get(0).get("ERROR_DESC"));
            }
	...
	public List<Map<String, Object>> selectList3(Map param, LoginVO user) throws Exception {
	    ...
	    if(ObjUtils.isEmpty(fnCheckExistABA131)){
		    ...
		    List<Map<String, Object>> returnData = (List<Map<String, Object>>) super.commonDao.list("agc170skrService.selectList3", param);
            String errorDesc ="";
            if(ObjUtils.isNotEmpty(returnData)){
                errorDesc = ObjUtils.getSafeString(returnData.get(0).get("ERROR_DESC"));
            }
