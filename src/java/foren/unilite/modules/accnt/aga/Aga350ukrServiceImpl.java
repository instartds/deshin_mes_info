...
@Service("aga350ukrService")
public class Aga350ukrServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		return  super.commonDao.list("aga350ukrServiceImpl.selectList", param);
	}
	...
	public void insertList(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map param :paramList )	{
			 super.commonDao.insert("aga350ukrServiceImpl.insertList", param);
		}	
		return;
	}
	...
	public void updateList(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map param :paramList )	{
			 super.commonDao.update("aga350ukrServiceImpl.updateList", param);
		}	
		return;
	}
	...
	public void deleteList(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map param :paramList )	{
			 super.commonDao.delete("aga350ukrServiceImpl.deleteList", param);
		}	
		return;
	}
}
