...
@Service("aigd320ukrvService")
public class Aigd320ukrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("aigd320ukrvServiceImpl.selectList", param);
	}
    ...
    private List<Map> runProcedure(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
        ...
        //에러메세지 처리
        String errorDesc = "";
        Map<String, Object> sysDateMap =(Map<String, Object>) super.commonDao.select("aigd320ukrvServiceImpl.selectSysdate", paramMaster);
        
        //2.로그테이블에 KEY_VALUE 업데이트
        for(Map param: paramList)      {
            param.put("KEY_VALUE"   , keyValue);
            param.put("OPR_FLAG"    , oprFlag);
            super.commonDao.insert("aigd320ukrvServiceImpl.insertLogTable", param);
        }       
        ...
        if(oprFlag.equals("D")) {
            ...
            super.commonDao.queryForObject("aigd320ukrvServiceImpl.cancelSlip", spParam);
            ...
            super.commonDao.queryForObject("aigd320ukrvServiceImpl.runAutoSlip", spParam);
