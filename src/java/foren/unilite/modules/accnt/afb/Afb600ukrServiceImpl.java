...
@Service("afb600ukrService")
public class Afb600ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectRefCode(Map param) throws Exception {
		return super.commonDao.select("afb600ukrServiceImpl.selectRefCode", param);
	}
	/**
	 * 공공예산관련 옵션 
	 * @param param
	...
	public Object selectCheck1(Map param) throws Exception {
		return super.commonDao.select("afb600ukrServiceImpl.selectCheck1", param);
	}
	/**
	...
	public Object selectCheck2(Map param) throws Exception {
		return super.commonDao.select("afb600ukrServiceImpl.selectCheck2", param);
	}
	/**
	 * 결재상신 경로정보
	 * @param param
	...
	public Object selectCheck3(Map param) throws Exception {
		return super.commonDao.select("afb600ukrServiceImpl.selectCheck3", param);
	}
	/**
	 * 예산기안_확정버튼 사용자ID
	 * @param param
	...
	public Object selectCheck4(Map param) throws Exception {
		return super.commonDao.select("afb600ukrServiceImpl.selectCheck4", param);
	}
	/**
	 * 지출결의_수정자ID
	 * @param param
	...
	public Object selectCheck5(Map param) throws Exception {
		return super.commonDao.select("afb600ukrServiceImpl.selectCheck5", param);
	}
	...
	public List<Map<String, Object>>  selectMaster(Map param) throws Exception {	
		...
		return super.commonDao.list("afb600ukrServiceImpl.selectMaster", param);
	...
	public List<Map<String, Object>>  selectDetail(Map param) throws Exception {	
		...
		return super.commonDao.list("afb600ukrServiceImpl.selectDetail", param);
	...
	public List<Map<String, Object>>  posAmt(Map param, LoginVO user) throws Exception {
		String errorDesc ="";
		List<Map> errCheck = (List<Map>) super.commonDao.list("afb600ukrServiceImpl.selectPosAmt", param);
			...
			if(!ObjUtils.isEmpty(errorDesc)){
				...
				return super.commonDao.list("afb600ukrServiceImpl.selectPosAmt", param);
			}
	...
	public List<Map<String, Object>>  pro1(Map param, LoginVO user) throws Exception {	
		List<Map> passCheck = (List<Map>) super.commonDao.list("afb600ukrServiceImpl.fnCheckPassword", param);
		if(passCheck.isEmpty()){
			...
			if(passCheck.get(0).get("CHECK_PASSWORD").equals("Y")){
				...
				if(!backPassWord.equals(paramPassWord)){
					...
					String errorDesc ="";
					List<Map> errCheck = (List<Map>) super.commonDao.list("afb600ukrServiceImpl.selectPro1", param);
					errorDesc = (String) errCheck.get(0).get("ERROR_DESC");
					
					if(!ObjUtils.isEmpty(errorDesc)){
						throw new  Exception(errorDesc);
					}else{
						return super.commonDao.list("afb600ukrServiceImpl.selectPro1", param);
					}
				}
			}else{
				String errorDesc ="";
		...
		if(passCheck.isEmpty()){
			...
			if(passCheck.get(0).get("CHECK_PASSWORD").equals("Y")){
				...
				if(!backPassWord.equals(paramPassWord)){
					...
					String errorDesc1 ="";
					List<Map> errCheck1 = (List<Map>) super.commonDao.list("afb600ukrServiceImpl.selectReCancel1", param);
					errorDesc1 = (String) errCheck1.get(0).get("ERROR_DESC");
					
					if(!ObjUtils.isEmpty(errorDesc1)){
						throw new  Exception(errorDesc1);
					}else{
						super.commonDao.list("afb600ukrServiceImpl.selectReCancel1", param);
						
						String errorDesc2 ="";
						List<Map> errCheck2 = (List<Map>) super.commonDao.list("afb600ukrServiceImpl.selectReCancel2", param);
						errorDesc2 = (String) errCheck2.get(0).get("ERROR_DESC");
						
						if(!ObjUtils.isEmpty(errorDesc2)){
							throw new  Exception(errorDesc2);
						}else{
							return super.commonDao.list("afb600ukrServiceImpl.selectReCancel2", param);
						}
					}
				}
			}else{
		...
		if(passCheck.isEmpty()){
			...
			if(passCheck.get(0).get("CHECK_PASSWORD").equals("Y")){
				...
				if(!backPassWord.equals(paramPassWord)){
					...
					String errorDesc ="";
					List<Map> errCheck = (List<Map>) super.commonDao.list("afb600ukrServiceImpl.selectPro2", param);
					errorDesc = (String) errCheck.get(0).get("ERROR_DESC");
					
					if(!ObjUtils.isEmpty(errorDesc)){
						throw new  Exception(errorDesc);
					}else{
						return super.commonDao.list("afb600ukrServiceImpl.selectPro2", param);
					}
				}
			}else{
				String errorDesc ="";
	...
	public ExtDirectFormPostResult syncMaster(Afb600ukrModel param, LoginVO user, BindingResult result) throws Exception {
		...
		super.commonDao.insert("afb600ukrServiceImpl.insertLogMaster", param);
...
//			String[] messsage = errorDesc.split(";");
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		super.commonDao.insert("afb600ukrServiceImpl.insertLogMaster", dataMaster);
...
//			String[] messsage = errorDesc.split(";");
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("afb600ukrServiceImpl.insertLogDetail", param);
		}		
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		try {
			for(Map param : paramList )	{
				super.commonDao.update("afb600ukrServiceImpl.insertDetail", param);
			}	
		}catch(Exception e){
	...
	public Integer updateDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )	{	
			super.commonDao.insert("afb600ukrServiceImpl.updateDetail", param);
		}
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user) throws Exception {
		 for(Map param :paramList )	{
			 try {
				 super.commonDao.delete("afb600ukrServiceImpl.deleteDetail", param);
			 }catch(Exception e)	{
