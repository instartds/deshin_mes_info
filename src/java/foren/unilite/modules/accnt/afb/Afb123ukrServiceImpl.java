...
@Service("afb123ukrService")
public class Afb123ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object getPosBudgAmt(Map param) throws Exception {
		return super.commonDao.list("afb123ukrServiceImpl.getPosBudgAmt", param);
	}	
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO user) throws Exception {		
		return (List) super.commonDao.list("afb123ukrServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> getAutoNo (Map param, LoginVO user) throws Exception {		
		return (List) super.commonDao.list("afb123ukrServiceImpl.getAutoNo", param);
	}
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user) throws Exception {
		try{
			for(Map param :paramList ) {
				super.commonDao.insert("afb123ukrServiceImpl.insertList", param);
			}
		}catch(Exception e){
	...
	public List<Map> updateList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("afb123ukrServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("afb123ukrServiceImpl.deleteList", param);
		}
		return paramList;
	}
    ...
    public List<Map> saveAllRequest(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
        ...
        super.commonDao.queryForObject("afb123ukrServiceImpl.spAutoNum", autoSpParam);
...
//                param.put("APRV_COMMENT", dataMaster.get("APRV_COMMENT"));
        ...
        spParam.put("APRV_TYPE", "DC");
        spParam.put("SLIP_TYPE", "");
        spParam.put("USER_ID"  , user.getUserID());
        super.commonDao.queryForObject("uspJoinsAccntAprvCheckAfb123ukr", spParam);
...
//            dataMaster.put("ELEC_SLIP_NO", "");
            ...
            spParam2.put("APRV_TYPE", "DC");
            spParam2.put("USER_ID"  , user.getUserID());
            super.commonDao.queryForObject("uspJoinsAccntAprvBufAfb123ukr", spParam2);
...
//                dataMaster.put("ELEC_SLIP_NO", "");
                ...
                spParam3.put("APRV_TYPE", "DC");
                spParam3.put("USER_ID"  , user.getUserID());
                super.commonDao.queryForObject("uspJoinsAccntAprvMainAfb123ukr", spParam3);
...
//        super.commonDao.insert("afb123ukrServiceImpl.insertRequestLogDetail", paramIns);
...
//            String divertSmtNum = (String) ObjUtils.getSafeString(autoSpParam.get("KEY_NUMBER"));
            ...
            super.commonDao.update("afb123ukrServiceImpl.updateRequestDetail", param);
            super.commonDao.insert("afb123ukrServiceImpl.insertRequestLogDetail", param);
        }     
        return params;
    }
