...
@Service("afb500skrService")
public class Afb500skrServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectBudgName(Map param) throws Exception {	
		return  super.commonDao.list("afb500skrServiceImpl.selectBudgName", param);
	}
	...
	public List<Map<String, Object>>  selectChargeGubun(Map param) throws Exception {	
		return  super.commonDao.list("afb500skrServiceImpl.selectChargeGubun", param);
	}
	...
	public List<Map<String, Object>>  selectAmtPoint(Map param) throws Exception {	
		return  super.commonDao.list("afb500skrServiceImpl.selectAmtPoint", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.FORM_LOAD, group = "accnt")
	public Object selectDeptBudg(Map param) throws Exception {		
		return super.commonDao.select("afb500skrServiceImpl.selectDeptBudg", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "accnt")		// 메인
	public List<Map<String, Object>>  selectList(Map param) throws Exception {	
		super.commonDao.list("afb500skrServiceImpl.selectBudgName", param);
		if(super.commonDao.list("afb500skrServiceImpl.selectAmtPoint", param).equals("1")) {
			param.put("sSqlAmtPoint", ", 0, 1)");
		} else if(super.commonDao.list("afb500skrServiceImpl.selectAmtPoint", param).equals("2")) {
			param.put("sSqlAmtPoint", "+0.0045, 0, 1)");
		} else {
			param.put("sSqlAmtPoint", ", 0)");
		}
		return  super.commonDao.list("afb500skrServiceImpl.selectList", param);
	}
}
