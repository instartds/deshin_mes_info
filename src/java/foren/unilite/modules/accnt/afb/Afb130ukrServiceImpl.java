...
@Service("afb130ukrService")
public class Afb130ukrServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectFnDate(Map param) throws Exception {	
		return  super.commonDao.list("afb130ukrServiceImpl.selectFnDate", param);
	}
	...
	public List<Map<String, Object>>  selectChargeInfo(Map param) throws Exception {	
		return  super.commonDao.list("afb130ukrServiceImpl.selectChargeInfo", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "accnt")		// 메인 조회
	public List<Map<String, Object>>  selectList(Map param) throws Exception {	
		super.commonDao.list("afb130ukrServiceImpl.selectList1", param);
		return  super.commonDao.list("afb130ukrServiceImpl.selectList2", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "accnt")		// 예산참조 조회
	public List<Map<String, Object>>  selectList2(Map param) throws Exception {	
		Map selectFnDate = (Map) super.commonDao.queryForObject("afb130ukrServiceImpl.selectFnDate", param);
		...
		return  super.commonDao.list("afb130ukrServiceImpl.selectList3", param);
	}
	 ...
	 public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
	  ...
	  for(Map paramData: paramList) {   
		  ...
		  for(Map param:  dataList) {
		    ...
		    param.put("BUDG_YYYYMM", ((String) param.get("BUDG_YYYYMM")).substring(0,6));
		    param.put("data", super.commonDao.update("afb130ukrServiceImpl.insertLogAfb130t", param));
		  }
	  }
	//4.매출저장 Stored Procedure 실행
		...
		if(dataMaster.get("BUDG_YYYYMM") != null)	{
			spParam.put("FR_MONTH", ObjUtils.getSafeString(dataMaster.get("BUDG_YYYYMM")).substring(0,4)+"01");
			spParam.put("TO_MONTH", ObjUtils.getSafeString(dataMaster.get("BUDG_YYYYMM")).substring(0,4)+"12");
		}
		//spParam.put("", value)

		super.commonDao.queryForObject("afb130ukrServiceImpl.spReceiving", spParam);
...
//			param.put("IWALL_YYYYMM", ((String) param.get("IWALL_YYYYMM")).replace(".", ""));
//			List<Map> selectAfb510tMaxCalDivi = super.commonDao.list("afb130ukrServiceImpl.selectAfb510tMaxCalDivi", param);
//			if(selectAfb510tMaxCalDivi.size() == 1) {
//				List<Map> MaxCalDivi = super.commonDao.list("afb130ukrServiceImpl.selectAfb510tMaxCalDivi", param);
//				Object CalDivi = MaxCalDivi.get(0).get("CAL_DIVI");
//				param.put("sOriDivi", CalDivi);
//				super.commonDao.update("afb130ukrServiceImpl.updateAfb510tCalDivi", param);
//				// 에러처리
//			} else {
//				// 에러처리
//			}
//			List<Map> selectAfb510t1 = (List<Map>) super.commonDao.list("afb130ukrServiceImpl.selectAfb510t1", param);
//			if(selectAfb510t1.size() == 1) {
//				if(ObjUtils.parseInt(selectAfb510t1.get(0).get("BUDGET_I")) < ObjUtils.parseInt(param.get("IWALL_YYYYMM"))) {
//					// 에러처리
//				}
//				super.commonDao.update("afb130ukrServiceImpl.updateAfb510tBudgIwallIInsert1", param);
//			} else {
//				// 에러처리
//				super.commonDao.update("afb130ukrServiceImpl.insertAfb510t1", param);
//			}
//			List<Map> selectAfb510t2 = (List<Map>) super.commonDao.list("afb130ukrServiceImpl.selectAfb510t2", param);
//			if(selectAfb510t2.size() == 1) {
////				if(ObjUtils.parseInt(selectAfb510t2.get(0).get("BUDGET_I")) < 0) {
////					// 에러처리
////				}
//				super.commonDao.update("afb130ukrServiceImpl.updateAfb510tBudgIwallIInsert2", param);
//			} else {
//				// 에러처리
//				super.commonDao.update("afb130ukrServiceImpl.insertAfb510t2", param);
//			}
//			super.commonDao.update("afb130ukrServiceImpl.insertDetail", param);
//		}
//		return 0;
//	}
//	
...
//				super.commonDao.update("afb130ukrServiceImpl.insertAfb510t2", param);
//			}
//			super.commonDao.update("afb130ukrServiceImpl.deleteDetail", param);
//		}
//		return 0;
//	} 
