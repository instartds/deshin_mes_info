...
@Service("afb010ukrService")
public class Afb010ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectList(Map param) throws Exception {
		return super.commonDao.list("afb010ukrServiceImpl.selectList", param);
	}	
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user, Map paramMaster) throws Exception {		
		try {
			...
			for(Map param : paramList )	{	
				super.commonDao.update("afb010ukrServiceImpl.insertDetail", param);
			}
		}catch(Exception e){
...
//			 param.put("F_CLOSE_DATE", dataMaster.get("F_CLOSE_DATE"));
			 super.commonDao.update("afb010ukrServiceImpl.updateDetail", param);
		 }		 
		 return 0;
	} 
	...
	public Integer deleteDetail(List<Map> paramList,  LoginVO user, Map paramMaster) throws Exception {
		 for(Map param :paramList )	{
			 try {
				 super.commonDao.delete("afb010ukrServiceImpl.deleteDetail", param);
			 }catch(Exception e)	{
