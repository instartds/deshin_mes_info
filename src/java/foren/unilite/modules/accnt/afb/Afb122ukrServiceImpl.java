...
@Service("afb122ukrService")
public class Afb122ukrServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object getPosBudgAmt(Map param) throws Exception {
		return super.commonDao.list("afb122ukrServiceImpl.getPosBudgAmt", param);
	}	
	...
	public List<Map<String, Object>> selectList(Map param, LoginVO user) throws Exception {		
		return (List) super.commonDao.list("afb122ukrServiceImpl.selectList", param);
	}
	...
	public List<Map<String, Object>> getAutoNo (Map param, LoginVO user) throws Exception {		
		return (List) super.commonDao.list("afb122ukrServiceImpl.getAutoNo", param);
	}
	...
	public List<Map> insertList(List<Map> paramList, LoginVO user) throws Exception {
		try{
			for(Map param :paramList ) {
				super.commonDao.insert("afb122ukrServiceImpl.insertList", param);
			}
		}catch(Exception e){
	...
	public List<Map> updateList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("afb122ukrServiceImpl.updateList", param);
		}
		return paramList;
	}
	...
	public List<Map> deleteList(List<Map> paramList) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.delete("afb122ukrServiceImpl.deleteList", param);
		}
		return paramList;
	}
    ...
    /*    Map<String, Object> autoSpParam = new HashMap<String, Object>();
        ...
        super.commonDao.queryForObject("afb122ukrServiceImpl.spAutoNum", autoSpParam);
        
//        param.setDIVERT_SMT_NUM(ObjUtils.getSafeString(autoSpParam.get("KEY_NUMBER")));
...
//                param.put("APRV_COMMENT", dataMaster.get("APRV_COMMENT"));
        ...
        spParam.put("APRV_TYPE", "DA");
        spParam.put("SLIP_TYPE", "");
        spParam.put("USER_ID"  , user.getUserID());
        super.commonDao.queryForObject("uspJoinsAccntAprvCheckAfb122ukr", spParam);
...
//            dataMaster.put("ELEC_SLIP_NO", "");
            ...
            spParam2.put("APRV_TYPE", "DA");
            spParam2.put("USER_ID"  , user.getUserID());
            super.commonDao.queryForObject("uspJoinsAccntAprvBufAfb122ukr", spParam2);
...
//                dataMaster.put("ELEC_SLIP_NO", "");
                ...
                spParam3.put("APRV_TYPE", "DA");
                spParam3.put("USER_ID"  , user.getUserID());
                super.commonDao.queryForObject("uspJoinsAccntAprvMainAfb122ukr", spParam3);
...
//        super.commonDao.insert("afb122ukrServiceImpl.insertRequestLogDetail", paramIns);
...
//            String divertSmtNum = (String) ObjUtils.getSafeString(autoSpParam.get("KEY_NUMBER"));
            ...
            super.commonDao.update("afb122ukrServiceImpl.updateRequestDetail", param);
            super.commonDao.insert("afb122ukrServiceImpl.insertRequestLogDetail", param);
