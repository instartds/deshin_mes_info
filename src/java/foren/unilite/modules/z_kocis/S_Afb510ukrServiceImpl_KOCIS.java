...
@Service("s_afb510ukrService_KOCIS")
public class S_Afb510ukrServiceImpl_KOCIS  extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>>  selectBudgName(Map param) throws Exception {	
		return  super.commonDao.list("s_afb510ukrServiceImpl_KOCIS.selectBudgName", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "accnt")		// 메인 조회
	public List<Map<String, Object>>  selectList(Map param) throws Exception {	
		super.commonDao.list("s_afb510ukrServiceImpl_KOCIS.selectBudgName", param);
		return  super.commonDao.list("s_afb510ukrServiceImpl_KOCIS.selectList", param);
	}
	
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "accnt")		// 편성예산참조 조회
	public List<Map<String, Object>>  selectList2(Map param) throws Exception {	
		super.commonDao.list("s_afb510ukrServiceImpl_KOCIS.selectBudgName", param);
		return  super.commonDao.list("s_afb510ukrServiceImpl_KOCIS.selectList2", param);
	}
	...
	public List<Map<String, Object>>  selectBudgCloseFg(Map param) throws Exception {	
		return  super.commonDao.list("s_afb510ukrServiceImpl_KOCIS.selectBudgCloseFg", param);
	}
	...
	public Integer  insertDetail(List<Map> paramList, LoginVO user) throws Exception {		
		for(Map param :paramList )	{
			...
			String sAcYyyy = acYyyy.toString().substring(0,4);
			param.put("FR_BUDG_YYYYMM", sAcYyyy);	
			Map selectBudgCloseFg = (Map) super.commonDao.queryForObject("s_afb510ukrServiceImpl_KOCIS.selectBudgCloseFg", param);
			if(selectBudgCloseFg.isEmpty()) {
				...
				for(i = 1; i < 13; i++) {
					...
					super.commonDao.update("s_afb510ukrServiceImpl_KOCIS.updateDetail", param);
				}
			}
		}
		return 0;
	...
	public Integer deleteDetail(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )	{	
			...
			param.put("FR_BUDG_YYYYMM", sAcYyyy);
			Map selectBudgCloseFg = (Map) super.commonDao.queryForObject("s_afb510ukrServiceImpl_KOCIS.selectBudgCloseFg", param);
			List<Map> dataExistenceCheck = (List<Map>)  super.commonDao.queryForObject("s_afb510ukrServiceImpl_KOCIS.dataExistenceCheck", param);
			...
			for(i = 1; i < 13; i++) {
				...
				if(!ObjUtils.isEmpty(dataExistenceCheck)) {
					...
					super.commonDao.queryForObject("s_afb510ukrServiceImpl_KOCIS.dataExistenceCheck", param);
					super.commonDao.update("s_afb510ukrServiceImpl_KOCIS.deleteDetail", param);
				}
			}
		}
		return 0;
