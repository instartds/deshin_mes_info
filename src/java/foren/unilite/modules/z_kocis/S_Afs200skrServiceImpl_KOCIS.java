...
@Service("s_afs200skrService_KOCIS")
public class S_Afs200skrServiceImpl_KOCIS  extends TlabAbstractServiceImpl {
...
//		super.commonDao.list("afs100skrServiceImpl.selectBudgName", param);
		return  super.commonDao.list("s_afs200skrServiceImpl_KOCIS.selectList", param);
	}
}
