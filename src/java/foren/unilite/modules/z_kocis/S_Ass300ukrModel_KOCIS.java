 ...
 *
 */
public class S_Ass300ukrModel_KOCIS extends BaseVO {
    /**
     * 
     */
    ...
    private String ITEM_NM;				//품명(추가)
    private String ITEM_CD;				//10품종(추가)
    private String ASS_STATE;			//물품상태(추가)
    private String REASON_NM;			//관련근거(추가)
    private String ITEM_USE;			//물품용도(추가)
    private String INSERT_DB_USER;		//담당자(추가)
    private String UPDATE_DB_USER;		//입력자(추가)
    private String NAME;				//입력자(추가)
