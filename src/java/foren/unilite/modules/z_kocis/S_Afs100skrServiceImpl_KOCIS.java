...
@Service("s_afs100skrService_KOCIS")
public class S_Afs100skrServiceImpl_KOCIS  extends TlabAbstractServiceImpl {
...
//		super.commonDao.list("afs100skrServiceImpl.selectBudgName", param);
		return  super.commonDao.list("s_afs100skrServiceImpl_KOCIS.selectList", param);
	}
}
