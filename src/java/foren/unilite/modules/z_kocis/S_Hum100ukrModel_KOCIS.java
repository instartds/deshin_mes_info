...
public class S_Hum100ukrModel_KOCIS extends BaseVO {
    ...
    private	double 	WAGES_STD_I			;
    private	double	PAY_PRESERVE_I		;
	...
	public double getWAGES_STD_I() {
		return WAGES_STD_I;
	}
	public void setWAGES_STD_I(double wAGES_STD_I) {
		WAGES_STD_I = wAGES_STD_I;
	}
	public double getPAY_PRESERVE_I() {
		return PAY_PRESERVE_I;
	}
	public void setPAY_PRESERVE_I(double pAY_PRESERVE_I) {
    ...
    public String getEXIST_YN() {
        return EXIST_YN;
    }
    public void setEXIST_YN(String eXIST_YN) {
    	EXIST_YN = eXIST_YN;
    }
