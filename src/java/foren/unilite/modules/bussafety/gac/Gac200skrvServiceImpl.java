...
@Service("gac200skrvService")
public class Gac200skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gac200skrvServiceImpl.selectList", param);
	}
