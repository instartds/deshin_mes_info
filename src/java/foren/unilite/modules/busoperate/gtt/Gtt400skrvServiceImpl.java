...
@Service("gtt400skrvService")
public class Gtt400skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gtt400skrvServiceImpl.selectList", param);
	}
