...
@Service("gtt110skrvService")
public class Gtt110skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  (List<Map<Object, String>> ) super.commonDao.list("gtt110skrvServiceImpl.selectList", param);
	}
}
