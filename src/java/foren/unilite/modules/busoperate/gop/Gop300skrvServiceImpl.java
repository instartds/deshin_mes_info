...
@Service("gop300skrvService")
public class Gop300skrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<Object, String>>  selectList(Map param) throws Exception {	
		return  super.commonDao.list("gop300skrvServiceImpl.selectList", param);
	}
	
	@ExtDirectMethod(group = "busoperate", value = ExtDirectMethodType.STORE_READ)
	public List<Map<Object, String>>  selectListSummary(Map param) throws Exception {	
		return  super.commonDao.list("gop300skrvServiceImpl.selectListSummary", param);
	}	
