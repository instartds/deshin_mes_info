...
@Service("ppl117ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Ppl117ukrvServiceImpl  extends TlabAbstractServiceImpl {
	...
	public List<CalendarModel> readCalendars() {
		return (List<CalendarModel>) super.commonDao.list("ppl117ukrvService.getCalendarList");
	}

	@ExtDirectMethod( value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<Map<String, Object>> getEventList(Map param, LoginVO user) throws Exception {
		
		List<Map<String, Object>> titleList = (List) super.commonDao.list("ppl117ukrvService.selectTitle", param);
		String title = "";
		...
		List<Map<String, Object>> dataList = (List) super.commonDao.list("ppl117ukrvService.getEventList", param);
	...
	public Object  updateDetail(Map param, LoginVO user) throws Exception {
		String status = (String) super.commonDao.select("ppl117ukrvService.checkClose", param);
		if("8".equals(status))	{
			throw new  UniDirectValidateException("마감된 일정은 수정할 수 없습니다.");
		}
		super.commonDao.update("ppl117ukrvService.updateDetail", param);
		return param;
	}

	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<CalendarModel> selectHolydayList(Map param, LoginVO user) {
		return (List<CalendarModel>) super.commonDao.list("ppl117ukrvService.selectHolydayList", param);
	}
