...
@Service("pmp280ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Pmp280ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object getJanOutstockReqQ(Map param) throws Exception{
		return super.commonDao.select("pmp280ukrvServiceImpl.getJanOutstockReqQ", param);
	}
	/**
	 * 라벨출력
	 * @param param
	...
	public List<Map<String, Object>> printList(Map param) throws Exception{
		return super.commonDao.list("pmp280ukrvServiceImpl.printList", param);
	}	
	/**
	 * 라벨출력 노비스용
	 * @param param
	...
	public List<Map<String, Object>> printList_novis(Map param) throws Exception{
		return super.commonDao.list("pmp280ukrvServiceImpl.printList_novis", param);
	}
	/**
	 * 메인그리드
	 * @param param
	...
	public List<Map> selectList(Map param) throws Exception{
		return super.commonDao.list("pmp280ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map> pop1SelectList(Map param) throws Exception{
		return super.commonDao.list("pmp280ukrvServiceImpl.pop1SelectList", param);
	}
	/**
	 * 팝업그리드1_2
	 * @param param
	...
	public List<Map> pop1_2SelectList(Map param) throws Exception{
		return super.commonDao.list("pmp280ukrvServiceImpl.pop1_2SelectList", param);
	}
	/**
	 * 팝업그리드2
	 * @param param
	...
	public List<Map> pop2SelectList(Map param) throws Exception{
		return super.commonDao.list("pmp280ukrvServiceImpl.pop2SelectList", param);
	}
	...
	public void deletePop1_2(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )  {
			...
			super.commonDao.insert("pmp280ukrvServiceImpl.insertPop1_2", param);
			...
			super.commonDao.queryForObject("pmp280ukrvServiceImpl.spCallPop2_2", spParam2);
...
//			if(deleteList != null) this.deleteDetail(deleteList, user);
	...
	public void insertPop2(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param : paramList ) {
            ...
            Map checkLotNo = (Map) super.commonDao.select("pmp280ukrvServiceImpl.checkLotNo", param);
            if(ObjUtils.isEmpty(checkLotNo)){
			    throw new  UniDirectValidateException("해당 LOT번호에 따른 입고 데이터가 없습니다.");
            }else{
            	Map checkIn = (Map) super.commonDao.select("pmp280ukrvServiceImpl.checkIn", param);
...
/*			//입고		(20190408 업무로직 변경으로 인해 입고 로직 제거 함)
			...
			super.commonDao.insert("pmp280ukrvServiceImpl.insertPop2", param);
			...
			super.commonDao.queryForObject("pmp280ukrvServiceImpl.spCallPop2_1", spParam);
...
//		 for(Map param :paramList ) {
//			 super.commonDao.delete("pmp280ukrvServiceImpl.deleteDetail", param);
//		 }
//		 return;
//	}
