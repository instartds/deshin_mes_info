...
@Service("pmp180ukrvService")
public class Pmp180ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("pmp180ukrvServiceImpl.selectDetailList", param);
	}
		...
		List<Map> chkList = (List<Map>) super.commonDao.list("pmp250ukrvServiceImpl.checkCompCode", compCodeMap);
		 for(Map param :paramList )	{	
			 for(Map checkCompCode : chkList) {
				 ...
				 super.commonDao.update("pmp180ukrvServiceImpl.updateDetail", param);
			 }
		 }
		 return 0;
	} 
	...
	public List<Map<String, Object>> fnWorkShopCode(Map param) throws Exception {
		return super.commonDao.list("pmp180ukrvServiceImpl.fnWorkShopCode", param);
	}
}
