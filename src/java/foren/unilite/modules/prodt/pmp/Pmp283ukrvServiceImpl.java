...
@Service("pmp283ukrvService")
@SuppressWarnings({ "unchecked", "rawtypes" })
public class Pmp283ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object getJanOutstockReqQ(Map param) throws Exception{
		return super.commonDao.select("pmp283ukrvServiceImpl.getJanOutstockReqQ", param);
	}
	/**
	 * 라벨출력
	 * @param param
	...
	public List<Map<String, Object>> printList(Map param) throws Exception{
		return super.commonDao.list("pmp283ukrvServiceImpl.printList", param);
	}
	/**
	 * 라벨출력 노비스용
	 * @param param
	...
	public List<Map<String, Object>> printList_novis(Map param) throws Exception{
		return super.commonDao.list("pmp283ukrvServiceImpl.printList_novis", param);
	}
	/**
	 * 메인그리드
	 * @param param
	...
	public List<Map> selectList(Map param) throws Exception{
		return super.commonDao.list("pmp283ukrvServiceImpl.selectList", param);
	}
	...
	public List<Map> pop1SelectList(Map param) throws Exception{
		return super.commonDao.list("pmp283ukrvServiceImpl.pop1SelectList", param);
	}
	/**
	 * 팝업그리드1_2
	 * @param param
	...
	public List<Map> pop1_2SelectList(Map param) throws Exception{
		return super.commonDao.list("pmp283ukrvServiceImpl.pop1_2SelectList", param);
	}
	/**
	 * 팝업그리드2
	 * @param param
	 ...
	 */
	@ExtDirectMethod(value = ExtDirectMethodType.STORE_READ, group = "prodt")
	public List<Map> pop2SelectList(Map param) throws Exception{
		return super.commonDao.list("pmp283ukrvServiceImpl.pop2SelectList", param);
	}
	...
	public void deletePop1_2(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList )  {
			...
			super.commonDao.insert("pmp283ukrvServiceImpl.insertPop1_2", param);
			...
			super.commonDao.queryForObject("pmp283ukrvServiceImpl.spCallPop2_2", spParam2);
...
//			if(deleteList != null) this.deleteDetail(deleteList, user);
	...
	public void insertPop2(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param : paramList ) {
            ...
            Map checkLotNo = (Map) super.commonDao.select("pmp283ukrvServiceImpl.checkLotNo", param);
            if(ObjUtils.isEmpty(checkLotNo)){
			    throw new  UniDirectValidateException("해당 LOT번호에 따른 입고 데이터가 없습니다.");
            }else{
            	Map checkIn = (Map) super.commonDao.select("pmp283ukrvServiceImpl.checkIn", param);
			...
			param.put("CREATE_LOC", "2");			//'2' 자재  (입고,출고)          '3'생산            /* 생성경로 : (B031) */
...
/*			//입고		(20190408 업무로직 변경으로 인해 입고 로직 제거 함)
			...
			super.commonDao.insert("pmp283ukrvServiceImpl.insertPop2", param);
			...
			super.commonDao.queryForObject("pmp283ukrvServiceImpl.spCallPop2_1", spParam);
...
//		 for(Map param :paramList ) {
//			 super.commonDao.delete("pmp283ukrvServiceImpl.deleteDetail", param);
//		 }
//		 return;
//	}
