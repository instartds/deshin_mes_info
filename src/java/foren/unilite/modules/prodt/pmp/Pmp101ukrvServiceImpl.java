...
@Service("pmp101ukrvService")
public class Pmp101ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object selectMaster(Map param) throws Exception {
		return super.commonDao.select("pmp101ukrvServiceImpl.selectMaster", param);
	}
	...
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("pmp101ukrvServiceImpl.selectDetailList", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetailList1(Map param) throws Exception {
		return super.commonDao.list("pmp101ukrvServiceImpl.selectDetailList1", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetailList2(Map param) throws Exception {
		return super.commonDao.list("pmp101ukrvServiceImpl.selectDetailList2", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("pmp101ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumDetailList(Map param) throws Exception {
		return super.commonDao.list("pmp101ukrvServiceImpl.selectOrderNumDetail", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("pmp101ukrvServiceImpl.selectEstiList", param);
	}
	...
	public List<Map<String, Object>> selectRefList(Map param) throws Exception {
		return super.commonDao.list("pmp101ukrvServiceImpl.selectRefList", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList, Map paramMaster, LoginVO user) throws Exception {
		...
		Map<String, Object> mapKey = (Map<String, Object>)super.commonDao.select("pmp101ukrvServiceImpl.getKeyValue");
		...
		super.commonDao.insert("pmp101ukrvServiceImpl.insertLogMaster", dataMaster);
	...
	public List<Map> insertLogDetails(List<Map> params, String keyValue, String oprFlag) throws Exception {
		for(Map param: params)		{
			...
			super.commonDao.insert("pmp101ukrvServiceImpl.insertLogDetail", param);
		}		
