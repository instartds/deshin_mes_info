...
@Service("pmp295ukrvService")
public class Pmp295ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public List<Map<String, Object>> selectAgreePrsn(Map param) throws Exception {
		return super.commonDao.list("pmp295ukrvServiceImpl.selectAgreePrsn", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("pmp295ukrvServiceImpl.selectMaster", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("pmp295ukrvServiceImpl.selectOrderNumMaster", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("pmp295ukrvServiceImpl.selectEstiList", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> printList(Map param) throws Exception {
		return super.commonDao.list("pmp295ukrvServiceImpl.printList", param);
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> orderApply(Map param) throws Exception {
		return super.commonDao.list("pmp295ukrvServiceImpl.orderApply", param);		// 참조 팝업 적용버튼 클릭시
	}

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> orderApply2(Map param) throws Exception {
		return super.commonDao.list("pmp295ukrvServiceImpl.orderApply2", param);		// 참조 팝업 적용버튼 클릭시2
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				param.put("data", super.commonDao.insert("pmp295ukrvServiceImpl.insertLogMaster", param));
			}
		}
...
//송윤선
	  //  super.commonDao.queryForObject("pmp295ukrvServiceImpl.spPmp200ukr", spParam);
