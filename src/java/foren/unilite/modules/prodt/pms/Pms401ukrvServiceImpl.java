...
@Service("pms401ukrvService")
public class Pms401ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public String sendMsg(Map param, LoginVO user) throws Exception {
		...
		param.put("S_PGM_ID", "pms401ukrv");
		
		Map<String, Object> badDataParam = (Map<String, Object>) super.commonDao.select("pms401ukrvServiceImpl.selectBadData", param);
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("pms401ukrvServiceImpl.selectMaster", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("pms401ukrvServiceImpl.selectDetail", param);
	}
	
	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectCheckItem(Map param) throws Exception {
		return super.commonDao.list("pms401ukrvServiceImpl.selectCheckItem", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("pms401ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("pms401ukrvServiceImpl.selectEstiList", param);
	}
    ...
    public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
        ...
        for(Map paramData: paramList) {         
            ...
            for(Map param:  dataList) {
                ...
                param.put("data", super.commonDao.insert("pms401ukrvServiceImpl.insertLogMaster", param));
            }
        }
        ...
        super.commonDao.queryForObject("pms401ukrvServiceImpl.spReceiving", spParam);
    ...
    public List<Map> saveAll2(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
        ...
        for(Map paramData: paramList) {         
            ...
            for(Map param:  dataList) {
                param.put("KEY_VALUE", keyValue);
                param.put("OPR_FLAG", oprFlag);
                param.put("data", super.commonDao.insert("pms401ukrvServiceImpl.insertLogMaster2", param));
            }
        }
