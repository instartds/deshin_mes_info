...
@Service("pms440ukrvService")
@SuppressWarnings({ "rawtypes", "unchecked" })
public class Pms440ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public String sendMsg(Map param, LoginVO user) throws Exception {
		...
		param.put("S_PGM_ID", "pms440ukrv");

		Map<String, Object> badDataParam = (Map<String, Object>) super.commonDao.select("pms440ukrvServiceImpl.selectBadData", param);
	...
	public List<Map<String, Object>> selectMaster(Map param) throws Exception {
		return super.commonDao.list("pms440ukrvServiceImpl.selectMaster", param);
	}

	@ExtDirectMethod(group = "sales", value = ExtDirectMethodType.STORE_READ)
	public List<Map<String, Object>> selectDetail(Map param) throws Exception {
		return super.commonDao.list("pms440ukrvServiceImpl.selectDetail", param);
	}
	...
	public List<Map<String, Object>> selectOrderNumMasterList(Map param) throws Exception {
		return super.commonDao.list("pms440ukrvServiceImpl.selectOrderNumMaster", param);
	}
	...
	public List<Map<String, Object>> selectEstiList(Map param) throws Exception {
		return super.commonDao.list("pms440ukrvServiceImpl.selectEstiList", param);
	}
	...
	public String getTestResult(Map param) throws Exception {
		return (String) super.commonDao.select("pms440ukrvServiceImpl.getTestResult", param);
	}
	...
	public List<Map> saveAll(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map paramData: paramList) {
			...
			for(Map param:  dataList) {
				...
				param.put("data", super.commonDao.insert("pms440ukrvServiceImpl.insertLogMaster", param));
			}
		}
...
//			if(paramData.get("method").equals("updateDetail2"))  oprFlag="U";
			...
			for(Map param:  dataList) {
				...
				param.put("KEY_VALUE", keyValue);
				param.put("OPR_FLAG", oprFlag);
				param.put("data", super.commonDao.insert("pms440ukrvServiceImpl.insertLogMaster2", param));
			}
		}
		...
		super.commonDao.queryForObject("pms440ukrvServiceImpl.spReceiving", spParam);
	...
	public List<Map<String, Object>>  inspecQtyCheck(Map param) throws Exception {
		return  super.commonDao.list("pms440ukrvServiceImpl.inspecQtyCheck", param);
	}
}
