...
@Service("pmr101ukrvService")
@SuppressWarnings({"rawtypes", "unchecked"})

public class Pmr101ukrvServiceImpl extends TlabAbstractServiceImpl {
	...
	public Object checkWorkEnd(Map param) throws Exception {
		return super.commonDao.select("pmr101ukrvServiceImpl.checkWorkEnd", param);
	}
	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)		// 작업지시조회
	public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList", param);
	}
	// END OF 작업실적등록
	...
	public List<Map<String, Object>> selectDetailList2(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList2", param);
	}
	// END OF 작업지시번호별등록 조회
	...
	public List<Map<String, Object>> selectDetailList3(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList3", param);
	}
	// END OF 공정별등록 조회1
	...
	public List<Map<String, Object>> selectDetailList4(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList4", param);
	}
	// END OF 공정별등록2
	...
	public List<Map<String, Object>> selectDetailList5(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList5", param);
	}
	// END OF 불량내역등록
	...
	public List<Map<String, Object>> selectDetailList6(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList6", param);
	}
	// END OF 특이사항등록
	...
	public List<Map<String, Object>> selectDetailList7(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList7", param);
	}
	// END OF 제조이력등록(제조이력등록)

	@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)		// 제조이력등록 조회
	public List<Map<String, Object>> selectDetailList8(Map param) throws Exception {
		return super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList8", param);
	}
	// END OF 제조이력등록(실적현황)
	...
	public List<Map<String, Object>> selectDetailList10(Map param) throws Exception {
		...
		if(param.get("POPUP_CHK").equals("WKORD")){
			selectDetail10 = super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList10", param);//작업실적 등록 팝업에서 조회했을 경우
		}else{
			selectDetail10 = super.commonDao.list("pmr101ukrvServiceImpl.selectDetailList10_2", param);//작업실적 수정 팝업에서 조회했을 경우
		}
		...
		for(Map paramData: paramList) {
			...
			for(Map param:	dataList) {
				...
				if(param.get("STATUS").equals("N")) {
					//자동채번
					super.commonDao.queryForObject("pmr101ukrvServiceImpl.spAutoNum", spParam);
					prodtNum = ObjUtils.getSafeString(spParam.get("KEY_NUMBER"));
					param.put("PRODT_NUM",	prodtNum);
					super.commonDao.update("pmr101ukrvServiceImpl.insertDetail2", param);

					super.commonDao.update("pmr101ukrvServiceImpl.updateMoldShot", param);
				} else if(param.get("STATUS").equals("U")) {
					super.commonDao.update("pmr101ukrvServiceImpl.updateDetail2", param);
				}else if(param.get("STATUS").equals("D")) {
					super.commonDao.update("pmr101ukrvServiceImpl.deleteDetail2", param);
				...
				super.commonDao.update("pmr101ukrvServiceImpl.spReceiving", param);
			...
			for(Map paramData: paramList) {
				...
				for(Map param:	dataList) {
					...
					if(param.get("STATUS").equals("N")) {
						...
						prodtNum = ObjUtils.getSafeString(spParam.get("KEY_NUMBER"));
						param.put("PRODT_NUM",	prodtNum);
						super.commonDao.update("pmr101ukrvServiceImpl.insertDetail3", param);
						...
						if(ObjUtils.isNotEmpty(param.get("MOLD_CODE")) && ObjUtils.parseInt(param.get("CAVIT_BASE_Q")) > 0 ){
							...
							super.commonDao.update("pmr101ukrvServiceImpl.updateMoldPlus", param);

						}


					} else if(param.get("STATUS").equals("U")) {
						super.commonDao.update("pmr101ukrvServiceImpl.updateDetail3", param);
					}
...
//							String[] messsage = errorDesc.split(";");
	...
	/*					//공정별 등록 그리드는 삭제로직 없음
						if(param.get("STATUS").equals("D")) {
							super.commonDao.update("pmr101ukrvServiceImpl.deleteDetail3", param);
						}*/
					dataMaster.put("CONTROL_STATUS", param.get("CONTROL_STATUS"));
		...
		for(Map paramData: paramList) {
			...
			//금형테이블에 사용SHOT update관련
				if(ObjUtils.isNotEmpty(dataMaster.get("MOLD_CODE")) && ObjUtils.parseInt(dataMaster.get("CAVIT_BASE_Q")) > 0 ){
					...
					super.commonDao.update("pmr101ukrvServiceImpl.updateMoldMinus", param);
	...
	*/
	...
	public Integer	insertDetail5(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param : paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.insertDetail5", param);
		}
		return 0;
	}
	...
	public Integer updateDetail5(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.updateDetail5", param);
		}
		return 0;
	}
	...
	public Integer deleteDetail5(List<Map> paramList,	LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.deleteDetail5", param);
		}
		return 0;
	}
	...
	*/
	...
	public Integer	insertDetail6(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param : paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.insertDetail6", param);
		}
		return 0;
	}
	...
	public Integer updateDetail6(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.updateDetail6", param);
		}
		return 0;
	}
	...
	public Integer deleteDetail6(List<Map> paramList,	LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.deleteDetail6", param);
		}
		return 0;
	}
	...
	*/
	...
	public Integer	insertDetail7(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param : paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.insertDetail7", param);
		}
		return 0;
	}
	...
	public Integer updateDetail7(List<Map> paramList, LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.updateDetail7", param);
		}
		return 0;
	}
	...
	public Integer deleteDetail7(List<Map> paramList,	LoginVO user) throws Exception {
		for(Map param :paramList ) {
			super.commonDao.update("pmr101ukrvServiceImpl.deleteDetail7", param);
		}
		return 0;
	}
	...
	public List<Map<String, Object>>  mainReport(Map param) throws Exception {
		return  super.commonDao.list("pmr101ukrvServiceImpl.mainReport", param);
	}
	...
	public List<Map<String, Object>>  subReport(Map param) throws Exception {
		return  super.commonDao.list("pmr101ukrvServiceImpl.subReport", param);
	}
	...
	public List<Map<String, Object>>  subReport2(Map param) throws Exception {
		return  super.commonDao.list("pmr101ukrvServiceImpl.subReport2", param);
	}
	...
	public List<Map<String, Object>>  selectRefItem(Map param) throws Exception {
		return  super.commonDao.list("pmr101ukrvServiceImpl.selectRefItem", param);
	}
	...
	public List<Map<String, Object>>  mainReport_label(Map param) throws Exception {
		return  super.commonDao.list("pmr101ukrvServiceImpl.mainReport_label", param);
	}
	...
	public List selectBadcodes(String comp_code) throws Exception {
		return (List)super.commonDao.list("pmr101ukrvServiceImpl.selectBadcodes" ,comp_code);
	}
		...
		for(Map paramData: paramList) {
			...
			if(oprFlag.equals("U") || oprFlag.equals("N")){
				for(Map param:	dataList) {
					...
					super.commonDao.update("pmr101ukrvServiceImpl.deleteDetail10", param);
					for (int i=0; i<badList.size(); i++) {
						...
						if( badQ > 0){
					    	super.commonDao.update("pmr101ukrvServiceImpl.updateDetail10", param);
					    }
					}
				}
			}/*else{
	...
	public void updateProductionResultRemark(Map param, LoginVO login) throws Exception {
			logger.debug("param:::"+param);
				 super.commonDao.update("pmr101ukrvServiceImpl.updateProductionResultRemark", param);
	}
	...
	public List<Map<String, Object>>  mainReport_label_afterProg(Map param) throws Exception {
		return  super.commonDao.list("pmr101ukrvServiceImpl.mainReport_label_afterProg", param);
	}
	...
	public List<Map<String, Object>>  mainReport_Pmplabel(Map param) throws Exception {
		return  super.commonDao.list("pmr101ukrvServiceImpl.mainReport_Pmplabel", param);
	}
}
