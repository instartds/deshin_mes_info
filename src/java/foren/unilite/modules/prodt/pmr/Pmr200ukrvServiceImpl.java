...
@Service("pmr200ukrvService")
@SuppressWarnings({"rawtypes", "unchecked"})

public class Pmr200ukrvServiceImpl extends TlabAbstractServiceImpl {
		private final Logger logger = LoggerFactory.getLogger(this.getClass());

		@ExtDirectMethod(group = "prodt", value = ExtDirectMethodType.STORE_READ)		//조회
		public List<Map<String, Object>> selectDetailList(Map param) throws Exception {
			return super.commonDao.list("pmr200ukrvServiceImpl.selectDetailList", param);
		}
...
//				param.put("WH_CODE"			, paramMaster.get("WH_CODE"));
				super.commonDao.insert("pmr200ukrvServiceImpl.insertDetail", param);
			} catch(Exception e){
				throw new  UniDirectValidateException(this.getMessage("8114", user));
			}
			Map b049 = (Map) super.commonDao.select("pmr200ukrvServiceImpl.selectB049", param);

			if("1".equals(b049.get("ESTIMATEM_METHOD"))) {
				if("1".equals(b049.get("AVERAGECALC_PERIOD"))) {

					Map selInoutDate = (Map) super.commonDao.select("pmr200ukrvServiceImpl.selectInoutDate", param);
					param.put("INOUT_DATE", selInoutDate.get("INOUT_DATE"));

					super.commonDao.update("pmr200ukrvServiceImpl.SP_STOCK_PeriodicAverage", param);

				} else {
					super.commonDao.update("pmr200ukrvServiceImpl.SP_STOCK_PeriodicAverageMonthly", param);
				}
			}
...
//				}
			try {
				if(param.get("QUERY_FLAG").equals("1")) {
					...
					super.commonDao.update("pmr200ukrvServiceImpl.updatePMP", param);
				}
			} catch(Exception e){
				throw new  UniDirectValidateException(this.getMessage("8114", user));
			}
...
//			param.put("WH_CODE"			, paramMaster.get("WH_CODE"));
			...
			super.commonDao.update("pmr200ukrvServiceImpl.updateDetail", param);
...
//					param.put("WH_CODE"			, paramMaster.get("WH_CODE"));
					...
					super.commonDao.delete("pmr200ukrvServiceImpl.deleteDetail", param);
				} catch(Exception e) {
...
//					throw new UniDirectValidateException(this.getMessage(errorDesc, user));
				...
				try {
					if(param.get("QUERY_FLAG").equals("1")) {
						...
						super.commonDao.update("pmr200ukrvServiceImpl.deletePMP", param);
					}
		...
		public List<Map<String, Object>> getWhCode(Map param) throws Exception {
			return super.commonDao.list("pmr200ukrvServiceImpl.getWhCode", param);
		}
		...
		public List<Map<String, Object>> selectClipPrintList(Map param) throws Exception {
			...
			return super.commonDao.list("pmr200ukrvServiceImpl.selectClipPrintList", param);
		}
}
