...
@Service("bsa010ukrvService")
public class Bsa010ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		...
		List<Map<String, Object>> rv =   super.commonDao.list("bsa010ukrvServiceImpl.selectList", param);
		return rv;
	}
	...
	public List<Map>  insert(List<Map> paramList, LoginVO user) throws Exception {
		...
		for(Map param :paramList )	{
				super.commonDao.insert("bsa010ukrvServiceImpl.insert", param);
		}
		return  paramList;
	}
	...
	public List<Map>  update(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList )	{
			super.commonDao.update("bsa010ukrvServiceImpl.update", param);
		}
		return  paramList;
	}
	...
	public List<Map>  delete(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList )	{				
				super.commonDao.update("bsa010ukrvServiceImpl.delete", param);
		}
		return  paramList;	
	}
