...
@Service("bsa105ukrvService")
public class Bsa105ukrvServiceImpl extends TlabAbstractServiceImpl  {
	...
	public List<Map<String, Object>>  selectList(Map param) throws Exception {
		...
		List<Map<String, Object>> rv =   super.commonDao.list("bsa105ukrvServiceImpl.selectList", param);
		return rv;
	}
	...
	public List<Map>  update(List<Map> paramList,  LoginVO user) throws Exception {
		for(Map param :paramList )	{
			super.commonDao.update("bsa105ukrvServiceImpl.update", param);
		}
		return  paramList;
	}
