 ...
 *
 */
@Service("pdi200ukrvService")
public class Pdi200ukrvServiceImpl extends TlabAbstractServiceImpl {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());	


	@Transactional(propagation = Propagation.REQUIRED, rollbackFor={Exception.class})	
	public List<Map> saveOutStockMove(List<Map> paramList,  Map paramMaster, LoginVO user) throws Exception {
		...
		for(Map param: paramList) {			
			...
			String oprFlag =  param.get("CRUD").toString();
				...
				param.put("data", super.commonDao.insert("pdi200ukrvServiceImpl.insertLogMaster", param));
	    ...
	    super.commonDao.queryForObject("pdi200ukrvServiceImpl.spReceiving", spParam);
