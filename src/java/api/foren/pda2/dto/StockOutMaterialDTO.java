...
public class StockOutMaterialDTO implements Serializable {
	...
	public String toString() {
		return "StockOutMaterialDTO [compCode=" + compCode + ", divCode=" + divCode + ", customCode=" + customCode
				+ ", toWhCode=" + toWhCode + ", toCellCode=" + toCellCode + ", inoutCode=" + inoutCode + ", inoutDate="
				+ inoutDate + ", inoutPrsn=" + inoutPrsn + ", moneyUnit=" + moneyUnit + ", exchgRateO=" + exchgRateO
				+ ", itemCode=" + itemCode + ", lotNo=" + lotNo + ", orderNum=" + orderNum + ", orderSeq=" + orderSeq
				+ ", orderUnit=" + orderUnit + ", trnsRate=" + trnsRate + ", orderUnitP=" + orderUnitP + ", basisNum="
				+ basisNum + ", basisSeq=" + basisSeq + ", pathCode=" + pathCode + ", outStockNum=" + outStockNum
				+ ", refWkordNum=" + refWkordNum + ", remark=" + remark + ", projectNo=" + projectNo + ", sGubunKd="
