...
public class Pdp300ukrvDTO implements Serializable {
	...
	public String toString() {
		return "Pdp300ukrvDTO [compCode=" + compCode + ", divCode=" + divCode
				+ ", customCode=" + customCode + ", workShopCode="
				+ workShopCode + ", toWhCode=" + toWhCode + ", toCellCode="
				+ toCellCode + ", inoutCode=" + inoutCode + ", inoutDate="
				+ inoutDate + ", inoutPrsn=" + inoutPrsn + ", moneyUnit="
				+ moneyUnit + ", exchgRateO=" + exchgRateO + ", itemCode="
				+ itemCode + ", lotNo=" + lotNo + ", orderNum=" + orderNum
				+ ", orderSeq=" + orderSeq + ", orderUnit=" + orderUnit
				+ ", trnsRate=" + trnsRate + ", orderUnitP=" + orderUnitP
				+ ", basisNum=" + basisNum + ", basisSeq=" + basisSeq
				+ ", pathCode=" + pathCode + ", outStockNum=" + outStockNum
				+ ", refWkordNum=" + refWkordNum + ", remark=" + remark
				+ ", projectNo=" + projectNo + ", sGubunKd=" + sGubunKd
				+ ", lotList=" + lotList + "]";
	}
