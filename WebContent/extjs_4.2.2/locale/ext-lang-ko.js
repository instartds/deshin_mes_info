...
Ext.define("Ext.locale.ko.Ext.ux.grid.FiltersFeature", {
    override: "Ext.ux.grid.FiltersFeature",
    menuFilterText: "필터"
});

Ext.define("Ext.locale.ko.Ext.grid.feature.Grouping", {
    override: "Ext.grid.feature.Grouping",
    groupByText : '이 항목으로 그룹핑',			// "Group by this field"
    showGroupsText : '그룹핑하여 보여주기'		// 'Show in groups'
});
Ext.define("Ext.locale.ko.Ext.grid.locking.Lockable", {
    override: "Ext.grid.locking.Lockable",
    lockText: "칼럼 잠금",					// Unlock
    unlockText: "칼럼 잠금해제"				//  'Lock'
});
 
Ext.define("Ext.locale.ko.Ext.ux.grid.filter.DateFilter", {
    override: "Ext.ux.grid.filter.DateFilter",
    afterText : '이후',					// 'After'
    beforeText : '이전',				// 'Before'
    onText : '날자에'					// 'On'
});


Ext.define("Ext.locale.ko.data.validations", {
    override: "Ext.data.validations",
    presenceMessage : '필수 입력 값입니다.'					// 'must be present'
});