 ...
 **************************************************/	
function openWorkDetailWin(parentContainer, actionType, workStatusId, selectedDate) {
	...
	workDetailWin.getRegItems()['WorkStatusID'] = workStatusId;
	workDetailWin.getRegItems()['SelectedDate'] = selectedDate;
