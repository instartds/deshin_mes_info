...
Ext.define('nbox.previewDetailWindow',{
    ...
    initComponent: function () {
    	...
    	var detailToolbar = Ext.create('nbox.previewDetailToolbar', {});
    	var popDetailView = Ext.create('nbox.previewDetailView', {});
		
		detailToolbar.getRegItems()['ParentContainer'] = me;
		me.getRegItems()['DetailToolbar'] = detailToolbar;
		
		popDetailView.getRegItems()['ParentContainer'] = me;
		popDetailView.getRegItems()['StoreData'] = approvalDetailStore;
		me.getRegItems()['ViewForm'] = popDetailView;
		
		me.dockedItems = [detailToolbar];
		me.items = [popDetailView];
 ...
 **************************************************/
//Preview Window Open
function openPreviewWin(documentID){
