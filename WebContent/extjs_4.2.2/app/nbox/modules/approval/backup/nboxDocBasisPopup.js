	 ...
	 **************************************************/
	//docBasis List
	var popupDocBasisStore = Ext.create('Ext.data.Store', {
	...
	//MyDocBasis List
	var tempDocBasisStore = Ext.create('Ext.data.Store', {
	...
	function openDocBasisPopupWin(editDocBasisView) {
		// detailWin
		if(!docBasisPopupWin){
		...
		docBasisPopupWin.getRegItems()['DocBasisView'] = editDocBasisView;
