 ...
 */
/**
 * @class nbox.calendar.template.DayBody
 * @extends Ext.XTemplate
 * <p>This is the template used to render the scrolling body container used in {@link nbox.calendar.view.Day DayView} and 
 * {@link nbox.calendar.view.Week WeekView}. This template is automatically bound to the underlying event store by the 
 ...
 * that internally creates an instance of this template along with a {@link nbox.calendar.DayHeaderTemplate}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('nbox.calendar.template.DayBody', {
    ...
    constructor: function(config){
        ...
        nbox.calendar.template.DayBody.superclass.constructor.call(this,
    ...
    applyTemplate : function(o){
        ...
        if (Ext.getVersion().isLessThan('4.1')) {
            return nbox.calendar.template.DayBody.superclass.applyTemplate.call(this, templateConfig);
        }
        else {
