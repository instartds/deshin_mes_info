...
<link rel="stylesheet" type="text/css" href='<c:url value="/app/Ext/ux/grid/feature/resources/MultiGroupingSummary.css" />' /> 
<link rel="stylesheet" type="text/css" href='<c:url value="/app/Ext/ux/grid/plugin/resources/GroupingPanel.css" />' /> 
