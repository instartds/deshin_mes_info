...
<title>Unilite(ExtJS 4.2.2)</title>

<script type="text/javascript">
	var CPATH = '/g3erp';
</script>
<link rel="stylesheet" type="text/css" href='/g3erp/extjs/resources/Z_temp4.22/index.css' />
<script type="text/javascript" charset="UTF-8" src='/g3erp/extjs/ext-all-dev.js'></script>
...
var Unilite = {
	...
	Ext.Loader.setConfig({
		enabled: true, scriptCharset: 'UTF-8', paths: {
			"Ext.ux": '${CPATH }/app/Ext/ux', "Unilite": '${CPATH }/app/Unilite', "Extensible": '${CPATH }/app/Extensible'
		}
	});
		...
		Ext.define('Benchmark.grid', {
			...
			constructor: function(config){    
		        ...
		        if( BENCHMARK.USE_GROUP ) {
		        	config.features.push( {id: 'masterGridSubTotal', ftype: 'uniGroupingsummary', showSummaryRow: false 	} );
