...
Ext.onReady(function() {
	    ...
	    fields: [ 	 {name :'COMP_CODE'  		,text : '법인코드'  ,type : 'string', allowBlank:false}
					...
					,{
						...
						convert : function(value, record) {
							return value; //record.get('S_COMP_CODE') + '|' + record.get('PROJECT_NO');
						}
					}					
			],
			idProperty : 'PKS'
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
					...
					syncAll: 'cmb200ukrvService.saveAll'
               }
	});
	
	var directMasterStore =  Unilite.createStore('Cmb200ukrvStore', {
    ...
    var app =  Ext.create('Unilite.com.BaseApp', {
		prgId : 'test.grid01',
		items : [panelSearch, 	cmb200ukrvGrid],
		...
		onResetButtonDown:function() {
				Ext.getCmp('searchForm').reset();
				 Ext.getCmp('cmb200ukrvGrid').reset();
				UniAppManager.setToolbarButtons( 'newData', true);
		},
		...
		onSaveDataButtonDown: function (config) {
			...
			//1.마스터정보 파라미터 구성 
			var paramMaster = {masterFd1: 'abcd', masterFd2: '1111'} 
			...
			masterGrid.getStore().syncAllDirect(config);
