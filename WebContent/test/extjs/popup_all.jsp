...
function appMain() {
	...
	var panelResult = Unilite.createForm('actionForm',{
		...
		items : [ 
			...
			, Unilite.popup('BU_CODE_POPUP' , {})
			, Unilite.popup('BUSS_OFFICE_CODE' , {}) 
			, Unilite.popup('SAUP_POPUP' , {}) 
			, Unilite.popup('SAUP_POPUP_SINGLE' , {}) 
			, Unilite.popup('PRIZE_POPUP' , {}) 
			...
			, Unilite.popup('INCOM_OFFER' , {})
			, Unilite.popup('INCOM_BL' , {})
			, Unilite.popup('DELIVERY' , {})
			, Unilite.popup('ACCNT_DIV_CODE' , {})
			, Unilite.popup('ACCNT' , {})
			, Unilite.popup('FOREIGN_ACCNT' , {})
			, Unilite.popup('EXCHANGE_ACCNT' , {})
			, Unilite.popup('ACCNT_AC' , {})
			, Unilite.popup('ACCNT_PAY' , {fieldLabel : 'pivot_계정과목'})
			...
			, Unilite.popup('ASSET' , {})
			, Unilite.popup('COST_POOL' , {})
			, Unilite.popup('UNIT' , {})
			, Unilite.popup('NOTE_TYPE' , {})
			, Unilite.popup('NOTE_NUM' , {})
			, Unilite.popup('CHECK_NUM' , {})
			, Unilite.popup('MONEY' , {})
			, Unilite.popup('EX_LCNO' , {})
			, Unilite.popup('IN_LCNO' , {})
			, Unilite.popup('EX_BLNO' , {})
			, Unilite.popup('IN_BLNO' , {})
			, Unilite.popup('PASS_SER_NO' , {})
			, Unilite.popup('AC_PROJECT' , {})
			, Unilite.popup('FUND' , {})
			, Unilite.popup('CREDIT_NO' , {})
			, Unilite.popup('PUR_SALE_TYPE' , {})
			, Unilite.popup('PROOF' , {})
			, Unilite.popup('EMISSION' , {})
			, Unilite.popup('BANK_BOOK' , {})
			, Unilite.popup('BOOK_CODE' , {})
			, Unilite.popup('DEBT_NO' , {})
			, Unilite.popup('BANK_ACCNT' , {})
			, Unilite.popup('BUSINESS_BANK' , {})
			, Unilite.popup('MONEY_UNIT' , {})
			, Unilite.popup('BUDG' , {})
			...
			, Unilite.popup('DEPTTREE' , {})
			, Unilite.popup('PJT_TREE' , {})
			, Unilite.popup('PJT_NONTREE' , {})
			, Unilite.popup( 'NONTAX_CODE' , {})
			, Unilite.popup('PAY_GRADE' , {})
			, Unilite.popup( 'IFRS_ASSET' , {})
			, Unilite.popup('PURCHASE_CARD' , {})
			, Unilite.popup('COM_ABA210' , {})
			, Unilite.popup('CIPHER_CARDNO' , {})
			, Unilite.popup('CIPHER_REPRENO' , {})
			, Unilite.popup('CIPHER_BANKACCNT' , {})
			, Unilite.popup('CIPHER_FOREIGNNO' , {})
			, Unilite.popup('BUDG_KOCIS' , {})  //KOCIS(해외문화홍보원) -  예산과목
			, Unilite.popup('BUDG_KOCIS_NORMAL' , {})  //KOCIS(해외문화홍보원) -  예산과목-normal
			, Unilite.popup('CUST_KOCIS' , {})  //KOCIS(해외문화홍보원) -  거래처
			, Unilite.popup('ART_KOCIS' , {})  //KOCIS(해외문화홍보원) -  미술품
			, Unilite.popup('EQU_CODE' , {})
			, Unilite.popup('EQU_MACH_CODE' , {})
			, Unilite.popup('EQU_MOLD_CODE' , {})
			, Unilite.popup('CORE_CODE' , {})
			, Unilite.popup('TREE_CODE' , {})
			, Unilite.popup('AS_NUM' , {})
			, Unilite.popup('SEND_SMS' , {})
			, Unilite.popup( 'SW_CODE' , {}) // SW코드 극동가스케트공업
			, Unilite.popup( 'REQ_NUM2' , {}) // 의뢰서번호 극동가스케트공업
			, Unilite.popup('COST_POOL_CBM600T' , {})
			, Unilite.popup('WKORD_NUM_KDG' , {}) 
			, Unilite.popup('WOODEN_CODE' , {})
