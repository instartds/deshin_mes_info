...
!function ($) {
    ...
    LeftSidebar.prototype._reset = function() {
    	var logoUri = './resources/images/cms/SF_logo_w.png';
    	var logoSmUri = './resources/images/cms/SF_symbol.png';
        this.body.removeAttr('data-leftbar-theme');
        $('#side-main-logo').attr('src', logoUri);
        $('#side-sm-main-logo').attr('src', logoSmUri);
    },
    ...
    LeftSidebar.prototype.activateLightTheme = function() {
        this._reset();
        var logoUri = './resources/images/cms/SF_logo_w.png';
        var logoSmUri = './resources/images/cms/SF_symbol_w.png';
        $('#side-main-logo').attr('src', logoUri);
        $('#side-sm-main-logo').attr('src', logoSmUri);
...
function ($) {
    ...
    */
    ...
    LayoutThemeApp.prototype.activateDarkMode = function() {
        ...
        $("#ifr-main-content").contents().find('#light-style').attr('disabled', true);
        $("#dark-style").attr("disabled", false);
        $("#ifr-main-content").contents().find('#dark-style').attr('disabled', false);
        /*추가 iframe에 동일하게 적용*/
        $.LeftSidebar.activateDarkTheme();
    ...
    LayoutThemeApp.prototype.deactivateDarkMode = function() {
        ...
        $("#ifr-main-content").contents().find('#light-style').attr('disabled', false);
        $("#dark-style").attr("disabled", true);
        $("#ifr-main-content").contents().find('#dark-style').attr('disabled', true);
