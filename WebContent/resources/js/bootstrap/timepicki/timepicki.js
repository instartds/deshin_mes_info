	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prev-time action-prev'></div>" :
				"<div class='prev-time action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='next-time action-next'></div>" :
				"<div class='next-time action-prev'></div>";
			...
			function set_value(event, close) {
				...
				if (tim.length !== 0 && mini.length !== 0 && (!settings.show_meridian || meri.length !== 0)) {
					...
					if(ele.attr('data-timepicki-meri') == "PM"){
						var hour = tim*1 + 12;
						if(hour > 23) hour = 12;
						ele.attr('data-timepicki-total', hour + ":" + mini + ":00");
					}else{
						var hour = tim;
						if(hour > 11) hour = "00";
						ele.attr('data-timepicki-total', hour + ":" + mini + ":00");
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'next-time') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prev')) || direction === 'prev-time') {
