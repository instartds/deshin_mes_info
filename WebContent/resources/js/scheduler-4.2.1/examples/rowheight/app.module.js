import { StringHelper, Toast, Scheduler } from '../../build/scheduler.module.js';
...
const
    resources = [
        ...
        { id : 'r5', name : 'Malik', eventColor : 'purple', rowHeight : 90, resourceMargin : 10 },
...
const { rowHeight, barMargin, resourceMargin } = scheduler.widgetMap;
...
function changeAdjustTarget(target) {
    ...
    resourceMargin.value = target.resourceMargin ?? scheduler.resourceMargin;
}
