var Scheduler = bryntum.scheduler.Scheduler; //region Data
...
var scheduler = new Scheduler({
  ...
  listeners: {
    eventSelectionChange: function eventSelectionChange() {
      var count = scheduler.selectedEvents.length;
      scheduler.widgetMap.countLabel.html = "".concat(count, " event").concat(count === 1 ? '' : 's', " selected");
    }
  },
  tbar: [{
    type: 'checkbox',
