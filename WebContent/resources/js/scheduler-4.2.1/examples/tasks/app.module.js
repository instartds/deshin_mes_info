import { Tooltip, Popup, Scheduler, ResourceModel, StringHelper } from '../../build/scheduler.module.js';
    ...
    columns : [
        {
            ...
            renderer({ record, value, size }) {
                ...
                if (record.isParent) {
                    const image = record.image !== false ? StringHelper.xss`<img class="profile-img" src="resources/images/${record.name.toLowerCase()}.jpg" />` : '';
