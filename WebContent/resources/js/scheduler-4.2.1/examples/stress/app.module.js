import { StringHelper, DateHelper, Toast, DataGenerator, Scheduler } from '../../build/scheduler.module.js';
...
class ColleagueSimulator {
    ...
    getRandomResourceName() {
        return this.resourceStore.getAt(Math.round(Math.random() * this.resourceStore.count))?.name || 'Mystery man';
    }
