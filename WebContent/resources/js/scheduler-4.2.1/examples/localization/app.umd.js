...
var _bryntum$scheduler = bryntum.scheduler,
    ...
    StringHelper = _bryntum$scheduler.StringHelper; // Importing custom locales
...
LocaleManager.throwOnMissingLocale = true; //region Data

var resources = [{
  id: 'r1',
  name: 'Mike',
  company: 'Big Fish inc'
}, {
  id: 'r2',
  name: 'Linda',
  company: 'Small rocket co'
}, {
  id: 'r3',
  name: 'Dan',
  company: 'Big Fish inc'
