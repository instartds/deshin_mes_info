...
window.examples = [
    ...
    { folder : 'vertical', group : 'Basic', title : 'Vertical mode', since : '2.2' },
    ...
    { folder : 'eventeditor', group : 'Intermediate', title : 'Event editor', updated : '4.1.1' },
    ...
    { folder : 'websockets', group : 'Advanced', title : 'WebSockets online demo', build : true, ie : false, since : '2.0' },
    ...
    { folder : 'webcomponents', group : 'Integration', title : 'Use as web component', ie : false },
    ...
    // Integration/WebPack
    { folder : 'frameworks/custom-build', group : 'Integration', title : 'Custom build using WebPack', overlay : 'webpack', version : 'WebPack 4', since : '2.3', offline : true },

    // Integration/Angular
    { folder : 'frameworks/angular/advanced', group : 'Integration/Angular', title : 'Angular Routing + NgRx demo', overlay : 'angular', version : 'Angular 8', build : true, since : '2.0' },
    { folder : 'frameworks/angular/angular-1', group : 'Integration/Angular', title : 'Angular 1 demo', overlay : 'angular', version : 'Angular 1', build : true },
    ...
    { folder : 'frameworks/angular/angular-2', group : 'Integration/Angular', title : 'Angular 2 demo', overlay : 'angular', version : 'Angular 2', build : true },
    { folder : 'frameworks/angular/angular-4', group : 'Integration/Angular', title : 'Angular 4 demo', overlay : 'angular', version : 'Angular 4', build : true },
    { folder : 'frameworks/angular/angular-5', group : 'Integration/Angular', title : 'Angular 5 demo', overlay : 'angular', version : 'Angular 5', build : true },
    ...
    { folder : 'frameworks/angular/animations', group : 'Integration/Angular', title : 'Angular Animations demo', overlay : 'angular', version : 'Angular 8', build : true, since : '2.0' },
    ...
    { folder : 'frameworks/angular/custom-event-editor', group : 'Integration/Angular', title : 'Angular Custom Event Editor demo', overlay : 'angular', version : 'Angular 8', build : true, since : '2.2.5' },
    ...
    { folder : 'frameworks/angular/drag-from-grid', group : 'Integration/Angular', title : 'Angular Drag Tasks from Grid', overlay : 'angular', version : 'Angular 8', build : true, since : '2.0', updated : '4.2.0' },
    ...
    // Integration/React
    { folder : 'frameworks/react/javascript/advanced', group : 'Integration/React', title : 'React + Redux advanced demo', overlay : 'react', version : 'React 16', build : true, since : '2.0' },
