...
var errorListener = function errorListener(errorEvent) {
  return earlyErrorEvent = errorEvent;
    ...
    ignoreUserActionsDemos = ['bigdataset', 'gantt-schedulerpro', 'resourcehistogram', 'drag-between-schedulers'],
    ignoreUserActionsRe = new RegExp("(".concat(ignoreUserActionsDemos.join('|'), ")"));
...
var Shared = /*#__PURE__*/function (_Localizable) {
  ...
  function Shared() {
    ...
    if (!isDemoBrowser && !document.body.matches('[class*=b-theme]')) {
      var currentThemeId = me.getStoredThemeId() || me.theme;
    ...
    me.loadDescription(); // Don't load hints for the example browser (or if viewing with ?develop or in tests)
  ...
  _createClass(Shared, [{
    ...
    value: function insertHeader() {
      ...
      header.innerHTML = "\n            <div id=\"title-container\">\n                <a id=\"title\" href=\"".concat(isDemoBrowser ? '#' : '../').concat(!isDemoBrowser && isUmd ? 'index.umd.html' : '', "#example-").concat(exampleId, "\">\n                    ").concat(exampleName, "\n                </a>\n            </div>\n            <div id=\"tools\"></div>\n        ");
      var tools = document.getElementById('tools'),
        ...
        onClick: function onClick(_ref) {
          ...
          if (window.grid || window.scheduler || window.gantt || window.calendar || window.taskboard) {
            ...
            Toast.show('Code editor disabled for this demo');
          }
        }
      }),
    ...
    key: "initHints",
    value: function () {
      var _initHints = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    value: function loadDescription() {
      ...
      AjaxHelper.get(url, {
        ...
        button.menuItems = [{
        ...
        }].concat(_toConsumableArray(!themes[currentThemeId] || body.matches('.b-theme-custom') ? [] : [themeCombo = {
          type: 'combo',
          ref: 'themeCombo',
          label: 'L{Theme}',
          labelPosition: 'above',
        ...
        }], _toConsumableArray(isDemoBrowser ? [] : [{
          type: 'combo',
          ref: 'sizeCombo',
          label: 'L{Size}',
          labelPosition: 'above',
          ...
          onAction: function onAction(_ref4) {
            ...
            setTimeout(function () {
              return body.classList.remove('b-change-size');
            }, 400);
            me.curSize = value;
        ...
        GlobalEvents.on({
          theme: function theme(_ref6) {
            ...
            themeCombo && (themeCombo.value = _theme);
            BrowserHelper.setLocalStorageItem('b-example-theme', _theme);
            body.classList.add("b-theme-".concat(_theme));
            body.classList.remove("b-theme-".concat(prev)); // display after loading theme to not show initial transition from default theme
    ...
    key: "getStoredThemeId",
    value: function getStoredThemeId(defaultThemeId) {
    ...
    get: function get() {
      ...
      return DomHelper.themeInfo || {
        name: this.getStoredThemeId(defaultTheme)
      };
    }
  }, {
    key: "theme",
    ...
    value: function startRootCause() {
      ...
      window.logger = new RC.Logger({
        ...
        recordUserActions: recordEvents && !location.pathname.match(ignoreUserActionsRe),
    ...
    value: function performVersionCheck() {
      ...
      AjaxHelper.get("https://bryntum.com/latest/?product=".concat(this.product.onlineId), {
        parseJson: true,
        credentials: 'omit'
    ...
    key: "showCodeEditor",
    value: function () {
      var _showCodeEditor = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var codeEditor;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return CodeEditor.addToPage(this.codeButton);

              case 4:
                codeEditor = this.codeEditor = _context2.sent;
      ...
      function showCodeEditor() {
        return _showCodeEditor.apply(this, arguments);
      }
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                DomHelper.forEachSelector(document.body, '.b-widget.b-outer', function (element) {
              ...
              case 23:
                ...
                DomHelper.forEachSelector(document.body, '.b-widget', function (element) {
