...
import { BryntumSchedulerComponent } from '@bryntum/scheduler-angular/bundles/bryntum-scheduler-angular.umd.js';
...
export class AppComponent implements AfterViewInit {
    ...
    getData(): void {
        const me = this;
        me.http.get('./assets/data/data.json').subscribe(res => {
            const data = res.json();
