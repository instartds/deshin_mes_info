...
import { DateHelper, Menu, Scheduler } from '@bryntum/scheduler/scheduler.lite.umd.js';
...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    onAfterLunch(): void {
        ...
        eventStore.query((event: AppEventModel) => event.eventType === 'Meeting')
            .forEach((event: AppEventModel) => event.startDate = DateHelper.max(event.startDate as Date, lunchFinishTime));
