...
<template>
    <div>
        <div class="demo-header" id="title-container">
            <a id="title" :href="link">{{ $props.title }}</a>
            <bryntum-fullscreen-button></bryntum-fullscreen-button>
        </div>
        <div id="tools" class="demo-toolbar align-right">
...
<script>
    import { BryntumFullscreenButton } from '@bryntum/scheduler-vue';
    import ColorsCombo from './ColorsCombo.vue';
    import StylesCombo from './StylesCombo.vue';
...
<style lang="scss">
    ...
    .style-list .b-list-item {
        ...
        .b-sch-event:not(.b-sch-style-colored) {
            color : #fff !important;
        }
    }
