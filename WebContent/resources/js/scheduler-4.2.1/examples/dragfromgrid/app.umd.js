...
var Drag = /*#__PURE__*/function (_DragHelper) {
  ...
  _createClass(Drag, [{
    ...
    value: function construct(config) {
      ...
      _get(_getPrototypeOf(Drag.prototype), "construct", this).call(this, config); // Configure DragHelper with schedule's scrollManager to allow scrolling while dragging
    ...
    value: function onTaskDrag(_ref2) {
      ...
      var me = this,
          schedule = me.schedule,
          task = context.task,
          coordinate = DomHelper["getTranslate".concat(schedule.isHorizontal ? 'X' : 'Y')](context.element),
...
var TaskStore = /*#__PURE__*/function (_EventStore) {
  ...
  _createClass(TaskStore, [{
    key: "add",
    value: // Override add to reschedule any overlapping events caused by the add
...
var CustomResourceModel = /*#__PURE__*/function (_ResourceModel) {
  _inherits(CustomResourceModel, _ResourceModel);

  var _super7 = _createSuper(CustomResourceModel);

  function CustomResourceModel() {
    _classCallCheck(this, CustomResourceModel);

    return _super7.apply(this, arguments);
  }

  _createClass(CustomResourceModel, null, [{
    key: "$name",
    get: function get() {
...
var schedule = new Schedule({
  ...
  tbar: ['Schedule view', '->', {
    ...
    onToggle: function onToggle(_ref7) {
    ...
    onAction: function onAction(_ref8) {
      var button = _ref8.source;

      var newConfig = _objectSpread(_objectSpread({}, schedule.initialConfig), button.schedulerConfig);
