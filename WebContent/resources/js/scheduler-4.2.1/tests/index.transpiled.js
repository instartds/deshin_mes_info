var Project = new Siesta.Project.Browser(),
    _BryntumTestHelper = BryntumTestHelper,
    isTC = _BryntumTestHelper.isTC,
    isTrial = _BryntumTestHelper.isTrial;
Project.configure({
  ...
  turboMode: true,
  // TODO: Investigate Safari "Script error." https://github.com/bryntum/bryntum-suite/issues/3718
  ignoreException: bowser.safari ? /Script error\./ : null,
  recorderConfig: {
    recordOffsets: false,
    ignoreCssClasses: ['b-sch-event-hover', 'b-active', 'b-icon', 'b-hover', 'b-dirty', 'b-focused', 'b-contains-focus'],
...
var getItems = function getItems(mode) {
  var examples = [{
  ...
  }, 'multiassign', 'multiassign-with-dependencies', 'multisummary', {
  ...
  }, 'resource-collapsing', 'resourcetimeranges', 'responsive', 'rough', 'rowheight', // 'salesforce', // Skip testing
  {
    ...
    url: 'examples/stresstest.t.js'
      ...
      frameworks = ['angular/advanced', 'angular/angular-2', 'angular/angular-1', 'angular/angular-4', 'angular/angular-5', 'angular/angular-6', {
    pageUrl: 'angular/angular-7',
    url: 'angular/angular-7.t.js'
  }, {
    pageUrl: 'angular/angular-8',
    url: 'angular/angular-8.t.js'
  }, 'angular/angular-7', 'angular/angular-8', {
    ...
    pageUrl: 'custom-build',
    url: 'custom-build.t.js',
    keepPageUrl: true,
    skip: !bowser.chrome
  ...
  {
    pageUrl: 'ionic/themes',
    skip: bowser.msie
  }, 'react/javascript/advanced', 'react/javascript/animations', {
    pageUrl: 'react/javascript/custom-event-editor',
    url: 'react/react-custom-event-editor.t.js',
    viewportWidth: 1200
  }, 'react/javascript/dependencies', 'react/javascript/drag-between-schedulers', 'react/javascript/drag-from-grid', 'react/javascript/drag-onto-tasks', 'react/javascript/filtering', 'react/javascript/localization', 'react/javascript/pdf-export', {
    pageUrl: 'react/javascript/simple',
    url: 'react/react-simple.t.js'
  }, 'react/javascript/vertical', 'react/typescript/basic', {
    pageUrl: 'vue/javascript/custom-event-editor',
    url: 'vue/vue-custom-event-editor.t.js'
  }, 'react/typescript/filtering', 'react/typescript/recurring-events', 'vue/javascript/advanced', 'vue/javascript/animations', 'vue/javascript/dependencies', 'vue/javascript/drag-between-schedulers', 'vue/javascript/drag-from-grid', 'vue/javascript/drag-onto-tasks', {
  ...
  }, 'vue/javascript/tasks', 'vue/javascript/vue-renderer', 'vue/javascript/vuestic', 'vue-3/javascript/simple', // This setting requires requests to be proxied. Usual setup would be like:
  ...
  // Web server should be adjusted to map http://localhost/scheduler-netcore to http://localhost:8080/
  {
    ...
    }, 'crud_manager/07_load_inline.t.js', 'crud_manager/07_load_append.t.js', 'crud_manager/08_auto_sync.t.js', //'crud_manager/09_xml_encoder.t.js',
    'crud_manager/09_json_encoder.t.js', 'crud_manager/10_ajax_transport.t.js', // Tests run in parallel in teamcity and possibly could start this test at the same time.
    ...
    }, 'crud_manager/13_view_update.t.js', 'crud_manager/14_crudmanager_sharing.t.js', {
    ...
    items: [{
      ...
      turboMode: false
    }, 'dependencies/DependencyDrawing.t.js', 'dependencies/DependencyDrawing_2.t.js', 'dependencies/DependencyDrawing_3.t.js', 'dependencies/DependencyDrawing_4.t.js', 'dependencies/DependencyGridCache.t.js', 'dependencies/Create.t.js', 'dependencies/Create-Events.t.js', 'dependencies/Create-Terminals.t.js', 'dependencies/231_vertically_close.t.js', {
      url: 'dependencies/Create-Type.t.js',
      speedRun: false
    }, {
      url: 'dependencies/Create-Validation.t.js',
      speedRun: false
    }, 'dependencies/2492_persisted_dependency.t.js', 'dependencies/Dependencies.t.js', 'dependencies/DependenciesMulti.t.js', 'dependencies/RefreshTriggers.t.js']
  }, {
    group: 'Docs',
    includeFor: isTrial ? 'module' : 'es6',
    pageUrl: {
    ...
    items: bowser.msie ? [] : [{
      ...
      ignoreTopics: ['demos'],
      ignoreLinks: ['Grid/feature/CellMenu#Grid/guides/customization/contextmenu.md', 'Grid/view/Grid#Grid/guides/data/displayingdata.md'],
      ...
      disableNoTimeoutsCheck: true,
      alsoPreload: bowser.firefox && preloadNoResizeObserver,
      ignoreLinks: ['Core/guides/advanced/widgets.md#foo']
    },
    /* <remove-on-release> */
    {
      usesConsole: true,
      url: 'docs/sanity.t.js',
      disableNoTimeoutsCheck: true,
      alsoPreload: bowser.firefox && preloadNoResizeObserver
    }, {
      url: 'docs/docs-integrity.t.js',
      alsoPreload: {
        type: 'js',
        isEcmaModule: true,
        content: 'import "../docs/data/docs_scheduler.js";'
      },
      ignore: {
        features: ['Core/feature/base/ContextMenuBase', 'Grid/feature/export/exporter/Exporter', 'Grid/feature/GridFeatureManager', 'Grid/feature/mixin/SummaryFormatter', 'Scheduler/feature/AbstractTimeRanges', 'Scheduler/feature/base/DragBase', 'Scheduler/feature/base/DragCreateBase', 'Scheduler/feature/base/EditBase', 'Scheduler/feature/base/ResourceTimeRangesBase', 'Scheduler/feature/base/TimeSpanMenuBase', 'Scheduler/feature/base/TimeSpanRecordContextMenuBase', 'Scheduler/feature/base/TooltipBase', 'Scheduler/feature/mixin/DependencyCreation', 'Scheduler/feature/mixin/RecurringEventEdit'],
        mixins: ['Core/mixin/InstancePlugin', 'Core/mixin/Override']
      }
    }
    /* </remove-on-release> */
    ]
    ...
    group: 'Column',
    items: ['column/ReplaceColumns.t.js', 'column/ResourceCollapseColumn.t.js', {
    ...
    group: 'Events',
    items: ['events/060_events.t.js', 'events/061_dragdrop.t.js', 'events/061_dragdrop_filtered_timeaxis.t.js', 'events/061_dragdrop_outside_of_view.t.js', 'events/061_dragdrop_sanity.t.js', 'events/062_resize.t.js', 'events/063_create.t.js', 'events/068_dragdrop_invalid.t.js', 'events/BeforeEventAdd.t.js', 'events/BeforeEventRemove.t.js', 'events/EventRefreshTriggers.t.js', 'events/EventStoreSetData.t.js']
  }, {
    group: 'Features',
    ...
    items: [{
      ...
      speedRun: false
    }, 'features/EventContextMenu.t.js', 'features/EventCopyPaste.t.js', 'features/EventMenu.t.js', 'features/EventDrag.t.js', 'features/EventDrag2.t.js', 'features/EventDrag3.t.js', 'features/EventDrag4.t.js', 'features/EventDragBetweenSchedulers.t.js', 'features/EventDragCreate.t.js', 'features/EventDragCreate2.t.js', 'features/EventDragCreateAsync.t.js', 'features/EventDragCreateNonContinuous.t.js', 'features/EventDragFiltered.t.js', 'features/EventDragMulti.t.js', 'features/EventDragMultiassignment.t.js', 'features/EventDragNonContinuous.t.js', 'features/EventDragScroll.t.js', 'features/EventDragSelect.t.js', {
      ...
      usesConsole: true
    }, 'features/EventEditEvents.t.js', 'features/EventEditFields.t.js', 'features/EventEditMulti.t.js', 'features/EventEditSTM.t.js', 'features/EventResize.t.js', 'features/EventResize2.t.js', 'features/EventTooltip.t.js', 'features/FilterBar.t.js', 'features/Group.t.js', 'features/Grouping.t.js', 'features/GroupSummary.t.js', 'features/HeaderContextMenu.t.js', 'features/HeaderContextMenu2.t.js', 'features/HeaderZoom.t.js', 'features/Labels.t.js', {
      alsoPreload: preloadLocales,
      url: 'features/NonWorkingTime.t.js'
    }, 'features/Pan.t.js', 'features/ResourceTimeRanges.t.js', 'features/ResourceTimeRangesRecurrence.t.js', 'features/ScheduleContextMenu.t.js', 'features/ScheduleMenu.t.js', 'features/ScheduleTooltip.t.js', 'features/SimpleEventEdit.t.js', 'features/StickyEvents.t.js', 'features/Summary.t.js?mode=horizontal', 'features/Summary.t.js?mode=vertical', 'features/TimeAxisHeaderMenu.t.js', 'features/TimeRanges.t.js', 'features/TimeSpanMenuBase.t.js', 'features/TimeSpanRecordContextMenuBase.t.js', 'features/Tree.t.js', {
    ...
    group: 'Header',
    items: ['header/125_timeaxiscolumn_header_refresh.t.js', 'header/200_timeaxisview_model.t.js', 'header/201_timeaxisview.t.js', 'header/310_single_timeaxisheader.t.js', 'header/312_single_single_level_header.t.js', 'header/314_single_headers_heights.t.js', 'header/317_filtered_time_axis_horizontal.t.js', 'header/318_header_scroll_bug.t.js', 'header/319_not_adjusted_custom_hour_timeaxis.t.js', 'header/ReorderColumns.t.js', 'header/UpdateFromHorizontalScroll.t.js']
  }, {
    group: 'Localization',
    items: [
    /* <remove-on-trial> */
    {
      alsoPreload: {
        default: [{
          type: 'js',
          isEcmaModule: true,
          content: ['import "../examples/_shared/locales/examples.locale.En.js";', 'import "../examples/_shared/locales/examples.locale.Nl.js";', 'import "../examples/_shared/locales/examples.locale.Ru.js";', 'import "../examples/_shared/locales/examples.locale.SvSE.js";'].join('')
        }]
      },
      ignoreList: {
        Common: ['PresetManager.secondAndMinute', 'PresetManager.minuteAndHour', 'PresetManager.hourAndDay', 'PresetManager.dayAndWeek']
      },
      universalList: {
        Common: ['Object.Ok', 'Column.Id'],
        Nl: ['Filter.filter', 'ExportDialog.columns', 'DependencyEdit.Type', 'EventEdit.Resource', 'EventEdit.Start', 'Column.Machines', 'Column.Score', 'Column.Type', 'CodeEditor.Code editor', 'CodeEditor.Download code'],
        SvSE: ['Filter.filter', 'EventEdit.Start', 'Column.Start', 'DependencyType.short.0', 'DependencyType.SS']
      },
      ...
      alsoPreload: {
        default: [{
          type: 'js',
          isEcmaModule: true,
          content: ['import "../examples/localization/locales/custom.locale.En.js";', 'import "../examples/localization/locales/custom.locale.Nl.js";', 'import "../examples/localization/locales/custom.locale.Ru.js";', 'import "../examples/localization/locales/custom.locale.SvSE.js";', 'import "../examples/localization/locales/custom.locale.De.js";'].join('')
        }]
      },
      ignoreList: {
        Common: ['PresetManager.secondAndMinute', 'PresetManager.minuteAndHour', 'PresetManager.hourAndDay', 'PresetManager.dayAndWeek'],
      ...
      universalList: {
        Common: ['Object.Ok', 'EventColor.Meeting', 'EventColor.Phone', 'EventColor.Lunch', 'EventColor.Workout'],
        Nl: ['Filter.filter', 'ExportDialog.columns', 'DependencyEdit.Type', 'EventEdit.Resource', 'EventEdit.Start', 'CodeEditor.Code editor', 'CodeEditor.Download code'],
        SvSE: ['Filter.filter', 'EventEdit.Start', 'DependencyType.short.0', 'DependencyType.SS'],
        De: ['Filter.filter', 'ExportDialog.export', 'EventEdit.Name', 'EventEdit.Start']
      },
      ...
      includeFor: 'es6',
      url: 'localization/features/recurrence/RecurringEventEditor.t.js'
    }
    /* </remove-on-trial> */
    ]
  },
  /* <remove-on-release> */
  {
    ...
    items: [{
      ...
      alsoPreload: {
        type: 'js',
        isEcmaModule: true,
        content: ['import * as BryntumClasses from "../build/scheduler.module.js";', 'window.bryntum.classes = BryntumClasses;', 'import En from "../lib/Scheduler/localization/En.js";', 'window.bryntum.locales = {En}'].join('')
      },
      url: 'localization/LocalizationSanity.t.js',
      classRename: {
        GridExportDialog: 'ExportDialog',
  ...
  /* </remove-on-release> */
  {
    ...
    group: 'Model',
    items: ['model/DependencyModel.t.js', 'model/EventModel.t.js', 'model/ProjectModel.t.js', 'model/ResourceModel.t.js', 'model/TimeSpan.t.js']
  }, {
    group: 'Preset',
    ...
    {
      group: 'Grid baseline',
      alsoPreload: ['../build/scheduler.classic.css'],
      items: ['grid/view/mixin/GridElementEvents.t.js', {
        url: 'grid/grid-and-scheduler-umd.t.js',
        pageUrl: 'grid/grid-and-scheduler-umd.html',
        includeFor: 'umd',
        keepPageUrl: true
      }, {
        url: 'grid/grid-and-scheduler-module.t.js',
        includeFor: 'module'
      }]
    },
    /* </remove-on-release> */
    {
      group: 'DST',
      items: ['view/dst/EventRendering.t.js']
    }, {
      group: 'mixins',
      ...
      includeFor: 'es6'
    }, 'view/Scheduler.t.js', 'view/SchedulerMisconfiguration.t.js', 'view/ScheduleDblClick.t.js', 'view/HeaderContextMenu.t.js', 'view/HeaderContextMenu2.t.js', 'view/TimeAxisHeaderMenu.t.js', 'view/HorizontalTimeAxis.t.js', 'view/EventCommittingCls.t.js', 'view/EventLayout.t.js', {
      url: 'view/Leaks.t.js',
      includeFor: 'es6'
    }, 'view/MilestoneLayout.t.js', 'view/HeaderZoomLevels.t.js', {
    ...
    group: 'Widget',
    items: ['widget/ResourceCombo.t.js', 'widget/ResourceFilter.t.js', 'widget/UndoRedo.t.js']
  }, {
    ...
    items: examples.filter(function (example) {
      return (example === null || example === void 0 ? void 0 : example.pageUrl) != null && (example === null || example === void 0 ? void 0 : example.url) != null;
    })
  }, {
...
preloadLocalization = {
  ...
  default: [{
    ...
    groups = []; // Don't test es6 and module in IE11
...
if (!bowser.msie) {
  ...
  !isTrial && groups.push({
    ...
    preload: preloads.concat([{
      type: 'js',
      isEcmaModule: true,
      content: ['import AjaxHelper from "../lib/Core/helper/AjaxHelper.js";', 'import AssignmentStore from "../lib/Scheduler/data/AssignmentStore.js";', 'import DependencyStore from "../lib/Scheduler/data/DependencyStore.js";', 'import EventStore from "../lib/Scheduler/data/EventStore.js";', 'import ResourceStore from "../lib/Scheduler/data/ResourceStore.js";', 'import PresetManager from "../lib/Scheduler/preset/PresetManager.js";', 'import Scheduler from "../lib/Scheduler/view/Scheduler.js";', 'Object.assign(window, { AjaxHelper, AssignmentStore, DependencyStore, EventStore, ResourceStore, PresetManager, Scheduler });'].join('')
    }]),
    isEcmaModule: true,
    collapsed: true,
    mode: 'es6',
