const
    ...
    { isTC, isTrial } = BryntumTestHelper;
    ...
    getItems                = mode => {
        const
            ...
            frameworks = [
                ...
                'ionic/ionic-4',
                // Demo disabled for IE11. Theme switching doesn't work in Ionic + IE11.
                        ...
                        },
                        {
                            ...
                            ignore : {
                                features : [
                                    ...
                                    'Grid/feature/GridFeatureManager',
                                    'Grid/feature/mixin/SummaryFormatter',
                                    ...
                                    'Scheduler/feature/base/TimeSpanRecordContextMenuBase',
                    ...
                    items : [
                        {
                            ...
                            alsoPreload : {
                                ...
                                isEcmaModule : true,
                                content      : [
                                    'import * as BryntumClasses from "../build/scheduler.module.js";',
                                    'window.bryntum.classes = BryntumClasses;',
                                    'import En from "../lib/Scheduler/localization/En.js";',
                                    'window.bryntum.locales = {En}'
                                ].join('')
                            },
                ...
                },
                {
                    ...
                    items   : [
                        /* <remove-on-release> */
                        {
                            group       : 'Grid baseline',
                            alsoPreload : [
                                '../build/scheduler.classic.css'
                            ],
                            items : [
                                'grid/view/mixin/GridElementEvents.t.js',
                                {
...
// Don't test es6 and module in IE11
if (!bowser.msie) {
        ...
        preload : preloads.concat([
            {
                ...
                content      : [
                    ...
                    'Object.assign(window, { AjaxHelper, AssignmentStore, DependencyStore, EventStore, ResourceStore, PresetManager, Scheduler });'
                ].join('')
            }
        ]),
        isEcmaModule : true,
        ...
        preload : preloads.concat([
            {
                ...
                isEcmaModule : true,
                content      : [
                    'import { AjaxHelper, AssignmentStore, DependencyStore, EventStore, ResourceStore, PresetManager, Scheduler} from "../build/scheduler.module.js";',
                    'Object.assign(window, { AjaxHelper, AssignmentStore, DependencyStore, EventStore, ResourceStore, PresetManager, Scheduler });'
                ].join('')
            }
        ]),
