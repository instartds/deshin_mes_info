import { Scheduler, DateHelper, BrowserHelper, VersionHelper } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Should disable "Add event" if no resources exist', async t => {
        ...
        t.chain(
            { rightClick : '.b-grid-subgrid-normal', offset : [2, 2] },
    ...
    t.it('Should be able to process items shown for an event', async t => {
        ...
        t.chain(
            { rightClick : '.b-sch-timeaxis-cell', offset : [50, 60] },
            ...
            { rightClick : '.b-sch-timeaxis-cell', offset : [400, 60] },
            ...
            { click : '.b-sch-timeaxis-cell', offset : [200, 60], desc : 'Clicking to hide menu' },
    ...
    t.it('Should trigger scheduleMenuBeforeShow & scheduleMenuShow events', async t => {
        ...
        t.chain(
            ...
            { click : '.b-sch-timeaxis-cell', offset : [50, 60] },
    ...
    t.it('LEGACY: Should trigger scheduleContextMenuBeforeShow & scheduleContextMenuShow events', async t => {
        ...
        t.chain(
            ...
            () => {
                ...
                t.expect(spy).toHaveBeenCalledWith('Scheduler', '5.0.0', '`scheduleContextMenuBeforeShow` event is deprecated, in favor of `scheduleMenuBeforeShow` event. Please see https://bryntum.com/docs/scheduler/#Scheduler/guides/upgrades/3.1.0.md for more information.');
                t.expect(spy).toHaveBeenCalledWith('Scheduler', '5.0.0', '`scheduleContextMenuShow` event is deprecated, in favor of `scheduleMenuShow` event. Please see https://bryntum.com/docs/scheduler/#Scheduler/guides/upgrades/3.1.0.md for more information.');
            }
        );
    });
    ...
    t.it('LEGACY: Should trigger scheduleContextMenuItem event', async t => {
        ...
        t.chain(
            ...
            () => {
                ...
                t.expect(spy).toHaveBeenCalledWith('Scheduler', '5.0.0', '`scheduleContextMenuItem` event is deprecated, in favor of `scheduleMenuItem` event. Please see https://bryntum.com/docs/scheduler/#Scheduler/guides/upgrades/3.1.0.md for more information.');
            }
        );
    });
    ...
    t.it('Should work with AssignmentStore', t => {
        ...
        t.chain(
            ...
            { rightClick : '.b-sch-timeaxis-cell', offset : [150, 10] },
            { click : '.b-menu:textEquals(Add event)' },
            { waitForSelector : '.b-sch-dirty-new', desc : 'New event rendered' },
