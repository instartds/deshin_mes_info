import { Scheduler, TimeAxisColumn, DateHelper, BrowserHelper, VersionHelper } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('LEGACY: Should be able to process items shown for an event', async t => {
        ...
        t.chain(
            ...
            { rightClick : '[data-index="2"] .b-sch-timeaxis-cell', offset : [10, 10] },
