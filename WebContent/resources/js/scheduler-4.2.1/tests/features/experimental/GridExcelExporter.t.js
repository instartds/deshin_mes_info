...
import '../../../lib/Scheduler/feature/experimental/ExcelExporter.js';
    ...
    t.it('Exporting a checkbox column should produce checkmark unicode symbol', t => {
        ...
        grid = t._getGrid({
            ...
            store : {
                fields : [
                    'name',
                    { name : 'swede', type : 'boolean' }
                ],
                data : [
                    { id : 1, name : 'Johan', swede : true },
                    { id : 2, name : 'Mats', swede : true },
                    { id : 3, name : 'Arcady', swede : false }
                ]
            }
        });
    ...
    t.it('Date is formatted during export', t => {
        ...
        grid = new Grid({
            ...
            store    : {
                ...
                data : [
                    { name : 'Andy',  age : '30', date : '2019-09-02', processed : true }
                ]
            },
            features : {
                excelExporter : true
            ...
            columns : [
                ...
                { text : 'Age', field : 'age' },
                { text : 'Age (ignored)', field : 'age', exportable : false },
                { text : 'Date', field : 'date', type : 'date', format : 'DD-MM-YYYY' },
                { text : 'Processed', field : 'processed' }
            ]
        });
    ...
    t.it('Should export the columns correctly according with configs defined on call export function', async t => {
        ...
        grid = t._getGrid({
            store    : {
                ...
                data : [
                    { id : 1, name : 'Johan', country : 'Sweden', date : '2020-09-02 10:30:40' },
                    { id : 2, name : 'Mats', country : 'Sweden', date : '2020-09-03 10:40:40' },
                    { id : 3, name : 'Arcady', country : 'Russia', date : '2020-09-04 10:50:40' }
                ]
            },
            columns : [{
                text  : 'Name',
        ...
        grid.features.excelExporter.export({
            ...
            exporterConfig : {
                columns : [
                    { text : 'Name Custom', field : 'name' },
                    { text : 'Date Custom', field : 'date' }
                ]
            }
        });
    });
