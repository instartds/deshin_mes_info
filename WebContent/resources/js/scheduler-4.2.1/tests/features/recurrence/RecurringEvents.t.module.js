import { AssignmentStore, EventStore, ResourceStore, Base, ArrayHelper } from '../../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Generates occurrences for recurring multi-assigned events', async t => {
        ...
        const eventStore = new EventStore({
            data : [
                { id : 1, name : 'Foo', startDate : '2018-06-14', endDate : '2018-06-15' },
                {
                    id             : 2,
                    name           : 'Bar',
                    startDate      : '2018-06-14',
        ...
        const assignmentStore = new AssignmentStore({
            data : [
                ...
                { id : 2, eventId : 2, resourceId : 'r1' },
                { id : 3, eventId : 3, resourceId : 'r1' },
                { id : 4, eventId : 1, resourceId : 'r2' },
                { id : 5, eventId : 2, resourceId : 'r2' },
                { id : 6, eventId : 3, resourceId : 'r2' }
            ]
        });
    ...
    t.it('Recurring event occurrences are generated once even if event and timespan are changed in the process of generating', async t => {
        ...
        const scheduler1 = await getScheduler({
    ...
    t.it('Generates occurrences for future occurrences of new recurring event', async t => {
        ...
        const newBase = event1.occurrences[2];

        // Promote Tues 19th June's occurrence to be a new base of wednesday and thursday occurrences
    ...
    t.it('Generates occurrences for events which are promoted to be recurring', async t => {
        ...
        const eventStore = new EventStore({
            data : [
                { id : 1, resourceId : 'r1', name : 'Foo', startDate : '2018-06-11', endDate : '2018-06-12' }
            ]
        });
    ...
    t.it('Draws recurring events on scroll', async t => {
        ...
        scheduler1.resourceStore.data = ArrayHelper.populate(10, i => ({ id : i + 1 }));
