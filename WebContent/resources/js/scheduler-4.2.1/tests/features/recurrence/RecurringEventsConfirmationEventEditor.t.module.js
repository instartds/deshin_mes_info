...
StartTest(t => {
    ...
    t.it('Confirmation shows up on recurring event editing in event editor', t => {
        ...
        t.chain(
            ...
            { type : '06/15/2018', target : 'input[name=startDate]', clearExisting : true },

            { click : 'input[name=endDate]' },

            { type : '06/16/2018', target : 'input[name=endDate]', clearExisting : true },

            { click : 'button:contains(Save)', desc : '"Save" clicked' },
    ...
    t.it('"All Future Events" button click causes further occurrences regeneration', t => {
        ...
        t.chain(
            ...
            { type : '06/19/2018', target : 'input[name=startDate]', clearExisting : true },

            { click : 'input[name=endDate]' },

            { type : '06/20/2018', target : 'input[name=endDate]', clearExisting : true },
