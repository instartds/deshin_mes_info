...
StartTest(t => {
    ...
    t.beforeEach(async(t, next) => {
        ...
        eventStore = new EventStore({
            data : [
                { id : 1, resourceId : 'r1', name : 'Not recurring', startDate : '2018-06-14', endDate : '2018-06-15', cls : 'sch-event1' },
                { id : 2, resourceId : 'r1', name : 'Recurrs Weekly', startDate : '2018-06-14', endDate : '2018-06-15', recurrenceRule : 'FREQ=WEEKLY;INTERVAL=1', cls : 'sch-event2' },
                { id : 3, resourceId : 'r1', name : 'Recurrs Daily', startDate : '2018-06-14', endDate : '2018-06-15', recurrenceRule : 'FREQ=DAILY;INTERVAL=2', cls : 'sch-event3' }
            ]
        });
    ...
    t.it('"Delete Only This Event" button click works properly', t => {
        ...
        t.chain(
            ...
            { waitForSelectorNotFound : '.b-sch-recurrenceconfirmation', desc : 'Confirmation closed' },
