    ...
    t.describe('All drag events should be fired and handled correctly', t => {
        ...
        t.it('Should be possible to determine in what resource row the event drag is about to start', async t => {
            ...
            scheduler = await setup({
                ...
                listeners : {
                    beforeEventDrag({ resourceRecord, eventRecord, eventRecords, assignmentRecords, event }) {
                    ...
                    eventDragStart({ resourceRecord, eventRecords, assignmentRecords, event }) {
                ...
                events : [
                    { id : 1, name : 'Foo', startDate : new Date(2011, 0, 4), endDate : new Date(2011, 0, 5) }
                ],
        ...
        t.it('Should be possible to determine in what resource row the event resize is about to start', async t => {
            ...
            scheduler = await setup({
                ...
                listeners : {
                    beforeEventResize({ resourceRecord, event }) {
                    ...
                    eventResizeStart({ resourceRecord, event }) {
                    ...
                    eventResizeEnd({ resourceRecord, event, changed }) {
