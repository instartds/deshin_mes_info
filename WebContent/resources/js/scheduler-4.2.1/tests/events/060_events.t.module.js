import { ResourceModel } from '../../build/scheduler.module.js';
...
StartTest(async t => {
    ...
    function verifyKeyEventSignature({ source: scheduler, assignmentRecord, eventRecord, eventRecords, assignmentRecords, event }, expectedType) {
        /**
        ...
        t.it('Should fire correct params for ' + event.type, t => {
            ...
            t.ok(event.type === expectedType && event.key === 'Enter', `Correct argument for event: ${expectedType}`);
            // Backwards compat
