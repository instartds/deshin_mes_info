import { AbstractCrudManager } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Generates load package correctly', t => {
        ...
        t.is(pack.stores[0], 'resources', '0th storeId is correct');
        ...
        t.is(pack.stores[1], 'events', '0th storeId is correct');
    ...
    t.it('Generates load package with custom request options', t => {
        ...
        t.isDeeply(pack.requestOptions, { reset : true }, 'Correct common request options');
    });
