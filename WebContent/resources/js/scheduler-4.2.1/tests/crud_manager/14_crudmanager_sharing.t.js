...
StartTest(t => {
    ...
    t.beforeEach(() => Scheduler.destroy(scheduler1, scheduler2));
    ...
    t.it('Should be able to share a CrudManager between two Schedulers', async t => {
        ...
        const
            [newResource]       = scheduler1.resourceStore.add({ name : 'New resource' }),
        ...
        t.is(scheduler1.crudManager.project, scheduler1.project, 'scheduler2.project refers to scheduler2.crudManager.project');
