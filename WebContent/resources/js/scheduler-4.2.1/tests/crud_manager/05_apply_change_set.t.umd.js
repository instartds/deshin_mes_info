...
StartTest(function (t) {
  ...
  var someStore1, someStore2, crud, added1, response;
  ...
  var initTestData = function initTestData() {
    ...
    someStore1.remove(someStore1.getById(11)); // modify record which has updated fields in the sync response

    someStore1.getById(12).ff1 = '-22'; // modify record which doesn't have updated fields in the sync response
  ...
  t.it('Should apply removed records correctly', function (t) {
    initTestData(); // 4 datachanged events: 2 because of "rows" provided + 2 for removals
    ...
    var rows = someStore1.allRecords.slice();
    crud.applySyncResponse(response);
    t.isDeeply(someStore1.allRecords, rows, 'Records not deleted'); // ##12,13,14 imitate server driven removal
  ...
  t.it('Applies changes to data', function (t) {
    ...
    t.xit('someStore2 has correct state after changes applied', function (t) {
  ...
  t.it('Responded phantom records do not get removed by the client', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(t) {
      var oldAllRecords, newAllRecords, newRecord;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              oldAllRecords = someStore1.allRecords.slice().sort(function (a, b) {
                return a.internalId - b.internalId;
              });
              _context.next = 5;
              return crud.applyResponse({
                type: 'sync'
              }, response);

            case 5:
              newAllRecords = someStore1.allRecords.slice().sort(function (a, b) {
                return a.internalId - b.internalId;
              });
              t.isDeeply(newAllRecords, oldAllRecords.concat(t.any(someStore1.modelClass)), 'one new record appeared');
              newRecord = newAllRecords[newAllRecords.length - 1];
