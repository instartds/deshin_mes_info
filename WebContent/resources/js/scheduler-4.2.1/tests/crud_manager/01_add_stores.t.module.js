import { Store, AbstractCrudManager } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Constructor accepts stores list', t => {
        ...
        t.it('storeId list', t => {
            let resourceStore = t.getResourceStore({ storeId : 'foo' }),
                eventStore    = t.getEventStore({ storeId : 'bar' }),
                crud          = setup({ stores : ['foo', 'bar'] }).crud;
