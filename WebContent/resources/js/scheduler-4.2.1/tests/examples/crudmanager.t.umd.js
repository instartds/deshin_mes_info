StartTest(function (t) {
  ...
  t.it('Should work with single-assigned events', function (t) {
    t.chain(clickResetButton, {
      waitForSelector: '[data-ref="crudStatus"]:contains(Data loaded)',
      desc: 'Status bar is correct'
    }, {
      ...
      waitForSelector: '[data-ref="crudStatus"]:contains(Changes saved)',
      desc: 'Status bar is correct'
    }, {
