import { DependencyStore, DependencyModel, MessageDialog } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Should include correct event params', async t => {
        scheduler.on({
            ...
            dependencyValidationComplete({ data, source, target, dependencyType }) {
            ...
            dependencycreatedrop({ data, source, target, dependency }) {
            ...
            afterDependencyCreateDrop({ data, source, target, dependency }) {
    ...
    t.it('Should support async finalization using beforeDependencyCreateFinalize event', t => {
        scheduler.on('beforeDependencyCreateFinalize', async({ source, target, fromSide, toSide }) => {
