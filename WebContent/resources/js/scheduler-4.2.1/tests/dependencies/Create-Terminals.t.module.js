import { DependencyStore, DateHelper } from '../../build/scheduler.module.js';
...
StartTest(t => {
    const labelsConfig = {
        ...
        top : {
            ...
            renderer : ({ eventRecord }) => 'At the very least, ' + eventRecord.duration + ' ' +  DateHelper.getLocalizedNameOfUnit(eventRecord.durationUnit, eventRecord.duration !== 1)
        },
    ...
    t.it('Terminals should be visible on hover, and hide on mouseleave', async t => {
        ...
        t.chain(
            ...
            { moveCursorTo : '.b-sch-event:contains(Assignment 1)', offset : ['110%', '50%'] },
