StartTest(function (t) {
  ...
  t.it('Correct events fired on valid drag/drop when dropping on task bar element', function (t) {
    t.firesOk(scheduler, {
      beforedependencycreatedrag: 1,
      dependencycreatedragstart: 1,
      dependencycreatedrop: 1,
  ...
  t.it('Correct events fired on invalid drag/drop when dropping on task bar element', function (t) {
