import { ResourceStore, EventStore, AssignmentStore, ProjectModel } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Basic assignment sanity', async t => {
        ...
        t.isDeeplyUnordered(batman.assignments, [batFight, batSneak], 'Correct assignments for second resource');

        // Not relations, but worth checking
        ...
        t.ok(assignmentStore.storage.indices.resource, 'Indexed by resource');
        // Excluded for now, see note AssignmentStoreMixin
    ...
    t.it('Relation manipulations should work', async t => {
        ...
        t.isDeeplyUnordered(batman.assignments, [batFight], 'Old resource assignments updated');
        ...
        t.is(batSneak.resource, batman, 'Third assignment updated');
        ...
        t.is(batSneak.resourceId, null, 'Assignments resourceId is null');
        ...
        t.is(superFly.resource, null, 'Assignments resource is null');
        // TODO: Is this what we want? What if resource enters store after
    ...
    t.it('Should update related entities while stores are batched', async t => {
        ...
        const event = eventStore.add({ name : 'test', startDate : new Date(2017, 0, 1, 14), duration : 1, durationUnit : 'hour' })[0];
        eventStore.endBatch();
    ...
    t.it('Removing assignment should not impact "event" relation of other assignments', async t => {
        const
            ...
            project = new ProjectModel({
                eventStore, resourceStore, assignmentStore
            });
    ...
    t.it('should remove assignments when linked records are removed', t => {
        ...
        t.it('should remove all assignments when all resources are removed', async t => {
            ...
            const
                resourceSpy   = t.spyOn(resourceStore, 'removeAll'),
    ...
    t.it('should remove events when assignments are removed', t => {
        ...
        t.it('should remove events when all assignments are removed', async t => {
            ...
            const unassigned = eventStore.add({ id : 4, name : 'Unassigned' });
        ...
        t.it('should remove events when resource is removed', async t => {
            ...
            t.is(assignmentStore.count, 0, 'Assignments removed');
            t.is(eventStore.count, 0, 'Events removed');
    ...
    t.it('Add assignment then event', async t => {
        ...
        project.assignmentStore.add({ id : 2, eventId : 2, resourceId : 1 });
        project.eventStore.add({ id : 2 });
    ...
    t.it('Data should be ready after addAsync()', async t => {
        ...
        const [assignment] = await assignmentStore.addAsync({ eventId : 1, resourceId : 2 });
    ...
    t.it('Data should be ready after loadDataAsync()', async t => {
        ...
        await assignmentStore.loadDataAsync([{ eventId : 1, resourceId : 2 }]);
    ...
    t.it('Changing resource should update resourceId', async t => {
        ...
        t.isDeeply(assignment.modifications, { resourceId : 2, id : 1 }, 'Modified');
    });
    ...
    t.it('Changing event should update eventId', async t => {
        ...
        t.isDeeply(assignment.modifications, { eventId : 3, id : 1 }, 'Modified');
    });
