import { EventModel, ProjectModel, RecurrenceModel, EventStore, ResourceStore } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('MONTHLY Record should not lose days info if the day matches event start date', t => {
        ...
        const event = new EventModel({
            id        : 'event1',
            startDate : new Date(2018, 5, 14), // TH
            endDate   : new Date(2018, 5, 15), // FR
            name      : 'Foo'
        });
        ...
        const recurrence = new RecurrenceModel({
            ...
            frequency : 'MONTHLY',
            interval  : 5,
            days      : ['TH'], // Day matches event start date
            positions : [2]
        });
