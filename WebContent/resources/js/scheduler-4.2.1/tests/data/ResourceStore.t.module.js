import { ResourceModel, ResourceStore, EventStore, ProjectModel, Model } from '../../build/scheduler.module.js';
    ...
    t.it('Resources in tree format should be re-assigned properly after reload', async t => {
        t.mockUrl('load1', {
            responseText : JSON.stringify({
                ...
                resources : {
                    rows : [
                        ...
                        },
                        {
                            ...
                            name     : 'resource2',
                            children : [
                                { id : '53', name : 'resource3' },
                                { id : '54', name : 'resource4' }
                            ],
                            expanded : true
                        }
                    ]
                ...
                events : {
                    rows : [
                        { id : '420', resourceId : '1', name : '168.00', startDate : '2011-01-04', endDate : '2011-01-05' }
                    ]
                }
            })
        });
