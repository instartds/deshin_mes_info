import { TimeAxis, DateHelper } from '../../build/scheduler.module.js';

StartTest(t => {
    const dstDates = t.getDSTDates(2018);
    // This test requires DST dates to be present!
    if (!dstDates.length) return;

    t.it('roundDate', t => {
        let dstDate, d, i;

        // Test each DST change
