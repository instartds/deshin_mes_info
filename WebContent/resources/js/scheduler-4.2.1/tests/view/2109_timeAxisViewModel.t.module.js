import { PresetManager, TimeAxis, TimeAxisViewModel } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Should get sane tickSize', t => {
        ...
        t.is(model.tickSize, 50, 'horizontal: tickSize got assigned correct value');

        //TODO: PORT porting vertical model later
        ...
        const scenarios = [
            {
                ...
                count      : 53, // jan 1 was last week 2016
                majorCount : 0
            },
            {
