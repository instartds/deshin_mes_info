import { AssignmentStore, ResourceStore, EventStore, ProjectModel, Scheduler } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    async function createScheduler(data = getDataSample()) {
