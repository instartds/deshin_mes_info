StartTest(function (t) {
  ...
  t.it('Should get sane tickSize', function (t) {
  ...
  t.it('Should get sane tickSize from getSnapPixelAmount method', function (t) {
    var ta = new TimeAxis({
      unit: 'minute',
      increment: 30,
    ...
    var model = new TimeAxisViewModel({
      snap: true,
      forceFit: false,
      timeAxis: ta,
      tickSize: 100
  ...
  t.it('getDates()', function (t) {
    ...
    scenarios.forEach(function (scenario) {
      t.it(scenario.name, function (t) {
        ...
        t.is(dates.filter(function (date) {
          return date.isMajor;
        }).length, scenario.majorCount, 'Major count correct');
      });
    });
  });
});