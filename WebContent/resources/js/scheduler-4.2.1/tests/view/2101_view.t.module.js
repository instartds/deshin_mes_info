import { EventModel, Scheduler } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Basic view functionality tests', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            eventRenderer       : ({ resourceRecord }) => resourceRecord.name,
    ...
    t.it('Multiple events per resource', async t => {
        class MyEvent extends EventModel {
            static get fields() {
                return [
                    { name : 'resourceId', dataSource : 'resId' }
                ];
            }
        }
        ...
        scheduler = await t.getSchedulerAsync({
            ...
            eventStore : {
                modelClass : MyEvent,
                data       : [
                    { id : 1, name : 'First',   startDate : '2018-05-15', endDate : '2018-05-16', resId : 'r1' },
                    { id : 2, name : 'Second', startDate : '2018-05-18', endDate : '2018-05-19', resId : 'r1' }
                ]
            }
        });
    ...
    t.it('Updating an event with mapped resourceId field should render event properly', async t => {
        ...
        scheduler = await t.getSchedulerAsync({
            ...
            eventStore : {
                modelClass : MyEvent,
                data       : [
                    { id : 1, startDate : '2018-05-17', endDate : '2018-05-18', resId : 'r1' }
                ]
            }
        });
    ...
    t.it('getCoordinateFromDate should work when scheduler is inside another DIV', async t => {
        ...
        t.is(scheduler.timeAxisViewModel.tickSize, 100);

        // local schedule coordinates
        t.is(scheduler.getCoordinateFromDate(new Date(2010, 1, 1)), 0);
        t.isApprox(scheduler.getCoordinateFromDate(new Date(2010, 1, 2)), 0.5, 100);
        t.is(scheduler.getDateFromCoordinate(100, 'round', true), new Date(2010, 1, 2));
    ...
    t.it('Should always draw at least a 1px high bar even if barMargin/rowHeight combination is misconfigured', async t => {
        ...
        t.chain(
            ...
            () => {
                ...
                t.isLessOrEqual(eventEl.getBoundingClientRect().top - foregroundEl.getBoundingClientRect().top,
                    scheduler.rowHeight / 2, 'Event is placed in the top half of the row');
            }
        );
    });
    ...
    t.it('should be able to resolve Resource from a Row element, Row child element or an Event element', async t => {
        ...
        const
            resource     = scheduler.resourceStore.getById('r1'),
    ...
    t.it('should update visibleDateRange after zoom', async t => {
        ...
        scheduler.viewPreset = {
            ...
            shiftUnit : 'day', // change one field to make timespan different
            options   : {
