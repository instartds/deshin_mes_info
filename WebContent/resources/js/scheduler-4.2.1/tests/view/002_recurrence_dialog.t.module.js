import { EventModel, RecurrenceModel, RecurrenceEditor } from '../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    function checkAvailability(t, visibleFields, enabledFields) {
        ...
        // only visible fields should be enabled by default
        enabledFields = enabledFields || visibleFields.slice();

        const { widgetMap } = dialog,
    ...
    t.xit('Check values', t => {
        ...
        t.chain(
            ...
            { type : '5', target : '>>numberfield[name=Count]' },
            ...
            { type : '2018-07-15', target : '>>datefield[name=EndDate]' },
