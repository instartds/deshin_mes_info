...
import '../../lib/Scheduler/feature/EventMenu.js';
import '../../lib/Scheduler/feature/EventEdit.js';
import '../../lib/Scheduler/feature/EventFilter.js';
import '../../lib/Scheduler/feature/GroupSummary.js';
import '../../lib/Scheduler/feature/TimeAxisHeaderMenu.js';
...
StartTest(t => {
    ...
    t.it('Vertical scheduler loaded using CrudManager should start with no error on touch devices', async t => {
        const wasTouchDevice = BrowserHelper.isTouchDevice;

        // While we do not run tests on touch devices, fake it.
