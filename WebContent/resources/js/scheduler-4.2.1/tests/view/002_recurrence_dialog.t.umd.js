StartTest(function (t) {
  var dialog, event, recurrence;
  var allFields = ['frequencyField', 'intervalField', 'daysButtonField', 'monthDaysRadioField', 'monthDaysButtonField', 'monthsButtonField', 'positionAndDayRadioField', 'positionsCombo', 'daysCombo', 'stopRecurrenceField', 'countField', 'endDateField'];
  ...
  function checkAvailability(t, visibleFields, enabledFields) {
    ...
    var _dialog = dialog,
        widgetMap = _dialog.widgetMap,
        hiddenFields = allFields.filter(function (x) {
      return !visibleFields.includes(x);
    }),
        disabledFields = allFields.filter(function (x) {
      return !enabledFields.includes(x);
    });
    t.diag('Check that fields are visible');
    visibleFields.forEach(function (field) {
      return t.ok(widgetMap[field].isVisible, "Field ".concat(field, " is visible"));
    });
    t.diag('Check that fields are enabled');
    enabledFields.forEach(function (field) {
      return t.notOk(widgetMap[field].disabled, "Field ".concat(field, " is enabled"));
    });
    t.diag('Check that fields are hidden');
    hiddenFields.forEach(function (field) {
      return t.notOk(widgetMap[field].isVisible, "Field ".concat(field, " is hidden"));
    });
    t.diag('Check that fields are disabled');
    disabledFields.forEach(function (field) {
      return t.ok(widgetMap[field].disabled, "Field ".concat(field, " is disabled"));
    });
  }

  t.it('Init dialog with default recurrence', function (t) {
    setup();
  ...
  t.it('Init dialog with Daily recurrence', function (t) {
    setup({
      recurrence: {
        frequency: 'DAILY',
        interval: 2,
  ...
  t.it('Init dialog with Weekly recurrence with no days specified', function (t) {
    setup({
      recurrence: {
        frequency: 'WEEKLY',
        interval: 3,
  ...
  t.it('Init dialog with Weekly recurrence', function (t) {
    setup({
      recurrence: {
        frequency: 'WEEKLY',
        interval: 3,
  ...
  t.it('Init dialog with Monthly recurrence', function (t) {
    setup({
      recurrence: {
        frequency: 'MONTHLY',
        interval: 4
  ...
  t.it('Init dialog with Monthly recurrence with month days specified', function (t) {
    setup({
      recurrence: {
        frequency: 'MONTHLY',
        interval: 4,
  ...
  t.it('Init dialog with Monthly recurrence with week days specified', function (t) {
    setup({
      recurrence: {
        frequency: 'MONTHLY',
        interval: 4,
  ...
  t.it('Init dialog with Weekly recurrence and check that Monthly is correct', function (t) {
    setup({
      recurrence: {
        frequency: 'WEEKLY',
        interval: 4,
  ...
  t.it('Init dialog with Yearly recurrence with no months and no week days specified', function (t) {
    setup({
      recurrence: {
        frequency: 'YEARLY',
        interval: 5
  ...
  t.it('Init dialog with Yearly recurrence with months specified', function (t) {
    setup({
      recurrence: {
        frequency: 'YEARLY',
        interval: 5,
  ...
  t.it('Init dialog with Yearly recurrence with week days specified', function (t) {
    setup({
      recurrence: {
        frequency: 'YEARLY',
        interval: 5,
