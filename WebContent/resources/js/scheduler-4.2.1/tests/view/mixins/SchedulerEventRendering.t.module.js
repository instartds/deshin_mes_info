import { Scheduler, CSSHelper, Rectangle } from '../../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('fillTicks should make all event widths multipliers of tickSize', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            endDate    : '2018-05-18',
            resources  : [
                { id : 1, name : 'Carl Lewis' },
                { id : 2, name : 'Ben Johnson' }
            ],
            events : [
                { resourceId : 1, name : '100m', startDate : '2018-05-11 15:00', duration : 10, durationUnit : 'seconds' },
                { resourceId : 1, name : 'Long jump', startDate : '2018-05-11 16:00', duration : 4, durationUnit : 'hours' },
                { resourceId : 1, name : '200m', startDate : '2018-05-13 10:00', duration : 21, durationUnit : 'seconds' },
                { resourceId : 2, name : '100m', startDate : '2018-05-11 15:00', duration : 11, durationUnit : 'seconds' }
            ],
            fillTicks : true
        });
    ...
    t.it('fillTicks should make event ending at midnight the correct size', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            events : [
                { resourceId : 1, name : '100m', startDate : '2018-05-11 00:00', duration : 1, durationUnit : 'day' }
            ],
            fillTicks : true
        });
    ...
    t.it('Event should be visible in monthAndYear preset if end date is out of scheduler timespan', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            events : [
                { resourceId : 1, name : '2 month long', startDate : '2018-05-11 15:00', duration : 2, durationUnit : 'month' }
            ]
        });
        ...
        t.isGreater(rect.left, 0, 'Left offset is positive');

        // elementIsTopElement checks center or all corners, so use elementIsTop with an offset instead
    ...
    t.it('Should handle per resource margins', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            resources : [
                { id : 1, name : 'One', resourceMargin : 10 },
                { id : 2, name : 'Two', barMargin : 10 },
                { id : 3, name : 'Three', resourceMargin : 10, barMargin : 10 },
                { id : 4, name : 'Four' }
            ],

            events : [
                { id : 1, name : 'One', startDate : '2020-12-02', endDate : '2020-12-03' },
                { id : 2, name : 'Two', startDate : '2020-12-02', endDate : '2020-12-03' }
            ],

            assignments : [
                { id : 'r1e1', eventId : 1, resourceId : 1 },
                { id : 'r1e2', eventId : 2, resourceId : 1 },
                { id : 'r2e1', eventId : 1, resourceId : 2 },
                { id : 'r2e2', eventId : 2, resourceId : 2 },
                { id : 'r3e1', eventId : 1, resourceId : 3 },
                { id : 'r3e2', eventId : 2, resourceId : 3 },
                { id : 'r4e1', eventId : 1, resourceId : 4 },
                { id : 'r4e2', eventId : 2, resourceId : 4 }
            ]
        });

        function assertTop(assignmentId, top) {
            const
                assignment = scheduler.assignmentStore.getById(assignmentId),
    ...
    t.it('Should handle per resource rowHeight, from data', async t => {
        ...
        async function createScheduler(config) {
            scheduler = await t.getSchedulerAsync(Object.assign({
                ...
                resources : [
                    { id : 1, name : 'One' },
                    { id : 2, name : 'Two', rowHeight : 105 },
                    { id : 3, name : 'Three', rowHeight : 35 }
                ],

                events : [
                    { id : 1, name : 'One', startDate : '2020-12-02', endDate : '2020-12-03' },
                    { id : 2, name : 'Two', startDate : '2020-12-02', endDate : '2020-12-03' },
                    { id : 3, name : 'Three', startDate : '2020-12-02', endDate : '2020-12-03' }
                ],
                ...
                assignments : [
                    ...
                    { id : 'r3e1', eventId : 1, resourceId : 3 },
                    { id : 'r3e2', eventId : 2, resourceId : 3 },
                    { id : 'r3e3', eventId : 3, resourceId : 3 }
                ]
            }, config));
        }
    ...
    t.it('Should handle per resource eventLayout', async t => {
        scheduler = await t.getSchedulerAsync({
            ...
            resources : [
                { id : 1, name : 'One', eventLayout : 'stack' },
                { id : 2, name : 'Two', eventLayout : 'pack' },
                { id : 3, name : 'Three', eventLayout : 'none' }
            ],
