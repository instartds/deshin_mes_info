import { Scheduler, AssignmentStore, EventStore, ResourceStore } from '../../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Should repaint each affected resource just once after eventStore#commit', async t => {
        scheduler = new Scheduler({
            ...
            events : [
                { id : 1, resourceId : 1, startDate : '2018-01-01', duration : 1 },
                { id : 2, resourceId : 1, startDate : '2018-02-01', duration : 1 }
            ]
        });
    ...
    t.it('Should always have an AssignmentStore', async t => {
        ...
        function assert(t) {
            ...
            const
                [firstAssignment, lastAssignment] = scheduler.assignmentStore,
        ...
        t.it('When using inline data with resourceId', async t => {
            await create({
                ...
                events : [
                    { id : 1, resourceId : 1, startDate : '2019-12-13', duration : 4 },
                    { id : 2, resourceId : 1, startDate : '2019-12-13', duration : 1 }
                ]
            });
        ...
        t.it('When using inline data with assignments', async t => {
            await create({
                ...
                events : [
                    { id : 1, startDate : '2019-12-13', duration : 4 },
                    { id : 2, startDate : '2019-12-13', duration : 1 }
                ],

                assignments : [
                    { eventId : 1, resourceId : 1 },
                    { eventId : 2, resourceId : 1 }
                ]
            });
