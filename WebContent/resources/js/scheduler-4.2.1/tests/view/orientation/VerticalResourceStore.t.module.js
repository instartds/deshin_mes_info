import { ResourceStore, Rectangle } from '../../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('CRUD - Update', async t => {
        ...
        scheduler.scrollResourceIntoView(resourceStore.last);
    ...
    t.it('CRUD - Replace', async t => {
        await t.firesOk({
            ...
            async during() {
                resourceStore.add({ id : 'r1', name : 'Replaced' });
                await scheduler.project.commitAsync();
            }
        });
    ...
    t.it('CRUD - Changing id', async t => {
        ...
        t.selectorExists('.b-resourceheader-cell[data-resource-id="r5000"]:contains(Resource 1)', 'Header updated');

        // Should be gone
        assertEventElement(t, 1, 'r1');
        assertEventElement(t, 2, 'r1');
        // Should instead find
    ...
    t.it('Filtering', async t => {
        ...
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 1, // Event on r4 moves to the left when r3 hides
        ...
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 2, // Event on r4 moves to the right when r3 is shown + event on r3
                releaseEvent : 0
            },
            async during() {
    ...
    t.it('Sorting', async t => {
        ...
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 4, // r3 is unaffected by the sort, thus not 5
                releaseEvent : 0
            },
            async during() {
