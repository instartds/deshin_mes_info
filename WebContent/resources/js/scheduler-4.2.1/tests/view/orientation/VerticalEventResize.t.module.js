...
StartTest(t => {
    ...
    t.it('Should display resize handles on hover', t => {
        ...
        t.chain(
            ...
            { moveMouseTo : '.b-sch-event', offset : ['50%', 3] },
            ...
            { drag : '.b-sch-event', offset : ['50%', 3], by : [0, -20], dragOnly : true },
    ...
    t.it('Basic resize', t => {
        t.chain(
            { drag : '[data-event-id="1"]', offset : ['50%', '100%-3'], by : [0, 100], desc : 'Dragging bottom edge down' },
            ...
            { moveMouseBy : [0, 20] }, // It misses the handle otherwise

            { drag : '[data-event-id="1"]', offset : ['50%', '100%-3'], by : [0, -150], desc : 'Dragging bottom edge up' },
            ...
            { drag : '[data-event-id="2"]', offset : [10, 3], by : [0, -50], desc : 'Dragging top edge up' },
    ...
    t.it('Should not start drag operation', async t => {
        ...
        t.chain(
            { drag : '.b-sch-event', offset : ['50%', '100%-3'], by : [0, 50], desc : 'Dragging bottom edge down' }
        );
    });
});
