...
StartTest(t => {
    ...
    t.it('Complex scenario', async t => {
        await getScheduler({
            eventStyle : 'border',
            events     : [
                { id : 1, name : 'Event 1', resourceId : 'r1', startDate : new Date(2019, 4, 27), duration : 8 },
                { id : 2, name : 'Event 2', resourceId : 'r1', startDate : new Date(2019, 4, 28), duration : 9 },
                { id : 3, name : 'Event 3', resourceId : 'r1', startDate : new Date(2019, 4, 29), duration : 5 },
                { id : 4, name : 'Event 4', resourceId : 'r1', startDate : new Date(2019, 5, 3), duration : 7 }
            ]
        });
    ...
    t.it('Should adjust canvas height when suppressing fit and not filling height', async t => {
        await getScheduler({
            startDate   : new Date(2019, 4, 28, 7), // 3 ticks
