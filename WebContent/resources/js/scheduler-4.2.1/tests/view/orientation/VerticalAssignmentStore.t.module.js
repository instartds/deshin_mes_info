import { AssignmentStore, Rectangle } from '../../../build/scheduler.module.js';
...
StartTest(t => {
    ...
    t.it('Resolves element <-> record', t => {
        const
            element = document.querySelector('.b-sch-event-wrap .b-sch-event'),
        ...
        const
            eventElement = scheduler.getElementFromEventRecord(eventRecord, resourceRecord),
    ...
    t.it('CRUD - Remove', async t => {
        ...
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 2, // Affects layout of event 2 & 3 also
                releaseEvent : 1
            },
            async during() {
        ...
        assertEventElement(t, { resourceId : 'r1', eventId : 1 });
        ...
        assertEventElement(t, { resourceId : 9, eventId : 1 });
    });
    ...
    t.it('CRUD - Update', async t => {
        ...
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 4, // Event 2 & 3 from old location, 4 & self from new
                releaseEvent : 0
            },
            async during() {
        ...
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 2, // Event 4 from old location, self in new
                releaseEvent : 0
            },
            async during() {
        ...
        assertEventElement(t, { resourceId : 'r1', eventId : 5 });
    ...
    t.it('CRUD - Replace', async t => {
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 3, // Event 2 & 3 from old location, self in new
                releaseEvent : 0
            },
            async during() {
                assignmentStore.add({ id : 'a1', eventId : 5, resourceId : 'r2' });
                await t.waitForProjectReady();
            }
        });
    ...
    t.it('Filtering', t => {
        ...
        t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 1, // r4 moves to the left
                releaseEvent : 2
            },
            during() {
