...
Value of [TimeRanges](#Scheduler/feature/TimeRanges) feature  [store](#Scheduler/feature/TimeRanges#config-store) config
is no longer passed to Crud Manager instance.
