...
export default class Rectangle {
    ...
    static from(element, relativeTo, ignorePageScroll) {
        ...
        // scaleX/Y is required to adjust scaled SVG element bounding rect
    ...
    alignTo(spec) {
        ...
        if (constrainTo && !(constrainTo instanceof Rectangle)) {
            ...
            if (constrainPadding) {
                ...
                constrainTo.deflate.apply(constrainTo, constrainPadding);
            }
        }
        const me                  = this,
    ...
    show(duration = 5000) {
        ...
        const relativeTo = duration instanceof Rectangle ? duration : (duration.nodeType === Element.ELEMENT_NODE ? Rectangle.from(duration) : null);
        if (relativeTo) {
