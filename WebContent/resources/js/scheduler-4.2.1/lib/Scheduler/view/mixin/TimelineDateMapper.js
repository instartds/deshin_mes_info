...
export default Target => class TimelineDateMapper extends (Target || Base) {
    ...
    get viewportCenterDate() {
        const
            me                         = this,
            { isHorizontal, timeAxis } = me,
            { scrollable }             = isHorizontal ? me.timeAxisSubGrid : me,
        ...
        if (timeAxis.isContinuous) {
            ...
            const
                scrollCenter = isHorizontal ? (centerX / scrollable.scrollWidth) : (centerY / scrollable.scrollHeight),
