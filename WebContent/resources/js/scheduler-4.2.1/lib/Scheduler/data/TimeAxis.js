...
export default class TimeAxis extends Store {
    ...
    internalOnReconfigure(preventThrow = false) {
        ...
        const checkEnd = me.last.endDate;
        ...
        do {
            // TODO this has to use more sophisticated formula to take into account that months for example can be expressed in ms consistently
    ...
    roundDate(date, relativeTo, resolutionUnit = this.resolutionUnit, increment = this.resolutionIncrement || 1) {
        ...
        switch (resolutionUnit) {
            ...
            default:
                ...
                return DH.add(relativeTo, snappedDuration - offset, resolutionUnit);
        }
    }
    ...
    getTickFromDate(date) {
        ...
        if (me.isContinuous) {
            ...
            tick = ticks[begin];
            tickStart = tick.startDate.getTime();
