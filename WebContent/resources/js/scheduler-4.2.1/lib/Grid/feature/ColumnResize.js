...
export default class ColumnResize extends InstancePlugin {
    ...
    onResizeStart({ context }) {
        const
            ...
            { scrollable }    = grid.subGrids[column.region];

        resizer.minWidth = column.minWidth;

        // Fix scroll width of the scrollable so that narrowing columns does not change scroll width
        // eslint-disable-next-line no-self-assign
        scrollable.scrollWidth = scrollable.scrollWidth;
