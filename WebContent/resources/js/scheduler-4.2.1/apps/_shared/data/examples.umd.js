...
/* </remove-on-trial> */
{
  ...
  folder: 'extjsmodern',
  group: 'Integration',
  title: 'ExtJS Modern App integration demo',
  overlay: 'extjs',
  version: 'ExtJS 6.5.3',
  updated: '4.2'
}, {
  ...
  folder: 'salesforce',
  group: 'Integration',
  title: 'Integrate with Salesforce Lightning (offline)',
  offline: true
}, {
  folder: 'scripttag',
  group: 'Integration',
...
{
  folder: 'frameworks/custom-build',
  group: 'Integration',
...
}, // Integration/Angular
{
  ...
  title: 'Angular Routing + NgRx demo',
  overlay: 'angular',
  version: 'Angular 8',
  build: true,
  since: '2.0'
}, {
  folder: 'frameworks/angular/angular-1',
  group: 'Integration/Angular',
  title: 'Angular 1 demo',
  overlay: 'angular',
  version: 'Angular 1',
  build: true
}, {
  ...
  folder: 'frameworks/angular/angular-2',
  group: 'Integration/Angular',
  ...
  folder: 'frameworks/angular/angular-4',
  group: 'Integration/Angular',
  ...
  folder: 'frameworks/angular/angular-5',
  group: 'Integration/Angular',
  ...
  folder: 'frameworks/angular/angular-6',
  group: 'Integration/Angular',
  title: 'Angular 6 demo',
  overlay: 'angular',
  version: 'Angular 6',
  build: true
}, {
  ...
  group: 'Integration/Angular',
  title: 'Angular 7 demo',
  overlay: 'angular',
  version: 'Angular 7',
  build: true
}, {
  folder: 'frameworks/angular/angular-8',
  group: 'Integration/Angular',
  ...
  group: 'Integration/Angular',
  title: 'Angular Custom Event Editor demo',
  overlay: 'angular',
  version: 'Angular 8',
  build: true,
  since: '2.2.5'
  ...
  group: 'Integration/Angular',
  title: 'Angular Dependencies demo',
  overlay: 'angular',
  version: 'Angular 8',
  build: true,
  since: '2.0',
  ...
  group: 'Integration/Angular',
  title: 'Angular Drag between Schedulers',
  overlay: 'angular',
  version: 'Angular 8',
  build: true,
  since: '2.0',
  ...
  group: 'Integration/Angular',
  title: 'Angular Drag Tasks from Grid',
  overlay: 'angular',
  version: 'Angular 8',
  build: true,
  since: '2.0',
  ...
  group: 'Integration/Angular',
  title: 'Angular Drop Equipment onto Tasks',
  overlay: 'angular',
  version: 'Angular 8',
  build: true,
  since: '2.0'
  ...
  group: 'Integration/Angular',
  title: 'Angular PDF export demo (offline)',
  overlay: 'angular',
  version: 'Angular 8',
  build: true,
  since: '3.0',
  ...
  group: 'Integration/Angular',
  title: 'Angular Recurring Events Demo',
  overlay: 'angular',
  version: 'Angular 9',
  build: true,
  since: '3.1'
...
}, // Integration/Ionic
{
  ...
  folder: 'frameworks/ionic/themes',
  group: 'Integration/Ionic',
  title: 'Themes with Ionic',
  build: true,
  overlay: 'ionic',
  version: 'Ionic 4',
  since: '3.0'
}, // Integration/React
{
  ...
  title: 'React + Redux advanced demo',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '2.0'
  ...
  group: 'Integration/React',
  title: 'React Custom Event Editor demo',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '2.2'
  ...
  group: 'Integration/React',
  title: 'React Drag between Schedulers demo',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '2.0'
}, {
  folder: 'frameworks/react/javascript/drag-from-grid',
  group: 'Integration/React',
  ...
  group: 'Integration/React',
  title: 'React Drag onto Tasks demo',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '2.0'
  ...
  group: 'Integration/React',
  title: 'React PDF export demo (offline)',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '3.0',
  ...
  folder: 'frameworks/react/javascript/vertical',
  group: 'Integration/React',
  title: 'React Vertical mode demo',
  overlay: 'react',
  version: 'React 17',
  build: true,
  since: '4.1'
  ...
  group: 'Integration/React',
  title: 'React + TypeScript filtering demo',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '2.2'
  ...
  group: 'Integration/React',
  title: 'React + TypeScript Recurring Events demo',
  overlay: 'react',
  version: 'React 16',
  build: true,
  since: '3.1'
}, // Integration/Vue
{
  ...
  folder: 'frameworks/vue/javascript/custom-event-editor',
  group: 'Integration/Vue',
  ...
  group: 'Integration/Vue',
  title: 'Vue Drag between Schedulers demo',
  overlay: 'vue',
  version: 'Vue 2',
  build: true,
  since: '2.0.4'
}, {
  folder: 'frameworks/vue/javascript/drag-from-grid',
  group: 'Integration/Vue',
  title: 'Vue Drag Tasks from grid demo',
  overlay: 'vue',
  version: 'Vue 2',
  build: true,
  since: '2.0.4',
  ...
  group: 'Integration/Vue',
  title: 'Vue Cell Renderer Demo',
  overlay: 'vue',
  version: 'Vue 2',
  build: true,
  since: '4.1'
}, {
  folder: 'frameworks/vue/javascript/vuestic',
  group: 'Integration/Vue',
  title: 'Vue Integrate Vuestic Admin demo',
  overlay: 'vue',
  version: 'Vue 2',
  build: true,
  since: '2.0'
...
window.examples = window.examples.filter(function (e) {
  return e[window._isIE11 ? 'ie' : window._isEdge ? 'edge' : null] !== false;
});