...
class Shared extends Localizable(Events()) {
    ...
    insertHeader() {
        ...
        Object.assign(this, { fullscreenButton,  infoButton });
    ...
    loadHints() {
        ...
        AjaxHelper.get('/resources/js/scheduler-4.2.1/apps/meta/hints.json', { parseJson : true }).then(response => {
    ...
    loadDescription() {
        const
            ...
            url    = siteUrl + '/resources/js/scheduler-4.2.1/apps/app.config.json';
