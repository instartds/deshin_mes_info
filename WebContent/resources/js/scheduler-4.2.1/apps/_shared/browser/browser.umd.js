...
var ExamplesApp = /*#__PURE__*/function () {
  function ExamplesApp() {
    ...
    var version = VersionHelper.getVersion(me.product.name),
      ...
      return "bryntum-".concat(me.product.name, "-demo-").concat(name);
    },
    ...
    document.getElementById('title').innerHTML = "".concat(me.product.fullName, " ").concat(version);
    GlobalEvents.on({
    ...
    var toolbar = new Toolbar({
      ...
      items: {
        ...
        upgradeButton: {
          ...
          text: 'Upgrade guide',
          icon: 'b-fa-book',
          href: me.isOnline ? "/docs/".concat(me.product.onlineDocsId, "#upgrade-guide") : '../docs#upgrade-guide'
        },
        docsButton: {
          id: 'docs-button',
          type: 'button',
          text: 'Documentation',
          icon: 'b-fa-book-open',
          href: me.isOnline ? "/docs/".concat(me.product.onlineDocsId) : '../docs'
        },
          ...
          configs.push({
            ...
            children: [{
              ...
              children: [{
                ...
                className: "overlay ".concat(example.overlay)
