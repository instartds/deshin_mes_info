import { BrowserHelper, Popup, DomHelper, Toast } from '../../../../build/scheduler.module.js';
        ...
        return {
            ...
            items : [
                ...
                },
                {
                    ...
                    items    : [
                        { id : 'calendar', downloadId : 'calendar-vanilla', text : 'Bryntum Calendar' }, // no-sanity
                        { id : 'gantt', downloadId : 'gantt-vanilla', text : 'Bryntum Gantt' }, // no-sanity
                        { id : 'grid', downloadId : 'grid', text : 'Bryntum Grid' }, // no-sanity
                        { id : 'scheduler', downloadId : 'scheduler-vanilla', text : 'Bryntum Scheduler' }, // no-sanity
                        { id : 'schedulerpro', downloadId : 'schedulerpro', text : 'Bryntum Scheduler Pro' }, // no-sanity
                        { id : 'taskboard', downloadId : 'taskboard-vanilla', text : 'Bryntum TaskBoard' } // no-sanity
                    ],
                    required : true
                },
                {
