...
var userAgentMatch = navigator.userAgent.match(/Edge?\/(\d+)\./),
...
if (!/index\.umd\.html/.test(document.location.href)) {
  var moduleSupport = ('noModule' in HTMLScriptElement.prototype);
...
if (window.isDemoBrowser) {
  ...
  var theme = localStorage.getItem('b-example-theme'),
