...
//        return "withCredentials" in i ? (i.open(e, n, !0),i.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8')) : "undefined" != typeof XDomainRequest ? (i = new XDomainRequest, i.open(e, n),i.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8')) : i = null, i
    ...
    return "https:" === location.protocol && (s = "https://localhost:9101/"), t.Device = function (t) {
        var s = this;
        this.name = t.name, this.deviceType = t.deviceType, this.connection = t.connection, this.uid = t.uid, this.version = r, this.provider = t.provider, this.manufacturer = t.manufacturer, this.sendErrorCallback = function (e) {}, this.sendFinishedCallback = function (e) {}, 
        this.send = function (t, r, o) {
