...
class SetDefault():
    ...
    NOT_NEW_TASK = 20   # 다음 작업 최소 준비시간  ( DB 에 없을 경우 사용 )
        ...
        for ii in range(len(order_df)):   ## 오더 제품 전체
            ...
            sql = "SELECT equ_code FROM PBS410T WHERE COMP_CODE = '{}' AND DIV_CODE = '{}' " \
                ...
                .format(base.comp_code, base.div_code, base.work_shop_code, base.prog_work_code,
                        base.schedule_num, base.comp_code, base.div_code, base.work_shop_code, base.prog_work_code,
                        item_code)
                    ...
                    for k in range(len(row)):
                        ...
                        for jj in range(len(fac_list)):
                            if fac_list.iloc[jj]['EQU_CODE'] == found_fac:
                                ...
                                if base.DEBUG :
                                    print(
                                        f"found fix 0 : {item_code} : [{found_fac}] [{ii + 1}] [{jj + 1}]  ")
            except:
                pass
        return fix_prod_0
        ...
        if batch_prodt_yn == 'Y':
            ...
            for ii in range(len(daily_plan)):
                ...
                while remain_qty > 0 :
                    ...
                    if remain_plan_time <= base.NOT_NEW_TASK  :
