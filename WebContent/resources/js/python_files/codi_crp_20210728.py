...
class CODI_LP():
    ...
    def get_fac_basecapa_list(self,ms_con):
        ...
        if ms_con:
            ...
            sql = "SELECT DISTINCT WORK_SHOP_CODE, EQU_CODE , STD_MEN, NET_CT_S, ACT_SET_M, ACT_OUT_M , STD_PRODT_Q as ONE_CAPA FROM PBS410T "\
                  "WHERE COMP_CODE = '{}' AND DIV_CODE = '{}' AND WORK_SHOP_CODE = '{}' " \
        ...
        if batch_prodt_yn == 'Y':
            ...
            for ii in range(len(daily_plan)):
                ...
                if ii == 0:  # 처음 시작은 무조건 다른 제품
                    ...
                    setup_time = daily_plan.iloc[ii]['act_set_m']
                else:
                ...
                plan_list = [base.comp_code, base.div_code, plan_no, order_no,order_seq, base.work_shop_code,
                             ...
                             end_date, end_time, plan_time, cycle_time,setup_time,clean_time, work_men, 'P']
            ...
            for ii in range(len(daily_plan)):
                ...
                while remain_qty > 0 :
                    ...
                    remain_plan_time = work_time - use_time - clean_time

                    if base.DEBUG :
                        print(f" Time : [{equ_code}] [{item_code}] [{start_day}]  [{work_time}] [{setup_time}]  [{clean_time}] [{remain_plan_time}] [{use_time}]")
                    ...
                    plan_list = [base.comp_code, base.div_code, plan_no, order_no, order_seq, base.work_shop_code,
                                 ...
                                 start_day, end_plan_time, plan_time, cycle_time, setup_time,clean_time,work_men, 'P']
                ...
                if assign_ratio > 0.0:  # 제품별 ( 한 제품이 두 번 나올수 있음 )  최대값은 1 ( 한 제품 한 설비 ) 1보다 작으면 한 설비 이상에 할당된다.
                    ...
                    if batch_prodt_yn =='Y':   # 제조 공정
                        ...
                        for pc in range(product_count):  # 설비 1회 가동시마다 계산
                            ...
                            plan_list = [base.comp_code, base.div_code, plan_no , order_no ,order_seq,base.work_shop_code ,
                                         base.prog_work_code, equ_code, base.aps_key ,item_code ,order_amount,
                                             ...
                                             base.base_start_day,0,plan_time, cycle_time,act_set_m,act_out_m, work_men,'P' ]
                            # print( plan_list )
                        ...
                        plan_list = [base.comp_code, base.div_code, plan_no, order_no, order_seq,
                                     ...
                                     cycle_time, act_set_m,act_out_m,work_men, 'P']
                        # print( plan_list )
