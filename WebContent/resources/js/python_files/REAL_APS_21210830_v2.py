...
class SetDefault():
    ...
    def __init__(self,aps_key, comp_code, div_code, work_shop_code, prog_work_code,
                        split_type ,validate, schedule_num,base_start_day,remaining_time,
...
class CODI_LP():
    ...
    def get_tomorrow_capa(self, ms_con, start_day, equ_code):
        ...
        if ms_con:
            ...
            sql = "SELECT WORK_DATE , (CASE WHEN OVER_TIME_YN = 'N' THEN STD_CAPA_TIME ELSE STD_CAPA_TIME + OVER_CAPA_TIME END) " \
                  ...
                  "and STD_CAPA_TIME + OVER_CAPA_TIME > 10 "\
    ...
    def get_cal_start_day(self, ms_con, equ_code, start_day):
        ...
        if ms_con:
            ...
            sql = "select work_date , " \
                  ...
                  "and equ_code = '{}' and work_type ='2' and std_capa_time + over_capa_time > 10  ". \
    ...
    def run_aps(self):
        ...
        if base.DEBUG :
            ...
            print(f"6.split_type = {base.split_type}")
            print(f"7.validate = {base.validate}")
            print(f"8.schedule_num = {base.schedule_num}")
            print(f"9.base_start_day = {base.base_start_day}")
            print(f"10.remaining_time = {base.remaining_time}")
            print(f"11.debug = {base.debug}")
            print(f"12.order_num = {base.order_num}")
...
if __name__ == "__main__":
    ...
    order_num = sys.argv[12]  # t_ppl100t   order_num
    order_seq = sys.argv[13]  # t_ppl100t   order_seq
