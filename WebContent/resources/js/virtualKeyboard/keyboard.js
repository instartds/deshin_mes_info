...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "한국어";  // Default keyboard layout
  this.VKI_langAdapt = false;  // Use lang attribute of input to select keyboard
  this.VKI_size = 7;  // Default keyboard size (1-5)
    ...
    var tr = document.createElement('tr');
      var th = document.createElement('th');
        ...
        this.VKI_kbsize = function(e) {
          self.VKI_size = Math.min(7, Math.max(1, self.VKI_size));
            ...
            for (var y = 0, lkey; lkey = lyt[y++];) {
              var td = document.createElement('td');
                ...
                switch (lkey[1]) {
                  ...
                  case ".":
                /*	  self.VKI_target.focus();
                	  var targetValue = self.VKI_target.value;
