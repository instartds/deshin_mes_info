...
Ext.define('Unilite.com.tab.UniTabScrollerMenu', {
    ...
    text: {
    	closeAllTabs: UniUtils.getLabel('system.label.commonJS.tab.closeAllTabs','모든창 닫기'),//'Close All Tabs',
    	closeOthersTabs:UniUtils.getLabel('system.label.commonJS.tab.closeOthersTabs','비활성창 닫기')// 'Close Other Tabs'
    },
