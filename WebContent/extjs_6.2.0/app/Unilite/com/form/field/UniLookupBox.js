...
Ext.define('Unilite.com.form.field.UniLookupBox', {
    ...
    //listConfig: {
        ...
        maxHeight: 300,
        shadow: 'sides',
		loadingText : UniUtils.getMessage('system.message.commonJS.lookupbox.loadingText','조회중...'),
		emptyText : UniUtils.getMessage('system.message.commonJS.lookupbox.emptyText','조회된 결과가 없습니다.'),
	...
	fieldSubTpl: [
        ...
        '<td width="100"><input type="text" name="{valueField}" class="{fieldCls} {typeCls} {typeCls}-{ui} {editableCls}"  style="width: 100%;" readonly="true" /></td>',
        '<td><input id="{id}" type="{type}" {inputAttrTpl} class="{fieldCls} {typeCls} {typeCls}-{ui} {editableCls}" autocomplete="off"',
