...
//        			this.childCombo.store.filter("X","Y");
    			UniUtils.msg(UniUtils.getLabel('system.label.commonJS.tagfield.btnClose','확인'),UniUtils.getMessage('system.message.commonJS.tagfield.invalidText','상위 분류값을 먼저 선택해 주세요.'));
    			return false;
    		}
        }        	
    },			
