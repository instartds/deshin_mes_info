...
Ext.define('Unilite.com.form.field.UniNumberField', {
    ...
    */
    ...
    uniType: null,
    blankText:UniUtils.getMessage('system.message.commonJS.numberfield.blankText','값을 입력하세요.'),
	/**
	 *  
	...
	initComponent: function() {  
		if(this.type && UniFormat)	{
			var typeString = UniFormat[this.type.replace('uni', '')];
			if(typeString)	{
				var deP = typeString.indexOf('.') > -1 ? typeString.length-1 - typeString.indexOf('.') : 0;
				this.decimalPrecision = deP;
				if(this.maxLength == null) {
					this.maxLength = deP==0? 39:46;
				}
				if(this.enforceMaxLength == null) {
					this.enforceMaxLength= deP==0? 39:46;
				}
			}
		}
