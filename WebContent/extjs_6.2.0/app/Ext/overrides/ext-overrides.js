...
Ext.define('Ext.overrides.picker.Date', {
    ...
    renderTpl: [
    	'<div id="{id}-innerEl" data-ref="innerEl" role="presentation">',
            ...
            '</table>',
            '<tpl if="showToday">',
                '<div id="{id}-footerEl" data-ref="footerEl" role="presentation" class="{baseCls}-footer">{%this.renderYesterdayBtn(values, out)%}{%this.renderTodayBtn(values, out)%}{%this.renderTomorrowBtn(values, out)%}</div>',
            '</tpl>',
        ...
        '</div>',
        {
            ...
            renderTomorrowBtn: function(values, out) {
                Ext.DomHelper.generateMarkup(values.$comp.tomorrowBtn.getRenderTree(), out);
            }
        }
    ],
    
    yesterdayTip: '{0} (Spacebar)',
    tomorrowTip: '{0} (Spacebar)',
    ...
    beforeRender: function() {
        ...
        var me = this,
			...
			tomorrow = Ext.Date.format(Ext.Date.add(new Date(),  Ext.Date.DAY, 1), me.format);
        ...
        if (me.showToday) {
            ...
            me.tomorrowBtn = new Ext.button.Button({
            	ui: me.footerButtonUI,
                ownerCt: me,
                ownerLayout: me.getComponentLayout(),
                text: Ext.String.format(me.tomorrowText, tomorrow),
                tooltip: Ext.String.format(me.tomorrowTip, tomorrow),
                tooltipType: 'title',
                tabIndex: -1,
                ariaRole: 'presentation',
                handler: me.selectTomorrow,
                scope: me
            });
        ...
        Ext.apply(me.renderData, {
            ...
            yesterdayText: encode(me.todayText),
            tomorrowText: encode(me.tomorrowText),
    ...
    fullUpdate: function(date) {
        var me = this,
            ...
            tomorrow = +eDate.clearTime(Ext.Date.add(new Date(),  Ext.Date.DAY, 1)),
        ...
        if (me.showToday) {
            ...
            if (!me.disabled) {
                ...
                me.tomorrowBtn.setDisabled(disableToday);
            }
        }
    ...
    beforeDestroy: function() {
     ...
     _onAfterRender:function(cmp)	{
     	...
     	if(Ext.isDefined(cmp.tomorrowBtn) && Ext.isFunction(cmp.tomorrowBtn.finishRender()) ) {
        	cmp.tomorrowBtn.finishRender();
		} 
     }
});
