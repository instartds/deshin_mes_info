...
<%
//다국어코드 등록(디비에러단어)
request.setAttribute("PKGNAME","Unilite_app_bsa010ukrv");
%>
<t:appConfig pgmId="bsa010ukrv" >
</t:appConfig>
<script type="text/javascript">
function appMain() {
		Unilite.defineModel('${PKGNAME}MasterModel', {
			fields : [ {name : 'MSG_NO',		text : '구분',		type : 'string',	allowBlank:false}				 				 
		...
		var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
			api: {
				read : 	 'bsa010ukrvService.selectList',
				create : 'bsa010ukrvService.insert',
				update : 'bsa010ukrvService.update',
				destroy: 'bsa010ukrvService.delete',
				syncAll: 'bsa010ukrvService.saveAll'
			}
		});
		...
		var directMasterStore = Unilite.createStore('${PKGNAME}MasterStore', { 
			...
			loadStoreRecords : function()	{
				var param= Ext.getCmp('bsa010ukrvSearchForm').getValues();	
				this.load({
					params : param
				});
			},
		...
		var masterGrid = Unilite.createGrid('${PKGNAME}Grid', {
			...
			columns : [   {dataIndex : 'MSG_NO',			width : 80		}					
						, {dataIndex : 'MSG_DESC',			width : 150		}
						, {dataIndex : 'MSG_DESC_EN',		width : 150		}
						, {dataIndex : 'MSG_DESC_CN',		width : 150		}
						, {dataIndex : 'MSG_DESC_JP',		width : 150		}		
						, {dataIndex : 'MSG_DESC_VI',		width : 150		}	
					],
			listeners: {          	
  ...
  var panelSearch = Unilite.createSearchForm('bsa010ukrvSearchForm',{
		weight:-100,
    	region: 'north',
