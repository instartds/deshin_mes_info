...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<t:appConfig pgmId="s_qms500skrv_mek">
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read	: 's_qms500skrv_mekService.selectList'
		}
	});
	 ...
	 * master grid1 Model
	 */
	Unilite.defineModel('s_qms500skrv_mekModel', {
		fields: [
	 ...
	 * master grid1 store
	 */
	var directMasterStore = Unilite.createStore('s_qms500skrv_mekMasterStore', {
		model : 's_qms500skrv_mekModel',
		uniOpt: {
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('s_qms500skrv_mekGrid', {
		layout	: 'fit',
		region	:'center',
	...
	});//End of var masterGrid = Unilite.createGrid('s_qms500skrv_mekGrid', {
