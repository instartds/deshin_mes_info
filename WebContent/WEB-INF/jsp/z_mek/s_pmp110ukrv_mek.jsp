...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read	: 's_pmp110ukrv_mekService.selectList',
			create	: 's_pmp110ukrv_mekService.updateList',
			syncAll	: 's_pmp110ukrv_mekService.saveAll'
		}
	});

	Unilite.defineModel('s_pmp110ukrv_mekModel', {
		fields: [
	...
	var masterStore = Unilite.createStore('s_pmp110ukrv_mekMasterStore',{
		model	: 's_pmp110ukrv_mekModel',
		proxy	: directProxy,
		autoLoad: false,
		uniOpt	: {
	...
	var masterGrid = Unilite.createGrid('s_pmp110ukrv_mekGrid', {
		store	: masterStore,
		region	: 'center',
		tbar    : [{
			xtype : 'button',
			...
			handler: function()	{
				...
				if(!excelWindow) {
					Unilite.Excel.defineModel('excel.s_pmp110ukrv_mek.sheet01', {
						fields: [
					...
					excelWindow = Ext.create( appName, {
						excelConfigName: 's_pmp110ukrv_mek',
						modal: false,
						extParam: {
						...
						grids: [{
							...
							title		: '생산마감업로드',
							useCheckbox	: true,
							model		: 'excel.s_pmp110ukrv_mek.sheet01',
							readApi		: 's_pmp110ukrv_mekService.selectExcelUploadSheet1',
							columns		: [
	...
	Unilite.defineModel('productionNoMasterModel', {
		fields: [
			...
			{name: 'REWORK_TYPE'		, text: '<t:message code="system.label.product.reworkordertype" default="재작업유형"/>'			, type: 'string' , comboType: 'AU' , comboCode:'P204'},
	...
	var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_pmp110ukrv_mekService.selectWorkNum'
		}
	});
	...
	var productionNoMasterGrid = Unilite.createGrid('pmp110ukrvproductionNoMasterGrid', {
		...
		columns: [
			...
			{ dataIndex: 'REWORK_TYPE'		, width: 133 }
		],
		listeners: {
		...
		returnData: function(record) {
			...
			panelResult.setValues({
				...
				'REWORK_TYPE'	: record.get('REWORK_TYPE'),		//	재작업유형
			...
			panelResult.getField('REWORK_TYPE').setReadOnly( true );
	...
	Unilite.Main({
		...
		onDeleteAllButtonDown : function()	{
			if(confirm('삭제 하시겠습니까?')) {
				...
				s_pmp110ukrv_mekService.deleteAll(
					{
						DIV_CODE : divCode,
						WKORD_NUM : wkordNum
					},
		...
		onResetButtonDown: function() {
			...
			panelResult.getField('REWORK_TYPE').setReadOnly( false );
