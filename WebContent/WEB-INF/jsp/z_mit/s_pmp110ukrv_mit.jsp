...
<t:appConfig pgmId="s_pmp110ukrv_mit">
	<t:ExtComboStore comboType="BOR120" pgmId="s_pmp110ukrv_mit" />			<!-- 사업장 -->
				...
				listeners: {
					blur: function(field, The, eOpts){
						if(!Ext.isEmpty(panelResult.getValue('ITEM_CODE'))){
							...
							alert('<t:message code="system.message.product.message064" default="작업지시를 할 품목을 입력해주세요."/>');
						}
					},
					change: function(field, newValue, oldValue, eOpts) {
						var store = detailGrid.getStore();
