...
<t:appConfig pgmId="s_agc700skr_mit"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_agc700skr_mit"/>
...
function appMain() {  
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_agc700skr_mitService.selectList'
		}
	});	
	
	Unilite.defineModel('s_agc700skr_mitModel', {
	    fields: [  	    
	    	...
	    	, {name : 'EXPENSE'                    	, text : '금액'                         		, type : 'uniPrice'                               }
	    	
	    ]
	});
	
	var directMasterStore = Unilite.createStore('s_agc700skr_mitMasterStore',{
		model: 's_agc700skr_mitModel',
		uniOpt: {
    ...
    var masterGrid = Unilite.createGrid('s_agc700skr_mitGrid', {
        ...
        columns:  [     
        	...
        	, {dataIndex : 'EXPENSE'                       	  , width : 80   , summaryType : 'sum'}
		]
    });  
