<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<t:appConfig pgmId="s_hat900skr_mit">
	<t:ExtComboStore comboType="BOR120" pgmId="s_hat900skr_mit" />		<!-- 사업장 -->
...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('s_hat900skr_mitModel', {
		fields: [
...
//						panelSearch.setValue('DEPT_NAME', panelResult.getValue('DEPT_NAME'));
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('s_hat900skr_mitMasterStore',{
		model: 's_hat900skr_mitModel',
		autoLoad: false,
		uniOpt : {
		...
		proxy: {
			type: 'uniDirect',
			api: {
				read   : 's_hat900skr_mitService.selectList'
			}
		},
		...
		listeners : {
			load: function(store, records, successful, eOpts) {
				var grid = Ext.getCmp('s_hat900skr_mitMasterGrid');
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('s_hat900skr_mitMasterGrid', {
		region: 'center',
		layout: 'fit',
		uniOpt: {
	...
	Unilite.Main({
		...
		onResetButtonDown : function()	{
			...
			Ext.getCmp('s_hat900skr_mitMasterGrid').reset();
