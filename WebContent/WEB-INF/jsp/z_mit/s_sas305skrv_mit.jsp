...
<t:appConfig pgmId="s_sas305skrv_mit"  >
...
function appMain() {  
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_sas305skrv_mitService.selectList'
		}
	});	
	
	Unilite.defineModel('s_sas305skrv_mitModel', {
	    fields: [  	    
	...
	var directMasterStore = Unilite.createStore('s_sas305skrv_mitMasterStore',{
		model: 's_sas305skrv_mitModel',
		uniOpt: {
    ...
    var masterGrid = Unilite.createGrid('s_sas305skrv_mitGrid', {
