<%@page language="java" contentType="text/html; charset=utf-8"%> 
	<t:appConfig pgmId="s_agd100ukr_mit"  >
...
var getChargeCode = ${getChargeCode};
	...
	/* 모델 및 스토어 주석 처리
	Unilite.defineModel('s_agd100ukr_mitModel', {		
	...
	var MasterStore = Unilite.createStore('s_agd100ukr_mitMasterStore',{
			model: 's_agd100ukr_mitModel',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {			
                	   read: 's_agd100ukr_mitService.selectList'                	
                }
            }
		    	...
		    	items:[{
					...
					handler : function() {
						if(panelSearch.setAllFieldsReadOnly(true)){
							...
							s_agd100ukr_mitService.procButton(param, 
					...
					handler : function() {
						if(panelSearch.setAllFieldsReadOnly(true)){
							var param = panelSearch.getValues();
							panelSearch.getEl().mask('로딩중...','loading-indicator');
							s_agd100ukr_mitService.cancButton(param, 
								function(provider, response) {
									if(provider) {	
