...
<t:appConfig pgmId="s_bpr560ukrv_mit"  >

	<t:ExtComboStore comboType="BOR120"  pgmId="s_bpr560ukrv_mit"/>					<!-- 사업장 -->
...
function appMain() {
	var masterSelectedGrid = 's_bpr560ukrv_mitGrid1';  // Grid1 createRow Default
	var excelWindow; 				//BOM정보 업로드 윈도우 생성
	//20190830 - 대체품목 엑셀업로드 윈도우 정의
	var excelWindow2;
	var BsaCodeInfo={
	...
	var bprYnStore = Unilite.createStore('s_bpr560ukrv_mitBPRYnStore', {
		fields	: ['text', 'value'],
		data	: [
	...
	var basisQtyStore = Unilite.createStore('s_bpr560ukrv_mitBasisQtyStore', {
		fields	: ['text', 'value'],
		data	: [
			{'text':'1'		, 'value':'1'},
			{'text':'100'	, 'value':'100'}
	...
	var directProxy1 = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api: {
			read	: 's_bpr560ukrv_mitService.selectList',
			update: 's_bpr560ukrv_mitService.updateDetail',
			create	: 's_bpr560ukrv_mitService.insertDetail',
			destroy	: 's_bpr560ukrv_mitService.deleteDetail',
			syncAll	: 's_bpr560ukrv_mitService.saveAll'
		}
	});

	var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api: {
			read	: 's_bpr560ukrv_mitService.selectList2',
			update	: 's_bpr560ukrv_mitService.updateDetail2',
			create	: 's_bpr560ukrv_mitService.insertDetail2',
			destroy	: 's_bpr560ukrv_mitService.deleteDetailGRID2',
			syncAll	: 's_bpr560ukrv_mitService.saveAll'
		}
	});
	...
	var directProxy3 = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api: {
			read	: 's_bpr560ukrv_mitService.selectList3',
			update	: 's_bpr560ukrv_mitService.updateDetailGRID3',
			create	: 's_bpr560ukrv_mitService.insertDetail3',
			destroy	: 's_bpr560ukrv_mitService.deleteDetailGRID3',
			syncAll	: 's_bpr560ukrv_mitService.saveAll'
		}
	});
	...
	Unilite.defineModel('s_bpr560ukrv_mitModel1', {
	...
	Unilite.defineModel('s_bpr560ukrv_mitModel2', {
		fields: [{name: 'COMP_CODE'			,text: '<t:message code="system.label.base.companycode" default="법인코드"/>'			,type: 'string' , defaultValue: UserInfo.compCode},
				 {name: 'DIV_CODE'			,text: '<t:message code="system.label.base.division" default="사업장"/>'				,type: 'string', defaultValue: UserInfo.divCode},
				 ...
				 {name: 'USE_YN'			,text: '<t:message code="system.label.base.use" default="사용"/>'						,type: 'string'  , defaultValue:'1' ,store: Ext.data.StoreManager.lookup('s_bpr560ukrv_mitBPRYnStore')},
...
//				 {name: 'SAMPLE_KEY'		,text: 'SAMPLE_KEY'	,type: 'string'}
	...
	Unilite.defineModel('s_bpr560ukrv_mitModel3', {
		fields: [{name: 'COMP_CODE'			,text: '<t:message code="system.label.base.companycode" default="법인코드"/>'			,type: 'string', defaultValue: UserInfo.compCode},
				 {name: 'DIV_CODE'			,text: '<t:message code="system.label.base.division" default="사업장"/>'				,type: 'string', defaultValue: UserInfo.divCode},
				 {name: 'SALE_CUSTOM_CODE'	,text: '매출거래처'				,type: 'string' ,allowBlank:false},
				 {name: 'CUSTOM_NAME'		,text: '매출거래처'				,type: 'string' ,allowBlank:false},
				 {name: 'SEQ'				,text: '<t:message code="system.label.base.seq" default="순번"/>'						,type: 'int'},
				 {name: 'PROD_ITEM_CODE'	,text: '<t:message code="system.label.base.parentitemcode" default="모품목코드"/>'		,type: 'string'},
				 ...
				 {name: 'MAN_HOUR'			,text: '<t:message code="system.label.base.standardtacttime" default="표준공수"/>'		,type: 'uniQty', defaultValue:0},
				 {name: 'USE_YN'			,text: '<t:message code="system.label.base.use" default="사용"/>'						,type: 'string' , defaultValue:'1',store: Ext.data.StoreManager.lookup('s_bpr560ukrv_mitBPRYnStore')},
				 {name: 'BOM_YN'			,text: '<t:message code="system.label.base.compyn" default="구성여부"/>'				,type: 'string' , defaultValue:'1',store: Ext.data.StoreManager.lookup('s_bpr560ukrv_mitBPRYnStore')},
	...
	Unilite.Excel.defineModel('excel.s_bpr560ukrv_mit.sheet01', {
		fields: [
	...
	//20190830 - 대체품목 엑셀업로드 window의 Grid Model
	Unilite.Excel.defineModel('excel.s_bpr560ukrv_mit.sheet02', {
		fields: [
			{name: '_EXCEL_JOBID'		, text: 'EXCEL_JOBID'	, type: 'string'},
			{name: 'COMP_CODE'			, text: '<t:message code="system.label.base.companycode" default="법인코드"/>'					, type: 'string'},
			{name: 'DIV_CODE'			, text: '<t:message code="system.label.base.division" default="사업장"/>'						, type: 'string', comboType: 'BOR120' },
			{name: 'SEQ'				, text: '<t:message code="system.label.base.seq" default="순번"/>'							, type: 'int'},
			{name: 'SALE_CUSTOM_CODE'	, text: '매출거래처'			,type: 'string'},
			{name: 'CUSTOM_NAME'		, text: '매출거래처'			,type: 'string'},
			{name: 'PROD_ITEM_CODE'		, text: '<t:message code="system.label.base.parentitemcode" default="모품목코드"/>'				, type: 'string'},
			{name: 'PROD_ITEM_NAME'		, text: '<t:message code="system.label.base.parentitemname" default="모품목명"/>'				, type: 'string'},
			{name: 'CHILD_ITEM_CODE'	, text: '<t:message code="system.label.base.childitemcode" default="자품목코드"/>'				, type: 'string'},
			{name: 'CHILD_ITEM_NAME'	, text: '자품목명'			,type: 'string'},
			{name: 'EXCHG_ITEM_CODE'	, text: '<t:message code="system.label.base.subitemcode" default="대체품목코드"/>'				, type: 'string'},
			{name: 'ITEM_NAME'			, text: '<t:message code="system.label.base.itemname" default="품목명"/>'						, type: 'string'},					//거래처품목코드
			{name: 'UNIT_Q'				, text: '<t:message code="system.label.base.originunitqty" default="원단위량"/>'				, type: 'number', defaultValue:1},	//거래처품명
			{name: 'LOSS_RATE'			, text: '<t:message code="system.label.base.lossrate" default="LOSS율"/>'					, type: 'number', defaultValue:0},
			{name: 'REMARK'				, text: '<t:message code="system.label.base.remarks" default="비고"/>'						, type: 'string'}
	 ...
	 * @type
	 */
	var directMasterStore1 = Unilite.createStore('s_bpr560ukrv_mitMasterStore1',{
		model	: 's_bpr560ukrv_mitModel1',
		proxy	: directProxy1,
		uniOpt	: {
		...
		saveStore: function(config) {
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('s_bpr560ukrv_mitGrid1');
	...
	var directMasterStore2 = Unilite.createStore('s_bpr560ukrv_mitMasterStore2',{
		model	: 's_bpr560ukrv_mitModel2',
		proxy	: directProxy2,
		uniOpt	: {
			isMaster	: false,	// 상위 버튼 연결
			editable	: true,		// 수정 모드 사용
	...
	var directMasterStore3 = Unilite.createStore('s_bpr560ukrv_mitMasterStore3',{
		model	: 's_bpr560ukrv_mitModel3',
		proxy	: directProxy3,
		uniOpt	: {
			isMaster	: false,	// 상위 버튼 연결
			editable	: true,		// 수정 모드 사용
	...
	var makeProdItemBtn = Ext.create('Ext.Button',{
		...
		handler	: function() {
			if (confirm('<t:message code="system.message.base.message008" default="모품목에 등록되지 않은 제품/반제품을 일괄등록하시겠습니까?"/>')) {
				s_bpr560ukrv_mitService.makeProdItems({'DIV_CODE': panelSearch.getValue('DIV_CODE')}, function(provider, response) {
				...
				fn: function(records, type) {
					...
					Ext.each(records, function(record,i) {
						var r={
							...
							'SEQ'				: Unilite.nvl(directMasterStore2.max('SEQ'),0)+1,
	...
	var masterGrid1 = Unilite.createGrid('s_bpr560ukrv_mitGrid1', {
		store	: directMasterStore1,
		layout	: 'fit',
		region	: 'west',
		flex	: .3,
		split	: true,
		itemId	: 's_bpr560ukrv_mitGrid1',
					  ...
					  editor: Unilite.popup('DIV_PUMOK_G', {
							...
							listeners: {'onSelected': {
								...
								applyextparam: function(popup){
									...
									popup.setExtParam({'DEFAULT_ITEM_ACCOUNT': '10'});
									//20190827 모품목에 제품, 반제품만 입력가능하도록 수정
									popup.setExtParam({'ADD_QUERY3': "AND ITEM_ACCOUNT IN ('10', '20')"});
								}
							}
						})
					},
	...
	var masterGrid2 = Unilite.createGrid('s_bpr560ukrv_mitGrid2', {
		store	: directMasterStore2,
		layout	: 'fit',
		region	: 'north',
		split	: true,
		flex	: .7,
		itemId	: 's_bpr560ukrv_mitGrid2',
		...
		tbar:[{
			...
			xtype:'uniCombobox',
			store: Ext.data.StoreManager.lookup('s_bpr560ukrv_mitBasisQtyStore'),
			id:'BASIS_QTY_COMBO',
			labelWidth  : 53,
			width	   : 180,
	...
	var masterGrid3 = Unilite.createGrid('s_bpr560ukrv_mitGrid3', {
					...
					return false;
					 ...
					 if(confirm("자품목코드와 대체품목코드를 교환하시겠습니까?")) {
						 var param= {
							...
							'SALE_CUSTOM_CODE'	: records3.data.SALE_CUSTOM_CODE
						};
						 Ext.getBody().mask();
						 	s_bpr560ukrv_mitService.changeItemData(param,function(provider, response){
		...
		columns:  [{ dataIndex: 'COMP_CODE'			,width: 66, hidden: true   },
				   { dataIndex: 'DIV_CODE'			,width: 66, hidden: true   },
				   { dataIndex: 'SALE_CUSTOM_CODE'	,width: 150, hidden: true,
						editor: Unilite.popup('CUST_G', {
							textFieldName: 'SALE_CUSTOM_CODE',
							DBtextFieldName: 'SALE_CUSTOM_CODE',
			 				autoPopup: true,
							listeners: {
								'onSelected': {
									fn: function(records, type) {
...
//				 { dataIndex: 'SEQ'					,width: 45, locked: true   },
		...
		listeners: {
			...
			beforeedit  : function( editor, e, eOpts ) {
				...
				if(!e.record.phantom){
					if(UniUtils.indexOf(e.field,
										['SALE_CUSTOM_CODE', 'CUSTOM_NAME', 'EXCHG_ITEM_CODE','ITEM_NAME','START_DATE']))
						return false;
				}
			}
		},
	...
	//자품목 엑셀업로드 윈도우 생성 함수(bpr560ukrv 그대로 사용)
	function openExcelWindow() {
		...
		if(!excelWindow) {
			...
			excelWindow = Ext.create( appName, {
				//20190830 - 정규 엑셀업로드 그대로 사용
				excelConfigName: 'bpr560ukrv',
				width	: 600,
				height	: 400,
				modal	: false,
				extParam: {
				...
				grids: [{							//팝업창에서 가져오는 그리드
						...
						title		: 'BOM정보 엑셀업로드',
						useCheckbox	: false,
						model		: 'excel.s_bpr560ukrv_mit.sheet01',
						readApi		: 'bpr560ukrvService.selectExcelUploadSheet1',
						columns		: [
	...
	function openExcelWindow2() {
		...
		if(!Ext.isEmpty(excelWindow2)){
			excelWindow2.extParam.DIV_CODE = panelResult.getValue('DIV_CODE');
		}
		if(!excelWindow2) {
			excelWindow2 = Ext.WindowMgr.get(appName);
			excelWindow2 = Ext.create( appName, {
				excelConfigName: 's_bpr560ukrv_mit',
				width	: 600,
				height	: 400,
				modal	: false,
				extParam: {
					'PGM_ID'		: 's_bpr560ukrv_mit',
					'DIV_CODE'		: panelResult.getValue('DIV_CODE')
				},
				grids: [{							//팝업창에서 가져오는 그리드
						itemId		: 'grid01',
						title		: '대체품목 엑셀업로드',
						useCheckbox	: false,
						model		: 'excel.s_bpr560ukrv_mit.sheet02',
						readApi		: 's_bpr560ukrv_mitService.selectExcelUploadSheet',
						columns		: [
							{dataIndex: '_EXCEL_JOBID'		, width: 80		, hidden: true},
							{dataIndex: 'COMP_CODE'			, width: 93		, hidden: true},
							{dataIndex: 'DIV_CODE'			, width: 66		, hidden: true},
				...
				onApply:function() {
					...
					if(!flag){
						...
						s_bpr560ukrv_mitService.insertS_BPR510T_MIT(param, function(provider, response) {
							console.log("provider:",provider);
							console.log("response:",response);
							if(provider){
	...
	Unilite.Main({
		...
		fnInitBinding : function(params) {
			...
			masterSelectedGrid = 's_bpr560ukrv_mitGrid1';
		...
		onNewDataButtonDown: function() {
			if(masterSelectedGrid == 's_bpr560ukrv_mitGrid1'){
				var r = {
			...
			else if(masterSelectedGrid == 's_bpr560ukrv_mitGrid2'){
			...
			else if(masterSelectedGrid == 's_bpr560ukrv_mitGrid3'){
		...
		onDeleteDataButtonDown: function() {
			if(masterSelectedGrid == 's_bpr560ukrv_mitGrid1'){
				var Grid1 = UniAppManager.app.down('#s_bpr560ukrv_mitGrid1');
				...
				var Grid1 = UniAppManager.app.down('#s_bpr560ukrv_mitGrid2');
				...
				var Grid1 = UniAppManager.app.down('#s_bpr560ukrv_mitGrid3');
		...
		rejectSave: function() {	// 저장
			if(masterSelectedGrid == 's_bpr560ukrv_mitGrid2'){
		...
		confirmSaveData: function(config) {
			var fp = Ext.getCmp('s_bpr560ukrv_mitFileUploadPanel');
