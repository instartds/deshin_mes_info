...
<t:appConfig pgmId="s_sas310skrv_mit"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_sas310skrv_mit"/>
...
function appMain() {  
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_sas310skrv_mitService.selectList'
		}
	});	
	
	Unilite.defineModel('s_sas310skrv_mitModel', {
	    fields: [  	    
	...
	var directMasterStore = Unilite.createStore('s_sas310skrv_mitMasterStore',{
		model: 's_sas310skrv_mitModel',
		uniOpt: {
    ...
    var masterGrid = Unilite.createGrid('s_sas310skrv_mitGrid', {
