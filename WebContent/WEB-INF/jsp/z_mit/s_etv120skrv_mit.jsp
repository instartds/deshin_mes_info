...
<t:appConfig pgmId="s_etv120skrv_mit"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="s_etv120skrv_mit"  />             <!-- 사업장 -->  
...
function appMain() {
    ...
    Unilite.defineModel('s_etv120skrv_mitModel', {
        fields: [
    ...
    Unilite.defineModel('s_etv120skrv_mitModel1', {
        fields: [
	...
	Unilite.defineModel('s_etv120skrv_mitModelContents', {
		fields: [
    ...
    var directMasterStore = Unilite.createStore('s_etv120skrv_mitMasterStore',{
        model: 's_etv120skrv_mitModel',
        uniOpt : {
        ...
        proxy: Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
            ...
            api: {			
        	   read: 's_etv120skrv_mitService.selectList'                 	
            },
            reader: {
...
//						}
    ...
    var directMasterStore1 = Unilite.createStore('s_etv120skrv_mitMasterStore1',{
        model: 's_etv120skrv_mitModel1',
        uniOpt : {
            isMaster:  false,            // 상위 버튼 연결 
            editable:  false,            // 수정 모드 사용 
            deletable: false,            // 삭제 가능 여부 
        ...
        proxy: Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
            ...
            api: {			
        	   read: 's_etv120skrv_mitService.selectList1'                 	
            },
            reader: {
                rootProperty: 'records',
                totalProperty: 'total'
...
//                 params :param 
	...
	var directContentsStore = Unilite.createStore('s_etv120skrv_mitContentsStore', {
		model: 's_etv120skrv_mitModelContents',
		uniOpt: {
			isMaster:  false,	// 상위 버튼 연결 
			editable:  false,	// 수정 모드 사용 
			deletable: false,	// 삭제 가능 여부 
		...
		proxy: Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
			api: {
				read: 's_etv120skrv_mitService.selectContents'
			}
		}),
		loadStoreRecords : function() {
			this.load(
    ...
    var masterGrid = Unilite.createGrid('s_etv120skrv_mitMasterGrid', {
        layout : 'fit',   
        region: 'center',
        width:'100%',
    ...
    var masterGrid1 = Unilite.createGrid('s_etv120skrv_mitMasterGrid1', {
        layout : 'fit',   
        region: 'south',    
        height		: '53%',
        width:'100%',
