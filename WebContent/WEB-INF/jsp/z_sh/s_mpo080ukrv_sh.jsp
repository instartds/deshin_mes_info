...
<t:appConfig pgmId="s_mpo080ukrv_sh"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_mpo080ukrv_sh" /><!-- 사업장 -->
...
function appMain() {
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_mpo080ukrv_shService.selectMasterList',
            create: 's_mpo080ukrv_shService.insertMaster',
			update: 's_mpo080ukrv_shService.updateMaster',
			destroy: 's_mpo080ukrv_shService.deleteMaster',
			syncAll: 's_mpo080ukrv_shService.saveMaster'
		}
	});
	...
	var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_mpo080ukrv_shService.selectDetailList',
			update: 's_mpo080ukrv_shService.updateDetail',
			syncAll: 's_mpo080ukrv_shService.saveDetail'
		}
	});
	...
	var directProxy2_2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_mpo080ukrv_shService.selectDetailList2'
//            create: 's_mpo080ukrv_shService.insertMaster',
//			update: 's_mpo080ukrv_shService.updateMaster',
//			destroy: 's_mpo080ukrv_shService.deleteMaster',
//			syncAll: 's_mpo080ukrv_shService.saveMaster'
	...
	var directProxy2_3 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_mpo080ukrv_shService.selectDetailList3'
		}
	});
	...
	var directProxy3 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_mpo080ukrv_shService.selectProdList'
		}
	});

	var directButtonProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
            create: 's_mpo080ukrv_shService.buttonInsert',
            syncAll: 's_mpo080ukrv_shService.buttonSave'
		}
	});

/*	var directButtonProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
            create: 's_mpo080ukrv_shService.buttonInsert2',
            syncAll: 's_mpo080ukrv_shService.buttonSave2'
		}
	});	*/
	 ...
	 * @type
	 */
	Unilite.defineModel('s_mpo080ukrv_shModel', {
	    fields: [
	...
	Unilite.defineModel('s_mpo080ukrv_shModel2', {
	    fields: [
	    	{name: 'COMP_CODE'			,text: '<t:message code="system.label.purchase.companycode" default="법인코드"/>'			,type: 'string'},
			{name: 'DIV_CODE'			,text: '<t:message code="system.label.purchase.division" default="사업장"/>'				,type: 'string'},
	...
	Unilite.defineModel('s_mpo080ukrv_shModel2_2', {
	    fields: [
	    	{name: 'CHILD_ITEM_CODE'	,text: '<t:message code="system.label.purchase.item" default="품목"/>'				,type: 'string'},
	    	{name: 'ITEM_NAME'			,text: '<t:message code="system.label.purchase.itemname2" default="품명"/>'				,type: 'string'},
	    	{name: 'SPEC'				,text: '<t:message code="system.label.purchase.spec" default="규격"/>'				,type: 'string'},
	...
	Unilite.defineModel('s_mpo080ukrv_shModel2_3', {
	    fields: [
	    	{name: 'CHILD_ITEM_CODE'	,text: '<t:message code="system.label.purchase.item" default="품목"/>'				,type: 'string'},
	    	{name: 'ITEM_NAME'			,text: '<t:message code="system.label.purchase.itemname2" default="품명"/>'				,type: 'string'},
	    	{name: 'SPEC'				,text: '<t:message code="system.label.purchase.spec" default="규격"/>'				,type: 'string'},
	...
	var buttonStore = Unilite.createStore('s_mpo080ukrv_shButtonStore',{
        uniOpt: {
...
/*
    var buttonStore2 = Unilite.createStore('s_mpo080ukrv_shButtonStore2',{
        uniOpt: {
            isMaster	: false,            // 상위 버튼 연결
            editable	: false,            // 수정 모드 사용
            deletable	: false,        	// 삭제 가능 여부
	 ...
	 * @type
	 */
	var directMasterStore = Unilite.createStore('s_mpo080ukrv_shMasterStore',{
		model: 's_mpo080ukrv_shModel',
		uniOpt: {
            isMaster: false,			// 상위 버튼 연결
	 ...
	 * @type
	 */
	var directDetailStore = Unilite.createStore('s_mpo080ukrv_shDetailStore',{
		model: 's_mpo080ukrv_shModel2',
		uniOpt: {
		...
		saveStore: function() {
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('s_mpo080ukrv_shGrid');
...
//			readOnly: true,
     ...
     * @type
     */
    var masterGrid = Unilite.createGrid('s_mpo080ukrv_shGrid', {
    	region: 'north' ,
        layout: 'fit',
	    split: true,
        uniOpt: {
     ...
     * @type
     */
    var detailGrid= Unilite.createGrid('s_mpo080ukrv_shGrid2', {
    	region:'center',
        layout: 'fit',
        uniOpt: {
			expandLastColumn: false,
    	...
    	tbar:[{
        	...
        	handler:function(){
				...
				param.PGM_ID= 's_mpo080ukrv_sh_1';
...
//        selModel:'spreadsheet',
    ...
    var detailGrid3= Unilite.createGrid('detailGrid3', {
    	...
    	tbar:[{
        	...
        	handler:function(){
				...
				param.PGM_ID= 's_mpo080ukrv_sh_2';
				param.MAIN_CODE= 'M030';
	...
	Unilite.defineModel('s_mpo080ukrv_shRefModel', {
	    fields: [
	    	{name: 'DIV_CODE'    		, text: '<t:message code="system.label.purchase.division" default="사업장"/>'			, type: 'string'},
	...
	var prodStore = Unilite.createStore('s_mpo080ukrv_shProdStore', {
		model: 's_mpo080ukrv_shRefModel',
        autoLoad: false,
        uniOpt : {
           	isMaster: false,			// 상위 버튼 연결
           	editable: false,			// 수정 모드 사용
...
//					var masterRecords = directMasterStore.data.filterBy(directMasterStore.filterNewOnly);
	 ...
	 var prodGrid = Unilite.createGrid('s_mpo080ukrv_shProdGrid', {
    	layout : 'fit',
    	store: prodStore,
