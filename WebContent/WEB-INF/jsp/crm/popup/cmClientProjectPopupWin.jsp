...
<%
// 고객 영업기회 팝업
request.setAttribute("PKGNAME","Unilite.app.popup.cmClientProjectPopup");
%>


<t:ExtComboStore useScriptTag="false" comboType="AU" comboCode="B010" />
<t:ExtComboStore useScriptTag="false" comboType="AU" comboCode="CB24" />

	/**
	 *   Model 정의 
	 * @type
	 */
Unilite.defineModel('${PKGNAME}.cmClientProjectPopupModel', {
 ...
 * @type 
 */					
Unilite.createStoreSimple('${PKGNAME}.cmClientProjectPupupMasterStore',{
		model: '${PKGNAME}.cmClientProjectPopupModel',
        autoLoad: false,
        proxy: {
            type: 'direct',
            api: {
...
Ext.define('${PKGNAME}', {
    ...
    constructor : function(config) {
		...
		me.panelSearch = Unilite.createSearchForm('cmClientProjectPopupSearchForm', {
		 ...
		 * @type 
		 */
		me.masterGrid = Unilite.createGrid('cmClientProjectPopupMasterGrid', {
			store: Ext.data.StoreManager.lookup('${PKGNAME}.cmClientProjectPupupMasterStore'),
		    columns:  [   						      
