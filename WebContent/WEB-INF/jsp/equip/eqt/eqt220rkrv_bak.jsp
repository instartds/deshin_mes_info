...
<t:appConfig pgmId="eqt220rkr"  >
	<t:ExtComboStore comboType="BOR120" pgmId="eqt220rkr" /> 			<!-- 사업장 --> 
</t:appConfig>
<style type="text/css">
...
function appMain() {   
	...
	var panelSearch = Unilite.createSearchForm('eqt220rkrForm', {
		region: 'center',
    	disabled :false,
    	border: false,
    	flex:1,
		...
		onPrintButtonDown: function() {
			if(this.onFormValidate()){
				...
				var win = Ext.create('widget.PDFPrintWindow', {
					url: CPATH+'/str/eqt220rkrPrint1.do',
					prgID: 'eqt220rkr',
					extParam: param
					});
				win.center();
