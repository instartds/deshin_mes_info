...
<t:appConfig pgmId="equ999ukrv"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="equ999ukrv"  />             <!-- 사업장 -->
...
/*                        var displayPanel = Ext.create('Ext.Panel', {
	...
	*/
	...
	var directProxyMaster = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 'equ999ukrvService.selectMaster',
            create: 'equ999ukrvService.insertMaster',
            update: 'equ999ukrvService.updateMaster',
            destroy: 'equ999ukrvService.deleteMaster',
            syncAll: 'equ999ukrvService.saveAllMaster'
        }
    });
            ...
            if(inValidRecs.length == 0 )    {
                var config = {
                  ...
                  /*
                        ...
                        equ999ukrvService.getFileList({ITEM_CODE : master.ITEM_CODE},              //파일조회 메서드  호출(param - 파일번호)
						...
						listeners: {
							blur: function(field, event, eOpts) {
								if(!field.readOnly){
									...
									equ999ukrvService.autoEquCode(param , function(provider, response){
