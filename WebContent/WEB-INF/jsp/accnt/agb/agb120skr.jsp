...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('Agb120skrModel', {
	 ...
	 * @type 
	 */					
	var MasterStore = Unilite.createStore('agb120skrMasterStore',{
		model: 'Agb120skrModel',
		uniOpt : {
        ...
        proxy: {
            type: 'direct',
            api: {			
            	   read: 'agb120skrService.selectList'                	
            }
        },
...
//		    width: 325,
            ...
            id: 'radio4',
            items: [{
                boxLabel: '과목' , width: 70, name: 'ACCNT_DIVI', inputValue: '1', checked: true
            }, {
                boxLabel: '세목' , width: 70, name: 'ACCNT_DIVI', inputValue: '2'
            }],
            listeners: {
                change: function(field, newValue, oldValue, eOpts) {      
...
//			    			/* , 'ADD_QUERY': "" },  
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('agb120skrGrid1', {
    	// for tab    	
        layout : 'fit',
        region:'center',
    	store: MasterStore,
...
//        			{ dataIndex: 'BOOKCODE_YN'	,width:	186		, hidden: true},
        			{ dataIndex: 'IWALL_TOT_AMT',width:	180},
        			{ dataIndex: 'DR_TOT_AMT'   ,width:	180},
        			{ dataIndex: 'CR_TOT_AMT'   ,width:	180},        			
        			{ dataIndex: 'JAN_TOT_AMT'  ,width:180 }/*,   
        			{ dataIndex: 'GUBUN'		,width:	20, hidden: true}*/
        ],
		listeners: {
	      	itemmouseenter:function(view, record, item, index, e, eOpts )	{          		
	        	if (record.get('ACCNT') != '합계' && record.get('ACCNT') != '') {
