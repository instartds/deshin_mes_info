...
var BsaCodeInfo	= {
	gsReportGubun: '${gsReportGubun}'	//20200803 추가: clip report 추가
};

function appMain() {
	var panelSearch = Unilite.createSearchForm('agb160rkrForm', {
		region	: 'center',
		disabled: false,
		border	: false,
		flex	: 1,
		...
		Unilite.popup('DEPT',{
			...
			text	: '출력',
			width	: 235,
			tdAttrs	: {'align':'center', style:'padding-left:25px'},		//20200804 수정: 95 -> 25
			handler	: function() {
		...
		onPrintButtonDown: function() {
			...
			if(reportGubun.toUpperCase() == 'CLIP'){
				...
				var win = Ext.create('widget.ClipReport', {
					url			: CPATH+'/accnt/agb160clrkrPrint.do',
					prgID		: 'agb160rkr',
					extParam	: param,
					submitType	: 'POST'
				});
