...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('Agb252skrModel', {
		fields: [  	  
			{name: 'AGENT_TYPE'			, text: '고객타입'		,type: 'string'},
			{name: 'AGENT_TYPE_NAME'	, text: '고객분류'		,type: 'string'},
			{name: 'CUSTOM_CODE'		, text: '거래처코드'		,type: 'string'},
			{name: 'CUSTOM_NAME'		, text: '거래처명'		,type: 'string'},
			{name: 'AMT_01'				, text: '1개월'		,type: 'uniPrice'},
			{name: 'AMT_02'				, text: '2개월'		,type: 'uniPrice'},
			{name: 'AMT_03'				, text: '3개월'		,type: 'uniPrice'},
			{name: 'AMT_04'				, text: '4개월'		,type: 'uniPrice'},
			{name: 'AMT_05'				, text: '5개월'		,type: 'uniPrice'},
			{name: 'AMT_06'				, text: '6개월'		,type: 'uniPrice'},
			{name: 'AMT_07'				, text: '7개월'		,type: 'uniPrice'},
			{name: 'AMT_08'				, text: '8개월'		,type: 'uniPrice'},
			{name: 'AMT_09'				, text: '9개월'		,type: 'uniPrice'},
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('agb252skrMasterStore1',{
		model: 'Agb252skrModel',
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {			
				read: 'agb252skrService.selectList'
			}
		},
		...
		groupField: 'AGENT_TYPE_NAME',
		listeners : {
			load: function(store, records, successful, eOpts) {
				var grid = Ext.getCmp('agb252skrGrid1');
				...
				var col01 = grid.getColumnIndex("AMT_01");
	...
	var masterGrid = Unilite.createGrid('agb252skrGrid1', {
		layout : 'fit',
		region : 'center',
		...
		columns: [
			...
			{dataIndex: 'AGENT_TYPE_NAME' 		, width: 86	 ,locked:true	, align:'center',
				summaryRenderer:function(value, summaryData, dataIndex, metaData ) {
					return Unilite.renderSummaryRow(summaryData, metaData, '소계', '총계');
			}}, 				
			{dataIndex: 'CUSTOM_CODE'		, width: 86  , locked:true},
			{dataIndex: 'CUSTOM_NAME'		, width: 120 , locked:true},
			{dataIndex: 'AMT_01'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_02'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_03'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_04'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_05'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_06'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_07'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_08'			, width: 120 , summaryType: 'sum' },
			{dataIndex: 'AMT_09'			, width: 120 , summaryType: 'sum' },
	...
	Unilite.Main( {
		...
		fnInitBinding : function() {
			...
			activeSForm.onLoadSelectText('PAYMENT_DAY');
