...
function appMain() {     
	 ...
	 * @type 
	 */
	Unilite.defineModel('Agb250skrModel', {
	    fields: [  	  
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('agb250skrMasterStore1',{
		model: 'Agb250skrModel',
		uniOpt: {
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agb250skrService.selectList'                	
            }
        },
		...
		listeners : {
			load: function(store, records, successful, eOpts) {
				var grid = Ext.getCmp('agb250skrGrid1');
    ...
    var masterGrid = Unilite.createGrid('agb250skrGrid1', {
    	layout : 'fit',
        region : 'center',
