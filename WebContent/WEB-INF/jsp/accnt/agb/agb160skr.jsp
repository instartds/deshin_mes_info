...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('Agb160skrModel1', {
		fields: [
	...
	Unilite.defineModel('Agb160skrModel2', {
		fields: [
			{name: 'J_DATE'			,text: '반제일'		,type: 'string'},
	 ...
	 * @type 
	 */
	var directMasterStore1 = Unilite.createStore('agb160skrMasterStore1',{
		model	: 'Agb160skrModel1',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 'agb160skrService.selectList'
			}
		},
		...
		listeners: {
			load: function(store, records, successful, eOpts) {
				...
				if(count > 0){
					...
					masterGrid1.down('#printBtn').enable();
//					UniAppManager.setToolbarButtons(['print'], true);
				}else{
					//20200804 추가: 출력버튼 추가로 인쇄버튼 사용 안 함
					masterGrid1.down('#printBtn').disable();
//					UniAppManager.setToolbarButtons(['print'], false);
	...
	var directMasterStore2 = Unilite.createStore('agb160skrMasterStore2',{
		model	: 'Agb160skrModel2',
		uniOpt	: {
			isMaster	: true,		// 상위 버튼 연결 
			editable	: false,	// 수정 모드 사용 
			deletable	: false,	// 삭제 가능 여부 
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 'agb160skrService.selectDetail'
			}
		},
		loadStoreRecords : function() {
...
//			validateBlank:false,	 
	 ...
	 * @type 
	 */
	var masterGrid1 = Unilite.createGrid('agb160skrGrid1', {
		...
		tbar		: [{
			...
			itemId	: 'printBtn',
			handler	: function() {
				//20200803 수정: 출력링크로직 수정
				var params		= panelSearch.getValues();
				params.PGM_ID	= 'agb160skr';
//				var params = {
...
//					'DEPT_CODE_TO'	: panelSearch.getValue('PEND_DEPT_CODE'),
//					'DEPT_NAME_TO'	: panelSearch.getValue('PEND_DEPT_NAME'),
//					'J_DATE_FR'		: panelSearch.getValue('J_DATE_FR'),
//					'J_DATE_TO'		: panelSearch.getValue('J_DATE_TO'),
//					'PRINT_KIND'	: panelSearch.getValue('CHECK')
//				}
				//전송
				var rec1 = {data : {prgID : 'agb160rkr', 'text':''}};
				parent.openTab(rec1, '/accnt/agb160rkr.do', params);	
			}
		}],
...
//			{ dataIndex: 'INPUT_DIVI'		, width: 80, hidden: true	}
	...
	var masterGrid2 = Unilite.createGrid('agb160skrGrid2', {
