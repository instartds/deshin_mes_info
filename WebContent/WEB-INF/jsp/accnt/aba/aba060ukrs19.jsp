<%@page language="java" contentType="text/html; charset=utf-8"%>
{
	title:'국고보조금(IFRS)',
	border: false,
	itemId: 'tab_Gov_Asst_Dep_IFRS',
	id:'tab_Gov_Asst_Dep_IFRS',
	xtype: 'container',
	layout: {type: 'vbox', align: 'stretch'},
	items:[{
		xtype: 'uniDetailForm',
		disabled:false,
		itemId: 'tab_Gov_Asst_Dep_IFRS_Form',
		...
		items: [{
			...
			xtype: 'uniGridPanel',
			id:'aiga410ukrvGrid',
			itemId:'aiga410ukrvGrid',
			excelTitle: '국고보조금 감가상각 IFRS 자동기표방법등록',
			uniOpt: {
			...
			features: [{
				id: 'aiga410ukrvGridSubTotal', 
				ftype: 'uniGroupingsummary', 
				showSummaryRow: false
			},{
				id: 'aiga410ukrvGridTotal', 
				ftype: 'uniSummary', 
				showSummaryRow: false
			}],
			store: aiga410ukrvStore,
			columns: [        
					...
					editor:Unilite.popup('ACCNT_G', {
						...
						listeners:{
							...
							onSelected:function(records, type )	{
								var grdRecord = panelDetail.down("#aiga410ukrvGrid").uniOpt.currentRecord;
