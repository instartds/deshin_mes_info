 ...
 */
    ...
    Unilite.defineModel('agj260ukrSlipModel', {
	...
	var drSum = 0; crSum = 0;
	var slipStore1 = Unilite.createStore('agj260ukrSlipStore1',{
			model: 'agj260ukrSlipModel',
            autoLoad: false,
            uniOpt : {
	...
	var slipStore2 = Unilite.createStore('agj260ukrSlipStore2',{
			model: 'agj260ukrSlipModel',
            autoLoad: false,
            uniOpt : {
            	isMaster: false,			// 상위 버튼 연결 
    ...
    var slipGrid1 = Unilite.createGrid('agj260ukrAccGrid1', {
		uniOpt:{
    ...
    var slipGrid2 = Unilite.createGrid('agj260ukrAccGrid2', {       
		uniOpt:{
        	expandLastColumn: false,
            useMultipleSorting: false,
            userToolbar:false
