...
var baseInfo = {
	...
	var directMasterStore1 = Unilite.createStore('agj105ukrMasterStore1',getStoreConfig('agj105ukrGrid1','agj105ukrDetailForm1'));
	...
	//createSearchForm
	var slipForm =  Unilite.createSearchForm('agj105ukrSlipForm',  {		
        itemId: 'agj105ukrSlipForm',
     ...
     * @type 
     */
    var masterGrid1 = Unilite.createGrid('agj105ukrGrid1', getGridConfig(directMasterStore1,'agj105ukrGrid1','agj105ukrDetailForm1', 0.6, true, '2'));

    var detailForm1 = Unilite.createForm('agj105ukrDetailForm1',  getAcFormConfig('agj105ukrDetailForm1',masterGrid1 ));
    ...
    Unilite.Main({
		...
		onPrevDataButtonDown:  function()	{
			...
			if(slipForm.isValid() )	{
				...
				agj105ukrService.getPrevSlipNum(param, function(provider, response){
					Ext.getBody().unmask();
					if(provider)	{
		...
		onNextDataButtonDown:  function()	{
			...
			if(slipForm.isValid())	{
				...
				agj105ukrService.getNextSlipNum(param, function(provider, response){
					Ext.getBody().unmask();
					if(provider)	{
						panelSearch.setValue('AC_DATE', provider.EX_DATE);
						panelSearch.setValue('EX_NUM', provider.EX_NUM);
		...
		onResetButtonDown:function() {
			...
			var masterGrid1 = Ext.getCmp('agj105ukrGrid1');
			panelSearch.reset();						
			masterGrid1.reset();
...
//				slipForm.setValue('INPUT_PATH',params.INPUT_PATH);
			...
			}else if(params.PGM_ID == 'agj400skr') {
				...
				this.onQueryButtonDown();
			}else if(params.PGM_ID == 'agj400ukr') {
		...
		fnAddSlipRecord:function(){
		    ...
		    /*var r = {
			 ...
			 var r = {
				...
				'REMARK'		: Ext.isEmpty(selectedRecord) ? '': selectedRecord.get('REMARK'),
				'POSTIT_YN'		: 'N',
