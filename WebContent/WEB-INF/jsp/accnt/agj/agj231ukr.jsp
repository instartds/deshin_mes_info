...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('Agj231ukrModel1', {
	...
	Unilite.defineModel('Agj231ukrModel2', {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read : 'agj231ukrService.selectList'
		 ,update : 'agj230ukrService.update'
		 //,create : 'agj231ukrService.insert'
		 //,destroy:'agj231ukrService.delete'
		 ,syncAll:'agj230ukrService.saveAll'
		}
	});
	var masterStore = Unilite.createStore('agj231ukrMasterStore',{
			model: 'Agj231ukrModel1',
			uniOpt : {
	...
	var masterStore2 = Unilite.createStore('agj231ukrMasterStore1',{
			model: 'Agj231ukrModel2',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {			
                	   read: 'agj231ukrService.selectExList'                	
                }
            },
...
//			allowBlank:false,
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('agj231ukrGrid1', {
    	// for tab    	
        layout : 'fit',
        region:'center',
        flex: 3,
...
/*		   	{ dataIndex: 'DIV_CODE'		 		, width: 80 ,hidden:true},
        	...
        	onGridDblClick :function( grid, record, cellIndex, colName ) {
                ...
                if (apSts == '1'){                          //구분이 "미승인"일 때,
					if(inputPath == 'Z1'){
						...
						masterGrid.gotoAgj106ukr(record);
					...
					//INPUT_DIVI가 '3'일 경우 결의미결반제입력으로 이동
					else if  (inputDivi == '3'){
						masterGrid.gotoAgj110ukr(record);
					}
		...
		gotoAgj100ukr:function(record)	{
			...
			parent.openTab(rec1, '/accnt/agj100ukr.do', param, CHOST+CPATH);
    	},
		gotoAgj105ukr:function(record)	{
    		...
    		var param = {
	  		...
	  		var rec1 = {data : {prgID : 'agj106ukr', 'text':''}};							
			parent.openTab(rec1, '/accnt/agj106ukr.do', param, CHOST+CPATH);
    	},
    	
    	gotoAgj106ukr:function(record)	{
    		var record = masterGrid.getSelectedRecord();
    		var param = {
    			'PGM_ID'			: 'agj231ukr',
				'AC_DATE_FR'		: record.data['AC_DATE'],
		...
		gotoAgj110ukr:function(record)	{
			...
			parent.openTab(rec1, '/accnt/agj110ukr.do', param, CHOST+CPATH);
    	},    	
		gotoAgj200ukr:function(record)	{
			...
			parent.openTab(rec1, '/accnt/agj200ukr.do', param, CHOST+CPATH);
    	},
		gotoAgj205ukr:function(record)	{
			...
			parent.openTab(rec1, '/accnt/agj205ukr.do', param, CHOST+CPATH);
    	}  ,
...
/*        uniRowContextMenu:{
    ...
    var masterGrid2 = Unilite.createGrid('agj231ukrGrid2', {
    	uniOpt:{
			useMultipleSorting	: true,			 
	    	useLiveSearch		: false,			
...
/*        		   { dataIndex: 'CUSTOM_CODE'	 		, width: 66, hidden: true },*/
    ...
    var detailForm = Unilite.createForm('agj231ukrDetailForm',  {	
        itemId: 'agj231ukrDetailForm',
