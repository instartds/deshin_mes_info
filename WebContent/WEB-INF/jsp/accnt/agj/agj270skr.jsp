...
function appMain() {
    ...
    var directReportProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            create: 'agj270skrService.insertDetail',
            syncAll: 'agj270skrService.saveAll'
        }
    });
	/* Model 정의 
	 * @type 
	 */
	Unilite.defineModel('Agj270skrModel1', {
		fields: [
	...
	Unilite.defineModel('Agj270skrModel2', {
		fields: [
    ...
    var reportStore = Unilite.createStore('Agj270skrReportStore',{
        uniOpt: {
            isMaster: false,
            editable: false,
            deletable: false,
	 ...
	 * @type 
	 */					
	var masterStore = Unilite.createStore('agj270skrDetailStore',{
		model: 'Agj270skrModel1',
		uniOpt : {
...
//                        reportStore.clearData();
	...
	var detailStore = Unilite.createStore('agj270skrDetailStore',{
			model: 'Agj270skrModel2',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {			
                	   read: 'agj270skrService.selectList2'                	
                }
            },
...
//			typeAhead: false,
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('agj270skrGrid', {
        layout : 'fit',
        region:'center',
        flex: 3,
    	store: masterStore,
    ...
    var detailGrid = Unilite.createGrid('agj270skrGrid2', {
    	// for tab    	
        layout : 'fit',
        region:'south',
        flex: 2,
    ...
    var detailForm = Unilite.createForm('agj270skrDetailForm',  {	
        itemId: 'agj270skrDetailForm',
