...
function appMain() {     
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'adt500ukrService.selectDetailList',
			update: 'adt500ukrService.updateDetail',
			create: 'adt500ukrService.insertDetail',
			destroy: 'adt500ukrService.deleteDetail',
			syncAll: 'adt500ukrService.saveAll'
		}
	});
	/**
	 *   Model 정의 
	 * @type 
	 */
	Unilite.defineModel('Adt500Model', {
	   fields: [
	...
	});		// End of Ext.define('Adt500ukrModel', {
	  
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('adt500MasterStore1',{
		model: 'Adt500Model',
		uniOpt: {
    ...
    var masterGrid = Unilite.createGrid('adt500Grid1', {
    	layout : 'fit',
        region : 'center',
