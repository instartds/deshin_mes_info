 ...
 */
    ...
    Unilite.defineModel('acm200ukrSlipModel', {
	...
	var drSum = 0; crSum = 0;
	var slipStore1 = Unilite.createStore('acm200ukrSlipStore1',{
			model: 'acm200ukrSlipModel',
            autoLoad: false,
            uniOpt : {
	...
	var slipStore2 = Unilite.createStore('acm200ukrSlipStore2',{
			model: 'acm200ukrSlipModel',
            autoLoad: false,
            uniOpt : {
            	isMaster: false,			// 상위 버튼 연결 
    ...
    var slipGrid1 = Unilite.createGrid('acm200ukrAccGrid1', {
		uniOpt:{
    ...
    var slipGrid2 = Unilite.createGrid('acm200ukrAccGrid2', {       
		uniOpt:{
        	expandLastColumn: false,
            useMultipleSorting: false,
            userToolbar:false
