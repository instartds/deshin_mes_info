...
function appMain() {
	...
	var sumTableSub2 = Unilite.createForm('sub2Form',{	//예정신고누락분-매입
		...
		items: [
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_10_32', id: 'TempS11',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_10_32', id: 'TempS12',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_10_33', id: 'TempS13',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_10_33', id: 'TempS14',value:0},
	...
	var sumTableSub3 = Unilite.createForm('sub3Form',{	//그밖의공제매입세액
		...
		items: [
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_31', id: 'TempS17',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_31', id: 'TempS18',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_63', id: 'TempS19',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_63', id: 'TempS20',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_32', id: 'TempS21',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_32', id: 'TempS22',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_33', id: 'TempS23',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_33', id: 'TempS24',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_55', id: 'TempS26',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_34', id: 'TempS28',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_35', id: 'TempS30',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_14_47', id: 'TempS32',value:0},
	...
	var sumTableSub4 = Unilite.createForm('sub4Form',{	//공제받지못할세액
		...
		items: [
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_37', id: 'TempS35',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_37', id: 'TempS36',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_38', id: 'TempS37',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_38', id: 'TempS38',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_39', id: 'TempS39',value:0},
			{ xtype: 'component',  html:''},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_39', id: 'TempS40',value:0},
	...
	var sumTableSub5 = Unilite.createForm('sub5Form',{	//그밖의공제.경감세액
		...
		items: [
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_16_46', id: 'TempS44',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_64', id: 'TempS46',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_41', id: 'TempS48',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_78', id: 'TempS94',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_16_47', id: 'TempS50',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_42', id: 'TempS52',value:0},
	...
	var sumTableSub6 = Unilite.createForm('sub6Form',{	//가산세액계
		...
		items: [
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_44', id: 'TempS55',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_44', id: 'TempS56',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_67', id: 'TempS57',value:0},
			{ xtype: 'component',  html:'1/100'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_67', id: 'TempS58',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_69', id: 'TempS59',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_69', id: 'TempS60',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_61', id: 'TempS61',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'TAX_61', id: 'TempS62',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_65', id: 'TempS63',value:0},
			{ xtype: 'component',  html:'5/1000'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_65', id: 'TempS64',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_66', id: 'TempS65',value:0},
			{ xtype: 'component',  html:'5/1000'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_66', id: 'TempS66',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_45', id: 'TempS67',value:0},
			{ xtype: 'component',  html:'1/100'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_45', id: 'TempS68',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_70', id: 'TempS69',value:0},
			{ xtype: 'component',  html:'5/1000'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_70', id: 'TempS70',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_46', id: 'TempS71',value:0},
			{ xtype: 'component',  html:'뒤쪽참조'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_46', id: 'TempS72',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_71', id: 'TempS73',value:0},
			{ xtype: 'component',  html:'뒤쪽참조'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_71', id: 'TempS74',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_72', id: 'TempS75',value:0},
			{ xtype: 'component',  html:'뒤쪽참조'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_72', id: 'TempS76',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_73', id: 'TempS77',value:0},
			{ xtype: 'component',  html:'뒤쪽참조'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_73', id: 'TempS78',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_47', id: 'TempS79',value:0},
			{ xtype: 'component',  html:'뒤쪽참조'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_47', id: 'TempS80',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_48', id: 'TempS81',value:0},
			{ xtype: 'component',  html:'5/1000'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_48', id: 'TempS82',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_56', id: 'TempS83',value:0},
			{ xtype: 'component',  html:'1/100'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_56', id: 'TempS84',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_74', id: 'TempS85',value:0},
			{ xtype: 'component',  html:'1/100'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_74', id: 'TempS86',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_75', id: 'TempS87',value:0},
			{ xtype: 'component',  html:'뒤쪽참조'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_75', id: 'TempS88',value:0},
			...
			{ xtype: 'uniNumberfield', 
					...
					name: 'AMT_76', id: 'TempS89',value:0},
			{ xtype: 'component',  html:'뒤쪽참조'},
			{ xtype: 'uniNumberfield', 
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name: 'TAX_76', id: 'TempS90',value:0},
	...
	var sumTableSetUp = Unilite.createForm('setUpForm',{	//설정
		...
		items: [{
			...
			items: [
				{ xtype: 'component',  html:'적용구분'},
				{ xtype: 'component',  html:'업종'},
				{ xtype: 'component',  html:'국가'},
				
				{ xtype: 'uniCombobox'	, name: 'ZERO_TAX_RECIP1'	, comboType: 'AU'	, comboCode: 'A246'	, width: 300 },
				{ xtype: 'uniTextfield'	, name: 'ZERO_TAX_CODE1' },
				{ xtype: 'uniCombobox'	, name: 'ZERO_TAX_NATION1'	, comboType: 'AU'	, comboCode: 'B012'	, width: 200 },
				
				{ xtype: 'uniCombobox'	, name: 'ZERO_TAX_RECIP2'	, comboType: 'AU'	, comboCode: 'A246'	, width: 300 },
				{ xtype: 'uniTextfield'	, name: 'ZERO_TAX_CODE2' },
				{ xtype: 'uniCombobox'	, name: 'ZERO_TAX_NATION2'	, comboType: 'AU'	, comboCode: 'B012'	, width: 200 },
				
				{ xtype: 'uniCombobox'	, name: 'ZERO_TAX_RECIP3'	, comboType: 'AU'	, comboCode: 'A246'	, width: 300 },
				{ xtype: 'uniTextfield'	, name: 'ZERO_TAX_CODE3' },
				{ xtype: 'uniCombobox'	, name: 'ZERO_TAX_NATION3'	, comboType: 'AU'	, comboCode: 'B012'	, width: 200 }
			]
//			[{
//				fieldLabel  : '적용구분',
//				xtype       : 'uniCombobox',
...
//			}]
	...
	var sumTable = Unilite.createForm('detailForm',{
			...
			items:[{
				...
				handler : function() {
					if(!UniAppManager.app.checkForNewDetail()){
						...
						atx300ukrService.dataCheck(param, function(provider, response)	{
		...
		items: [
			{ xtype: 'component',  html:'<b>신 고 내 용</b>', colspan: 7,tdAttrs: {width:1012,height:27}},
			{ xtype: 'component',  html:'구&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
				'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;분', colspan: 4,width:500,tdAttrs: {height:27}},
			{ xtype: 'component',  html:'금&nbsp;&nbsp;&nbsp;&nbsp;액',width: 200},
			{ xtype: 'component',  html:'세&nbsp;&nbsp;&nbsp;&nbsp;율', width:100},
			{ xtype: 'component',  html:'세&nbsp;&nbsp;&nbsp;&nbsp;액',width: 200},
			...
			{ xtype: 'uniNumberfield', value:0,
					...
					name:'AMT_57', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,
					...
					name:'TAX_57', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_62', width: '100%',tdAttrs: {width:'100%'}},
			{ xtype: 'component', html:'10/100', width: 100,tdAttrs: {width:100}},
			{ xtype: 'uniNumberfield', value:0,	
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name:'TAX_62', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_2', width: '100%',tdAttrs: {width:'100%'}},
			{ xtype: 'component', html:'10/100', width: 100,tdAttrs: {width:100}},
			{ xtype: 'uniNumberfield', value:0,	
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name:'TAX_2', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_3', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_4', width: '100%',tdAttrs: {width:'100%'}},
			{ xtype: 'component', html:'0/100', width: 100,tdAttrs: {width:100}},
			{ xtype: 'uniNumberfield', readOnly:true, width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'TAX_6', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_8', width: '100%',tdAttrs: {width:'100%'}},
			{ xtype: 'component', html:'', width: 100,tdAttrs: {width:100}},
			{ xtype: 'uniNumberfield', value:0,	
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name:'TAX_8', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'TAX_10_1', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_9', width: '100%',tdAttrs: {width:'100%'}},
			{ xtype: 'component', html:'', width: 100,tdAttrs: {width:100}},
			{ xtype: 'uniNumberfield', value:0,	
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name:'TAX_9', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_58', width: '100%',tdAttrs: {width:'100%'}},
			{ xtype: 'component', html:'', width: 100,tdAttrs: {width:100}},
			{ xtype: 'uniNumberfield', value:0,	
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name:'TAX_58', width: '100%',tdAttrs: {width:'100%'}},
		...
		{ xtype: 'component', html:'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'AMT_14', width: '100%',tdAttrs: {width:'100%'}},
			{ xtype: 'component', html:'', width: 100,tdAttrs: {width:100}},
			{ xtype: 'uniNumberfield', value:0,	
					listeners:{
						change:function(field, newValue, oldValue)	{
					...
					name:'TAX_14', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'TAX_17', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'TAX_18', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'TAX_23', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'TAX_59', width: '100%',tdAttrs: {width:'100%'}},
			...
			{ xtype: 'uniNumberfield', value:0,	
					...
					name:'TAX_77', width: '100%',tdAttrs: {width:'100%'}},
		...
		api: {
			load: 'atx300ukrService.selectForm' ,
			submit: 'atx300ukrService.syncMaster'
		},
	...
	Unilite.Main( {
		...
		onPrintButtonDown: function(type) {
			...
			var win = Ext.create('widget.ClipReport', {
				url: CPATH+'/accnt/atx300clukr.do',
				prgID: 'atx300ukr',
				extParam: param
				});
			win.center();
