...
<t:appConfig pgmId="afb510ukr"  >
	<t:ExtComboStore comboType="BOR120" pgmId="afb510ukr" /> 	<!-- 사업장 --> 
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'afb510ukrService.selectList',
			update: 'afb510ukrService.updateDetail',
			create: 'afb510ukrService.insertDetail',
			destroy: 'afb510ukrService.deleteDetail',
			syncAll: 'afb510ukrService.saveAll'
		}
	});
	...
	var MasterStore2 = Unilite.createStore('Afb510MasterStore2',{
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'afb510ukrService.selectList2'                	
            }
        },
        listeners:{
...
//			this.fnInitBinding();
	...
	function createModelField(budgNameList) {
		var fields = [
			...
			{name: 'FR_BUDG_YYYYMM'		, text: 'FR_BUDG_YYYYMM'	, type: 'string'},
