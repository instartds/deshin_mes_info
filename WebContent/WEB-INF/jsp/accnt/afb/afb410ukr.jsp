...
var lastYearCopyWindow; // 전년도자료복사 버튼
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'afb410ukrService.selectList',
			update: 'afb410ukrService.updateMulti',
			//create: 'afb410ukrService.insertDetail',
			destroy: 'afb410ukrService.deleteMulti',
			syncAll: 'afb410ukrService.saveAll'
		}
	});
	/**
	 *   Model 정의 
						...
						handler : function(records) {
							if(!UniAppManager.app.checkForNewDetail()) {
								...
								if(Ext.getCmp('RDO_SELECT').getChecked()[0].inputValue == '1') {
									...
									afb410ukrService.insertDataCopy(param, function(provider, response)	{ 
										alert("완료 되었습니다.");
									});
									...
									afb410ukrService.deleteDataCopy(param, function(provider, response)	{ 
										alert("완료 되었습니다.");
									});
									lastYearCopyWindow.hide();
								}
...
//  				}
    ...
    Unilite.Main( {
		...
		onDeleteDataButtonDown : function()	{
			...
			afb410ukrService.selectAfb500tBeforeSave(params, 
				function(provider1, response) {
					afb410ukrService.selectAfb510tBeforeSave(params, 
