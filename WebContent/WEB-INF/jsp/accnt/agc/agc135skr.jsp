...
function appMain() {
	 ...
	 * 제조원가명세서			agc135skrs1
	 * 용역원가명세서			agc135skrs1
	 * 용역원가명세서2			agc135skrs1
	 * 이익잉여금처분계산서		agc135skrs2
	 * 자본변동표				agc135skrs3
	 * */
	var getStDt = ${getStDt};
	 ...
	 * @type 
	 */
	Unilite.defineModel('agc135skrModel', {
	    fields: [  	  
	...
	Unilite.defineModel('agc135skrModel2', {
	    fields: [  	  
	    	{name: 'ACCNT_CD'		, text: '계정코드' 		,type: 'string'},
		    {name: 'ACCNT_NAME'		, text: '과목'			,type: 'string'},
		    {name: 'AMT_I1'			, text: '금액' 			,type: 'uniPrice'},
	...
	Unilite.defineModel('agc135skrModel3', {
	    fields: [  	  
	    	{name: 'ACCNT_CD'		, text: '계정코드' 		,type: 'string'},
		    {name: 'ACCNT_NAME'		, text: '과목'			,type: 'string'},
		    {name: 'AMT_I1'			, text: '금액' 			,type: 'uniPrice'},
	...
	Unilite.defineModel('agc135skrModel4', {
	    fields: [  	  
	    	{name: 'ACCNT_CD'		, text: '계정코드' 		,type: 'string'},
		    {name: 'ACCNT_NAME'		, text: '과목'			,type: 'string'},
		    {name: 'AMT_I1'			, text: '금액' 			,type: 'uniPrice'},
	...
	Unilite.defineModel('agc135skrModel5', {
	    fields: [  	  
	    	{name: 'ACCNT_CD'		, text: '계정코드' 		,type: 'string'},
		    {name: 'ACCNT_NAME'		, text: '과목'			,type: 'string'},
		    {name: 'AMT_I1'			, text: '금액' 			,type: 'uniPrice'},
	...
	Unilite.defineModel('agc135skrModel6', {
	    fields: [  	  
	    	{name: 'ACCNT_NAME'		, text: '과목' 			,type: 'string'},
		    {name: 'AMT_I1'			, text: '금액' 			,type: 'uniPrice'},
		    {name: 'AMT_I2'			, text: '금액'			,type: 'uniPrice'},
	...
	Unilite.defineModel('agc135skrModel7', {
	    fields: [  	  
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('agc135skrMasterStore1',{
		model: 'agc135skrModel',
		uniOpt: {
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc135skrService.selectList1'                	
            }
        },
	...
	var directMasterStore2 = Unilite.createStore('agc135skrMasterStore2',{
		model: 'agc135skrModel2',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,		// 수정 모드 사용 
            deletable:false,		// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc135skrService.selectList2'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
	...
	var directMasterStore3 = Unilite.createStore('agc135skrMasterStore3',{
		model: 'agc135skrModel3',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,		// 수정 모드 사용 
            deletable:false,		// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc135skrService.selectList3'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
	...
	var directMasterStore4 = Unilite.createStore('agc135skrMasterStore4',{
		model: 'agc135skrModel4',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,		// 수정 모드 사용 
            deletable:false,		// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc135skrService.selectList4'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
	...
	var directMasterStore5 = Unilite.createStore('agc135skrMasterStore5',{
		model: 'agc135skrModel5',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,		// 수정 모드 사용 
            deletable:false,		// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc135skrService.selectList5'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
	...
	var directMasterStore6 = Unilite.createStore('agc135skrMasterStore6',{
		model: 'agc135skrModel6',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,		// 수정 모드 사용 
            deletable:false,		// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc135skrService.selectList6'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
	...
	var directMasterStore7 = Unilite.createStore('agc135skrMasterStore7',{
		model: 'agc135skrModel7',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,		// 수정 모드 사용 
            deletable:false,		// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc135skrService.selectList7'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
    ...
    var masterGrid1 = Unilite.createGrid('agc135skrGrid1', {
    	title  : tabTitle1,
    	hidden : hideTab1,
    	...
    	tbar:[
        	...
        	},
        	{
	        	...
	        	handler:function()	{
                    ...
                    var rec = {data : {prgID : 'agc135rkr', 'text':''}};
                    parent.openTab(rec, '/accnt/agc135rkr.do', params, CHOST+CPATH); 
		...
		listeners: {
            ...
            onGridDblClick :function( grid, record, cellIndex, colName ) {
	        	if(record.get('DIS_DIVI') != '3'){
					masterGrid1.gotoagc135skr(record);
	        	}
            }
        },  
			...
			items: [
	            {	text	: '보조부 보기',   
	            	handler	: function(menuItem, event) {
	            		...
	            		masterGrid1.gotoagc135skr(param.record);
	            	}
	        	}
	        ]
	    },
	    gotoagc135skr:function(record)	{
	    	if(record)	{	
	    		var params = {
		    		action:'select',
			    	'PGM_ID' 			: 'agc135skr',   	
	     ...
	     /*gotoagc135skr:function(grid, record, cellIndex, colName)	{  // 로직 수정필요
			if(record)	{	
				switch(colName)	{
					case 'ACCNT_CD':
					case 'ACCNT_NAME':
      ...
      var masterGrid2 = Unilite.createGrid('agc135skrGrid2', {
    	title  : tabTitle2,
    	hidden : hideTab2,
		...
		listeners: {
            ...
            onGridDblClick :function( grid, record, cellIndex, colName ) {
	        	if(record.get('DIS_DIVI') != '3'){
					masterGrid2.gotoagc135skr(record);
	        	}
            }
        },  
        onItemcontextmenu:function( menu, grid, record, item, index, event  )	{          		
      	...
      	uniRowContextMenu:{
			items: [
	            {	text	: '보조부 보기',   
	            	handler	: function(menuItem, event) {
	            		var param = menuItem.up('menu');
	            		masterGrid2.gotoagc135skr(param.record);
	            	}
	        	}
	        ]
	    },
      ...
      var masterGrid3 = Unilite.createGrid('agc135skrGrid3', {
    	title  : tabTitle3,
    	hidden : hideTab3,
		...
		listeners: {
            ...
            onGridDblClick :function( grid, record, cellIndex, colName ) {
	        	if(record.get('DIS_DIVI') != '3'){
					masterGrid3.gotoagc135skr(record);
	        	}
            }
        },  
        onItemcontextmenu:function( menu, grid, record, item, index, event  )	{          		
      	...
      	uniRowContextMenu:{
			items: [
	            {	text	: '보조부 보기',   
	            	handler	: function(menuItem, event) {
	            		var param = menuItem.up('menu');
	            		masterGrid3.gotoagc135skr(param.record);
	            	}
	        	}
	        ]
	    },
      ...
      var masterGrid4 = Unilite.createGrid('agc135skrGrid4', {
    	title  : tabTitle4,
    	hidden : hideTab4,
		...
		listeners: {
            ...
            onGridDblClick :function( grid, record, cellIndex, colName ) {
	        	if(record.get('DIS_DIVI') != '3'){
					masterGrid4.gotoagc135skr(record);
	        	}
            }
        },  
        onItemcontextmenu:function( menu, grid, record, item, index, event  )	{          		
      	...
      	uniRowContextMenu:{
			items: [
	            {	text	: '보조부 보기',   
	            	handler	: function(menuItem, event) {
	            		var param = menuItem.up('menu');
	            		masterGrid4.gotoagc135skr(param.record);
	            	}
	        	}
	        ]
	    },
      ...
      var masterGrid5 = Unilite.createGrid('agc135skrGrid5', {
    	title  : tabTitle5,
    	hidden : hideTab5,
		...
		listeners: {
            ...
            onGridDblClick :function( grid, record, cellIndex, colName ) {
	        	if(record.get('DIS_DIVI') != '3'){
					masterGrid5.gotoagc135skr(record);
	        	}
            }
        },  
        onItemcontextmenu:function( menu, grid, record, item, index, event  )	{          		
      	...
      	uniRowContextMenu:{
			items: [
	            {	text	: '보조부 보기',   
	            	handler	: function(menuItem, event) {
	            		var param = menuItem.up('menu');
	            		masterGrid5.gotoagc135skr(param.record);
	            	}
	        	}
	        ]
	    },
      ...
      var masterGrid6 = Unilite.createGrid('agc135skrGrid6', {
    	title  : tabTitle6,
    	hidden : hideTab6,
		...
		listeners: {
            ...
            onGridDblClick :function( grid, record, cellIndex, colName ) {
	        	if(record.get('DIS_DIVI') != '3'){
					masterGrid6.gotoagc135skr(record);
	        	}
            }
        },  
        onItemcontextmenu:function( menu, grid, record, item, index, event  )	{          		
      	...
      	uniRowContextMenu:{
			items: [
	            {	text	: '보조부 보기',   
	            	handler	: function(menuItem, event) {
	            		var param = menuItem.up('menu');
	            		masterGrid6.gotoagc135skr(param.record);
	            	}
	        	}
	        ]
	    },
      ...
      var masterGrid7 = Unilite.createGrid('agc135skrGrid7', {
    	title  : tabTitle7,
    	hidden : hideTab7,
		...
		listeners: {
            ...
            onGridDblClick :function( grid, record, cellIndex, colName ) {
	        	if(record.get('DIS_DIVI') != '3'){
					masterGrid7.gotoagc135skr(record);
	        	}
            }
        },  
        onItemcontextmenu:function( menu, grid, record, item, index, event  )	{          		
      	...
      	uniRowContextMenu:{
			items: [
	            {	text	: '보조부 보기',   
	            	handler	: function(menuItem, event) {
	            		var param = menuItem.up('menu');
	            		masterGrid7.gotoagc135skr(param.record);
	            	}
	        	}
	        ]
	    },
    ...
    var commentSearch = Unilite.createSearchForm('CommentSearch', { //주석
		...
		items :[{
			...
			api: {
				load : 'agc135skrService.selectForm',
            	submit: 'agc135skrService.syncForm'	
            },
    ...
    var tab = Unilite.createTabPanel('tabPanel',{
	 ...
	 Unilite.Main( {
		...
		onQueryButtonDown : function()	{		
			...
			if(activeTabId == 'agc135skrGrid1'){	
				masterGrid1.down('#CHANGE_NAME1').setText('제 ' + UniAppManager.app.fnCalSession('THIS_START_DATE') + ' 당(기)');
				masterGrid1.down('#CHANGE_NAME2').setText('제 ' + UniAppManager.app.fnCalSession('PREV_START_DATE') + ' 전(기)');
				directMasterStore.loadStoreRecords();
			}
			else if(activeTabId == 'agc135skrGrid2'){
			...
			else if(activeTabId == 'agc135skrGrid3'){
			...
			else if(activeTabId == 'agc135skrGrid4'){
			...
			else if(activeTabId == 'agc135skrGrid5'){
			...
			else if(activeTabId == 'agc135skrGrid6'){
			...
			else if(activeTabId == 'agc135skrGrid7'){						
