...
// 	 		alert(month);
	 ...
	 * @type 
	 */
	Unilite.defineModel('Agc170skrModel', {
	    fields: [  	  
	...
	Unilite.defineModel('Agc170skrModel2', {
	    fields: [  	  
	    	{name: 'GRP'			, text: 'GRP' 		,type: 'string'},
		    {name: 'ACCNT_CD'		, text: '항목코드'		,type: 'string'},
		    {name: 'ACCNT_NAME'		, text: '항목명' 		,type: 'string'},
	...
	Unilite.defineModel('Agc170skrModel3', {
	    fields: [  	  
	    	{name: 'GRP'			, text: 'GRP' 		,type: 'string'},
		    {name: 'ACCNT_CD'		, text: '항목코드'		,type: 'string'},
		    {name: 'ACCNT_NAME'		, text: '항목명' 		,type: 'string'},
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('agc170skrMasterStore1',{
		model: 'Agc170skrModel',
		uniOpt: {
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc170skrService.selectList1'                	
            }
        },
	...
	var directMasterStore2 = Unilite.createStore('agc170skrMasterStore2',{
		model: 'Agc170skrModel2',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,			// 수정 모드 사용 
            deletable:false,			// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc170skrService.selectList2'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
	...
	var directMasterStore3 = Unilite.createStore('agc170skrMasterStore3',{
		model: 'Agc170skrModel3',
		uniOpt: {
            isMaster: true,			// 상위 버튼 연결 
            editable: false,			// 수정 모드 사용 
            deletable:false,			// 삭제 가능 여부 
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'agc170skrService.selectList3'                	
            }
        },
        loadStoreRecords: function() {
			var param= Ext.getCmp('searchForm').getValues();			
    ...
    var masterGrid = Unilite.createGrid('agc170skrGrid1', {
    	title  : tabTitle1,
    	hidden : hideTab1,
...
//				}
    ...
    var masterGrid2 = Unilite.createGrid('agc170skrGrid2', {
    	title  : tabTitle2,
    	hidden : hideTab2,
...
//				}
    ...
    var masterGrid3 = Unilite.createGrid('agc170skrGrid3', {
    	title  : tabTitle3,
    	hidden : hideTab3,
...
//				}
     ...
     var tab = Unilite.createTabPanel('tabPanel',{
	    ...
	    listeners:{
    		...
    		tabchange: function( tabPanel, newCard, oldCard, eOpts )	{
    			...
    			if(newCard.getItemId() == 'agc170skrGrid1')	{					       
					changeColumns(month);
    				UniAppManager.app.onQueryButtonDown();
    			}else if(newCard.getItemId() == 'agc170skrGrid2') {						       
					changeColumns2(month);
    				UniAppManager.app.onQueryButtonDown();
    			}else if(newCard.getItemId() == 'agc170skrGrid3') {						       
	...
	Unilite.Main( {
		...
		fnInitBinding : function() {
			...
			//changeColumns2(month);
			//changeColumns3(month);
			UniAppManager.app.fnSetGridHeaderMonth(masterGrid , value);
			UniAppManager.app.fnSetGridHeaderMonth(masterGrid2, value);
			UniAppManager.app.fnSetGridHeaderMonth(masterGrid3, value);
		...
		onQueryButtonDown : function()	{	
			...
			if(activeTabId == 'agc170skrGrid1'){	
				UniAppManager.app.fnSetGridHeaderMonth(masterGrid, value);
				directMasterStore.loadStoreRecords();				
			}else if (activeTabId == 'agc170skrGrid2'){	
				UniAppManager.app.fnSetGridHeaderMonth(masterGrid2, value);
				directMasterStore2.loadStoreRecords();			
			}else if (activeTabId == 'agc170skrGrid3'){	
				UniAppManager.app.fnSetGridHeaderMonth(masterGrid3, value);
		...
		fnGotoAgc170rkr: function(type) {
			...
			var rec = {data : {prgID : 'agc170rkr', 'text':''}};
			parent.openTab(rec, '/accnt/agc170rkr.do', params); 
        },
        fnSetGridHeaderMonth : function(grid, dt) {
        	dt = UniDate.getDbDateStr(dt);
        	
        	for(var i = 0; i < 12; i++) {
        		var mon = this.addMonth(dt, i);
        		grid.columns[i+6].setText(mon.substring(0, 4) + '.' + mon.substring(4, 6));
        	}
        },
