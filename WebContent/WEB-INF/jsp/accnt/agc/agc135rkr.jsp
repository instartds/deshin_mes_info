...
<t:appConfig pgmId="agc135rkr"  >
	<t:ExtComboStore comboType="BOR120"  /> 			<!-- 사업장 -->
	<t:ExtComboStore comboType="AU" comboCode="A054"  opts= '10;20;30;31;32;40;35'/> <!-- 재무제표양식구분-->
...
//	}
	...
	var panelSearch = Unilite.createSearchForm('agc135rkrForm', {
		region: 'center',
    	disabled :false,
    	border: false,
    	flex:1,
...
//			var param= Ext.getCmp('searchForm').getValues();
			var win = Ext.create('widget.PDFPrintWindow', {
				url: CPATH+'/agc/agc135rkrPrint.do',
				prgID: 'agc135rkr',
				extParam: {
