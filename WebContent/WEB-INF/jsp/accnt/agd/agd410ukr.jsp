...
//	bookCode2		= '';
	...
	var directButtonProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
            create	: 'agd410ukrService.runProcedure',
            syncAll	: 'agd410ukrService.callProcedure'
		}
	});	
	 ...
	 * @type 
	 */
	Unilite.defineModel('agd410ukrModel', {
	   fields: [
	...
	});		// End of Ext.define('agd410ukrModel', {
	  
	/* Store 정의(Service 정의)
	 * @type 
	 */					
	var masterStore = Unilite.createStore('agd410ukrmasterStore',{
		model	: 'agd410ukrModel',
		uniOpt	: {
        ...
        proxy	: {
           type	: 'direct',
            api	: {			
                read: 'agd410ukrService.selectList'                	
            }
        },
    ...
    var buttonStore = Unilite.createStore('agd410ukrButtonStore',{ 
...
//			paramMaster.BOOK_CODE2		= bookCode2;												//addresult 설정계정의 BOOK_CODE2
            ...
            if(inValidRecs.length == 0) {
                ...
                var grid = Ext.getCmp('agd410ukrGrid');
...
//			colspan: 2,
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('agd410ukrGrid', {
		store	: masterStore,
    	layout	: 'fit',
        region	: 'center',
    	features: [
