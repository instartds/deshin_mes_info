...
//	bookCode2		= '';
	...
	var directButtonProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
            create	: 'agd390ukrService.runProcedure',
            syncAll	: 'agd390ukrService.callProcedure'
		}
	});	
	 ...
	 * @type 
	 */
	Unilite.defineModel('agd390ukrModel', {
	   fields: [
			...
			{name: 'RE_SLIP_NUM'		, text: '선급비용 -> 비용 회계번호'		, type: 'int'     },
			{name: 'INSERT_DB_USER'		, text: '입력자'					, type: 'string'  },
			{name: 'INSERT_DB_TIME'		, text: '입력일'					, type: 'uniDate' },
			{name: 'UPDATE_DB_USER'		, text: '수정자'					, type: 'string'  },
			{name: 'UPDATE_DB_TIME'		, text: '수정일'					, type: 'uniDate' }
	    ]
	});		// End of Ext.define('agd390ukrModel', {
	  
	/* Store 정의(Service 정의)
	 * @type 
	 */					
	var masterStore = Unilite.createStore('agd390ukrmasterStore',{
		model	: 'agd390ukrModel',
		uniOpt	: {
        ...
        proxy	: {
           type	: 'direct',
            api	: {			
                read: 'agd390ukrService.selectList'                	
            }
        },
    ...
    var buttonStore = Unilite.createStore('agd390ukrButtonStore',{ 
...
//			paramMaster.BOOK_CODE2		= bookCode2;												//addresult 설정계정의 BOOK_CODE2
            ...
            if(inValidRecs.length == 0) {
                ...
                var grid = Ext.getCmp('agd390ukrGrid');
...
//			colspan: 2,
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('agd390ukrGrid', {
		store	: masterStore,
    	layout	: 'fit',
        region	: 'center',
    	features: [
