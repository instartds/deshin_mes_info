...
function appMain() {
    ...
    var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            create    : 'axt100ukrService.insertList',                
            read      : 'axt100ukrService.selectList',
            update    : 'axt100ukrService.updateList',
            destroy   : 'axt100ukrService.deleteList',
            syncAll   : 'axt100ukrService.saveAll'
        }
    });
     ...
     * @type 
     */
    Unilite.defineModel('axt100ukrModel', {
        fields: [
            ...
            {name: 'IN_FOR_AMOUNT'       , text: '외화(USD/EUR)' , type: 'uniFC'},
    ...
    });//End of Unilite.defineModel('axt100ukrModel', {
     ...
     * @type 
     */            
    var masterStore = Unilite.createStore('axt100ukrMasterStore1', {
        model    : 'axt100ukrModel',
        proxy    : directProxy,
        uniOpt    : {
...
//              multiSelect    : true, 
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('axt100ukrGrid1', {
        store    : masterStore,
        layout    : 'fit',
        region    : 'center',
        uniOpt    : {
...
//        }
    ...
    });//End of var masterGrid = Unilite.createGr100id('axt100ukrGrid1', {    
