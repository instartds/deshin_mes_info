<%@page language="java" contentType="text/html; charset=utf-8"%>
	<t:appConfig pgmId="map103ukrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="map103ukrv"   />          <!-- 사업장 -->
...
function appMain() {
    ...
    */
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'map103ukrvService.selectList',
			update: 'map103ukrvService.updateDetail',
			create: 'map103ukrvService.insertDetail',
			destroy: 'map103ukrvService.deleteDetail',
			syncAll: 'map103ukrvService.saveAll'
		}
	});	
	
	Unilite.defineModel('Map103ukrvModel', {
		fields: [
			...
			{name: 'ORDER_UNIT_Q'     , text: '<t:message code="system.label.purchase.purchaseqty" default="매입량"/>'			, type: 'uniQty'},
			...
			{name: 'FOREIGN_P'	      , text: '<t:message code="system.label.purchase.foreigncurrencyunit" default="외화단가"/>'			, type: 'uniFC'},
			...
			{name: 'BILL_DIV_CODE'    , text: '매입사업장'			, type: 'string'},
	...
	});//End of Unilite.defineModel('Map103ukrvModel', {
	...
	Unilite.defineModel('map103ukrvRECEIVEModel', {	//입고내역참조 
	    fields: [
	    	{name: 'COMP_CODE'    	    	, text: '<t:message code="system.label.purchase.companycode" default="법인코드"/>'    	, type: 'string'},
	    	...
	    	{name: 'INOUT_P'  	    		, text: '<t:message code="system.label.purchase.price" default="단가"/>'		, type: 'uniUnitPrice', allowBlank: false},
	    	{name: 'INOUT_Q'           		, text: '<t:message code="system.label.purchase.qty" default="수량"/>'		, type: 'uniQty', allowBlank: false},
...
//			{name: 'INOUT_TYPE'	     	    , text: '유형'    	, type: 'string'},
...
//			{name: 'AMOUNT_P'        	    , text: '<t:message code="system.label.purchase.price" default="단가"/>'    	, type: 'uniPrice'},
 ...
 */
	...
	Unilite.defineModel('map103ukrvRETURNINGModel', {	//반품내역참조 
	    fields: [
	    	{name: 'INOUT_DATE'    	    	, text: '반품일자'    	, type: 'uniDate'},
	    	{name: 'ITEM_CODE'	     	    , text: '<t:message code="system.label.purchase.itemcode" default="품목코드"/>'    	, type: 'string'},
			{name: 'ITEM_NAME'	     	    , text: '<t:message code="system.label.purchase.itemname" default="품목명"/>'    	, type: 'string'},
			{name: 'SPEC'		     	    , text: '<t:message code="system.label.purchase.spec" default="규격"/>'    	, type: 'string'},
			{name: 'ORDER_UNIT'	     	    , text: '<t:message code="system.label.purchase.purchaseunit" default="구매단위"/>'    	, type: 'string'},
...
/*
			...
			{name: 'ORDER_UNIT_Q'    	    , text: '반품수량'  , type: 'uniQty'},
			{name: 'ORDER_UNIT_P'    	    , text: '<t:message code="system.label.purchase.purchaseprice" default="구매단가"/>'  , type: 'uniUnitPrice'},
			{name: 'AMOUNT_P'        	    , text: '<t:message code="system.label.purchase.price" default="단가"/>'    	, type: 'uniUnitPrice'},
			{name: 'AMOUNT_I'        	    , text: '<t:message code="system.label.purchase.amount" default="금액"/>'    	, type: 'uniPrice'},
			{name: 'ORDER_UNIT_FOR_P'	    , text: '구매단위외화단가', type: 'uniUnitPrice'},
			...
			{name: 'INOUT_NUM'	     	    , text: '반품번호'    	, type: 'string'},
			{name: 'INOUT_SEQ'	     	    , text: '<t:message code="system.label.purchase.seq" default="순번"/>'    	, type: 'string'},
			{name: 'TAX_CALC_TYPE'	 	    , text: '<t:message code="system.label.purchase.taxcalculationmethod" default="세액계산방법"/>'  , type: 'string'},
			{name: 'REMARK'	         	    , text: '<t:message code="system.label.purchase.remarks" default="비고"/>'    	, type: 'string'},
			{name: 'PROJECT_NO'      	    , text: '<t:message code="system.label.purchase.manageno" default="관리번호"/>'    	, type: 'string'},
			{name: 'PURCHASE_TYPE'    		, text: 'PURCHASE_TYPE'	, type: 'string'},
			{name: 'INOUT_TYPE'       		, text: 'INOUT_TYPE'	, type: 'string'}
	...
	Unilite.defineModel('map103ukrvORDERModel', {	//발주내역참조(선지급)
	    fields: [
		//	{name: 'GUBUN'        		, text: '<t:message code="system.label.purchase.selection" default="선택"/>'    	, type: 'string'},
    ...
    * @type 
    */               
	var directMasterStore1 = Unilite.createStore('map103ukrvMasterStore1',{
		model: 'Map103ukrvModel',
		uniOpt: {
...
////							alert(CustomCodeInfo.gsTaxCalcType);
	...
	});//End of var directMasterStore1 = Unilite.createStore('map103ukrvMasterStore1',{
	...
	var buyslipNoMasterStore = Unilite.createStore('buyslipNoMasterStore', {	//조회버튼 누르면 나오는 조회창
        ...
        proxy: {
            type: 'direct',
            api: {
            	read: 'map103ukrvService.selectOrderNumMasterList'
            }
        },
        loadStoreRecords : function()	{
	...
	var receiveHistoryStore = Unilite.createStore('map103ukrvReceiveHistoryStore', {//입고내역참조
		model: 'map103ukrvRECEIVEModel',
        autoLoad: false,
        uniOpt: {
        	isMaster: false,			// 상위 버튼 연결
        	editable: false,			// 수정 모드 사용
        ...
        proxy: {
            type: 'direct',
            api: {
            	read: 'map103ukrvService.selectreceiveHistoryList'                	
            }
        },
	...
	var returningHistoryStore = Unilite.createStore('map103ukrvReturningHistoryStore', {//반품내역참조
		model: 'map103ukrvRETURNINGModel',
        autoLoad: false,
        uniOpt: {
        	isMaster: false,			// 상위 버튼 연결
        	editable: false,			// 수정 모드 사용
        ...
        proxy: {
            type: 'direct',
            api: {
            	read: 'map103ukrvService.selectreturningHistoryList'                	
            }
        },
	...
	var orderHistoryStore = Unilite.createStore('map103ukrvOrderHistoryStore', {//발주내역참조(선지급)
		model: 'map103ukrvORDERModel',
        autoLoad: false,
        uniOpt: {
        	isMaster: false,			// 상위 버튼 연결
        	editable: false,			// 수정 모드 사용
        ...
        proxy: {
            type: 'direct',
            api: {
            	read : 'map103ukrvService.selectorderHistoryList'               	
            }
        },
        listeners: {
        	load:function(store, records, successful, eOpts)	{
    ...
    */
    var masterForm = Unilite.createSearchPanel('searchForm', {		
		...
		api: {
			load: 'map103ukrvService.selectForm',
			submit: 'map103ukrvService.syncForm'				
		},		
...
//								
    ...
    var receivehistorySearch = Unilite.createSearchForm('receivehistoryForm', {//입고내역참조
            ...
            items: [
				...
				Unilite.popup('DIV_PUMOK', {
					...
					listeners: {
					applyextparam: function(popup){							
							popup.setExtParam({'DIV_CODE': receivehistorySearch.getValue('DIV_CODE')});
						}
					}
				}),
				{
     ...
     * @type 
     */
	var masterGrid = Unilite.createGrid('map103ukrvGrid1', {
       // for tab       
		layout: 'fit',
		region:'center',
		...
		columns: [
			...
			{dataIndex: 'LC_NUM'		   , width: 86 },
			{dataIndex: 'BL_NUM'	       , width: 86 },
...
/*		disabledLinkButtons: function(b) {
	...
	//		grdRecord.set('CHANGE_BASIS_SEQ'	, lSerNo); 추후
			...
			grdRecord.set('ORDER_UNIT_P'		, record['ORDER_UNIT_P']);
			grdRecord.set('AMOUNT_I'			, record['REMAIN_AMOUNT']);
	...
	});//End of var masterGrid = Unilite.createGrid('map103ukrvGrid1', {   

    var buyslipNoMasterGrid = Unilite.createGrid('map103ukrvbuyslipNoMasterGrid', {		//조회버튼 누르면 나오는 조회창
        // title: '기본',
        layout: 'fit',       
    ...
    var receivehistoryGrid = Unilite.createGrid('map103ukrvreceivehistoryGrid', {//입고내역참조
        // title: '기본',
        layout: 'fit',
        ...
        columns: [  
        	...
        	{ dataIndex: 'INOUT_I' 				     	,  width: 80},
        	{ dataIndex: 'INOUT_TAX_AMT' 		     	,  width: 80},
        	{ dataIndex: 'TOTAL_INOUT_I' 		     	,  width: 80},
...
//			{ dataIndex: 'INOUT_TAX_AMT'   			,  width: 100 },
    ...
    var returninghistoryGrid = Unilite.createGrid('map103ukrvreturninghistoryGrid', {//반품내역참조
        // title: '기본',
        layout: 'fit',
    ...
    var orderhistoryGrid = Unilite.createGrid('map103ukrvorderhistoryGrid', {//발주내역참조(선지급)
        // title: '기본',
        layout: 'fit',
...
//			Call fnFirstCombo(ComRs, 0, txtOrderType)
        	...
        	masterForm.setValue('BILL_DATE', (UniDate.get('today')-1));
        	masterForm.setValue('CHANGE_BASIS_DATE', (UniDate.get('today')-1));
        	
        	panelResult.setValue('DIV_CODE',UserInfo.divCode);
			panelResult.setValue('BILL_DIV_CODE',UserInfo.divCode);
			panelResult.setValue('ORDER_TYPE','1');
        	panelResult.setValue('BILL_DATE', (UniDate.get('today')-1));
        	panelResult.setValue('CHANGE_BASIS_DATE', (UniDate.get('today')-1));
