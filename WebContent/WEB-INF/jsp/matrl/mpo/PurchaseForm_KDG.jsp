        	...
        	mpo150skrvService.selectList_yp(param, function(provider, response)  {
                ...
                var requestMsg =              '<!doctype html>';
                    ...
                    if(Ext.isEmpty(provider[0].RESPONSIBILITY_PHONE)){
                    	requestMsg +=  '    <td style="border:0px gray solid;padding: 5px 10px; text-align:left; text-overflow: ellipsis;" colspan="1"><b>구매담당: <ins>'+ masterRec.get('ORDER_PRSN') +'</ins></b></td>';
                    }else{
                    	requestMsg +=  '    <td style="border:0px gray solid;padding: 5px 10px; text-align:left; text-overflow: ellipsis;" colspan="1"><b>구매담당: <ins>'+ masterRec.get('ORDER_PRSN') + '('  +  provider[0].RESPONSIBILITY_PHONE + ')' + '</ins></b></td>';
                    }
                    requestMsg +=  '  </tr>';
                    requestMsg +=  '  <tr style="border:0px gray solid;padding: 5px 10px;">';
