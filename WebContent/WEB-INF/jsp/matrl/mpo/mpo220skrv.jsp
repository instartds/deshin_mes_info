...
<t:appConfig pgmId="mpo220skrv" >
	<t:ExtComboStore comboType="BOR120" pgmId="mpo220skrv" /> 				<!-- 사업장 -->
...
function appMain() {
	 ...
	 */
	 ...
	 Unilite.defineModel('Mpo220skrvModel', {
		fields: [
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'mpo220skrvService.selectList',
			update: 'mpo220skrvService.updateDetail',
			syncAll: 'mpo220skrvService.saveAll'
		}
	});
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('mpo220skrvMasterStore1', {
		model: 'Mpo220skrvModel',
		uniOpt: {
		...
		items: [{	
			...
			items: [{
				...
				listeners: {
		 		...
		 		listeners: {
					change: function(field, newValue, oldValue, eOpts) {						
						panelResult.setValue('WEEK_DAY', newValue);
					}
				}
			}]
		}]
     ...
     * @type 
     */
	var masterGrid = Unilite.createGrid('mpo220skrvGrid1', {
		layout: 'fit',
		region: 'center',
