...
//					value: UniDate.get('yesterday'),
			     	...
			     	items: [{
							...
							handler : function() {
								...
								if(confirm(Msg.sMB063)) {
									...
									Mrp110ukrvService.spCall(param, function(provider, response) {
										if(provider != null) {
											alert('<t:message code="system.message.purchase.message054" default="MRP 작업이 완료되었습니다."/>');
										}
			...
			api: {
         		 submit: 'Mrp110ukrvService.executeMrp'
