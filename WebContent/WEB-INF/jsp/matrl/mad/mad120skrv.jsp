...
<t:appConfig pgmId="mad120skrv" >
	<t:ExtComboStore comboType="BOR120" pgmId="mad120skrv" /> 				<!-- 사업장 -->
...
function appMain() {
	...
	Unilite.defineModel('Mad120skrvModel', {
	    fields: [
	    	...
	    	{name: 'SUM_STOCK_Q'		, text: '<t:message code="system.label.purchase.qty" default="수량"/>'		, type: 'uniQty'},
	    	{name: 'SUM_STOCK_I'		, text: '<t:message code="system.label.purchase.amount" default="금액"/>'		, type: 'uniPrice'},
	    	{name: 'SUM_STOCK_TAX_AMT'	, text: '<t:message code="system.label.purchase.vatamount" default="부가세액"/>'		, type: 'uniPrice'},
	    	{name: 'TOTAL_SUM_STOCK_I'	, text: '재고합계'		, type: 'uniPrice'}
	    	
	    ]
	});//End of Unilite.defineModel('Mad120skrvModel', {
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('mad120skrvMasterStore1', {
		model: 'Mad120skrvModel',
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {			
				read: 'mad120skrvService.selectList'                	
			}
		},
		...
		groupField: 'CUSTOM_NAME'
			*/
	});//End of var directMasterStore1 = Unilite.createStore('mad120skrvMasterStore1', {
     ...
     * @type 
     */
	var masterGrid = Unilite.createGrid('mad120skrvGrid1', {
    	// for tab    	
		layout: 'fit',
		region: 'center',
		excelTitle: '거래처별 입고/재고현황',
        uniOpt: {
			...
			{ 
         	...
         	text:'반품',
	      	...
	      	text:'<t:message code="system.label.purchase.onhandstock" default="현재고"/>',
     			columns: [
		        	{dataIndex: 'SUM_STOCK_Q'		, width: 88,summaryType: 'sum'},
		        	{dataIndex: 'SUM_STOCK_I'		, width: 120,summaryType: 'sum'},
		        	{dataIndex: 'SUM_STOCK_TAX_AMT'		, width: 90,summaryType: 'sum'},
		        	{dataIndex: 'TOTAL_SUM_STOCK_I'		, width: 120,summaryType: 'sum'}
	        	]
			}],
		listeners: {
			onGridDblClick: function(grid, record, cellIndex, colName) {
				...
				var rec = {data : {prgID : 'mad130skrv'}};							
					parent.openTab(rec, '/matrl/'+'mad130skrv'+'.do', params);	
			}
		}
    }); 
...
//			panelResult.setValue('DEPT_NAME',UserInfo.deptName);
		/*	mad120skrvService.userWhcode({}, function(provider, response)	{
