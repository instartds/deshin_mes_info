...
<t:appConfig pgmId="mad110skrv" >
	<t:ExtComboStore comboType="BOR120" pgmId="mad110skrv" /> 	<!-- 사업장 -->
...
function appMain() {
	...
	Unilite.defineModel('Mad110skrvModel', {
	    fields: [
	    	{name: 'CUSTOM_CODE'			, text: '매입처'		, type: 'string'},
	    	{name: 'CUSTOM_NAME'			, text: '매입처명'		, type: 'string'},
	    	
	    	{name: 'CON_BUY_Q'				, text: '<t:message code="system.label.purchase.purchaseqty" default="매입량"/>'		, type: 'uniQty'},
	    	{name: 'CON_AMT'				, text: '매입금액'		, type: 'uniPrice'},
	    	...
	    	{name: 'NOW_BUY_Q'				, text: '<t:message code="system.label.purchase.purchaseqty" default="매입량"/>'		, type: 'uniQty'},
	    	{name: 'NOW_AMT'				, text: '매입금액'		, type: 'uniPrice'},
	    	...
	    	{name: 'TOTAL_BUY_Q'			, text: '<t:message code="system.label.purchase.purchaseqty" default="매입량"/>'		, type: 'uniQty'},
	    	{name: 'TOTAL_AMT'				, text: '매입금액'		, type: 'uniPrice'},
	...
	});//End of Unilite.defineModel('Mad110skrvModel', {
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('mad110skrvMasterStore1', {
		model: 'Mad110skrvModel',
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {			
				read: 'mad110skrvService.selectList'                	
			}
		},
	...
	});//End of var directMasterStore1 = Unilite.createStore('mad110skrvMasterStore1', {
     ...
     * @type 
     */
	var masterGrid = Unilite.createGrid('mad110skrvGrid1', {
    	// for tab    	
		layout: 'fit',
		region: 'center',
		excelTitle: '매입 지급결의현황 조회',
        uniOpt: {
	...
	Unilite.Main({
		...
		fnInitBinding: function() {
			...
			panelSearch.setValue('BASIS_DATA_FR',UniDate.get('today'));
			panelSearch.setValue('BASIS_DATA_TO',UniDate.get('today'));
			panelResult.setValue('BASIS_DATA_FR',UniDate.get('today'));
			panelResult.setValue('BASIS_DATA_TO',UniDate.get('today'));
