...
<t:appConfig pgmId="man200skrv" >
	<t:ExtComboStore comboType="BOR120" pgmId="man200skrv"/>	<!-- 사업장 -->
...
function appMain() {
	 ...
	 * @type
	 */
	Unilite.defineModel('man200skrvModel', {
		fields: [
			...
			{name: 'PRE_MONTH'		, text: '<t:message code="system.label.sales.lastmonth" default="전월"/>'					, type: 'uniPrice'},
	 ...
	 * @type
	 */
	var directMasterStore = Unilite.createStore('man200skrvMasterStore1', {
		model	: 'man200skrvModel',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 'man200skrvService.selectList'
			}
		},
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('man200skrvGrid1', {
		...
		columns	: [
			...
			{dataIndex: 'PRE_MONTH'		, width: 100, summaryType: 'sum'},
