...
function appMain() {
    ...
    var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 'otr100ukrvService.selectDetail',
            update: 'otr100ukrvService.updateDetail',
            create: 'otr100ukrvService.insertDetail',
            destroy: 'otr100ukrvService.deleteDetail',
            syncAll: 'otr100ukrvService.saveAll'
        }
    }); 
    ...
    Unilite.defineModel('Otr100ukrvModel1', {       // 메인1
        fields: [
    ...
    Unilite.defineModel('Otr100ukrvModel2', {       // 메인2
        fields: [
...
//          {name: 'EXCHG_YN'           ,text: '대체여부'           ,type: 'string', comboType:'AU', comboCode:'B081'},
            ...
            {name: 'INOUT_Q'            ,text: '<t:message code="system.label.purchase.tranqty" default="수불량"/>'           ,type: 'float'}
        ]
    });
     ...
     * @type 
     */                 
    var directMasterStore1 = Unilite.createStore('otr100ukrvMasterStore1',{     // 메인1
            model: 'Otr100ukrvModel1',
            uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {          
                       read: 'otr100ukrvService.selectMaster'                   
                }
            },
            ...
            saveStore: function() {}
    });     // End of var directMasterStore1 = Unilite.createStore('Otr100ukrvMasterStore1',{
            
    var directMasterStore2 = Unilite.createStore('otr100ukrvMasterStore2',{     // 메인2
            model: 'Otr100ukrvModel2',
            uniOpt : {
                isMaster: true,         // 상위 버튼 연결 
            ...
            saveStore: function() {                 
                ...
                if(inValidRecs.length == 0) {
                    ...
                    var grid = Ext.getCmp('otr100ukrvGrid2');
                    grid.uniSelectInvalidColumnAndAlert(inValidRecs);
                }
            }
    });     // End of var directMasterStore2 = Unilite.createStore('Otr100ukrvMasterStore2')
   
    /**
     * Master Grid1 정의(Grid Panel)
     * @type 
     */  
    var masterGrid1 = Unilite.createGrid('otr100ukrvGrid1', {
        // for tab      
        layout : 'fit',
        region:'center',
...
//                  });
    ...
    var masterGrid2 = Unilite.createGrid('otr100ukrvGrid2', {
        // for tab      
        layout : 'fit',
        region:'center',
        uniOpt:{    expandLastColumn: true,
...
//            { dataIndex: 'EXCHG_YN'                 , width:66, hidden: bExchgRegYN},
    ...
    var replaceItemStore = Unilite.createStore('str103ukrvReplaceItemStore', {
            ...
            proxy: {
                type: 'direct',
                api: {
                    read    : 'otr100ukrvService.selectReplaceItemList'                  
                }
            }
