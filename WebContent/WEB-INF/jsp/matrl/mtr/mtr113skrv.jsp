...
function appMain() {
	Unilite.defineModel('mtr113skrvModel1', {
		fields: [
	...
	var directProxy1 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'mtr113skrvService.selectList'
		}
	});



	var directMasterStore1 = Unilite.createStore('mtr113skrvMasterStore1',{
		proxy: directProxy1,
		model: 'mtr113skrvModel1',
		uniOpt: {
...
//					}
	 ...
	 * @type
	 */
	var itemGrid = Unilite.createGrid('mtr113skrvGrid1', {
		layout: 'fit',
		region:'center',
		uniOpt: {
		...
		columns: [
			...
			{dataIndex: 'EXPENSE_I'			, width: 120,summaryType: 'sum'},
			{dataIndex: 'INOUT_I_TOTAL'		, width: 150,summaryType: 'sum'},
			{dataIndex: 'TAX_TYPE'			, width: 90},
			{dataIndex: 'INOUT_FOR_P'		, width: 100},
			{dataIndex: 'INOUT_FOR_O'		, width: 120,summaryType: 'sum'},
	...
	Unilite.Main( {
		...
		fnInitBinding: function() {
			...
			mtr113skrvService.userWhcode({}, function(provider, response) {
