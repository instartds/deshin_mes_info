...
<t:appConfig pgmId="mrt110skrv"  >
	
	<t:ExtComboStore comboType="BOR120" pgmId="mrt110skrv"  /> 			<!-- 사업장 -->
...
function appMain() {
	...
	Unilite.defineModel('mrt110skrvModel', {
	    fields: [  	
	    	...
	    	{name: 'COUNT_TOTAL'			,text:'<t:message code="system.label.purchase.qty" default="수량"/>'				,type:'uniQty'},
	    	{name: 'MONEY_TOTAL'			,text:'<t:message code="system.label.purchase.amount" default="금액"/>'				,type:'uniPrice'},
	    	{name: 'REMARK'					,text:'<t:message code="system.label.purchase.remarks" default="비고"/>'				,type:'string'}
		]
	});		// end of Unilite.defineModel('mrt110skrvModel', {
	
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('mrt110skrvMasterStore1',{
			model: 'mrt110skrvModel',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {			
                	   read: 'mrt110skrvService.selectList'                	
                }
            }
	...
	});		// end of var directMasterStore1 = Unilite.createStore('mrt110skrvMasterStore1',{
    ...
    var masterGrid = Unilite.createGrid('mrt110skrvGrid1', {
    	// for tab    	
        layout : 'fit',
        region: 'center',
        uniOpt: {
        ...
        columns: [
        	...
        	{ dataIndex: 'COUNT_TOTAL'				,    width: 88},
        	{ dataIndex: 'MONEY_TOTAL'		   		,    width: 130},
    ...
    }); 		// end of var masterGrid = Unilite.createGrid('mrt110skrvGrid1', {  
    ...
    Unilite.Main({
		...
		fnInitBinding : function() {
			...
			mrt110skrvService.userWhcode({}, function(provider, response)	{
...
/*        onSaveAsExcelButtonDown: function() {
        ...
        onPrintButtonDown: function() {
			...
			Ext.each(param, 
		   		function(record, i)	{
		   			inout_num_arry[i] = record.get('INOUT_NUM'); 
		   	});
