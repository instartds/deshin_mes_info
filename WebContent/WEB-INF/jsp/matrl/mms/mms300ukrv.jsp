...
<t:appConfig pgmId="mms300ukrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="mms300ukrv" /> 			<!-- 사업장 -->
...
function appMain() {
	...
	Unilite.defineModel('Mms300ukrvModel1', {
		fields: [
			{name: 'COMP_CODE'    	        , text: '<t:message code="system.label.purchase.companycode" default="법인코드"/>'		, type: 'string'},
			{name: 'CLOSE_YN'    	    	, text: '마감여부'		, type: 'string' ,comboType: 'AU' ,comboCode: 'B010' ,defaultValue: 'N'},
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'mms300ukrvService.selectList',
			update: 'mms300ukrvService.updateDetail',
			syncAll: 'mms300ukrvService.saveAll'
		}
	});	 
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('mms300ukrvMasterStore1', {
		model: 'Mms300ukrvModel1',
		uniOpt: {
...
//							popup.setExtParam({'DEPT_CODE': UserInfo.deptCode});
			...
			}),
			{
				...
				xtype:'container',
				html:"<div class='x-hide-display' align='right' style='margin-top:5px'><div style='font-weight:bold; color:red;'>※미입고(부분입고) 내역만 보임.</div>"
			}]
		}],		
...
//						popup.setExtParam({'DEPT_CODE': UserInfo.deptCode});
     ...
     * @type 
     */
	var masterGrid = Unilite.createGrid('mms300ukrvGrid1', {
		layout: 'fit',
		region:'center',
	...
	Unilite.Main({
		...
		fnInitBinding: function(){
			...
			/*mms300ukrvService.userWhcode({}, function(provider, response)	{
