<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<t:appConfig pgmId="hpe200skr">
	<t:ExtComboStore comboType="BOR120"  pgmId="hpe200skr"/> 			<!-- 사업장 -->
...
function appMain() {
	 ...
	 * @type
	 */
	Unilite.defineModel('hpe200skrMasterModel', {
		fields: [
	 ...
	 * @type
	 */
	var directMasterStore = Unilite.createStore('hpe200skrMasterStore', {
		model: 'hpe200skrMasterModel',
		uniOpt: {
		...
		proxy: {
			type: 'uniDirect',
			api: {
				read   : 'hpe200skrService.selectList'
			}
		},
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('hpe200skrMasterGrid', {
		layout	: 'fit',
		region	: 'center',
		title	: '지급명세서',
		flex	: 1,
