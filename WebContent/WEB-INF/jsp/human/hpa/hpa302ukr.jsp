...
function appMain() {
	...
	var hum101InsuranceStore = Ext.create('Ext.data.Store',{
		storeId: 'hpa302ukrInsuranceCombo',
        fields:[
        	'value',
        	'text'
        ],
	...
	var panelSearch = Unilite.createForm('searchForm', {		
	    ...
	    , items :[{ 
		    ...
		    name: 'BASE_YEAR'
			 ...
			 id:'CLOSE_TYPE', 
			 xtype: 'uniCombobox',
			 store: Ext.data.StoreManager.lookup('hpa302ukrInsuranceCombo')
		},{
	    	xtype: 'container',
	    	padding: '10 0 0 0',
	    	layout: {
	    	...
	    	items:[{
	    		...
	    		handler: function(btn){
					...
					hpa302ukrService.doBatch(param, function(provider, response)	{
						if(provider){
