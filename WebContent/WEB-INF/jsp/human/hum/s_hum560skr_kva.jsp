...
<t:appConfig pgmId="s_hum560skr_kva">
...
function appMain() {
	 ...
	 */
	//1: 입사일별
	Unilite.defineModel('s_hum560skr_kvaModel1', {
		fields: [
	...
	//2: 퇴사일별
	Unilite.defineModel('s_hum560skr_kvaModel2', {
		fields: [
			{name: 'COMP_CODE'		 	,text: 'COMP_CODE'		,type: 'string'},
	 ...
	 */			
	//1: 입사일별		
	var masterStore1 = Unilite.createStore('s_hum560skr_kvaMasterStore1',{
		model	: 's_hum560skr_kvaModel1',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {			
					read: 's_hum560skr_kvaService.selectList'
			}
		},
...
//				}
	...
	//2: 퇴사일별	
	var masterStore2 = Unilite.createStore('s_hum560skr_kvaMasterStore2',{
		model	: 's_hum560skr_kvaModel2',
		uniOpt	: {
			isMaster	: true,				// 상위 버튼 연결 
			editable	: false,			// 수정 모드 사용 
			deletable	: false,			// 삭제 가능 여부 
...
//							dataForm.setValue('S_DEPT_CODE', records[0].DEPT_CODE);
	 ...
	 */
	//1: 입사일별
	var masterGrid1 = Unilite.createGrid('s_hum560skr_kvaGrid1', {
		store	: masterStore1,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
	...
	//2: 퇴사일별
	var masterGrid2 = Unilite.createGrid('s_hum560skr_kvaGrid2', {
		store	: masterStore2,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
	...
	var tab = Unilite.createTabPanel('s_hum560skr_kvaTab',{		
		region		: 'center',
		activeTab	: 0,
		border		: false,
		items		: [{
	...
	Unilite.Main({
		...
		onQueryButtonDown : function()	{
			...
			//1: 입사일별
			if (activeTab == 's_hum560skr_kvaTab1'){
				masterStore1.loadStoreRecords();

			//2: 퇴사일별
			} else if (activeTab == 's_hum560skr_kvaTab2'){
