...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('hum540skrModel', {
		fields: [
	 ...
	 * @type 
	 */					
	var masterStore = Unilite.createStore('hum540skrMasterStore1',{
		model	: 'hum540skrModel',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {			
					read: 'hum540skrService.selectList'
			}
		},
...
//							dataForm.setValue('S_DEPT_CODE', records[0].DEPT_CODE);
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('hum540skrGrid1', {
		store	: masterStore,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
