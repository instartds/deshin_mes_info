...
function appMain() {
	...
	var panelSearch = Unilite.createSearchForm('hum963rkrForm', {
		region: 'center',
    	disabled :false,
    	border: false,
    	flex:1,
...
//						url: CPATH+'/human/hum963crkrPrint.do',//'/human/hum960rkrPrint.do',//'/human/hum960crkr.do',//'/human/hum960rkrPrint.do',
//						prgID: 'hum963rkr',
//							extParam: param
//						});
                	
		            param.PGM_ID = 'hum963rkr';  //프로그램ID
		            param.sTxtValue2_fileTitle = "인사기록카드";
		            
					var win = Ext.create('widget.ClipReport', {
						url: CPATH+'/human/hum963clrkrv.do',
						prgID: 'hum963rkr',
							extParam: param
						});
					win.center();
