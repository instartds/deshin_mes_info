...
<t:appConfig pgmId="s_hum510skr_kva">
...
function appMain() {
     ...
     * @type 
     */
    Unilite.defineModel('s_hum510skr_kvaModel', {
        fields: [
     ...
     * @type 
     */                 
    var masterStore = Unilite.createStore('s_hum510skr_kvaMasterStore1',{
        model   : 's_hum510skr_kvaModel',
        uniOpt  : {
        ...
        proxy   : {
            type: 'direct',
            api: {          
                    read: 's_hum510skr_kvaService.selectList'
            }
        },
...
//                          dataForm.setValue('S_DEPT_CODE', records[0].DEPT_CODE);
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('s_hum510skr_kvaGrid1', {
        store   : masterStore,
        region  : 'west',
        flex    : 2,
        uniOpt  : { 
