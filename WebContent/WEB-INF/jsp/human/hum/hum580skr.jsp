...
function appMain() {
	 ...
	 */
	//1: 연봉직
	Unilite.defineModel('hum580skrModel1', {
		fields: [
	...
	//2: 연봉직 외
	Unilite.defineModel('hum580skrModel2', {
		fields: [
			{name: 'COMP_CODE'		 	,text: 'COMP_CODE'		,type: 'string'},
			{name: 'DIV_CODE'			,text: '사업장코드'		,type: 'string'},
			{name: 'PERSON_NUMB'		,text: '사원번호'			,type: 'string'},
	...
	//3: 1년간 기준
	Unilite.defineModel('hum580skrModel3', {
		fields: [
			{name: 'COMP_CODE'		 	,text: 'COMP_CODE'		,type: 'string'},
			{name: 'DIV_CODE'			,text: '사업장코드'		,type: 'string'},
			{name: 'PERSON_NUMB'		,text: '사원번호'			,type: 'string'},
	 ...
	 */			
	//1: 연봉직		
	var masterStore1 = Unilite.createStore('hum580skrMasterStore1',{
		model	: 'hum580skrModel1',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {			
					read: 'hum580skrService.selectList'
			}
		},
...
//				}
	...
	//2: 연봉직 외	
	var masterStore2 = Unilite.createStore('hum580skrMasterStore2',{
		model	: 'hum580skrModel2',
		uniOpt	: {
			isMaster	: true,				// 상위 버튼 연결 
			editable	: false,			// 수정 모드 사용 
			deletable	: false,			// 삭제 가능 여부 
...
//				}
	...
	//3: 1년간 기준
	var masterStore3 = Unilite.createStore('hum580skrMasterStore3',{
		model	: 'hum580skrModel3',
		uniOpt	: {
			isMaster	: true,				// 상위 버튼 연결 
			editable	: false,			// 수정 모드 사용 
			deletable	: false,			// 삭제 가능 여부 
...
//							dataForm.setValue('S_DEPT_CODE', records[0].DEPT_CODE);
	 ...
	 */
	//1: 연봉직
	var masterGrid1 = Unilite.createGrid('hum580skrGrid1', {
		store	: masterStore1,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
	...
	//2: 연봉직 외
	var masterGrid2 = Unilite.createGrid('hum580skrGrid2', {
		store	: masterStore2,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
	...
	//3: 1년간 기준
	var masterGrid3 = Unilite.createGrid('hum580skrGrid3', {
		store	: masterStore3,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
	...
	var tab = Unilite.createTabPanel('hum580skrTab',{		
		region		: 'center',
		activeTab	: 0,
		border		: false,
		items		: [{
		...
		listeners:{
			tabchange: function( tabPanel, newCard, oldCard, eOpts )	{
				if(newCard.getItemId() == 'hum580skrTab1')	{
					masterStore1.loadStoreRecords();
				}else if(newCard.getItemId() == 'hum580skrTab2') {
	...
	Unilite.Main({
		...
		onQueryButtonDown : function()	{
			...
			//1: 연봉직
			if (activeTab == 'hum580skrTab1'){
				masterStore1.loadStoreRecords();

			//2: 연봉직 외
			} else if (activeTab == 'hum580skrTab2'){
				masterStore2.loadStoreRecords();
