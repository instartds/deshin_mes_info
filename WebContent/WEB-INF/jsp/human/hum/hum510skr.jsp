...
function appMain() {
     ...
     * @type 
     */
    Unilite.defineModel('hum510skrModel', {
        fields: [
     ...
     * @type 
     */                 
    var masterStore = Unilite.createStore('hum510skrMasterStore1',{
        model   : 'hum510skrModel',
        uniOpt  : {
        ...
        proxy   : {
            type: 'direct',
            api: {          
                    read: 'hum510skrService.selectList'
            }
        },
...
//                          dataForm.setValue('S_DEPT_CODE', records[0].DEPT_CODE);
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('hum510skrGrid1', {
        store   : masterStore,
        region  : 'west',
        flex    : 2,
        uniOpt  : { 
