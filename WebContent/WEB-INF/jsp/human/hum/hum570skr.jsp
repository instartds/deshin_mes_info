...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('hum570skrModel', {
		fields: [
	 ...
	 * @type 
	 */				
	var masterStore = Unilite.createStore('hum570skrmasterStore',{
		model	: 'hum570skrModel',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {			
					read: 'hum570skrService.selectList'
			}
		},
...
//							dataForm.setValue('S_DEPT_CODE', records[0].DEPT_CODE);
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('hum570skrGrid1', {
		store	: masterStore,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
