...
<t:appConfig pgmId="hum306ukr"  >
	<t:ExtComboStore comboType="BOR120"	pgmId="hum306ukr"/> 			<!-- 사업장  -->
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
        	read : 'hum306ukrService.selectList',
        	update: 'hum306ukrService.updateDetail',
			create: 'hum306ukrService.insertDetail',
			destroy: 'hum306ukrService.deleteDetail',
			syncAll: 'hum306ukrService.saveAll'
        }
	});
