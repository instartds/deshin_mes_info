...
function appMain() {    
    ...
    Unilite.defineModel('had616ukr600Model', {
        fields: [                                                                                                                                                                                
             ...
             , {name:'HALFWAY_TYPE'                    , text:'중도퇴사자정산여부'                  , type:'string'}
             , {name:'FORE_SINGLE_YN'                , text:'외국인단일세율적용여부'              , type:'string'}
             , {name:'FOREIGN_DISPATCH_YN'          , text:'외국법인소속 파견근로자 여부'          , type:'string'}
             , {name:'HOUSEHOLDER_YN'                , text:'세대주여부'                          , type:'string'}
             ...
             , {name:'ONE_PARENT'                    , text:'부녀자유무'                          , type:'string'}
             ...
             , {name:'CARD_SELF_USE_2013_I'          , text:'2013년본인신용카드등사용액'          , type:'uniNumber'    ,defaultValue:0}
             , {name:'CARD_SELF_USE_2014_I'          , text:'2014년본인신용카드등사용액'          , type:'uniNumber'    ,defaultValue:0}
             , {name:'CARD_SELF_USE_2015_I'          , text:'2015년본인신용카드등사용액'          , type:'uniNumber'    ,defaultValue:0}
             , {name:'ADD_SELF_USE_2013_I'          , text:'2013년본인추가공제율사용액'          , type:'uniNumber'    ,defaultValue:0}
             , {name:'ADD_SELF_USE_2014_I'          , text:'2014년본인추가공제율사용액'          , type:'uniNumber'    ,defaultValue:0}
             , {name:'ADD_SELF_USE_2015F_I'          , text:'2015년본인추가공제율사용액-상반기'  , type:'uniNumber'    ,defaultValue:0}
             , {name:'ADD_SELF_USE_2015S_I'          , text:'2015년본인추가공제율사용액-하반기'  , type:'uniNumber'    ,defaultValue:0}
             , {name:'COMP_PREMINUM'                , text:'소기업,소상공인공제부금소득공제 2016년 가입한 대표자 여부' , type:'string'}
    ...
    var direct600Store = Unilite.createStore('had616ukr600Store',{
            model: 'had616ukr600Model',
            autoLoad: false,
            folderSort: true,
            uniOpt : {
            ...
            proxy: /*directProxy*/{
                type: 'uniDirect',
                api: {
                    read : 'had616ukrService.selectFormHad600'
                    ,update : 'had616ukrService.update600'
                    ,create : 'had616ukrService.insert600'
                    ,syncAll: 'had616ukrService.save600All'
        ...
        Unilite.defineModel('had616ukr400Model', {
        fields: [
              {name:'PERSON_NUMB'                ,text:'사번'                                    ,type:'string'}
             ,{name:'NAME'                        ,text:'성명'                                    ,type:'string'}
             ,{name:'DEPT_CODE'                    ,text:'부서코드'                                ,type:'string'}
             ,{name:'DEPT_NAME'                    ,text:'부서명'                                    ,type:'string'}
             ,{name:'POST_CODE'                    ,text:''                                        ,type:'string'}
             ,{name:'POST_NAME'                    ,text:''                                        ,type:'string'}
             ,{name:'REPRE_NUM'                    ,text:''                                        ,type:'string'}
             ,{name:'FOREIGN_NUM'                ,text:'외국인번호'                                ,type:'string'}
             ,{name:'NATION_CODE'                ,text:''                                        ,type:'string'}
             ,{name:'LIVE_GUBUN'                ,text:''                                        ,type:'string'}
             ,{name:'YEAR_YYYY'                    ,text:'정산년도'                                ,type:'string'}
             ,{name:'HALFWAY_TYPE'                ,text:'중도퇴사자정산여부'                        ,type:'string'}
             ,{name:'FORE_SINGLE_YN'            ,text:'외국인단일세율적용여부'                    ,type:'string'}
             ,{name:'FOREIGN_DISPATCH_YN'        ,text:'외국법인소속 파견근로자여부'                ,type:'string'}
             ,{name:'HOUSEHOLDER_YN'            ,text:'세대주여부'                                ,type:'string'}
             ...
             ,{name:'CARD_SELF_USE_2013_I'        ,text:'2013년본인신용카드등사용액'                ,type:'uniNumber'}
             ,{name:'CARD_SELF_USE_2014_I'        ,text:'2014년본인신용카드등사용액'                ,type:'uniNumber'}
             ,{name:'CARD_SELF_USE_2015_I'        ,text:'2015년본인신용카드등사용액'                ,type:'uniNumber'}
             ,{name:'ADD_SELF_USE_2013_I'        ,text:'2013년본인추가공제율사용액'                ,type:'uniNumber'}
             ,{name:'ADD_SELF_USE_2014_I'        ,text:'2014년본인추가공제율사용액'                ,type:'uniNumber'}
             ,{name:'ADD_SELF_USE_2015F_I'        ,text:'2015년본인추가공제율사용액-상반기'        ,type:'uniNumber'}
             ,{name:'ADD_SELF_USE_2015S_I'        ,text:'2015년본인추가공제율사용액-하반기'        ,type:'uniNumber'}
             ,{name:'COMP_PREMINUM'                ,text:'소기업소상공인공제부금 2016년 가입한 법인대표자 여부',type:'string'}
        ...
        var direct400Store = Unilite.createStore('had616ukr400Store',{
            model: 'had616ukr400Model',
            autoLoad: false,
            folderSort: true,
            uniOpt : {
                isMaster: true,            // 상위 버튼 연결 
            ...
            proxy: /*directProxy*/{
                type: 'uniDirect',
                api: {
                    read : 'had616ukrService.selectFormHad400'
                    ,update : 'had616ukrService.update400'
                    ,create : 'had616ukrService.insert400'
                    ,syncAll: 'had616ukrService.save400All'
                    ...
                    listeners: {
                        onSelected:function(records, type)    {
                            if(records)    {
                                ...
                                panelSearch.setValue("REPRE_NUM",record['REPRE_NUM']);
                                ...
                                panelResult.setValue("REPRE_NUM",record['REPRE_NUM']);
    ...
    var tab1 = Ext.create('Ext.container.Container',{    
        ...
        //                }
                    ...
                    items:[
                        ...
                        { xtype: 'button', text:'부양가족 기본공제 입력', style: 'text-align:center', width: '90%',
                          handler:function()    {
                             if(panelSearch.isValid())    {
                                 UniAppManager.app.openFamily('P');
                             } else {
                                 alert("사원을 입력하세요.");
                             }
                          }
                        ...
                        { xtype: 'component', html:'&nbsp;본인기본공제<font color= "blue">(자동계산)</font>', style: 'text-align:left'},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'PER_DED_I'},
                        
                        { xtype: 'component', html:'&nbsp;배우자공제', style: 'text-align:left'},
                        {
                            xtype: 'radiogroup',
                            tdAttrs: {align : 'left'},
                            items: [
                        ...
                        { xtype: 'component', html:'&nbsp;부양가족공제', style: 'text-align:left'},
                        ...
                        { 
                            ...
                            items: [{
                                ...
                                xtype: 'uniNumberfield', value:'0', suffixTpl: '명', readOnly:true, name: 'SUPP_NUM_4', width: 40, tdAttrs: {align : 'right'}, padding: '0 0 2 0'
                            }]
                        },
                        ...
                        { 
                            ...
                            items: [{
                                ...
                                xtype: 'uniNumberfield', value:'0', suffixTpl: '명', readOnly:true, name: 'SUPP_NUM_5', width: 40, tdAttrs: {align : 'right'}, padding: '0 0 2 0'
                            }]
                        },
        ...
        //                }
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'', colspan: 3},
                        { xtype: 'component', html:''},
                        { xtype: 'component', html:'만60세 이상(1955.12.31 이전 출생) 직계존속', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'', colspan: 3},
                        { xtype: 'component', html:''},
                        { xtype: 'component', html:'만20세 이하(1995.1.1 이후 출생)의 거주자 직계비속</br>민법 또는 입양촉진 및 절차에 관한 특례법에 따라 입양한 양자 ', style: 'text-align:left', rowspan: 2},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '명', readOnly:true, name: 'AGED_DED_I', width: 40, tdAttrs: {align : 'right'}, margin: '0 3 0 0'},
                        
                        { xtype: 'component', html:'&nbsp;장애인공제', style: 'text-align:left'},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '명', readOnly:true, name: 'DEFORM_DED_I', width: 40, tdAttrs: {align : 'right'}, margin: '0 3 0 0'},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'&nbsp;주택임차차입금', style: 'text-align:left', rowspan: 2, tdAttrs: {width:200, style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif;'}},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'button', text:'신용카드등 사용금액 입력', style: 'text-align:center', width: '90%', colspan: 2,
                          handler:function()    {
                             if(panelSearch.isValid())    {
                                 UniAppManager.app.openFamily('C');
                             } else {
                                 alert("사원을 입력하세요.");
                             }
                          }
                        ...
                        { xtype: 'component', html:'&nbsp;2013년 본인 신용카드등 사용액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 10%'}},
                        { xtype: 'component', html:'&nbsp;사용금액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'CARD_SELF_USE_2013_I'},
                        
                        { xtype: 'component', html:'&nbsp;2014년 본인 신용카드등 사용액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 10%'}},
                        { xtype: 'component', html:'&nbsp;사용금액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'CARD_SELF_USE_2014_I'},
                        
                        { xtype: 'component', html:'&nbsp;2015년 본인 신용카드등 사용액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 10%'}},
                        { xtype: 'component', html:'&nbsp;사용금액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly: true, name: 'CARD_SELF_USE_2015_I'},
                        
                        { xtype: 'component', html:'&nbsp; 2013년 본인 추가공제율 사용액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 10%'}},
                        { xtype: 'component', html:'&nbsp;사용금액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'ADD_SELF_USE_2013_I'},
                        
                        { xtype: 'component', html:'&nbsp; 2014년 본인 추가공제율 사용액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 10%'}},
                        { xtype: 'component', html:'&nbsp;사용금액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'ADD_SELF_USE_2014_I'},
                        
                        { xtype: 'component', html:'&nbsp;2015년 상반기 본인 추가공제율 사용액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 10%'}},
                        { xtype: 'component', html:'&nbsp;사용금액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'ADD_SELF_USE_2015F_I'},
                        
                        { xtype: 'component', html:'&nbsp;2015년 하반기 본인 추가공제율 사용액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 10%'}},
                        { xtype: 'component', html:'&nbsp;사용금액', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'ADD_SELF_USE_2015S_I'}
                    ...
                    items:[
                        ...
                        { xtype: 'uniNumberfield', value:'0', fieldLabel:'2014년본인신용카드등사용액 ', hidden: true, name: 'CARD_SELF_USE_2014_I', rowspan: 12},
                        { xtype: 'uniNumberfield', value:'0', fieldLabel:'2015년본인신용카드등사용액 ', hidden: true, name: 'CARD_SELF_USE_2015_I', rowspan: 12},
                        { xtype: 'uniNumberfield', value:'0', fieldLabel:'2014년본인추가공제율사용액 ', hidden: true, name: 'ADD_SELF_USE_2014_I', rowspan: 12},
                        { xtype: 'uniNumberfield', value:'0', fieldLabel:'2015년본인추가공제율사용액-상반기', hidden: true, name: 'ADD_SELF_USE_2015F_I', rowspan: 12},
                    
                        { xtype: 'component', html:'정 산 항 목'},
                        { xtype: 'component', html:'정 산 금 액'},
                        { xtype: 'component', html:'항목별 요약설명 및 공제요건', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 30%'}},
                        
                        { xtype: 'button', text:'신용카드등 사용금액 산출내역', style: 'text-align:center', width: '90%', colspan: 2},
                        { xtype: 'component', html:''},
                        
                        { xtype: 'component', html:'신용카드등 사용금액', style: 'text-align:left', rowspan: 12},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly: true, name: 'CARD_DED_I', rowspan: 12},
                        ...
                        { xtype: 'component', html:'2013년 본인 사용의 전통,교통,현금영수증,직불ㆍ선불카드 전체사용액', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'2014년 본인 사용의 전통,교통,현금영수증,직불ㆍ선불카드 전체사용액', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'2015년 본인 사용의 전통,교통,현금영수증,직불ㆍ선불카드 전체사용액', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'2013년 본인 사용의 전통,교통,현금영수증,직불ㆍ선불카드(추가공제) 합계액', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'2014년 본인 사용의 전통,교통,현금영수증,직불ㆍ선불카드(추가공제) 합계액', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'2015년 상반기 본인 사용의 전통,교통,현금영수증,직불ㆍ선불카드(추가공제) 합계액', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'2015년 하반기 본인 사용의 전통,교통,현금영수증,직불ㆍ선불카드(추가공제) 합계액', style: 'text-align:left'}                
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        {  xtype: 'fieldcontainer',
                            ...
                            colspan:2,
                            items: [
                                {boxLabel: '2016년 가입',  name: 'COMP_PREMINUM', inputValue: '1', tooltip:'2016년가입한 법인의 대표자인경우 체크'}
                            ]
                        },
                        ...
                        { xtype: 'component', html:'&nbsp우리사주출연금소득공제', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 8%'}},
                        ...
                        { xtype: 'component', html:'&nbsp;우리사주조합기부금소득공제', style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 8%'}},
                        { xtype: 'component', html:'&nbsp;기부금액', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 6%'}, colspan: 2},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'STAFF_GIFT_I', readOnly: true},
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'&nbsp;투자조합 출자공제', style: 'text-align:left', tdAttrs:{height:319}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'INVESTMENT_DED_I', readOnly: true, tdAttrs:{height:319}},
                        { xtype: 'component', html:'중소기업창업투자조합 등에 출자 또는 투자한 금액 공제', style: 'text-align:left', tdAttrs:{height:319}},
                        ...
                        { xtype: 'component', html:'&nbsp우리사주출연금소득공제', style: 'text-align:left'},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'STAFF_STOCK_DED_I', readOnly: true},
                        { xtype: 'component', html:'우리사주조합원이 자사주를 취득하기 위하여 우리사주조합에 출자한 경우 ', style: 'text-align:left'},
                        
                        { xtype: 'component', html:'&nbsp;우리사주조합기부금소득공제', style: 'text-align:left'},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', name: 'STAFF_GIFT_DED_I', readOnly: true},
                        { xtype: 'component', html:'우리사주조합원이 아닌 근로자가 우리사주조합에 기부하는 기부금을 공제', style: 'text-align:left'},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'세액</br>감면', rowspan: 5, tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 2%'}},
                        ...
                        { xtype: 'component', html:'&nbsp;중소기업취업청년', rowspan: 3, style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 6%'}},
                        { xtype: 'component', html:'100%', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        ...
                        { xtype: 'component', html:'70%', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'component', html:'<font color= "blue">(자동계산)</font>', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'YOUTH_DED_I3'},
                        
                        { xtype: 'component', html:'50%', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'component', html:'<font color= "blue">(자동계산)</font>', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 3%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'YOUTH_DED_I2'},
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'&nbsp;중소기업취업청년', rowspan: 3, style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 8%'}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'YOUTH_DED_I'},                    
                        { xtype: 'component', html:'중소기업 취업 청년에 대한 소득세 감면 ', style: 'text-align:left', rowspan: 3},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'button', text:'보장성보험 입력', style: 'text-align:center', width: '90%',
                            handler:function(){
                             if(panelSearch.isValid())    {
                                 UniAppManager.app.openFamily('I');
                             } else {
                                 alert("사원을 입력하세요.");
                             }
                          }
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        
                        {
                            ...
                            tdAttrs : {align: 'left'},
                            layout: {type: 'table', columns: 2},
                            items:[{ xtype: 'button', text:'의료비제출대상 입력',  width:250,  tdAttrs:{'align':'center',width:300}, margin: '0 2 0 0',
                          handler:function()    {
                             if(panelSearch.isValid())    {
                            ...
                            handler:function()    {
                                 if(panelSearch.isValid())    {
                                     UniAppManager.app.openFamily('M');
                                 } else {
                                     alert("사원을 입력하세요.");
                                 }
                            }
                    ...
                    items:[
                        ...
                        { xtype: 'button', text:'의료비산출내역보기', style: 'text-align:center', width: 250, colspan: 3, tdAttrs : {align: 'center'}},
                        { xtype: 'component', html:''},
                        
                        { xtype: 'component', html:'&nbsp;의료비공제금액', style: 'text-align:left', tdAttrs:{height:145}, rowspan:2},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'MED_DED_I', tdAttrs:{height:145}, rowspan:2},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'MED_TAX_DED_I', tdAttrs:{height:145}, rowspan:2},
                        { xtype: 'component', html:'본인·장애인·65세이상인 자를 위하여 지출한 의료비', style: 'text-align:left', tdAttrs:{height:116}},
                        ...
                        { xtype: 'component', html:'본인·장애인·65세이상인 자를 위하여 지출한 의료비를 제외한 금액', style: 'text-align:left'}
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'button', text:'교육비내역 입력', style: 'text-align:center', width: '90%', colspan: 3,
                          handler:function()    {
                             if(panelSearch.isValid())    {
                                 UniAppManager.app.openFamily('E');
                             } else {
                                 alert("사원을 입력하세요.");
                             }
                          }
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'교육비', rowspan: 5, tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 4%'}},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'button', text:'기부금내역 입력', style: 'text-align:center', width: '70%', colspan: 2, tdAttrs : {align: 'left'},
                          handler:function()    {
                             if(panelSearch.isValid())    {
                        ...
                        { xtype: 'component', html:'&nbsp;법정기부금', rowspan: 3, style: 'text-align:left', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 6%'}},
                        ...
                        { xtype: 'component', html:'2014년도이월액', tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 4%'}},
                    ...
                    items:[
                        ...
                        { xtype: 'button', text:'기부금산출내역보기', style: 'text-align:center', width: '60%', colspan: 2, tdAttrs : {align: 'left'}},
                        { xtype: 'component', html:''},
                        
                        
                        { xtype: 'component', html:'&nbsp;기부금공제금액', style: 'text-align:left', rowspan: 6, tdAttrs: { height: 464}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'GIFT_TAX_DED_I', rowspan: 6, tdAttrs: { height: 464}},
...
//            defaults:{width: '97.5%', margin: '2 2 2 2'},
            items: [{
                ...
                items: [{
                    ...
                    padding: '0 0 0 10',
                    xtype: 'component',
                    html: '¹차감소득금액 : 근로소득금액-기본공제-추가공제-특별소득공제',
                    tdAttrs: {align:'left', height:29, style: 'border : 0px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif;'},
                    colspan:5
                }]                
            }]
        }], 
    ...
    var search2 = Unilite.createSearchForm('search2',{    
        ...
        xtype: 'container',
         flex: 1,
        api: {
            load: 'had616ukrService.selectFormData02'
        },
        trackResetOnLoad: true,
        layout:{type:'vbox', align:'stretch', defaultMargins: '0 0 5 0'},        
        items: [{
...
//        tabRotation: 0,          
    ...
    var grid = Unilite.createGrid('test', {
        ...
        columns:[
             ...
             ,{dataIndex    :'POST_NAME'                        }                                    
             ,{dataIndex    :'REPRE_NUM'                        }                                    
             ,{dataIndex    :'FOREIGN_NUM'                    }                                    
             ,{dataIndex    :'NATION_CODE'                    }                                    
             ,{dataIndex    :'LIVE_GUBUN'                    }                                    
             ,{dataIndex    :'YEAR_YYYY'                        }                                    
             ...
             ,{dataIndex    :'SPOUSE'                        }                                        
             ,{dataIndex    :'SUPP_NUM'                        }                                    
             ,{dataIndex    :'SUPP_NUM_1'                    }                                    
             ,{dataIndex    :'SUPP_NUM_4'                    }                                    
             ,{dataIndex    :'SUPP_NUM_5'                    }                                    
             ,{dataIndex    :'SUPP_NUM_6'                    }                                    
             ,{dataIndex    :'SUPP_NUM_7'                    }                                    
             ,{dataIndex    :'SUPP_NUM_8'                    }                                    
             ,{dataIndex    :'AGED_NUM'                        }                                    
             ...
             ,{dataIndex    :'MED_PREMINM_ADD_I'                }                            
             ,{dataIndex    :'HIRE_INSUR_I'                    }                                
             ,{dataIndex    :'HOUS_AMOUNT_TOT_I'                }                            
             ,{dataIndex    :'HOUS_AMOUNT_TOT_I_2'            }                            
             ,{dataIndex    :'HOUS_AMOUNT_INTER_I_2'            }                        
             ,{dataIndex    :'HOUS_AMOUNT_INTER_I'            }                            
             ,{dataIndex    :'HOUS_AMOUNT_INTER_I_3'            }                        
             ,{dataIndex    :'FIXED_RATE_LOAN'                }                                
             ,{dataIndex    :'ETC_LOAN'                        }                                    
             ,{dataIndex    :'HOUS_AMOUNT_INTER_I_6'            }                        
             ,{dataIndex    :'HOUS_AMOUNT_INTER_I_7'            }                        
             ,{dataIndex    :'HOUS_AMOUNT_INTER_I_8'            }                        
             ,{dataIndex    :'HOUS_AMOUNT_INTER_I_9'            }                        
             ...
             ,{dataIndex    :'CARD_SELF_USE_2013_I'            }                        
             ,{dataIndex    :'CARD_SELF_USE_2014_I'            }                        
             ,{dataIndex    :'CARD_SELF_USE_2015_I'            }                        
             ,{dataIndex    :'ADD_SELF_USE_2013_I'            }                            
             ,{dataIndex    :'ADD_SELF_USE_2014_I'            }                            
             ,{dataIndex    :'ADD_SELF_USE_2015F_I'            }                        
             ,{dataIndex    :'ADD_SELF_USE_2015S_I'            }                        
             ,{dataIndex    :'COMP_PREMINUM'                    }                                
             ,{dataIndex    :'COMP_PREMINUM_I'                }                                
             ,{dataIndex    :'INVESTMENT_I'                    }                                
             ,{dataIndex    :'INVESTMENT_I3'                    }                                
             ,{dataIndex    :'INVESTMENT_I4'                    }                                
             ,{dataIndex    :'INVESTMENT_I2'                    }                                
             ,{dataIndex    :'INVESTMENT_I5'                    }                                
             ,{dataIndex    :'INVESTMENT_I6'                    }                                
             ,{dataIndex    :'INVESTMENT_I7'                    }                                
             ,{dataIndex    :'INVESTMENT_I8'                    }                                
             ,{dataIndex    :'INVESTMENT_I9'                    }                                
             ,{dataIndex    :'INVESTMENT_I10'                }                                
             ,{dataIndex    :'INVESTMENT_I11'                }                                
             ,{dataIndex    :'STAFF_STOCK_I'                    }                                
             ,{dataIndex    :'EMPLOY_WORKER_I'                }                                
             ,{dataIndex    :'NOT_AMOUNT_LOAN_I'                }                            
             ,{dataIndex    :'LONG_INVEST_STOCK_I'            }                            
             ...
             ,{dataIndex    :'PER_EDUC_I'                    }                                    
             ,{dataIndex    :'UNIV_EDUC_NUM'                    }                                
             ,{dataIndex    :'UNIV_EDUC_I'                    }                                    
             ,{dataIndex    :'STUD_EDUC_NUM'                    }                                
             ,{dataIndex    :'STUD_EDUC_I'                    }                                    
             ,{dataIndex    :'KIND_EDU_NUM'                    }                                
             ,{dataIndex    :'KIND_EDUC_I'                    }                                    
             ,{dataIndex    :'DEFORM_EDUC_NUM'                }                                
             ,{dataIndex    :'DEFORM_EDUC_I'                    }                                
             ...
             ,{dataIndex    :'P3_TAX_DED_I'                    }                                
             ,{dataIndex    :'HOUS_INTER_I'                    }                                
             ,{dataIndex    :'FORE_INCOME_I'                    }                                
             ,{dataIndex    :'FORE_TAX_I'                    }                                    
             ,{dataIndex    :'MON_RENT_I'                    }                                    
             ,{dataIndex    :'NEW_DATA_YN'                    }                                    
        ]
    ...
    Unilite.Main( {
        ...
        onPrevDataButtonDown:  function()    {
            had616ukrService.selectPrev(panelSearch.getValues(), function(responseText, response){
                if(responseText){
        ...
        onNextDataButtonDown:  function()    {
            had616ukrService.selectNext(panelSearch.getValues(), function(responseText, response){
                if(responseText){
        ...
        fnCollectData:function(cType){
            ...
            var infoForm400 = Ext.getCmp('infoForm400');
               var paramData = {             
                ...
                'FORE_SINGLE_YN': infoForm400.getValue('FORE_SINGLE_YN') ? 'Y':'N',         
                'FOREIGN_DISPATCH_YN': infoForm400.getValue('FOREIGN_DISPATCH_YN')  ? 'Y':'N' 
               };
               Ext.getBody().mask('Loading');
               had616ukrService.selectSummaryData(paramData, function(responseText, response){
        ...
        fnDisplayData1: function(record, sCollectType) {
            ...
            //일반정보                                                                    
            record400.set('HOUSEHOLDER_YN',record["HOUSEHOLDER_YN"] )        ;        //세대주여부
            ...
            if(record["FOREIGN_NUM"] != "" )  {                                                                        //외국인단일세율(외국인여부)
                ...
                record400.set("FORE_SINGLE_YN", "");
            }
        
            record400.set("FOREIGN_DISPATCH_YN", record["FOREIGN_DISPATCH_YN"]);    //외국법인소속 파견근로자 여부
            record400.set("FORE_SINGLE_YN", record["FORE_SINGLE_YN"]);                //외국인단일세율(저장값)
            ...
            if(sCollectType == "QUERY") {
                    //frabody8.txt400CardSelfUse2013I record.set(""    , record["CARD_SELF_USE_2013_I"))  ,0));    //[입력]2013년본인신용카드등사용액
                    //frabody8.txt400AddSelfUse2013I record.set(""    , record["ADD_SELF_USE_2013_I"))   ,0));    //[입력]2013년본인추가공제율사용액
                    //frabody8.txt400AddSelfUse2015SI record.set(""    , record["ADD_SELF_USE_2015S_I"))  ,0));    //[입력]2015년본인추가공제율사용액(하반기)
        
                    record400.set("CARD_SELF_USE_2014_I"    , Unilite.nvl(record["CARD_SELF_USE_2014_I"]  ,0));    //[입력]2014년본인신용카드등사용액            
                    record400.set("ADD_SELF_USE_2014_I"        , Unilite.nvl(record["ADD_SELF_USE_2014_I"]   ,0));    //[입력]2014년본인추가공제율사용액
                    record400.set("CARD_SELF_USE_2015_I"    , Unilite.nvl(record["CARD_SELF_USE_2015_I"]  ,0));    //[입력]2015년본인신용카드등사용액
                    record400.set("ADD_SELF_USE_2015F_I"    , Unilite.nvl(record["ADD_SELF_USE_2015F_I"]  ,0));    //[입력]2016년본인추가공제율사용액(상반기)
                    
            }
        
            //그밖의소득공제-기타
            if(sCollectType == "QUERY") {
                record400.set("COMP_PREMINUM"    , record["COMP_PREMINUM"] );
        ...
        fnSetClear1:function(sCollectType) {
            ...
            //일반정보    
            record400.set('HOUSEHOLDER_YN',"N" )        ;        //세대주여부
            ...
            record400.set("FOREIGN_DISPATCH_YN", "N");    //외국법인소속 파견근로자 여부
            record400.set("FORE_SINGLE_YN", "N");                //외국인단일세율(저장값)
            record400.set("HALFWAY_TYPE", "N");                    //중도퇴사자정산
            ...
            if(sCollectType == "QUERY") {
                //frabody8.txt400CardSelfUse2013I record.set(""    , record.get("CARD_SELF_USE_2013_I"))  ,0));    //[입력]2013년본인신용카드등사용액
                //frabody8.txt400AddSelfUse2013I record.set(""    , record.get("ADD_SELF_USE_2013_I"))   ,0));    //[입력]2013년본인추가공제율사용액
                //frabody8.txt400AddSelfUse2015SI record.set(""    , record.get("ADD_SELF_USE_2015S_I"))  ,0));    //[입력]2015년본인추가공제율사용액(하반기)
    
                record400.set("CARD_SELF_USE_2014_I"    , 0);    //[입력]2014년본인신용카드등사용액            
                record400.set("ADD_SELF_USE_2014_I"        , 0);    //[입력]2014년본인추가공제율사용액
                record400.set("CARD_SELF_USE_2015_I"    , 0);    //[입력]2015년본인신용카드등사용액
                record400.set("ADD_SELF_USE_2015F_I"    , 0);    //[입력]2016년본인추가공제율사용액(상반기)
        ...
        fnCalculateTax:function()    {
            ...
            var infoForm400 = Ext.getCmp('infoForm400');
               ...
               Ext.getBody().mask('Loading');
               had616ukrService.selectCalculateTax(paramData, function(responseText, response){
                   console.log("responseText", responseText);
        ...
        fnDisplayData2:function(record)    {
            ...
            record600.set("HALFWAY_TYPE"            , record["HALFWAY_TYPE"]);                                //[숨김]중도퇴사자정산    
            record600.set("HOUSEHOLDER_YN"            , record["HOUSEHOLDER_YN"]);                            //[숨김]세대주여부    
            record600.set("FOREIGN_DISPATCH_YN"        , record["FOREIGN_DISPATCH_YN"]);                        //[숨김]외국법인소속 파견근로자 여부    
            record600.set("FORE_SINGLE_YN"            , record["FORE_SINGLE_YN"]);                            //[숨김]외국인단일세율
            ...
            record600.set("CARD_SELF_USE_2014_I"    , Unilite.nvl(record["CARD_SELF_USE_2014_I"]  ,0));    //[숨김]2014년본인신용카드등사용액
            record600.set("CARD_SELF_USE_2015_I"    , Unilite.nvl(record["CARD_SELF_USE_2015_I"]  ,0));    //[숨김]2015년본인신용카드등사용액
            record600.set("ADD_SELF_USE_2014_I"        , Unilite.nvl(record["ADD_SELF_USE_2014_I"]   ,0));    //[숨김]2014년본인추가공제율사용액
            record600.set("ADD_SELF_USE_2015F_I"    , Unilite.nvl(record["ADD_SELF_USE_2015F_I"]  ,0));    //[숨김]2016년본인추가공제율사용액-상반기
        
            //그밖의소득공제-기타
            record600.set("COMP_PREMINUM_DED_I"        , Unilite.nvl(record["COMP_PREMINUM_DED_I"]   ,0));    //소기업,소상공인공제부금소득공제
              record600.set("COMP_PREMINUM"            , Unilite.nvl(record["COMP_PREMINUM"]         ,0));    //[숨김]소기업,소상공인공제부금소득공제
        ...
        fnSetClear2:function()    {
            ...
            record600.set("HOUSEHOLDER_YN"                , "");                            //[숨김]세대주여부    
            record600.set("FOREIGN_DISPATCH_YN"            , "");                        //[숨김]외국법인소속 파견근로자 여부    
            record600.set("FORE_SINGLE_YN"                , "");                            //[숨김]외국인단일세율
            ...
            record600.set("CARD_SELF_USE_2014_I"        , 0);    //[숨김]2014년본인신용카드등사용액
            record600.set("CARD_SELF_USE_2015_I"        , 0);    //[숨김]2015년본인신용카드등사용액
            record600.set("ADD_SELF_USE_2014_I"            , 0);    //[숨김]2014년본인추가공제율사용액
            record600.set("ADD_SELF_USE_2015F_I"        , 0);    //[숨김]2016년본인추가공제율사용액-상반기
        
            //그밖의소득공제-기타
            record600.set("COMP_PREMINUM_DED_I"            , 0);    //소기업,소상공인공제부금소득공제
              record600.set("COMP_PREMINUM"                , 0);    //[숨김]소기업,소상공인공제부금소득공제
        ...
        openYearIncome:function()    {
            ...
            var paramData = {             
                ...
                'POST_NAME'        : panelSearch.getValue('POST_NAME')
            };
            if(!yearIncomeWin)    {
                ...
                Unilite.defineModel('had700ukrModel', {
                    fields: [    
                        ...
                        {name: 'NAME'                , text: '성명'            , type: 'string'},
                        {name: 'PAY_YYYYMM'            , text: '귀속월'        , type: 'string', allowBlank:false},
                            ...
                            items:[
                                ...
                                Unilite.createGrid('had800Grid', {
                                    ...
                                    columns:  [
                                        ...
                                        {dataIndex: 'SUPPTOTAL'        , width: 90, summary:'sum'},
                                        {dataIndex: 'TAXAMOUNT'        , width: 90, summary:'sum'},
                                        {dataIndex: 'NONTAXAMOUNT'    , width: 90, summary:'sum'},
                                        {dataIndex: 'ANU'            , width: 90, summary:'sum'},
                                        {dataIndex: 'MED'            , width: 90, summary:'sum'},
                                        {dataIndex: 'HIR'            , width: 90, summary:'sum'},
                                        {dataIndex: 'BUSISHAREI'    , width: 110, summary:'sum'},
                                        {dataIndex: 'SUDK'            , width: 90, summary:'sum'},
                                        {dataIndex: 'JUMIN'            , width: 90, summary:'sum'},
                            ...
                            //기타소득내역
                                Unilite.createGrid('had700ukrGrid', {
                                    ...
                                    columns:  [
                                        ...
                                        {dataIndex: 'SUPP_TOTAL_I'        , width: 90, summary:'sum'},
                                        {dataIndex: 'IN_TAX_I'            , width: 90, summary:'sum'},
                                        {dataIndex: 'LOCAL_TAX_I'        , width: 90, summary:'sum'},
                                        {dataIndex: 'HIRE_INSUR_I'        , width: 90, summary:'sum'},
                                        {dataIndex: 'TAX_AMOUNT_I'        , width: 110, summary:'sum'},
                                        {dataIndex: 'NON_TAX_AMOUNT_I'    , width: 90, summary:'sum'},
                                        {dataIndex: 'NONTAX_CODE_NAME'        , width: 90,
            ...
            if(!prevCompanyWin)    {
                Unilite.defineModel('had510ukrModel', {
                    fields: [    
                        ...
                        {name: 'PERSON_NUMB'        , text: '사번'            , type: 'string', allowBlank:false},
                        {name: 'NONTAX_CODE'        , text: '비과세코드'        , type: 'string', allowBlank:false, comboType:'AU', comboCode:'H039'},
                        ...
                        items :  [
                             ...
                             },
                             {
                                ...
                                handler: function() {
                                    ...
                                    if( had520ukrStore.isDirty())     had520ukrStore.saveStore();
                                    if( had530_1ukrStore.isDirty()) had530_1ukrStore.saveStore();
                                    if( had530_2ukrStore.isDirty()) had530_2ukrStore.saveStore();
...
//                                        if(confirm(Msg.sMH974 + "\n" + Msg.sMB017))    {
                                        if(confirm(Msg.sMB017))    {
                                            ...
                                            if( had530_1ukrStore.isDirty()) had530_1ukrStore.saveStore();
                                            if( had530_2ukrStore.isDirty()) had530_2ukrStore.saveStore();
                                            setTimeout(prevCompanyWin.hide(), 2000);
                                        } else {
                                            prevCompanyWin.hide();
                                        }
                                    }
                ...
                taxCommunityWin= Ext.create('widget.uniDetailWindow', {
                    ...
                    items: [{
                            ...
                            items:[{
                                ...
                                xtype:'uniDetailForm',
                                itemId:'had616NapForm',
                                disabled:false,
                                height:340,
                                api:{
                                    load:had616ukrService.selectNap,
                                    submit:had616ukrService.napSyncMaster
                                },
                        ...
                        items :  [
                             {
                                ...
                                handler: function() {
                                    ...
                                    had616ukrService.napDeleteAll(searchForm.getValues(), function(){
                             ...
                             },
                             {
                                ...
                                width:80,
                                handler: function() {
                                    var had616NapForm =  taxCommunityWin.down('#had616NapForm');
                                    if( had616NapForm.isDirty())          {
                                        var searchForm =  taxCommunityWin.down('#search');
                                        taxCommunityWin.mask();
                                        had616NapForm.submit({
                                            params: searchForm.getValues(),
                                            success:function()    {
                                                //alert('저장되었습니다.');
                                                taxCommunityWin.unmask();
                                ...
                                handler: function() {
                                    ...
                                    if(had616NapForm.isDirty() )    {
                                        if(confirm(Msg.sMH974 + "\n" + Msg.sMB017))    {
                                            ...
                                            setTimeout(taxCommunityWin.hide(), 1000);
                                        } else {
                                            taxCommunityWin.hide();
                                        }
                                    }
                    ...
                    listeners : {
                        ...
                        show: function( panel, eOpts )    {
                            ...
                            var form =  taxCommunityWin.down('#had616NapForm');
                            form.load({
                                params:searchForm.getValues()
                            })
            ...
            if(!familyWin)    {
                ...
                Unilite.defineModel('had960ukrModel', {
                    fields: [    
                        ...
                        {name: 'DEFAULT_DED_YN'            , text: '기본공제'            , type: 'bool'},
                        {name: 'HOUSEHOLDER_YN'            , text: '세대주여부'        , type: 'bool'},
                        {name: 'DEFORM_DED_YN'            , text: '장애인공제'        , type: 'bool'},
                        {name: 'DEFORM_KIND_CODE'        , text: '장애인종류코드'    , type: 'string', comboType:'AU', comboCode:'H169'},
                        
                        {name: 'BRING_CHILD_DED_YN'        , text: '자녀양육비공제'    , type: 'bool'},
                        {name: 'WOMAN_DED_YN'            , text: '부녀자공제'        , type: 'bool'},
                        {name: 'ONE_PARENT_DED_YN'        , text: '한부모소득공제'    , type: 'bool'},
                        {name: 'OLD_DED_YN'                , text: '경로우대공제'        , type: 'bool'},
                        {name: 'MANY_CHILD_DED_YN'        , text: '다자녀추가공제'    , type: 'bool'},
                        {name: 'BIRTH_ADOPT_DED_YN'        , text: '출산입양자공제'    , type: 'bool'},
                                ...
                                Unilite.createGrid('had960ukrGrid', {
                                    ...
                                    tbar:[
                                        '->',
                                        {
                                            ...
                                            handler:function()    {
                                                ...
                                                var data = Ext.Array.push(had960ukrStore.data.filterBy(function(record) {return (record.get('REPRE_NUM')== selRecord.get('REPRE_NUM') ) } ).items);
                                    ...
                                    columns:  [
                                        ...
                                        {text:'인적공제항목', id:'info_gr', columns:[
                                            {xtype:'checkcolumn', dataIndex: 'DEFAULT_DED_YN'    , width: 70},
                                            {xtype:'checkcolumn',dataIndex: 'HOUSEHOLDER_YN'    , width: 80},
                                            {xtype:'checkcolumn',dataIndex: 'DEFORM_DED_YN'    , width: 80},
                                            {dataIndex: 'DEFORM_KIND_CODE'        , width: 100},
                                            {xtype:'checkcolumn',dataIndex: 'BRING_CHILD_DED_YN'    , width: 100},
                                            {xtype:'checkcolumn',dataIndex: 'WOMAN_DED_YN'    , width: 90},
                                            {xtype:'checkcolumn',dataIndex: 'ONE_PARENT_DED_YN'        , width: 110},
                                            {xtype:'checkcolumn',dataIndex: 'OLD_DED_YN'    , width: 90},
                                            {xtype:'checkcolumn',dataIndex: 'MANY_CHILD_DED_YN'    , width: 90},
                                            {xtype:'checkcolumn',dataIndex: 'BIRTH_ADOPT_DED_YN'        , width: 110}
                                        ]},
                                        {text:'보험료공제', id:'insur_gr', columns:[
                                            {dataIndex: 'INSUR_CODE'    , width: 90},
                                            {dataIndex: 'INSUR_USE_I'    , flex:1}
                                        ]},
                                        {dataIndex: 'MED_USE_I', id:'med_gr'    , flex:1},
                                        {text:'교육비공제', id:'edu_gr', columns:[
                                            {dataIndex: 'EDU_CODE'        , width: 90},
                                            {dataIndex: 'EDU_USE_I'    ,flex:1}
                                        ]},
                                    ...
                                    listeners:{
                                        ...
                                        edit:function(editor, context, eOpts){
                                            ...
                                            //'관계코드 필수 체크
                                            if (relationCode == "" && 
                                                UniUtils.indexOf(context.field, [ "DEFAULT_DED_YN", "HOUSEHOLDER_YN"    , "DEFORM_DED_YN"    , "BRING_CHILD_DED_YN", "WOMAN_DED_YN"  , "ONE_PARENT_DED_YN" , "OLD_DED_YN"       , "MANY_CHILD_DED_YN" , "BIRTH_ADOPT_DED_YN"]))    {
                                                alert(Msg.sMB308);        
                                            ...
                                            switch(context.field)    {
                                                ...
                                                case "DEFORM_KIND_CODE" :     //장애인 구분에 따라서 장애인 YN, 기본 공제 YN 자동 셋팅
                                                    ...
                                                    if( sAfterValue == '' )   { 
                                                        ...
                                                        context.record.set("DEFAULT_DED_YN", false);
                                                    } else {
                                                ...
                                                case "EDU_CODE":
                                                     if( sAfterValue == "" )   {
                                                        ...
                                                        if( !context.record.get("DEFORM_DED_YN"))   {
                                                            var data = Ext.Array.push(had960ukrStore.data.filterBy(function(record) {return (record != context.record && record.get('REPRE_NUM')== context.record.get('REPRE_NUM') ) } ).items);
                                                            if(data)    {
                                                                if(data[0].get(context.field) != '' && data[0].get(context.field) != sAfterValue)    {
                                                                    alert(Msg.fsbMsgH0139);
                                                                    context.record.set(context.field, data[0].get(context.field));
                                                                    sAfterValue = data[0].get(context.field);
                                                                    return;
                                                                }
                                                            }
                                                        }
                                                ...
                                                case "DEFAULT_DED_YN":
                                                    ...
                                                    if( relationCode == "0" ) {    
                                                        if( !sAfterValue  ) {
                                                            context.record.set(context.field,true);
                                                            return
                                                        }
                                                    }                    
                                                    context.grid.fnAutoSetSamePerson(context.record, context.field)
                                                ...
                                                case "WOMAN_DED_YN"    : //'부녀자공제
                                                    //'한부모소득공제 여부체크          
                                                    if(context.record.get("ONE_PARENT_DED_YN") && sAfterValue ) {
                                                    ...
                                                    //'성별 및 관계코드(본인) 체크
                                                    if( ((gender != "2" && gender != "6") || (relationCode != "0" )) && sAfterValue ) {
                                                ...
                                                case "ONE_PARENT_DED_YN"://'한부모소득공제
                                                    //'부녀자공제 여부체크
                                                    if( context.record.get("WOMAN_DED_YN") ) {
                                                ...
                                                case "MANY_CHILD_DED_YN"://'다자녀추가공제
                                                    ...
                                                    //'거주자 여부 체크
                                                    if( context.record.get("LIVE_GUBUN") == "2" ) {
                                                    ...
                                                    if( dAge > dAgeLimit  &&  !context.record.get("DEFORM_DED_YN") ) {    
                                                        alert(Msg.sMH1578); 
                                                        context.record.set(context.field, false);
                                                        context.grid.fnAutoSetSamePerson(context.record, context.field)
                                                        return;
                                                ...
                                                case "BIRTH_ADOPT_DED_YN"://'출산입양자공제
                                                    ...
                                                    if( lBirthDay < parseInt(context.record.get("YEAR_YYYY") + "0101") ) {    
                        ...
                        beforeshow: function( panel, eOpts )    {
                            ...
                            switch(familyWin.openType)    {
                                ...
                                case 'M': //의료비
                                    ...
                                    grid.getColumn("MANY_CHILD_DED_YN").hide();
                                    grid.getColumn("BIRTH_ADOPT_DED_YN").hide();
                                    grid.getColumn("MED_USE_I").setWidth(200);
                                break;
                                case 'E': //교육비
                                    info.hide();
                                    ins.hide();
                                    ...
                                    edu.show();
                                    cred.hide();
                                    grid.getColumn("EDU_USE_I").setWidth(400);
                                break;
                                case 'C': //신용카드
                                    info.hide();
                                    ins.hide();
            ...
            if(!personalPensionWin)    {
                ...
                Unilite.defineModel('had460ukrModel', {
                    fields: [    
                        ...
                        {name: 'PAY_YRLV'        , text: '납입연차'            , type: 'string', allowBlank:false, comboType:'AU', comboCode:'H151'},
            ...
            if(!medDocWin)    {
                ...
                Unilite.defineModel('had410ukrModel', {
                    fields: [    
                        ...
                        {name: 'YEAR_YYYY'            , text: '정산년도'            , type: 'string', allowBlank:false},
                        {name: 'PERSON_NAME'        , text: '사원명'            , type: 'string'},
                        {name: 'SEQ_NUM'            , text: '순번'                , type: 'string'},
                            ...
                            items:[
                                Unilite.createGrid('had410ukrGrid', {
                                    ...
                                    columns:  [
                                        ...
                                        {dataIndex: 'SEND_NUM'        , width: 100},
                                        {dataIndex: 'SEND_USE_I'        , width: 100},
                                    ...
                                    listeners:{
                                        ...
                                        edit:function(editor, context, eOpts)    {
                                            if(context.field == "MED_COMPANY_NUM")    {
                                            ...
                                            if(!me.familyPopupWin)    {
                                                ...
                                                var humanFamilyPopupStore = Unilite.createStore('humanFamilyPopupStore',{
                                                    ...
                                                    proxy: {
                                                        type: 'uniDirect',
                                                        api: {
                                                            read : 'had616ukrService.selectFamliy'
                                                        }
                                                    },
                                                    loadStoreRecords: function(){
            ...
            if(!donationWin)    {
                ...
                Unilite.defineModel('had420ukrModel', {
                    fields: [    
                        ...
                        {name: 'GIFT_COMPANY_NUM'    , text: '사업자(주민)등록번호'            , type: 'string', allowBlank:false},
                        {name: 'GIFT_COMPANY_NAME'    , text: '상호'                , type: 'string', allowBlank:false},
                        {name: 'GIFT_TEXT'            , text: '기부내용'            , type: 'string'},
                        {name: 'GIFT_YYMM'            , text: '기부년월'            , type: 'string', allowBlank:false},
                        ...
                        {name: 'GIFT_AMOUNT_I'        , text: '금액'                , type: 'uniPrice', allowBlank:false},
                            ...
                            items:[
                                Unilite.createGrid('had420ukrGrid', {
                                    ...
                                    columns:  [
                                        ...
                                        {dataIndex: 'GIFT_YYMM'        , width: 100},
                                        {dataIndex: 'GIFT_CODE'        , width: 100},
                                        {dataIndex: 'TAX_GU'        , width: 100},
                                        {dataIndex: 'GIFT_COUNT'        , width: 100},
                                        {dataIndex: 'GIFT_AMOUNT_I'        , width: 100},
                                        {text:'기부자', columns:[
                                            {dataIndex: 'FAMILY_NAME'        , width: 100},
            ...
            if(!rentWin)    {
                ...
                Unilite.defineModel('had450ukrModel', {
                    fields: [    
                        ...
                        {name: 'YEAR_YYYY'            , text: '정산년도'            , type: 'string', allowBlank:false},
                        {name: 'PERSON_NAME'        , text: '사원명'            , type: 'string'},
                        {name: 'SEQ_NO'                , text: '순번'                , type: 'uniNumber', allowBlank:false},
                        {name: 'LEAS_NAME'            , text: '임대인성명'        , type: 'string', allowBlank:false},
                        {name: 'REPRE_NUM'            , text: '주민등록번호'                , type: 'string', allowBlank:false},
                        {name: 'LEAS_ADDR'            , text: '임대차계약서 상 주소지'    , type: 'string', allowBlank:false},
                        {name: 'LEAS_BGN_DATE'        , text: '임차시작일'        , type: 'string', allowBlank:false},
                            
                        {name: 'LEAS_END_DATE'        , text: '임차종료일'        , type: 'string', allowBlank:false},
                            ...
                            items:[
                                Unilite.createGrid('had450ukrGrid', {
                                    ...
                                    columns:  [
                                        ...
                                        {dataIndex: 'MNRT_TOTAL_I'        , width: 100},
