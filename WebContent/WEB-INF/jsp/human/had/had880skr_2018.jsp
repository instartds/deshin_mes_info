<%@page language="java" contentType="text/html; charset=utf-8"%>
	...
	var directMasterStore2018 = Unilite.createStore('had880skrMasterStore2018',{
	...
	});		// end of var directMasterStore2018 = Unilite.createStore('had880skrMasterStore2018',{
	
    
    var grid2018 = Unilite.createGrid('had880skrGrid2018', {
    	// for tab    	
    	title: '2018년기준',
        layout : 'fit',
        region:'center',
        ...
        features: [{id : 'grid2018SubTotal', ftype: 'uniGroupingsummary', showSummaryRow: false },
    	           {id : 'grid2018Total', 	ftype: 'uniSummary', 	  showSummaryRow: false} ],
    	store: directMasterStore2018,
    	columns: [
