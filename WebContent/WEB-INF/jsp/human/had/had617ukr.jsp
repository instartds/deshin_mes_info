...
function appMain() {    
    ...
    Unilite.defineModel('had617ukr600Model', {
        fields: [                                                                                                                                                                                
    ...
    var direct600Store = Unilite.createStore('had617ukr600Store',{
            model: 'had617ukr600Model',
            autoLoad: false,
            folderSort: true,
            uniOpt : {
            ...
            proxy: /*directProxy*/{
                type: 'uniDirect',
                api: {
                    read : 'had617ukrService.selectFormHad600'
                    ,update : 'had617ukrService.update600'
                    ,create : 'had617ukrService.insert600'
                    ,syncAll: 'had617ukrService.save600All'
            ...
            ,saveStore : function()    {    
	            ...
	            if(list.length > 0)	{
	            	...
	            	if(me.getData() && me.getData().items)	{
	                	...
	                	Ext.getBody().mask();
		            	had617ukrService.update600_3(param, function(responseText, response){
		            		Ext.getBody().unmask();
		            	})
	            	}
	            }
        ...
        Unilite.defineModel('had617ukr400Model', {
        fields: [
              {name:'PERSON_NUMB'                ,text:'사번'                                    ,type:'string'}
        ...
        var direct400Store = Unilite.createStore('had617ukr400Store',{
            model: 'had617ukr400Model',
            autoLoad: false,
            folderSort: true,
            uniOpt : {
                isMaster: true,            // 상위 버튼 연결 
            ...
            proxy: /*directProxy*/{
                type: 'uniDirect',
                api: {
                    read : 'had617ukrService.selectFormHad400'
                    ,update : 'had617ukrService.update400'
                    ,create : 'had617ukrService.insert400'
                    ,syncAll: 'had617ukrService.save400All'
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly: true, name: 'CARD_DED_I', rowspan: 5},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'세액</br>감면', rowspan: 6, tdAttrs: {style: 'border : 1px solid #ced9e7; font: normal 12px "굴림",Gulim,tahoma, arial, verdana, sans-serif; width: 2%'}},
            ...
            items: [
                {
                    ...
                    items:[
                        ...
                        { xtype: 'component', html:'&nbsp;기부금공제금액', style: 'text-align:left', rowspan: 4, tdAttrs: { height: 319}},
                        { xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'GIFT_TAX_DED_I', rowspan: 4, tdAttrs: { height: 319}},
                        ...
                        */
                        ...
                        { xtype: 'component', html:'소득세법 시행령 제80조에서 규정하는 기부금', style: 'text-align:left', tdAttrs: { height: 145}}
                    ]
                }
            ]
        }]
...
//            defaults:{width: '97.5%', margin: '2 2 2 2'},
    ...
    var search2 = Unilite.createSearchForm('search2',{    
        ...
        xtype: 'container',
         flex: 1,
        api: {
            load: 'had617ukrService.selectFormData02'
        },
        trackResetOnLoad: true,
        layout:{type:'vbox', align:'stretch', defaultMargins: '0 0 5 0'},        
        items: [{
...
//        tabRotation: 0,          
    ...
    Unilite.Main( {
        ...
        onPrevDataButtonDown:  function()    {
            had617ukrService.selectPrev(panelSearch.getValues(), function(responseText, response){
                if(responseText){
        ...
        onNextDataButtonDown:  function()    {
            had617ukrService.selectNext(panelSearch.getValues(), function(responseText, response){
                if(responseText){
        ...
        fnCollectData:function(cType){
            ...
            var infoForm400 = Ext.getCmp('infoForm400');
               ...
               Ext.getBody().mask('Loading');
               had617ukrService.selectSummaryData(paramData, function(responseText, response){
        ...
        fnDisplayData1: function(record, sCollectType) {
            ...
            record400.set("HALFWAY_TYPE", record["HALFWAY_TYPE"]=="Y"? true:false);                    //중도퇴사자정산
        ...
        fnCalculateTax:function()    {
            ...
            var infoForm400 = Ext.getCmp('infoForm400');
               ...
               Ext.getBody().mask('Loading');
               had617ukrService.selectCalculateTax(paramData, function(responseText, response){
                   console.log("responseText", responseText);
                ...
                taxCommunityWin= Ext.create('widget.uniDetailWindow', {
                    ...
                    items: [{
                            ...
                            items:[{
                                ...
                                xtype:'uniDetailForm',
                                itemId:'had617NapForm',
                                disabled:false,
                                height:340,
                                api:{
                                    load:had617ukrService.selectNap,
                                    submit:had617ukrService.napSyncMaster
                                },
                        ...
                        items :  [
                             {
                                ...
                                handler: function() {
                                    ...
                                    had617ukrService.napDeleteAll(searchForm.getValues(), function(){
                             ...
                             },
                             {
                                ...
                                width:80,
                                handler: function() {
                                    var had617NapForm =  taxCommunityWin.down('#had617NapForm');
                                    if( had617NapForm.isDirty())          {
                                        var searchForm =  taxCommunityWin.down('#search');
                                        taxCommunityWin.mask();
                                        had617NapForm.submit({
                                            params: searchForm.getValues(),
                                            success:function()    {
                                                //alert('저장되었습니다.');
                    ...
                    listeners : {
                        ...
                        show: function( panel, eOpts )    {
                            ...
                            var form =  taxCommunityWin.down('#had617NapForm');
                            form.uniOpt.inLoading = true;
                            form.load({
                                params:searchForm.getValues(),
                                success: function()	{
            ...
            if(!familyWin)    {
                ...
                Unilite.defineModel('had960ukrModel', {
                    fields: [    
                        ...
                        {name: 'BIRTH_ADOPT_DED_YN'     , text: '출산입양자'    , type: 'bool'},
                                ...
                                Unilite.createGrid('had960ukrGrid', {
                                    ...
                                    columns:  [
                                        ...
                                        {text:'인적공제항목', id:'info_gr', columns:[
                                            ...
                                            {xtype:'checkcolumn'	,dataIndex: 'BIRTH_ADOPT_DED_YN'    , width: 90,
                                            	listeners:{
                                            		beforecheckchange:function()	{
                                            			if(familyWin.openType != 'P')	return false;
                                            		},
                                            ...
                                            {dataIndex: 'BIRTH_ADOPT_CODE'        						, width: 110}
                                        ]},
                                        {text:'보험료공제', id:'insur_gr', columns:[
                                            {dataIndex: 'INSUR_CODE'    , width: 90},
                                            {dataIndex: 'INSUR_USE_I'    , flex:1}
                                        ]},
                                        {dataIndex: 'MED_USE_I'		, id:'med_gr'    , width:100},
                                        {dataIndex: 'SURGERY_MED_I'	, id:'med_gr2'   , flex:1},
                        ...
                        if(inValidRecs.length == 0) {
                            config = {
                                        ...
                                        success: function(batch, option) {
                                            ...
                                            // 난임수술비, 의료비 반영
                                            had617ukrService.updateMedI(medDocWin.paramData, function(){
                                            	medDocWin.unmask();
                                            })
                                        }
                                };
                                            ...
                                            if(!me.familyPopupWin)    {
                                                ...
                                                var humanFamilyPopupStore = Unilite.createStore('humanFamilyPopupStore',{
                                                    ...
                                                    proxy: {
                                                        type: 'uniDirect',
                                                        api: {
                                                            read : 'had617ukrService.selectFamliy'
                                                        }
                                                    },
                                                    loadStoreRecords: function(){
            ...
            if(!pdfWin)    {
                ...
                var hadPdfStore = Unilite.createStore('hadPdfStore',{
                    ...
                    proxy: {
                        type: 'uniDirect',
                        api: {
                            read : 'had617ukrService.selectPdfList'
                            ,update : 'had617ukrService.updatePdf'
                            /*,create : 'had617ukrService.insert'
                            ,destroy : 'had617ukrService.delete'*/
                            ,syncAll: 'had617ukrService.saveAllPdf'
                        }
                ...
                pdfWin= Ext.create('widget.uniDetailWindow', {
                    ...
                    items: [{
                          ...
                          {	
                            ...
                            xtype:'uniDetailForm',
                            api: {
                                submit: had617ukrService.pdfUploadFile 
                            },
                            style:{
                                'background':'#fff'
                            },
                           ...
                           // margine:'3 3 3 3',
                          	...
                          	items:[	
			                            	...
			                            	uploadForm.submit(
												{
													params: params,
												 	...
												 	success: function(form, action)	{
												 		pdfWin.mask();
												 		had617ukrService.pdfRead(action.params, function(responseText, response){
												 			pdfWin.unmask();
															if(!response.message) {
                                ...
                                items:[{
                                    ...
                                    listeners:{
                                    	render:function(c)	{
                                    		c.getEl().on('click', function(component){
                                    			hadPdfStore.refreshFilter('G106Y');
                                    			var grid = pdfWin.down('#hadPdfGrid');
                                    			grid.getColumn('DATA_NAME').show();
                                    			grid.getColumn('CARD_TYPE_NAME').hide();
                                    			grid.getColumn('SBDY_APLN_SUM').hide();
                                    ...
                                    listeners:{
                                    	render:function(c)	{
                                    		c.getEl().on('click', function(component){
                                    			hadPdfStore.refreshFilter('G306Y');
                                    			var grid = pdfWin.down('#hadPdfGrid');
                                    ...
                                    listeners:{
                                    	render:function(c)	{
                                    		c.getEl().on('click', function(component){
                                    			hadPdfStore.refreshFilter('G206Y');
                                    			var grid = pdfWin.down('#hadPdfGrid');
                                    			grid.getColumn('DATA_NAME').show();
                                    			grid.getColumn('CARD_TYPE_NAME').hide();
                                    			grid.getColumn('SBDY_APLN_SUM').hide();
                            ...
                            api:{
                            	load:'had617ukrService.selectPDFSummary'                            
                            }
						},{
                            xtype:'container',
                            flex:1,
                    ...
                    applyData:function()	{
                    	pdfWin.mask();
                    	had617ukrService.spYearTaxPdf(pdfWin.paramData, function(responseText, response){
                    		console.log("responseText : ", responseText);
