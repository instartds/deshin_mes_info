			...
			items: [{
				...
				},
				{
					...
					items:[
						...
						{ xtype: 'component', html:'기</br>본</br>공</br>제', rowspan: 3, tdAttrs: {width:30}},
						{ xtype: 'component', html:'본인', style:'text-align:left;', tdAttrs: {width:80}},
						{ xtype: 'component', html:'', style: 'text-align:left', tdAttrs: {width:80}},
						{ xtype: 'uniNumberfield', value:'0', suffixTpl: '원', readOnly:true, name: 'PER_DED_I'},
						{ xtype: 'component', html:'근로소득자 본인에 대한 기본공제(연150만원)', style: 'text-align:left;'},

						{ xtype: 'component', html:'배우자', style: 'text-align:left'},
						{ xtype: 'component', html:'', style: 'text-align:left'},
						...
						{ xtype: 'uniNumberfield', value:'0', suffixTpl: '명', readOnly:true, name: 'SUPP_NUM', width: 75, tdAttrs: {width:75, align : 'right'}},
			...
			items: [
				{
					...
					items:[
						...
						{ xtype: 'button', text:'과학기술인공제회법에 따른 퇴직연금 입력', style: 'text-align:center', tdAttrs: {height:68}, width: '90%', itemId:'btnPension',
						  handler:function()	{
							 if(panelResult.isValid())	{
								...
								columns: [
									...
									{text:'신용카드 등 사용액공제', id:'credit_gr', columns:[
										...
										{text:'대중교통이용분', id:'traffic_gr_2020', columns:[
											...
											{dataIndex: 'TRAFFIC_USE_I_C'	, width: 90	, summaryType: 'sum',
												renderer: function(value, meta, record) {
													if(UniUtils.indexOf(record.get("REL_CODE"), ['', '6', '7', '8'])) {
														meta.tdCls = 'cash_disabled';
													}
									...
									switch(field)	{
										case "DEFAULT_DED_YN":
											...
											//'2-2) 직계비속, 위탁아동
												...
												if(sAfterValue){
													if( relationCode == "4" || relationCode == "8" ){
															//자녀세액공제
															if(dAge >= 7){
							...
							case "REL_CODE":
								...
								switch(sAfterValue){
									...
									case "8":
										if(dAge <= 20){
											record.set("DEFAULT_DED_YN", true);
											if (sAfterValue == "4" || sAfterValue == "8"){
												//7세이상 자녀세액공제	
												if(dAge >= 7){
													record.set("BRING_CHILD_DED_YN", true);
												}
				...
				donationWin = Ext.create('widget.uniDetailWindow', {
					...
					listeners : {
						...
						beforeshow: function( panel, eOpts )	{
							...
							searchForm.setValue("NATION_CODE"	,donationWin.paramData.NATION_CODE);
						...
						switch(fieldName)	{
							case "GIFT_CODE":
								if(sAfterValue == '20' || sAfterValue == '42')	{
									...
									record.set("IN_FORE", (searchForm.getValue("NATION_CODE") == "KR" ? "1" : "9"));
								}
								if(sAfterValue == '20')	{
