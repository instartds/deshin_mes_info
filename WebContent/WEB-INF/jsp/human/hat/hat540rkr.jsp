...
//                  },
	...
	Unilite.Main({
        ...
        onPrintButtonDown: function() {
			...
			var title_Doc = '';
			var prgID1    = 'hat540rkr';
			if(doc_Kind == '1' ){
				title_Doc = Msg.sMHT0083; 
			}else if(doc_Kind == '2'){
				title_Doc = Msg.sMHT0084; 
			}
...
/*			
	        var win = Ext.create('widget.PDFPrintWindow', {
	            url: CPATH+'/hat/hat540rkrPrint.do',
	            prgID: prgID1,
	            extParam: param2
	            });
	            win.center();
	...
	*/
				...
				param.PGM_ID				= 'hat540rkr';				
				
				var win = Ext.create('widget.ClipReport', {
					url		: CPATH+'/human/hat540clrkrPrint.do',
					prgID	: 'hat540rkr',
					extParam: param2
				});
				win.center();
