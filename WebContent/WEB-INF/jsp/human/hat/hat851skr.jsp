...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('hat851skrModel', {
		fields: [
	 ...
	 * @type 
	 */					
	var masterStore = Unilite.createStore('hat851skrMasterStore1',{
		model	: 'hat851skrModel',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {			
					read: 'hat851skrService.selectList'
			}
		},
...
//					detailForm.openCryptRepreNoPopup();
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('hat851skrGrid1', {
		store	: masterStore,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
