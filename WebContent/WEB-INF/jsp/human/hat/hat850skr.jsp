...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('hat850skrModel', {
		fields: [
	 ...
	 * @type 
	 */					
	var masterStore = Unilite.createStore('hat850skrMasterStore1',{
		model	: 'hat850skrModel',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {			
					read: 'hat850skrService.selectList'
			}
		},
...
//					detailForm.openCryptRepreNoPopup();
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('hat850skrGrid1', {
		store	: masterStore,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
