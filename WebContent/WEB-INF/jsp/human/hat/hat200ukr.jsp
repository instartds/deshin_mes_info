...
//                            'DIV_CODE'  : panelResult.getValue('DIV_CODE')
                        ...
                        grids: [{
                            ...
                            readApi: 'hat200ukrService.selectExcelUploadSheet1',
...
//                                console.log("response",response)
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'hat200ukrService.selectList',
			destroy: 'hat200ukrService.deleteHat200',
			update: 'hat200ukrService.updateHat200',
			syncAll: 'hat200ukrService.saveAll'
		}
	});
	/**
	 * Store 정의(Service 정의)
...
//			UniAppManager.setToolbarButtons('deleteAll',true);
	...
	var directMasterStore2 = Unilite.createStore('hat200ukrMasterStore2', {
		...
		proxy: {
			type: 'direct',
			api: {
				read: 'hat200ukrService.selectList2'
			}
		},
		listeners: {
