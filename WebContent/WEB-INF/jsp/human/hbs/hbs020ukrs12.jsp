					...
					items:[
							...
							listeners: {
                                ...
                                onClear: function(type) {
                                    Ext.getCmp('hbs020ukrTab12_inner').setValue('DEPT_CODE_FROM', '');
                                    Ext.getCmp('hbs020ukrTab12_inner').setValue('DEPT_NAME_FROM', '');
                                }
                            }
						}),
						Unilite.popup('DEPT',{
							...
							listeners: {
                                ...
                                onClear: function(type) {
                                    Ext.getCmp('hbs020ukrTab12_inner').setValue('DEPT_CODE_TO', '');
                                    Ext.getCmp('hbs020ukrTab12_inner').setValue('DEPT_NAME_TO', '');
                                }
                            }
						}),
						Unilite.popup('Employee', {
							...
							listeners: {
                                ...
                                onClear: function(type) {
                                    Ext.getCmp('hbs020ukrTab12_inner').setValue('PERSON_NUMB', '');
                                    Ext.getCmp('hbs020ukrTab12_inner').setValue('NAME', '');
                                }
                            }
					})]
				},{
...
//						tdAttrs: {align: 'left', width: 65},
						handler : function() {
							if(confirm('연봉 반영 작업을 진행하시겠습니까?')){
								hbs020ukrs12Store.saveStore(true);
							}
        ...
        tbar: [{
    		...
    		text:'엑셀 참조',
    		handler: function() {
    			openExcelWindowAnnualSalary();
			}
   		 }],
			columns: columnsTab12,
