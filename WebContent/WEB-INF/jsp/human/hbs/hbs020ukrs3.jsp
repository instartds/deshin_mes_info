...
<!-- 	} -->
		{
			xtype: 'container',
			title:'<t:message code="system.label.human.dutybaseupdate" default="근태기준등록"/>',
			id:'hbs020ukrTab3',
			itemId: 'hbs020ukrTab3',
			layout: {type: 'vbox', align: 'stretch'},
			items:[{
					...
					items:[{
						...
						items:[{
							...
							fieldLabel: '<t:message code="system.label.human.dutycode" default="근태코드"/>',
							name: 'DUTY_CODE',
							id: 'DUTY_CODE3',
							itemId: 'tabFocus3',
							xtype: 'uniCombobox',
...
//						{dataIndex: 'DUTY_LAST_DD'  	,		width: 80, hidden: true},
						...
						{dataIndex: 'WORK_TIME_REL_CODE',		width: 100},
						...
						{dataIndex: 'FULL_REL_CODE' 	,		width: 100}
