<%@page language="java" contentType="text/html; charset=utf-8"%>
	 {
		title:'<t:message code="system.label.human.armymajorupdate" default="병역병과등록"/>',
		id:'hbs010ukrGrid10',
		border: true,
		subCode:'H019',
		getSubCode: function()	{
...
//			{dataIndex: 'CODE_NAME_EN'			,		width: 300, hidden: true},
//			{dataIndex: 'CODE_NAME_CN'			,		width: 300, hidden: true},
//			{dataIndex: 'CODE_NAME_JP'			,		width: 300, hidden: true},
