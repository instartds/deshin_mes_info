<%@page language="java" contentType="text/html; charset=utf-8"%>
	 {
		title:'<t:message code="system.label.human.departrateupdate" default="부서별요율등록"/>',
		id:'hbs020ukrTab13',
		...
		items:[{
			...
			Unilite.treePopup('DEPTTREE',{
				...
				name: 'CREATE_DEPT',
				id: 'createDept',
				text: '<t:message code="system.label.human.createdept" default="대상부서일괄생성"/>',
				handler: function() {
					if(confirm('<t:message code="system.message.human.message094" default="대상부서를 일괄 생성합니다. 생성 하시겠습니까?"/>')){
