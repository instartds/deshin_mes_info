...
<script type="text/javascript">
	...
	Ext.onReady(function() {
        ...
        modulesOther.push({
             xtype: 'uniImg',
             src: CPATH+'/resources/css/theme_01/product_11_over.png',
			...
			height: '142px',
             ...
             listeners: {
                 el: {
                    click: function() {
                      //	window.open('prodt/pmp120skrv.do','_blank','width='+(1270)+',height='+(screen.availHeight)+'menubar=no,location=no,scrollbars=yes,resizable=no,top=0,left=0');
                    	window.open('prodt/pmp120skrv.do', '_blank');
                    },
		            mouseover: function(e, elem, eOpts) {
		            	elem.src =  CPATH+'/resources/css/theme_01/product_11_over.png';
		            },
		            mouseout: function(e, elem, eOpts) {
		            	elem.src =  CPATH+'/resources/css/theme_01/product_11.png';
		            }
                }
             }
        });
        ...
        modulesOther.push({
            xtype: 'uniImg',
            src: CPATH+'/resources/css/theme_01/product_12_over.png',
          	width: '110px',
			height: '142px',
            margin: '40 20 0 20',
            listeners: {
	           el: {
		           ...
		           mouseover: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_12_over.png';
		           },
		           mouseout: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_12.png';
		           }
           	   }
           }
        });
        ...
        modulesOther.push({
            xtype: 'uniImg',
            src: CPATH+'/resources/css/theme_01/product_13_over.png',
          	width: '110px',
			height: '142px',
            margin: '40 20 0 20',
            listeners: {
	           el: {
	               click: function() {
	                 	//window.open('prodt/pmp283ukrv.do','_blank','width='+(1270)+',height='+(screen.availHeight)+'menubar=no,location=no,scrollbars=yes,resizable=no,top=0,left=0');
	            	   window.open('prodt/pmp283ukrv.do', '_blank');
	               },
		           mouseover: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_13_over.png';
		           },
		           mouseout: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_13.png';
		           }
           	   }
           }
        });
     // 작업자등록(POP) 추가.
        modulesOther.push({
            xtype: 'uniImg',
            src: CPATH+'/resources/css/theme_01/product_14_over.png',
          	width: '110px',
			height: '142px',
            margin: '40 20 0 20',
            listeners: {
	           el: {
	                click: function() {
	                 	//window.open('prodt/pmr800ukrv.do','_blank','width='+(1270)+',height='+(screen.availHeight)+'menubar=no,location=no,scrollbars=yes,resizable=no,top=0,left=0');
	                	window.open('prodt/pmr800ukrv.do', '_blank');
	                },
	           		mouseover: function(e, elem, eOpts) {
	           			elem.src =  CPATH+'/resources/css/theme_01/product_14_over.png';
	           		},
		           mouseout: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_14.png';
		           }
           	   }
           }
        });
        ...
        modulesOther.push({
            xtype: 'uniImg',
            src: CPATH+'/resources/css/theme_01/product_15_over.png',
          	width: '110px',
			height: '142px',
            margin: '40 20 0 20',
            listeners: {
	           el: {
	               	click: function() {
                 		//window.open('prodt/pms401ukrv.do','_blank','width='+(1270)+',height='+(screen.availHeight)+'menubar=no,location=no,scrollbars=yes,resizable=no,top=0,left=0');
	               		window.open('prodt/pms401ukrv.do', '_blank');
	               	},
		           	mouseover: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_15_over.png';
		           	},
		           	mouseout: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_15.png';
		           	}
           	   }
           }
        });
        ...
        modulesOther.push({
            xtype: 'uniImg',
            src: CPATH+'/resources/css/theme_01/product_16_over.png',
          	width: '110px',
			height: '142px',
            margin: '40 20 0 20',
            listeners: {
	           el: {
	                click: function() {
	                 	//window.open('prodt/pmp300ukrv.do','_blank','width='+(1270)+',height='+(screen.availHeight)+'menubar=no,location=no,scrollbars=yes,resizable=no,top=0,left=0');
	                	window.open('prodt/pmp300ukrv.do', '_blank');
	                },
		           mouseover: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_16_over.png';
		           },
		           mouseout: function(e, elem, eOpts) {
		           		elem.src =  CPATH+'/resources/css/theme_01/product_16.png';
		           }
           	   }
           }
        });
     // 설비일상점검등록  추가.
        modulesOther.push({
            xtype: 'uniImg',
            src: CPATH+'/resources/css/theme_01/product_17_over.png',
          	width: '110px',
			height: '142px',
            margin: '40 20 0 20',
            listeners: {
	           el: {
	                click: function() {
	                 	//window.open('prodt/pmp400ukrv.do','_blank','width='+(1270)+',height='+(screen.availHeight)+'menubar=no,location=no,scrollbars=yes,resizable=no,top=0,left=0');
	                	window.open('prodt/pmp400ukrv.do', '_blank');
	                },
	           mouseover: function(e, elem, eOpts) {
	           		elem.src =  CPATH+'/resources/css/theme_01/product_17_over.png';
	           },
	           mouseout: function(e, elem, eOpts) {
	           		elem.src =  CPATH+'/resources/css/theme_01/product_17.png';
	           }
           	   }
           }
        });
     // 공정검사등록(POP) 추가.
        modulesOther.push({
            xtype: 'uniImg',
            src: CPATH+'/resources/css/theme_01/product_18_over.png',
          	width: '110px',
			height: '142px',
            margin: '40 20 0 20',
            listeners: {
	           el: {
	                click: function() {
	                 	//window.open('prodt/pms402ukrv.do','_blank','width='+(1270)+',height='+(screen.availHeight)+'menubar=no,location=no,scrollbars=yes,resizable=no,top=0,left=0');
	                	window.open('prodt/pms402ukrv.do', '_blank');
	                },
	           mouseover: function(e, elem, eOpts) {
	           		elem.src =  CPATH+'/resources/css/theme_01/product_18_over.png';
	           },
	           mouseout: function(e, elem, eOpts) {
	           		elem.src =  CPATH+'/resources/css/theme_01/product_18.png';
	           }
           	   }
           }
        });
