...
<script type="text/javascript">
	...
	var boardNoticeRefreshTime = Unilite.nvl(${refreshNoticeTime},-1);			// 운행정보
	var boardRefreshTime = Unilite.nvl(${refreshTime},-1);			// 운행정보
	var boardGttRefreshTime = Unilite.nvl(${refreshTime},-1);		// 근태정보
	var bordTime = {
		gttStartTime: Unilite.nvl('${gttStartTime}'	, '0400'),
		gttEndTime	: Unilite.nvl('${gttEndTime}'	, '0859'),
		startTime	: Unilite.nvl('${startTime}'	, '0900'),
		endTime		: Unilite.nvl('${endTime}'		, '2359')
//		gttStartTime: '02:06',
//		gttEndTime	: '02:07',
//		startTime	: '01:06',
//		endTime		: '01:50'
...
//			},
		...
		//tab3: board
		tabContents.push(Ext.create('Unilite.main.board.MainBoardSUWON'));
