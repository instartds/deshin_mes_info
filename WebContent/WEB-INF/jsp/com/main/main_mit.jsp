...
//                            }
        ...
        modules.push({
                xtype: 'uniImg',
                src: CPATH+'/resources/css/theme_01/module_20.png',
                //title: '<t:message code="main.menuTab.mymenu" />',
                width: moduleWidth,
                height: moduleHeight,
                margin: '40 20 0 20',
...
//                            }
			            ...
			            mouseover: function(e, elem, eOpts) {
			            	elem.src = CPATH+'/resources/css/theme_01/module_20_over.png';
			            },
			            mouseout: function(e, elem, eOpts) {
			            	elem.src = CPATH+'/resources/css/theme_01/module_20.png';
			            }
                    }
                }
        });
...
//					if(url.substring(url.indexOf('/' , 1) +1, 7) == 's_etv'){//현황판 프로그램일 경우 window open으로 띄움
					if(rec.get("parentId") == "20.0100"){//현황판 프로그램일 경우 window open으로 띄움
