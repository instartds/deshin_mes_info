...
//			};
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH + '/resources/css/theme_01/' + "worldmemory_over.png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 90',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH + '/resources/css/theme_01/' + "worldmemory.png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH + '/resources/css/theme_01/' + "worldmemory_over.png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'34'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'34'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'34'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'12'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'12'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'12'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'13'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'13'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'13'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
...
//						}
		...
		modules.push({
			xtype	: 'component',
			html	: '<p><hr width="100%" color="white" height="10px"/><p>',
			width	: '100%',
			margin	: '40 20 0 20',
			listeners: {
			}
		...
		//20210622 아래 모듈 이미지 전체 변경
		//기준, 20210521 위치 변경
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'11_wm'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 40',
			listeners: {
				el: {
					click: function(e, elem, eOpts) {
						var tabPanel = Ext.getCmp('panelNavigation');
						moduleChange('11', '기준정보');
						console.log('changed');
					},
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'11_wm'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'11_wm'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'14_wm'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'14_wm'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'14_wm'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'15_wm'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'15_wm'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'15_wm'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'16_wm'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'16_wm'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'16_wm'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'18_wm'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 20 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'18_wm'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'18_wm'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
		...
		modules.push({
			xtype	: 'uniImg',
			src		: CPATH+'/resources/css/theme_01/module_'+'21_wm'+'_over'+CUR_LANG_SUFFIX+".png",
			width	: moduleWidth,
			height	: moduleHeight,
			margin	: '40 0 0 20',
			listeners: {
				el: {
					...
					mouseover: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'21_wm'+CUR_LANG_SUFFIX+".png";
					},
					mouseout: function(e, elem, eOpts) {
						elem.src = CPATH+'/resources/css/theme_01/module_'+'21_wm'+'_over'+CUR_LANG_SUFFIX+".png";
					}
				}
			}
		});
...
//		modules.push({
//			xtype	: 'uniImg',
//			src		: CPATH+'/resources/css/theme_01/module_'+'99'+'_over'+CUR_LANG_SUFFIX+".png",
//			width	: moduleWidth,
//			height	: moduleHeight,
//			margin	: '40 20 0 20',
//			listeners: {
...
//					click: function(e, elem, eOpts) {
//						var tabPanel = Ext.getCmp('panelNavigation');
//						moduleChange('99', '오메가플러스');
//						console.log('changed');
//					},
//					mouseover: function(e, elem, eOpts) {
//						elem.src = CPATH+'/resources/css/theme_01/module_'+'99'+CUR_LANG_SUFFIX+".png";
//					},
//					mouseout: function(e, elem, eOpts) {
//						elem.src = CPATH+'/resources/css/theme_01/module_'+'99'+'_over'+CUR_LANG_SUFFIX+".png";
//					}
//				}
//			}
//		});
			...
			<c:choose>
				...
				<c:otherwise>
					load: function(store, records, successful, operation, node, eOpts) { //5.1.0
						...
						//20210303 수정: 운송장 발행량 확인 위해
						mainMenuService.getInvoiceNumCount({}, function(provider, response) {
							if(provider) {
								Ext.getCmp('USED_QTY').setValue(provider.USED_QTY);
							}
						});
			...
			listeners : {
				render: function() {
					...
					//	moduleChange(moduleArray[0].id, moduleArray[0].title);
						moduleChange('32', '월드');			//20210524 수정
				},
				urlclick : function(rec, url, item) {
					if(url.substring(url.indexOf('_wm.do') - 1, url.indexOf('_wm.do')) == 'b'){//20201109 추가: 현황판 프로그램(board)일 경우 window open으로 띄움
...
//			},
		...
		tabContents.push(<%@include file="main_homeContents_wm.jsp" %>);		//20210303 수정: 운송장 발행량 확인 위해
