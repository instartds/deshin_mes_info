...
String loginPage = request.getContextPath() + ConfigUtil.getString("common.login.loginPage", "/login/loginForExtUser.do");
request.setAttribute("loginPage", loginPage);
if(userSession == null)	{
	response.sendRedirect(request.getContextPath()+"/login/loginForExtUser.do");
} 
%>
<!DOCTYPE html >
...
function updatePassword(lForce) {
        ...
        $.ajax({
            type: "POST",
            url: "<c:url value='/login/updateExtUserPassword.do' />",
