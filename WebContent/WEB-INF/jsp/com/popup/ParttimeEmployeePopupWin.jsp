...
<%
// 거래처 팝업
request.setAttribute("PKGNAME","Unilite.app.popup.ParttimeEmployeePopup");
%>
...
var isDecYn = 'N';  //복호화 조회 여부   
	 ...
	 * @type 
	 */
Unilite.defineModel('${PKGNAME}.ParttimeEmployeePopupModel', {  
...
Ext.define('${PKGNAME}', {
    ...
    constructor : function(config) {
		...
		me.masterStore = Unilite.createStoreSimple('${PKGNAME}.emplyeePopupMasterStore',{
                model: '${PKGNAME}.ParttimeEmployeePopupModel',
                autoLoad: true,
                proxy: {
                    type: 'direct',
                    api: {
                        read: 'popupService.parttimeEmployeePopup'
                    }
                }
        })
		/**
