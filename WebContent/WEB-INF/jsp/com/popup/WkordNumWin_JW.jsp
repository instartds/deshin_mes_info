...
<%
//	작업지시정보 팝업 'Unilite.app.popup.wkordNum_JW' 
request.setAttribute("PKGNAME","Unilite.app.popup.WkordNum_JW");
%>
...
Ext.define('${PKGNAME}', {
	...
	fnInitBinding : function(param) {
        ...
        if(param) {
			...
			if(param['FR_PRODT_WKORD_DATE'] && param['FR_PRODT_WKORD_DATE']!='')	frm.setValue('FR_PRODT_WKORD_DATE',   param['FR_PRODT_WKORD_DATE']);
			if(param['TO_PRODT_WKORD_DATE'] && param['TO_PRODT_WKORD_DATE']!='')	frm.setValue('TO_PRODT_WKORD_DATE',   param['TO_PRODT_WKORD_DATE']);
			if(param['TOP_WKORD_NUM'] && param['TOP_WKORD_NUM']!='')				frm.setValue('WKORD_NUM',   param['TOP_WKORD_NUM']);
