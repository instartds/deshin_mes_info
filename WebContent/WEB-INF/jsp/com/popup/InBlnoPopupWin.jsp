...
<%
request.setAttribute("PKGNAME","Unilite.app.popup.InBlnoPopup");
%>
	<t:ExtComboStore useScriptTag="false" comboType="BOR120" />							// 사업장 

	 Unilite.defineModel('${PKGNAME}.InBlnoPopupModel', {
	    fields: [{name: 'DIV_CODE' 			,text:'<t:message code="system.label.common.division" default="사업장"/>' 		,type:'string', comboType:'BOR120'	},
				 ...
				 {name: 'IN_BLNO_CODE' 		,text:'<t:message code="system.label.common.blno" default="B/L번호"/>' 		,type:'string'	},
...
Ext.define('${PKGNAME}', {
    ...
    me.masterGrid = Ext.create('Unilite.com.grid.UniGridPanel',{
            store: Unilite.createStoreSimple('${PKGNAME}.inBlnoPopupStore',{
							model: '${PKGNAME}.InBlnoPopupModel',
					        autoLoad: false,
					        proxy: {
					            type: 'direct',
					            api: {
					            	read: 'popupService.inBlnoPopup'
					            }
					        }
					}),
	        uniOpt:{
	        ...
	        columns:  [        
	                    ...
	                    ,{ dataIndex: 'IN_BLNO_CODE' 	,  width: 100 }
