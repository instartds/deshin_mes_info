...
request.setAttribute("PKGNAME","Unilite.app.popup.WkordNum_KDG");
%>
	 ...
	 */
	 ...
	 Unilite.defineModel('${PKGNAME}.wkordNumPopup_KDGModel', {
	    fields: [
...
Ext.define('${PKGNAME}', {
	...
	constructor : function(config){
        ...
        me.form = Unilite.createSearchForm('', {
                        ...
                        items : [{
								...
								,{
                                  ...
                                  fieldLabel : '<t:message code="system.label.common.drafting" default="기안여부"/>',
                                  name : 'GW_FLAG',
                                  xtype: 'uniCombobox',
								  comboType:'AU', 
								  comboCode:'WB17',
		...
		me.grid = Ext.create('Unilite.com.grid.UniGridPanel',{
            ...
            store : Unilite.createStoreSimple('${PKGNAME}.wkordNumPopup_KDGMasterStore',{
							model: '${PKGNAME}.wkordNumPopup_KDGModel',
					        autoLoad: false,
					        proxy: {
					            type: 'direct',
					            api: {
					            	read: 'popupService.wkordNum_KDG'
					            }
					        }
					}),
			uniOpt:{
