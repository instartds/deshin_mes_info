...
//    }
	me.panelSearch = Unilite.createSearchForm('',{
	    ...
	    items: [ { fieldLabel: '대표모델' ,  name:'TXTITEM_GROUP'  , xtype: 'uniTextfield' }
	               ,{ fieldLabel: '대분류',     name: 'TXTLV_L1' , xtype: 'uniCombobox' ,  store: Ext.data.StoreManager.lookup('itemLeve1Store') , child: 'TXTLV_L2'}
	               ,{ fieldLabel: '검색항목' ,   name:'TXTFIND_TYPE'  , xtype: 'uniCombobox' , comboType:'AU' ,comboCode:'B052' , value:'01'}
	               ,{ fieldLabel: '중분류',     name: 'TXTLV_L2' , xtype: 'uniCombobox' ,  store: Ext.data.StoreManager.lookup('itemLeve2Store') , child: 'TXTLV_L3'}
	               ,{ fieldLabel: '검색어',     name: 'TXT_SEARCH' , xtype: 'uniTextfield' }
	               ,{ fieldLabel: '소분류',     name: 'TXTLV_L3' , xtype: 'uniCombobox' ,  store: Ext.data.StoreManager.lookup('itemLeve3Store'), parentNames:['TXTLV_L1','TXTLV_L2'], levelType:'ITEM' }
//	               ,{ fieldLabel: '품목코드' ,   name:'LBL_SEARCH' ,  xtype: 'uniTextfield', allowBlank: true }
	               ,{ fieldLabel: '사용여부' ,   name:'USE_YN' ,  xtype: 'uniTextfield', hidden: true }
				   ,{ xtype: 'uniTextfield', fieldLabel: '조회조건',     name:'TXT_SEARCH2'}
