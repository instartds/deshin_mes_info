...
*/
%>
<t:appConfig pgmId="crm.pop.ItemGroupPopup"  >
...
function appMain() {
	...
	Unilite.defineModel('itemGroupPopupModel', {
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('itemGroupPopupMasterStore',{
			model: 'itemGroupPopupModel',
            autoLoad: false,
            proxy: {
                type: 'direct',
                api: {
	...
	var panelSearch = Unilite.createSearchForm('searchForm',{
        ...
        items: [    { fieldLabel: '계정' ,   name:'ITEM_ACCOUNT'  , xtype: 'uniCombobox' , comboType:'AU' ,comboCode:'B020' , value:'01'}
    ...
    var masterGrid = Unilite.createGrid('itemGroupPopupGrid', masterGridConfig);
