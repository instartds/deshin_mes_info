...
<%
request.setAttribute("PKGNAME","Unilite.app.popup.IFRSAssetPopup");
%>
	...
	<t:ExtComboStore useScriptTag="false" comboType="BOR120" />							// 사업장 
	 ...
	 Unilite.defineModel('${PKGNAME}.IFRSAssetPopupModel', {
...
//                 }
    ...
    me.masterGrid = Ext.create('Unilite.com.grid.UniGridPanel',{
            store: Unilite.createStoreSimple('${PKGNAME}.custPopupStore',{
							model: '${PKGNAME}.IFRSAssetPopupModel',
					        autoLoad: false,
					        proxy: {
					            type: 'direct',
					            api: {
					            	read: 'popupService.IFRSassetPopup'
					            }
					        }
					}),
	        uniOpt:{
