...
<%
	...
	request.setAttribute("PKGNAME","Unilite.app.popup.AgentDivPumokPopup");
%>
    ...
    <t:ExtComboStore useScriptTag="false" items="${COMBO_DIV_CODE}" storeId="divComboStore" /><!-- 사업장 -->


	/**
	 *   Model 정의
	 */
	Unilite.defineModel('${PKGNAME}.AgentDivPumokPopupModel', {
		fields: [
...
//		}
		...
		me.panelSearch = Unilite.createSearchForm('',{
			...
			items: [	{ fieldLabel: '<t:message code="system.label.common.division" default="사업장"/>' ,xtype: 'uniCombobox',	name:'DIV_CODE'  , store: Ext.data.StoreManager.lookup('divComboStore'), readOnly:true}
...
//					   }
		...
		var masterGridConfig = {
			store	: Unilite.createStoreSimple('${PKGNAME}.AgentDivPumokPopupMasterStore',{
				model: '${PKGNAME}.AgentDivPumokPopupModel',
				autoLoad: false,
				proxy: {
					type: 'direct',
					api: {
						read: 'popupService.divPumokPopup_Agent'
					}
				},
				listeners	: {
