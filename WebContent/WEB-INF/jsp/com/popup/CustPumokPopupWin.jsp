...
<%
	//  거래처별 품목 'Unilite.app.popup.CustPumokPopup' 
	request.setAttribute("PKGNAME","Unilite.app.popup.CustPumokPopup");
%>
	...
	Unilite.defineModel('${PKGNAME}.divPumokPopupModel', {
	    fields: [ 	{name: 'ITEM_CODE'    		,text:'<t:message code="system.label.common.itemcode" default="품목코드"/>'	,type : 'string'} 
					...
					,{name: 'PURCHASE_P'    		,text:'<t:message code="system.label.common.purchaseprice" default="매입가"/>'	,type : 'uniUnitPrice'}
					...
					,{name: 'STOCK_Q'  		  				,text:'<t:message code="system.label.common.inventoryqty2" default="재고수량"/>'	,type : 'uniQty'}
			]
	});
...
Ext.define('${PKGNAME}', {
    ...
    constructor : function(config){
	    ...
	    me.panelSearch = Unilite.createSearchForm('',{
	        ...
	        items: [   { fieldLabel: '<t:message code="system.label.common.division" default="사업장"/>' ,   name:'DIV_CODE'  , xtype: 'uniCombobox' , comboType:'BOR120', readOnly: true, allowBlank: false }
	        		   ,{ fieldLabel: '<t:message code="system.label.common.customcode" default="거래처코드"/>' ,   name:'CUSTOM_CODE'  , xtype: 'uniTextfield' , hidden:true}
	                   ,{ fieldLabel: '<t:message code="system.label.common.repmodel" default="대표모델"/>' ,  name:'ITEM_GROUP' ,colspan:2 }
	                   ,{ fieldLabel: '<t:message code="system.label.common.account" default="계정"/>' ,   name:'ITEM_ACCOUNT'  , xtype: 'uniCombobox' , comboType:'AU' ,comboCode:'B020', /*value: '01', multiSelect : true, typeAhead: false,*/
		                    listeners:{
	     ...
	     var masterGridConfig = {
            store : Unilite.createStoreSimple('${PKGNAME}.divPumokPopupMasterStore',{
				            ...
				            proxy: {
				                type: 'direct',
				                api: {
				                	read: 'popupService.custPumokPopup'
				                }
				            }
					}),
	        uniOpt:{
	        ...
	        columns:  [        
	                    ...
	                    ,{ dataIndex: 'SALE_BASIS_P',       width: 90   ,hidden:false}
	                    ,{ dataIndex: 'PURCHASE_P'	,       width: 90   ,hidden:false}
