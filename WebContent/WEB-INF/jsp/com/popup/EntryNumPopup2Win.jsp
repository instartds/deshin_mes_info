...
<%
request.setAttribute("PKGNAME","Unilite.app.popup.EntryNumPopup2");
%>
 ...
 * @type 
 */
Unilite.defineModel('${PKGNAME}.EntryNumPopup2Model', {
    fields: [
            ...
            {name : 'MAKE_QTY',             text : '<t:message code="system.label.common.processqty" default="가공수량"/>',        type : 'uniQty'},
 ...
 */
         me.masterGrid = Unilite.createGrid('', {
            store: Unilite.createStore('${PKGNAME}.EntryNumPopup2MasterStore',{
                            model: '${PKGNAME}.EntryNumPopup2Model',
                            autoLoad: false,
                            proxy: {
                                type: 'uniDirect',
                                api: {
                                    read: 'popupService.entryNumPopup2'
                                }
                            },
