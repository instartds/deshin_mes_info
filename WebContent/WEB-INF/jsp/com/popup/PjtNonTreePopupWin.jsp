...
<%
request.setAttribute("PKGNAME","Unilite.app.popup.PjtNonTreePopup");
%>


	Unilite.defineModel('${PKGNAME}.PjtNonTreePopupModel', {
...
Ext.define('${PKGNAME}', {
    ...
    me.masterGrid = Ext.create('Unilite.com.grid.UniGridPanel',{
            store: Unilite.createStoreSimple('${PKGNAME}.PjtNonTreePopupStore',{
					model: '${PKGNAME}.PjtNonTreePopupModel',
			        autoLoad: false,
			        proxy: {
			            type: 'direct',
			            api: {
			            	read: 'popupService.pjtPopupW'
			            }
			        }
			}),
	        uniOpt:{
