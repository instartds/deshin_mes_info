...
<%
request.setAttribute("PKGNAME","Unilite.app.popup.ExchangeAccntsPopup");
%>
<t:ExtComboStore useScriptTag="false" comboType="BOR120" />							// 사업장 
	
	Unilite.defineModel('${PKGNAME}.ExchangeAccntsPopupModel', {
	    fields: [{name: 'ACCNT' 				,text:'<t:message code="system.label.common.exchangecode" default="환산계정코드"/>' 	,type:'string'	},
				 {name: 'ACCNT_NAME' 		,text:'<t:message code="system.label.common.exchangename" default="환산계정"/>' 		,type:'string'	}
			]
	});
    ...
    constructor : function(config) {
	    ...
	    me.masterGrid = Ext.create('Unilite.com.grid.UniGridPanel',{
	        store: Unilite.createStoreSimple('${PKGNAME}.custPopupStore',{
				model: '${PKGNAME}.ExchangeAccntsPopupModel',
		        autoLoad: false,
		        proxy: {
		            type: 'direct',
		            api: {
		            	read: 'popupService.exchangeAccntPopup'
		            }
		        }
			}),
	        uniOpt:{
