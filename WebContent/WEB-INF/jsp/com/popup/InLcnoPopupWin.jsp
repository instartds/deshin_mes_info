...
<%
request.setAttribute("PKGNAME","Unilite.app.popup.InLcnoPopup");
%>
	<t:ExtComboStore useScriptTag="false" comboType="BOR120" />							// 사업장 

	 Unilite.defineModel('${PKGNAME}.InLcnoPopupModel', {
	    fields: [{name: 'DIV_CODE' 			,text:'<t:message code="system.label.common.division" default="사업장"/>' 		,type:'string', comboType:'BOR120'	},
				 ...
				 {name: 'IN_LCNO_CODE' 		,text:'<t:message code="system.label.common.lcno" default="L/C번호"/>' 		,type:'string'	},
...
Ext.define('${PKGNAME}', {
    ...
    me.masterGrid = Ext.create('Unilite.com.grid.UniGridPanel',{
            store: Unilite.createStoreSimple('${PKGNAME}.inLcnoPopupStore',{
							model: '${PKGNAME}.InLcnoPopupModel',
					        autoLoad: false,
					        proxy: {
					            type: 'direct',
					            api: {
					            	read: 'popupService.inLcnoPopup'
					            }
					        }
					}),
	        uniOpt:{
	        ...
	        columns:  [        
	                    ...
	                    ,{ dataIndex: 'IN_LCNO_CODE' 		,  width: 100 }
