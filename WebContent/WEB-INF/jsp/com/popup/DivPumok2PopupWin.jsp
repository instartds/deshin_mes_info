...
<%
	//  사업장별 품목 'Unilite.app.popup.DivPumok2Popup' 
	request.setAttribute("PKGNAME","Unilite.app.popup.DivPumok2Popup");
%>
	 ...
	 *   Model 정의 
	 */
	Unilite.defineModel('${PKGNAME}.divPumok2PopupModel', {
...
Ext.define('${PKGNAME}', {
    ...
    constructor : function(config){
	    ...
	    me.panelSearch = Unilite.createSearchForm('',{
	        ...
	        items: [   
	        		    ...
	        		    { fieldLabel: '<t:message code="system.label.common.gridtype" default="그리드구분"/>' ,   name:'Gird'  , xtype: 'uniTextfield' , hidden:true}
	        		   ,{ fieldLabel: '<t:message code="system.label.common.parentitemcode" default="모품목코드"/>' ,   name:'PROD_ITEM_CODE'  , xtype: 'uniTextfield' , hidden:true}
	        		   ,{ fieldLabel: '<t:message code="system.label.common.childitemcode" default="자품목코드"/>' ,   name:'CHILD_ITEM_CODE'  , xtype: 'uniTextfield', hidden:true }
	        		   ,{ fieldLabel: '<t:message code="system.label.common.division" default="사업장"/>' ,   name:'DIV_CODE'  , xtype: 'uniCombobox' , comboType:'BOR120', readOnly: true  }
	                   ,{ fieldLabel: '<t:message code="system.label.common.repmodel" default="대표모델"/>' ,  name:'ITEM_GROUP' ,colspan:2 }
	                   ,{ fieldLabel: '<t:message code="system.label.common.account" default="계정"/>' ,   name:'ITEM_ACCOUNT'  , xtype: 'uniCombobox' , comboType:'AU' ,comboCode:'B020' , value:'00'}
	     ...
	     */
	     ...
	     var masterGridConfig = {
            store : Unilite.createStoreSimple('${PKGNAME}.divPumok2PopupMasterStore',{
							model: '${PKGNAME}.divPumok2PopupModel',
				            autoLoad: false,
				            proxy: {
				                type: 'direct',
				                api: {
				                	read: 'popupService.divPumok2Popup'
				                }
				            }
					}),
	        uniOpt:{
	...
	fnInitBinding : function(param) {
		...
		if( Ext.isDefined(param)) {
			panelSearch.setValue('PROD_ITEM_CODE',param['PROD_ITEM_CODE']);
			panelSearch.setValue('CHILD_ITEM_CODE',param['CHILD_ITEM_CODE']);
