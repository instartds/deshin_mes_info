...
<%
	request.setAttribute("PKGNAME","Unilite.app.popup.LotPopupStock");
%>
	 ...
	 * @type 
	 */
	Unilite.defineModel('${PKGNAME}.LotPopupStockModel', {
		fields: [
...
//							}
		...
		var masterGridConfig = {
			store: Unilite.createStoreSimple('${PKGNAME}.LotPopupStockMasterStore',{
				model: '${PKGNAME}.LotPopupStockModel',
				autoLoad: false,
				proxy: {
					type: 'uniDirect',
					api: {
						read: 'popupService.lotStockPopup'
					}
				}
			}),
			uniOpt:{
