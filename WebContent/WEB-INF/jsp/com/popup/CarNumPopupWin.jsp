...
<%
request.setAttribute("PKGNAME","Unilite.app.popup.CarNumPopup");
%>
	...
	<t:ExtComboStore useScriptTag="false" comboType="BOR120" />							// 사업장 
	 ...
	 Unilite.defineModel('${PKGNAME}.CarNumPopupModel', {
...
Ext.define('${PKGNAME}', {
    ...
    me.masterGrid = Ext.create('Unilite.com.grid.UniGridPanel',{
            store: Unilite.createStoreSimple('${PKGNAME}.carNumPopupStore',{
							model: '${PKGNAME}.CarNumPopupModel',
					        autoLoad: false,
					        proxy: {
					            type: 'direct',
					            api: {
					            	read: 'popupService.carNumPopup'
					            }
					        }
					}),
	        uniOpt:{
