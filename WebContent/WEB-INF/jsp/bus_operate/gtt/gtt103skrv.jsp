...
<%
//일일근태내역 조회
request.setAttribute("PKGNAME","Unilite_app_gtt103skrv");
%>
<t:appConfig pgmId="gtt103skrv"  >
...
function appMain() {
	...
	Unilite.defineModel('${PKGNAME}model', {
	    fields: [
					...
					,{name: 'EARLY_CNT'   			,text:'조퇴수'			,type : 'uniQty'  	  }	,{name: 'DRIVER_CNT'   			,text:'기사수'			,type : 'uniQty'  	  }		
					,{name: 'ROUTE_CNT'    			,text:'노선수'			,type : 'uniQty'  }
					,{name: 'VEHICLE_CNT'    		,text:'차량수'			,type : 'uniQty'  }
					,{name: 'OPERATION_DATE_CNT'   	,text:'운행일수'		,type : 'uniQty'  	  }	
					,{name: 'LATE_CNT'   			,text:'지각수'			,type : 'uniQty'  	  }	
