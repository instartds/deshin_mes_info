...
<%
//일일근태내역 조회
request.setAttribute("PKGNAME","Unilite_app_gtt102skrv");
%>
<t:appConfig pgmId="gtt102skrv"  >
		...
		fnInitBinding : function(params) {
			...
			if(params) {
				if(!Ext.isEmpty(params.DIV_CODE))	{
					...
					sfrm.setValue('DRIVER_CODE',params.DRIVER_CODE);
					sfrm.setValue('DRIVER_NAME',params.DRIVER_NAME);
