...
<t:appConfig pgmId="s_emp100skrv_hs"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="s_emp100skrv_hs"  />             <!-- 사업장 -->  
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api : {
			read : 's_emp100skr_hsService.selectList'
		}
	})
	
	Unilite.defineModel('s_emp_100skrv_hsModel', {
		fields : [
	...
	Unilite.defineModel('s_emp100skrv_hsModelExchg', {
		fields: [
	...
	var directMasterStore = Unilite.createStore('s_emp100skrv_hsStore', {
		model  : 's_emp_100skrv_hsModel',
		uniOpt : {
...
//                 params :param 
	...
	var directExchgStore = Unilite.createStore('s_emp100skrv_hsExchgStore', {
		model: 's_emp100skrv_hsModelExchg',
		uniOpt: {
			isMaster:  false,	// 상위 버튼 연결 
			editable:  false,	// 수정 모드 사용 
			deletable: false,	// 삭제 가능 여부 
		...
		proxy: Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
			api: {
				read: 's_emp100skr_hsService.selectExchg'
			}
		}),
		loadStoreRecords : function() {
			this.load(
	...
	var masterGrid = Unilite.createGrid('s_emp100skrv_hsMasterGrid', {
		layout : 'fit',
		region : 'center',
	...
	/* var panelEast = Unilite.createSearchForm('eastForm', {
		region 	: 'east',
		layout 	: {type : 'uniTable', columns : 1,
					tableAttrs : {width : '10%'}},
		padding : '1 1 1 1',
