<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<t:appConfig pgmId="s_agb160skr_hs">
...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('S_Agb160skr_hsModel1', {
		fields: [
	...
	Unilite.defineModel('S_Agb160skr_hsModel2', {
		fields: [
	 ...
	 * @type 
	 */
	var directMasterStore1 = Unilite.createStore('s_agb160skr_hsMasterStore1',{
		model	: 'S_Agb160skr_hsModel1',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 's_agb160skr_hsService.selectList'
			}
		},
...
//					UniAppManager.setToolbarButtons(['print'], false);
	...
	var directMasterStore2 = Unilite.createStore('s_agb160skr_hsMasterStore2',{
		model	: 'S_Agb160skr_hsModel2',
		uniOpt	: {
			isMaster	: true,		// 상위 버튼 연결 
			editable	: false,	// 수정 모드 사용 
			deletable	: false,	// 삭제 가능 여부 
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 's_agb160skr_hsService.selectDetail'
			}
		},
		loadStoreRecords : function() {
...
//			validateBlank:false,	 
	 ...
	 * @type 
	 */
	var masterGrid1 = Unilite.createGrid('s_agb160skr_hsGrid1', {
		...
		tbar		: [{
			...
			handler	: function() {
				...
				params.PGM_ID	= 's_agb160skr_hs';
				
				//전송
				var rec1 = {data : {prgID : 's_agb160rkr_hs', 'text':''}};
				parent.openTab(rec1, '/z_hs/s_agb160rkr_hs.do', params);
			}
		}],
	...
	var masterGrid2 = Unilite.createGrid('s_agb160skr_hsGrid2', {
