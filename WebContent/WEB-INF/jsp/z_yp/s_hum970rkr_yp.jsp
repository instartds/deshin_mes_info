...
<t:appConfig pgmId="s_hum970rkr_yp"  >
...
//                        alert(Ext.getCmp('optPrintGb').getValue().optPrint);
                        ...
                        s_hum970rkr_ypService.fnHum970ini(param, function(provider, response){           // 증명번호 최신화
...
//        	var doc_Kind = Ext.getCmp('optPrintGb').getChecked()[0].inputValue;
			...
			var win = Ext.create('widget.CrystalReport', {
                url: CPATH+'/z_yp/s_hum970crkr_yp.do',
                prgID: 's_hum970crkr_yp',
                extParam: param
            });
            win.center();
            win.show();
...
//	    	param.optPrintGb = bParam0;
	    	...
	    	s_hum970rkr_ypService.insertDetail(param, function(provider, response){	
	    		s_hum970rkr_ypService.fnHum970ini(param, function(provider2, response){
