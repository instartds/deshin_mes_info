...
<t:appConfig pgmId="ssd120skrv" >
<t:ExtComboStore comboType="BOR120" pgmId="ssd120skrv" /> 				<!-- 사업장 -->
<t:ExtComboStore items="${COMBO_ITEM_LEVEL1}" storeId="ssd120skrvLevel1Store" />
<t:ExtComboStore items="${COMBO_ITEM_LEVEL2}" storeId="ssd120skrvLevel2Store" />
<t:ExtComboStore items="${COMBO_ITEM_LEVEL3}" storeId="ssd120skrvLevel3Store" />
</t:appConfig>
<style type="text/css">
...
function appMain() {
	...
	Unilite.defineModel('Ssd120skrvModel', {
	    fields: [
...
//	    	{name: 'STOCK_Q'				, text: '<t:message code="system.label.sales.onhandqty" default="현재고량"/>'		, type: 'uniQty'},
	...
	});//End of Unilite.defineModel('Ssd120skrvModel', {
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('ssd120skrvMasterStore1', {
		model: 'Ssd120skrvModel',
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {			
				read: 'ssd120skrvService.selectList'                	
			}
		},
	...
	var panelSearch = Unilite.createSearchPanel('searchForm', {		
		...
		items: [{	
        	...
        	Unilite.popup('DEPT', { 
				...
				xtype:'uniCombobox', 
				store: Ext.data.StoreManager.lookup('ssd120skrvLevel1Store'), 
				child: 'ITEM_LEVEL2',
				listeners: {
					change: function(field, newValue, oldValue, eOpts) {						
				...
				xtype:'uniCombobox', 
				store: Ext.data.StoreManager.lookup('ssd120skrvLevel2Store'), 
				child: 'ITEM_LEVEL3',
				listeners: {
					change: function(field, newValue, oldValue, eOpts) {						
				...
				xtype:'uniCombobox', 
				store: Ext.data.StoreManager.lookup('ssd120skrvLevel3Store'),
     ...
     * @type 
     */
	var masterGrid = Unilite.createGrid('ssd120skrvGrid1', {
    	// for tab    	
		layout: 'fit',
		region: 'center',
...
//        	{dataIndex: 'STOCK_Q'			, width: 60},
    ...
    });//End of var masterGrid = Unilite.createGrid('ssd120skrvGrid1', {  
