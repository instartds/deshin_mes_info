...
<t:appConfig pgmId="sfa100skrv"  >
	<t:ExtComboStore comboType="AU" comboCode="S010" /> <!--영업담당 -->
	<t:ExtComboStore comboType="BOR120"  pgmId="sfa100skrv"/> 			<!-- 사업장 -->  
...
//    Unilite.messageBox(output);
	 ...
	 * @type 
	 */
	Unilite.defineModel('Sfa100skrvModel', {
	...
	}); //End of Unilite.defineModel('Sfa100skrvModel', {

	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('sfa100skrvMasterStore1',{
		model: 'Sfa100skrvModel',
		uniOpt: {
        ...
        proxy: {
        	type: 'direct',
            api: {			
            	read: 'sfa100skrvService.selectList1'                	
			}
        },
	...
	});		//End of var directMasterStore1 = Unilite.createStore('sfa100skrvMasterStore1',{
    ...
    var masterGrid = Unilite.createGrid('sfa100skrvGrid1', {
    	// for tab
    	region: 'center',
		layout: 'fit',
        uniOpt: {
...
<div id='sfa100skrvMessage' class='x-hide-display' align='right' style='margin-top: 15px; margin-right: 10px '>
