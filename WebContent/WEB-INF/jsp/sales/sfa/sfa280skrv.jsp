...
<t:appConfig pgmId="sfa280skrv"  >
<t:ExtComboStore comboType="BOR120"  pgmId="sfa280skrv"/> 			<!-- 사업장 -->
...
function appMain() {
	 ...
	 * @type 
	 */   			 
	Unilite.defineModel('sfa280skrvModel', {
	    fields: [
	 ...
	 * @type 
	 */
	var MasterStore = Unilite.createStore('sfa280skrvMasterStore',{
			model: 'sfa280skrvModel',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {
               		read: 'sfa280skrvService.selectList'
                }
            },
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('sfa280skrvGrid', {
    	region: 'center' ,
        layout : 'fit',
        store : MasterStore,
        uniOpt:{
