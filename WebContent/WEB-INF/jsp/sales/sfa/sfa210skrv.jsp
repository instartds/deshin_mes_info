...
<t:appConfig pgmId="sfa210skrv"  >
<t:ExtComboStore comboType="BOR120"  pgmId="sfa210skrv"/> 		<!-- 사업장 -->
...
function appMain() {
	 ...
	 * @type 
	 */   			 
	Unilite.defineModel('sfa210skrvModel', {
	    fields: [
	    	...
	    	{name:'TICKECT_MONEY' 		, text: '상품권'			, type: 'uniPrice'},
...
//	    	{name:'FIRST_O' 			, text: '선수금'			, type: 'uniPrice'},
	 ...
	 * @type 
	 */
	var MasterStore = Unilite.createStore('sfa210skrvMasterStore',{
		model: 'sfa210skrvModel',
		uniOpt : {
        ...
        proxy: {
            type: 'direct',
            api: {
           		read: 'sfa210skrvService.selectList'
            }
        },
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('sfa210skrvGrid', {
    	region: 'center' ,
        layout : 'fit',
        store : MasterStore,
        uniOpt:{
        ...
        columns:  [
        	...
        	{dataIndex:'POS_NO' 			, width: 70, locked: true},
        	...
        	{dataIndex:'COLLECT_AMT' 		, width: 120, summaryType: 'sum',tdCls:'x-change-cell2'},
...
//        	{dataIndex:'FIRST_O' 			, width: 120, summaryType: 'sum'},
...
//			panelResult.setValue('SALE_DATE_FR', UniDate.get('startOfMonth', panelSearch.getValue('SALE_DATE_TO')));
		...
		onPrintButtonDown: function() {
	         ...
	         var win = Ext.create('widget.PDFPrintWindow', {
	            url: CPATH+'/sfa/sfa210rkrPrint.do',
	            prgID: 'sfa210rkr',
	               extParam: {
