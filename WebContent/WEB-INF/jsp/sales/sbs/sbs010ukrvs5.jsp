<%@page language="java" contentType="text/html; charset=utf-8"%>
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read	: 'bsa100ukrvService.selectDetailPayments',
	...
	Unilite.defineModel('sbs010ukrvs_5Model', {
		fields: [
			...
			{name: 'REF_CODE1'		,text:'<t:message code="system.label.sales.division" default="사업장"/>'				,type : 'string' , allowBlank : true , comboType:'BOR120'},
			{name: 'REF_CODE2'		,text:'<t:message code="system.label.sales.department" default="부서"/>'				,type : 'string' },
			{name: 'DEPT_NAME'		,text:'<t:message code="system.label.sales.department" default="부서"/>'				,type : 'string' , allowBlank : true},
			...
			{name: 'REF_CODE5'		,text:'<t:message code="system.label.sales.reference2" default="참조"/>5'				,type : 'string'},
			{name: 'REF_CODE6'		,text:'<t:message code="system.label.sales.reference2" default="참조"/>6'				,type : 'string'},
			{name: 'REF_CODE7'		,text:'<t:message code="system.label.sales.reference2" default="참조"/>7'				,type : 'string'},
			{name: 'REF_CODE8'		,text:'<t:message code="system.label.sales.reference2" default="참조"/>8'				,type : 'string'},
			{name: 'REF_CODE9'		,text:'<t:message code="system.label.sales.reference2" default="참조"/>9'				,type : 'string'},
			{name: 'REF_CODE10'		,text:'<t:message code="system.label.sales.connectuserid" default="접속자ID"/>'		,type : 'string'},  // ID
	...
	var sbs010ukrvs_5Store = Unilite.createStore('sbs010ukrvs_5Store',{
		model	: 'sbs010ukrvs_5Model',
		proxy	: directProxy,
		autoLoad: false,
		uniOpt	: {
		...
		saveStore: function() {
			...
			if(inValidRecs.length == 0 ) {
				...
				var grid = panelDetail.down('#sbs010ukrvs_5Grid');
	...
	var payments = {
		...
		items	: [{
			title		: '<t:message code="system.label.sales.trancharge" default="수불담당"/>',
			itemId		: 'tab_payments',
			xtype		: 'container',
			...
			items		: [{
				...
				xtype		: 'uniGridPanel',
				itemId		: 'sbs010ukrvs_5Grid',
				store		: sbs010ukrvs_5Store,
				padding		: '0 0 0 0',
				dockedItems	: [{
					xtype	: 'toolbar',
					dock	: 'top',
						...
						'editor': Unilite.popup('DEPT_G',{
							...
							listeners		: {
								'onSelected': {
									...
									var grdRecord = panelDetail.down('#sbs010ukrvs_5Grid').uniOpt.currentRecord;
