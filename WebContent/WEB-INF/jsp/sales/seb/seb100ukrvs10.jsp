<%@page language="java" contentType="text/html; charset=utf-8"%>
	var multiCompCodeProxy10;
	<c:if test="${multiCompCode == 'true'}">
	multiCompCodeProxy10 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	var seb100ukrvProxy10 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	Unilite.defineModel('seb100ukrvsModel10', {
		fields: [
			...
			{name: 'REF_CODE1'			, text: '사용여부(Y/N)'		, type: 'string', comboType: 'AU', comboCode: 'B010'},								//20210629 수정: 콤보로 변경
	...
	var seb100ukrvStore10 = Unilite.createStore('seb100ukrvStore10',{
		model	: 'seb100ukrvsModel10',
		proxy	: Ext.isEmpty(multiCompCodeProxy10) ? seb100ukrvProxy10:multiCompCodeProxy10,
		autoLoad: false,
		uniOpt	: {
		...
		saveStore: function() {
			...
			if(inValidRecs.length == 0) {
				...
				panelDetail.down('#agreeYn').uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners: {
			load: function (store, records) {
				if(records && records.length > 0) {
					var mGrid	= panelDetail.down('#seb100ukrvGrid10');
	...
	var agreeYn = {
		...
		items	: [{
			...
			items		: [{
				...
				xtype		: 'uniGridPanel',
				itemId		: 'seb100ukrvGrid10',
				store		: seb100ukrvStore10,
				autoScroll	: false,
				dockedItems	: [{
					xtype	: 'toolbar',
					dock	: 'top',
