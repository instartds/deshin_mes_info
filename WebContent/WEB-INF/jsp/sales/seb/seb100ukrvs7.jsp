<%@page language="java" contentType="text/html; charset=utf-8"%>
	var multiCompCodeProxy7;
	<c:if test="${multiCompCode == 'true'}">
	multiCompCodeProxy7 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	var seb100ukrvProxy7 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	Unilite.defineModel('seb100ukrvsModel7', {
		fields: [
	...
	var seb100ukrvStore7 = Unilite.createStore('seb100ukrvStore7',{
		model	: 'seb100ukrvsModel7',
		proxy	: Ext.isEmpty(multiCompCodeProxy7) ? seb100ukrvProxy7:multiCompCodeProxy7,
		autoLoad: false,
		uniOpt	: {
		...
		saveStore: function() {
			...
			if(inValidRecs.length == 0) {
				...
				panelDetail.down('#researchPart').uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners: {
			load: function (store, records) {
				if(records && records.length > 0) {
					var mGrid	= panelDetail.down('#seb100ukrvGrid7');
	...
	var researchPart = {
		...
		items	: [{
			...
			items		: [{
				...
				xtype		: 'uniGridPanel',
				itemId		: 'seb100ukrvGrid7',
				store		: seb100ukrvStore7,
				autoScroll	: false,
				dockedItems	: [{
					xtype	: 'toolbar',
					dock	: 'top',
