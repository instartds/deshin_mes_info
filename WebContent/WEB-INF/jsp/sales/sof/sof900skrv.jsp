...
<t:appConfig pgmId="sof900skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="sof900skrv"/>		<!-- 사업장 -->
 ...
 */
	...
	Unilite.defineModel('Sof900skrvModel', {
		fields: [
			...
			{name: 'ADDR1'				, text: '<t:message code="system.label.sales.address" default="주소"/>'						    , type: 'string'}
	 ...
	 * @type
	 */
	var directMasterStore1 = Unilite.createStore('sof900skrvMasterStore1', {
		model	: 'Sof900skrvModel',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {
				read: 'sof900skrvService.selectList1'
			}
		},
...
//				allowBlank:false,
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('sof900skrvGrid1', {
