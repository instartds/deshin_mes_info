...
<t:appConfig pgmId="sco170skrv">
	<t:ExtComboStore comboType="BOR120"  pgmId="sco170skrv"/>	<!-- 사업장 -->
...
//					}
	 ...
	 * @type
	 */
	Unilite.defineModel('sco170skrvModel1', {
		fields: [
	 ...
	 * @type
	 */
	var directMasterStore = Unilite.createStore('sco170skrvMasterStore1',{
		model	: 'sco170skrvModel1',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 'sco170skrvService.selectList'
			}
		},
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('sco170skrvGrid1', {
	...
	Unilite.Main({
		...
		onQueryButtonDown : function() {
			...
			sco170skrvService.getColumn(param, function(provider, response){
