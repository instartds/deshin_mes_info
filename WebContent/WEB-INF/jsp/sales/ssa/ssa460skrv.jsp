...
<t:appConfig pgmId="ssa460skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="ssa460skrv"  />			<!-- 사업장 -->  
...
//				 {name: 'CONSIGNMENT_FEE'	,text: '수수료(위탁)'	,type: 'uniPrice'},
	 ...
	 * @type 
	 */				 
	var directMasterStore1 = Unilite.createStore('ssa460skrvMasterStore1',{
		...
		proxy: {
			type: 'direct',
			api: {		  
				read: 'ssa460skrvService.selectList1'
			}
		},
...
//						}
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('ssa460skrvGrid1', {
		region			: 'center',
		syncRowHeight	: false,	
