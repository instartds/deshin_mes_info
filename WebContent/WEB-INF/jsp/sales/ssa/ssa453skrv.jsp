...
<t:appConfig pgmId="ssa453skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="ssa453skrv"/>		<!-- 사업장 -->
...
function appMain() {
	 ...
	 * @type
	 */
	Unilite.defineModel('Ssa453skrvModel1', {
		fields: [
...
//			{name: 'CONSIGNMENT_FEE'	,text: '수수료(위탁)'	,type: 'uniPrice'},
	 ...
	 * @type
	 */
	var directMasterStore = Unilite.createStore('ssa453skrvMasterStore1',{
		model	: 'Ssa453skrvModel1',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 'ssa453skrvService.selectList1'
			}
		},
...
//			}
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('ssa453skrvGrid1', {
