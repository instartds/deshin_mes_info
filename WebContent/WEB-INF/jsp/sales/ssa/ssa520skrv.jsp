...
<t:appConfig pgmId="ssa520skrv"  >
	<t:ExtComboStore comboType="BOR120"  pgmId="ssa520skrv"  /> 			<!-- 사업장 -->	
...
function appMain() {
	...
	Unilite.defineModel('Ssa520skrvModel1', {
	 ...
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('ssa520skrvMasterStore1',{
			model: 'Ssa520skrvModel1',
			uniOpt: {
            ...
            proxy: {
                type: 'direct',
                api: {			
                	   read: 'ssa520skrvService.selectList1'                	
                }
            }
		...
		items: [{     
        	...
        	items: [{
        		...
        		items: [{
        			...
        			fieldLabel: '<t:message code="system.label.sales.dishonoreddate" default="부도일"/>',            			 		       
