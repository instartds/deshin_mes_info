...
<t:appConfig pgmId="ssa500skrv" >
	<t:ExtComboStore comboType="BOR120" pgmId="ssa500skrv"  /> 			<!-- 사업장 -->  
...
function appMain() {
	...
	Unilite.defineModel('Ssa500skrvModel', {
	    fields: [
	    	{name: 'SALE_DATE'			, text: '판매일자'		, type: 'string'},
	    	...
	    	{name: 'TOT_AMT_O'			, text: '<t:message code="system.label.sales.totalamount" default="합계"/>'		, type: 'uniPrice'},
	    	{name: 'SALE_Q'				, text: '판매수량'		, type: 'uniQty'},
	    	{name: 'ITEM_NAME'			, text: '<t:message code="system.label.sales.itemname" default="품목명"/>'		, type: 'string'}
	    ]
	});//End of Unilite.defineModel('Ssa500skrvModel', {
	
	/**
	 * Store 정의(Service 정의)
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('ssa500skrvMasterStore1', {
		model: 'Ssa500skrvModel',
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {			
				read: 'ssa500skrvService.selectList'                	
			}
		},
     ...
     * @type 
     */
	var masterGrid = Unilite.createGrid('ssa500skrvGrid1', {
    	// for tab    	
		layout: 'fit',
		region: 'center',
		uniOpt: {
        ...
        columns: [
        	...
        	{dataIndex: 'TOT_AMT_O'			,		 width:	110 , summaryType: 'sum'},
    ...
    });//End of var masterGrid = Unilite.createGrid('ssa500skrvGrid1', {  
...
//		    viewNormal.getFeature('masterGridTotal').toggleSummaryRow(true);
		...
		onPrintButtonDown: function() {
	         ...
	         var param= Ext.getCmp('searchForm').getValues();
//	
//	         if(param.INOUT_TYPE == 'A'){
//	         	param.INOUT_TYPE = '<t:message code="system.label.sales.whole" default="전체"/>';
//	         }else if(param.INOUT_TYPE =='1'){
//	         	param.INOUT_TYPE = '<t:message code="system.label.sales.receipt" default="입고"/>';
//	         }else if(param.INOUT_TYPE =='4'){
//	         	param.INOUT_TYPE = '<t:message code="system.label.sales.return" default="반품"/>';
//	         }
	         
	         var win = Ext.create('widget.PDFPrintWindow', {
	            url: CPATH+'/ssa/ssa500rkrPrint.do',
	            prgID: 'ssa500rkr',
	               extParam: {
	                  ...
	                  CUSTOM_CODE_FR: param.CUSTOM_CODE_FR,
	                  CUSTOM_NAME_FR: param.CUSTOM_NAME_FR,
	                  CUSTOM_CODE_TO: param.CUSTOM_CODE_TO,
	                  CUSTOM_NAME_TO: param.CUSTOM_NAME_TO
	               }
	            });
	            win.center();
	            win.show();
