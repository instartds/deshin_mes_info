...
function appMain() {
	 ...
	 * @type
	 */
	Unilite.defineModel('Str320skrvModel1', {
		fields: [
			...
			{name: 'SALES_Q'			,text: '<t:message code="system.label.sales.sellingqty" default="판매수량"/>'				,type: 'uniQty'},
	 ...
	 * @type
	 */
	var directMasterStore1 = Unilite.createStore('str320skrvMasterStore1',{
		model	: 'Str320skrvModel1',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api	: {
				read: 'str320skrvService.selectList1'
			}
		},
...
//				allowBlank:false,
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('str320skrvGrid1', {
		...
		columns: [
			...
			{ dataIndex: 'SALES_Q'			, width: 100, summaryType: 'sum' },
