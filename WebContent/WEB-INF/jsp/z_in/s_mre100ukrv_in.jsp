			...
			beforeedit  : function( editor, e, eOpts ) {
				if(!e.record.phantom) {
                    if(Ext.isEmpty(e.record.data.ITEM_CODE)) {
                    	if(UniUtils.indexOf(e.field, ['ITEM_CODE', 'ITEM_NAME', 'SPEC', 'REQ_Q', 'DELIVERY_DATE', 'USE_REMARK', 'NEXT_YN']))
                        {
                            return true;
                        } else {
                            return false;
                    	...
                    	if(UniUtils.indexOf(e.field, ['ITEM_CODE', 'REQ_Q', 'DELIVERY_DATE', 'USE_REMARK', 'NEXT_YN','STOCK_UNIT']))
                        {
                            return true;
                        } else {
                        	return false;
...
//                        }
		...
		setDefault: function() {
        	...
        	panelResult.setValue('PERSON_NAME',personName);  
            UniAppManager.app.fnExchngRateO();
