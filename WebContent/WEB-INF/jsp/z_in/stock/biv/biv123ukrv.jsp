...
<t:appConfig pgmId="biv123ukrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="biv123ukrv"/> 			<!-- 사업장 -->
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'biv123ukrvService.selectMaster',
			update: 'biv123ukrvService.updateDetail',
			create: 'biv123ukrvService.insertDetail',
			destroy: 'biv123ukrvService.deleteDetail',
			syncAll: 'biv123ukrvService.saveAll'
		}
	});
			...
			Unilite.popup('DEPT', {
				...
				listeners: {
					...
					expand: function(field,eOpts) {
						...
						biv123ukrvService.getSectorList(param, function(provider, response)	{
		    	...
		    	items:[{
						...
						//Ext.each(records, function(record,i) {
							...
							biv123ukrvService.dataCheckSave(param,
						...
						handler : function(records) {
							...
							//Ext.each(records, function(record,i) {
								if(!Ext.isEmpty(record.get('_EXCEL_ERROR_MSG'))) {
									...
									me.setDisabled(true);
									masterForm.getEl().mask('<t:message code="system.label.inventory.loading" default="로딩중..."/>','loading-indicator');
									biv123ukrvService.dataCheckSave(param, function(provider, response){
	...
	var panelResult = Unilite.createSearchForm('resultForm',{
		...
		//biv123ukrvs1 Model
	Unilite.defineModel('Biv123ukrvModel', {		// 메인
            ...
            if(!excelWindow) {
                ...
                excelWindow = Ext.create( appName, {
                        ...
                        grids: [{
                        		...
                        		readApi: 'biv123ukrvService.selectExcelUploadSheet1',
                        		useCheckbox: false,
                        		columns: [{dataIndex: 'ITEM_CODE'			        ,   	width: 110,
                        ...
                        onApply:function()	{
							...
							biv123ukrvService.insertExcelData(param,
	...
	//directMasterStore
	var directMasterStore = Unilite.createStore('biv123ukrvMasterStore1',{		// 메인
		model: 'Biv123ukrvModel',
		uniOpt: {
		...
		saveStore: function() {
			...
			if(inValidRecs.length == 0) {
                ...
                var grid = Ext.getCmp('biv123ukrvGrid');
                grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		}
	});	// End of var directMasterStore1

    var masterGrid = Unilite.createGrid('biv123ukrvGrid', {
		layout : 'fit',
        region:'center',
    	uniOpt: {
    ...
    });	//End of var masterGrid = Unilite.createGrid('biv123ukrvGrid1', {
	...
	Unilite.Main( {
		...
		fnInitBinding: function() {
			...
			biv123ukrvService.userWhcode({}, function(provider, response)	{
				if(!Ext.isEmpty(provider)){
