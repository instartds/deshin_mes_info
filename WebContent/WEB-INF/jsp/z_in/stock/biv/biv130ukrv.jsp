...
function appMain() {
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'biv130ukrvService.insertMaster',
			//update: 'biv130ukrvService.updateDetail',
			create: 'biv130ukrvService.insertDetail',
			syncAll: 'biv130ukrvService.saveAll'
		}
	});
	var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'biv130ukrvService.selectMaster',
			//update: 'biv130ukrvService.updateDetail',
			create: 'biv130ukrvService.insertDetail',
			syncAll: 'biv130ukrvService.saveAll'
		}
				...
				handler : function(records) {
					...
					if(masterForm.getForm().isValid()) {	
						if(confirm('<t:message code="system.message.inventory.message007" default="실행하시겠습니까?"/>')) {
							...
							biv130ukrvService.selectMaster(param, function(provider, response) {
    ...
    */               
	...
	Unilite.Main({
		...
		fnInitBinding: function() {
			...
			biv130ukrvService.userWhcode({}, function(provider, response)	{
				if(!Ext.isEmpty(provider)){
