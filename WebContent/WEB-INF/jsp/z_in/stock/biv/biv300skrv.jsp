...
<t:appConfig pgmId="biv300skrv"  >
	<t:ExtComboStore comboType="BOR120"  pgmId="biv300skrv"/>				<!-- 사업장 -->
...
function appMain() {
	...
	Unilite.defineModel('Biv300skrvModel4', {
		fields:  [
			{name: 'DIV_CODE'		, text: '<t:message code="system.label.inventory.division" default="사업장"/>',					type: 'string'},
	...
	Unilite.defineModel('Biv300skrvModel5', {
		fields:  [
			{name: 'DIV_CODE'		,text: '<t:message code="system.label.inventory.division" default="사업장"/>',				type: 'string'},
			{name: 'WH_CODE'		,text: '<t:message code="system.label.inventory.warehouse" default="창고"/>',				type: 'string'},
			{name: 'WH_NAME'		,text: '<t:message code="system.label.inventory.warehousename" default="창고명"/>',		type: 'string'},
	 ...
	 * @type
	 */
	var directMasterStore1 = Unilite.createStore('biv300skrvMasterStore1',{
		...
		proxy: {
			type: 'direct',
			api: {read: 'biv300skrvService.selectMaster'}
		},
	...
	var directMasterStore2 = Unilite.createStore('biv300skrvMasterStore2',{
		...
		proxy: {
			type: 'direct',
			api: {read: 'biv300skrvService.selectMaster2'}
		},
		loadStoreRecords : function() {
			var param= Ext.getCmp('searchForm').getValues();
			param.QUERY_TYPE = '2'
	...
	var directMasterStore3 = Unilite.createStore('biv300skrvMasterStore3',{
		...
		proxy: {
			type: 'direct',
			api: {read: 'biv300skrvService.selectMaster3'}
		},
		loadStoreRecords : function() {
			var param= Ext.getCmp('searchForm').getValues();
	...
	var directMasterStore4 = Unilite.createStore('biv300skrvMasterStore4',{
		model: 'Biv300skrvModel4',
		uniOpt : {
			isMaster	: false,		// 상위 버튼 연결
			editable	: false,	// 수정 모드 사용
			deletable	: false,	// 삭제 가능 여부
		...
		proxy: {
			type: 'direct',
			api: {read: 'biv300skrvService.selectMaster4'}
		},
		loadStoreRecords : function() {
			var param= Ext.getCmp('searchForm').getValues();
	...
	var directMasterStore5 = Unilite.createStore('biv300skrvMasterStore5',{
		model: 'Biv300skrvModel5',
		uniOpt : {
			isMaster	: false,		// 상위 버튼 연결
			editable	: false,	// 수정 모드 사용
			deletable	: false,	// 삭제 가능 여부
		...
		proxy: {
			type: 'direct',
			api: {read: 'biv300skrvService.selectMaster5'}
		},
		loadStoreRecords : function() {
			var param= Ext.getCmp('searchForm').getValues();
	 ...
	 * @type
	 */
	var masterGrid = Unilite.createGrid('biv300skrvGrid_1', {
//		title: '품목별',
...
//			{dataIndex: 'ITEM_LEVEL3'	, width: 100,align:'center', locked: true},
	...
	var masterGrid2 = Unilite.createGrid('biv300skrvGrid_2', {
//		title: '창고별',
...
//			{dataIndex: 'ITEM_LEVEL3'	, width: 100,align:'center', locked: true},
	...
	var masterGrid3 = Unilite.createGrid('biv300skrvGrid_3', {
//		title: 'LOT별',
	...
	var masterGrid4 = Unilite.createGrid('biv300skrvGrid_4', {
//		title: '외주처별',
	...
	var masterGrid5 = Unilite.createGrid('biv300skrvGrid_5', {
//		title: 'CELL별',
		region: 'center' ,
		layout : 'fit',
	...
	Unilite.Main({
		...
		fnInitBinding : function() {
			...
			biv300skrvService.userWhcode({}, function(provider, response) {
		...
		onQueryButtonDown : function() {
			...
			if(activeTabId == 'biv300skrvGrid1'){
				directMasterStore1.loadStoreRecords();
			}
			else if(activeTabId == 'biv300skrvGrid2'){
				directMasterStore2.loadStoreRecords();
			}
			else if(activeTabId == 'biv300skrvGrid3'){
				directMasterStore3.loadStoreRecords();
			}
			else if(activeTabId == 'biv300skrvGrid4'){
				directMasterStore4.loadStoreRecords();
			}
			else if(activeTabId == 'biv300skrvGrid5'){
