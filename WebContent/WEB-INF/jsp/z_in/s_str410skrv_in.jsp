...
<t:appConfig pgmId="s_str410skrv_in"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_str410skrv_in"/> 			<!-- 사업장 -->
...
function appMain() {
	Unilite.defineModel('Str410skrModel', {
	    fields: [
			...
			{name: 'INOUT_NUM'		 	, text: '매출번호' 				, type:'string'},
			{name: 'INOUT_DATE'     	, text: '매출일'      			, type: 'uniDate'},
			...
			{name: 'TO_FAX_NO'			, text: 'TO_FAX_NO'			, type: 'string'},
	 ...
	 * @type
	 */
	var directMasterStore = Unilite.createStore('s_str410skrv_inMasterStore1', {
        ...
        proxy: {
        	type: 'direct',
            api: {
            	read: 's_str410skrv_inService.selectList1'
		    }
		},
     ...
     * @type
     */
    var masterGrid = Unilite.createGrid('s_str410skrv_inGrid1', {
    	layout: 'fit',
    	region:'center',
    	selModel: 'rowmodel',
        uniOpt: {
        ...
        columns: [
           ...
           { text:'FAX' , dataIndex:'service', width: 85, hidden:false,
            ...
            {dataIndex: 'FAX_YN'    		, width: 80, align:'center'},
            {dataIndex: 'COUNT_NO'    		, width: 120 , hidden: true},
            {dataIndex: 'TO_FAX_NO', width: 120, hidden: true},
        ...
        printBtn:function(record){
				...
				if(record.data.DEAL_REPORT_TYPE == '15'){
					var win = Ext.create('widget.ClipReport', {
						url: CPATH+'/z_in/s_str410skrv_in_clskrv_5.do',
						prgID: 's_str410skrv_in',
						extParam: param
						});
						win.center();
						win.show();
					...
					var win = Ext.create('widget.ClipReport', {
						url: CPATH+'/z_in/s_str410skrv_in_clskrv.do',
						prgID: 's_str410skrv_in',
						extParam: param
						});
						win.center();
        ...
        faxBtn:function(record){
        	var param= record.data;
				...
				param["COMP_NAME"] = UserInfo.deptName;
				param["INCLUDE_PRICE_YN"] = panelSearch.getValue('rdoIncludePriceGroup1').rdoIncludePrice;
				param["TO_FAX_NO"] = record.data.TO_FAX_NO;
				param["REF_VAL_1"] = record.data.INOUT_NUM;
				if(record.data.DEAL_REPORT_TYPE == '15'){ //택배비명세서 출력
					param["FAX_URL"] = CPATH+'/z_in/s_str410skrv_in_clskrv_5_fax.do'
					var win = Ext.create('widget.ClipReportFax', {
						url: CPATH+'/z_in/s_str410skrv_in_clskrv_5.do',
						prgID: 's_str410skrv_in',
						extParam: param
						});
					...
					param["FAX_URL"] = CPATH+'/z_in/s_str410skrv_in_clskrv_fax.do'
					var win = Ext.create('widget.ClipReportFax', {
						url: CPATH+'/z_in/s_str410skrv_in_clskrv.do',
						prgID: 's_str410skrv_in',
						extParam: param
