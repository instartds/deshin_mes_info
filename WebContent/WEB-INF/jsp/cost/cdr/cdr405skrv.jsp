...
<t:appConfig pgmId="cdr405skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="cdr405skrv" /> 				<!-- 사업장 -->
...
function appMain() {
   var cdr405skrvModel=Unilite.defineModel('cdr405skrvModel', {
   	fields: [
	    	...
	    	{name: 'WH_CODE_NM'	    			, text: '창고'   			, type: 'string'},
   ...
   var cdr405skrvStore=Unilite.createStore('Store', {	
   		model: 'cdr405skrvModel',
		autoLoad: false,
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {
				read    : 'cdr405skrvService.selectList'
   ...
   /**
						...
						listeners: {
		                    change: function(field, newValue, oldValue, eOpts) {            
		                        ...
		                        if(newValue.STATUS==2){
					                 masterGrid.columns[4].show();
					                 masterGrid.columns[5].show();
					            }else{
	...
	var masterGrid = Unilite.createGrid('tio110skrvGrid1', {
        ...
        columns: [
        	...
        	{text:'입고',columns:[
        		{text:'생산입고'	,columns:[{dataIndex: 'InProdt_q'	, width: 90,summaryType: 'sum' },{dataIndex: 'InProdt_p'	, width: 90,summaryType: 'sum' },{dataIndex: 'InProdt_i'	, width: 110,summaryType: 'sum' }]},
        		{text:'구매입고'	,columns:[{dataIndex: 'InBuy_q'		, width: 90,summaryType: 'sum' },{dataIndex: 'InBuy_p'		, width: 90,summaryType: 'sum' },{dataIndex: 'InBuy_i'		, width: 110,summaryType: 'sum' }]},
        		{text:'주입입고'	,columns:[{dataIndex: 'InOutOrder_q', width: 90,summaryType: 'sum' },{dataIndex: 'InOutOrder_p', width: 90,summaryType: 'sum' },{dataIndex: 'InOutOrder_i', width: 110,summaryType: 'sum' }]},
        	...
        	{text:'출고',columns:[
        		...
        		{text:'외주출고'	,columns:[{dataIndex: 'OutOutOrder_q', width: 90,summaryType: 'sum' },{dataIndex: 'OutOutOrder_i', width: 110,summaryType: 'sum' }]},
        		...
        		{text:'계'  		,columns:[{dataIndex: 'OutSum_q'	, width: 90,summaryType: 'sum' },{dataIndex: 'OutSum_p'	, width: 90,summaryType: 'sum' },{dataIndex: 'OutSum_i'	, width: 110,summaryType: 'sum' }]}
        	]},
			{text:'재고',columns:[
				{dataIndex:'STOCK_Q',width:90,summaryType: 'sum'},
				{dataIndex:'STOCK_P',width:90,summaryType: 'sum'},
