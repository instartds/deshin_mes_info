...
<t:appConfig pgmId="cdr400skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="cdr400skrv" /> 				<!-- 사업장 -->
...
function appMain() {
   ...
   var cdr400skrvModel=Unilite.defineModel('cdr400skrvModel', {
   	fields: [
   ...
   var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 'cdr400skrvService.selectList'
        }
    });
   var cdr400skrvStore=Unilite.createStore('Store', {	
   		model: 'cdr400skrvModel',
		autoLoad: false,
		uniOpt: {
			...
			items: [{ 
					...
					{ name: 'ITEM_ACCOUNT',
						  		...
						  		,{ name: 'ITEM_LEVEL3',
						  			...
						  			autoPopup: true, // 20210824 추가 : 프로그램 로직 때문에 추가(팝업창 표준화 작업)
						  			listeners: {
						  				onSelected: {
