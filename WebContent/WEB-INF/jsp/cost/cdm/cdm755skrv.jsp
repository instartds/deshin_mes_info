...
function appMain() {
	...
	//모델 정의
    var cdm755skrvModel = Unilite.defineModel('cdm755skrvModel', {
		fields: [
			...
			{name: 'INOUT_Q'		, text: '출고량'			, type: 'uniPrice'},
			{name: 'D_AMT'			, text: '금액'			, type: 'uniPrice'}
		]
   	});
   
	//스토어 정의
	var cdm755skrvStore = Unilite.createStore('Store', {	
   		model: 'cdm755skrvModel',
		autoLoad: false,
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {
				read: 'cdm755skrvService.selectList'
			}
		},
	...
	// Grid 정의
    var masterGrid = Unilite.createGrid('cdm755skrvGrid', {
		layout: 'fit',
		region: 'center',
		excelTitle: '품목별 재료비 집계현황',
		uniOpt: {
	...
	var panelSearch = Unilite.createSearchPanel('searchForm', {		
		title: '검색조건',
		api: {
        	load:'cdm755skrvService.selectMaxSeq'
		},
