...
function appMain() {
	...
	//모델 정의
    var cdm455skrvModel = Unilite.defineModel('cdm455skrvModel', {
		fields: [
			...
			{name: 'EXP_AMT'		, text: '합계'			, type: 'uniPrice'}
		]
   	});
   
	//스토어 정의
	var cdm455skrvStore = Unilite.createStore('Store', {	
   		model: 'cdm455skrvModel',
		autoLoad: false,
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {
				read: 'cdm455skrvService.selectList'
			}
		},
	...
	// Grid 정의
    var masterGrid = Unilite.createGrid('cdm455skrvGrid', {
		layout: 'fit',
		region: 'center',
		excelTitle: '품목별 제조경비 집계현황',
		uniOpt: {
	...
	var panelSearch = Unilite.createSearchPanel('searchForm', {		
		title: '검색조건',
		api: {
        	load:'cdm455skrvService.selectMaxSeq'
		},
