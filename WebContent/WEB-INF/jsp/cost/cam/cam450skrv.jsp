...
<t:appConfig pgmId="cam450skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="cam450skrv" /> 				<!-- 사업장 -->
...
function appMain() {
   var cam450skrvModel=Unilite.defineModel('cam450skrvModel', {
   	fields: [
   ...
   var cam450skrvStore=Unilite.createStore('Store', {	
   		model: 'cam450skrvModel',
		autoLoad: false,
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {
				read    : 'cam450skrvService.selectList'
   ...
   /**
	...
	var panelSearch = Unilite.createSearchPanel('searchForm', {		
		title: '검색조건',
		api: {
         		 load:'cam450skrvService.selectWORK_SEQ'
				},
	...
	var masterGrid = Unilite.createGrid('tio110skrvGrid1', {
        ...
        columns: [
        	...
        	{text:'직접재료비',
        	 columns:[{dataIndex: 'MAT_DAMT_ONE'			, width: 120,summaryType: 'sum' },
