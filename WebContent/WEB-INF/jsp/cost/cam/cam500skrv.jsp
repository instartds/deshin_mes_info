...
<t:appConfig pgmId="cam500skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="cam500skrv" /> 				<!-- 사업장 -->
...
function appMain() {
   var cam500skrvModel=Unilite.defineModel('cam500skrvModel', {
   	fields: [
   ...
   var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 'cam500skrvService.selectList'
        }
    });
   var cam500skrvStore=Unilite.createStore('Store', {	
   		model: 'cam500skrvModel',
		autoLoad: false,
		uniOpt: {
		...
		items: [{	
			...
			items: [{ 
					...
					{ name: 'ITEM_ACCOUNT',
							  	...
							  	},Unilite.popup('DIV_PUMOK',{ // 20210820 수정: 품목코드 팝업창 정규화
						  			fieldLabel: '품목코드',
						  		...
						  		}) ,Unilite.popup('CUST',{ // 20210820 수정: 외주처 팝업창 정규화
						  			fieldLabel: '외주처',
