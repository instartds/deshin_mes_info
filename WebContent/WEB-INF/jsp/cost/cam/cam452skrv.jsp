...
<t:appConfig pgmId="cam452skrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="cam452skrv" /> 				<!-- 사업장 -->
...
function appMain() {
   var cam452skrvModel=Unilite.defineModel('cam452skrvModel', {
   	fields: [
   			...
   			{name: 'TOP_WKORD_NUM'	    			, text: '대표작업지시번호'	, type: 'string'},
	    	...
	    	{name: 'REMARK'	    					, text: '장비구분'    		, type: 'string'},
	    	...
	    	{name: 'MAN_HOUR_RATE'	    			, text: '투입비율(LC)'   	, type: 'float', format:'0,000.000000'},
	    	{name: 'MAT_DAMT_TWO_RATE'	    		, text: '투입비율(M)'   	, type: 'float', format:'0,000.000000'},
	    	{name: 'EXPENSE_AMT_RATE'	   			, text: '투입비율(OH)'   	, type: 'float', format:'0,000.000000'},
	    	...
	    	{name: 'ACCU_TOTAL_AMT'	    			, text: '누적총계'    		, type: 'uniPrice'},
	    	{name: 'PER_UNIT_COST'	    			, text: '누적단위당원가'    , type: 'uniPrice'}
		]
   });
   
   var cam452skrvStore=Unilite.createStore('Store', {	
   		model: 'cam452skrvModel',
		autoLoad: false,
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {
				read    : 'cam452skrvService.selectList'
   ...
   /**
	...
	var panelSearch = Unilite.createSearchPanel('searchForm', {		
		title: '검색조건',
		api: {
         		 load:'cam452skrvService.selectWORK_SEQ'
				},
	...
	var masterGrid = Unilite.createGrid('tio110skrvGrid1', {
        ...
        columns: [
        	...
        	{dataIndex: 'PROD_ITEM_SPEC'			, width: 130 },
        	...
        	{dataIndex: 'EXPENSE_AMT_RATE'			, width: 100 ,summaryType: 'sum'
        		,summaryRenderer: function(value, summaryData, dataIndex, metaData) {
            		return Ext.util.Format.number(Ext.Number.toFixed(value, 2), '0,000.000000');
         		}
    		},
			...
			{dataIndex: 'ACCU_TOTAL_AMT'			, width: 90,  summaryType: 'sum'},
			{dataIndex: 'PER_UNIT_COST'				, width: 110}
		] 
    }); 
	Unilite.Main( {
		borderItems:[{
