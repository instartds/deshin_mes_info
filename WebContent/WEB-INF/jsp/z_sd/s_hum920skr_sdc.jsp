...
<t:appConfig pgmId="s_hum920skr_sdc"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_hum920skr_sdc"/> 						<!-- 사업장 -->
...
function appMain() {
    ...
    */
	...
	Unilite.defineModel('s_hum920skr_sdcModel', {
		fields: [ 
			...
			{name: 'AGE',					text: '<t:message code="system.label.human.age" default="나이"/>',			type: 'string'},
			{name: 'SEX_CODE',				text: '<t:message code="system.label.human.sexcode" default="성별"/>',			type: 'string'},
			...
			{name: 'RETR_EXP_YYYY',				text: '<t:message code=""							default="퇴직예정년도"/>',			type: 'string'}, // 추가
			...
			{name: 'DEPT_DATE',		text: '<t:message code="" default="현부서임용일"/>', 		type: 'uniDate'},
...
//			{name: 'COST_POOL',				text: gsCostPool, type: 'string'},
			...
			{name: 'DEPT_DATE_DIFF',		text: '<t:message code="" default="부서근속기간"/>', 			type: 'string'},
			{name: 'ANNOUNCE_DATE_DIFF',	text: '<t:message code="" default="직급근속기간"/>', 			type: 'string'}
		]
	});
    ...
    * @type 
    */               
   var directMasterStore1 = Unilite.createStore('s_hum920skr_sdcMasterStore',{
         model: 's_hum920skr_sdcModel',
         uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {          
                      read: 's_hum920skr_sdcService.selectList'                   
                }
            },
    		listeners : {
    	        load : function(store) {
	...
	var panelSearch = Unilite.createSearchPanel('searchForm', {		
		...
		items: [{	
			...
			Unilite.popup('Employee',{
		        ...
		        startFieldName: 'FR_DURATION',
		        endFieldName: 'TO_DURATION',
		        width: 315,
		        onStartDateChange: function(field, newValue, oldValue, eOpts) {
	                	if(panelResult) {
							panelResult.setValue('FR_DURATION',newValue);
	                	}
				    },
			    onEndDateChange: function(field, newValue, oldValue, eOpts) {
			    	if(panelResult) {
			    		panelResult.setValue('TO_DURATION',newValue);
			    	}
			    }
	        },{
...
//					},{
						...
						boxLabel: '<t:message code="system.label.human.join" default="입사"/>',
						name: 'RDO_TYPE',
						inputValue: '2'
					},{
	...
	var panelResult = Unilite.createSearchForm('panelResultForm', {
		...
		border:true,
			...
			{ 
		        ...
		        onStartDateChange: function(field, newValue, oldValue, eOpts) {
	                	if(panelSearch) {
							panelSearch.setValue('FR_DURATION',newValue);
	                	}
				    },
			    onEndDateChange: function(field, newValue, oldValue, eOpts) {
			    	if(panelSearch) {
			    		panelSearch.setValue('TO_DURATION',newValue);
			    	}
			    }
	        },{ 
                fieldLabel: '<t:message code="system.label.human.ocpt" default="직종"/>',
...
//					},{
	...
	var masterGrid = Unilite.createGrid('s_hum920skr_sdcMasterGrid', {
       region: 'center',
        layout: 'fit',
        uniOpt:{	
        ...
        columns: [
			...
			{dataIndex: 'AGE',					width:  60 , align: 'center'},
			{dataIndex: 'SEX_CODE',				width:  60 , align: 'center'},
			...
			{dataIndex: 'RETR_EXP_YYYY',		width:  90 , align: 'center'},
			...
			{dataIndex: 'DEPT_DATE',			width: 100 },
			{dataIndex: 'DEPT_DATE_DIFF',		width: 100 },
			{dataIndex: 'ANNOUNCE_DATE',		width: 100 },
			{dataIndex: 'ANNOUNCE_DATE_DIFF',	width: 100 },
