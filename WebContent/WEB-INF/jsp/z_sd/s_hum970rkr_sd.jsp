...
<t:appConfig pgmId="s_hum970rkr_sd"  >
...
//                        alert(Ext.getCmp('optPrintGb').getValue().optPrint);
                        ...
                        s_hum970rkr_sdService.fnHum970ini(param, function(provider, response){           // 증명번호 최신화
    ...
    var panelResult2 = Unilite.createSearchForm('resultForm2',{
		...
		items: [
			Unilite.popup('Employee',{
				...
				xtype:'container',
				html: '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <t:message code="system.message.human.message026" default="출력버튼을 클릭하시면 실제 출력여부에 관계 없이 증명번호가 카운트 되니"/>'+ '</br>' +
					  '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <t:message code="system.message.human.message027" default="이점 유의하시어 사전에 미리보기로 충분히 검토하신 후에 출력을 실행하여 주시기 바랍니다."/>',
				style: {
					color: 'blue'				
				}
			},{
...
//			var param = {"S_COMP_CODE": UserInfo.compCode };
        ...
        onPrintButtonDown: function() {
            ...
            param.PGM_ID = 's_hum970rkr_sd';  //프로그램ID
			...
			UniAppManager.app.fnUpdateChanges('0');
	    },
        onPrintButtonDown_bak: function() {
			...
			var win = Ext.create('widget.CrystalReport', {
                url: CPATH+'/z_sd/s_hum970crkr_sd.do',
                prgID: 's_hum970crkr_sd',
                extParam: param
            });
            win.center();
            win.show();
...
//	    	param.optPrintGb = bParam0;
	    	...
	    	s_hum970rkr_sdService.insertDetail(param, function(provider, response){	
	    		s_hum970rkr_sdService.fnHum970ini(param, function(provider2, response){
