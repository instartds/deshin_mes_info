...
<%
//노무개인별 조회
request.setAttribute("PKGNAME","Unilite_app_gla200skrv");
%>
<t:appConfig pgmId="gla200skrv"  >
...
function appMain() {
	Unilite.defineModel('${PKGNAME}Model', {
	    fields: [
			...
			{name: 'NAME'            		,text:'기사명'	,type : 'string',editable:false},
			{name: 'OFFENCE_COUNT'          ,text:'건수'		,type : 'uniQty',editable:false},
			{name: 'PENALTY_POINT'          ,text:'점수'		,type : 'uniQty',editable:false}
		]
	});
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'gla200skrvService.selectList2'/*,
			update: 'gla200skrvService.updateDetail',
			create: 'gla200skrvService.insertDetail',
			destroy: 'gla200skrvService.deleteDetail',
			syncAll: 'gla200skrvService.saveAll'*/
		}
	});
        ...
        model: '${PKGNAME}Model',
         autoLoad: false,
            ...
            proxy: {
				type: 'direct',
				api: {			
					read: 'gla200skrvService.selectList'               	
				}
			},
...
//    	           	{id : 'masterGridTotal', 	ftype: 'uniSummary', 	  showSummaryRow: true} ],
		...
		columns:[
			...
			{dataIndex:'OFFENCE_COUNT'            ,width: 47},
			{dataIndex:'PENALTY_POINT'            ,width: 47}
		],
		listeners: {
        	cellclick: function( view, td, cellIndex, record, tr, rowIndex, e, eOpts ) {
				if(rowIndex != beforeRowIndex){
					panelSearch.setValue('DRIVER_CODE_G',record.get('DRIVER_CODE'));
     ...
     var masterGrid2 = Unilite.createGrid('${PKGNAME}Grid2', {
      ...
      Unilite.Main({
		...
		onQueryButtonDown : function()	{
			panelSearch.setValue('DRIVER_CODE_G','');
			masterGrid2.reset();
		...
		onPrevDataButtonDown:  function()	{
			masterGrid2.selectPriorRow();
		},
		onNextDataButtonDown:  function()	{
			masterGrid2.selectNextRow();
		},	
