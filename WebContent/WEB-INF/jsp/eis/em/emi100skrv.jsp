...
<t:appConfig pgmId="emi100skrv"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="emi100skrv"  />             <!-- 사업장 -->  
...
function appMain() {
    ...
    var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 'emi100skrvService.selectList'
        }
    });
     ...
     * @type 
     */
    Unilite.defineModel('emi100skrvModel', {
        fields: [
     ...
     * @type 
     */                 
    var directMasterStore = Unilite.createStore('emi100skrvMasterStore',{
        model: 'emi100skrvModel',
        uniOpt : {
...
//        region: 'north',
//        layout : {type : 'uniTable', columns : 12
...
//		layout : {type : 'vbox', columns : 1},
		...
		items: [{
			...
			html: '<img src="'+CPATH+'/resources/images/eis/wh_map1_KDG.jpg" width="400"">'
		},{
        	fieldLabel:' ',
        	name:'GUBUN',
        	xtype:'uniCombobox',
    ...
    var masterGrid = Unilite.createGrid('emi100skrvmasterGrid1', { 
        layout : 'fit',   
        region: 'center',                          
