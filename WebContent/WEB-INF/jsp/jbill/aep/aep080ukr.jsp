...
function appMain() {
	...
	Unilite.defineModel('aep080ukrSubModel', {
    	fields: [ 
    		{name: 'BULLETIN_ID'	 	,text: '등록번호' 			,type: 'string'},
    	    {name: 'TITLE'      		,text: '제목'       	 	,type: 'string'},   
    	    {name: 'USER_ID'	 		,text: '게시자' 			,type: 'string'},
    	    {name: 'USER_NAME'	 		,text: '게시자' 			,type: 'string'},
            {name: 'FROM_DATE'          ,text: '게시시작일'         ,type: 'string'},
    		{name: 'TO_DATE'	 		,text: '게시종료일' 		,type: 'string'},  
    ...
    var detailForm = Unilite.createForm('aep080ukrDetail', {
    	disabled :false,
	    ...
	    , items :[{	    
     	...
     	api: {
     		load	: 'aep080ukrService.selectMaster',
			submit	: 'aep080ukrService.syncMaster'				
		},
		tbar: [
            '->',{
//                        itemId : 'Btn',
...
/*            		if(!elecSlipTransForm.getInvalidMessage()) return; 
	...
	var directSubStore = Unilite.createStore('aep080ukrSubStore', {
		model: 'aep080ukrSubModel',
        autoLoad: false,
        uniOpt : {
		...
		proxy: {
		   type: 'direct',
		   api: {			
		       read: 'aep080ukrService.selectSubList'                	
		   }
		},
...
//			    	UniAppManager.updateStatus(msg, true);	
    ...
    var subGrid = Unilite.createGrid('aep080ukrSubGrid', {    	
    	//region:'center',
...
//			id:'tdPayDtlNo',
    ...
    Unilite.Main( {
			...
			,fnInitBinding : function(params) {
				...
				detailForm.setValue('TYPE_FLAG','1');
