...
function appMain() {
    ...
    var directProxyButton = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            create: 'aep805ukrService.insertDetailButton',
            syncAll: 'aep805ukrService.saveAllButton'
        }
    });
    ...
    */
    ...
    Unilite.defineModel('aep805ukrSubModel1', {
        fields: [
...
/*    Unilite.defineModel('aep805ukrSubModel2', {
        fields: [
    ...
    * @type 
    */               
    var directDetailStore = Unilite.createStore('aep805ukrDetailStore',{
        model: 'aep805ukrModel',
        uniOpt : {
        ...
        proxy: {
            type: 'direct',
            api: {          
                read: 'aep805ukrService.selectList'                  
            }
        },
    ...
    var buttonStore = Unilite.createStore('ButtonStore',{     
        ...
        saveStore: function() {             
            ...
            if(inValidRecs.length == 0) {
                ...
                var grid = Ext.getCmp('aep805ukrGrid');
    ...
    var directSubStore1 = Unilite.createStore('aep805ukrSubStore1', {
        model: 'aep805ukrSubModel1',
        uniOpt: {
            isMaster: false,         // 상위 버튼 연결 
            editable: false,            // 수정 모드 사용 
            deletable: false,           // 삭제 가능 여부 
...
/*    var directSubStore2 = Unilite.createStore('aep805ukrSubStore2', {
        model: 'aep805ukrSubModel2',
        uniOpt: {
            isMaster: false,         // 상위 버튼 연결 
            editable: false,            // 수정 모드 사용 
            deletable: false,           // 삭제 가능 여부 
        ...
        proxy: {
            type: 'direct',
            api: {
                read: 'aep805ukrService.selectSubList2'                 
            }
        },
...
//          colspan:2,
    ...
    var detailGrid = Unilite.createGrid('aep805ukrGrid', {
        region: 'center',
        layout: 'fit',
        uniOpt: {
    ...
    //                    alert(buttonStore.count());  //임시로 카운트 뽑아 놓음 로그테이블 완성되면 saveStore 호출
        ...
        columns: [
            ...
            {dataIndex: 'APPR_MANAGE_NO'    ,            width: 150},
...
/*        tpl: '<tpl for=".">'+
             '<div class="data-source" ><div class="x-view-item-focused x-item-selected">' +                        
              ...
              '</tpl>',*/
/*        tpl: '<tpl for=".">'+
//             '<div class="data-source"><div class="border: 1px solid blue">'  +  
//        '<div class="data-source"><div class="container">'  +
   ...
   /*         tpl: '<tpl for=".">'+
             '<span class="data-source" ><div class="border: 1px solid blue">' +                        
...
//                        UniAppManager.app.setToolbarButtons('save', true);  //파일 추가or삭제시 저장버튼 on
        ...
        api: {
             load: 'aep805ukrService.getFileList',   //조회 api
             submit: 'aep805ukrService.saveFile'      //저장 api
        }
    });  
