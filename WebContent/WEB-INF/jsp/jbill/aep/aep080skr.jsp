...
<t:appConfig pgmId="aep080skrService"  >
...
function appMain() {     
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'aep080skrService.selectList',
			//update: 'aep080skrService.updateList',
			//create: 'aep080skrService.insertList
			destroy: 'aep080skrService.deleteList',
			syncAll: 'aep080skrService.saveAll'
		}
	});	
	
	
	Unilite.defineModel('Aep080skrModel', {
	    fields: [{name: 'COMP_CODE'    		,text:'COMP_CODE'		,type : 'string', defaultValue: UserInfo.userID}, 
				 {name: 'FROM_DATE'    		,text:'게시시작일'		,type : 'uniDate', editable: false},
	...
	var directMasterStore = Unilite.createStore('aep080skrMasterStore',{
		model: 'Aep080skrModel',
		uniOpt: {
...
//       	if(fnCheckReqiured(list)) return false;
    ...
    var masterGrid = Unilite.createGrid('aep080skrGrid1', {
    	layout : 'fit',
    	region:'center',
