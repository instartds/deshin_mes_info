...
function appMain() {     
	 ...
	 * @type 
	 */
	Unilite.defineModel('aep640skrModel', {
	    fields: [
			...
			{name: 'APPR_TIME'				, text: '사용시간'		, type: 'string'  },
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('aep640skrMasterStore1',{
		model: 'aep640skrModel',
		uniOpt: {
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'aep640skrService.selectList'                	
            }
        },
		...
		items: [{	
			...
			Unilite.popup('DEPT',{
			   ...
			   handler : function() {
					...
					aep640skrService.updateList(param, function(provider, response)	{
					});
			   }
		    }]				
		}]		
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('aep640skrGrid1', {
    	layout : 'fit',
        region : 'center',
