...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('Gba110Model', {
	    fields: [
	...
	var directMasterStore = Unilite.createStore('gba110ukrvMasterStore',{
			model: 'Gba110Model',
            autoLoad: false,
            uniOpt : {
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('gba110ukrvGrid', {
		...
		columns:[
        	{dataIndex: 'BUDG_CODE'		, text: '항목'	, width: 150	
        	...
        	{dataIndex: 'PJT_CODE'		, hidden:true		, width: 120},
        	{dataIndex: 'ORDER_Q'		, text: '수주수량'		, width: 120, summaryType: 'sum'},
        	{dataIndex: 'ORDER_P'		, text: '수주단가'		, width: 140},
        	{dataIndex: 'ORDER_O'		, text: '수주금액'		, width: 160, summaryType: 'sum'},
        	{dataIndex: 'BUDG_O'		, text: '예산금액'		, width: 160, summaryType: 'sum'},
        	{dataIndex: 'REMARK'		, text: '<t:message code="system.label.base.remarks" default="비고"/>'		, width: 250}
        ],
        listeners: {
  	...
  	Unilite.Main({                                                 
		...
		onSaveDataButtonDown: function () {
			var masterGrid = Ext.getCmp('gba110ukrvGrid');
