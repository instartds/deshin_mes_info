...
function appMain() {
     ...
     * @type
     */
    Unilite.defineModel('log100skrvModel', {
     ...
     * @type
     */
    var directMasterStore = Unilite.createStore('log100skrvMasterStore',{
        model: 'log100skrvModel',
        uniOpt: {
        ...
        proxy: {
            type: 'direct',
            api: {
                read: 'log100skrvService.selectList'
            }
        }
...
*/
     ...
     * @type
     */
    var masterGrid = Unilite.createGrid('log100skrvGrid', {
        region: 'center',
        layout: 'fit',
        uniOpt:{
