...
<t:appConfig pgmId="bpr100rkrv"  >
<t:ExtComboStore comboType="BOR120" pgmId="bpr100rkrv"  /> 			<!-- 사업장 -->
</t:appConfig>
...
function appMain() {
	 ...
	 * @type 
	 */	    			
	Unilite.defineModel('bpr100rkrvModel1', {
	    fields: [
	    	...
	    	{name: 'SALE_BASIS_P'	,text: '단가'				,type: 'string', editable: false, defaultValue: '0'},
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('bpr100rkrvMasterStore1',{
		model: 'bpr100rkrvModel1',
		uniOpt: {
...
//	        	tdAttrs:{'align':'center'},							   	
    ...
    var masterGrid = Unilite.createGrid('bpr100rkrvGrid1', {
    	// for tab
    	region: 'west',
    	layout: 'fit',
    	flex: 1,
...
//	   		var grdRecord = this.uniOpt.currentRecord;
    ...
    var describedPanel = Unilite.createSearchForm('bpr100rkrvDescribedPanel',{
    	region: 'center',
    	padding: '1 1 1 1',
	...
	Unilite.Main( {
		borderItems:[{
			...
			border: false,
			items:[
				masterGrid, panelResult, describedPanel
			]
		},
			panelSearch  	
		],
