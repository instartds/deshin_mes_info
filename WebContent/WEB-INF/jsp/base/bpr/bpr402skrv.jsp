...
<t:appConfig pgmId="bpr402skrv"  >
	...
	<t:ExtComboStore comboType="BOR120" pgmId="bpr402skrv" /> <!-- 사업장 -->       
</t:appConfig>
...
function appMain() {
	...
	Unilite.defineModel('Bpr402skrvModel', {
...
/*				 {name: 'STOCK_UNIT' 		,text:'<t:message code="system.label.base.inventoryunit" default="재고단위"/>' 		,type:'string'},
				 ...
				 {name: 'CUSTOM_P' 			,text:'<t:message code="system.label.base.sellingprice" default="판매단가"/>' 		,type:'uniUnitPrice'},
				 ...
				 {name: 'USE_YN' 			,text:'<t:message code="system.label.base.photoflag" default="사진유무"/>' 		,type:'string', comboType:'AU', comboCode:'B010'}
	 ...
	 * @type 
	 */					
	var directMasterStore = Unilite.createStore('bpr402skrvMasterStore1',{
			model: 'Bpr402skrvModel',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read: 'bpr402skrvService.selectList'                	
                }
            }
		...
		items: [{     
	        ...
	        items : [{
	    		...
	    		,listeners : {change : function( radioGroup, newValue, oldValue, eOpts) {
	    								...
	    								var custPopup = Ext.getCmp('bpr402ukrvCustPopup');
	    								var value = {};
	    								if(newValue.TYPE == '1')	{
	    									value = {'CUSTOM_TYPE' : '2'}
			    ...
			    listeners: {
					change: function(field, newValue, oldValue, eOpts) {						
						panelResult.getField('USE_YN').setValue(newValue.USE_YN);
					}
				}
			}]                 
		...
		border:true,
	    	items: [{
	    		...
	    		,listeners : {change : function( radioGroup, newValue, oldValue, eOpts) {
	    								...
	    								var custPopup = Ext.getCmp('bpr402ukrvCustPopup1');
	    								var value = {};
	    								if(newValue.TYPE == '1')	{
	    									value = {'CUSTOM_TYPE' : '2'}
	    								}else if(newValue.TYPE == '2')	{
			    ...
			    listeners: {
					change: function(field, newValue, oldValue, eOpts) {						
						panelSearch.getField('USE_YN').setValue(newValue.USE_YN);
					}
				}
			}]
	});
    ...
    var masterGrid = Unilite.createGrid('bpr402skrvGrid1', {
    	// for tab
    	region: 'center',
        layout : 'fit', 
        ...
        columns:  [{dataIndex: 'TYPE', 							width: 66, hidden: true}, 	// 구분
				   ...
				   {dataIndex: 'ITEM_NAME',  					width: 200 }, 				// 품명
				   {dataIndex: 'SPEC',		  					width: 80 }, 				// 규격 					
				   {dataIndex: 'MONEY_UNIT',					width: 100, hidden:true}, 	// 화폐단위
				   {dataIndex: 'ORDER_UNIT',					width: 100}, 				// 단위
				   {dataIndex: 'ITEM_P',						width: 100 }, 				// 단가
				   {dataIndex: 'APLY_START_DATE',  				width: 100 }, 	 			// 적용시작일
/*				   {dataIndex: 'STOCK_UNIT',					width: 100 }, 				// 재고단위
