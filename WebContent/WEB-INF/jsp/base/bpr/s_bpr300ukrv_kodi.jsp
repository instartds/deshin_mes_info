...
<t:appConfig pgmId="s_bpr300ukrv_kodi">
...
function appMain() {
	...
	Unilite.defineModel('bpr300ukrvModel', {
		fields: [
			...
			{name: 'SALE_TRNS_RATE'		, text: '<t:message code="system.label.base.salespackednumber" default="판매입수"/>'				, type: 'string'	, type: 'uniNumber'	, decimalPrecision:4	, format:'0,000.0000'	, defaultValue: 1.0000},
			//20180514 과출고허용율 추가
			...
			{name: 'PUR_TRNS_RATE'			, text: '<t:message code="system.label.base.purchasereceiptcount" default="구매입수"/>'			, type: 'uniNumber'	, decimalPrecision:4, format:'0,000.0000'	, defaultValue: 1.0000},
			//20180514 과입고허용율 추가
			...
			{name: 'PACK_TYPE'			, text: '<t:message code="system.label.base.packtype" default="포장형태"/>'		, type: 'int'},
			...
			{name: 'AUTO_ITEM_ACCOUNT'		, text: 'AUTO_ITEM_ACCOUNT'				, type: 'string'}
		]
	});
...
//			hidden:true,
			items		: [{
				...
				defaults: {type: 'uniTextfield', labelWidth:120},
				                ...
				                bpr300ukrvService.saveAutoItemCode(param, function(provider, response)  {
				                    if(!Ext.isEmpty(provider)){
				                        if(provider=='Y'){
											...
											detailForm.setValue('ITEM_ACCOUNT',detailForm.getValue('AUTO_ITEM_ACCOUNT'));
