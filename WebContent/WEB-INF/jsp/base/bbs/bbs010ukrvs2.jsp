<%@page language="java" contentType="text/html; charset=utf-8"%>
	var bbs010ukrv2Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	var bbs010ukrv2Store = Unilite.createStore('bbs010ukrv2Store',{
...
var nationCode =  Unilite.createGrid('bbs010ukrvGrid2', {
		title:'<t:message code="system.label.base.countrycode" default="국가코드"/>',
		itemId:'nationCode',
		subCode:'B012',
		autoScroll:true,
		flex:1,
