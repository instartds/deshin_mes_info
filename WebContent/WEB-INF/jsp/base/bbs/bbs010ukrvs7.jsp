...
var bbs010ukrv7Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
...
var bbs010ukrv7Store = Unilite.createStore('bbs010ukrv7Store',{
...
var noticeManager  = Unilite.createGrid('bbs010ukrvGrid7', {
		title:'<t:message code="system.label.base.noticesmanageruserid" default="공지사항 관리자 user id"/>',
		itemId:'noticeManager',
		subCode:'B600',
		autoScroll:true,
		flex:1,
		dockedItems: [{
