<%@page language="java" contentType="text/html; charset=utf-8"%>
	var bbs010ukrv4Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	var bbs010ukrv4Store = Unilite.createStore('bbs010ukrv4Store',{
...
var dueDate  = Unilite.createGrid('bbs010ukrvGrid4', {
		title:'<t:message code="system.label.base.customclosingdate" default="거래처마감일"/>',
		itemId:'dueDate',
		subCode:'B033',
		autoScroll:true,
		flex:1,
