<%@page language="java" contentType="text/html; charset=utf-8"%>
	var bbs010ukrv5Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	var bbs010ukrv5Store = Unilite.createStore('bbs010ukrv5Store',{
...
var payment  = Unilite.createGrid('bbs010ukrvGrid5', {
		title:'<t:message code="system.label.base.paymentcondition" default="결제조건"/>',
		itemId:'payment',
		subCode:'B034',
		autoScroll:true,
		flex:1,
