<%@page language="java" contentType="text/html; charset=utf-8"%>
	var bbs010ukrv3Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
	...
	var bbs010ukrv3Store = Unilite.createStore('bbs010ukrv3Store',{
...
var unit  = Unilite.createGrid('bbs010ukrvGrid3', {
		title:'<t:message code="system.label.base.unit" default="단위"/>',
		itemId:'unit',
		subCode:'B013',
		autoScroll:true,
		flex:1,
