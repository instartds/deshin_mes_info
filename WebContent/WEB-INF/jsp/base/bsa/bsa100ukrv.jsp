...
function appMain() {
		...
		Unilite.defineModel('${PKGNAME}MasterCodeModel', {
			fields : [ {name : 'MAIN_CODE',			text : '<t:message code="system.label.base.commoncode" default="종합코드"/>',			type : 'string',    allowBlank:false, isPk:true,  pkGen:'user', readOnly:true	}
					 ...
					 , {name : 'REF_CODE11',			text : '<t:message code="system.label.base.refer11" default="관련11"/>',				type : 'string'		}
					 , {name : 'REF_CODE12',			text : '<t:message code="system.label.base.refer12" default="관련12"/>',				type : 'string'		}
					 , {name : 'REF_CODE13',			text : '<t:message code="system.label.base.refer13" default="관련13"/>',				type : 'string'		}
					 , {name : 'REF_CODE14',			text : '<t:message code="system.label.base.refer14" default="관련14"/>',				type : 'string'		}
					 , {name : 'REF_CODE15',			text : '<t:message code="system.label.base.refer15" default="관련15"/>',				type : 'string'		}
		...
		Unilite.defineModel('DetailCodeModel', {
			fields : [ 	  {name : 'MAIN_CODE',		text : '<t:message code="system.label.base.commoncode" default="종합코드"/>'	, allowBlank : false, readOnly:true}
						...
						, {name : 'CODE_NAME_EN',		text : '<t:message code="system.label.base.subcodenameen" default="상세코드명(영어)"/>'	}
						, {name : 'CODE_NAME_CN',		text : '<t:message code="system.label.base.subcodenamecn" default="상세코드명(중국어)"/>'	}
						, {name : 'CODE_NAME_JP',		text : '<t:message code="system.label.base.subcodenamejp" default="상세코드명(일본어)"/>'	}
						, {name : 'CODE_NAME_VI',		text : '<t:message code="system.label.base.subcodenamevi" default="상세코드명(베트남어)"/>'	}
		...
		var masterGrid = Unilite.createGrid('${PKGNAME}Grid', {
			...
			columns : [   {dataIndex : 'MAIN_CODE',			width : 80		}
						...
						, {dataIndex : 'CODE_NAME_VI',			width : 150		,hidden:true}
						...
						, {dataIndex : 'REF_CODE12',			width : 110		}
						, {dataIndex : 'REF_CODE13',			width : 110		}
						, {dataIndex : 'REF_CODE14',			width : 110		}
						, {dataIndex : 'REF_CODE15',			width : 110		}
					],
			listeners : {
		...
		var detailGrid =  Unilite.createGrid('${PKGNAME}DetailGrid', {
			...
			columns : [   {dataIndex : 'id',				width: 130,		hidden: true}
						...
						, {	dataIndex : 'REF_CODE11',		width : 110,	hidden : false	}
						, {	dataIndex : 'REF_CODE12',		width : 110,	hidden : false	}
						, {	dataIndex : 'REF_CODE13',		width : 110,	hidden : false	}
						, {	dataIndex : 'REF_CODE14',		width : 110,	hidden : false	}
						, {	dataIndex : 'REF_CODE15',		width : 110,	hidden : false	}
				...
				, onNewDataButtonDown : function()	{
					if(activeGridId == '${PKGNAME}Grid' )	{ 
						...
						if(pRecord != null)	{
							...
							Unilite.messageBox('<t:message code="system.message.base.message014" default="종합코드를 선택하세요."/>');
						}
					}
				}
