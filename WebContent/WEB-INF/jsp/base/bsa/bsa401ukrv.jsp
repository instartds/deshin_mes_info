...
<%
//프로그램 정보등록
request.setAttribute("PKGNAME","Unilite_app_bsa401ukrv");
%>
<t:appConfig pgmId="bsa401ukrv"  >
...
function appMain() {
	...
	var directMasterStore = Unilite.createTreeStore('${PKGNAME}MasterStore',{
            ...
            proxy: /*directProxy*/{
                ...
                api: {
	                read : 'bsa401ukrvService.selectList'
	                ,update : 'bsa401ukrvService.updatePrograms'
					,create : 'bsa401ukrvService.insertPrograms'
					,destroy: 'bsa401ukrvService.deletePrograms'
					,syncAll: EXTVERSION == '4.2.2' ? 'bsa401ukrvService.syncAll':'bsa401ukrvService.saveAll'
    ...
    var masterGrid = Unilite.createTreeGrid('${PKGNAME}Grid', {
		...
		columns:[{
				...
				,{dataIndex:'PGM_ARNG_SEQ'	,width:60}
