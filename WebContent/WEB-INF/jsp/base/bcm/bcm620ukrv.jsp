...
function appMain() {    
	var selectedGrid = 'bcm620ukrvGrid1';  // Grid1 createRow Default
	
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'bcm620ukrvService.selectMaster',
			update: 'bcm620ukrvService.updateMaster',
			create: 'bcm620ukrvService.insertMaster',
			destroy: 'bcm620ukrvService.deleteMaster',
			syncAll: 'bcm620ukrvService.saveAll'
		}
	});	
	...
	var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'bcm620ukrvService.selectDetail',
			update: 'bcm620ukrvService.updateDetail',
			create: 'bcm620ukrvService.insertDetail',
			destroy: 'bcm620ukrvService.deleteDetail',
			syncAll: 'bcm620ukrvService.saveAll2'
		}
	});	
	 ...
	 * @type 
	 */    			
	Unilite.defineModel('bcm620ukrvModel1', {
	    fields: [  	 
	...
	});		//End of Unilite.defineModel('bcm620ukrvModel', {
	
	
	Unilite.defineModel('bcm620ukrvModel2', {
	    fields: [  	 
			{name: 'UPDATE_DB_USER'	       	,text: '작성자'		,type: 'string'},  	 
			{name: 'UPDATE_DB_TIME'	       	,text: '작성시간'		,type: 'string'},  	 
			{name: 'PJT_CODE'		       	,text: '프로젝트번호'	,type: 'string'},  	 
			{name: 'INPUT_DATE'		       	,text: '일자'			,type: 'uniDate', allowBlank: false},  	 
			{name: 'MONEY_UNIT'			    ,text: '화폐단위'		,type: 'string'	, comboType:'AU',comboCode:'B004', displayField: 'value'},
			{name: 'EXCHG_RATE'		       	,text: '환율'			,type: 'uniER'},
			{name: 'CONTRACT_AMT'			,text: '금액'			,type: 'uniPrice'},
			{name: 'AMT'			       	,text: '금액(원화)'	,type: 'uniPrice'},  	 
			{name: 'BEFORE_AMT'		       	,text: '선수금'		,type: 'uniPrice'},
			{name: 'PAY_CONDITION'			,text: '결제방법'		,type: 'string'	, comboType:'AU',comboCode:'T006'},
			{name: 'DOCU_NO'			    ,text: '관련문서번호'	,type: 'string'},
	...
	var directMasterStore = Unilite.createStore('bcm620ukrvMasterStore',{
			model: 'bcm620ukrvModel1',
			uniOpt: {
	...
	});		// End of var directMasterStore = Unilite.createStore('bcm620ukrvMasterStore1',{
	
	var directDetailStore = Unilite.createStore('bcm620ukrvDetailStore',{
			model: 'bcm620ukrvModel2',
			uniOpt: {
            	isMaster: true,			// 상위 버튼 연결 
            	editable: true,			// 수정 모드 사용 
            	deletable: true,		// 삭제 가능 여부 
	...
	});		// End of var directDetailStore = Unilite.createStore('bcm620ukrvDetailStore',{
...
/*						{
    ...
    var masterGrid= Unilite.createGrid('bcm620ukrvGrid1', {
        layout:'fit',
        region:'center',
        uniOpt: {
     ...
     * @type 
     */
	var detailGrid = Unilite.createGrid('bcm620ukrvGrid2', {
		layout:'fit',
		split: true,
        region:'south',
        uniOpt: {
        ...
        columns:  [
        	...
        	{dataIndex:'CONTRACT_AMT'	, width:133},
        	{dataIndex:'AMT'			, width:133},
        	{dataIndex:'BEFORE_AMT'		, width:133},
        	{dataIndex:'PAY_CONDITION'	, width:86, align: 'center'},
        	{dataIndex:'DOCU_NO'		, width:120},
	...
	});		// End of var detailGrid= Unilite.createGrid('bcm620ukrvGrid2', {
    ...
    Unilite.Main({ 
		...
		onNewDataButtonDown : function()	{
			if(selectedGrid == 'bcm620ukrvGrid1'){
				var r = {
	            	DIVI         : 'N'
	            };
			...
			else if(selectedGrid == 'bcm620ukrvGrid2'){
