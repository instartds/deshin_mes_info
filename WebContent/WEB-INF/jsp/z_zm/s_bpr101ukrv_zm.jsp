...
<t:appConfig pgmId="s_bpr101ukrv_zm"  >
...
<t:ExtComboStore items="${COMBO_ITEM_LEVEL1}" storeId="s_bpr101ukrv_zmLevel1Store" />
<t:ExtComboStore items="${COMBO_ITEM_LEVEL2}" storeId="s_bpr101ukrv_zmLevel2Store" />
<t:ExtComboStore items="${COMBO_ITEM_LEVEL3}" storeId="s_bpr101ukrv_zmLevel3Store" />
</t:appConfig>
...
//	var isAllowBasisPriceChange = true;
		...
		initComponent: function() {			
	    	...
	    	var searchStore  = Ext.create('Ext.data.Store',{
	            ...
	            proxy: {
	                type: 'direct',
	                api: {
	                    read : 's_bpr101ukrv_zmService.searchMenu'
	                },
		            reader: {
		                type: 'json',
				<c:choose>
	...
	Unilite.defineModel('s_bpr101ukrv_zmModel', {
		fields: [	 //BPR100T필수
					...
					,{ name: 'STOCK_UNIT',  			text: '재고단위', 		type : 'string', allowBlank: false, comboType:'AU', comboCode:'B013', displayField: 'value'/*, defaultValue: 'EA'*/ }      
    	 	 		...
    	 	 		,{ name: 'ITEM_CODE',  				text: '품목코드', 		type : 'string', allowBlank: true, isPk:true, pkGen:'user',maxLength:20 }
			  		,{ name: 'ITEM_NAME',  				text: '품목명', 		type : 'string', allowBlank: false, maxLength: 40}        
			  		
			  		,{ name: 'SPEC',  					text: '규격', 		type : 'string', maxLength: 160}
				    ,{ name: 'ITEM_LEVEL1',  			text: '대분류', 		type : 'string', store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel1Store'), child:'ITEM_LEVEL2'}        					       
				    ,{ name: 'ITEM_LEVEL2',  			text: '중분류', 		type : 'string', store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel2Store'), child:'ITEM_LEVEL3'}        
				    ,{ name: 'ITEM_LEVEL3',  			text: '소분류', 		type : 'string', store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel3Store'),parentNames:['ITEM_LEVEL1','ITEM_LEVEL2'], levelType:'ITEM'}
			  		,{ name: 'SALE_UNIT',  				text: '판매단위', 		type : 'string', comboType:'AU', comboCode:'B013', displayField: 'value', allowBlank: false/*, defaultValue: 'EA'*/}      
			  		,{ name: 'TRNS_RATE',  				text: '판매입수', 		type : 'int'/*, defaultValue:1.00*/, maxLength: 12 }           
			  		,{ name: 'SALE_BASIS_P',  	 		text: '판매단가', 		type : 'uniPrice', maxLength: 18, allowBlank: true}
			  		,{ name: 'BF_SALE_BASIS_P',  		text: '이전단가', 		type : 'uniPrice', maxLength: 18}
			  		
			  		//BPR200T 필수
			  		,{ name: 'DIV_CODE',  				text: '사업장', 		type : 'string', allowBlank: false, comboType: 'BOR120' /*, multiSelect: true, typeAhead: false*/}
			  		...
			  		,{ name: 'WH_CODE',  				text: '주창고', 		type : 'string', store: Ext.data.StoreManager.lookup('whList'), defaultValue: 'W052'}
			  		,{ name: 'ORDER_PLAN',  			text: '발주방침', 		type : 'string', comboType:'AU', comboCode:'B061', allowBlank: true/*, defaultValue: '1'*/}
			  		
			  		//BPR200T 일반
			  		,{ name: 'BUY_RATE',  				text: '구매입수', 		type : 'int', maxLength:12 }
				    ...
				    ,{ name: 'ITEM_GROUP_NAME',  		text: '대표모델명', 	type : 'string', maxLength: 40}    
			  		,{ name: 'STOCK_CARE_YN',  			text: '재고관리대상', 	type : 'string', comboType:'AU', comboCode:'B010'}   
			  		,{ name: 'START_DATE',  			text: '사용시작일', 	type : 'uniDate', maxLength: 10}    
				    ...
				    ,{ name: 'SALE_COMMON_P',  			text: '시중가', 		type : 'uniPrice', maxLength: 18}
				    ...
				    ,{ name: 'SPEC_CONTROL_CODE',	  	text: '특정코드', 		type : 'string', maxLength:3 }				    
			  		...
			  		,{ name: 'IN_EXCESS_RATE',  		text: '과입고허용율',  	type : 'uniPercent', defaultValue:99999.00, maxLength: 10}
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_bpr101ukrv_zmService.selectDetailList',
			update: 's_bpr101ukrv_zmService.updateDetail',
			create: 's_bpr101ukrv_zmService.insertDetail',
			destroy: 's_bpr101ukrv_zmService.deleteDetail',
			syncAll: 's_bpr101ukrv_zmService.saveAll'
		}
	});
	var directMasterStore = Unilite.createStore('s_bpr101ukrv_zmMasterStore',{
			model: 's_bpr101ukrv_zmModel',
           	autoLoad: false,
        	uniOpt : {
        	...
        	,loadStoreRecords : function()	{
					...
					s_bpr101ukrv_zmService.checkItemCode(checkParam, function(provider1, response)	{
...
//				var paramMaster= [];
//				var app = Ext.getCmp('s_bpr101ukrv_zmApp');
...
//							params: [paramMaster],
							success: function(batch, option) {
								...
								s_bpr101ukrv_zmService.goInterFace(param, function(provider, response)	{
								});
...
//					}
	...
	Unilite.defineModel('s_bpr101ukrv_zmSubModel', {
    	fields: [ {name: 'CUSTOM_CODE'	 		,text: '매입처코드' 			,type: 'string', allowBlank: false},
		    	  ...
		    	  {name: 'ORDER_RATE'			,text: '발주율(%)' 			,type: 'uniPercent', allowBlank: true},
		    	  {name: 'USE_YN'				,text: 'USE_YN' 			,type: 'string'},
		    	  {name: 'ITEM_P'				,text: '매입가' 				,type: 'uniPrice', allowBlank: true},//단가 * 발주율 %
			  	  {name: 'BASIS_P'				,text: '판매단가'				,type :'uniPrice'},
	...
	var directSubProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 's_bpr101ukrv_zmService.selectSubDetailList',
			update: 's_bpr101ukrv_zmService.updateSubDetail',
			create: 's_bpr101ukrv_zmService.insertSubDetail',
			destroy: 's_bpr101ukrv_zmService.deleteSubDetail',
			syncAll: 's_bpr101ukrv_zmService.subSaveAll'
		}
	});
	
	var directSubStore = Unilite.createStore('s_bpr101ukrv_zmSubStore', {
		model: 's_bpr101ukrv_zmSubModel',
        autoLoad: false,
        uniOpt : {
...
//			    	UniAppManager.updateStatus(msg, true);	
	 ...
	 * 검색 Form
	 */
	var sortSeqStore = Unilite.createStore('s_bpr101ukrv_zmSeqStore', {
	    fields: ['text', 'value'],
		data :  [
			        {'text':'오름차순'		, 'value':'ASC'},
		...
		items: [{     
        	...
        	layout: {type: 'uniTable', columns: 1},
		 	items: [{
    			...
    			fieldLabel: '대분류',
    			xtype:'uniCombobox',
                store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel1Store'),
                child: 'ITEM_LEVEL2'
              }, {
              	name: 'ITEM_LEVEL2',
              	fieldLabel: '중분류',
              	xtype:'uniCombobox',
                store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel2Store'),
                child: 'ITEM_LEVEL3'
             	...
             	fieldLabel: '소분류',
             	xtype:'uniCombobox',
                store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel3Store'),
     ...
     * Master Grid
     */
	 var masterGrid = Unilite.createGrid('s_bpr101ukrv_zmGrid', {  
    	region:'center',
...
//				directSubStore.clearData();
    ...
    /*상세폼에  BPR400T그리드*/
    var subGrid = Unilite.createGrid('s_bpr101ukrv_zmsubGrid', {    	
    	//region:'center',
...
//					var orderUnit = record.get('ORDER_UNIT');
        ...
        columns:  [  { dataIndex: 'CUSTOM_CODE'	 		,  		width: 90,
			  		...
			  		,{ dataIndex: 'PURCHASE_TYPE'	 	,  		width: 90 }
			  		,{ dataIndex: 'SALES_TYPE'		 	,  		width: 90 }
			  		...
			  		,{ dataIndex: 'ORDER_RATE'			,  		width: 110 }
	        		...
	        		if(compareRecords.length > 0){
	    				...
	    				if(updateRec && insertRec && isSuccess){
	    					if(UniDate.getDbDateStr(insertRec.get('APLY_START_DATE')) >  UniDate.getDbDateStr(updateRec.get('APLY_START_DATE'))){
	    						...
	    						alert('최종 적용일자보다 이전 날짜를 입력 할 수 없습니다.\n 매입처명:' + duplRecord[0].get('CUSTOM_NAME'));
			        			isSuccess = false;
			        			duplRecord = [];
		    					return isSuccess;
	    					}		    				
    ...
    var stockSearchForm = Unilite.createSearchForm('s_bpr101ukrv_zmstockSearchForm', {        
            layout :  {type : 'uniTable', columns : 1},
            items :[{
				name: 'DIV_CODE',
				fieldLabel: '사업장',
    ...
    //창고별재고 조회 모델
	Unilite.defineModel('s_bpr101ukrv_zmstockSearchModel', {
	    fields: [{name: 'COMP_CODE'			    	,text: 'COMP_CODE'				, type: 'string'},
	    		 ...
	    		 {name: 'PURCHASE_P'			    ,text: '매입가'					, type: 'uniPrice'},
	    		 {name: 'STOCK_Q'			    	,text: '현재고'					, type: 'uniQty'}				 				 
		]
	});
	//창고별재고 조회 스토어
    var stockSearchStore = Unilite.createStore('s_bpr101ukrv_zmstockSearchStore', {
			model: 's_bpr101ukrv_zmstockSearchModel',
            autoLoad: false,
            uniOpt : {
            	isMaster: false,			// 상위 버튼 연결
            ...
            proxy: {
                type: 'direct',
                api: {
                	read    : 's_bpr101ukrv_zmService.selectStockList'
                }
            }
            ,loadStoreRecords : function()	{
				var param= {
	...
	//창고별재고 조회 그리드 
    var stockSearchGrid = Unilite.createGrid('s_bpr101ukrv_zmstockSearchGrid', {
        // title: '기본',
        layout : 'fit',
...
/*								if(!Ext.isEmpty(field.getValue())){
	    		...
	    		{ 
        			...
        			, layout: { type: 'uniTable', columns: 1}
        			, height: 435
        			, items :[	 { name: 'ITEM_LEVEL1',  			fieldLabel: '대분류' 		,xtype:'uniCombobox', store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel1Store'), child: 'ITEM_LEVEL2'}   
						  		,{ name: 'ITEM_LEVEL2',  			fieldLabel: '중분류' 		,xtype:'uniCombobox', store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel2Store'), child: 'ITEM_LEVEL3'}    
						  		,{ name: 'ITEM_LEVEL3',  			fieldLabel: '소분류' 		,xtype:'uniCombobox', store: Ext.data.StoreManager.lookup('s_bpr101ukrv_zmLevel3Store'), parentNames:['ITEM_LEVEL1','ITEM_LEVEL2'],levelType:'ITEM'}
						  		,{xtype: 'displayfield', name: ''}
						  		,{ name: 'SPEC',  					fieldLabel: '규격' 		,maxLength: 160} 
						  		,{ name: 'STOCK_UNIT',  			fieldLabel: '재고단위',	 xtype:'uniCombobox',	comboType:'AU', comboCode:'B013' , allowBlank:false, displayField: 'value'}     
...
//						  		,{ name: 'USE_YN',  				fieldLabel: '사용여부', 	xtype:'uniRadiogroup', comboType:'AU', comboCode:'B010', width:235, allowBlank:false}
							   ...
							   ,{
	        						...
	        						layout: {type: 'uniTable', columns: 1},
	        						defaults: {type: 'uniTextfield', enforceMaxLength: true},
	        						items: [ { name: 'REMARK1',  			fieldLabel: '비고사항1'  , xtype:'uniTextfield'	, maxLength: 300}       
							  				,{ name: 'REMARK2',  			fieldLabel: '비고사항2'  , xtype:'uniTextfield', maxLength: 300} 
							  				,{ name: 'REMARK3',  			fieldLabel: '비고사항3'  , xtype:'uniTextfield', maxLength: 300}
									]
        						}
	    	   ...
	    	   ,{   title: '제원정보'
        			...
        			, height: 435
        			, width: 300
        			, items :[	 { name: 'TAX_TYPE',  				fieldLabel: '세구분', 	xtype:'uniCombobox', comboType:'AU', comboCode:'B059' , allowBlank:false}         
						  		,{ name: 'SALE_BASIS_P',  	 		fieldLabel: '판매단가', 	xtype : 'uniNumberfield', maxLength: 18, colspan: 1, readOnly: true, allowBlank: false}
						  		,{						           
						           margin: '0 0 0 4',
						           xtype: 'button',
								   text: '변경',		
...
//							    ,{ name: 'SPEC_CONTROL',  	 		fieldLabel: '특정', 		xtype : 'uniRadiogroup', comboType:'AU', comboCode:'B010', width:235, allowBlank:false}
							    ...
							    ,{ name: 'SALE_UNIT',  				fieldLabel: '판매단위',	xtype:'uniCombobox',	comboType:'AU', comboCode:'B013' , displayField: 'value', allowBlank:false}							    
							    ,{ name: 'TRNS_RATE',  				fieldLabel: '판매입수',	xtype:'uniNumberfield', maxLength :12}
							    ,{ name: 'BIG_BOX_BARCODE', 		fieldLabel: '박스바코드',	xtype:'uniTextfield', maxLength :20}
							    ,{ name: 'EXCESS_RATE',  			fieldLabel: '과출고허용율',	xtype : 'uniNumberfield',  decimalPrecision:'2', maxLength :3}
							    ,{xtype: 'displayfield', name: ''}
/*							    ,{
	    							padding: '8 0 0 0',
								    xtype: 'radiogroup',
							   ...
							   ,{ name: 'USE_BY_DATE',  			fieldLabel: '유효일자',		 xtype:'uniNumberfield',value:'${UseByDate}', hidden: false, maxLength: 10}*/
//        					   ,{xtype: 'displayfield', name: ''}
        					   ,{ name: 'ORDER_PLAN',  				fieldLabel: '발주방침',		 xtype:'uniCombobox', comboType:'AU', comboCode:'B061', hidden: true, allowBlank:true}//bpr200t
...
//        					   ,{xtype: 'displayfield', name: ''}
	        				   ...
	        				   ,{ name: 'PURCHASE_BASE_P', 			fieldLabel: '구매단가',		 xtype:'uniNumberfield', maxLength: 18}//bpr200t
//	        				   ,{xtype: 'displayfield', name: '', height: 162}
	    		...
	    		,{  title: '조달정보'
        			...
        			, defaults: {type: 'uniTextfield', enforceMaxLength: true}
        			, height: 435
        			,items :[ { name: 'DIV_CODE',  					fieldLabel: '사업장', 		 xtype:'uniCombobox', comboType:'BOR120', value:UserInfo.divCode, readOnly: true,allowBlank:false/*, multiSelect: true, typeAhead: false*/}//bpr200t	 
        					 ,{ name: 'ITEM_ACCOUNT',  				fieldLabel: '품목계정', 		 xtype:'uniCombobox', comboType:'AU', comboCode:'B020', allowBlank:false}//bpr200t
        					 ,{ name: 'SUPPLY_TYPE',  				fieldLabel: '조달구분', 		 xtype:'uniCombobox', comboType:'AU', comboCode:'B014', allowBlank:false}//bpr200t
        					 ,{ name: 'ORDER_UNIT',  				fieldLabel: '구매단위',		 xtype:'uniCombobox', comboType:'AU', comboCode:'B013', displayField: 'value', allowBlank:false}//bpr200t        					 
        					 ,{				            	
			    				xtype: 'uniNumberfield',
			    				fieldLabel: '구매입수',
			    				name: 'BUY_RATE',
...
//        					 ,{xtype: 'uniCombobox', fieldLabel: '진열대번호', name: 'BIN_NUM', comboType:'AU', comboCode:'YP02', maxLength :10 }
							...
							Unilite.popup('BIN', { 
        					 ...
        					 ,{ name: 'WH_CODE',	  				fieldLabel: '주창고', 		 xtype:'uniCombobox', store: Ext.data.StoreManager.lookup('whList')}//bpr200t
        					 ,{ name: 'LOCATION',  					fieldLabel: 'Location', 	 xtype:'uniTextfield', maxLength :20}//bpr200t
        					 ,{ name: 'IN_EXCESS_RATE',  			fieldLabel: '과입고허용율',	xtype : 'uniNumberfield',  decimalPrecision:'2', maxLength :10}
...
//									SALES_TYPE : ,						
								...
								s_bpr101ukrv_zmService.updateSaleBasisP(param, function(provider, response)	{
	...
	Unilite.Excel.defineModel('excel.bpr101.sheet01', {
	    fields: [
			...
			{name: 'ITEM_LEVEL_NAME2' 		 ,text:'중분류'		,type: 'string'},			 
			{name: 'ITEM_LEVEL3' 		 	 ,text:'소분류코드'		,type: 'string'},	
			{name: 'ITEM_LEVEL_NAME3' 		 ,text:'소분류'		,type: 'string'},		 
			...
			{name: 'STOCK_CARE_YN' 		 	 ,text:'재고관리대상'	,type: 'string', comboType:'AU', comboCode:'B010'},			 
			{name: 'WH_CODE' 		 		 ,text:'주창고'		,type: 'string', store: Ext.data.StoreManager.lookup('whList')},			 
			...
			{name: 'CUSTOM_CODE' 		 	 ,text:'매입처코드'		,type: 'string'},
			{name: 'CUSTOM_NAME' 		 	 ,text:'매입처명'		,type: 'string'},
			{name: 'ITEM_P' 		 		 ,text:'매입단가'		,type: 'uniPrice'},			 
            ...
            if(!excelWindow) {
                ...
                excelWindow = Ext.create( appName, {
                        ...
                        grids: [{
                        		...
                        		readApi: 's_bpr101ukrv_zmService.selectExcelUploadSheet1',
                        		//useCheckbox: false,
                        		columns: [
                        ...
                        onApply:function()	{
							...
							s_bpr101ukrv_zmService.selectExcelUploadSheet1(param, function(provider, response){
...
//				detailForm.clearForm();		//넣으면 폼 깨짐
		...
		setDefault: function() {
        	panelSearch.setValue('ITEM_ACCOUNT','01');
        	panelResult.setValue('ITEM_ACCOUNT','01');
...
/*			masterForm.getForm().wasDirty = false;
		...
		processParams: function(params) {
			...
			if(params && params.ITEM_CODE) {
				...
				s_bpr101ukrv_zmService.checkItemDuplicate(param, function(provider1, response)	{							
