...
<title>Error Message(Session)</title>
        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left"><img src="<c:url value='/images/egovframework/com/cmm/er_logo.jpg' />" width="379" height="57" alt="Error"/></td>
              </tr>
              <tr>
                <td><br />
                  <br /></td>
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td width="399" align="left" class="lt_text2">Session Expired</td>
                  </tr>
                </table>
              ...
              <tr>
                <td align="center"><a href="javascript:fncGoAfterErrorPage();"><img src="<c:url value='/resources/images/error/go_history.jpg' />" width="90" height="29" alt="바로가기버튼이미지" /></a></td>
              </tr>
            </table>
              <br /></td>
          </tr>
