...
<t:appConfig pgmId="s_pmp141skrv_jw"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_pmp141skrv_jw" />	<!-- 사업장 -->  
...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('s_Pmp141skrv_jwModel', {
		fields: [
	...
	});		//End of Unilite.defineModel('s_Pmp141skrv_jwModel', {
	 ...
	 * @type 
	 */
	var directMasterStore1 = Unilite.createStore('s_pmp141skrv_jwMasterStore1',{
		model: 's_Pmp141skrv_jwModel',
		uniOpt: {
		...
		proxy: {
			type: 'direct',
			api: {			
				read: 's_pmp141skrv_jwService.selectList'
			}
		},
	...
	});		//End of var directMasterStore1 = Unilite.createStore('s_pmp141skrv_jwMasterStore1',{
			...
			items: [{
					...
					listeners: {
							onSelected: {
								fn: function(records, type) {
									topSearch.setValue('PROD_ITEM_CODE', panelSearch.getValue('PROD_ITEM_CODE'));
									topSearch.setValue('PROD_ITEM_NAME', panelSearch.getValue('PROD_ITEM_NAME'));	
								},
								scope: this
							},
				...
				Unilite.popup('DIV_PUMOK',{
					...
					listeners: {
						onSelected: {
							fn: function(records, type) {
								topSearch.setValue('CITEM_CODE', panelSearch.getValue('CITEM_CODE'));
								topSearch.setValue('CITEM_NAME', panelSearch.getValue('CITEM_NAME'));
							},
							scope: this
						},
						onClear: function(type)	{
	...
	var topSearch = Unilite.createSimpleForm('topSearchForm', {
		...
		border:true,
			...
			listeners: {
					onSelected: {
						fn: function(records, type) {
							panelSearch.setValue('PROD_ITEM_CODE', topSearch.getValue('PROD_ITEM_CODE'));
							panelSearch.setValue('PROD_ITEM_NAME', topSearch.getValue('PROD_ITEM_NAME'));
						},
						scope: this
					},
					onClear: function(type)	{
			...
			Unilite.popup('DIV_PUMOK',{
				...
				listeners: {
					onSelected: {
						fn: function(records, type) {
							panelSearch.setValue('CITEM_CODE', topSearch.getValue('CITEM_CODE'));
							panelSearch.setValue('CITEM_NAME', topSearch.getValue('CITEM_NAME'));
						},
						scope: this
					},
					onClear: function(type)	{
	 ...
	 * @type 
	 */
	var masterGrid1 = Unilite.createGrid('s_pmp141skrv_jwGrid1', {
		...
		columns: [{
			...
			columns: [
				...
				{dataIndex: 'CITEM_LOT_NO'		, width: 100	},
	...
	});		//End of var masterGrid1 = Unilite.createGrid('s_pmp141skrv_jwGrid1', {



	Unilite.Main({
		id: 's_pmp141skrv_jwApp',
		borderItems:[{
			region: 'center',
			layout: 'border',
			border: false,
