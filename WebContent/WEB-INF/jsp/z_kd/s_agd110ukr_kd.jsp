...
<t:appConfig pgmId="s_agd110ukr_kdv"  >
...
function appMain() {
	 ...
	 * @type
	 */     
	var panelSearch = Unilite.createForm('s_agd110ukr_kdvDetail', {
    	disabled :false,
    	flex:1,
		    	...
		    	items:[{
					...
					handler : function() {
						if(panelSearch.setAllFieldsReadOnly(true)){
							...
							s_agd110ukr_kdService.procButton(param, 
					...
					handler : function() {
						if(panelSearch.setAllFieldsReadOnly(true)){
							...
							panelSearch.getEl().mask('로딩중...','loading-indicator');
							s_agd110ukr_kdService.cancButton(param, 
								function(provider, response) {
									if(provider) {	
