...
<t:appConfig pgmId="s_hpa996skr_kd">
...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('s_hpa996skr_kdModel', {
		fields: [
			...
			{name: 'AFFIL_CODE'           ,text: '관리구분코드'               ,type: 'string'},
	 ...
	 * @type 
	 */			
	var masterStore = Unilite.createStore('s_hpa996skr_kdmasterStore',{
		model	: 's_hpa996skr_kdModel',
		uniOpt	: {
		...
		proxy	: {
			type: 'direct',
			api: {			
					read: 's_hpa996skr_kdService.selectList'
			}
		},
...
//            })
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('s_hpa996skr_kdGrid1', {
		store	: masterStore,
		region	: 'center',
		layout	: 'fit',
		uniOpt	: {	
		...
		columns:  [
			...
			{ dataIndex: 'DEPT_CODE'         , width: 110    , hidden: false,
                summaryRenderer:function(value, summaryData, dataIndex, metaData ) {
                    return Unilite.renderSummaryRow(summaryData, metaData, '', '총계');
                }
            },
            { dataIndex: 'DEPT_NAME'            , width: 110, hidden: false  },
            { dataIndex: 'AFFIL_CODE'         , width: 110  , hidden: true  ,
                summaryRenderer:function(value, summaryData, dataIndex, metaData ) {
                    return Unilite.renderSummaryRow(summaryData, metaData, '', '총계');
                }
            },
            { dataIndex: 'AFFIL_NAME'            , width: 110    },
...
// 
            ...
            var groupUrl = "http://gw.kdg.co.kr:8070/approval/legacyGateway.hi?viewMode=docuDraft&prg_no=hpa996skr&draft_no=0&sp=EXEC "
            
                        
            var spText      = 'omegaplus_kdg.unilite.USP_HUMAN_HPA996SKR_fnQuery ' + "'" + compCode + "'" + ', ' + "'" + divCode + "'" 
                            + ', ' + "'" + personnumb + "'"  +', ' + "'" + paymonthfr + "'" +', ' + "'" + paymonthto + "'"
                            + ', ' + "''" + ', ' + "'" + userId + "'" + ', ' + "'ko'" + ', ' + "''";
