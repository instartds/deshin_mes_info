...
<t:appConfig pgmId="s_sbx902skrv_kd"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="s_sbx902skrv_kd"  />             <!-- 사업장 -->  
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 's_sbx902skrv_kdService.selectList'
        }
    });
     ...
     * @type 
     */
    Unilite.defineModel('s_sbx902skrv_kdModel', {
        fields: [
            ...
            {name: 'PRE_STOCK_Q'            ,text:'이월수량'         ,type: 'uniQty'},
     ...
     * @type 
     */                 
    var directMasterStore = Unilite.createStore('s_sbx902skrv_kdMasterStore1',{
        model: 's_sbx902skrv_kdModel',
        uniOpt : {
...
//                            Ext.getCmp('ITEM_ACCOUNT_ID').setDisabled(true);
    ...
    var masterGrid = Unilite.createGrid('s_sbx902skrv_kdmasterGrid', { 
        layout : 'fit',   
        region: 'center',                          
    ...
    Unilite.Main( {
        ...
        requestApprove: function(){     //결재 요청
            ...
            var spText      = 'EXEC omegaplus_kdg.unilite.USP_GW_S_SBX901SKRV_KD ' + "'" + compCode + "'" + ', ' + "'" + divCode + "'" +', ' + "'" + basisDate + "'";
            var spCall      = encodeURIComponent(spText); 
            
//            frm.action = '/payment/payreq.php';
            frm.action   = groupUrl + "viewMode=docuDraft" + "&prg_no=s_sbx902skrv_kd&draft_no=" + '0' + "&sp=" + spCall;
