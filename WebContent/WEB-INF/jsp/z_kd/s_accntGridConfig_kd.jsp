<%@page language="java" contentType="text/html; charset=utf-8"%>
	...
	Unilite.defineModel('accntModel', { 
	    ...
	    fields: [ 
            ...
            ,{name: 'REMARK'            ,text:'적요'              ,type : 'string', allowBlank:false,  maxLength:100 } 
	...
	function getStoreConfig()	{
		var config = {
			...
			,saveStore : function(config)	{	
                ...
                s_agj105ukr_kdService.slipUpdate(param, function(provider, result ) {
                }); 
...
//				,{ dataIndex: ' AP_CHARGE_CODE'    	,width:80}
//				,{ dataIndex: 'DRAFT_YN'    	,width:80}
...
//	    			}
	    			if(e.position.column.dataIndex=='CREDIT_NUM_EXPOS')	{
	    				UniAppManager.app.fnProofKindPopUp(record);
	    				//creditWIn = creditPopup (creditWIn, record, record.get('CREDIT_NUM'), "CREDIT_NUM", null, null, null, null,  'VALUE');			
	    			}	    			
					...
					foreignWindow = Ext.create('widget.uniDetailWindow', {
		                ...
		                onApply:function()	{
							...
							if(!Ext.isEmpty(mUnit) && !Ext.isEmpty(forAmt) &&  !Ext.isEmpty(exRate)) {
								...
								var numDigit = UniFormat.Price.length - UniFormat.Price.indexOf(".");
