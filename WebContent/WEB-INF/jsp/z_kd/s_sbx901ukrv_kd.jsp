...
<t:appConfig pgmId="s_sbx901ukrv_kd"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="s_sbx901ukrv_kd"  />             <!-- 사업장 -->
...
/*     var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 's_sbx901ukrv_kdService.selectList',
            update: 's_sbx901ukrv_kdService.updateDetail',
            create: 's_sbx901ukrv_kdService.insertDetail',
            destroy: 's_sbx901ukrv_kdService.deleteDetail',
            syncAll: 's_sbx901ukrv_kdService.saveAll'
        }
    }); */

    var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 's_sbx901ukrv_kdService.selectList2',
            update: 's_sbx901ukrv_kdService.updateDetail2',
            create: 's_sbx901ukrv_kdService.insertDetail2',
            destroy: 's_sbx901ukrv_kdService.deleteDetail2',
            syncAll: 's_sbx901ukrv_kdService.saveAll2'
        }
    });
     ...
     * @type
     */
/*     Unilite.defineModel('s_sbx901ukrv_kdModel', {
        fields: [
            ...
            {name: 'ORDER_UNIT_O'         ,text:'운송금액'              ,type: 'uniPrice'},
    ...
    Unilite.Excel.defineModel('excel.s_sbx901ukrv_kd.sheet01', {
        fields: [
            ...
            {name: 'SPEC'                , text: '규격'         , type: 'string'},
            {name: 'OWN_TYPE'            , text: '입고유형'          , type: 'string', store: Ext.data.StoreManager.lookup('comboZ0031')},
     ...
     * @type
     */
    Unilite.defineModel('s_sbx901ukrv_kdModel2', {
        fields: [
            {name: 'COMP_CODE'            ,text:'법인코드'              ,type: 'string'},
            {name: 'DIV_CODE'             ,text:'사업장'                ,type: 'string', comboType:'BOR120'},
            {name: 'INOUT_NUM'            ,text:'수불번호'              ,type: 'string'},
            ...
            {name: 'TRNS_RATE'            ,text:'입수'                  ,type: 'uniER'},
            {name: 'ORDER_UNIT_Q'         ,text:'수량'                  ,type: 'uniQty', allowBlank: false},
            {name: 'ORDER_UNIT_P'         ,text:'운송단가'              ,type: 'uniUnitPrice'},
    ...
    Unilite.defineModel('s_sbx901ukrv_kdModel3', {          // 검색 팝업창
        fields: [
            {name: 'DIV_CODE'       , text: '사업장'       , type: 'string', comboType:'BOR120'},
            {name: 'INOUT_CODE'     , text: '거래처코드'   , type: 'string'},
            {name: 'CUSTOM_NAME'    , text: '거래처명'     , type: 'string'},
     ...
     * @type
     */
   /*  var directMasterStore = Unilite.createStore('s_sbx901ukrv_kdMasterStore1',{
        model: 's_sbx901ukrv_kdModel',
        uniOpt : {
...
//                        panelResult.setValue("INOUT_NUM", master.INOUT_NUM);
     ...
     * @type
     */
    var directMasterStore2 = Unilite.createStore('s_sbx901ukrv_kdMasterStore2',{
        model: 's_sbx901ukrv_kdModel2',
        uniOpt : {
            isMaster: true,            // 상위 버튼 연결
            editable: true,            // 수정 모드 사용
            deletable:true,            // 삭제 가능 여부
...
//                        panelResult.setValue("INOUT_NUM", master.INOUT_NUM);
     ...
     * @type
     */
    var directMasterStore3 = Unilite.createStore('s_sbx901ukrv_kdMasterStore3',{
        model: 's_sbx901ukrv_kdModel3',
        uniOpt : {
            isMaster: true,             // 상위 버튼 연결
        ...
        proxy: {
            type: 'direct',
            api: {
                read: 's_sbx901ukrv_kdService.selectList3'
            }
        },
        loadStoreRecords : function()   {
...
//            },
    ...
    /*var masterGrid = Unilite.createGrid('s_sbx901ukrv_kdmasterGrid', {
        layout : 'fit',
        region: 'center',
...
//                            Ext.getCmp('ITEM_ACCOUNT_ID').setDisabled(true);
            ...
            { dataIndex: 'ORDER_UNIT_O'                         ,           width: 80},
...
//          var grdRecord = this.uniOpt.currentRecord;
    ...
    var masterGrid2 = Unilite.createGrid('s_sbx901ukrv_kdmasterGrid2', {
        layout : 'fit',
        region: 'center',
        ...
        columns:  [
            ...
            { dataIndex: 'ITEM_CODE'                            ,           width: 110,
                editor: Unilite.popup('DIV_PUMOK_G', {
                        ...
                        'onClear': function(type) {
                            masterGrid2.setItemData2(null,true, masterGrid2.uniOpt.currentRecord,true);
                        },
                        applyextparam: function(popup){
                            popup.setExtParam({'DIV_CODE': panelResult.getValue('DIV_CODE')});
                            popup.setExtParam({'ITEM_ACCOUNT': '60'});
                ...
                editor: Unilite.popup('DIV_PUMOK_G', {
                        ...
                        listeners: {'onSelected': {
                            fn: function(records, type) {
                                ...
                                Ext.each(records, function(record,i) {
                                    if(i==0) {
                                        masterGrid.setItemData(record,false, masterGrid2.uniOpt.currentRecord);
                                    } else {
                                        UniAppManager.app.onNewDataButtonDown();
                                        masterGrid.setItemData(record,false, masterGrid2.getSelectedRecord());
                                    }
                                });
                            },
                            scope: this
                        ...
                        'onClear': function(type) {
                        	masterGrid2.setItemData2(null,true, masterGrid2.uniOpt.currentRecord,false);
                        },
                        applyextparam: function(popup){
                            popup.setExtParam({'DIV_CODE': panelResult.getValue('DIV_CODE')});
                            popup.setExtParam({'ITEM_ACCOUNT': '60'});
//                            Ext.getCmp('ITEM_ACCOUNT_ID').setDisabled(true);
            ...
            { dataIndex: 'TRNS_RATE'                            ,           width: 80, hidden: true},
            { dataIndex: 'ORDER_UNIT_Q'                         ,           width: 80},
            { dataIndex: 'ORDER_UNIT_P'                         ,           width: 80, hidden: true},
            { dataIndex: 'ORDER_UNIT_O'                         ,           width: 80, hidden: true},
            { dataIndex: 'INOUT_Q'                              ,           width: 80, hidden: true},
            { dataIndex: 'INOUT_P'                              ,           width: 80, hidden: true},
            { dataIndex: 'INOUT_I'                              ,           width: 80, hidden: true},
            { dataIndex: 'INOUT_FOR_P'                          ,           width: 80, hidden: true},
            ...
            beforeedit  : function( editor, e, eOpts ) {
                if(e.record.phantom == true) {
                   if(UniUtils.indexOf(e.field, ['ITEM_STATUS',    'INOUT_PRSN',   'EXCHG_RATE_O', 'MONEY_UNIT',       'PROJECT_NO',   'LOT_NO',
                    ...
                    {
                        return false;
                    } else if(UniUtils.indexOf(e.field, ['INOUT_SEQ',    'REMARK',  'ORDER_UNIT_Q', 'ORDER_UNIT_P', 'TRANS_CUST_CD', 'ITEM_CODE',
                                                         'ORDER_UNIT_O', 'INOUT_Q', 'INOUT_P',      'INOUT_I',  'INOUT_FOR_P',  'INOUT_FOR_O', 'OWN_TYPE', 'INOUT_DATE']))
                    {
                        return true;
                    } else {
                        return false;
                   ...
                   if(UniUtils.indexOf(e.field, ['ITEM_STATUS',    'INOUT_PRSN',   'EXCHG_RATE_O', 'MONEY_UNIT',       'PROJECT_NO',   'LOT_NO',
                                                 'ORDER_UNIT',     'OWN_TYPE',     'TRNS_RATE',    'INOUT_TAX_AMT',    'TAX_TYPE',     'INOUT_TYPE',
                                                 'INOUT_CODE',     'CUSTOM_NAME',  'INOUT_DATE',   'SPEC', 'ITEM_CODE',
                                                 'INSERT_DB_USER',   'INSERT_DB_TIME',   'UPDATE_DB_USER',   'UPDATE_DB_TIME']))
                    {
                        return false;
                    } else if(UniUtils.indexOf(e.field, ['REMARK',  'ORDER_UNIT_Q', 'ORDER_UNIT_P', 'TRANS_CUST_CD',
                                                         'ORDER_UNIT_O', 'INOUT_Q', 'INOUT_P',      'INOUT_I',  'INOUT_FOR_P',  'INOUT_FOR_O']))
                    {
                        return true;
                    } else {
                        return false;
                    ...
                    beforeshow: function( panel, eOpts) {
                       ...
                       /*  var activeTabId = tab.getActiveTab().getId();
                        if(activeTabId == 'tab1') {
                            ...
                            inoutNumSearch.setValue('INOUT_TYPE',   '1');
                        //}
                    }
                }
            })
            ...
            beforetabchange : function(tabPanel, newCard, oldCard, eOpts) {
                ...
                switch(newTabId) {
                    case 'tab1':
                        ...
                        masterGrid.reset();
                        masterGrid2.reset();
                        UniAppManager.setToolbarButtons(['save', 'deleteAll', 'delete'], false);
                        UniAppManager.setToolbarButtons('newData', true);
                        UniAppManager.app.onResetButtonDown();
                     	panelResult.getField("INOUT_DATE_COMMON").setFieldLabel('출고일자');
...
//                        }
                    ...
                    case 'tab2':
                        ...
                        UniAppManager.setToolbarButtons('newData', true);
                        UniAppManager.app.onResetButtonDown();
                     	panelResult.getField("INOUT_DATE_COMMON").setFieldLabel('입고일자');
                        break;
...
//                var moneyUnit          = UserInfo.currency;
                ...
                var customCode         = panelResult.getValue('CUSTOM_CODE');
                var customName         = panelResult.getValue('CUSTOM_NAME');
                var seq                = directMasterStore2.max('INOUT_SEQ');
                    if(!seq) seq = 1;
                    else  seq += 1;
                var inoutType          = '1';
                var inoutDate          = panelResult.getValue('INOUT_DATE');
//                var moneyUnit          = UserInfo.currency;
    ...
    function openExcelWindow() {
        ...
        if(!directMasterStore2.isDirty())  {                                   //화면에 저장할 내용이 있을 경우 저장여부 확인
...
//          excelWindow.extParam.APPLY_YN       = Ext.getCmp('rdoSelect0_0').getChecked()[0].inputValue;
        ...
        if(!excelWindow) {
            ...
            excelWindow = Ext.create( appName, {
                excelConfigName: 's_sbx901ukrv_kd',
                width   : 600,
                height  : 400,
                modal   : false,
                extParam: {
                    'PGM_ID'    : 's_sbx901ukrv_kd'
                ...
                grids: [{                           //팝업창에서 가져오는 그리드
                        ...
                        title       : '엑셀업로드',
                        useCheckbox : true,
                        model       : 'excel.s_sbx901ukrv_kd.sheet01',
                        readApi     : 's_sbx901ukrv_kdService.selectExcelUploadSheet1',
                        columns     : [
