...
<t:appConfig pgmId="s_hat930skr_kd"  >
    <t:ExtComboStore comboType="BOR120"    pgmId="s_hat930skr_kd"/>             <!-- 사업장 -->
</t:appConfig>
<style type="text/css">
...
function appMain() {
     ...
     * @type 
     */
    Unilite.defineModel('s_hat930skr_kdModel', {
        fields: [
     ...
     * @type 
     */                    
    var directMasterStore1 = Unilite.createStore('s_hat930skr_kdMasterStore1',{
            model: 's_hat930skr_kdModel',
            uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {            
                       read: 's_hat930skr_kdServiceImpl.selectList'                    
                }
            }
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('s_hat930skr_kdGrid1', {
        region: 'center',
        layout: 'fit',
        uniOpt:{    
    ...
    Unilite.Main({
        ...
        requestApprove: function(){     //결재 요청
            ...
            var groupUrl = "http://gw.kdg.co.kr:8070/approval/legacyGateway.hi?viewMode=docuDraft&prg_no=hat930skr&draft_no=0&sp=EXEC " 
