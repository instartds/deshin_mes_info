...
<t:appConfig pgmId="s_zaa300skrv_kd"  >
...
var selectedMasterGrid = 's_zaa300skrv_kdGrid'; 
...
function appMain() {
    ...
    var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{     
        api: {
            read: 's_zaa300skrv_kdService.selectList'
        }
    });
    
    var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{     
        api: {
            read: 's_zaa300skrv_kdService.selectList2'
        }
    });
    ...
    Unilite.defineModel('pbs071ukrvsModel', {
        fields: [
            ...
            {name: 'ING_COUNT'         ,text:'진행건'           ,type : 'uniQty'},
            {name: 'END_COUNT'         ,text:'미진행건'         ,type : 'uniQty'}
        ]                   
    });
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('s_zaa300skrv_kdGrid', {
        layout : 'fit',
        region:'center',
        ...
        columns: [
            ...
            {dataIndex: 'PLAN_NUM'            ,       width: 200, hidden: true},
            {dataIndex: 'DEPT_CODE'           ,       width: 110},
            {dataIndex: 'DEPT_NAME'           ,       width: 200},
            {dataIndex: 'ING_COUNT'           ,       width: 100},
            {dataIndex: 'END_COUNT'           ,       width: 100}
        ],
        listeners :{
    ...
    var masterGrid2 = Unilite.createGrid('s_zaa300skrv_kdGrid2', {
        layout : 'fit',
        region:'south',
        title: '미진행건',
        ...
        columns: [
            ...
            {dataIndex: 'PLAN_DATE'              ,       width: 100},
            {dataIndex: 'ITEM_CODE'              ,       width: 110},
            {dataIndex: 'ITEM_NAME'              ,       width: 200},
            {dataIndex: 'SPEC'                   ,       width: 200},
            {dataIndex: 'OEM_ITEM_CODE'          ,       width: 100},
            {dataIndex: 'CAR_TYPE'               ,       width: 200},
            {dataIndex: 'MAKE_DATE'              ,       width: 100},
            {dataIndex: 'SER_NO'                 ,       width: 80},
            {dataIndex: 'PLAN_BIZ1'              ,       width: 150},
            {dataIndex: 'PLAN_BIZ2'              ,       width: 150},
            {dataIndex: 'PLAN_ST_DATE'           ,       width: 100},
            {dataIndex: 'PLAN_END_DATE'          ,       width: 100},
            {dataIndex: 'DEPT_CODE'              ,       width: 110},
            {dataIndex: 'DEPT_NAME'              ,       width: 200},
            {dataIndex: 'REMARK1'                ,       width: 200},
            {dataIndex: 'EXEC_ST_DATE'           ,       width: 100},
            {dataIndex: 'EXEC_END_DATE'          ,       width: 100},
