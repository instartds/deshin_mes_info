...
<t:appConfig pgmId="s_zcc700skrv_kd"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="s_zcc700skrv_kd"  />             <!-- 사업장 -->
...
function appMain() {
    ...
    var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
        api: {
            read    : 's_zcc700skrv_kdService.selectList'
        }
    });
     ...
     * @type 
     */
    Unilite.defineModel('s_zcc700skrv_kdModel', {
        fields: [
            ...
            {name : 'PRODUCT_AMT',          text : '가공단가',         type : 'uniPrice'},
     ...
     * @type 
     */                 
    var directMasterStore = Unilite.createStore('s_zcc700skrv_kdMasterStore1',{
        model: 's_zcc700skrv_kdModel',
        uniOpt : {
...
//        },
        ...
        api : {
            submit: 's_zcc700skrv_kdService.syncForm'                
        },
    ...
    var masterGrid = Unilite.createGrid('s_zcc700skrv_kdmasterGrid', { 
        layout : 'fit',   
        region : 'center',                          
    ...
    Unilite.Main( {
        ...
        requestApprove: function(){     //결재 요청
            ...
            var spText      = 'EXEC omegaplus_kdg.unilite.USP_GW_S_ZCC700SKRV_KD ' + "'" + compCode + "'" + ', ' + "'" + divCode + "'" + ', ' + "'" + frDate + "'" + ', ' + "'" + toDate + "'" + ', ' + "'" + entryNum + "'" + ', ' + "'" + oemItemCode + "'" + ', ' + "'" + deptCode + "'" + ', ' + "'" + closeYN + "'";
            var spCall      = encodeURIComponent(spText); 
            
/* //            frm.action = '/payment/payreq.php';
            frm.action   = groupUrl + "viewMode=docuDraft" + "&prg_no=s_zcc700skrv_kd&draft_no=" + '0' + "&sp=" + spCall;
//            frm.action   = groupUrl + "&prg_no=s_zcc700skrv_kd&draft_no=" + UserInfo.compCode + inoutNum + "&sp=" + spCall + Base64.encode();
            frm.target   = "payviewer"; 
            frm.method   = "post";
            frm.submit(); */
            
            var gwurl = groupUrl + "viewMode=docuDraft" + "&prg_no=s_zcc700skrv_kd&draft_no=" + '0' + "&sp=" + spCall;
