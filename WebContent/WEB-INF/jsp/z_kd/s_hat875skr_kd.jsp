...
<t:appConfig pgmId="s_hat875skr_kd">
...
function appMain() {
     ...
     */
    //1. 기간별 , 2. 월별
    Unilite.defineModel('s_hat875skr_kdModel', {
        fields: [
			...
			{name: 'NIGHT_WORK_TEAM'	,text: '야근여부'		,type: 'string'},
			...
			{name: 'DUTY_NAME'          ,text: '비고'        ,type: 'string'}
        ]
    });
     ...
     */        
    //1. 기간별
    var masterStore1 = Unilite.createStore('s_hat875skr_kdmasterStore11',{
        model    : 's_hat875skr_kdModel',
        uniOpt    : {
        ...
        proxy    : {
            type: 'direct',
            api: {            
                    read: 's_hat875skr_kdService.selectList'
            }
        },
    ...
    //2. 월별
    var masterStore2 = Unilite.createStore('s_hat875skr_kdmasterStore12',{
        model    : 's_hat875skr_kdModel',
        uniOpt    : {
//            isMaster    : true,                // 상위 버튼 연결 
...
//                            dataForm.setValue('S_DEPT_CODE', records[0].DEPT_CODE);
     ...
     */
    //1. 서울
    var masterGrid1 = Unilite.createGrid('s_hat875skr_kdGrid1', {
        store    : masterStore1,
        region    : 'center',
        layout    : 'fit',
        uniOpt    : {    
        ...
        columns:  [
            ...
            { dataIndex: 'NIGHT_WORK_TEAM'  , width: 100    },
            { dataIndex: 'DUTY_NAME'        , width: 90     },
            { dataIndex: 'OUT_TIME'         , width: 90    , hidden: true     },
            { dataIndex: 'IN_TIME'          , width: 90    , hidden: true     },
            { dataIndex: 'DUTY_CODE1'       , width: 90    , hidden: true     },
            { dataIndex: 'DUTY_CODE2'       , width: 90    , hidden: true     },
            { dataIndex: 'DUTY_CODE3'       , width: 90    , hidden: true     },
            { dataIndex: 'DUTY_CODE4'       , width: 90    , hidden: true     }
    ...
    //2. 인천
    var masterGrid2 = Unilite.createGrid('s_hat875skr_kdGrid2', {
        store    : masterStore2,
        region    : 'center',
        layout    : 'fit',
        uniOpt    : {    
    ...
    var tab = Unilite.createTabPanel('s_hat875skr_kdTab',{        
        region        : 'center',
        ...
        listeners:{
            tabchange: function( tabPanel, newCard, oldCard, eOpts )    {
                if(newCard.getItemId() == 's_hat875skr_kdTab1')    {
     ...
     Unilite.Main({
        ...
        onQueryButtonDown : function()    {
            ...
            //1: 서울
            if (activeTab == 's_hat875skr_kdTab1'){
        ...
        requestApprove: function(){     //결재 요청
            ...
            var apply       = Ext.getCmp('apply_yn').getChecked()[0].inputValue
            ...
            //1: 서울
            if (activeTab == 's_hat875skr_kdTab1'){
            	var groupUrl = "http://gw.kdg.co.kr:8070/approval/legacyGateway.hi?viewMode=docuDraft&prg_no=hat870skr_3&draft_no=0&sp=EXEC " 
            	gubun = '1';
            ...
            var spText      = 'omegaplus_kdg.unilite.USP_HUMAN_HAT875SKR_fnQuery ' + "'" + compCode + "'" + ', ' + "'" + divCode + "'" 
