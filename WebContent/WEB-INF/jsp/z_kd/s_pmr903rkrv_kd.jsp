...
<t:appConfig pgmId="s_pmr903rkrv_kd"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_pmr903rkrv_kd"  /> 			<!-- 사업장 -->
</t:appConfig>
<style type="text/css">
    ...
    //                margin: '0 0 0 0',
                ...
                handler : function() {
                    if(panelResult.setAllFieldsReadOnly(true) == false){
                        ...
                        var spText      = 'EXEC omegaplus_kdg.unilite.USP_GW_S_PMR903RKRV_KD ' + "'" + compCode + "'" + ', ' + "'" + divCode + "'" + ', ' + "'" + frDate + "'" + ', ' + "'" + toDate + "'";
                        var spCall      = encodeURIComponent(spText);

     /*        //            frm.action = '/payment/payreq.php';
                        frm.action   = groupUrl + "viewMode=docuDraft" + "&prg_no=s_pmr903rkrv_kd&draft_no=" + '0' + "&sp=" + spCall;
            //            frm.action   = groupUrl + "&prg_no=s_pmr911rkrv_kd&draft_no=" + UserInfo.compCode + inoutNum + "&sp=" + spCall + Base64.encode();
                        frm.target   = "payviewer";
                        frm.method   = "post";
                        frm.submit(); */
                        var gwurl = groupUrl + "viewMode=docuDraft" + "&prg_no=s_pmr903rkrv_kd&draft_no="+ '0' +  "&sp=" + spCall/* + Base64.encode()*/;
