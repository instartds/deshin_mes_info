...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 작업실적 등록
		api: {
			read: 'pmr100ukrvService.selectDetailList'/*,
			update: 'pmr100ukrvService.updateDetail',
			create: 'pmr100ukrvService.insertDetail',
			destroy: 'pmr100ukrvService.deleteDetail',
			syncAll: 'pmr100ukrvService.saveAll'*/
		}
	});

	var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 작업지시별 등록
		api: {
			read: 'pmr100ukrvService.selectDetailList2',
			update: 'pmr100ukrvService.updateDetail2',
			create: 'pmr100ukrvService.insertDetail2',
			destroy: 'pmr100ukrvService.deleteDetail2',
			syncAll: 'pmr100ukrvService.saveAll2'
		}
	});

	var directProxy3 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 공정별 등록1
		api: {
			read: 'pmr100ukrvService.selectDetailList3',
			update: 'pmr100ukrvService.updateDetail3',
			create: 'pmr100ukrvService.insertDetail3',
			destroy: 'pmr100ukrvService.deleteDetail3',
			syncAll: 'pmr100ukrvService.saveAll3'
		}
	});

	var directProxy4 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 공정별 등록2
		api: {
			read: 'pmr100ukrvService.selectDetailList4',
			update: 'pmr100ukrvService.updateDetail4',
			create: 'pmr100ukrvService.insertDetail4',
			destroy: 'pmr100ukrvService.deleteDetail4',
			syncAll: 'pmr100ukrvService.saveAll4'
		}
	});

	var directProxy5 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 불량내역 등록
		api: {
			read: 'pmr100ukrvService.selectDetailList5',
			update: 'pmr100ukrvService.updateDetail5',
			create: 'pmr100ukrvService.insertDetail5',
			destroy: 'pmr100ukrvService.deleteDetail5',
			syncAll: 'pmr100ukrvService.saveAll5'
		}
	});

	var directProxy6 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 특기사항 등록
		api: {
			read: 'pmr100ukrvService.selectDetailList6',
			update: 'pmr100ukrvService.updateDetail6',
			create: 'pmr100ukrvService.insertDetail6',
			destroy: 'pmr100ukrvService.deleteDetail6',
			syncAll: 'pmr100ukrvService.saveAll6'
		}
	});

	var directProxy7 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 20190508 제조이력등록 탭 추가
		api: {
			read	: 'pmr100ukrvService.selectDetailList7',
			update	: 'pmr100ukrvService.updateDetail7',
			create	: 'pmr100ukrvService.insertDetail7',
			destroy	: 'pmr100ukrvService.deleteDetail7',
			syncAll	: 'pmr100ukrvService.saveAll7'
		}
	});

	var directProxy8 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 20190508 제조이력등록 탭 추가
		api: {
			read: 'pmr100ukrvService.selectDetailList8'
		}
	});

	var directProxy10 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 자재불량내역
		api: {
			read: 'pmr100ukrvService.selectDetailList10',
			update: 'pmr100ukrvService.updateDetail10',
			create: 'pmr100ukrvService.insertDetail10',
			destroy: 'pmr100ukrvService.deleteDetail10',
			syncAll: 'pmr100ukrvService.saveAll10'
		}
	});


	var directProxy11 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{		// 작업인원
		api: {
			read: 'pmr100ukrvService.selectDetailList11',
			update: 'pmr100ukrvService.updateDetail11',
			create: 'pmr100ukrvService.insertDetail11',
			destroy: 'pmr100ukrvService.deleteDetail11',
			syncAll: 'pmr100ukrvService.saveAll11'
		}
	});
	...
	var masterForm = Unilite.createSearchPanel('pmr100ukrvMasterForm', {
				...
				listeners: {
					change: function(field, newValue, oldValue, eOpts) {
						...
						var param = {"S_COMP_CODE": UserInfo.compCode,
                         "DIV_CODE": newValue};
						pmr100ukrvService.selectIfSite(param, function(provider, response) {
		...
		/*api: {
			load: 'pmr100ukrvService.selectDetailList',
			submit: 'pmr100ukrvService.syncMaster'
		},
		listeners: {
	...
	Unilite.defineModel('pmr100ukrvDetailModel', {
		fields: [
	...
	var detailStore = Unilite.createStore('pmr100ukrvDetailStore', {
		model: 'pmr100ukrvDetailModel',
		autoLoad: false,
		uniOpt: {
...
//					UniAppManager.app.onResetButtonDown();
	 ...
	 * @type
	 */
	var detailGrid = Unilite.createGrid('pmr100ukrvGrid', {
		store: detailStore,
		layout: 'fit',
		region:'center',
		uniOpt: {
...
//			{dataIndex: 'PJT_CODE'			, width: 133},
			...
			{dataIndex: 'INSPEC_YN'		, width: 0 ,hidden:true},
			{dataIndex: 'WH_CODE'			, width: 0 ,hidden:true},
			{dataIndex: 'BASIS_P'			, width: 0 ,hidden:true},
			{dataIndex: 'DIV_CODE'			, width: 10 ,hidden:true},
			{dataIndex: 'INSPEC_TYPE'	, width: 10 ,hidden:true},
			{dataIndex: 'STD_ITEM_ACCOUNT'	, width: 10},
			{dataIndex: 'ITEM_LEVEL1'	, width: 10 ,hidden:true},
			{dataIndex: 'ITEM_ACCOUNT'	, width: 10 ,hidden:true},
		...
		listeners: {
			...
			selectionchange:function( model1, selected, eOpts ){
				if(selected.length > 0)	{
					...
					if(activeTabId == 'pmr100ukrvGrid2'){
						directMasterStore2.loadStoreRecords();
					} else if(activeTabId == 'pmr100ukrvGrid3_1'){
						directMasterStore3.loadStoreRecords();
					} else if(activeTabId == 'pmr100ukrvGrid5'){
						directMasterStore5.loadStoreRecords();
					} else if(activeTabId == 'pmr100ukrvGrid6'){
	 ...
	 * @type
	 */
	Unilite.defineModel('pmr100ukrvModel2', {  //Pmr100ns3v.htm
		fields: [
	 ...
	 * @type
	 */
	Unilite.defineModel('pmr100ukrvModel3', {  //Pmr100ns1v.htm
		fields: [
	 ...
	 * @type
	 */
	Unilite.defineModel('pmr100ukrvModel4', {  //Pmr100ns1v.htm
		fields: [
	 ...
	 * @type
	 */
	Unilite.defineModel('pmr100ukrvModel5', {
		fields: [
	 ...
	 * @type
	 */
	Unilite.defineModel('pmr100ukrvModel6', {
		fields: [
			{name: 'WKORD_NUM'		,text: '<t:message code="system.label.product.workorderno" default="작업지시번호"/>'		,type:'string'},
			{name: 'PROG_WORK_CODE'	,text: '<t:message code="system.label.product.routingname" default="공정명"/>'			,type:'string', store: Ext.data.StoreManager.lookup('pmr100ukrvProgWordComboStore'), allowBlank:false },
			{name: 'PRODT_DATE'		,text: '<t:message code="system.label.product.occurreddate" default="발생일"/>'			,type:'uniDate', allowBlank:false},
	 ...
	 * @type
	 */
	Unilite.defineModel('pmr100ukrvModel7', {
		fields: [
			//공통정보
	 ...
	 * @type
	 */
	Unilite.defineModel('pmr100ukrvModel8', {
		fields: [
			{name: 'COMP_CODE'		,text: '<t:message code="system.label.product.companycode2" default="회사코드"/>'			,type:'string'},
			{name: 'DIV_CODE'		,text: '<t:message code="system.label.product.division" default="사업장"/>'		,type:'string'},
			...
			{name: 'FR_TIME'		,text: 'Fr작업시간'			,type:'uniTime' , format:'Hi'},
			{name: 'TO_TIME'		,text: 'To작업시간'			,type:'uniTime' , format:'Hi'},
			{name: 'MAN_HOUR'		,text: '<t:message code="system.label.product.inputtime" default="투입공수"/>'			,type:'float', decimalPrecision: 1, format:'0,000.0'},
			{name: 'LUNCH_CHK'      , text: '점심시간제외'       , type: 'boolean'},
	...
	var directMasterStore2 = Unilite.createStore('pmr100ukrvMasterStore2',{
		model: 'pmr100ukrvModel2',
		uniOpt: {
			isMaster: true,			// 상위 버튼 연결
			editable: true,			// 수정 모드 사용
			deletable:true,			// 삭제 가능 여부
...
//				if (saveFlag) {
				...
				var grid = Ext.getCmp('pmr100ukrvGrid2');
	...
	var directMasterStore3 = Unilite.createStore('pmr100ukrvMasterStore3',{
		model: 'pmr100ukrvModel3',
		uniOpt: {
			isMaster	: true,			// 상위 버튼 연결
			editable	: true,			// 수정 모드 사용
				...
				config = {
					...
					success: function(batch, option) {
						...
						if(!Ext.isEmpty(master.PRODT_NUM)) {
							...
							if(directMasterStore11.isDirty()){
								directMasterStore11.saveStore();
							}
...
//						작업실적데이터 MES연동사용시
						if(BsaCodeInfo.gsIfCode == 'Y'){
								...
								pmr100ukrvService.selectInterfaceInfo(param, function(provider, response) {
								var records = response.result;
								if(!Ext.isEmpty(provider)) {
//								Ext.each(records, function(record,i) {
...
//												});
				...
				var grid = Ext.getCmp('pmr100ukrvGrid3');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
...
//				});
	...
	var directMasterStore4 = Unilite.createStore('pmr100ukrvMasterStore4',{
		model: 'pmr100ukrvModel4',
		uniOpt: {
			isMaster	: true,			// 상위 버튼 연결
...
//												});
				...
				var grid = Ext.getCmp('pmr100ukrvGrid4');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
	...
	var directMasterStore5 = Unilite.createStore('pmr100ukrvMasterStore5',{
		model: 'pmr100ukrvModel5',
		uniOpt: {
			isMaster: true,			// 상위 버튼 연결
			editable: true,			// 수정 모드 사용
			deletable:true,			// 삭제 가능 여부
		...
		saveStore : function(config)	{
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('pmr100ukrvGrid5');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
	...
	var directMasterStore6 = Unilite.createStore('pmr100ukrvMasterStore6',{
		model: 'pmr100ukrvModel6',
		uniOpt: {
			isMaster: true,			// 상위 버튼 연결
			editable: true,			// 수정 모드 사용
			deletable:true,			// 삭제 가능 여부
		...
		saveStore : function(config)	{
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('pmr100ukrvGrid6');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
	...
	//20190508 제조이력등록 탭 추가
	var directMasterStore7 = Unilite.createStore('pmr100ukrvMasterStore7',{
		model	: 'pmr100ukrvModel7',
		proxy	: directProxy7,
		uniOpt	: {
			isMaster	: true,		// 상위 버튼 연결
			editable	: true,		// 수정 모드 사용
		...
		saveStore : function(config)	{
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('pmr100ukrvGrid7');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
	...
	var directMasterStore8 = Unilite.createStore('pmr100ukrvMasterStore8',{
	...
	var directMasterStore9 = Unilite.createStore('pmr100ukrvMasterStore9',{
		model: 'pmr100ukrvModel6',
		uniOpt: {
			isMaster: false,			// 상위 버튼 연결
			editable: true,			// 수정 모드 사용
		...
		saveStore : function(config)	{
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('pmr100ukrvGrid9');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
	...
	/***생산 실적 팝업의 작업인원 스토어***/
	var directMasterStore11 = Unilite.createStore('pmr100ukrvMasterStore11',{
		model: 'pmr100ukrvModel8',
		uniOpt: {
			isMaster: false,			// 상위 버튼 연결
			editable: true,			// 수정 모드 사용
			deletable:true,			// 삭제 가능 여부
		...
		saveStore : function(config)	{
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('pmr100ukrvGrid13');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
		...
		_onStoreDataChanged: function( store, eOpts ) {
			...
			if(store.count() == 0){
				if(gsPopupChk == 'WKORD'){
					this.setToolbarButtons(['sub_delete4'], false);
					Ext.apply(this.uniOpt.state, {'btn':{'sub_delete13':false}});
				}else{
					this.setToolbarButtons(['sub_delete11'], false);
					Ext.apply(this.uniOpt.state, {'btn':{'sub_delete14':false}});
				}

			}else {
				if(this.uniOpt.deletable)	{
					if(gsPopupChk == 'WKORD'){
						this.setToolbarButtons(['sub_delete13'], true);
						Ext.apply(this.uniOpt.state, {'btn':{'sub_delete13':true}});
					}else{
						this.setToolbarButtons(['sub_delete14'], true);
						Ext.apply(this.uniOpt.state, {'btn':{'sub_delete14':true}});
					}
		...
		setToolbarButtons: function( btnName, state)	 {
			if(gsPopupChk == 'WKORD'){
				var toolbar = masterGrid13.getDockedItems('toolbar[dock="top"]');
			}else{
				var toolbar = masterGrid14.getDockedItems('toolbar[dock="top"]');
			}
			var obj = toolbar[0].getComponent(btnName);
			if(obj) {
				(state) ? obj.enable():obj.disable();
		...
		fnManHourSum: function() {
			console.log("=============Exec fnManHourSum()");
			var sumManCnt = Ext.isNumeric(this.sum('MAN_CNT')) ? this.sum('MAN_CNT'):0;
			var sumManHour = Ext.isNumeric(this.sum('MAN_HOUR')) ? this.sum('MAN_HOUR'):0;

			if(!Ext.isEmpty(this.min('FR_TIME'))){
				var minTime = this.min('FR_TIME');
			}else{
				var minTime = '';
			}

			if(!Ext.isEmpty(this.max('TO_TIME'))){
				var maxTime = this.max('TO_TIME');
			}else{
				var maxTime = '';
			}

			resultsAddForm.setValue('MAN_CNT', sumManCnt);
			resultsAddForm.setValue('MAN_HOUR', sumManHour);
			resultsAddForm.setValue('FR_TIME', minTime);
			resultsAddForm.setValue('TO_TIME', maxTime);

		}
	});

	/***생산 실적 팝업의 작업인원 스토어***/
	var directMasterStore12 = Unilite.createStore('pmr100ukrvMasterStore12',{
		model: 'pmr100ukrvModel8',
		uniOpt: {
			isMaster: false,			// 상위 버튼 연결
			editable: true,			// 수정 모드 사용
		...
		loadStoreRecords : function()	{
			var param	= masterForm.getValues();
			var record	= masterGrid4.getSelectedRecord();
			if(!Ext.isEmpty(record)) {
				param.PRODT_NUM			= record.get('PRODT_NUM');
			}
			console.log(param);
		...
		saveStore : function(config)	{
			...
			paramMaster.PRODT_NUM = resultsUpdateForm.getValue('PRODT_NUM');
			...
			if(inValidRecs.length == 0) {
				...
				var grid = Ext.getCmp('pmr100ukrvGrid14');
				grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		},
		listeners:{
		...
		_onStoreDataChanged: function( store, eOpts ) {
			...
			if(store.count() == 0){
				if(gsPopupChk == 'WKORD'){
					this.setToolbarButtons(['sub_delete13'], false);
					Ext.apply(this.uniOpt.state, {'btn':{'sub_delete13':false}});
				}else{
					this.setToolbarButtons(['sub_delete14'], false);
					Ext.apply(this.uniOpt.state, {'btn':{'sub_delete14':false}});
				}
		...
		fnManHourSum: function() {
			...
			if(!Ext.isEmpty(this.min('TO_TIME'))){
				var maxTime = this.min('TO_TIME');
			}else{
				var maxTime = '';
			}

			resultsUpdateForm.setValue('MAN_CNT', sumManCnt);
			resultsUpdateForm.setValue('MAN_HOUR', sumManHour);
			resultsUpdateForm.setValue('FR_TIME', minTime);
			resultsUpdateForm.setValue('TO_TIME', maxTime);

		}
	});

	var masterGrid2 = Unilite.createGrid('pmr100ukrvGrid2', {
		layout : 'fit',
		region:'center',
...
//			{dataIndex: 'PJT_CODE'			, width: 93},
	...
	var masterGrid3 = Unilite.createGrid('pmr100ukrvGrid3', {
//		split: true,
		layout	: 'fit',
		region	: 'center',
		flex	: 4,
...
//					activeGridId = girdNm;
	...
	var masterGrid4 = Unilite.createGrid('pmr100ukrvGrid4', {
		split: true,
		layout : 'fit',
		selModel: 'rowmodel',
		region:'center',
...
//              var param = panelResult.getValues();
	...
	var masterGrid5 = Unilite.createGrid('pmr100ukrvGrid5', {
		layout : 'fit',
		region:'center',
	...
	var masterGrid6 = Unilite.createGrid('pmr100ukrvGrid6', {
		layout : 'fit',
		region:'center',
	...
	var masterGrid7 = Unilite.createGrid('pmr100ukrvGrid7', {
		title	: '제조이력등록',
	...
	var masterGrid8 = Unilite.createGrid('pmr100ukrvGrid8', {
		title	: '<t:message code="system.label.product.resultsstatus" default="실적현황"/>',
...
//				var girdNm = grid.getItemId();
	...
	var masterGrid9 = Unilite.createGrid('pmr100ukrvGrid9', {
		layout : 'fit',
		region:'center',
		width:960,
		border:false,
		...
		dockedItems : [{
			...
			items	: [{
				...
				handler	: function() {
					...
					pmr100ukrvService.checkWorkEnd(param, function(provider, response) {
						if(!Ext.isEmpty(provider)){
...
//			userToolbar:false,
	...
	//생산실적 수정 팝업 특기사항 그리드
	var masterGrid11 = Unilite.createGrid('pmr100ukrvGrid11', {
		layout : 'fit',
		region:'center',
		width:960,
		border:false,
	...
	var masterGrid12 = Unilite.createGrid('pmr100ukrvGrid12', {
		store	: directMasterStore10,
		layout	: 'fit',
		region	: 'center',
		border:false,
...
//			userToolbar:false,
	...
	var masterGrid13 = Unilite.createGrid('pmr100ukrvGrid13', {
		layout : 'fit',
		region:'center',
		width:960,
		border:false,
		title : '',
		store : directMasterStore11,
		uniOpt:{	expandLastColumn: false,
					useRowNumberer: false,
					useMultipleSorting: true
		},
		...
		dockedItems : [{
			...
			items	: [{
				...
				handler: function() {
					//if( me._needSave()) {
					var toolbar	= masterGrid13.getDockedItems('toolbar[dock="top"]');
//					var needSave= !toolbar[0].getComponent('sub_save13').isDisabled();
					var record	= detailGrid.getSelectedRecord();
					if (needSave) {
						Ext.Msg.show({
							title	: '<t:message code="system.label.base.confirm" default="확인"/>',
							...
							fn		: function(res) {
								...
								if (res === 'yes' ) {
									...
									directMasterStore11.loadStoreRecords();
								}
							}
						});
					} else {
						directMasterStore11.loadStoreRecords(record.get('PRODT_NUM'));
					}
				}
			},{
				xtype	: 'uniBaseButton',
							...
							Ext.Msg.show({
								...
								fn: function(res) {
									...
									if (res === 'yes' ) {
											...
											masterGrid13.reset();
											directMasterStore11.clearData();
//											directMasterStore11.setToolbarButtons('sub_save13', false);
											directMasterStore11.setToolbarButtons('sub_delete13', false);
									}
								}
							});
					} else {
...
//							directMasterStore11.setToolbarButtons('sub_save13', false);
				...
				handler: function() {
					...
					var remark			= '';
					 var seq = 0;
					 seq = directMasterStore11.max('SEQ');
				...
				itemId		: 'sub_delete13',
				handler	: function() {
					var selRow = masterGrid13.getSelectedRecord();
					if(!Ext.isEmpty(selRow)) {
						if(selRow.phantom == true) {
							masterGrid13.deleteSelectedRow();
						}else if(confirm('<t:message code="system.message.base.confirm001" default="현재행을 삭제 합니다. 삭제 하시겠습니까?"/>')) {
							masterGrid13.deleteSelectedRow();
						}
					} else {
		...
		columns: [
            ...
            {dataIndex: 'MAN_CNT'			, width: 100},
			{dataIndex: 'FR_TIME'			, width: 120, align:'center'
				,editor: {
					xtype: 'timefield',
					format: 'H:i',
				//	submitFormat: 'Hi', //i tried with and without this config
			...
			{dataIndex: 'TO_TIME'			, width: 120, align:'center'
				,editor: {
					xtype: 'timefield',
					format: 'H:i',
				//	submitFormat: 'Hi', //i tried with and without this config
			...
			{dataIndex: 'LUNCH_CHK'                  , width:85, xtype: 'checkcolumn'
				,listeners:{
					beforecheckchange: function( CheckColumn, rowIndex, checked, record, e, eOpts ) {
						var grdRecord = directMasterStore11.getAt(rowIndex);
                    	if(grdRecord.phantom == false){
                    		return false;
                    	}
			        },
                    checkchange: function( CheckColumn, rowIndex, checked, eOpts ){
                    	...
                    	if(checked == true){
                    		...
                    		if((grdRecord.get('TO_TIME') >= panelResult.getValue('GS_TO_TIME')) && (grdRecord.get('FR_TIME')  <=  panelResult.getValue('GS_FR_TIME'))){
	                        	  diffTime = diffTime - 1;
	                        	  var manCnt = grdRecord.get('MAN_CNT');
	                        	  var manHour = Math.floor(manCnt * diffTime * 100)/100
								  grdRecord.set('MAN_HOUR', manHour);
                    		}
...
//				}
	...
	var masterGrid14 = Unilite.createGrid('pmr100ukrvGrid14', {
		layout : 'fit',
		region:'center',
		width:960,
		border:false,
		store : directMasterStore12,
		uniOpt:{	expandLastColumn: false,
					useRowNumberer: false,
					useMultipleSorting: true
		},
		...
		dockedItems : [{
			...
			items	: [{
				...
				handler: function() {
					//if( me._needSave()) {
					var toolbar	= masterGrid14.getDockedItems('toolbar[dock="top"]');
//					var needSave= !toolbar[0].getComponent('sub_save14').isDisabled();
					var record	= detailGrid.getSelectedRecord();
					if (needSave) {
						Ext.Msg.show({
							title	: '<t:message code="system.label.base.confirm" default="확인"/>',
							...
							fn		: function(res) {
								...
								if (res === 'yes' ) {
									var saveTask =Ext.create('Ext.util.DelayedTask', function(){
										directMasterStore12.saveStore();
									});
									saveTask.delay(500);
								} else if(res === 'no') {
									directMasterStore12.loadStoreRecords();
								}
							}
						});
					} else {
						directMasterStore12.loadStoreRecords(record.get('PRODT_NUM'));
					}
				}
			},{
				xtype	: 'uniBaseButton',
							...
							Ext.Msg.show({
								...
								fn: function(res) {
									...
									if (res === 'yes' ) {
											...
											masterGrid14.reset();
											directMasterStore12.clearData();
//											directMasterStore12.setToolbarButtons('sub_save14', false);
											directMasterStore12.setToolbarButtons('sub_delete14', false);
									}
								}
							});
					} else {
...
//							directMasterStore12.setToolbarButtons('sub_save14', false);
				...
				width	: 26,
				height	: 26,
				itemId	: 'sub_newData14',
				handler: function() {
					var record = masterGrid4.getSelectedRecord();
					var divCode		= masterForm.getValue('DIV_CODE');
					var prodtNum		= resultsUpdateForm.getValue('PRODT_NUM');
					var prodtDate		= record.get('PRODT_DATE');
					var manCnt			= '';
					var manHour	        = '';
					var remark			= '';
					 var seq = 0;
					 seq = directMasterStore12.max('SEQ');
				...
				itemId		: 'sub_delete14',
				handler	: function() {
					var selRow = masterGrid14.getSelectedRecord();
					if(!Ext.isEmpty(selRow)) {
						if(selRow.phantom == true) {
							masterGrid14.deleteSelectedRow();
						}else if(confirm('<t:message code="system.message.base.confirm001" default="현재행을 삭제 합니다. 삭제 하시겠습니까?"/>')) {
							masterGrid14.deleteSelectedRow();
						}
					} else {
		...
		columns: [
			...
			{dataIndex: 'LUNCH_CHK'                  , width:85, xtype: 'checkcolumn'
				,listeners:{
					beforecheckchange: function( CheckColumn, rowIndex, checked, record, e, eOpts ) {
						var grdRecord = directMasterStore12.getAt(rowIndex);
                    	if(grdRecord.phantom == false){
                    		return false;
                    	}
			        },
		...
		if(!outouProdtSave) {
			outouProdtSave = Ext.create('widget.uniDetailWindow', {
				...
				tbar:  ['->',
					...
					handler: function() {
						var activeTabId = tab.getActiveTab().getId();
						if(activeTabId == 'pmr100ukrvGrid2') {	// 작업지시별 등록
...
//											 	allowBlank:false,
		    	...
		    	layout:{type:'vbox', align:'stretch'},
		    	items:[masterGrid10],
		    	id: 'pmr100ukrvGrid10_tab2'
		    },{
		    	title: '작업인원',
		    	xtype:'container',
		    	id: 'pmr100ukrvGrid13_tab2',
		    	width:1010,
		    	height:480,
		    	layout:{type:'vbox', align:'stretch'},
		    	items:[	masterGrid13]
...
//				UniAppManager.setToolbarButtons(['newData', 'delete'], false);
		      ...
		      if(!Ext.isEmpty(record)) {
					...
					}else if(newTabId == 'pmr100ukrvGrid13_tab2'){
						if(directMasterStore11.getCount() == 0){
						directMasterStore11.loadStoreRecords(record);
						Ext.getCmp('resultsAddSetBtn').setDisabled(false);
						}
						//UniAppManager.setToolbarButtons(['newData'], true);
					}else{
			...
			resultsAddWindow = Ext.create('widget.uniDetailWindow', {
				...
				tbar:  ['->', {
						...
						if(Ext.isEmpty(resultsAddForm.getValue('WORK_Q'))|| resultsAddForm.getValue('WORK_Q') == 0) {
							tab2.setActiveTab('pmr100ukrvGrid9_tab1');
						}
						...
						handler: function() {
							...
							masterGrid13.reset();
							directMasterStore11.commitChanges();
							masterGrid14.reset();
							directMasterStore12.commitChanges();
						},
						disabled: false
					}
				],
				listeners: {
					...
					beforeshow: function( panel, eOpts )	{
						...
						//Ext.getCmp('pmr100ukrvGrid9_tab1').setValue('LUNCH_CHK1', 'Y');
					}
				}
			})
		}
...
//		 					defaults: { padding: '-3 0 0 0'},
			        	...
			        	{	title: '<t:message code="system.label.product.specialremarkentry" default="특기사항등록"/>',
					    	...
					    	layout:{type:'vbox', align:'stretch'},
					    	items:[masterGrid12],
					    	id: 'pmr100ukrvResult_tab3'
				    	},{
					    	title: '작업인원',
					    	xtype:'container',
					    	id: 'pmr100ukrvResult_tab4',
					    	width:1010,
					    	height:480,
					    	layout:{type:'vbox', align:'stretch'},
					    	items:[masterGrid14]
...
//					UniAppManager.setToolbarButtons(['newData', 'delete'], false);
					...
					var record		= detailGrid.getSelectedRecord();
			      if(!Ext.isEmpty(record)) {
						if(newTabId == 'pmr100ukrvResult_tab2'){
							directMasterStore9.loadStoreRecords(record);
							Ext.getCmp('resultsUpdateSetBtn').setDisabled(true);
							//UniAppManager.setToolbarButtons(['newData'], true);
						}else if(newTabId == 'pmr100ukrvResult_tab3'){
							var badQtyArray = new Array();
							badQtyArray = gsBadQtyInfo.split(',');
							var badRemarkArray = new Array();
							if(!Ext.isEmpty(badRemarkArray)){
						...
						}else if(newTabId == 'pmr100ukrvResult_tab4'){
							if(directMasterStore12.getCount() == 0){
							directMasterStore12.loadStoreRecords(record);
							Ext.getCmp('resultsUpdateSetBtn').setDisabled(false);
							}
							//UniAppManager.setToolbarButtons(['newData'], true);
						}else{
				...
				resultsUpdateWindow = Ext.create('widget.uniDetailWindow', {
					...
					tbar:  ['->', {
							...
							//if(!UniAppManager.app.checkForNewDetail()) return false;
								...
								if(activeTabId == 'pmr100ukrvResult_tab1'){
									var param = {
									  ...
									  pmr100ukrvService.updateProductionResultRemark(param , function(provider, response){
										  if(provider){
	...
	/* 									resultsUpdateForm.clearForm();
										...
										masterGrid12.reset();
										directMasterStore10.commitChanges(); */
								}else if(activeTabId == 'pmr100ukrvResult_tab3'){
									if(directMasterStore10.isDirty()){
										var selectDetailRecord = detailGrid.getSelectedRecord();
										var param = {
											'DIV_CODE' : selectDetailRecord.get('DIV_CODE'),
								...
								}else if(activeTabId == 'pmr100ukrvResult_tab4'){
									if(directMasterStore12.isDirty()){
										var selectDetailRecord = detailGrid.getSelectedRecord();
										var param = {
											'DIV_CODE' : selectDetailRecord.get('DIV_CODE'),
											'WKORD_NUM' : selectDetailRecord.get('WKORD_NUM'),
					...
					listeners: {
						...
						beforeshow: function( panel, eOpts )	{
							...
							masterGrid14.reset();
							directMasterStore12.commitChanges();
							tab3.setActiveTab('pmr100ukrvResult_tab1');
	...
	var refItemProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'pmr100ukrvService.selectRefItem'
		}
	});
...
// 			param.WK_PLAN_NUM = records.get('WK_PLAN_NUM');    작업지시번호로 변경함
	...
	var refItemGrid = Unilite.createGrid('refItemGrid', {
		...
		selModel:'rowmodel',
		columns: [
			{ dataIndex: 'WH_CODE'				, width:  70 },
			{ dataIndex: 'WH_NAME'				, width: 110 },
	...
	Unilite.Main( {
		...
		onDeleteDataButtonDown: function() {
			...
			if(!Ext.isEmpty(selectedDetailGrid)) {
				...
				} else if(activeTabId == 'pmr100ukrvGrid3_1') {	//masterGrid3은 삭제로직 없음, masterGrid4가 삭제
				...
				} else if(activeTabId == 'pmr100ukrvGrid7_1') {
			...
			pmr100ukrvService.checkWorkEnd(param, function(provider, response) {
				if(!Ext.isEmpty(provider)){
					if(provider.WORK_END_YN == 'Y'){
						...
						} else if(activeTabId == 'pmr100ukrvGrid3_1') {				// 공정별 등록
						...
						} else if(activeTabId == 'pmr100ukrvGrid5') {	// 불량내역 등록
							masterForm.setValue('RESULT_TYPE', "3");
							directMasterStore5.saveStore();
						} else if(activeTabId == 'pmr100ukrvGrid6') {	// 특기사항 등록
							masterForm.setValue('RESULT_TYPE', "4");
							directMasterStore6.saveStore();
						} else if(activeTabId == 'pmr100ukrvGrid7_1') {	// 제조이력등록
...
/* 						if(Ext.isEmpty(record.get('MAN_CNT'))){
	...
	Unilite.createValidator('validator11', {
		store: directMasterStore12,
		grid: masterGrid14,
		validate: function( type, fieldName, newValue, oldValue, record, eopt) {
			console.log('validate >>> ', {'type':type, 'fieldName':fieldName, 'newValue':newValue, 'oldValue':oldValue, 'record':record});
