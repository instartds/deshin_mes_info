...
function appMain() {
	 ...
	 * @type 
	 */
	var directMasterStore1 = Unilite.createStore('pmr355skrvMasterStore1',{
		...
		proxy	: {
			type: 'direct',
			api: {
				read: 'pmr355skrvService.selectList'
			}
		},
	 ...
	 * @type 
	 */
	var masterGrid1 = Unilite.createGrid('pmr355skrvGrid1', {
...
//				'x-change-cell_light', 'x-change-cell_normal', 'x-change-cell_dark'
	...
	});	//End ofvar masterGrid1 = Unilite.createGrid('pmr355skrvGrid1', {
