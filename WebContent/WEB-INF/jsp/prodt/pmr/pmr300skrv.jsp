...
function appMain() {     
	 ...
	 * @type 
	 */
	Unilite.defineModel('Pmr300skrvModel', {
	    fields: [  	  
	 ...
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('pmr300skrvMasterStore1',{
		model: 'Pmr300skrvModel',
		uniOpt: {
        ...
        proxy: {
           type: 'direct',
            api: {			
                read: 'pmr300skrvService.selectList'                	
            }
        },
		...
		items: [{	
		    ...
		    items: [{
				...
				onStartDateChange: function(field, newValue, oldValue, eOpts) {
	                	if(topSearch) {
							topSearch.setValue('PRODT_END_DATE_FR',newValue);
				    ...
				    onEndDateChange: function(field, newValue, oldValue, eOpts) {
				    	if(topSearch) {
				    		topSearch.setValue('PRODT_END_DATE_TO',newValue);
    ...
    var masterGrid1 = Unilite.createGrid('pmr300skrvGrid1', {
    	layout : 'fit',
    	region:'center',
...
/*        tbar: [{
        ...
        columns: [        
			...
			{dataIndex: 'OUT_METH'        	, width: 80, locked: true}, 				
			{dataIndex: 'RESULT_YN'       	, width: 80, locked: true}, 				
