...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read: 'mro100ukrvService.selectDetailList',
			update: 'mro100ukrvService.updateDetail',
			create: 'mro100ukrvService.insertDetail',
			destroy: 'mro100ukrvService.deleteDetail',
			syncAll: 'mro100ukrvService.saveAll'
		}
	});
	 ...
	 * @type
	 */
	Unilite.defineModel('mro100ukrvModel', {
	    fields: [
	 ...
	 * @type
	 */
	var directMasterStore1 = Unilite.createStore('mro100ukrvMasterStore1',{
		model: 'mro100ukrvModel',
		uniOpt: {
		...
		saveStore: function() {
			...
			if(inValidRecs.length == 0) {
                ...
                var grid = Ext.getCmp('mro100ukrvGrid1');
...
//				 alert(Msg.sMB083);
	...
	var panelSearch = Unilite.createSearchPanel('searchForm',{
		...
		items: [{
		    ...
		    items: [{
		    	...
		    	Unilite.popup('TREE_CODE',{ // 20210824 수정: 공구코드 팝업창 정규화
     ...
     * @type
     */
    var masterGrid1 = Unilite.createGrid('mro100ukrvGrid1', {
    	layout : 'fit',
    	region:'center',
        ...
        columns: [
			...
			{dataIndex: 'REQ_YYYYMM'      	, width: 80,hidden:true},
			{dataIndex: 'REQ_DATE'      	, width: 80},
			{dataIndex: 'TREE_CODE'      	, width: 120,
        		editor: Unilite.popup('TREE_CODE_G', {
					...
					listeners: {
						'onSelected': {
							fn: function(records, type) {
								...
								record.set("TREE_CODE",records[0].TREE_CODE);
								record.set("TREE_NAME",records[0].TREE_NAME);
								record.set("SPEC",records[0].SPEC);
								record.set("REQ_P",records[0].BASE_P);
							},
							scope: this
						},
						'onClear': function(type) {
							var record=masterGrid1.uniOpt.currentRecord;
							record.set("TREE_CODE",'');
							record.set("TREE_NAME",'');
							record.set("SPEC",'');
							record.set("REQ_P",0);
						},
			...
			{dataIndex:'WORKSHOP'					, width: 100 ,hidden:true,
...
//						width : 1000,
		...
		confirmSaveData: function(config)	{
			var fp = Ext.getCmp('mro100ukrvFileUploadPanel');
