...
function appMain() {     
    var panelDetail = Ext.create('Ext.panel.Panel', {
	    ...
	    items : [{ 
	    	...
	    	collapsible:true,
	    	items: [
				{xtype:'ConfigCodeGrid', subCode:'P002', codeName:'<t:message code="system.label.product.specialremarkclass" default="특기사항 분류"/>'},
	 ...
	 Unilite.Main( {
		...
		onQueryButtonDown : function()	{	
			var activeTab = panelDetail.down('#pbs050Tab').getActiveTab();
