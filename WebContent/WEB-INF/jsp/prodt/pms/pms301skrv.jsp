...
<t:appConfig pgmId="pms301skrv"  >
	...
	<t:ExtComboStore comboType="AU" comboCode="Z003" /> <!-- 검사자 -->
</t:appConfig>
<style type="text/css">
...
function appMain() {     
	 ...
	 * @type 
	 */
	Unilite.defineModel('Pms301skrvModel', {
	    fields: [  	 
	 ...
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('pms301skrvMasterStore1',{
		model: 'Pms301skrvModel',
		uniOpt: {
        ...
        proxy: {
            type: 'direct',
            api: {			
                read: 'pms301skrvService.selectList'                	
            }
        },
...
/*		,groupField: 'ITEM_NAME'*/
		...
		items: [{	
		    ...
		    items: [{
				...
				onStartDateChange: function(field, newValue, oldValue, eOpts) {
				    ...
				    onEndDateChange: function(field, newValue, oldValue, eOpts) {
				    	if(topSearch) {
				    		topSearch.setValue('RECEIPT_DATE_TO',newValue);
				    		//panelResult.getField('ISSUE_REQ_DATE_TO').validate();				    		
				    	}
				    }
			},{ 
			    ...
			    listeners: {
						change: function(field, newValue, oldValue, eOpts) {						
							topSearch.setValue('TOT_RECEIPT_Q', newValue);
						}
					}
			}]
		}],
    ...
    var masterGrid1 = Unilite.createGrid('pms301skrvGrid1', {
    	layout : 'fit',
    	region:'center',
        ...
        columns: [        
			...
			{dataIndex:'ITEM_NAME'  	, width: 106}, 
			{dataIndex:'SPEC'           , width: 133}, 
			{dataIndex:'PRODT_Q'        , width: 106 , summaryType: 'sum'}, 
	...
	Unilite.Main( {
		...
		fnInitBinding: function() {
			...
			topSearch.setValue('PRODT_DATE_FR', UniDate.get('startOfMonth'));
			topSearch.setValue('RECEIPT_DATE_FR', UniDate.get('startOfMonth'));
			...
			topSearch.setValue('PRODT_DATE_TO', UniDate.get('today'));
			topSearch.setValue('RECEIPT_DATE_TO', UniDate.get('today'));
			topSearch.setValue('INSPEC_DATE_TO', UniDate.get('today'));
