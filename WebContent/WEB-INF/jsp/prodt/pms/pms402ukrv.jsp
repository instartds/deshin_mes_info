...
var selectedMasterGrid = 'pms402ukrvGrid';
...
var activeGridId = 'pms402ukrvGrid';
// var output ='';
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read	: 'pms402ukrvService.selectMaster',
			update	: 'pms402ukrvService.updateDetail',
			create	: 'pms402ukrvService.insertDetail',
			destroy	: 'pms402ukrvService.deleteDetail',
			syncAll	: 'pms402ukrvService.saveAll'
		}
	});

	var directProxy2 = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read	: 'pms402ukrvService.selectDetail',
			update	: 'pms402ukrvService.updateDetail2',
			create	: 'pms402ukrvService.insertDetail2',
			destroy	: 'pms402ukrvService.deleteDetail2',
			syncAll	: 'pms402ukrvService.saveAll2'
		}
	});



	var masterForm = Unilite.createSearchPanel('pms402ukrvMasterForm', {
	 ...
	 * @type
	 */
	Unilite.defineModel('pms402ukrvDetailModel', {
		fields: [
	...
	Unilite.defineModel('pms402ukrvDetailModel2', {
		fields: [
	...
	var detailStore = Unilite.createStore('pms402ukrvDetailStore', {
		model: 'pms402ukrvDetailModel',
		autoLoad: false,
		uniOpt: {
	...
	var detailStore2 = Unilite.createStore('pms402ukrvDetailStore2', {
		model: 'pms402ukrvDetailModel2',
		autoLoad: false,
		uniOpt: {
			isMaster	: false,	// 상위 버튼 연결
			editable	: true,		// 수정 모드 사용
...
//			var param= param.data.items[0];
	...
	var detailGrid = Unilite.createGrid('pms402ukrvGrid', {
		layout: 'fit',
		region:'center',
		uniOpt: {
...
//			grdRecord.set('INSPEC_PRSN'			, record['INSPEC_PRSN']);
	...
	var detailGrid2 = Unilite.createGrid('pms402ukrvGrid2', {
		layout: 'fit',
		region:'south',
		uniOpt: {
			expandLastColumn: false,
...
//		trackResetOnLoad: true,
	...
	var checkNoMasterStore = Unilite.createStore('checkNoMasterStore', {
			...
			proxy: {
				type: 'direct',
				api: {
					read : 'pms402ukrvService.selectOrderNumMasterList'
				}
			},
			loadStoreRecords : function()	{
	...
	var checkNoMasterGrid = Unilite.createGrid('pms402ukrvcheckNoMasterGrid', {
		// title: '기본',
		layout : 'fit',
...
//			{ dataIndex: 'PJT_CODE'			, width: 100 }
	...
	// 접수 참조 모델 정의
	Unilite.defineModel('pms402ukrvProductionModel', {
		fields: [
	...
	// 접수 참조 스토어 정의
	var productionStore = Unilite.createStore('pms402ukrvProductionStore', {
		model: 'pms402ukrvProductionModel',
		autoLoad: false,
		uniOpt : {
			isMaster: false,	// 상위 버튼 연결
			editable: false,	// 수정 모드 사용
		...
		proxy: {
			type: 'direct',
			api: {
				read : 'pms402ukrvService.selectEstiList'
			}
		},
		loadStoreRecords : function()	{
	...
	var productionGrid = Unilite.createGrid('pms402ukrvproductionGrid', {
...
//		productionSearch.setValue('LOT_NO'			, masterForm.getValue('LOT_NO'));
	...
	Unilite.Main({
		...
		onNewDataButtonDown: function() {
			if(activeGridId == 'pms402ukrvGrid' )	{
	...
	//					GOODBAD_TYPE: '01'
		...
		onDeleteDataButtonDown: function() {
			if(selectedMasterGrid == 'pms402ukrvGrid')	{
