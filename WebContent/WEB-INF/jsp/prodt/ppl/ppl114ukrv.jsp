...
<t:appConfig pgmId="ppl114ukrv"  >
    <t:ExtComboStore comboType="BOR120"  pgmId="ppl114ukrv"  />             <!-- 사업장 -->
...
function appMain() {
	...
	var directProxyMaster = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            read: 'ppl114ukrvService.selectMaster',
//            create: 'ppl114ukrvService.insertMaster',
            update: 'ppl114ukrvService.updateMaster',
//            destroy: 'ppl114ukrvService.deleteMaster',
            syncAll: 'ppl114ukrvService.saveAllMaster'
        }
    }); 
 ...
 // 검색 스토어(디테일)
    ...
    var sub1Store = Unilite.createStore('sub1Store', {
        ...
        proxy: {
            type: 'direct',
            api: {
                read: 'ppl114ukrvService.selectSub1'
            }
        },
...
//            panelResult.setValue('DVRY_DATE_TO',UniDate.get('todayForMonth'));
            ...
            panelResult.setValue('WORK_SHOP_CODE','WS100');
...
/*				'editor' : Unilite.popup('EQU_MACH_CODE_G',{
			...
			{dataIndex: 'CUSTOM_NAME'       , width: 100,lockable : true, locked:true,style: {textAlign: 'center' }	},
			{dataIndex: 'ITEM_NAME'     	, width: 100,lockable : true, locked:true,style: {textAlign: 'center' }	}, 
...
//								grdRecord.set('EQUIP_NAME', '');
			...
			{dataIndex: 'ITEM_CODE'     	, width: 65,lockable : true, locked:true,style: {textAlign: 'center' }}, 
			...
			{dataIndex: 'PRODT_MTRL'     	, width: 65,lockable : true, locked:true,style: {textAlign: 'center' }	}, 
			{dataIndex: 'ITEM_COLOR'     	, width: 65,lockable : true, locked:true,style: {textAlign: 'center' }	},
			{
				text: '후가공',
		        width: 50,
				align: 'center',
