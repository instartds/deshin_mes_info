...
function appMain() {
	...
	Ext.define('ppl116ukrvModel', {
     ...
     var eventStore = Unilite.createStore('ppl116ukrvStore',{
    	 model:'ppl116ukrvModel',
         proxy: {
             type: 'uniDirect',
             api: {
                 read: ppl116ukrvService.getEventList,
                 update : ppl116ukrvService.updateDetail
             }
         },
         listeners:{
        	 load : function(store)	{
     ...
     Unilite.defineModel('ppl116ukrvModel1', {
         fields: [
     ...
     var holidaysStore = Unilite.createStore('ppl116ukrvholidaysStore',{
    	 model:'ppl116ukrvModel1',
         proxy: Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
     		api: {
    			read: 'ppl116ukrvService.selectHolydayList'
    		}
    	 }), 
    ...
    var panelSearch = Unilite.createSearchForm('ppl116ukrvForm', {
		   region: 'north',
		   xtype: 'container',
