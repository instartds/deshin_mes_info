...
<t:appConfig pgmId="pmp282ukrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="pmp282ukrv" />	<!-- 사업장 -->
...
function appMain() {
	...
	var pop2Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api: {
			read	: 'pmp282ukrvService.pop2SelectList',
			create	: 'pmp282ukrvService.insertPop2',
			update	: 'pmp282ukrvService.updatePop2',
//			destroy	: 'pmp282ukrvService.deleteDetail',
			syncAll	: 'pmp282ukrvService.savePop2'
		}
	});
	var pop1_2Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api: {
			read	: 'pmp282ukrvService.pop1_2SelectList',
//			create	: 'pmp282ukrvService.insertPop2',
//			update	: 'pmp282ukrvService.updatePop2',
			destroy	: 'pmp282ukrvService.deletePop1_2',
			syncAll	: 'pmp282ukrvService.savePop1_2'
		}
	});
...
//			{name: 'AA1'			,text: '<t:message code="system.label.product.seq" default="순번"/>' 			,type: 'int'},
	...
	var detailStore = Unilite.createStore('detailStore',{
		...
		proxy: {
			type: 'direct',
			api: {
				read: 'pmp282ukrvService.selectList'
			}
		},
		autoLoad: false,
		uniOpt: {
...
//			comboCode:'B013'
	...
	var pop1Store = Unilite.createStore('pop1Store', {
		...
		proxy: {
			type: 'direct',
			api: {
				read: 'pmp282ukrvService.pop1SelectList'
			}
		},
		loadStoreRecords: function() {
			var param = panelSearch.getValues();
	...
	//							selectedRecord.set('INOUT_Q',pop2Search.getValue('OUTSTOCK_JAN_Q'));
								...
								if(! Ext.isEmpty(scanYn)){
										...
										var param = {
						  				...
						  				pmp282ukrvService.getJanOutstockReqQ(param, function(provider, response) {
