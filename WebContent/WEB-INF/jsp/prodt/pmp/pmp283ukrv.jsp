...
<t:appConfig pgmId="pmp283ukrv"  >
	<t:ExtComboStore comboType="BOR120" pgmId="pmp283ukrv" />	<!-- 사업장 -->
...
function appMain() {
	...
	var pop2Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api: {
			read	: 'pmp283ukrvService.pop2SelectList',
			create	: 'pmp283ukrvService.insertPop2',
			update	: 'pmp283ukrvService.updatePop2',
//			destroy	: 'pmp283ukrvService.deleteDetail',
			syncAll	: 'pmp283ukrvService.savePop2'
		}
	});
	var pop1_2Proxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy', {
		api: {
			read	: 'pmp283ukrvService.pop1_2SelectList',
//			create	: 'pmp283ukrvService.insertPop2',
//			update	: 'pmp283ukrvService.updatePop2',
			destroy	: 'pmp283ukrvService.deletePop1_2',
			syncAll	: 'pmp283ukrvService.savePop1_2'
		}
	});
...
//			{name: 'AA1'			,text: '<t:message code="system.label.product.seq" default="순번"/>' 			,type: 'int'},
			...
			{name: 'GUBUN'			,text: '출고상태' 			,type: 'string'},
	...
	var detailStore = Unilite.createStore('detailStore',{
		...
		proxy: {
			type: 'direct',
			api: {
				read: 'pmp283ukrvService.selectList'
			}
		},
		autoLoad: false,
		uniOpt: {
...
//			comboCode:'B013'
	...
	var pop1Store = Unilite.createStore('pop1Store', {
		...
		proxy: {
			type: 'direct',
			api: {
				read: 'pmp283ukrvService.pop1SelectList'
			}
		},
		loadStoreRecords: function() {
			var param = panelSearch.getValues();
...
//							selectedRecord.set('INOUT_Q',pop2Search.getValue('OUTSTOCK_JAN_Q'));
							...
							var param = {
			  				...
			  				pmp283ukrvService.getJanOutstockReqQ(param, function(provider, response) {
