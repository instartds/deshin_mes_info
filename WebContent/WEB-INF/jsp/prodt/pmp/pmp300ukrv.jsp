...
var activeGrid='pmp300ukrvGridTab';
...
//----- 2023.01.30 Dongsoo Park - (설비일상점검내역 Tab추가작업) Start------- //
	Unilite.defineModel('pmp300ukrvMasterModel', {
	    fields: [
 ...
 var MasterStore = Unilite.createStore('pmp300ukrvMasterStore', {
	    model: 'pmp300ukrvMasterModel',
		autoLoad: false,
		uniOpt: {
...
//저장프로세스
     	saveStore: function() {
			...
			if(inValidRecs.length == 0) {
                ...
                var grid = Ext.getCmp('pmp300ukrvGrid');
                grid.uniSelectInvalidColumnAndAlert(inValidRecs);
			}
		}
	});

	var MasterGrid = Unilite.createGrid('pmp300ukrvGrid', {
