...
<%
//일일근태내역 조회
request.setAttribute("PKGNAME","Unilite_app_gcd300skrv");
%>
<t:appConfig pgmId="gcd300skrv"  >
...
//	});
	...
	Unilite.defineModel('${PKGNAME}model', {
	    fields: [{name: 'COMP_CODE'                    	,text:'법인코드'			,type : 'string' }
	    		...
	    		,{name: 'OPERATION_COUNT'              	,text:'순번'				,type : 'int' }
        ...
        model: '${PKGNAME}model',
         autoLoad: false,
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read : 'gcd300skrvService.selectList'
                }
            },
	...
	var panelSearch = Unilite.createSearchPanel('${PKGNAME}searchForm',{
     ...
     var masterGrid = Unilite.createGrid('${PKGNAME}grid', {
		...
		columns:[{dataIndex: 'COMP_CODE'                    	,width: 100,hidden: true}
				...
				,{dataIndex: 'OPERATION_COUNT'              	,width: 66}
				,{dataIndex: 'NOTINSERVICE_YN'              	,xtype : 'checkcolumn', width: 66,
					listeners: {
...
//				,{dataIndex: 'AVG_PER_SERVICE'       	,width: 100, summaryType: 'average'}
//				,{dataIndex: 'REMARK'                	,width: 100}
