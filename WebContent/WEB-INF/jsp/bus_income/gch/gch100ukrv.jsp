...
<%
//현금 수입금 등록
request.setAttribute("PKGNAME","Unilite_app_gch100ukrv");
%>
<t:appConfig pgmId="gch100ukrv"  >
...
function appMain() {
	Unilite.defineModel('${PKGNAME}Model', {
	    ...
	    fields: [
					...
					,{name: 'DEPOSIT_CASH'    		,text:'현금'		,type : 'uniPrice' } 
					,{name: 'THOUSAND_BILL_COUNT'   ,text:'일천원권매수'	,type : 'uniQty' } 
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read 	: 'gch100ukrvService.selectList',
    	   	update 	: 'gch100ukrvService.update',
			syncAll	: 'gch100ukrvService.saveAll'
		}
	});
	...
	var panelSearch = Unilite.createSearchPanel('${PKGNAME}SearchForm',{
     ...
     var masterGrid = Unilite.createGrid('${PKGNAME}Grid', {
	    ...
	    features: [ 
	    	...
	    	{id : 'masterGridTotal', 	ftype: 'uniSummary', 	  showSummaryRow: true, dock:'bottom'} 
	    ],
    	store: masterStore, 
		columns:[
			{dataIndex:'DEPOSIT_DATE'	,width: 80,
			...
			{dataIndex:'THOUSAND_BILL_COUNT'	,width: 100,summaryType:'sum'}
