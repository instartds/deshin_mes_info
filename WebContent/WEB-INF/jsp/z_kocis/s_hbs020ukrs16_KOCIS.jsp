		...
		items:[{
				...
				items:[{
			         ...
			         items:[{
			            ...
			            items: [
			            	{boxLabel: '인정경력산입', name: 'srchImportanceGroup1', id: 'srchImportanceGroup1', inputValue: 'Y', width: 110},
			                {boxLabel: '징계기간불산입', name: 'srchImportanceGroup2', id: 'srchImportanceGroup2', inputValue: 'Y', padding: '0 0 0 10', width: 120},
			                {boxLabel: '휴직불산입', name: 'srchImportanceGroup3', id: 'srchImportanceGroup3', inputValue: 'Y', padding: '0 0 0 10', width: 80}
			            ]
				...
				columns: [{dataIndex: 'STRT_MONTH'			          	,		width: 200},				  
