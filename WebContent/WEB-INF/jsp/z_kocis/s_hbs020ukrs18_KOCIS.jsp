...
//                  padding:'0 0 0 30',
               ...
               border: false,
               name: '',
               html: "<font size='3'>[참고사항]<br>" +
               		 "&nbsp;&nbsp;상여구분자가 신입사원(변경전)이었는데 근속개월 <br>" +
               		 "&nbsp;&nbsp;수가 6개월이 경과한 후에는 경력사원(변경후)으로<br>" +
               		 "&nbsp;&nbsp;변경된다. <br>" +
               		 "&nbsp;&nbsp;변경되는 시점은 상여기초자료일괄등록 에서 근속<br>" +
               		 "&nbsp;&nbsp;개월수를 계산해 자동으로 변경된다.<br>" +
               		 "&nbsp;&nbsp;근속개월수의 시작일은 입사일이고 종료일은 상여기<br>" +
               		 "&nbsp;&nbsp;초자료일괄등록에서 입력하는 지급기준일이 된다.<br></font>",
               width: 600,
               padding: '20 0 180 20'
            }]
         }]
