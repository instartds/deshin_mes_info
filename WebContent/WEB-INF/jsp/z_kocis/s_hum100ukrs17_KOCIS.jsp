<%@page language="java" contentType="text/html; charset=utf-8"%>
	...
	var hum100ukrs17Store = Unilite.createStore('hum100ukrs17Store',{
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read :  s_hum100ukrService_KOCIS.schoolExpence,
                	   update: s_hum100ukrService_KOCIS.updateHUM820,
					   create: s_hum100ukrService_KOCIS.insertHUM820,
					   destroy:s_hum100ukrService_KOCIS.deleteHUM820,
