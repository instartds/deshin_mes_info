<%@page language="java" contentType="text/html; charset=utf-8"%>
	...
	var hum100ukrs12Store = Unilite.createStore('hum100ukrs12Store',{
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read :  s_hum100ukrService_KOCIS.personalRating,
                	   update: s_hum100ukrService_KOCIS.updateHUM770,
					   create: s_hum100ukrService_KOCIS.insertHUM770,
					   destroy:s_hum100ukrService_KOCIS.deleteHUM770,
