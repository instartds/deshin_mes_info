<%@page language="java" contentType="text/html; charset=utf-8"%> 
	<t:appConfig pgmId="s_afb300ukr_KOCIS"  >
...
//			   width:600,
    	...
    	api: {
    		load: 's_Afb300ukrService_KOCIS.selectForm',
	 		submit: 's_Afb300ukrService_KOCIS.syncMaster'	
		},
		listeners: {
					...
					items: [
						'->',{ xtype: 'button', text: '실행',
							handler: function() {
								...
								s_Afb300ukrService_KOCIS.selectCheckDataCopy1(param, function(provider, response)	{
									if(!Ext.isEmpty(provider)){
										if(confirm(Msg.fsbMsgA0194)) {
											var param = {"COMP_CODE": UserInfo.compCode,
												"AC_YYYY_NEXT": subForm.getValue('AC_YYYY_NEXT')
											};
											s_Afb300ukrService_KOCIS.selectCheckDataCopy2(param, function(provider, response)	{
												if(!Ext.isEmpty(provider)){
