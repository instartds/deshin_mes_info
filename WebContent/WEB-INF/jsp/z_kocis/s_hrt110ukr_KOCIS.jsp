...
<t:appConfig pgmId="s_hrt110ukr_KOCIS"  >
...
function appMain() {
	...
	Unilite.defineModel('Hrt110ukrModel2', {		
	    fields: [{name: 'POST_CODE'		,text: '임원직급' 		,type: 'string'},	 
	...
	var directMasterStore1 = Unilite.createStore('hrt110ukrMasterStore1',{
            ...
            proxy: {
                type: 'direct',
                api: {
                	   create: 's_hrt110ukrService_KOCIS.insertList01',
                	   read: 's_hrt110ukrService_KOCIS.selectList01',
                	   update: 's_hrt110ukrService_KOCIS.updateList01',
                	   destroy: 's_hrt110ukrService_KOCIS.deleteList01',
                	   syncAll: 's_hrt110ukrService_KOCIS.syncAll'
                }
            }
	...
	var directMasterStore2 = Unilite.createStore('hrt110ukrMasterStore2',{
            ...
            proxy: {
                type: 'direct',
                api: {			
                		create: 's_hrt110ukrService_KOCIS.insertList02',
             	   		read: 's_hrt110ukrService_KOCIS.selectList02',
             	   		update: 's_hrt110ukrService_KOCIS.updateList02',
             	   		destroy: 's_hrt110ukrService_KOCIS.deleteList02',
             	   		syncAll: 's_hrt110ukrService_KOCIS.syncAll'                	
                }
            }
			,loadStoreRecords : function()	{
	...
	var comboStore01 = Ext.create('Ext.data.Store', { 
        ...
        proxy: {
			type: 'direct',
		    api: { 
				read : 's_hrt110ukrService_KOCIS.selectComboList01'
			}
        }
	});
	...
	var comboStore02 = Ext.create('Ext.data.Store', { 
        ...
        proxy: {
			type: 'direct',
		    api: { 
				read : 's_hrt110ukrService_KOCIS.selectComboList02'
			}
        }
	});
	...
	var directMasterStore3 = Unilite.createStore('hrt110ukrMasterStore3',{
        ...
        proxy: {
            type: 'direct',
            api: {			
         	   		read: 's_hrt110ukrService_KOCIS.selectList03'
            }
        }
		,loadStoreRecords : function()	{
	...
	var directMasterStore4 = Unilite.createStore('hrt110ukrMasterStore4',{
        ...
        proxy: {
            type: 'direct',
            api: {			
         	   		read: 's_hrt110ukrService_KOCIS.selectList04',
         	   		destroy: 's_hrt110ukrService_KOCIS.deleteList04',
         	   		syncAll: 's_hrt110ukrService_KOCIS.syncAll'
            }
        }
		,loadStoreRecords : function()	{
...
// 			comboCode:''			
		...
		api: {
    		 load: 's_hrt110ukrService_KOCIS.loadFormData',
			 submit: 's_hrt110ukrService_KOCIS.submitFormData'				
			}
		, listeners : {
    ...
    var masterGrid2 = Unilite.createGrid('hrt110ukrGrid2', {
        ...
        columns:  [{ dataIndex: 'POST_CODE'		,		    	width: 150, align: 'center',
        				...
        				renderer: function(value) {
        					// not work... why?
//         					var record = comboStore02.findRecord('SUB_CODE', value);
...
// 							console.log(comboStore02.data.items);
// 							var dataArray = comboStore02.data.items;
// 							console.log(comboStore02.data.items.length);
							
// 							for (var i =0; i < comboStore02.data.items.length; i++) {
// 								console.log(comboStore02.data.items[i].data.SUB_CODE);
// 							}
							return value;
        				}
        			},
        ...
        listeners: {
          	containerclick: function() {
          		...
          		if (!e.record.phantom && e.field == 'POST_CODE') {
          			return false;
          		}
          	}
        }
		...
		items:[{
			...
			items: [{	
					...
					items:[
						{xtype: 'container',
						 margin: '15 0 0 0',
						 html: '<div align = "center"><b>[퇴직정산 기준설정]</b></div>'},
					 panelSearch]
			    }, {	
			    	flex: 0.4,
			    	xtype:'container',
