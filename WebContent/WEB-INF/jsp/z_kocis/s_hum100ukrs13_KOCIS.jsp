<%@page language="java" contentType="text/html; charset=utf-8"%>
	...
	var hum100ukrs13Store = Unilite.createStore('hum100ukrs13Store',{
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read :  s_hum100ukrService_KOCIS.disciplinaryInfo,
                	   update: s_hum100ukrService_KOCIS.updateHUM810,
					   create: s_hum100ukrService_KOCIS.insertHUM810,
					   destroy:s_hum100ukrService_KOCIS.deleteHUM810,
