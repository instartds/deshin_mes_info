...
<t:appConfig pgmId="s_hum302ukr_KOCIS"  >
	<t:ExtComboStore comboType="BOR120" pgmId="s_hum302ukr_KOCIS"	/> 			<!-- 사업장  -->
...
function appMain() {
	...
	var directProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
        	read : 's_hum302ukrService_KOCIS.selectList',
        	update: 's_hum302ukrService_KOCIS.updateDetail',
			create: 's_hum302ukrService_KOCIS.insertDetail',
			destroy: 's_hum302ukrService_KOCIS.deleteDetail',
			syncAll: 's_hum302ukrService_KOCIS.saveAll'
        }
	});
