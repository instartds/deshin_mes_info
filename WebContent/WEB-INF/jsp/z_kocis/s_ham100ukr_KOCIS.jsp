...
%>
<t:appConfig pgmId="s_ham100ukr_KOCIS"  >
	<t:ExtComboStore comboType="AU" comboCode="H012" /><!--  입사코드       -->
    <t:ExtComboStore comboType="AU" comboCode="H024" opts= '40;50'/><!--  사원구분 -->
...
function appMain() {
	...
	var searchPanelStore = Unilite.createStore('ham100ukrMasterStore',{
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read : 's_ham100ukrService_KOCIS.selectList'
                }
            },
            listeners: {
	            load: function(){
			...
			,loadStoreRecords : function(personNumb)	{
                ...
                param.DEPT_CODE = UserInfo.deptCode;
...
//인사기본정보
<%@include file="./s_ham100ukrs01_KOCIS.jsp" %> 
//급여정보
<%@include file="./s_ham100ukrs02_KOCIS.jsp" %>
	...
	function openUploadWindow() {
		var photoForm = Ext.create('Unilite.com.form.UniDetailForm',{ xtype:'uniDetailForm',
                                ...
                                api: {
                                    submit: s_ham100ukrService_KOCIS.photoUploadFile 
                                },
                                items:[
                                      {
                                        fieldLabel:'사번', 
		...
		onNewDataButtonDown : function()	{
			...
			switch(activeTab.getItemId())	{
				case 'personalInfo':
                    ...
                    activeTab.setValue('PAY_GUBUN', '2');
                    if(UserInfo.divCode != "01"){
		...
		onResetButtonDown:function() {
			...
			/* switch(activeTab.getItemId())	{
				...
				case 'contractInfo':
					...
					break;
				case 'visaInfo':
					var activeGrid1 = activeTab.down('#ham100ukrs15_1Grid');					
					activeGrid1.reset();	
					var activeGrid2 = activeTab.down('#ham100ukrs15_2Grid');					
					activeGrid2.reset();	
					break;
				case 'abroadTrip':
					var activeGrid = activeTab.down('#ham100ukrs16Grid');					
