...
/**
	...
	var hum100ukrs15_1Store = Unilite.createStore('hum100ukrs15_1Store',{
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read : s_hum100ukrService_KOCIS.passportInfo,
                	   create: s_hum100ukrService_KOCIS.insertHUM730,	
                	   update: s_hum100ukrService_KOCIS.updateHUM730,				   
				   	   destroy:s_hum100ukrService_KOCIS.deleteHUM730,
	...
	var hum100ukrs15_2Store = Unilite.createStore('hum100ukrs15_2Store',{
            ...
            proxy: {
                type: 'direct',
                api: {
                	   read : s_hum100ukrService_KOCIS.visaInfo,
                	   create: s_hum100ukrService_KOCIS.insertHUM731,	
                	   update: s_hum100ukrService_KOCIS.updateHUM731,				   
				   	   destroy:s_hum100ukrService_KOCIS.deleteHUM731,
				   	   syncAll:s_hum100ukrService_KOCIS.syncAll
                }
            },
            saveStore : function(config)	{				
