...
function appMain() {
	...
	// GroupField string type으로 변환, 20210803 주석
...
//	}
		...
		items: [{	
			...
			defaultType: 'uniTextfield',
				items: [{
					...
					Unilite.popup('ITEM',{ // 20210811 수정: 품목 조회조건 소스코드 표준화
						...
						listeners: {
							onValueFieldChange:function( elm, newValue, oldValue) {						
								panelResult.setValue('FROM_ITEM', newValue);
							...
							onTextFieldChange:function( elm, newValue, oldValue) {
								panelResult.setValue('FROM_NAME', newValue);
					...
					Unilite.popup('ITEM',{ // 20210811 수정: 품목 조회조건 소스코드 표준화
						...
						listeners: {
							onValueFieldChange:function( elm, newValue, oldValue) {						
								panelResult.setValue('TO_ITEM', newValue);
							...
							onTextFieldChange:function( elm, newValue, oldValue) {
								panelResult.setValue('TO_NAME', newValue);
	...
	var panelResult = Unilite.createSearchForm('resultForm',{
		...
		Unilite.popup('ITEM',{ // 20210811 수정: 품목 조회조건 소스코드 표준화
			...
			listeners: {
				onValueFieldChange:function( elm, newValue, oldValue) {
					panelSearch.setValue('FROM_ITEM', newValue);
				...
				onTextFieldChange:function( elm, newValue, oldValue) {
					panelSearch.setValue('FROM_NAME', newValue);
...
//			labelWidth: 15, 
			listeners: {
				onValueFieldChange:function( elm, newValue, oldValue) {						
					panelSearch.setValue('TO_ITEM', newValue);
				...
				onTextFieldChange:function( elm, newValue, oldValue) {
					panelSearch.setValue('TO_NAME', newValue);
	...
	Unilite.Main({
		...
		onQueryButtonDown : function() {
			...
			//20210727 주석: 그리드 lock 옵션 사용하지 않음
