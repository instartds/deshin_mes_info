...
<t:appConfig pgmId="biv460skrv"  >
	
	<t:ExtComboStore comboType="BOR120" pgmId="biv460skrv"/> 			<!-- 사업장 -->
...
function appMain() {
	...
	Unilite.defineModel('Biv460skrvModel', {
	    fields: [  	  
	 ...
	 * @type 
	 */					
	var directMasterStore1 = Unilite.createStore('biv460skrvMasterStore1',{
			model: 'Biv460skrvModel',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {			
                	   read: 'biv460skrvService.selectList'                	
                }
            }
...
//					allowBlank:false,
    ...
    Unilite.Main( {
		...
		fnInitBinding : function() {
			...
			biv460skrvService.userWhcode({}, function(provider, response)	{
