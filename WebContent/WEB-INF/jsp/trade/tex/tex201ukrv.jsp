...
function appMain() {
	 ...
	 * @type 
	 */
	Unilite.defineModel('tex201ukrvModel', {
		fields: [  	  
	...
	Unilite.defineModel('tex201ukrvModel2', {
		fields: [
	...
	var directMasterProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read	: 'tex201ukrvService.selectMasterList',
			update	: 'tex201ukrvService.updateMaster',
//			create	: 'tex201ukrvService.insertMaster',
//			destroy	: 'tex201ukrvService.deleteMaster',
			syncAll	: 'tex201ukrvService.saveAll'
		}
	});

	var directDetailProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
		api: {
			read	: 'tex201ukrvService.selectDetailList',
			update	: 'tex201ukrvService.updateDetail',
			create	: 'tex201ukrvService.insertDetail',
			destroy	: 'tex201ukrvService.deleteDetail',
			syncAll	: 'tex201ukrvService.saveAll'
		}
	});  
	 ...
	 * @type 
	 */
	var directMasterStore = Unilite.createStore('tex201ukrvMasterStore1',{
		proxy	: directMasterProxy,
		model	: 'tex201ukrvModel',
		uniOpt	: {
...
//			}
	...
	var directDetailStore = Unilite.createStore('tex201ukrvMasterStore2',{
		proxy	: directDetailProxy,
		model	: 'tex201ukrvModel2',
		uniOpt	: {
	 ...
	 * @type 
	 */
	var masterGrid = Unilite.createGrid('tex201ukrvGrid1', {
...
//			useContextMenu: true,
	 ...
	 * @type 
	 */
	var detailGrid = Unilite.createGrid('tex201ukrvGrid2', {
