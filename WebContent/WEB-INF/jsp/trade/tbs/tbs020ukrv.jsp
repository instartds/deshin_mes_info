...
<t:appConfig pgmId="tbs020ukrv">
		
	<t:ExtComboStore comboType="AU" comboCode="" /> <!--<t:message code="system.label.trade.qty" default="수량"/>-->
	<t:ExtComboStore comboType="AU" comboCode="" /> <!--<t:message code="system.label.trade.price" default="단가 "/>-->
	<t:ExtComboStore comboType="AU" comboCode="" /> <!--자국화폐금액-->
	<t:ExtComboStore comboType="AU" comboCode="" /> <!--외화화폐금액-->
	<t:ExtComboStore comboType="AU" comboCode="" /> <!--<t:message code="system.label.trade.exchangerate" default="환율"/>-->
...
function appMain() {     
	var tbs020ukrvStore = Ext.create('Ext.data.Store',{
		storeId: 'tbs020ukrvCombo',
        fields:[
        	'value',
        	'text'
        ],
	...
	<%@include file="./tbs020ukrvs1.jsp" %>	//구매자재기준설정
	<%@include file="./tbs020ukrvs2.jsp" %>	//조회데이타포맷설정
    ...
    var panelDetail = Ext.create('Ext.panel.Panel', {
	 ...
	 Unilite.Main( {
		...
		onQueryButtonDown : function()	{		
			var activeTab = panelDetail.down('#tbs020Tab').getActiveTab();
