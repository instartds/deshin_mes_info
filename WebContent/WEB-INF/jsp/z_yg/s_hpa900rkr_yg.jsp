...
<t:appConfig pgmId="s_hpa900rkr_yg"  >
...
function appMain() {
	 ...
	 * @type 
	 */					
	var masterStore = Unilite.createStore('s_hpa900rkr_ygMasterStore',{
		uniOpt: {
        ...
        proxy: {
            type: 'direct',
            api: {			
                read: 's_hpa900rkr_ygService.selectList'                	
            }
        }/*, //(사용 안 함 : 쿼리에서 처리)
        listeners : {
	        load : function(store) {
...
/*			if(!panelResult.setAllFieldsReadOnly(true)){
            ...
            var param = {
                   ...
                   DEPT_CODE_FR : param.DEPT_CODE_FR,
                   DEPT_CODE_TO : param.DEPT_CODE_TO,
            ...
            var win = Ext.create('widget.CrystalReport', {
                url: CPATH+'/z_yg/s_hpa900crkr_yg.do',
                prgID: 's_hpa900crkr_yg',
                extParam: param
            });
            win.center();
            win.show();		
