...
<t:appConfig pgmId="s_agj270skr_yg"  >
...
function appMain() {
    ...
    var directReportProxy = Ext.create('Unilite.com.data.proxy.UniDirectProxy',{
        api: {
            create: 's_agj270skr_ygService.insertDetail',
            syncAll: 's_agj270skr_ygService.saveAll'
        }
    });
	/* Model 정의 
	 * @type 
	 */
	Unilite.defineModel('s_agj270skr_ygModel1', {
		fields: [
	...
	Unilite.defineModel('s_agj270skr_ygModel2', {
		fields: [
    ...
    var reportStore = Unilite.createStore('s_agj270skr_ygReportStore',{
        uniOpt: {
            isMaster: false,
            editable: false,
            deletable: false,
	 ...
	 * @type 
	 */					
	var masterStore = Unilite.createStore('s_agj270skr_ygDetailStore',{
		model: 's_agj270skr_ygModel1',
		uniOpt : {
        ...
        proxy: {
            type: 'direct',
            api: {
                read: 's_agj270skr_ygService.selectList'
            }
        },
...
//                        reportStore.clearData();
	...
	var detailStore = Unilite.createStore('s_agj270skr_ygDetailStore',{
			model: 's_agj270skr_ygModel2',
			uniOpt : {
            ...
            proxy: {
                type: 'direct',
                api: {			
                	   read: 's_agj270skr_ygService.selectList2'                	
                }
            },
...
//			typeAhead: false,
     ...
     * @type 
     */
    var masterGrid = Unilite.createGrid('s_agj270skr_ygGrid', {
        layout : 'fit',
        region:'center',
        flex: 3,
    	store: masterStore,
...
//				}				
    ...
    var detailGrid = Unilite.createGrid('s_agj270skr_ygGrid2', {
    	// for tab    	
        layout : 'fit',
        region:'south',
        flex: 2,
    ...
    var detailForm = Unilite.createForm('s_agj270skr_ygDetailForm',  {	
        itemId: 's_agj270skr_ygDetailForm',
