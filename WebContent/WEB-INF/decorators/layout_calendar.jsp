...
<%
    String extjsVersion = "4.2.2";//ConfigUtil.getString("extjs.version", "4.2.2");
...
<c:when test="${isDevelopServer }">
    ...
    <script type="text/javascript" charset="UTF-8" src='<c:url value="/${ext_root}/app/Extensible/calendar/UniCalendarPanel.js" />'  ></script>
