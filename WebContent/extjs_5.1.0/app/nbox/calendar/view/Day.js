 ...
 */
/**
 * @class nbox.calendar.view.Day
 * @extends Ext.container.Container
 * <p>Unlike other calendar views, is not actually a subclass of {@link nbox.calendar.view.AbstractCalendar CalendarView}.
 * Instead it is a {@link Ext.container.Container Container} subclass that internally creates and manages the layouts of
 * a {@link nbox.calendar.view.DayHeader DayHeaderView} and a {@link nbox.calendar.view.DayBody DayBodyView}. As such
 ...
 */
Ext.define('nbox.calendar.view.Day', {
    extend: 'Ext.container.Container',
    alias: 'widget.nbox.dayview',
    
    requires: [
        'nbox.calendar.view.AbstractCalendar',
        'nbox.calendar.view.DayHeader',
        'nbox.calendar.view.DayBody'
    ],
    ...
    initComponent : function(){
         ...
         */
        this.ddCreateEventText = this.ddCreateEventText || nbox.calendar.view.AbstractCalendar.prototype.ddCreateEventText;
        /**
         ...
         */
        this.ddMoveEventText = this.ddMoveEventText || nbox.calendar.view.AbstractCalendar.prototype.ddMoveEventText;
     ...
     * @return {nbox.calendar.view.Day} this
     */
    showEventEditor : function(rec, animateTarget){
        return nbox.calendar.view.AbstractCalendar.prototype.showEventEditor.apply(this, arguments);
    },
    ...
    dismissEventEditor : function(dismissMethod){
        return nbox.calendar.view.AbstractCalendar.prototype.dismissEventEditor.apply(this, arguments);
    }
});