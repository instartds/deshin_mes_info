...
//    },
     ...
     * as defined in {@link nbox.calendar.data.EventMappings}.</div></li><ul></div>
     */
    setValue: function(v){
        if(!v) {
            return;
        ...
        var me = this,
            eventMappings = nbox.calendar.data.EventMappings,
