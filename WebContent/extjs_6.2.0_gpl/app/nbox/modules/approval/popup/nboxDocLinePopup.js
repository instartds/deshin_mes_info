...
var commonDocPathStore;
var docLinePopupDeptTreeStore;
var tempDocLineStore;
var tempDoubleLineStore;
var tempRcvUserStore;
var tempRefUserStore;
/**************************************************
 * Common Code
 **************************************************/
Ext.define('nbox.commonDocPathStore', {
...
Ext.define('nbox.docRcvUserModel', {
    extend: 'Ext.data.Model',
    fields: [
		{name: 'id'},     
    	{name: 'DocumentID'},
 ...
 **************************************************/
//dept tree	
Ext.define('nbox.docLinePopupDeptTreeStore', {
...
//DocLine List
Ext.define('nbox.tempDocLineStore', {
	extend: 'Ext.data.Store',
	model: 'nbox.docLineModel',
	autoLoad: false,
	proxy: {
        type: 'direct',
...
//DoubleLine List
Ext.define('nbox.tempDoubleLineStore', {
	extend: 'Ext.data.Store',
	model: 'nbox.docLineModel',
	autoLoad: false,
	proxy: {
...
//RCV User List
Ext.define('nbox.tempRcvUserStore', {
	extend: 'Ext.data.Store',
	model: 'nbox.docRcvUserModel',
	autoLoad: false,
	proxy: {
        type: 'direct',
...
//REF User List
Ext.define('nbox.tempRefUserStore', {
	extend: 'Ext.data.Store',
	model: 'nbox.docRcvUserModel',
	autoLoad: false,
	proxy: {
...
Ext.define('nbox.docLinePopupTab', {
    ...
    initComponent: function () {
    	var me = this;
    	tempDocLineStore = Ext.create('nbox.tempDocLineStore', {
    		
    	});
    	
    	tempDoubleLineStore = Ext.create('nbox.tempDoubleLineStore', {
    		
    	});
    	
    	tempRcvUserStore = Ext.create('nbox.tempRcvUserStore', {
    		
    	});
    	
    	tempRefUserStore = Ext.create('nbox.tempRefUserStore', {
...
Ext.define('nbox.docLinePopupWindow',{
    ...
    initComponent: function () {
        ...
        docLinePopupDeptTreeStore = Ext.create('nbox.docLinePopupDeptTreeStore', {});
    ...
    formShow: function(){
		...
		var docLineStore = docLinePopupWin.getRegItems()['DocLineView'].getStore();
...
Ext.define('nbox.docLinePopupToolbar',    {
	...
	initComponent: function () {
    	var me = this;
    	commonDocPathStore = Ext.create('nbox.commonDocPathStore', {
...
function openDocLinePopupWin(openType,lineType,DocLineView,RcvUserView,RefUserView) {
	// detailWin
	if(!docLinePopupWin){
	...
	docLinePopupWin.getRegItems()['DocLineView'] = DocLineView;
