 ...
 */
/**
 * @class nbox.calendar.template.Month
 * @extends Ext.XTemplate
 * <p>This is the template used to render the {@link nbox.calendar.view.Month MonthView}. Internally this class defers to an
 * instance of {@link nbox.calendar.template.BoxLayout} to handle the inner layout rendering and adds containing elements around
 ...
 */
Ext.define('nbox.calendar.template.Month', {
    ...
    constructor: function(config){
        ...
        this.weekTpl = Ext.create('nbox.calendar.template.BoxLayout', config);
        this.weekTpl.compile();
        
        var weekLinkTpl = this.showWeekLinks ? '<div class="ext-cal-week-link-hd">&#160;</div>' : '';
        
        nbox.calendar.template.Month.superclass.constructor.call(this,
    ...
    applyTemplate : function(o){
        ...
        if (Ext.getVersion().isLessThan('4.1')) {
            return nbox.calendar.template.Month.superclass.applyTemplate.call(this, templateConfig);
        }
        else {
