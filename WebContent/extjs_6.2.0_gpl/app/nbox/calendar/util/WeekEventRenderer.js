 ...
 */
Ext.define('nbox.calendar.util.WeekEventRenderer', {
    ...
    statics: {
        ...
        renderEvent: function(event, weekIndex, dayIndex, eventIndex, dayCount, currentDate, renderConfig) {
            var eventMappings = nbox.calendar.data.EventMappings,
         ...
         * nbox.calendar.view.Month.renderItems() to see what gets passed).
         * @private
         */
