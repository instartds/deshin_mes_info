 ...
 */
/**
 * @class nbox.calendar.data.EventModel
 * @extends Ext.data.Record
 * <p>This is the {@link Ext.data.Record Record} specification for calendar event data used by the
 * {@link nbox.calendar.CalendarPanel CalendarPanel}'s underlying store. It can be overridden as 
...
rec = new nbox.calendar.data.EventModel({
 ...
 * If you have overridden any of the record's data mappings via the {@link nbox.calendar.data.EventMappings EventMappings} object
 ...
 */
Ext.define('nbox.calendar.data.EventModel', {
    ...
    statics: {
        /**
         * Reconfigures the default record definition based on the current {@link nbox.calendar.data.EventMappings EventMappings}
         * object. See the header documentation for {@link nbox.calendar.data.EventMappings} for complete details and 
    ...
    // Sencha broke getId() for mapped ids in 4.2. Mappings are required by nbox and this method
...
function(){
    nbox.calendar.data.EventModel.reconfigure();
});