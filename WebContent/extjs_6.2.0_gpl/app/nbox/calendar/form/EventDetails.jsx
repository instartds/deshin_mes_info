 ...
 */
/**
 * @class nbox.calendar.form.EventDetails
 ...
 * calendar components. It is also configured to automatically bind records of type {@link nbox.calendar.data.EventModel}
 ...
 */
Ext.define('nbox.calendar.form.EventDetails', {
    extend: 'Ext.form.Panel',
    alias: 'widget.nbox.eventeditform',
    
    requires: [
        'nbox.form.field.DateRange',
        'nbox.calendar.form.field.ReminderCombo',
        'nbox.calendar.data.EventMappings',
        'nbox.calendar.form.field.CalendarCombo',
        'nbox.form.recurrence.Combo',
    ...
    initComponent: function(){
        ...
        this.addEvents({
             ...
             * @param {nbox.calendar.form.EventDetails} this
        ...
        this.dateRangeField = Ext.create('nbox.form.field.DateRange', {
        ...
        this.reminderField = Ext.create('nbox.calendar.form.field.ReminderCombo', {
            name: nbox.calendar.data.EventMappings.Reminder.name,
        ...
        this.locationField = Ext.create('Ext.form.field.Text', {
            ...
            name: nbox.calendar.data.EventMappings.Location.name,
            anchor: '100%'
        });
        this.urlField = Ext.create('Ext.form.field.Text', {
            fieldLabel: this.webLinkLabelText,
            name: nbox.calendar.data.EventMappings.Url.name,
            anchor: '100%'
        });
...
//            this.recurrenceField = Ext.create('nbox.form.recurrence.Fieldset', {
//                name: nbox.calendar.data.EventMappings.RRule.name,
...
//        }
        ...
        if(this.calendarStore){
            this.calendarField = Ext.create('nbox.calendar.form.field.CalendarCombo', {
                store: this.calendarStore,
                fieldLabel: this.calendarLabelText,
                name: nbox.calendar.data.EventMappings.CalendarId.name,
                anchor: '70%'
            });
    ...
    loadRecord: function(rec){
        ...
        if(this.recurrenceField){
            this.recurrenceField.setStartDate(rec.data[nbox.calendar.data.EventMappings.StartDate.name]);
        }
        if(this.calendarStore){
            this.form.setValues({'calendar': rec.data[nbox.calendar.data.EventMappings.CalendarId.name]});
        }
        
        //this.isAdd = !!rec.data[nbox.calendar.data.EventMappings.IsNew.name];
        if(rec.phantom){
