 ...
 */
/**
 * @class nbox.calendar.form.field.CalendarCombo
 ...
 */
Ext.define('nbox.calendar.form.field.CalendarCombo', {
    extend: 'Ext.form.field.ComboBox',
    alias: 'widget.nbox.calendarcombo',
    
    requires: ['nbox.calendar.data.CalendarMappings'],
    ...
    initComponent: function(){
        this.valueField = nbox.calendar.data.CalendarMappings.CalendarId.name;
        this.displayField = nbox.calendar.data.CalendarMappings.Title.name;
    ...
    getListItemTpl: function(displayField) {
        return '<div class="x-combo-list-item x-cal-{' + nbox.calendar.data.CalendarMappings.ColorId.name +
    ...
    refreshColorCls: function() {
        var me = this,
            calendarMappings = nbox.calendar.data.CalendarMappings,
            colorCls = '',
            value = me.getValue();
...
//        }
    ...
    setValue: function(value) {
        if (!value && this.store.getCount() > 0) {
            ...
            value = this.store.getAt(0).data[nbox.calendar.data.CalendarMappings.CalendarId.name];
        }
