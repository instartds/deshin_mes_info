 ...
 */
/**
 * @class nbox.calendar.view.Month
 ...
 */
Ext.define('nbox.calendar.view.Month', {
    extend: 'nbox.calendar.view.AbstractCalendar',
    alias: 'widget.nbox.monthview',
    
    requires: [
        'Ext.XTemplate',
        'Ext.util.TaskManager',
        'nbox.calendar.template.Month',
        'nbox.calendar.util.WeekEventRenderer',
        'nbox.calendar.view.MonthDayDetail'
    ],
     ...
     * True to display an extra column before the first day in the calendar that links to the {@link nbox.calendar.view.Week view}
    ...
    initComponent : function(){
        ...
        this.addEvents({
             ...
             * @param {nbox.calendar.view.Month} this
	...
	initDD : function(){
        ...
        this.dragZone = Ext.create('nbox.calendar.dd.DragZone', this.el, cfg);
        this.dropZone = Ext.create('nbox.calendar.dd.DropZone', this.el, cfg);
	},
    ...
    afterRender : function(){
        if(!this.tpl){
            this.tpl = Ext.create('nbox.calendar.template.Month', {
                id: this.id,
        ...
        if(!this.eventBodyMarkup){
            this.eventBodyMarkup = [
	            ...
	            '</tpl>',
             	...
             	'</tpl>',
             	'<tpl if="_isRecurring">',
	            	'<i class="ext-cal-ic ext-cal-ic-rer">&#160;</i>',
	            '</tpl>',
	            '{Title}',
	            '<tpl if="spanLeft">',
    ...
    getTemplateEventData : function(evt){
        ...
        if(this.calendarStore && evt[M.CalendarId.name]){
            var rec = this.calendarStore.findRecord(nbox.calendar.data.CalendarMappings.CalendarId.name, evt[M.CalendarId.name]);
            if(rec){
    ...
    renderItems : function(){
        nbox.calendar.util.WeekEventRenderer.render({
    ...
    onClick : function(e, t){
        ...
        if(nbox.calendar.view.Month.superclass.onClick.apply(this, arguments)){
