 ...
 */
/**
 * @class nbox.calendar.menu.Event
 * @extends Ext.menu.Menu
 * The context menu displayed for calendar events in any {@link nbox.calendar.view.AbstractCalendar CalendarView} subclass. 
 * @xtype nbox.eventcontextmenu
 */
Ext.define('nbox.calendar.menu.Event', {
    extend: 'Ext.menu.Menu',
    alias: 'widget.nbox.eventcontextmenu',
    ...
    initComponent : function(){
        this.addEvents(
             ...
             * (by default, in an instance of {@link nbox.calendar.form.EventDetails}. Handling code should 
             * transfer the current event record to the appropriate instance of the detailed form by showing
             * the form and calling {@link nbox.calendar.form.EventDetails#loadRecord loadRecord}.
             * @param {nbox.calendar.menu.Event} this
             ...
             * @param {nbox.calendar.menu.Event} this
             * @param {nbox.calendar.data.EventModel} rec The {@link nbox.calendar.data.EventModel record} for the event to be deleted
             * @param {Ext.Element} el The element associated with this context menu
             */
            'eventdelete',
            /**
             ...
             * @param {nbox.calendar.menu.Event} this
             * @param {nbox.calendar.data.EventModel} rec The {@link nbox.calendar.data.EventModel record} for the event to be moved
    ...
    buildMenu: function(){
        ...
        this.dateMenu = Ext.create('Ext.menu.DatePicker', {
            ...
            handler: function(dp, dt){
                dt = Extensible.Date.copyTime(this.rec.data[nbox.calendar.data.EventMappings.StartDate.name], dt);
        ...
        Ext.apply(this, {
            items: [{
                ...
                iconCls: 'nbox-cal-icon-evt-edit',
                scope: this,
                handler: function(){
                ...
                iconCls: 'nbox-cal-icon-evt-move',
                menu: this.dateMenu
            }]
        });
    },
     ...
     * @param {nbox.calendar.data.EventModel} rec The {@link nbox.calendar.data.EventModel record} for the event
     * @param {Ext.Element} el The element associated with this context menu
    ...
    showForEvent: function(rec, el, xy){
        this.rec = rec;
        this.ctxEl = el;
        this.dateMenu.picker.setValue(rec.data[nbox.calendar.data.EventMappings.StartDate.name]);
        this.showAt(xy);
    },
