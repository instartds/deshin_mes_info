 ...
 * 
 * 참고자료 : {@link http://www.sencha.com/forum/showthread.php?205576}
 */
Ext.define('Ext.ux.upload.Basic', {
    ...
    /**
     * 
     * @cfg {String} statusQueuedText
     */
    statusQueuedText: 'Ready to upload',
    /**
     * 
     * @cfg {String} statusUploadingText
     */
    statusUploadingText: 'Uploading ({0}%)',
    /**
     * 
     * @cfg {String} statusFailedText
     */
    statusFailedText: 'Error',
    /**
     * 
     * @cfg {String} statusDoneText
     */
    statusDoneText: 'Complete',
    /**
     * 
     * @cfg {String} statusInvalidSizeText
     */
    statusInvalidSizeText: 'File too large',
    /**
     * 
     * @cfg {String} statusInvalidExtensionText
     */
