    ...
    if (exists('Extensible.calendar.form.field.ReminderCombo')) {
        Ext.apply(Extensible.calendar.form.field.ReminderCombo.prototype, {
            ...
            getMinutesText: function(numMinutes){
                return numMinutes === 1 ? '분' : '분';
            },
            getHoursText: function(numHours){
                return numHours === 1 ? '시간' : '시간';
            },
            getDaysText: function(numDays){
                return numDays === 1 ? '일' : '일';
            },
            getWeeksText: function(numWeeks){
                return numWeeks === 1 ? '주' : '주';
            },
            reminderValueFormat: '{0} {1} 시간 전' // e.g. "2 hours before start"
        });
    }
