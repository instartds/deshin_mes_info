	...
	popup: function(sPopItem, config ) {
		...
		if (sPopItem == 'WKORD_NUM' ) { 		// 작업지시정보
            ...
            rv = {
                xtype:'uniPopupField', 
                fieldLabel : '관리번호',
                valueFieldName:'NEGO_INCOM_NO',
                textFieldName:'NEGO_INCOM_NO',
                DBvalueFieldName: 'NEGO_INCOM_NO',
                DBtextFieldName: 'NEGO_INCOM_NO',
                textFieldOnly: true,
...
//                        popupHeight:650
                    ...
                    }else if (sPopItem == 'EQU_CODE' ) {
        				rv = {
        					xtype:'uniPopupField',				
        					valueFieldName:'EQU_CODE',
                            textFieldName:'EQU_CODE',   
