 ...
 */
/**
 * @class nbox.calendar.template.BoxLayout
 ...
 * the {@link nbox.calendar.view.Month MonthView} and the all-day headers for {@link nbox.calendar.view.Day DayView} and 
 ...
 */
Ext.define('nbox.calendar.template.BoxLayout', {
     ...
     * above the first row (e.g., {@link nbox.calendar.view.Month#showHeader MonthView.showHeader} = true)
    ...
    constructor: function(config){
        ...
        nbox.calendar.template.BoxLayout.superclass.constructor.call(this,
            '<tpl for="weeks">',
    ...
    applyTemplate : function(o){
        ...
        if (Ext.getVersion().isLessThan('4.1')) {
            return nbox.calendar.template.BoxLayout.superclass.applyTemplate.call(this, {
                weeks: weeks
            });
        }
        else {
