...
/**
 * @private
 * @class nbox.calendar.gadget.CalendarListMenu
 * @extends Ext.menu.Menu
 * <p>A menu containing a {@link nbox.calendar.util.ColorPicker color picker} for choosing calendar colors, 
 * as well as other calendar-specific options.</p>
 * @xtype nbox.calendarlistmenu
 */
Ext.define('nbox.calendar.gadget.CalendarListMenu', {
    extend: 'Ext.menu.Menu',
    alias: 'widget.nbox.calendarlistmenu',
    
    requires: ['nbox.calendar.util.ColorPicker'],
     ...
     * @property palette
     * @type ColorPicker
     * The {@link nbox.calendar.util.ColorPicker ColorPicker} instance for this CalendarListMenu
     */
    ...
    initComponent : function(){
        ...
        Ext.apply(this, {
            ...
            items: [{
                ...
                iconCls: 'nbox-cal-icon-cal-show',
                handler: Ext.bind(this.handleRadioCalendarClick, this)
            }, '-', {
                xtype: 'nbox.calendarcolorpicker',
     ...
     * @return {nbox.calendar.gadget.CalendarListMenu} this
     */
